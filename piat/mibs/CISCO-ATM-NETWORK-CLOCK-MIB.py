...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ATM-NETWORK-CLOCK-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:25:44 2019
...
TimeTicks, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Gauge32, NotificationType, ObjectIdentity, MibIdentifier, Unsigned32, iso, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Gauge32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Unsigned32", "iso", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("CISCO-ATM-NETWORK-CLOCK-MIB", cncNcdpRowStatus=cncNcdpRowStatus, ciscoAtmNetworkClockMIB=ciscoAtmNetworkClockMIB, cncSourceChangeReason=cncSourceChangeReason, cncMIBCompliance=cncMIBCompliance, cncNcdpSourceHealth=cncNcdpSourceHealth, cncNcdpSource=cncNcdpSource, cncNcdpEnable=cncNcdpEnable, ciscoAtmNetworkClockMIBCompliances=ciscoAtmNetworkClockMIBCompliances, ciscoAtmNetworkClockConformance=ciscoAtmNetworkClockConformance, cncManualSourceHealth=cncManualSourceHealth, cncNcdpAtmTable=cncNcdpAtmTable, ciscoAtmNetworkClockNotificationPrefix=ciscoAtmNetworkClockNotificationPrefix, cncNcdpAdminWeight=cncNcdpAdminWeight, cncNcdpVpi=cncNcdpVpi, cncNcdpSourceEntry=cncNcdpSourceEntry, cncNcdpPRSReference=cncNcdpPRSReference, cncGroup=cncGroup, cncManualSource=cncManualSource, ciscoAtmNetworkClockMIBNotifications=ciscoAtmNetworkClockMIBNotifications, ciscoAtmNetworkClockMIBObjects=ciscoAtmNetworkClockMIBObjects, cncNotificationGroup=cncNotificationGroup, cncManualSourceId=cncManualSourceId, cncManualSourcePriority=cncManualSourcePriority, cncNcdpMaxDiameter=cncNcdpMaxDiameter, cncDistributionMethod=cncDistributionMethod, cncNcdpPriority=cncNcdpPriority, cncNcdpAtmEntry=cncNcdpAtmEntry, cncSourceChangeTimeStamp=cncSourceChangeTimeStamp, cncNotificationOnChange=cncNotificationOnChange, CncHealth=CncHealth, cncNcdp=cncNcdp, cncNcdpBestClockSource=cncNcdpBestClockSource, cncManualSourceEntry=cncManualSourceEntry, cncManualSourceTable=cncManualSourceTable, cncRootClockSource=cncRootClockSource, cncNcdpHoldTime=cncNcdpHoldTime, cncNcdpStratum=cncNcdpStratum, cncNcdpVci=cncNcdpVci, cncNotifySourceChange=cncNotifySourceChange, ciscoAtmNetworkClockMIBGroups=ciscoAtmNetworkClockMIBGroups, cncNcdpSourceTable=cncNcdpSourceTable, PYSNMP_MODULE_ID=ciscoAtmNetworkClockMIB, cncGlobal=cncGlobal, cncNodeStratum=cncNodeStratum, cncNcdpHealth=cncNcdpHealth, cncNcdpMessageInterval=cncNcdpMessageInterval, CncStratum=CncStratum, cncManualRowStatus=cncManualRowStatus)
