...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-RF-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:29:44 2019
...
Gauge32, Bits, ModuleIdentity, MibIdentifier, TimeTicks, IpAddress, NotificationType, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "ModuleIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "NotificationType", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Integer32", "Counter64")
TextualConvention, DateAndTime, DisplayString, TimeInterval, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DateAndTime", "DisplayString", "TimeInterval", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("CISCO-RF-MIB", cRFHistory=cRFHistory, cRFStatusRFClientDescr=cRFStatusRFClientDescr, cRFStatus=cRFStatus, cRFStatusRFClientSeq=cRFStatusRFClientSeq, ciscoRFMIBCompliance=ciscoRFMIBCompliance, ciscoRFMIBComplianceRev2=ciscoRFMIBComplianceRev2, ciscoRFMIBConformance=ciscoRFMIBConformance, ciscoRFMIBNotificationsPrefix=ciscoRFMIBNotificationsPrefix, cRFHistorySwactTime=cRFHistorySwactTime, RFAction=RFAction, PYSNMP_MODULE_ID=ciscoRFMIB, cRFCfgKeepaliveTimerMax=cRFCfgKeepaliveTimerMax, cRFStatusRFModeCapsEntry=cRFStatusRFModeCapsEntry, RFMode=RFMode, ciscoRFMIBGroups=ciscoRFMIBGroups, cRFCfgKeepaliveThresh=cRFCfgKeepaliveThresh, RFClientStatus=RFClientStatus, cRFCfgSplitMode=cRFCfgSplitMode, cRFHistorySwitchOverTable=cRFHistorySwitchOverTable, cRFStatusPrimaryMode=cRFStatusPrimaryMode, cRFCfgRedundancyModeDescr=cRFCfgRedundancyModeDescr, cRFCfgKeepaliveTimerMin=cRFCfgKeepaliveTimerMin, cRFStatusPeerStandByEntryTime=cRFStatusPeerStandByEntryTime, cRFCfgNotifTimer=cRFCfgNotifTimer, ciscoRFIssuStateObjGroup=ciscoRFIssuStateObjGroup, cRFCfgNotifsEnabled=cRFCfgNotifsEnabled, ciscoRFMIBComplianceRev4=ciscoRFMIBComplianceRev4, ciscoRFMIBComplianceRev1=ciscoRFMIBComplianceRev1, RFSwactReasonType=RFSwactReasonType, ciscoRFConfigGroup=ciscoRFConfigGroup, cRFStatusLastSwactReasonCode=cRFStatusLastSwactReasonCode, ciscoRFStatusGroup=ciscoRFStatusGroup, ciscoRFIssuStateNotifGroup=ciscoRFIssuStateNotifGroup, ciscoRFIssuStateNotifGroupRev1=ciscoRFIssuStateNotifGroupRev1, cRFStatusUnitState=cRFStatusUnitState, ciscoRFSwactNotif=ciscoRFSwactNotif, cRFHistoryPrevActiveUnitId=cRFHistoryPrevActiveUnitId, RFUnitIdentifier=RFUnitIdentifier, RFIssuStateRev1=RFIssuStateRev1, cRFStatusRFModeCapsModeDescr=cRFStatusRFModeCapsModeDescr, ciscoRFConfigGroupRev1=ciscoRFConfigGroupRev1, cRFCfgKeepaliveTimer=cRFCfgKeepaliveTimer, ciscoRFStatusRFModeCapsGroup=ciscoRFStatusRFModeCapsGroup, cRFStatusPeerUnitState=cRFStatusPeerUnitState, cRFCfgKeepaliveThreshMax=cRFCfgKeepaliveThreshMax, cRFHistoryColdStarts=cRFHistoryColdStarts, cRFStatusManualSwactInhibit=cRFStatusManualSwactInhibit, ciscoRFHistoryGroup=ciscoRFHistoryGroup, ciscoRFMIBObjects=ciscoRFMIBObjects, cRFHistoryStandByAvailTime=cRFHistoryStandByAvailTime, cRFStatusRFClientID=cRFStatusRFClientID, cRFStatusIssuFromVersion=cRFStatusIssuFromVersion, cRFClient=cRFClient, cRFCfgAdminAction=cRFCfgAdminAction, ciscoRFStatusGroupRev1=ciscoRFStatusGroupRev1, RFIssuState=RFIssuState, cRFStatusDuplexMode=cRFStatusDuplexMode, ciscoRFMIBNotifications=ciscoRFMIBNotifications, cRFCfgRedundancyOperMode=cRFCfgRedundancyOperMode, cRFStatusRFModeCapsMode=cRFStatusRFModeCapsMode, cRFStatusUnitId=cRFStatusUnitId, RFState=RFState, ciscoRFIssuStateNotifRev1=ciscoRFIssuStateNotifRev1, cRFStatusIssuToVersion=cRFStatusIssuToVersion, cRFCfgMaintenanceMode=cRFCfgMaintenanceMode, cRFStatusRFModeCapsTable=cRFStatusRFModeCapsTable, ciscoRFMIBComplianceRev5=ciscoRFMIBComplianceRev5, ciscoRFMIBCompliances=ciscoRFMIBCompliances, cRFStatusIssuState=cRFStatusIssuState, cRFStatusRFClientStatus=cRFStatusRFClientStatus, cRFCfgKeepaliveThreshMin=cRFCfgKeepaliveThreshMin, cRFHistorySwitchOverEntry=cRFHistorySwitchOverEntry, cRFCfgNotifTimerMin=cRFCfgNotifTimerMin, cRFHistorySwitchOverReason=cRFHistorySwitchOverReason, cRFStatusFailoverTime=cRFStatusFailoverTime, cRFHistorySwitchOverIndex=cRFHistorySwitchOverIndex, cRFStatusPeerUnitId=cRFStatusPeerUnitId, cRFStatusRFClientEntry=cRFStatusRFClientEntry, ciscoRFProgressionNotif=ciscoRFProgressionNotif, ciscoRFConfigRFOperModeGroup=ciscoRFConfigRFOperModeGroup, ciscoRFMIB=ciscoRFMIB, ciscoRFMIBComplianceRev3=ciscoRFMIBComplianceRev3, ciscoRFStatusClientGroup=ciscoRFStatusClientGroup, cRFStatusRFClientRedTime=cRFStatusRFClientRedTime, cRFStatusIssuStateRev1=cRFStatusIssuStateRev1, ciscoRFNotifGroup=ciscoRFNotifGroup, cRFCfgRedundancyMode=cRFCfgRedundancyMode, cRFStatusRFClientTable=cRFStatusRFClientTable, cRFHistoryCurrActiveUnitId=cRFHistoryCurrActiveUnitId, cRFCfg=cRFCfg, ciscoRFIssuStateObjGroupRev1=ciscoRFIssuStateObjGroupRev1, ciscoRFIssuStateNotif=ciscoRFIssuStateNotif, cRFCfgNotifTimerMax=cRFCfgNotifTimerMax, cRFHistoryTableMaxLength=cRFHistoryTableMaxLength)
