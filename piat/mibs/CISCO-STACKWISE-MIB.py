...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-STACKWISE-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:48:28 2019
...
Gauge32, NotificationType, Counter32, Unsigned32, Counter64, IpAddress, MibIdentifier, Bits, ModuleIdentity, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Counter32", "Unsigned32", "Counter64", "IpAddress", "MibIdentifier", "Bits", "ModuleIdentity", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("CISCO-STACKWISE-MIB", cswStackPowerPortNeighborMacAddress=cswStackPowerPortNeighborMacAddress, cswDistrStackPhyPortNbrsw=cswDistrStackPhyPortNbrsw, cswStackType=cswStackType, cswStackMemberRemoved=cswStackMemberRemoved, cswSwitchSoftwareImage=cswSwitchSoftwareImage, CswPowerStackMode=CswPowerStackMode, cswStackPortChange=cswStackPortChange, cswGlobals=cswGlobals, cswStackMismatch=cswStackMismatch, cswEnableIndividualStackNotifications=cswEnableIndividualStackNotifications, cswStackPowerPortInfoTable=cswStackPowerPortInfoTable, cswStackPowerMasterSwitchNum=cswStackPowerMasterSwitchNum, cswStackNewMaster=cswStackNewMaster, cswStackPortInfoTable=cswStackPortInfoTable, cswSwitchPoeDevicesHighPriority=cswSwitchPoeDevicesHighPriority, cswStackBandWidth=cswStackBandWidth, cswDSLindex=cswDSLindex, cswStackPowerPortName=cswStackPowerPortName, CswSwitchNumber=CswSwitchNumber, cswStackPowerInvalidTopology=cswStackPowerInvalidTopology, cswNotificationGroup=cswNotificationGroup, cswStackWiseMIBComplianceRev3=cswStackWiseMIBComplianceRev3, cscwStackPowerBudgetWarrning=cscwStackPowerBudgetWarrning, cswStackPowerMasterMacAddress=cswStackPowerMasterMacAddress, CswPowerStackType=CswPowerStackType, cswSwitchHwPriority=cswSwitchHwPriority, cswStackPortNeighbor=cswStackPortNeighbor, cswDistrStackLinkInfoEntry=cswDistrStackLinkInfoEntry, cswStackPowerNotificationGroup=cswStackPowerNotificationGroup, cswStackPowerILS=cswStackPowerILS, cswStackNewMember=cswStackNewMember, cswStackPortOperStatus=cswStackPortOperStatus, cswMIBNotifications=cswMIBNotifications, cswSwitchPowerAllocated=cswSwitchPowerAllocated, cswStackPowerStackNumber=cswStackPowerStackNumber, cswStackInfo=cswStackInfo, cswSwitchState=cswSwitchState, cswStackPowerPortOperStatus=cswStackPowerPortOperStatus, cswDistrStackPhyPortOperStatus=cswDistrStackPhyPortOperStatus, cswStackMemberToBeReloadedForUpgrade=cswStackMemberToBeReloadedForUpgrade, cswStackPowerUnbalancedPowerSupplies=cswStackPowerUnbalancedPowerSupplies, cswDistrStackLinkBundleOperStatus=cswDistrStackLinkBundleOperStatus, cswDistrStackPhyPort=cswDistrStackPhyPort, cswStatusGroupRev2=cswStatusGroupRev2, cswStackPowerPortStatusGroup=cswStackPowerPortStatusGroup, cswStackPowerSSLS=cswStackPowerSSLS, CswSwitchPriority=CswSwitchPriority, cswStackPowerPriorityConflict=cswStackPowerPriorityConflict, cswStackWiseMIBCompliances=cswStackWiseMIBCompliances, cswSwitchSwPriority=cswSwitchSwPriority, cswStackPowerInfo=cswStackPowerInfo, cswSwitchMacAddress=cswSwitchMacAddress, ciscoStackWiseMIBNotifs=ciscoStackWiseMIBNotifs, cswSwitchSystemPowerPriority=cswSwitchSystemPowerPriority, cswStackPowerPortInfoEntry=cswStackPowerPortInfoEntry, cswStackPowerPortOperStatusChanged=cswStackPowerPortOperStatusChanged, cswSwitchRole=cswSwitchRole, cswStackPowerStatusGroup=cswStackPowerStatusGroup, cswStackPowerName=cswStackPowerName, cswDistrStackLinkStatusGroup=cswDistrStackLinkStatusGroup, cswDistrStackPhyPortInfoEntry=cswDistrStackPhyPortInfoEntry, ciscoStackWiseMIBObjects=ciscoStackWiseMIBObjects, cswSwitchPowerCommited=cswSwitchPowerCommited, cswStackPowerAllocatedGroup=cswStackPowerAllocatedGroup, cswSwitchNumNextReload=cswSwitchNumNextReload, cswStackPowerInvalidOutputCurrent=cswStackPowerInvalidOutputCurrent, cswStatusGroupRev1=cswStatusGroupRev1, cswStackPowerGLS=cswStackPowerGLS, cswDistrStackPhyPortStatusGroup=cswDistrStackPhyPortStatusGroup, cswStatusGroup=cswStatusGroup, cswSwitchNumCurrent=cswSwitchNumCurrent, cswStackDomainNum=cswStackDomainNum, cswSwitchInfoEntry=cswSwitchInfoEntry, cswStackRingRedundant=cswStackRingRedundant, cswMaxSwitchNum=cswMaxSwitchNum, CswSwitchNumberOrZero=CswSwitchNumberOrZero, cswStackPowerPortIndex=cswStackPowerPortIndex, cswSwitchPoeDevicesLowPriority=cswSwitchPoeDevicesLowPriority, cswStackPowerInfoTable=cswStackPowerInfoTable, cswMaxSwitchConfigPriority=cswMaxSwitchConfigPriority, cswStackPortInfoEntry=cswStackPortInfoEntry, cswNotificationGroupSup1=cswNotificationGroupSup1, cswStackPowerPortLinkStatus=cswStackPowerPortLinkStatus, ciscoStackWiseMIB=ciscoStackWiseMIB, cswStackPowerVersionMismatch=cswStackPowerVersionMismatch, cswEnableStackNotifications=cswEnableStackNotifications, cswRingRedundant=cswRingRedundant, cswStackWiseMIBComplianceRev1=cswStackWiseMIBComplianceRev1, cswSwitchInfoTable=cswSwitchInfoTable, cswDistrStackLinkInfoTable=cswDistrStackLinkInfoTable, cswSwitchPowerBudget=cswSwitchPowerBudget, cswStackPowerPortNeighborSwitchNum=cswStackPowerPortNeighborSwitchNum, cswDistrStackPhyPortNbr=cswDistrStackPhyPortNbr, cswDistrStackPhyPortInfoTable=cswDistrStackPhyPortInfoTable, cswStackPowerInvalidInputCurrent=cswStackPowerInvalidInputCurrent, cswStackPowerPortLinkStatusChanged=cswStackPowerPortLinkStatusChanged, cswStackPowerNumMembers=cswStackPowerNumMembers, cswStackPowerMode=cswStackPowerMode, cswStackPowerUnderBudget=cswStackPowerUnderBudget, cswStackPowerInfoEntry=cswStackPowerInfoEntry, cswStackPowerEnableNotificationGroup=cswStackPowerEnableNotificationGroup, cswStackPowerSwitchStatusGroup=cswStackPowerSwitchStatusGroup, cswStackWiseMIBCompliance=cswStackWiseMIBCompliance, PYSNMP_MODULE_ID=ciscoStackWiseMIB, cswStackPowerPortOverCurrentThreshold=cswStackPowerPortOverCurrentThreshold, cswStackPowerSRLS=cswStackPowerSRLS, cswStackWiseMIBGroups=cswStackWiseMIBGroups, cswStackWiseMIBComplianceRev2=cswStackWiseMIBComplianceRev2, ciscoStackWiseMIBConform=ciscoStackWiseMIBConform, cswStackWiseMIBComplianceRev4=cswStackWiseMIBComplianceRev4, cswStackPowerUnderVoltage=cswStackPowerUnderVoltage, cswStackPowerType=cswStackPowerType, cswStackPowerInsufficientPower=cswStackPowerInsufficientPower)
