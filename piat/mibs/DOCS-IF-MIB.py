...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/DOCS-IF-MIB
...
Bits, transmission, TimeTicks, Unsigned32, MibIdentifier, Counter64, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, iso, ModuleIdentity, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "transmission", "TimeTicks", "Unsigned32", "MibIdentifier", "Counter64", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "iso", "ModuleIdentity", "IpAddress", "Counter32")
DisplayString, RowStatus, StorageType, MacAddress, TextualConvention, TimeInterval, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "StorageType", "MacAddress", "TextualConvention", "TimeInterval", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-IF-MIB", docsIfCmtsCmStatusMicroreflections=docsIfCmtsCmStatusMicroreflections, docsIfCmtsUpChnlCtrTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrTotalCntnReqDataMslots, docsIfCmStatusInvalidUcds=docsIfCmStatusInvalidUcds, docsIfCmStatusUCCFails=docsIfCmStatusUCCFails, docsIfDownChannelFrequency=docsIfDownChannelFrequency, TenthdBmV=TenthdBmV, docsIfBaseObjects=docsIfBaseObjects, docsIfCmtsChannelUtilizationEntry=docsIfCmtsChannelUtilizationEntry, docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtCollCntnInitMaintMslots, docsIfCmtsCmStatusDownChannelIfIndex=docsIfCmtsCmStatusDownChannelIfIndex, docsIfUpChannelPreEqEnable=docsIfUpChannelPreEqEnable, docsIfCmStatusEqualizationData=docsIfCmStatusEqualizationData, docsIfCmtsDownChnlCtrUsedBytes=docsIfCmtsDownChnlCtrUsedBytes, docsIfCmtsModScdmaInterleaverStepSize=docsIfCmtsModScdmaInterleaverStepSize, docsIfCmtsDownChnlCtrId=docsIfCmtsDownChnlCtrId, docsIfCmtsUpChnlCtrCollCntnInitMaintMslots=docsIfCmtsUpChnlCtrCollCntnInitMaintMslots, docsIfCmtsModScdmaSpreaderEnable=docsIfCmtsModScdmaSpreaderEnable, docsIfUpChannelRangingBackoffEnd=docsIfUpChannelRangingBackoffEnd, docsIfSigQEqualizationData=docsIfSigQEqualizationData, docsIfUpChannelScdmaFrameSize=docsIfUpChannelScdmaFrameSize, docsIfDownChannelStorageType=docsIfDownChannelStorageType, docsIfCmtsModScdmaSubframeCodes=docsIfCmtsModScdmaSubframeCodes, docsIfCmtsStatusInvalidRegReqs=docsIfCmtsStatusInvalidRegReqs, docsIfCmtsModulationTable=docsIfCmtsModulationTable, docsIfCmtsMacStorageType=docsIfCmtsMacStorageType, docsIfCmtsModScramblerSeed=docsIfCmtsModScramblerSeed, docsIfCmStatusInvalidMaps=docsIfCmStatusInvalidMaps, docsIfCmtsCmStatusHighResolutionTimingOffset=docsIfCmtsCmStatusHighResolutionTimingOffset, docsIfCmStatusUCCs=docsIfCmStatusUCCs, docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtTotalCntnInitMaintMslots, docsIfCmtsCmStatusIndex=docsIfCmtsCmStatusIndex, docsIfCmtsModPreambleType=docsIfCmtsModPreambleType, docsIfCmtsModTcmErrorCorrectionOn=docsIfCmtsModTcmErrorCorrectionOn, docsIfCmtsUpChnlCtrExtCollCntnMslots=docsIfCmtsUpChnlCtrExtCollCntnMslots, docsIfUpChannelStatus=docsIfUpChannelStatus, docsIfCmObjects=docsIfCmObjects, docsIfCmtsModMaxBurstSize=docsIfCmtsModMaxBurstSize, docsIfCmtsServiceCmStatusIndex=docsIfCmtsServiceCmStatusIndex, docsIfCmtsStatusT5Timeouts=docsIfCmtsStatusT5Timeouts, docsIfCmtsSyncInterval=docsIfCmtsSyncInterval, docsIfCmtsCmStatusValue=docsIfCmtsCmStatusValue, docsIfCmtsCmStatusExtUnerroreds=docsIfCmtsCmStatusExtUnerroreds, docsIfCmtsChannelUtIfType=docsIfCmtsChannelUtIfType, docsIfCmtsServiceTable=docsIfCmtsServiceTable, docsIfCmStatusDocsisOperMode=docsIfCmStatusDocsisOperMode, docsIfUpChannelType=docsIfUpChannelType, docsIfCmtsUpChnlCtrCollCntnReqMslots=docsIfCmtsUpChnlCtrCollCntnReqMslots, PYSNMP_MODULE_ID=docsIfMib, docsIfCmtsChannelUtilizationInterval=docsIfCmtsChannelUtilizationInterval, docsIfCmtsServiceId=docsIfCmtsServiceId, docsIfCmtsUcdInterval=docsIfCmtsUcdInterval, docsIfCmtsMacToCmEntry=docsIfCmtsMacToCmEntry, docsIfCmtsInsertionInterval=docsIfCmtsInsertionInterval, docsIfCmtsChannelUtId=docsIfCmtsChannelUtId, docsIfCmtsMaxServiceIds=docsIfCmtsMaxServiceIds, docsIfCmtsCmStatusMacAddress=docsIfCmtsCmStatusMacAddress, docsIfCmtsCmStatusSignalNoise=docsIfCmtsCmStatusSignalNoise, docsIfCmtsUpChannelCounterEntry=docsIfCmtsUpChannelCounterEntry, DocsisUpstreamType=DocsisUpstreamType, docsIfCmtsDownChnlCtrExtUsedBytes=docsIfCmtsDownChnlCtrExtUsedBytes, docsIfCmtsGroup=docsIfCmtsGroup, docsIfCmServiceTxSlotsDed=docsIfCmServiceTxSlotsDed, docsIfUpChannelTxTimingOffset=docsIfUpChannelTxTimingOffset, docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots=docsIfCmtsUpChnlCtrExtCollCntnReqDataMslots, docsIfCmtsInvitedRangingAttempts=docsIfCmtsInvitedRangingAttempts, docsIfCmtsModType=docsIfCmtsModType, docsIfUpChannelTxBackoffEnd=docsIfUpChannelTxBackoffEnd, docsIfSignalQualityEntry=docsIfSignalQualityEntry, docsIfQosProfStatus=docsIfQosProfStatus, docsIfCmCmtsAddress=docsIfCmCmtsAddress, TenthdB=TenthdB, docsIfCmStatusTxPower=docsIfCmStatusTxPower, docsIfMib=docsIfMib, docsIfCmServiceTable=docsIfCmServiceTable, docsIfCmServiceId=docsIfCmServiceId, docsIfCmGroupV2=docsIfCmGroupV2, docsIfDownstreamChannelEntry=docsIfDownstreamChannelEntry, docsIfCmServiceTxSlotsImmed=docsIfCmServiceTxSlotsImmed, docsIfCmtsCmStatusTable=docsIfCmtsCmStatusTable, docsIfCmCapabilities=docsIfCmCapabilities, docsIfQosProfMaxDownBandwidth=docsIfQosProfMaxDownBandwidth, docsIfCmtsStatusFailedRegReqs=docsIfCmtsStatusFailedRegReqs, docsIfUpChannelWidth=docsIfUpChannelWidth, docsIfCmtsCmStatusInetAddress=docsIfCmtsCmStatusInetAddress, docsIfCmtsModByteInterleaverBlockSize=docsIfCmtsModByteInterleaverBlockSize, docsIfCmtsUpChnlCtrExtTotalCntnReqMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqMslots, docsIfCmStatusT2Timeouts=docsIfCmStatusT2Timeouts, docsIfCmtsModIntervalUsageCode=docsIfCmtsModIntervalUsageCode, docsIfCmStatusRangingAborteds=docsIfCmStatusRangingAborteds, docsIfUpChannelFrequency=docsIfUpChannelFrequency, docsIfUpstreamChannelEntry=docsIfUpstreamChannelEntry, docsIfUpChannelCloneFrom=docsIfUpChannelCloneFrom, docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqDataMslots, docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrExtUsedCntnInitMaintMslots, docsIfCmtsCmStatusValueLastUpdate=docsIfCmtsCmStatusValueLastUpdate, docsIfCmtsModChannelType=docsIfCmtsModChannelType, docsIfCmtsUpChnlCtrUsedCntnReqMslots=docsIfCmtsUpChnlCtrUsedCntnReqMslots, docsIfCmRangingRespTimeout=docsIfCmRangingRespTimeout, docsIfSignalQualityTable=docsIfSignalQualityTable, docsIfCmtsCmStatusExtUncorrectables=docsIfCmtsCmStatusExtUncorrectables, DocsisVersion=DocsisVersion, docsIfDownChannelModulation=docsIfDownChannelModulation, docsIfCmtsUpChnlCtrTotalCntnReqMslots=docsIfCmtsUpChnlCtrTotalCntnReqMslots, docsIfCmMacEntry=docsIfCmMacEntry, docsIfCmServiceExtTxSlotsImmed=docsIfCmServiceExtTxSlotsImmed, docsIfSigQMicroreflections=docsIfSigQMicroreflections, docsIfCmtsModByteInterleaverDepth=docsIfCmtsModByteInterleaverDepth, docsIfCmtsUpChnlCtrId=docsIfCmtsUpChnlCtrId, docsIfCmtsServiceInOctets=docsIfCmtsServiceInOctets, docsIfCmtsCmStatusExtCorrecteds=docsIfCmtsCmStatusExtCorrecteds, docsIfCmtsCmStatusUnerroreds=docsIfCmtsCmStatusUnerroreds, docsIfQosProfPriority=docsIfQosProfPriority, docsIfUpChannelScdmaHoppingSeed=docsIfUpChannelScdmaHoppingSeed, docsIfSigQUnerroreds=docsIfSigQUnerroreds, docsIfCmtsChannelUtilizationTable=docsIfCmtsChannelUtilizationTable, docsIfUpChannelUpdate=docsIfUpChannelUpdate, docsIfCmServiceQosProfile=docsIfCmServiceQosProfile, docsIfCmtsUpChnlCtrUcastGrantedMslots=docsIfCmtsUpChnlCtrUcastGrantedMslots, docsIfCmtsStatusInvalidRangeReqs=docsIfCmtsStatusInvalidRangeReqs, docsIfCmtsMacToCmTable=docsIfCmtsMacToCmTable, DocsisQosVersion=DocsisQosVersion, docsIfCmtsModIndex=docsIfCmtsModIndex, docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots=docsIfCmtsUpChnlCtrTotalCntnInitMaintMslots, docsIfCmGroup=docsIfCmGroup, docsIfQosProfStorageType=docsIfQosProfStorageType, docsIfQosProfGuarUpBandwidth=docsIfQosProfGuarUpBandwidth, docsIfCmtsDownChnlCtrTotalBytes=docsIfCmtsDownChnlCtrTotalBytes, docsIfBasicGroupV2=docsIfBasicGroupV2, docsIfCmMacTable=docsIfCmMacTable, docsIfCmtsInsertInterval=docsIfCmtsInsertInterval, docsIfCmtsUpChnlCtrUsedCntnReqDataMslots=docsIfCmtsUpChnlCtrUsedCntnReqDataMslots, docsIfCmtsCmStatusRxPower=docsIfCmtsCmStatusRxPower, docsIfObsoleteGroup=docsIfObsoleteGroup, docsIfUpChannelTxBackoffStart=docsIfUpChannelTxBackoffStart, docsIfUpChannelScdmaActiveCodes=docsIfUpChannelScdmaActiveCodes, docsIfCmtsCmStatusEqualizationData=docsIfCmtsCmStatusEqualizationData, docsIfCmtsCmStatusDocsisRegMode=docsIfCmtsCmStatusDocsisRegMode, docsIfQosProfIndex=docsIfQosProfIndex, docsIfQosProfMaxTransmitBurst=docsIfQosProfMaxTransmitBurst, docsIfCmtsModStorageType=docsIfCmtsModStorageType, docsIfCmtsStatusInvalidDataReqs=docsIfCmtsStatusInvalidDataReqs, docsIfCmtsServiceInPackets=docsIfCmtsServiceInPackets, docsIfCmtsStatusRangingAborteds=docsIfCmtsStatusRangingAborteds, docsIfQosProfMaxUpBandwidth=docsIfQosProfMaxUpBandwidth, docsIfCmtsObjects=docsIfCmtsObjects, docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots=docsIfCmtsUpChnlCtrUsedCntnInitMaintMslots, docsIfUpChannelSlotSize=docsIfUpChannelSlotSize, docsIfCmServiceTxRetries=docsIfCmServiceTxRetries, docsIfCmStatusInvalidRangingResponses=docsIfCmStatusInvalidRangingResponses, docsIfCmtsUpChnlCtrExtTotalMslots=docsIfCmtsUpChnlCtrExtTotalMslots, docsIfCmtsUpChannelCounterTable=docsIfCmtsUpChannelCounterTable, docsIfCmtsStatusEntry=docsIfCmtsStatusEntry, docsIfQosProfBaselinePrivacy=docsIfQosProfBaselinePrivacy, docsIfCmStatusLostSyncs=docsIfCmStatusLostSyncs, docsIfCmtsModGuardTimeSize=docsIfCmtsModGuardTimeSize, docsIfCmStatusT3Timeouts=docsIfCmStatusT3Timeouts, docsIfQosProfMaxTxBurst=docsIfQosProfMaxTxBurst, docsIfCmtsCmStatusIpAddress=docsIfCmtsCmStatusIpAddress, docsIfCmtsModFECCodewordLength=docsIfCmtsModFECCodewordLength, docsIfSigQExtUncorrectables=docsIfSigQExtUncorrectables, docsIfGroups=docsIfGroups, docsIfSigQUncorrectables=docsIfSigQUncorrectables, docsIfCmServiceEntry=docsIfCmServiceEntry, docsIfCmtsDownChnlCtrExtTotalBytes=docsIfCmtsDownChnlCtrExtTotalBytes, docsIfUpChannelId=docsIfUpChannelId, docsIfCmServiceRqRetries=docsIfCmServiceRqRetries, docsIfCmtsUpChnlCtrExtUsedCntnReqMslots=docsIfCmtsUpChnlCtrExtUsedCntnReqMslots, docsIfCmtsCmMac=docsIfCmtsCmMac, docsIfCmtsMacEntry=docsIfCmtsMacEntry, docsIfCmtsModControl=docsIfCmtsModControl, docsIfCmStatusT4Timeouts=docsIfCmStatusT4Timeouts, docsIfCmtsServiceAdminStatus=docsIfCmtsServiceAdminStatus, docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots=docsIfCmtsUpChnlCtrExtTotalCntnReqDataMslots, docsIfCmStatusEntry=docsIfCmStatusEntry, docsIfDownChannelWidth=docsIfDownChannelWidth, docsIfCmServiceExtTxSlotsDed=docsIfCmServiceExtTxSlotsDed, docsIfCmtsDownChannelCounterEntry=docsIfCmtsDownChannelCounterEntry, docsIfCmStatusT1Timeouts=docsIfCmStatusT1Timeouts, docsIfNotification=docsIfNotification, docsIfSigQSignalNoise=docsIfSigQSignalNoise, docsIfCmStatusCode=docsIfCmStatusCode, docsIfCmStatusResets=docsIfCmStatusResets, docsIfCmtsModLastCodewordShortened=docsIfCmtsModLastCodewordShortened, docsIfCmtsUpChnlCtrExtTotalCntnMslots=docsIfCmtsUpChnlCtrExtTotalCntnMslots, docsIfBasicComplianceV2=docsIfBasicComplianceV2, docsIfCmtsServiceQosProfile=docsIfCmtsServiceQosProfile, docsIfMibObjects=docsIfMibObjects, docsIfUpChannelRangingBackoffStart=docsIfUpChannelRangingBackoffStart, docsIfCmtsCmStatusModulationType=docsIfCmtsCmStatusModulationType, docsIfDownChannelAnnex=docsIfDownChannelAnnex, docsIfCmStatusModulationType=docsIfCmStatusModulationType, docsIfCmtsUpChnlCtrTotalMslots=docsIfCmtsUpChnlCtrTotalMslots, docsIfSigQExtCorrecteds=docsIfSigQExtCorrecteds, docsIfSigQExtUnerroreds=docsIfSigQExtUnerroreds, docsIfCmtsUpChnlCtrExtCollCntnReqMslots=docsIfCmtsUpChnlCtrExtCollCntnReqMslots, DocsEqualizerData=DocsEqualizerData, docsIfCmtsCmPtr=docsIfCmtsCmPtr, docsIfCmtsServiceNewCmStatusIndex=docsIfCmtsServiceNewCmStatusIndex, docsIfCmtsServiceEntry=docsIfCmtsServiceEntry, docsIfCmStatusValue=docsIfCmStatusValue, docsIfSigQCorrecteds=docsIfSigQCorrecteds, docsIfBasicGroup=docsIfBasicGroup, docsIfCmRangingTimeout=docsIfCmRangingTimeout, docsIfQosProfileTable=docsIfQosProfileTable, docsIfCmtsCmStatusUpChannelIfIndex=docsIfCmtsCmStatusUpChannelIfIndex, docsIfSigQIncludesContention=docsIfSigQIncludesContention, docsIfCmtsCmStatusInetAddressType=docsIfCmtsCmStatusInetAddressType, docsIfCmtsModFECErrorCorrection=docsIfCmtsModFECErrorCorrection, docsIfCmStatusInvalidRegistrationResponses=docsIfCmStatusInvalidRegistrationResponses, docsIfCmtsUpChnlCtrCollCntnMslots=docsIfCmtsUpChnlCtrCollCntnMslots, docsIfDownstreamChannelTable=docsIfDownstreamChannelTable, docsIfUpstreamChannelTable=docsIfUpstreamChannelTable, docsIfBasicCompliance=docsIfBasicCompliance, docsIfDownChannelPower=docsIfDownChannelPower, docsIfCmServiceTxExceededs=docsIfCmServiceTxExceededs, docsIfDocsisBaseCapability=docsIfDocsisBaseCapability, docsIfCompliances=docsIfCompliances, docsIfCmtsQosProfilePermissions=docsIfCmtsQosProfilePermissions, docsIfCmStatusTable=docsIfCmStatusTable, docsIfCmtsCmStatusTimingOffset=docsIfCmtsCmStatusTimingOffset, docsIfCmtsCmStatusCorrecteds=docsIfCmtsCmStatusCorrecteds, docsIfCmtsCmStatusUncorrectables=docsIfCmtsCmStatusUncorrectables, docsIfConformance=docsIfConformance, docsIfCmtsUpChnlCtrUsedCntnMslots=docsIfCmtsUpChnlCtrUsedCntnMslots, docsIfCmtsModScrambler=docsIfCmtsModScrambler, docsIfUpChannelModulationProfile=docsIfUpChannelModulationProfile, docsIfCmtsUpChnlCtrTotalCntnMslots=docsIfCmtsUpChnlCtrTotalCntnMslots, docsIfCmtsModPreambleLen=docsIfCmtsModPreambleLen, docsIfCmtsModDifferentialEncoding=docsIfCmtsModDifferentialEncoding, docsIfCmtsCmStatusEntry=docsIfCmtsCmStatusEntry, docsIfCmtsUpChnlCtrExtUsedCntnMslots=docsIfCmtsUpChnlCtrExtUsedCntnMslots, docsIfCmtsDownChannelCounterTable=docsIfCmtsDownChannelCounterTable, docsIfCmtsCapabilities=docsIfCmtsCapabilities, docsIfUpChannelScdmaCodesPerSlot=docsIfUpChannelScdmaCodesPerSlot, docsIfCmtsStatusTable=docsIfCmtsStatusTable, docsIfCmtsUpChnlCtrExtUcastGrantedMslots=docsIfCmtsUpChnlCtrExtUcastGrantedMslots, docsIfDownChannelInterleave=docsIfDownChannelInterleave, docsIfCmtsUpChnlCtrCollCntnReqDataMslots=docsIfCmtsUpChnlCtrCollCntnReqDataMslots, docsIfCmtsGroupV2=docsIfCmtsGroupV2, docsIfQosProfileEntry=docsIfQosProfileEntry, docsIfCmtsMacTable=docsIfCmtsMacTable, docsIfCmtsChannelUtUtilization=docsIfCmtsChannelUtUtilization, docsIfCmtsModulationEntry=docsIfCmtsModulationEntry, docsIfCmServiceRqExceededs=docsIfCmServiceRqExceededs, docsIfDownChannelId=docsIfDownChannelId, docsIfCmtsServiceCreateTime=docsIfCmtsServiceCreateTime)
