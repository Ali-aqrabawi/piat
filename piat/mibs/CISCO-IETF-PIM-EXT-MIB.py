...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IETF-PIM-EXT-MIB
...
cPimCRPEntry, cPimInetMRouteNextHopEntry, cPimNbrEntry, cPimNbrAddressType, cPimNbrIfIndex, cPimIfStatus, cPimInetMRouteEntry, cPimNbrAddress, cPimIfEntry = mibBuilder.importSymbols("CISCO-IETF-PIM-MIB", "cPimCRPEntry", "cPimInetMRouteNextHopEntry", "cPimNbrEntry", "cPimNbrAddressType", "cPimNbrIfIndex", "cPimIfStatus", "cPimInetMRouteEntry", "cPimNbrAddress", "cPimIfEntry")
...
TimeTicks, iso, Counter32, IpAddress, NotificationType, ObjectIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Integer32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Counter32", "IpAddress", "NotificationType", "ObjectIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Integer32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-IETF-PIM-EXT-MIB", cpimExtMRouteOriginatorSRTTL=cpimExtMRouteOriginatorSRTTL, cpimExtStateRefreshInterval=cpimExtStateRefreshInterval, cpimExtBidirDFWinnerMetric=cpimExtBidirDFWinnerMetric, cpimExtRPSetPriority=cpimExtRPSetPriority, cpimExtMRouteNextHopJoinPruneTmr=cpimExtMRouteNextHopJoinPruneTmr, cpimExtMRouteNextHopTable=cpimExtMRouteNextHopTable, ciscoIetfPimExtNotifEnabledGroup=ciscoIetfPimExtNotifEnabledGroup, ciscoIetfPimExtNbrGroup=ciscoIetfPimExtNbrGroup, cpimExtIfSRCapable=cpimExtIfSRCapable, ciscoIetfPimExtMIB=ciscoIetfPimExtMIB, cpimExtIfGraftRetryInterval=cpimExtIfGraftRetryInterval, cpimExtRPMappingChangeNotifEnabled=cpimExtRPMappingChangeNotifEnabled, ciscoIetfPimExtRPMappingChange=ciscoIetfPimExtRPMappingChange, ciscoIetfPimExtMIBComplianceRev1=ciscoIetfPimExtMIBComplianceRev1, cpimExtNbrDRPresent=cpimExtNbrDRPresent, cpimExtRPSetHoldTime=cpimExtRPSetHoldTime, cpimExtIfSRTTLThreshold=cpimExtIfSRTTLThreshold, cpimExtNbrSecAddressTable=cpimExtNbrSecAddressTable, cpimExtNbrSecAddress=cpimExtNbrSecAddress, cpimExtRPSetGroupMask=cpimExtRPSetGroupMask, cpimExtIfTable=cpimExtIfTable, ciscoIetfPimExtNotificationGroup=ciscoIetfPimExtNotificationGroup, cpimExtIfJoinPruneHoldtime=cpimExtIfJoinPruneHoldtime, cpimExtNbrBidirCapable=cpimExtNbrBidirCapable, ciscoIetfPimExtMIBGroups=ciscoIetfPimExtMIBGroups, cpimExtBidirDFEntry=cpimExtBidirDFEntry, ciscoIetfPimExtNotifs=ciscoIetfPimExtNotifs, cpimExtNbrSRCapable=cpimExtNbrSRCapable, cpimExtIfDRPriority=cpimExtIfDRPriority, cpimExtRPSetRPActive=cpimExtRPSetRPActive, ciscoIetfPimExtMIBCompliance=ciscoIetfPimExtMIBCompliance, cpimExtStateRefreshLimitInterval=cpimExtStateRefreshLimitInterval, cpimExtMRouteNextHopAssertTimer=cpimExtMRouteNextHopAssertTimer, cpimExtRPSetAddrType=cpimExtRPSetAddrType, cpimExtRPSetProtocol=cpimExtRPSetProtocol, cpimExtBidirDFIfIndex=cpimExtBidirDFIfIndex, ciscoIetfPimExtBidirGroup=ciscoIetfPimExtBidirGroup, cpimExtBidirDFWnrMtrcPref=cpimExtBidirDFWnrMtrcPref, cpimExtIfPropagationDelay=cpimExtIfPropagationDelay, cpimExtIfLanDelayEnabled=cpimExtIfLanDelayEnabled, cpimExtBidirDFWinnerAddress=cpimExtBidirDFWinnerAddress, cpimExtBidirDFWinnerUptime=cpimExtBidirDFWinnerUptime, cpimExtCRPBidir=cpimExtCRPBidir, cpimExtRPSetComponent=cpimExtRPSetComponent, cpimExtIfGenerationID=cpimExtIfGenerationID, cpimExtMRouteNextHopEntry=cpimExtMRouteNextHopEntry, cpimExtMRouteSourceTimer=cpimExtMRouteSourceTimer, cpimExtNbrOverrideInterval=cpimExtNbrOverrideInterval, PYSNMP_MODULE_ID=ciscoIetfPimExtMIB, cpimExtRPSetGroupAddress=cpimExtRPSetGroupAddress, cpimExtIfMaxGraftRetries=cpimExtIfMaxGraftRetries, cpimExtIfHelloHoldtime=cpimExtIfHelloHoldtime, cpimExtNbrLANPruneDelay=cpimExtNbrLANPruneDelay, cpimExtNbrDRPriority=cpimExtNbrDRPriority, cpimExtNbrTBit=cpimExtNbrTBit, ciscoIetfPimExtMIBCompliances=ciscoIetfPimExtMIBCompliances, cpimExtIfTrigHelloInterval=cpimExtIfTrigHelloInterval, cpimExtIfLanPruneDelay=cpimExtIfLanPruneDelay, cpimExtBidirDFState=cpimExtBidirDFState, cpimExtIfEntry=cpimExtIfEntry, cpimExtCRPEntry=cpimExtCRPEntry, ciscoIetfPimExtGeneralGroup=ciscoIetfPimExtGeneralGroup, cpimExtMRouteTable=cpimExtMRouteTable, cpimExtBidirDFRPAddressType=cpimExtBidirDFRPAddressType, cpimExtRPSetExpiryTime=cpimExtRPSetExpiryTime, cpimExtNbrSecAddressEntry=cpimExtNbrSecAddressEntry, cpimExtSourceLifetime=cpimExtSourceLifetime, cpimExtRPSetEntry=cpimExtRPSetEntry, ciscoPimExt=ciscoPimExt, cpimExtRPSetType=cpimExtRPSetType, cpimExtStateRefreshTimeToLive=cpimExtStateRefreshTimeToLive, cpimExtBidirDFRPAddress=cpimExtBidirDFRPAddress, cpimExtMRouteNextHopAsrtMtrcPref=cpimExtMRouteNextHopAsrtMtrcPref, cpimExtMRouteNextHopAssertWinner=cpimExtMRouteNextHopAssertWinner, ciscoIetfPimExtInterfaceUp=ciscoIetfPimExtInterfaceUp, cpimExtMRouteBidirGroup=cpimExtMRouteBidirGroup, cpimExtBidirDFStateTimer=cpimExtBidirDFStateTimer, cpimExtMRouteRPFNeighbor=cpimExtMRouteRPFNeighbor, cpimExtCRPTable=cpimExtCRPTable, cpimExtRPSetAddress=cpimExtRPSetAddress, cpimExtMRouteEntry=cpimExtMRouteEntry, cpimExtIfOverrideInterval=cpimExtIfOverrideInterval, cpimExtRPSetTable=cpimExtRPSetTable, cpimExtInterfaceStateChangeNotifEnabled=cpimExtInterfaceStateChangeNotifEnabled, cpimExtBidirDFTable=cpimExtBidirDFTable, ciscoIetfPimExtMIBConformance=ciscoIetfPimExtMIBConformance, cpimExtIfBidirCapable=cpimExtIfBidirCapable, ciscoIetfPimExtMIBObjects=ciscoIetfPimExtMIBObjects, cpimExtIfBSRBorder=cpimExtIfBSRBorder, ciscoIetfPimExtNextHopGroup=ciscoIetfPimExtNextHopGroup, cpimExtNbrTable=cpimExtNbrTable, cpimExtNbrGenId=cpimExtNbrGenId, cpimExtNbrSecMask=cpimExtNbrSecMask, ciscoIetfPimExtInterfaceDown=ciscoIetfPimExtInterfaceDown, cpimExtNbrEntry=cpimExtNbrEntry, cpimExtMRouteNextHopAssertMetric=cpimExtMRouteNextHopAssertMetric)
