...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ZS-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:37:05 2019
...
iso, Integer32, Counter32, Gauge32, Counter64, ModuleIdentity, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Unsigned32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Counter32", "Gauge32", "Counter64", "ModuleIdentity", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Unsigned32", "Bits", "ObjectIdentity")
TextualConvention, TestAndIncr, TruthValue, TimeStamp, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TestAndIncr", "TruthValue", "TimeStamp", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CISCO-ZS-MIB", zoneSetActivateRowStatus=zoneSetActivateRowStatus, zoneSetEnforcedZoneListBmap8k=zoneSetEnforcedZoneListBmap8k, zoneTxChangeAccepts=zoneTxChangeAccepts, zoneVsanId=zoneVsanId, zoneMergeSuccessVSANNum=zoneMergeSuccessVSANNum, zoneConfigurationGroup2=zoneConfigurationGroup2, zoneSetLastChange=zoneSetLastChange, zoneDbHardZoningEnabled=zoneDbHardZoningEnabled, zoneNotificationControlGroup1=zoneNotificationControlGroup1, zoneTable=zoneTable, zoneAliasLastChange=zoneAliasLastChange, zoneMemberRowStatus=zoneMemberRowStatus, zoneDefaultZoneBroadcast=zoneDefaultZoneBroadcast, zoneSetZoneListBmap6k=zoneSetZoneListBmap6k, zoneSetFailCause=zoneSetFailCause, zoneSetPropagationEntry=zoneSetPropagationEntry, zoneEnforcedZoneMemberNumber=zoneEnforcedZoneMemberNumber, zoneEnforcedZoneMemberFormat=zoneEnforcedZoneMemberFormat, zoneTxGS3Rejects=zoneTxGS3Rejects, zoneLunStatsGroup=zoneLunStatsGroup, zoneDefaultZoneTable=zoneDefaultZoneTable, zoneMergeFailRecoverInterface=zoneMergeFailRecoverInterface, zoneLastChange=zoneLastChange, zoneDefaultZoneQosPriority=zoneDefaultZoneQosPriority, zoneServerMIBCompliances=zoneServerMIBCompliances, zoneStatsEntry=zoneStatsEntry, zoneEnforcedZoneSetNumber=zoneEnforcedZoneSetNumber, zoneMergeFailureVSANNum=zoneMergeFailureVSANNum, zoneServerMIBComplianceRev8=zoneServerMIBComplianceRev8, zoneEnforcedZoneAliasTable=zoneEnforcedZoneAliasTable, FcZoneServerRejReasonExpl=FcZoneServerRejReasonExpl, zoneEnforcedZoneSetTable=zoneEnforcedZoneSetTable, zoneNotificationGroup2Sup1=zoneNotificationGroup2Sup1, zoneRoZoneLunNum=zoneRoZoneLunNum, zoneMergeFailureObject=zoneMergeFailureObject, ZoneCopyProtocol=ZoneCopyProtocol, PYSNMP_MODULE_ID=ciscoZsMIB, zoneCopyServerAddr=zoneCopyServerAddr, zoneSetEnforcedZoneListBmap6k=zoneSetEnforcedZoneListBmap6k, zoneAliasTable=zoneAliasTable, zoneLunRxOtherCmds=zoneLunRxOtherCmds, zoneNotification=zoneNotification, zoneNotificationGroup1=zoneNotificationGroup1, zoneEnforcedZoneMemberTable=zoneEnforcedZoneMemberTable, zoneEnforcedZoneQos=zoneEnforcedZoneQos, zoneSetZoneListEntry=zoneSetZoneListEntry, zoneEntry=zoneEntry, zoneCompactTable=zoneCompactTable, zoneConfiguration=zoneConfiguration, zoneMergeSuccessNotifyEnable=zoneMergeSuccessNotifyEnable, zoneAliasMemberList=zoneAliasMemberList, zoneDefaultZoneEntry=zoneDefaultZoneEntry, zoneAliasEntry=zoneAliasEntry, zoneMemberEntry=zoneMemberEntry, zoneEnforcedZoneSetEntry=zoneEnforcedZoneSetEntry, zoneCompactEntry=zoneCompactEntry, zoneEnforcedZoneName=zoneEnforcedZoneName, zoneCopyTable=zoneCopyTable, zoneSetPropagationMode=zoneSetPropagationMode, zoneAliasIndex=zoneAliasIndex, ZoneFileType=ZoneFileType, zoneServiceRejReasonCode=zoneServiceRejReasonCode, zoneCopyStartCopy=zoneCopyStartCopy, zoneBroadcast=zoneBroadcast, zoneServerMIBComplianceRev2=zoneServerMIBComplianceRev2, zoneMemberID=zoneMemberID, zoneMergeFailRecoverVsan=zoneMergeFailRecoverVsan, zoneLunDstFcId=zoneLunDstFcId, zoneLunStatsTable=zoneLunStatsTable, zoneSwitchWwn=zoneSwitchWwn, zoneQos=zoneQos, zoneConfigurationGroup3=zoneConfigurationGroup3, zoneConfigurationGroup7=zoneConfigurationGroup7, zoneCopyRowStatus=zoneCopyRowStatus, zoneSetEnforcedZoneListBmap4k=zoneSetEnforcedZoneListBmap4k, zoneEnforcedZoneEntry=zoneEnforcedZoneEntry, zoneEnforcedZoneTable=zoneEnforcedZoneTable, zoneRxGS3Reqs=zoneRxGS3Reqs, zoneRoZoneTxDataProts=zoneRoZoneTxDataProts, zoneConfigurationGroup6=zoneConfigurationGroup6, zoneServiceRejReasonCodeExp=zoneServiceRejReasonCodeExp, zoneCopyProto=zoneCopyProto, zoneCopyActToFullMode=zoneCopyActToFullMode, zoneServerMIBComplianceRev5=zoneServerMIBComplianceRev5, zoneMemberTypeIndex=zoneMemberTypeIndex, zoneLunRxRepLunReqs=zoneLunRxRepLunReqs, zoneNotificationControlGroup=zoneNotificationControlGroup, zoneMergeFailureNotifyEnable=zoneMergeFailureNotifyEnable, zoneZoneSetDistributeVsan=zoneZoneSetDistributeVsan, zoneServerMIBComplianceRev4=zoneServerMIBComplianceRev4, zoneConfigurationGroup1=zoneConfigurationGroup1, ciscoZsMIB=ciscoZsMIB, zoneEnforcedZoneSetActivateTime=zoneEnforcedZoneSetActivateTime, zoneSetEnforcedZoneListTable=zoneSetEnforcedZoneListTable, zoneNotificationControlGroup1Sup2=zoneNotificationControlGroup1Sup2, zoneRxChangeReqs=zoneRxChangeReqs, zoneServiceReqRejNotify=zoneServiceReqRejNotify, zoneMergeFailRecoverSpinLock=zoneMergeFailRecoverSpinLock, zoneMemberTable=zoneMemberTable, ZoneMergeFailCause=ZoneMergeFailCause, zoneTxMergeReqs=zoneTxMergeReqs, zoneQosPriority=zoneQosPriority, zoneEnforcedZoneAliasNumber=zoneEnforcedZoneAliasNumber, zoneSetActivateTable=zoneSetActivateTable, zoneEnforcedZoneMemberList=zoneEnforcedZoneMemberList, zoneInformation=zoneInformation, zoneRoZoneStatsTable=zoneRoZoneStatsTable, zoneActivateNotify=zoneActivateNotify, zoneMemberList=zoneMemberList, zoneServiceReqRejNotifyEnable=zoneServiceReqRejNotifyEnable, zoneZoneSetDistributeResult=zoneZoneSetDistributeResult, zoneEnforcedZoneSetName=zoneEnforcedZoneSetName, zoneEnforcedZoneAliasName=zoneEnforcedZoneAliasName, zoneReadOnly=zoneReadOnly, zoneEnforcedZoneReadOnly=zoneEnforcedZoneReadOnly, zoneRxChangeAccepts=zoneRxChangeAccepts, zoneDbTable=zoneDbTable, zoneCopyUserPassword=zoneCopyUserPassword, zoneSetZoneListBmap4k=zoneSetZoneListBmap4k, zoneLunTxIllegalReqs=zoneLunTxIllegalReqs, zoneClone=zoneClone, zoneSetDeActivate=zoneSetDeActivate, zoneTotalGS3Rejects=zoneTotalGS3Rejects, zoneConfigGroupSup1=zoneConfigGroupSup1, zoneServerMIBConformance=zoneServerMIBConformance, zoneZoneSetDistributeFailReason=zoneZoneSetDistributeFailReason, zoneDbEntry=zoneDbEntry, zoneDefaultZoneQos=zoneDefaultZoneQos, zoneMemberFormat=zoneMemberFormat, zoneCopyActiveToFullOnVsan=zoneCopyActiveToFullOnVsan, zoneRoZoneStatsEntry=zoneRoZoneStatsEntry, zoneSetClone=zoneSetClone, zoneEnforcedZoneNumber=zoneEnforcedZoneNumber, zoneEnforcedZoneAliasMemberList=zoneEnforcedZoneAliasMemberList, zoneEnforcedZoneMemberID=zoneEnforcedZoneMemberID, zoneCopyActToFullSpinLock=zoneCopyActToFullSpinLock, zoneTxMergeAccepts=zoneTxMergeAccepts, zoneMergeFailureReason=zoneMergeFailureReason, zoneLunStatsEntry=zoneLunStatsEntry, zoneDefZoneBehvrChngNotifyEnable=zoneDefZoneBehvrChngNotifyEnable, zoneSetIndex=zoneSetIndex, zoneServerMIBCompliance=zoneServerMIBCompliance, zoneConfigGroupSup2=zoneConfigGroupSup2, zoneEnforcedZoneAliasList=zoneEnforcedZoneAliasList, zoneMemberIndex=zoneMemberIndex, zoneServerMIBComplianceRev3=zoneServerMIBComplianceRev3, zoneSetZoneListTable=zoneSetZoneListTable, zoneUnsuppMemInIntOpModeNotify=zoneUnsuppMemInIntOpModeNotify, zoneCopyEntry=zoneCopyEntry, zoneCopyServerAddrType=zoneCopyServerAddrType, zoneConfigurationGroup4=zoneConfigurationGroup4, zoneLunTxInqDataNoLus=zoneLunTxInqDataNoLus, zoneSetActivate=zoneSetActivate, zoneSetEntry=zoneSetEntry, zoneCopyActToFullVsan=zoneCopyActToFullVsan, FcList=FcList, zoneServerMIBGroups=zoneServerMIBGroups, zoneSetFailDomId=zoneSetFailDomId, zoneAliasRowStatus=zoneAliasRowStatus, zoneNotifications=zoneNotifications, zoneName=zoneName, zoneEnforcedZoneBroadcast=zoneEnforcedZoneBroadcast, zoneStatisticsGroup=zoneStatisticsGroup, zoneMergeFailureNotify=zoneMergeFailureNotify, zoneRxMergeAccepts=zoneRxMergeAccepts, zoneMemberParentIndex=zoneMemberParentIndex, zoneCompactVsan=zoneCompactVsan, zoneSetTable=zoneSetTable, zoneSetZoneList=zoneSetZoneList, zoneDefaultZoneBehaviour=zoneDefaultZoneBehaviour, zoneDefZoneBehaviourChngNotify=zoneDefZoneBehaviourChngNotify, zoneLunRxSenseReqs=zoneLunRxSenseReqs, zoneRoZoneDstFcId=zoneRoZoneDstFcId, zoneCopyDestFileName=zoneCopyDestFileName, zoneLunNum=zoneLunNum, ciscoZoningMIBObjects=ciscoZoningMIBObjects, zoneSetEnforcedZoneListEntry=zoneSetEnforcedZoneListEntry, zoneTxChangeReqs=zoneTxChangeReqs, zoneEnforcedZoneAliasEntry=zoneEnforcedZoneAliasEntry, zoneCompactNotify=zoneCompactNotify, zoneUnsuppMemInIntOpNotifyEnable=zoneUnsuppMemInIntOpNotifyEnable, zoneServerMIBCompliance1=zoneServerMIBCompliance1, zoneCopyDestFileType=zoneCopyDestFileType, zoneConfigurationGroup5=zoneConfigurationGroup5, zoneStatsTable=zoneStatsTable, zoneSetName=zoneSetName, zoneStats=zoneStats, zoneSetZoneListBmap8k=zoneSetZoneListBmap8k, zoneMemberLunID=zoneMemberLunID, zoneAliasNumber=zoneAliasNumber, zoneMergeFailRecoverResult=zoneMergeFailRecoverResult, zoneNotificationGroup=zoneNotificationGroup, zoneSetActivateEntry=zoneSetActivateEntry, zoneEnforcedZoneMemberEntry=zoneEnforcedZoneMemberEntry, zoneRoZoneSrcFcId=zoneRoZoneSrcFcId, zoneRxMergeReqs=zoneRxMergeReqs, zoneAliasList=zoneAliasList, zoneCopyState=zoneCopyState, zoneEnforcedZoneActivateTime=zoneEnforcedZoneActivateTime, zoneNotificationGroup2=zoneNotificationGroup2, zoneIndex=zoneIndex, zoneLunSrcFcId=zoneLunSrcFcId, zoneAliasName=zoneAliasName, zoneEnforcedZoneQosPriority=zoneEnforcedZoneQosPriority, zoneEnforcedZoneSetZoneList=zoneEnforcedZoneSetZoneList, zoneCopyUserName=zoneCopyUserName, zoneAliasClone=zoneAliasClone, zoneMemberNumber=zoneMemberNumber, zoneSetActivateResult=zoneSetActivateResult, zoneDbClearDb=zoneDbClearDb, ZoneQosPriorityLevel=ZoneQosPriorityLevel, zoneSetPropagationTable=zoneSetPropagationTable, zoneSetRowStatus=zoneSetRowStatus, zoneRowStatus=zoneRowStatus, zoneMergeFailRecoverOper=zoneMergeFailRecoverOper, zoneDbEnforcedEqualsLocal=zoneDbEnforcedEqualsLocal, zoneCompactFirst2k=zoneCompactFirst2k, zoneConfigurationGroup=zoneConfigurationGroup, zoneNotificationControlGroup1Sup1=zoneNotificationControlGroup1Sup1, FcChangeProtoFailCause=FcChangeProtoFailCause, zoneSetNumber=zoneSetNumber, ZoneMemberType=ZoneMemberType, zoneEnforcedZoneMemberLunID=zoneEnforcedZoneMemberLunID, zoneLunRxInqReqs=zoneLunRxInqReqs, zoneMergeSuccessNotify=zoneMergeSuccessNotify, zoneServerMIBComplianceRev6=zoneServerMIBComplianceRev6, zoneNumber=zoneNumber, zoneServerMIBComplianceRev7=zoneServerMIBComplianceRev7, zoneDefaultZoneReadOnly=zoneDefaultZoneReadOnly)
