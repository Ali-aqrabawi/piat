...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-C8500-REDUNDANCY-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:26:15 2019
...
TimeTicks, Integer32, Unsigned32, ModuleIdentity, NotificationType, IpAddress, Counter64, ObjectIdentity, iso, Bits, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Unsigned32", "ModuleIdentity", "NotificationType", "IpAddress", "Counter64", "ObjectIdentity", "iso", "Bits", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-C8500-REDUNDANCY-MIB", ciscoC8500RedundancyMIB=ciscoC8500RedundancyMIB, RedundancySlotIndex=RedundancySlotIndex, ciscoC8500RedundancyMIBObjects=ciscoC8500RedundancyMIBObjects, ccrForceCounterSync=ccrForceCounterSync, ccrCpu=ccrCpu, ccrDesiredSwitchBw=ccrDesiredSwitchBw, ciscoC8500RedundancyMIBConformance=ciscoC8500RedundancyMIBConformance, ccrSwitchLastSwitchoverTime=ccrSwitchLastSwitchoverTime, ccrSwitchBw=ccrSwitchBw, ccrVcCounterSyncFreq=ccrVcCounterSyncFreq, RedundancyMode=RedundancyMode, ccrSwitchLastSwitchoverReason=ccrSwitchLastSwitchoverReason, ccrCpuTable=ccrCpuTable, ccrCpuSwitchoverTime=ccrCpuSwitchoverTime, ccrCpuStatusChange=ccrCpuStatusChange, RedundancyStatus=RedundancyStatus, ccrCpuMibGroup=ccrCpuMibGroup, ccrSwitchMibGroup=ccrSwitchMibGroup, ciscoC8500RedundancyMIBNotificationPrefix=ciscoC8500RedundancyMIBNotificationPrefix, ccrCpuMode=ccrCpuMode, ciscoC8500RedundancyMIBComplianceRev1=ciscoC8500RedundancyMIBComplianceRev1, ccrSwitchSlotIndex=ccrSwitchSlotIndex, ccrCpuStatus=ccrCpuStatus, ccrCpuSlotIndex=ccrCpuSlotIndex, ccrCpuStandbyEnableMode=ccrCpuStandbyEnableMode, ccrIfCounterSyncFreq=ccrIfCounterSyncFreq, ccrSwitchMode=ccrSwitchMode, ccrSwitchModeChange=ccrSwitchModeChange, ccrMIBNotifications=ccrMIBNotifications, ccrSwitchEntry=ccrSwitchEntry, PYSNMP_MODULE_ID=ciscoC8500RedundancyMIB, ccrSwitchStatusChange=ccrSwitchStatusChange, ccrCpuMibGroup1=ccrCpuMibGroup1, ccrSwitchStatus=ccrSwitchStatus, ccrSigCounterSyncEnable=ccrSigCounterSyncEnable, ciscoC8500RedundancyMIBGroups=ciscoC8500RedundancyMIBGroups, ccrSwitchTable=ccrSwitchTable, ccrNotificationsGroup=ccrNotificationsGroup, ccrSyncConfigOnSet=ccrSyncConfigOnSet, ciscoC8500RedundancyMIBCompliances=ciscoC8500RedundancyMIBCompliances, ciscoC8500RedundancyMIBCompliance=ciscoC8500RedundancyMIBCompliance, ccrCpuEntry=ccrCpuEntry, ccrSwitch=ccrSwitch)
