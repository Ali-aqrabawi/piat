...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-UNIFIED-FIREWALL-MIB
...
dot1dTpFdbStatus, dot1dTpFdbPort = mibBuilder.importSymbols("BRIDGE-MIB", "dot1dTpFdbStatus", "dot1dTpFdbPort")
CFWPolicyTargetType, CFWPolicyTarget, CFWApplicationProtocol, CFWNetworkProtocol, CFWUrlfVendorId, CFWUrlServerStatus, CFWPolicy = mibBuilder.importSymbols("CISCO-FIREWALL-TC", "CFWPolicyTargetType", "CFWPolicyTarget", "CFWApplicationProtocol", "CFWNetworkProtocol", "CFWUrlfVendorId", "CFWUrlServerStatus", "CFWPolicy")
...
mibBuilder.exportSymbols("CISCO-UNIFIED-FIREWALL-MIB", cufwPolAppConnNumSetupsAborted=cufwPolAppConnNumSetupsAborted, ciscoFwTransparentNotifGroup=ciscoFwTransparentNotifGroup, cufwL2GlobalEnableStealthMode=cufwL2GlobalEnableStealthMode, cufwAaicGlobalNumBadPDUSize=cufwAaicGlobalNumBadPDUSize, cufwConnGlobalNumResDeclined=cufwConnGlobalNumResDeclined, cufwAppConnNumAborted=cufwAppConnNumAborted, cufwAppConnNumPolicyDeclined=cufwAppConnNumPolicyDeclined, cuFwConnectionGrp=cuFwConnectionGrp, cufwUrlfServerTable=cufwUrlfServerTable, cufwConnNumPolicyDeclined=cufwConnNumPolicyDeclined, cufwConnSetupRate5=cufwConnSetupRate5, ciscoFwApplInspectionGroup=ciscoFwApplInspectionGroup, cufwInspectionTable=cufwInspectionTable, cufwUrlfRequestsNumCacheDenied=cufwUrlfRequestsNumCacheDenied, cufwPolConnNumSetupsAborted=cufwPolConnNumSetupsAborted, cufwPolAppConnNumActive=cufwPolAppConnNumActive, ciscoFwNotificationsGroup=ciscoFwNotificationsGroup, cufwL2GlobalNumBadArpResponses=cufwL2GlobalNumBadArpResponses, cufwConnReptAppStats=cufwConnReptAppStats, cufwConnGlobalNumAttempted=cufwConnGlobalNumAttempted, cufwConnSummaryEntry=cufwConnSummaryEntry, cufwUrlfServerPort=cufwUrlfServerPort, cufwConnGlobalNumActive=cufwConnGlobalNumActive, cufwInspectionEntry=cufwInspectionEntry, cufwAaicHttpNumBadProtocolOps=cufwAaicHttpNumBadProtocolOps, ciscoUniFirewallMIBGroups=ciscoUniFirewallMIBGroups, cufwUrlFilterGlobals=cufwUrlFilterGlobals, cufwConnReptAppStatsLastChanged=cufwConnReptAppStatsLastChanged, cuFwConnectionSummaryTables=cuFwConnectionSummaryTables, cufwConnGlobalNumEmbryonic=cufwConnGlobalNumEmbryonic, ciscoUnifiedFirewallMIBObjects=ciscoUnifiedFirewallMIBObjects, cufwConnSummaryTable=cufwConnSummaryTable, ciscoUFwUrlfServerStateChange=ciscoUFwUrlfServerStateChange, cufwConnNumAborted=cufwConnNumAborted, cufwPolConnNumAborted=cufwPolConnNumAborted, ciscoUnifiedFirewallMIBNotifs=ciscoUnifiedFirewallMIBNotifs, cufwConnGlobalNumExpired=cufwConnGlobalNumExpired, cufwConnNumAttempted=cufwConnNumAttempted, cufwAaicHttpNumLargeURIs=cufwAaicHttpNumLargeURIs, cufwPolicyConnSummaryEntry=cufwPolicyConnSummaryEntry, cufwPolConnNumAttempted=cufwPolConnNumAttempted, cufwAppConnNumSetupsAborted=cufwAppConnNumSetupsAborted, cuFwUrlFilterGrp=cuFwUrlFilterGrp, cufwConnResHOConnMemoryUsage=cufwConnResHOConnMemoryUsage, cufwUrlfRequestsDeniedRate5=cufwUrlfRequestsDeniedRate5, cufwPolAppConnPolicy=cufwPolAppConnPolicy, cufwPolAppConnNumHalfOpen=cufwPolAppConnNumHalfOpen, cufwUrlfUrlAccRespsNumResDropped=cufwUrlfUrlAccRespsNumResDropped, cufwUrlfServerRespsNumReceived=cufwUrlfServerRespsNumReceived, cufwAaicHttpNumBadPDUSize=cufwAaicHttpNumBadPDUSize, cufwL2GlobalEnableArpInspection=cufwL2GlobalEnableArpInspection, cufwInspectionPolicyName=cufwInspectionPolicyName, cufwAppConnNumActive=cufwAppConnNumActive, cufwUrlfRequestsProcRate5=cufwUrlfRequestsProcRate5, cuFwConnectionResources=cuFwConnectionResources, cuFwL2FwGrp=cuFwL2FwGrp, cufwUrlfServerNumRetries=cufwUrlfServerNumRetries, cufwAppConnNumAttempted=cufwAppConnNumAttempted, cufwConnGlobalNumPolicyDeclined=cufwConnGlobalNumPolicyDeclined, cufwUrlfResponsesNumLate=cufwUrlfResponsesNumLate, cufwUrlfServerReqsNumAllowed=cufwUrlfServerReqsNumAllowed, cufwAppConnNumResDeclined=cufwAppConnNumResDeclined, cufwConnNumHalfOpen=cufwConnNumHalfOpen, PYSNMP_MODULE_ID=ciscoUnifiedFirewallMIB, cufwUrlfNumServerTimeouts=cufwUrlfNumServerTimeouts, cufwCntlL2StaticMacAddressMoved=cufwCntlL2StaticMacAddressMoved, cufwUrlfRequestsNumDenied=cufwUrlfRequestsNumDenied, ciscoUniFirewallMIBCompliance=ciscoUniFirewallMIBCompliance, cuFwApplInspectionGrp=cuFwApplInspectionGrp, cufwConnNumResDeclined=cufwConnNumResDeclined, cufwUrlfRequestsDeniedRate1=cufwUrlfRequestsDeniedRate1, cufwAaicHttpProtocolStats=cufwAaicHttpProtocolStats, cufwAaicGlobalNumBadProtocolOps=cufwAaicGlobalNumBadProtocolOps, cufwL2GlobalNumDrops=cufwL2GlobalNumDrops, cufwPolAppConnNumPolicyDeclined=cufwPolAppConnNumPolicyDeclined, cufwPolConnNumHalfOpen=cufwPolConnNumHalfOpen, cufwPolConnNumResDeclined=cufwPolConnNumResDeclined, cufwPolicyConnSummaryTable=cufwPolicyConnSummaryTable, cufwL2GlobalNumSpoofedArpResps=cufwL2GlobalNumSpoofedArpResps, cufwUrlfAllowModeReqNumDenied=cufwUrlfAllowModeReqNumDenied, cufwPolConnProtocol=cufwPolConnProtocol, ciscoFwAaicHttpGroup=ciscoFwAaicHttpGroup, cuFwConnectionReportSettings=cuFwConnectionReportSettings, cufwAaicHttpNumBadContent=cufwAaicHttpNumBadContent, cufwL2FwGlobals=cufwL2FwGlobals, cufwAaicGlobalNumBadPortRange=cufwAaicGlobalNumBadPortRange, cufwUrlfAllowModeReqNumAllowed=cufwUrlfAllowModeReqNumAllowed, cufwPolConnPolicyTargetType=cufwPolConnPolicyTargetType, cuFwConnectionGlobals=cuFwConnectionGlobals, cufwConnProtocol=cufwConnProtocol, cufwUrlfRequestsNumProcessed=cufwUrlfRequestsNumProcessed, cufwUrlfRequestsNumAllowed=cufwUrlfRequestsNumAllowed, ciscoFwMibReportingControlGroup=ciscoFwMibReportingControlGroup, cufwUrlFilterResourceUsage=cufwUrlFilterResourceUsage, cufwL2GlobalNumFloods=cufwL2GlobalNumFloods, cufwUrlfRequestsProcRate1=cufwUrlfRequestsProcRate1, cufwAaicHttpNumDoubleEncodedPkts=cufwAaicHttpNumDoubleEncodedPkts, ciscoUnifiedFirewallMIBConform=ciscoUnifiedFirewallMIBConform, cufwUrlfServerReqsNumDenied=cufwUrlfServerReqsNumDenied, cufwConnGlobalNumHalfOpen=cufwConnGlobalNumHalfOpen, cufwAaicHttpNumTunneledConns=cufwAaicHttpNumTunneledConns, ciscoFwBasicAaicGroup=ciscoFwBasicAaicGroup, cufwConnSetupRate1=cufwConnSetupRate1, cufwPolicyAppConnSummaryEntry=cufwPolicyAppConnSummaryEntry, cufwConnGlobalNumAborted=cufwConnGlobalNumAborted, cuFwAaicGrp=cuFwAaicGrp, cufwPolConnPolicyTarget=cufwPolConnPolicyTarget, cufwAaicProtocolStats=cufwAaicProtocolStats, ciscoFwConnResourceUsageGroup=ciscoFwConnResourceUsageGroup, cufwConnGlobalNumRemoteAccess=cufwConnGlobalNumRemoteAccess, cufwUrlfServerReqsNumProcessed=cufwUrlfServerReqsNumProcessed, cufwUrlfNumServerRetries=cufwUrlfNumServerRetries, cufwUrlfServerVendor=cufwUrlfServerVendor, cufwPolAppConnNumAttempted=cufwPolAppConnNumAttempted, ciscoFwPolicyConnectionGroup=ciscoFwPolicyConnectionGroup, cufwUrlfRequestsNumCacheAllowed=cufwUrlfRequestsNumCacheAllowed, cufwUrlfResTotalRequestCacheSize=cufwUrlfResTotalRequestCacheSize, cufwCntlUrlfServerStatusChange=cufwCntlUrlfServerStatusChange, cufwConnGlobalConnSetupRate5=cufwConnGlobalConnSetupRate5, cufwAppConnSummaryEntry=cufwAppConnSummaryEntry, cufwAIAlertEnabled=cufwAIAlertEnabled, ciscoUFwL2StaticMacAddressMoved=ciscoUFwL2StaticMacAddressMoved, ciscoUniFirewallMIBCompliances=ciscoUniFirewallMIBCompliances, cufwAppConnProtocol=cufwAppConnProtocol, cufwUrlFilterServers=cufwUrlFilterServers, cufwInspectionProtocol=cufwInspectionProtocol, cufwUrlfRequestsResDropRate1=cufwUrlfRequestsResDropRate1, cufwUrlfServerAvgRespTime1=cufwUrlfServerAvgRespTime1, cufwUrlfServerRespsNumLate=cufwUrlfServerRespsNumLate, ciscoUnifiedFirewallMIB=ciscoUnifiedFirewallMIB, cufwPolConnNumPolicyDeclined=cufwPolConnNumPolicyDeclined, cufwPolAppConnPolicyTargetType=cufwPolAppConnPolicyTargetType, ciscoFwTransparentFwGroup=ciscoFwTransparentFwGroup, cufwPolAppConnNumAborted=cufwPolAppConnNumAborted, cufwConnNumSetupsAborted=cufwConnNumSetupsAborted, cufwConnGlobalNumSetupsAborted=cufwConnGlobalNumSetupsAborted, cufwAppConnSetupRate5=cufwAppConnSetupRate5, cufwUrlfRequestsResDropRate5=cufwUrlfRequestsResDropRate5, ciscoFwUrlFilterResourceGroup=ciscoFwUrlFilterResourceGroup, cuFwFailoverGrp=cuFwFailoverGrp, cufwPolAppConnNumResDeclined=cufwPolAppConnNumResDeclined, ciscoFwUrlFilterGroup=ciscoFwUrlFilterGroup, cufwUrlfServerStatus=cufwUrlfServerStatus, cufwPolConnNumActive=cufwPolConnNumActive, cufwConnGlobalConnSetupRate1=cufwConnGlobalConnSetupRate1, cufwPolicyAppConnSummaryTable=cufwPolicyAppConnSummaryTable, cufwAIAuditTrailEnabled=cufwAIAuditTrailEnabled, cufwAppConnSetupRate1=cufwAppConnSetupRate1, cufwConnResEmbrConnMemoryUsage=cufwConnResEmbrConnMemoryUsage, cufwL2GlobalNumArpRequests=cufwL2GlobalNumArpRequests, cufwUrlfRequestsNumResDropped=cufwUrlfRequestsNumResDropped, cufwUrlfServerNumTimeouts=cufwUrlfServerNumTimeouts, cufwAppConnNumHalfOpen=cufwAppConnNumHalfOpen, cufwL2GlobalArpCacheSize=cufwL2GlobalArpCacheSize, cufwConnResMemoryUsage=cufwConnResMemoryUsage, cufwAaicGlobals=cufwAaicGlobals, cufwPolAppConnProtocol=cufwPolAppConnProtocol, cufwInspectionStatus=cufwInspectionStatus, cufwL2GlobalArpOverflowRate5=cufwL2GlobalArpOverflowRate5, cufwUrlfFunctionEnabled=cufwUrlfFunctionEnabled, cufwConnNumActive=cufwConnNumActive, cuFwNotifCntlGrp=cuFwNotifCntlGrp, cufwUrlfServerEntry=cufwUrlfServerEntry, cufwPolConnPolicy=cufwPolConnPolicy, cufwPolAppConnPolicyTarget=cufwPolAppConnPolicyTarget, cufwUrlfResTotalRespCacheSize=cufwUrlfResTotalRespCacheSize, cufwUrlfServerAddrType=cufwUrlfServerAddrType, ciscoFwConnectionGroup=ciscoFwConnectionGroup, cufwConnResActiveConnMemoryUsage=cufwConnResActiveConnMemoryUsage, cufwUrlfServerAddress=cufwUrlfServerAddress, cufwAaicHttpNumMismatchContent=cufwAaicHttpNumMismatchContent, cufwL2GlobalNumIcmpRequests=cufwL2GlobalNumIcmpRequests, cufwAppConnSummaryTable=cufwAppConnSummaryTable, cufwUrlfServerAvgRespTime5=cufwUrlfServerAvgRespTime5)
