...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-SCSI-MIB
...
IpAddress, Integer32, Bits, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Gauge32, Unsigned32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Bits", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Gauge32", "Unsigned32", "Counter32", "ObjectIdentity")
AutonomousType, DisplayString, TimeStamp, TruthValue, RowStatus, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("CISCO-SCSI-MIB", ciscoScsiCompliances=ciscoScsiCompliances, ciscoScsiLuStatus=ciscoScsiLuStatus, ciscoScsiTgtPortInCommands=ciscoScsiTgtPortInCommands, ciscoScsiTgtPortHSInCommands=ciscoScsiTgtPortHSInCommands, ciscoScsiLunMapRowStatus=ciscoScsiLunMapRowStatus, ciscoScsiDscLunIdIndex=ciscoScsiDscLunIdIndex, ciscoScsiTranportSPI=ciscoScsiTranportSPI, ciscoScsiLuIdValue=ciscoScsiLuIdValue, ciscoScsiTgtDevEntry=ciscoScsiTgtDevEntry, ciscoScsiTgtPortEntry=ciscoScsiTgtPortEntry, ciscoScsiLunMapIndex=ciscoScsiLunMapIndex, ciscoScsiTrnsptIndex=ciscoScsiTrnsptIndex, ciscoScsiIntrPrtOutCommands=ciscoScsiIntrPrtOutCommands, ciscoScsiTransportFCP=ciscoScsiTransportFCP, ciscoScsiLuInResets=ciscoScsiLuInResets, ciscoScsiTargetGroup=ciscoScsiTargetGroup, ciscoScsiIntrPrtName=ciscoScsiIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ciscoScsiAttTgtPortIndex=ciscoScsiAttTgtPortIndex, ciscoScsiTargetHSStatsGroup=ciscoScsiTargetHSStatsGroup, ciscoScsiDscTgtEntry=ciscoScsiDscTgtEntry, ciscoScsiLuEntry=ciscoScsiLuEntry, ciscoScsiNotifications=ciscoScsiNotifications, ciscoScsiLunMapHSStatsGroup=ciscoScsiLunMapHSStatsGroup, ciscoScsiAttIntrPrtTable=ciscoScsiAttIntrPrtTable, ciscoScsiDscLunIdCodeSet=ciscoScsiDscLunIdCodeSet, ciscoScsiAttIntrPrtName=ciscoScsiAttIntrPrtName, ciscoScsiNotification=ciscoScsiNotification, ciscoScsiLuPeripheralType=ciscoScsiLuPeripheralType, ciscoScsiAttIntrPrtEntry=ciscoScsiAttIntrPrtEntry, ciscoScsiTransportSRP=ciscoScsiTransportSRP, ciscoScsiDeviceStatGroup=ciscoScsiDeviceStatGroup, ciscoScsiIntrDevAccMode=ciscoScsiIntrDevAccMode, ciscoScsiDeviceResets=ciscoScsiDeviceResets, ciscoScsiInstVendorVersion=ciscoScsiInstVendorVersion, ciscoScsiInitiator=ciscoScsiInitiator, ScsiDeviceOrPort=ScsiDeviceOrPort, ciscoScsiAuthIntrIndex=ciscoScsiAuthIntrIndex, ciscoScsiDscTgtInCommands=ciscoScsiDscTgtInCommands, ciscoScsiTgtPortTable=ciscoScsiTgtPortTable, ScsiIdValue=ScsiIdValue, ciscoScsiTrnsptEntry=ciscoScsiTrnsptEntry, ciscoScsiDiscoveryGroup=ciscoScsiDiscoveryGroup, ciscoScsiIntrPrtEntry=ciscoScsiIntrPrtEntry, ciscoScsiIntrPrtReadMegaBytes=ciscoScsiIntrPrtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdAssociation=ScsiIdAssociation, ciscoScsiAuthorizedIntrTable=ciscoScsiAuthorizedIntrTable, ciscoScsiLuProductId=ciscoScsiLuProductId, ciscoScsiCompliance=ciscoScsiCompliance, ciscoScsiLuReadMegaBytes=ciscoScsiLuReadMegaBytes, ciscoScsiLuWrittenMegaBytes=ciscoScsiLuWrittenMegaBytes, ciscoScsiObjects=ciscoScsiObjects, ciscoScsiLuHSInCommands=ciscoScsiLuHSInCommands, ScsiName=ScsiName, ciscoScsiInstAlias=ciscoScsiInstAlias, ciscoScsiDeviceTable=ciscoScsiDeviceTable, ciscoScsiLuState=ciscoScsiLuState, ciscoScsiLuIndex=ciscoScsiLuIndex, ciscoScsiAttTgtPortIdentifier=ciscoScsiAttTgtPortIdentifier, ciscoScsiLuIdEntry=ciscoScsiLuIdEntry, ciscoScsiConformance=ciscoScsiConformance, ScsiIdentifier=ScsiIdentifier, ciscoScsiTgtDevNonAccLUs=ciscoScsiTgtDevNonAccLUs, ciscoScsiAuthIntrOutCommands=ciscoScsiAuthIntrOutCommands, ciscoScsiAttIntrPrtAuthIntrIdx=ciscoScsiAttIntrPrtAuthIntrIdx, ciscoScsiTgtPortName=ciscoScsiTgtPortName, ciscoScsiAttTgtPortName=ciscoScsiAttTgtPortName, ciscoScsiLuWwnName=ciscoScsiLuWwnName, ciscoScsiInitiatorStatsGroup=ciscoScsiInitiatorStatsGroup, ciscoScsiDeviceEntry=ciscoScsiDeviceEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ciscoScsiPortRole=ciscoScsiPortRole, ScsiNameIdOrZero=ScsiNameIdOrZero, ciscoScsiRemoteInitiators=ciscoScsiRemoteInitiators, ciscoScsiDscLunIdEntry=ciscoScsiDscLunIdEntry, ciscoScsiTgtDevTable=ciscoScsiTgtDevTable, ciscoScsiAttTgtPortDscTgtIdx=ciscoScsiAttTgtPortDscTgtIdx, ciscoScsiDiscoveryStatsGroup=ciscoScsiDiscoveryStatsGroup, ciscoScsiAuthIntrName=ciscoScsiAuthIntrName, ciscoScsiDscTgtDevOrPort=ciscoScsiDscTgtDevOrPort, ciscoScsiDiscoveryHSStatsGroup=ciscoScsiDiscoveryHSStatsGroup, ciscoScsiIntrPrtWrMegaBytes=ciscoScsiIntrPrtWrMegaBytes, ciscoScsiPortTable=ciscoScsiPortTable, ciscoScsiDeviceGroup=ciscoScsiDeviceGroup, ciscoScsiAttIntrPrtId=ciscoScsiAttIntrPrtId, ciscoScsiInstIndex=ciscoScsiInstIndex, ciscoScsiTranportOther=ciscoScsiTranportOther, ciscoScsiLuOutQueueFullStatus=ciscoScsiLuOutQueueFullStatus, ciscoScsiTargetStatsGroup=ciscoScsiTargetStatsGroup, ciscoScsiAuthIntrLunMapIndex=ciscoScsiAuthIntrLunMapIndex, ciscoScsiAuthIntrAttachedTimes=ciscoScsiAuthIntrAttachedTimes, ciscoScsiDscTgtDiscovered=ciscoScsiDscTgtDiscovered, ciscoScsiTgtDeviceStatus=ciscoScsiTgtDeviceStatus, ciscoScsiAuthIntrDevOrPort=ciscoScsiAuthIntrDevOrPort, ciscoScsiLuIdIndex=ciscoScsiLuIdIndex, ciscoScsiInstNotifEnable=ciscoScsiInstNotifEnable, ciscoScsiInstSoftwareIndex=ciscoScsiInstSoftwareIndex, ciscoScsiPortIndex=ciscoScsiPortIndex, ciscoScsiDscTgtRowStatus=ciscoScsiDscTgtRowStatus, ciscoScsiLuDefaultLun=ciscoScsiLuDefaultLun, PYSNMP_MODULE_ID=ciscoScsiMIB, ciscoScsiAuthIntrRowStatus=ciscoScsiAuthIntrRowStatus, ciscoScsiTransportTypes=ciscoScsiTransportTypes, ciscoScsiLuIdType=ciscoScsiLuIdType, ciscoScsiTrnsptPointer=ciscoScsiTrnsptPointer, ciscoScsiPortBusyStatuses=ciscoScsiPortBusyStatuses, ciscoScsiIntrPrtHSOutCommands=ciscoScsiIntrPrtHSOutCommands, ciscoScsiAttTgtPortTable=ciscoScsiAttTgtPortTable, ciscoScsiInstanceTable=ciscoScsiInstanceTable, ciscoScsiIntrPrtIdentifier=ciscoScsiIntrPrtIdentifier, ciscoScsiDscLunIdValue=ciscoScsiDscLunIdValue, ciscoScsiTgtDevStatusChanged=ciscoScsiTgtDevStatusChanged, ciscoScsiRemoteTarget=ciscoScsiRemoteTarget, ciscoScsiAuthIntrWrMegaBytes=ciscoScsiAuthIntrWrMegaBytes, ciscoScsiDscLunIdAssociation=ciscoScsiDscLunIdAssociation, ciscoScsiPortTrnsptPtr=ciscoScsiPortTrnsptPtr, ciscoScsiDscLunLun=ciscoScsiDscLunLun, ciscoScsiLunMapLun=ciscoScsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, ciscoScsiLuRevisionId=ciscoScsiLuRevisionId, ciscoScsiTransportSBP=ciscoScsiTransportSBP, ciscoScsiAuthIntrLastCreation=ciscoScsiAuthIntrLastCreation, ciscoScsiDeviceIndex=ciscoScsiDeviceIndex, ciscoScsiLunMapLuIndex=ciscoScsiLunMapLuIndex, ciscoScsiDscLunEntry=ciscoScsiDscLunEntry, ciscoScsiTarget=ciscoScsiTarget, ScsiIndexValue=ScsiIndexValue, ciscoScsiLuInCommands=ciscoScsiLuInCommands, ciscoScsiDscTgtHSInCommands=ciscoScsiDscTgtHSInCommands, ciscoScsiDevicePortNumber=ciscoScsiDevicePortNumber, ciscoScsiLunMapStatsGroup=ciscoScsiLunMapStatsGroup, ScsiIdType=ScsiIdType, ciscoScsiAuthIntrHSOutCommands=ciscoScsiAuthIntrHSOutCommands, ciscoScsiGeneral=ciscoScsiGeneral, ciscoScsiTrnsptDevName=ciscoScsiTrnsptDevName, ciscoScsiLunMapTable=ciscoScsiLunMapTable, ciscoScsiGroups=ciscoScsiGroups, ciscoScsiIntrPrtTable=ciscoScsiIntrPrtTable, ciscoScsiLuTable=ciscoScsiLuTable, ciscoScsiAttIntrPrtIdx=ciscoScsiAttIntrPrtIdx, ciscoScsiDscTgtLastCreation=ciscoScsiDscTgtLastCreation, ciscoScsiTgtPortReadMegaBytes=ciscoScsiTgtPortReadMegaBytes, ciscoScsiDscTgtWrMegaBytes=ciscoScsiDscTgtWrMegaBytes, ciscoScsiDscLunIndex=ciscoScsiDscLunIndex, ciscoScsiTransportISCSI=ciscoScsiTransportISCSI, ciscoScsiInstanceEntry=ciscoScsiInstanceEntry, ciscoScsiDscLunTable=ciscoScsiDscLunTable, ciscoScsiDscTgtName=ciscoScsiDscTgtName, ciscoScsiIntrDevOutResets=ciscoScsiIntrDevOutResets, ciscoScsiIntrDevTable=ciscoScsiIntrDevTable, ciscoScsiDscLunIdType=ciscoScsiDscLunIdType, ciscoScsiLuIdAssociation=ciscoScsiLuIdAssociation, ciscoScsiAttTgtPortEntry=ciscoScsiAttTgtPortEntry, ciscoScsiLuIdTable=ciscoScsiLuIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ciscoScsiPortEntry=ciscoScsiPortEntry, ciscoScsiTrnsptTable=ciscoScsiTrnsptTable, ciscoScsiAuthorizedIntrEntry=ciscoScsiAuthorizedIntrEntry, ciscoScsiLuIdCodeSet=ciscoScsiLuIdCodeSet, ciscoScsiInitiatorHSStatsGroup=ciscoScsiInitiatorHSStatsGroup, ciscoScsiDscTgtConfigured=ciscoScsiDscTgtConfigured, ciscoScsiLogicalUnit=ciscoScsiLogicalUnit, ciscoScsiAuthIntrTgtPortIndex=ciscoScsiAuthIntrTgtPortIndex, ciscoScsiDscTgtTable=ciscoScsiDscTgtTable, ciscoScsiLunMapEntry=ciscoScsiLunMapEntry, ciscoScsiInitiatorGroup=ciscoScsiInitiatorGroup, ciscoScsiLunMapGroup=ciscoScsiLunMapGroup, ciscoScsiDscTgtIntrPortIndex=ciscoScsiDscTgtIntrPortIndex, ciscoScsiDscLunIdTable=ciscoScsiDscLunIdTable, ciscoScsiLuStatusChanged=ciscoScsiLuStatusChanged, ciscoScsiIntrDevEntry=ciscoScsiIntrDevEntry, ciscoScsiTgtPortIdentifier=ciscoScsiTgtPortIdentifier, ciscoScsiTgtPortWrMegaBytes=ciscoScsiTgtPortWrMegaBytes, ciscoScsiNotifGroup=ciscoScsiNotifGroup, ciscoScsiDscTgtReadMegaBytes=ciscoScsiDscTgtReadMegaBytes, ciscoScsiLuVendorId=ciscoScsiLuVendorId, ciscoScsiAuthIntrReadMegaBytes=ciscoScsiAuthIntrReadMegaBytes, ciscoScsiDeviceRole=ciscoScsiDeviceRole, ciscoScsiTrnsptType=ciscoScsiTrnsptType, ciscoScsiDscTgtIndex=ciscoScsiDscTgtIndex, ciscoScsiMIB=ciscoScsiMIB, ciscoScsiTgtDevNumberOfLUs=ciscoScsiTgtDevNumberOfLUs, ciscoScsiDeviceAlias=ciscoScsiDeviceAlias)
