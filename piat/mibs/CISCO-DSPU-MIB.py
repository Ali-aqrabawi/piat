...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DSPU-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:39:52 2019
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, NotificationType, Unsigned32, IpAddress, Bits, MibIdentifier, ModuleIdentity, Counter32, ObjectIdentity, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "NotificationType", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "ModuleIdentity", "Counter32", "ObjectIdentity", "Counter64", "iso")
...
mibBuilder.exportSymbols("CISCO-DSPU-MIB", dspuLuOperSessionState=dspuLuOperSessionState, dspuSapDlcPort=dspuSapDlcPort, dspuLuGroupV11R01=dspuLuGroupV11R01, dspuPoolClassOperUpStreamLuDefs=dspuPoolClassOperUpStreamLuDefs, dspuPuStatsEntry=dspuPuStatsEntry, dspuPuAdminDlcUnit=dspuPuAdminDlcUnit, dspuLuOperPoolClassName=dspuLuOperPoolClassName, dspuPuTraps=dspuPuTraps, dspuLuAdminLuLocalAddress=dspuLuAdminLuLocalAddress, dspuPuOperName=dspuPuOperName, dspuLuAdminEntry=dspuLuAdminEntry, dspuPuStatsActiveLus=dspuPuStatsActiveLus, dspuPuAdminDlcPort=dspuPuAdminDlcPort, dspuPooledLu=dspuPooledLu, dspuPuAdminIndex=dspuPuAdminIndex, dspuPoolClassName=dspuPoolClassName, dspuSap=dspuSap, dspuLuOperLastActivationFailureReason=dspuLuOperLastActivationFailureReason, dspuPuStatsLastActivationFailureReason=dspuPuStatsLastActivationFailureReason, dspuPoolClassTable=dspuPoolClassTable, dspuLuOperState=dspuLuOperState, dspuNodeLastConfigChgTime=dspuNodeLastConfigChgTime, dspuPuStatsSentNegativeRsps=dspuPuStatsSentNegativeRsps, dspuPuAdminLinkRetryCount=dspuPuAdminLinkRetryCount, dspuPooledLuTable=dspuPooledLuTable, dspuPuAdminLocalSapAddress=dspuPuAdminLocalSapAddress, dspuPuAdminMaxIframe=dspuPuAdminMaxIframe, dspuPuOperWindowSize=dspuPuOperWindowSize, dspuPoolClass=dspuPoolClass, dspuLuAdminPoolClassName=dspuLuAdminPoolClassName, dspuLuAdminRowStatus=dspuLuAdminRowStatus, dspuLuOperEntry=dspuLuOperEntry, dspuPuStateChangeTrap=dspuPuStateChangeTrap, dspuPuOperFocalPoint=dspuPuOperFocalPoint, dspuNode=dspuNode, dspuPuAdminName=dspuPuAdminName, dspuNodeRsrbLocalVirtualRing=dspuNodeRsrbLocalVirtualRing, dspuPuAdminLinkRetryTimeout=dspuPuAdminLinkRetryTimeout, dspuPooledLuPeerPuIndex=dspuPooledLuPeerPuIndex, dspuPuOperRemoteSapAddress=dspuPuOperRemoteSapAddress, dspuLuOperType=dspuLuOperType, dspuPuAdminEntry=dspuPuAdminEntry, dspuPuAdminRemoteAddress=dspuPuAdminRemoteAddress, ciscoDspuMIB=ciscoDspuMIB, newdspuLuStateChangeTrap=newdspuLuStateChangeTrap, dspuSapOperState=dspuSapOperState, dspuPuAdminWindowSize=dspuPuAdminWindowSize, dspuLuAdminPeerLuLocalAddress=dspuLuAdminPeerLuLocalAddress, dspuNodeRsrbBridgeNumber=dspuNodeRsrbBridgeNumber, dspuPuOperLinkRetryCount=dspuPuOperLinkRetryCount, dspuLuAdminTable=dspuLuAdminTable, dspuPuAdminDlcType=dspuPuAdminDlcType, dspuLuOperPeerLuLocalAddress=dspuLuOperPeerLuLocalAddress, dspuSapDlcType=dspuSapDlcType, dspuNodeRsrbVirtualMacAddress=dspuNodeRsrbVirtualMacAddress, dspuPuGroupV11R01=dspuPuGroupV11R01, dspuPuOperStartTime=dspuPuOperStartTime, dspuPuOperXid=dspuPuOperXid, dspuLuStateChangeTrap=dspuLuStateChangeTrap, dspuPuOperTable=dspuPuOperTable, dspuPuTrapsPrefix=dspuPuTrapsPrefix, dspuPoolClassOperDnStreamLuDefs=dspuPoolClassOperDnStreamLuDefs, dspuPuStatsBindLus=dspuPuStatsBindLus, dspuSapGroup=dspuSapGroup, dspuNodeRsrbTargetVirtualRing=dspuNodeRsrbTargetVirtualRing, dspuSapStateChangeTrap=dspuSapStateChangeTrap, dspuLuActivationFailureTrap=dspuLuActivationFailureTrap, dspuPuStatsSentFrames=dspuPuStatsSentFrames, dspuPuOperLocalSapAddress=dspuPuOperLocalSapAddress, dspuSapAddress=dspuSapAddress, dspuPuOperState=dspuPuOperState, dspuSapEntry=dspuSapEntry, dspuLuAdminType=dspuLuAdminType, dspuLuOperTable=dspuLuOperTable, dspuPuStatsRcvdBytes=dspuPuStatsRcvdBytes, dspuPooledLuPeerLuLocalAddress=dspuPooledLuPeerLuLocalAddress, dspuPuAdminStartPu=dspuPuAdminStartPu, dspuPuOperLastStateChgTime=dspuPuOperLastStateChgTime, dspuPuOperDlcPort=dspuPuOperDlcPort, dspuNodeGroup=dspuNodeGroup, dspuPoolClassInactivityTimeout=dspuPoolClassInactivityTimeout, ciscoDspuMIBComplianceV11R01=ciscoDspuMIBComplianceV11R01, dspuPuOperFsmState=dspuPuOperFsmState, dspuPooledLuEntry=dspuPooledLuEntry, dspuPuActivationFailureTrap=dspuPuActivationFailureTrap, dspuPuAdminFocalPoint=dspuPuAdminFocalPoint, dspuSapDlcUnit=dspuSapDlcUnit, dspuPuAdminXidFmt=dspuPuAdminXidFmt, dspuLuTraps=dspuLuTraps, dspuPoolClassEntry=dspuPoolClassEntry, dspuPuStatsRcvdNegativeRsps=dspuPuStatsRcvdNegativeRsps, dspuPuStatsRcvdFrames=dspuPuStatsRcvdFrames, dspuPuOperIndex=dspuPuOperIndex, dspuLuOperPeerPuIndex=dspuLuOperPeerPuIndex, ciscoDspuMIBCompliances=ciscoDspuMIBCompliances, dspuPuAdminRemoteMacAddress=dspuPuAdminRemoteMacAddress, dspuPuOperEntry=dspuPuOperEntry, ciscoDspuMIBCompliance=ciscoDspuMIBCompliance, ciscoDspuMIBConformance=ciscoDspuMIBConformance, dspuPuOperStartPu=dspuPuOperStartPu, dspuLuTrapsPrefix=dspuLuTrapsPrefix, dspuPuOperRemoteAddress=dspuPuOperRemoteAddress, dspuPuOperType=dspuPuOperType, dspuSapTable=dspuSapTable, dspuPuOperDlcUnit=dspuPuOperDlcUnit, dspuPoolClassGroup=dspuPoolClassGroup, dspuSapRowStatus=dspuSapRowStatus, dspuPuAdminTable=dspuPuAdminTable, dspuLuGroup=dspuLuGroup, dspuSapTraps=dspuSapTraps, dspuPuGroup=dspuPuGroup, dspuPooledLuGroup=dspuPooledLuGroup, dspuLuAdminPeerPuIndex=dspuLuAdminPeerPuIndex, dspuPu=dspuPu, dspuPuAdminRemoteSapAddress=dspuPuAdminRemoteSapAddress, dspuPuAdminXid=dspuPuAdminXid, dspuNodeDefaultPuWindowSize=dspuNodeDefaultPuWindowSize, dspuNodeRsrb=dspuNodeRsrb, dspuPuStatsTable=dspuPuStatsTable, dspuSapType=dspuSapType, dspuPuOperDlcType=dspuPuOperDlcType, dspuNodeActivationWindow=dspuNodeActivationWindow, newdspuPuStateChangeTrap=newdspuPuStateChangeTrap, dspuPoolClassIndex=dspuPoolClassIndex, dspuNodeDefaultPu=dspuNodeDefaultPu, dspuPuOperRemoteMacAddress=dspuPuOperRemoteMacAddress, PYSNMP_MODULE_ID=ciscoDspuMIB, dspuPuStatsSentBytes=dspuPuStatsSentBytes, dspuLuOperFsmState=dspuLuOperFsmState, dspuPuOperLinkRetryTimeout=dspuPuOperLinkRetryTimeout, ciscoDspuMIBGroups=ciscoDspuMIBGroups, dspuLu=dspuLu, dspuLuOperLuLocalAddress=dspuLuOperLuLocalAddress, dspuPuStatsActivationFailures=dspuPuStatsActivationFailures, dspuPuAdminType=dspuPuAdminType, dspuPuOperMaxIframe=dspuPuOperMaxIframe, dspuPuStatsInactiveLus=dspuPuStatsInactiveLus, dspuNodeDefaultPuMaxIframe=dspuNodeDefaultPuMaxIframe, newdspuPuActivationFailureTrap=newdspuPuActivationFailureTrap, dspuObjects=dspuObjects, dspuPuOperXidFmt=dspuPuOperXidFmt, dspuPuAdminRowStatus=dspuPuAdminRowStatus)
