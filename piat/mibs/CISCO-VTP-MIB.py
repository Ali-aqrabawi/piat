...
# Produced by pysmi-0.3.4 at Sun Apr 21 23:41:10 2019
...
MibIdentifier, Gauge32, Counter32, IpAddress, NotificationType, ModuleIdentity, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, iso, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "Counter32", "IpAddress", "NotificationType", "ModuleIdentity", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "Bits")
TestAndIncr, RowStatus, TimeStamp, DateAndTime, TruthValue, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "RowStatus", "TimeStamp", "DateAndTime", "TruthValue", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", managementDomainTftpPathname=managementDomainTftpPathname, vtpVlanEntry=vtpVlanEntry, vtpVlanIfIndex=vtpVlanIfIndex, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, managementDomainPruningState=managementDomainPruningState, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vlanTrunkPortActiveVlansGroup=vlanTrunkPortActiveVlansGroup, vlanTrunkPortVlansActiveFirst2k=vlanTrunkPortVlansActiveFirst2k, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpStats=vtpStats, vtpInAdvertRequests=vtpInAdvertRequests, vtpVlanTable=vtpVlanTable, vtpMaxVlanStorage=vtpMaxVlanStorage, vtpVlanEditStpType=vtpVlanEditStpType, vtpAuthEntry=vtpAuthEntry, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vtpOutAdvertRequests=vtpOutAdvertRequests, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vlanStatsGroup=vlanStatsGroup, vtpConfigNotificationsGroup6=vtpConfigNotificationsGroup6, vtpInSubsetAdverts=vtpInSubsetAdverts, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, managementDomainDeviceID=managementDomainDeviceID, vtpVlanLocalShutdownGroup=vtpVlanLocalShutdownGroup, managementDomainTable=managementDomainTable, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpConfigDigestError=vtpConfigDigestError, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vtpDeviceIdGroup=vtpDeviceIdGroup, vtpEditControlEntry=vtpEditControlEntry, vlanTrunkPortVlansActiveSecond2k=vlanTrunkPortVlansActiveSecond2k, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpVlanEditState=vtpVlanEditState, vlanStatistics=vlanStatistics, vtpVlanStpType=vtpVlanStpType, vlanTrunkPortTable=vlanTrunkPortTable, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, vlanEdit=vlanEdit, vtpLocalModeChanged=vtpLocalModeChanged, vtpAuthPasswordType=vtpAuthPasswordType, ciscoVtpMIB=ciscoVtpMIB, managementDomainOperSrcIf=managementDomainOperSrcIf, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpDatabaseName=vtpDatabaseName, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpDatabaseGroup=vtpDatabaseGroup, vtpDiscoverAction=vtpDiscoverAction, vlanStatsFreeVlans=vlanStatsFreeVlans, vtpVersion2BasicGroup=vtpVersion2BasicGroup, VlanIndex=VlanIndex, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vlanStatsVlans=vlanStatsVlans, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpVlanCreated=vtpVlanCreated, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpVlanEditOperation=vtpVlanEditOperation, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpMIBCompliance4=vtpMIBCompliance4, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vtpAuthGroup=vtpAuthGroup, vtpVlanTypeExt=vtpVlanTypeExt, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpTrunkPortGroup=vtpTrunkPortGroup, vtpNotificationsObjects=vtpNotificationsObjects, vtpVlanEditMtu=vtpVlanEditMtu, vtpVlanParentVlan=vtpVlanParentVlan, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpDatabaseEntry=vtpDatabaseEntry, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpConfigNotificationsGroup8=vtpConfigNotificationsGroup8, vtpSourceInterfaceGroup=vtpSourceInterfaceGroup, managementDomainSourceOnlyMode=managementDomainSourceOnlyMode, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, managementDomainLocalMode=managementDomainLocalMode, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, VlanType=VlanType, internalVlanInfo=internalVlanInfo, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpDatabase=vtpDatabase, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpVlanLocalShutdownTable=vtpVlanLocalShutdownTable, vtpVlanEditName=vtpVlanEditName, managementDomainPruningStateOper=managementDomainPruningStateOper, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, managementDomainName=managementDomainName, managementDomainEntry=managementDomainEntry, vtpVlanDot10Said=vtpVlanDot10Said, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vtpMIBCompliance15=vtpMIBCompliance15, vtpTrunkPruningGroup3=vtpTrunkPruningGroup3, vtpMIBCompliance6=vtpMIBCompliance6, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, PYSNMP_MODULE_ID=ciscoVtpMIB, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpNotificationsPrefix=vtpNotificationsPrefix, managementDomainRowStatus=managementDomainRowStatus, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpMIBCompliances=vtpMIBCompliances, vtpDiscoverGroup=vtpDiscoverGroup, vtpInternalVlanGrp=vtpInternalVlanGrp, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpMIBCompliance=vtpMIBCompliance, vtpVlanIndex=vtpVlanIndex, vlanInfo=vlanInfo, vtpDiscoverResultTable=vtpDiscoverResultTable, managementDomainLastChange=managementDomainLastChange, vtpMIBCompliance14=vtpMIBCompliance14, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vtpVlanLocalShutdown=vtpVlanLocalShutdown, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, vtpMIBCompliance5=vtpMIBCompliance5, vtpStatsEntry=vtpStatsEntry, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vtpVlanRingNumber=vtpVlanRingNumber, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpMIBCompliance16=vtpMIBCompliance16, vtpStatsGroup=vtpStatsGroup, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vtpMtuTooBig=vtpMtuTooBig, vtpAuthenticationTable=vtpAuthenticationTable, vtpVlanEditIndex=vtpVlanEditIndex, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vtpDiscoverTable=vtpDiscoverTable, managementDomainIndex=managementDomainIndex, managementDomainLocalUpdater=managementDomainLocalUpdater, vtpVlanName=vtpVlanName, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpAuthSecretKey=vtpAuthSecretKey, vtpVlanAreHopCount=vtpVlanAreHopCount, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, managementDomainConfigRevNumber=managementDomainConfigRevNumber, managementDomainLocalUpdaterType=managementDomainLocalUpdaterType, vtpMIBCompliance2=vtpMIBCompliance2, vtpMIBCompliance3=vtpMIBCompliance3, vtpLocalUpdaterGroup=vtpLocalUpdaterGroup, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpMIBCompliance9=vtpMIBCompliance9, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vtpVlanEditType=vtpVlanEditType, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpMIBCompliance11=vtpMIBCompliance11, vlanManagementDomains=vlanManagementDomains, vtpDiscover=vtpDiscover, managementDomainConfigFile=managementDomainConfigFile, vtp4kVlanGroup=vtp4kVlanGroup, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtpServerDisabled=vtpServerDisabled, vtpVlanLocalShutdownEntry=vtpVlanLocalShutdownEntry, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpDiscoverEntry=vtpDiscoverEntry, vtpConfigFileGroup=vtpConfigFileGroup, vtpVlanType=vtpVlanType, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpVersion=vtpVersion, vtpPruningStateOperChange=vtpPruningStateOperChange, vtpAuthPassword=vtpAuthPassword, vtpMIBConformance=vtpMIBConformance, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpVlanEditRingNumber=vtpVlanEditRingNumber, ManagementDomainIndex=ManagementDomainIndex, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vtpVlanMtu=vtpVlanMtu, vtpEditControlTable=vtpEditControlTable, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpVlanSteHopCount=vtpVlanSteHopCount, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vtpVlanDeleted=vtpVlanDeleted, vlanStatsExtendedVlans=vlanStatsExtendedVlans, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vlanStatsInternalVlans=vlanStatsInternalVlans, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpVlanBridgeType=vtpVlanBridgeType, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpMIBCompliance13=vtpMIBCompliance13, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpStatus=vtpStatus, vlanTrunkPorts=vlanTrunkPorts, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpConfigNotificationsGroup7=vtpConfigNotificationsGroup7, managementDomainVersionInUse=managementDomainVersionInUse, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpInternalVlanTable=vtpInternalVlanTable, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpNotifications=vtpNotifications, vtpDatabaseIndex=vtpDatabaseIndex, vtpMIBObjects=vtpMIBObjects, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpMIBCompliance8=vtpMIBCompliance8, vtpMIBCompliance10=vtpMIBCompliance10, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpAuthentication=vtpAuthentication, managementDomainAdminSrcIf=managementDomainAdminSrcIf, vtpDiscoverStatus=vtpDiscoverStatus, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpBasicGroup=vtpBasicGroup, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpVlanEditDot10Said=vtpVlanEditDot10Said, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpVlanEditTable=vtpVlanEditTable, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpMIBCompliance12=vtpMIBCompliance12, vtpMIBCompliance7=vtpMIBCompliance7, vtpStatsTable=vtpStatsTable, managementDomainTftpServer=managementDomainTftpServer, vtpVlanState=vtpVlanState, vtpVlanEditEntry=vtpVlanEditEntry, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpVlanInfoGroup=vtpVlanInfoGroup, vtpMIBGroups=vtpMIBGroups, vtpDatabaseTable=vtpDatabaseTable, managementDomainLastUpdater=managementDomainLastUpdater, VlanTypeExt=VlanTypeExt, vtpDiscoverResultEntry=vtpDiscoverResultEntry)
