...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-SMART-INSTALL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:44:20 2019
...
iso, ModuleIdentity, Bits, Counter64, Counter32, TimeTicks, MibIdentifier, NotificationType, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Bits", "Counter64", "Counter32", "TimeTicks", "MibIdentifier", "NotificationType", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Gauge32")
RowStatus, DateAndTime, TextualConvention, MacAddress, TruthValue, StorageType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "TextualConvention", "MacAddress", "TruthValue", "StorageType", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-SMART-INSTALL-MIB", csiJoinWindowPeriodRowStatus=csiJoinWindowPeriodRowStatus, csiNotifOperationType=csiNotifOperationType, csiDeviceAddressType=csiDeviceAddressType, csiDeviceBackupConfigFileName=csiDeviceBackupConfigFileName, csiOperationModeChange=csiOperationModeChange, csiJoinWindowPeriodInterval=csiJoinWindowPeriodInterval, ciscoSmartInstallNotificationEnableGroup=ciscoSmartInstallNotificationEnableGroup, ciscoSmartInstallNotificationsGroup=ciscoSmartInstallNotificationsGroup, ciscoSmartInstallGroups=ciscoSmartInstallGroups, csiProfileEntry=csiProfileEntry, csiMatchMacAddress=csiMatchMacAddress, csiDeviceLost=csiDeviceLost, csiProfileNextFreeIndex=csiProfileNextFreeIndex, ciscoSmartInstallMIBConform=ciscoSmartInstallMIBConform, csiJoinWindowPeriodStorageType=csiJoinWindowPeriodStorageType, csiJoinWindowPeriodEntry=csiJoinWindowPeriodEntry, csiMatchSwitchNum=csiMatchSwitchNum, csiJoinWindowPeriodStartTime=csiJoinWindowPeriodStartTime, csiManagementVlansFirst2K=csiManagementVlansFirst2K, csiMatchGroupType=csiMatchGroupType, csiDeviceEntry=csiDeviceEntry, csiDeviceStatus=csiDeviceStatus, ciscoSmartInstallMIB=ciscoSmartInstallMIB, csiDeviceTable=csiDeviceTable, csiProfileImageTwoUrl=csiProfileImageTwoUrl, csiDeviceImageVersion=csiDeviceImageVersion, csiImageFileUrl=csiImageFileUrl, csiMatchEntry=csiMatchEntry, csiJoinWindowPeriodRecurrencePattern=csiJoinWindowPeriodRecurrencePattern, ciscoSmartInstallMIBObjects=ciscoSmartInstallMIBObjects, csiDirectorIpAddress=csiDirectorIpAddress, csiDeviceMacAddress=csiDeviceMacAddress, csiDeviceAddress=csiDeviceAddress, csiBackup=csiBackup, ciscoSmartInstallNotifyVarsGroup=ciscoSmartInstallNotifyVarsGroup, csiProfileTable=csiProfileTable, csiMatchProductId=csiMatchProductId, csiMatchSwitchProductId=csiMatchSwitchProductId, csiNotifOperationResult=csiNotifOperationResult, csiFileLoadFailed=csiFileLoadFailed, csiDeviceNum=csiDeviceNum, csiMatchStorageType=csiMatchStorageType, csiDeviceAdded=csiDeviceAdded, csiDeviceSerialNum=csiDeviceSerialNum, csiBackupHostUrl=csiBackupHostUrl, PYSNMP_MODULE_ID=ciscoSmartInstallMIB, ciscoSmartInstallCompliance=ciscoSmartInstallCompliance, csiMatchHostInterface=csiMatchHostInterface, csiNotifObjects=csiNotifObjects, csiProfile=csiProfile, csiBackupEnable=csiBackupEnable, csiDevicePlatform=csiDevicePlatform, csiGlobalConfig=csiGlobalConfig, csiJoinWindowPeriodTable=csiJoinWindowPeriodTable, csiJoinWindowPeriodExpirationDate=csiJoinWindowPeriodExpirationDate, csiProfileRowStatus=csiProfileRowStatus, csiManagementVlan=csiManagementVlan, ciscoSmartInstallCompliances=ciscoSmartInstallCompliances, csiMatchHostAddressType=csiMatchHostAddressType, ciscoSmartInstallProfileGroup=ciscoSmartInstallProfileGroup, csiHostnamePrefix=csiHostnamePrefix, ciscoSmartInstallConfigBackupGroup=ciscoSmartInstallConfigBackupGroup, csiDirectorIpAddressType=csiDirectorIpAddressType, csiConfigFileUrl=csiConfigFileUrl, ciscoSmartInstallDeviceInformationGroup=ciscoSmartInstallDeviceInformationGroup, csiOperationMode=csiOperationMode, csiProfileIndex=csiProfileIndex, csiJoinWindowConfigOperationMode=csiJoinWindowConfigOperationMode, csiManagementVlansSecond2K=csiManagementVlansSecond2K, csiProfileGroupName=csiProfileGroupName, ciscoSmartInstallMIBNotifs=ciscoSmartInstallMIBNotifs, ciscoSmartInstallJoinWindowGroup=ciscoSmartInstallJoinWindowGroup, csiDeviceInfo=csiDeviceInfo, csiJoinWindowPeriodIndex=csiJoinWindowPeriodIndex, csiMatchHostAddress=csiMatchHostAddress, csiJoinWindow=csiJoinWindow, csiProfileStorageType=csiProfileStorageType, csiMatchIndex=csiMatchIndex, csiNotifEnable=csiNotifEnable, csiJoinWindowPeriodNextFreeIndex=csiJoinWindowPeriodNextFreeIndex, csiProfileConfigUrl=csiProfileConfigUrl, csiDeviceName=csiDeviceName, csiMatchRowStatus=csiMatchRowStatus, ciscoSmartInstallGlobalConfigGroup=ciscoSmartInstallGlobalConfigGroup, csiMatchTable=csiMatchTable, csiProfileImageUrl=csiProfileImageUrl)
