...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IF-THRESHOLD-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:36:15 2019
...
Unsigned32, Integer32, MibIdentifier, Counter32, Counter64, Bits, TimeTicks, NotificationType, IpAddress, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "MibIdentifier", "Counter32", "Counter64", "Bits", "TimeTicks", "NotificationType", "IpAddress", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-IF-THRESHOLD-MIB", cIfThresholdNotifsGroup=cIfThresholdNotifsGroup, cIfThresholdMIBCompliance=cIfThresholdMIBCompliance, cifthThresholdFiredLastChange=cifthThresholdFiredLastChange, cIfThresholdMIBNotifications=cIfThresholdMIBNotifications, cifthThresholdDescr=cifthThresholdDescr, cifthIfThresholdFiredTable=cifthIfThresholdFiredTable, cifthThresholdTable=cifthThresholdTable, cifthApsGroup=cifthApsGroup, cifthTemplateIfAssignOperStatus=cifthTemplateIfAssignOperStatus, cifthThresholdClearedValue=cifthThresholdClearedValue, cifthTemplateIfAssignRowStatus=cifthTemplateIfAssignRowStatus, cifthTemplateIfStatusChange=cifthTemplateIfStatusChange, cifthTemplateIfAssignInterface=cifthTemplateIfAssignInterface, ciscoIfThresholdMIB=ciscoIfThresholdMIB, cifthIfThresholdCleared=cifthIfThresholdCleared, cifthHoldDownHysteresisGroup=cifthHoldDownHysteresisGroup, cifthTemplateNotifyHoldDownTime=cifthTemplateNotifyHoldDownTime, cifthTemplateIfLastChange=cifthTemplateIfLastChange, cifthTemplateIfAssignEntry=cifthTemplateIfAssignEntry, cifthThresholdRowStatus=cifthThresholdRowStatus, cifthTemplateLastChange=cifthTemplateLastChange, cIfThresholdMIBConformance=cIfThresholdMIBConformance, cifthTemplateTable=cifthTemplateTable, cifthIfThresholdFiredTemplate=cifthIfThresholdFiredTemplate, cifthIfThresholdFiredLstChange=cifthIfThresholdFiredLstChange, cifthThresholdEntry=cifthThresholdEntry, cIfThresholdFiredGroup=cIfThresholdFiredGroup, cIfThresholdMIBCompliances=cIfThresholdMIBCompliances, cifthHoldDownTimerGroup=cifthHoldDownTimerGroup, PYSNMP_MODULE_ID=ciscoIfThresholdMIB, cifthThresholdIndex=cifthThresholdIndex, CifthThresholdList=CifthThresholdList, cifthThresholdLastChange=cifthThresholdLastChange, CifthTemplateIndexOrZero=CifthTemplateIndexOrZero, cifthIfThresholdFired=cifthIfThresholdFired, cifthTemplateEntry=cifthTemplateEntry, cifthIfLastThresholdFired=cifthIfLastThresholdFired, cifthTemplateGroup=cifthTemplateGroup, cifthThresholdType=cifthThresholdType, cifthThresholdDirection=cifthThresholdDirection, cifthIfThresholdFiredMaxSeverity=cifthIfThresholdFiredMaxSeverity, cIfThresholdMIBObjects=cIfThresholdMIBObjects, cifthTemplateIndex=cifthTemplateIndex, CifthThresholdIndex=CifthThresholdIndex, cifthThresholdFiredValue=cifthThresholdFiredValue, cifthTemplateIfAssignTable=cifthTemplateIfAssignTable, cifthThresholdFiredNotifyEnable=cifthThresholdFiredNotifyEnable, cifthThresholdObject=cifthThresholdObject, cifthIfThresholdFiredLstSeverity=cifthIfThresholdFiredLstSeverity, cifthTemplateIfAssignGroup=cifthTemplateIfAssignGroup, CifthThresholdSeverity=CifthThresholdSeverity, cifthThresholdSeverity=cifthThresholdSeverity, CifthThresholdSeverityOrZero=CifthThresholdSeverityOrZero, cifthIfThresholdsFired=cifthIfThresholdsFired, cifthMIBNotificationsPrefix=cifthMIBNotificationsPrefix, cIfThresholdMIBGroups=cIfThresholdMIBGroups, cifthTemplateIfNotifsGroup=cifthTemplateIfNotifsGroup, cifthTemplateRowStatus=cifthTemplateRowStatus, cifthTemplateName=cifthTemplateName, cifthTemplateNotifyHoldDownType=cifthTemplateNotifyHoldDownType, cifthThresholdApsSwitchover=cifthThresholdApsSwitchover, cifthThresholdSampleInterval=cifthThresholdSampleInterval, cifthTemplateIndexNext=cifthTemplateIndexNext, cifthIfThresholdFiredEntry=cifthIfThresholdFiredEntry, CifthTemplateIndex=CifthTemplateIndex, cifthIfThresholdFiredGroup=cifthIfThresholdFiredGroup, cIfThresholdTemplateGroup=cIfThresholdTemplateGroup)
