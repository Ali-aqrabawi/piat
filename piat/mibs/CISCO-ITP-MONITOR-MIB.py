...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ITP-MONITOR-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:42:40 2019
...
Unsigned32, TimeTicks, MibIdentifier, Gauge32, Bits, NotificationType, Integer32, ObjectIdentity, iso, Counter64, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "MibIdentifier", "Gauge32", "Bits", "NotificationType", "Integer32", "ObjectIdentity", "iso", "Counter64", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-ITP-MONITOR-MIB", cItpmConnQueueDepth=cItpmConnQueueDepth, cItpmLinkTableEntry=cItpmLinkTableEntry, cItpmLinkRcvdMsuRate=cItpmLinkRcvdMsuRate, ciscoItpmMIBComplianceRev1=ciscoItpmMIBComplianceRev1, ciscoItpMonitorCongestion=ciscoItpMonitorCongestion, cItpmConn=cItpmConn, cItpmLink=cItpmLink, cItpmLinkRcvdMsuDrops=cItpmLinkRcvdMsuDrops, cItpmLinkSlotNumber=cItpmLinkSlotNumber, cItpmLinkRcvdBitsRate=cItpmLinkRcvdBitsRate, cItpmLinkNumber=cItpmLinkNumber, cItpmConnPortNumber=cItpmConnPortNumber, ciscoItpmMIB=ciscoItpmMIB, ciscoItpmMIBConform=ciscoItpmMIBConform, cItpmConnCongAbate=cItpmConnCongAbate, cItpmLinkTable=cItpmLinkTable, cItpmConnMonitorState=cItpmConnMonitorState, ciscoItpmMIBNotifs=ciscoItpmMIBNotifs, cItpmConnTableEntry=cItpmConnTableEntry, cItpmLinkSentMsuRate=cItpmLinkSentMsuRate, ciscoItpmLinkGroup=ciscoItpmLinkGroup, cItpmConnCongCounts=cItpmConnCongCounts, ciscoItpmConnGroup=ciscoItpmConnGroup, cItpmLinkSentBitsRate=cItpmLinkSentBitsRate, cItpmMonitorStateNotifEnabled=cItpmMonitorStateNotifEnabled, ciscoItpmMIBGroups=ciscoItpmMIBGroups, ciscoItpmMIBObjects=ciscoItpmMIBObjects, ciscoItpMonitorState=ciscoItpMonitorState, cItpmConnMaxQDepth=cItpmConnMaxQDepth, cItpmConnCongOnset=cItpmConnCongOnset, cItpmCongestionNotifEnabled=cItpmCongestionNotifEnabled, ciscoItpmNotificationsGroup=ciscoItpmNotificationsGroup, ciscoItpmNotificationsGroupRev1=ciscoItpmNotificationsGroupRev1, cItpmConnKeepAlive=cItpmConnKeepAlive, cItpmLinkStatus=cItpmLinkStatus, cItpmConnTable=cItpmConnTable, cItpmLinkRcvdMsus=cItpmLinkRcvdMsus, cItpmLinkSentMsus=cItpmLinkSentMsus, cItpmLinkDescription=cItpmLinkDescription, cItpmLinkSentMsuDrops=cItpmLinkSentMsuDrops, cItpmConnCongestion=cItpmConnCongestion, ciscoItpmMIBCompliances=ciscoItpmMIBCompliances, ciscoItpmConnGroupRev1=ciscoItpmConnGroupRev1, ciscoItpmMIBCompliance=ciscoItpmMIBCompliance, PYSNMP_MODULE_ID=ciscoItpmMIB, cItpmConnRcvWindowSize=cItpmConnRcvWindowSize, cItpmConnFastStart=cItpmConnFastStart)
