...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-OAM-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:30:08 2019
...
ObjectIdentity, MibIdentifier, Counter64, iso, NotificationType, IpAddress, Counter32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter64", "iso", "NotificationType", "IpAddress", "Counter32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("CISCO-OAM-MIB", oamLoopbackPingVci=oamLoopbackPingVci, CiscoOAMPingDir=CiscoOAMPingDir, oamLoopbackPingEntryStatus=oamLoopbackPingEntryStatus, oamLoopbackPingMinRtt=oamLoopbackPingMinRtt, oamLoopbackPingSerialNumber=oamLoopbackPingSerialNumber, ciscoOamPingMIBGroup=ciscoOamPingMIBGroup, oamLoopbackPingMaxRtt=oamLoopbackPingMaxRtt, oamLoopbackPingEntryOwner=oamLoopbackPingEntryOwner, oamLoopbackPingMIBTraps=oamLoopbackPingMIBTraps, ciscoOamPingMIBCompliance2=ciscoOamPingMIBCompliance2, oamLoopSegVpi=oamLoopSegVpi, oamLoopSegRowStatus=oamLoopSegRowStatus, oamLoopbackPingTable=oamLoopbackPingTable, oamLoopbackPingAvgRttuSec=oamLoopbackPingAvgRttuSec, ciscoOamPingMIBObjects=ciscoOamPingMIBObjects, oamLoopbackPingDir=oamLoopbackPingDir, ciscoOamPingMIBGroups=ciscoOamPingMIBGroups, oamLoopbackSegEndPointEntry=oamLoopbackSegEndPointEntry, ciscoOamPingMIBCompliance3=ciscoOamPingMIBCompliance3, oamLoopbackPingEntry=oamLoopbackPingEntry, ciscoOamPingMIBCompliances=ciscoOamPingMIBCompliances, oamLoopbackPingExecTime=oamLoopbackPingExecTime, oamLoopbackPingSentCells=oamLoopbackPingSentCells, oamLoopbackSegEndPointTable=oamLoopbackSegEndPointTable, oamLoopbackPingCount=oamLoopbackPingCount, oamLoopbackPingMaxRttuSec=oamLoopbackPingMaxRttuSec, oamLoopbackPingMinRttuSec=oamLoopbackPingMinRttuSec, PYSNMP_MODULE_ID=ciscoOamPingMIB, oamLoopbackPingVpi=oamLoopbackPingVpi, oamLoopbackPingCompletionTrap=oamLoopbackPingCompletionTrap, oamLoopbackPingType=oamLoopbackPingType, ciscoOamPingMIB=ciscoOamPingMIB, oamLoopbackNotificationsGroup=oamLoopbackNotificationsGroup, oamLoopbackPingLocation=oamLoopbackPingLocation, oamLoopbackPingDelay=oamLoopbackPingDelay, oamLoopbackPingInterface=oamLoopbackPingInterface, CiscoOAMPingStatus=CiscoOAMPingStatus, oamLoopbackPingTrapOnCompletion=oamLoopbackPingTrapOnCompletion, ciscoOamPing2MIBGroup=ciscoOamPing2MIBGroup, ciscoOamPingSegEndPointGroup=ciscoOamPingSegEndPointGroup, ciscoOamPingMIBConformance=ciscoOamPingMIBConformance, oamLoopSegVci=oamLoopSegVci, oamLoopbackPingReceivedCells=oamLoopbackPingReceivedCells, oamLoopbackPingAvgRtt=oamLoopbackPingAvgRtt, oamLoopbackPingOperStatus=oamLoopbackPingOperStatus, oamLoopbackPingMIBTrapPrefix=oamLoopbackPingMIBTrapPrefix, ciscoOamPingMIBCompliance=ciscoOamPingMIBCompliance, oamLoopbackPingTimeout=oamLoopbackPingTimeout, oamLoopbackPingCompleted=oamLoopbackPingCompleted, oamLoopbackPingLocationFlag=oamLoopbackPingLocationFlag, ciscoOamPingMIBGroupRev3=ciscoOamPingMIBGroupRev3)
