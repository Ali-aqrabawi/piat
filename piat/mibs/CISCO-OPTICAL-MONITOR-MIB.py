...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-OPTICAL-MONITOR-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:37:38 2019
...
iso, IpAddress, ModuleIdentity, Counter64, MibIdentifier, TimeTicks, Gauge32, Unsigned32, Counter32, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "ModuleIdentity", "Counter64", "MibIdentifier", "TimeTicks", "Gauge32", "Unsigned32", "Counter32", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("CISCO-OPTICAL-MONITOR-MIB", cOpticalPMIntervalEntry=cOpticalPMIntervalEntry, cOpticalMonitorMIBComplianceRev=cOpticalMonitorMIBComplianceRev, cOpticalMIBNotifyEnableGroup=cOpticalMIBNotifyEnableGroup, cOpticalMonEnable=cOpticalMonEnable, cOpticalMonEntry=cOpticalMonEntry, cOpticalPMCurrentMaxParam=cOpticalPMCurrentMaxParam, cOpticalPMIntervalMeanParam=cOpticalPMIntervalMeanParam, cOpticalMonTable=cOpticalMonTable, cOpticalPMIntervalUnavailSecs=cOpticalPMIntervalUnavailSecs, cOpticalMonLocation=cOpticalMonLocation, cOpticalPMCurrentMinParam=cOpticalPMCurrentMinParam, cOpticalMonitorMIBCompliance=cOpticalMonitorMIBCompliance, cOpticalPMGroup=cOpticalPMGroup, cOpticalPMIntervalLocation=cOpticalPMIntervalLocation, cOpticalMonitorMIBObjects=cOpticalMonitorMIBObjects, cOpticalParamAlarmCurMaxSev=cOpticalParamAlarmCurMaxSev, cOpticalMonNotificationPrefix=cOpticalMonNotificationPrefix, cOpticalMonParameterStatus=cOpticalMonParameterStatus, cOpticalMIBIntervalConfigGroup=cOpticalMIBIntervalConfigGroup, cOpticalParamAlarmLastChange=cOpticalParamAlarmLastChange, cOpticalMonIfTimeInSlot=cOpticalMonIfTimeInSlot, cOpticalMonGroup=cOpticalMonGroup, cOpticalPMIntervalTable=cOpticalPMIntervalTable, cOpticalParamHighWarningThresh=cOpticalParamHighWarningThresh, cOpticalParamLowAlarmSev=cOpticalParamLowAlarmSev, OpticalParameterType=OpticalParameterType, cOpticalParamAlarmCurMaxThresh=cOpticalParamAlarmCurMaxThresh, cOpticalPMCurrentUnavailSecs=cOpticalPMCurrentUnavailSecs, cOpticalPMCurrentLocation=cOpticalPMCurrentLocation, cOpticalPMIntervalMaxParam=cOpticalPMIntervalMaxParam, cOpticalMon24HrValidIntervals=cOpticalMon24HrValidIntervals, cOpticalMIBEnableConfigGroup=cOpticalMIBEnableConfigGroup, cOpticalParamHighAlarmThresh=cOpticalParamHighAlarmThresh, cOpticalParamAlarmStatus=cOpticalParamAlarmStatus, cOpticalMon15MinValidIntervals=cOpticalMon15MinValidIntervals, cOpticalMonIfTable=cOpticalMonIfTable, cOpticalPMCurrentPeriod=cOpticalPMCurrentPeriod, OpticalParameterValue=OpticalParameterValue, OpticalIfMonLocation=OpticalIfMonLocation, cOpticalParamLowWarningThresh=cOpticalParamLowWarningThresh, cOpticalMonParameterType=cOpticalMonParameterType, cOpticalPMCurrentTable=cOpticalPMCurrentTable, cOpticalPMCurrentParamType=cOpticalPMCurrentParamType, cOpticalMonitorMIBNotifications=cOpticalMonitorMIBNotifications, cOpticalParamHighWarningSev=cOpticalParamHighWarningSev, cOpticalParamLowWarningSev=cOpticalParamLowWarningSev, cOpticalMIBThresholdGroup=cOpticalMIBThresholdGroup, cOpticalPMCurrentDirection=cOpticalPMCurrentDirection, ciscoOpticalMonitorMIB=ciscoOpticalMonitorMIB, cOpticalNotifyEnable=cOpticalNotifyEnable, cOpticalParamThreshSource=cOpticalParamThreshSource, cOpticalMonDirection=cOpticalMonDirection, cOpticalPMCurrentEntry=cOpticalPMCurrentEntry, cOpticalPMCurrentMeanParam=cOpticalPMCurrentMeanParam, cOpticalMIBSeverityGroup=cOpticalMIBSeverityGroup, cOpticalPMIntervalPeriod=cOpticalPMIntervalPeriod, cOpticalPMIntervalDirection=cOpticalPMIntervalDirection, cOpticalPMIntervalNumber=cOpticalPMIntervalNumber, cOpticalPMIntervalMinParam=cOpticalPMIntervalMinParam, cOpticalMonThreshSourceGroup=cOpticalMonThreshSourceGroup, cOpticalMonIfEntry=cOpticalMonIfEntry, cOpticalMonPollInterval=cOpticalMonPollInterval, OpticalAlarmSeverityOrZero=OpticalAlarmSeverityOrZero, PYSNMP_MODULE_ID=ciscoOpticalMonitorMIB, OpticalAlarmSeverity=OpticalAlarmSeverity, cOpticalMonIfTimeGroup=cOpticalMonIfTimeGroup, cOpticalParamLowAlarmThresh=cOpticalParamLowAlarmThresh, cOpticalMonitorMIBCompliances=cOpticalMonitorMIBCompliances, OpticalPMPeriod=OpticalPMPeriod, OpticalAlarmStatus=OpticalAlarmStatus, cOpticalParamHighAlarmSev=cOpticalParamHighAlarmSev, cOpticalPMIntervalParamType=cOpticalPMIntervalParamType, cOpticalMonitorMIBConformance=cOpticalMonitorMIBConformance, cOpticalMIBPMGroup=cOpticalMIBPMGroup, cOpticalMonitorMIBGroups=cOpticalMonitorMIBGroups, cOpticalMIBNotifGroup=cOpticalMIBNotifGroup, cOpticalParameterValue=cOpticalParameterValue, OpticalIfDirection=OpticalIfDirection, cOpticalMIBMonGroup=cOpticalMIBMonGroup)
