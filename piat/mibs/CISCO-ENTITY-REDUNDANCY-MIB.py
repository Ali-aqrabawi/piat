...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ENTITY-REDUNDANCY-MIB
...
CeRedunType, CeRedunSwitchCommand, CeRedunMode, CeRedunScope, CeRedunArch, CeRedunStateCategories, CeRedunReasonCategories, CeRedunMbrStatus = mibBuilder.importSymbols("CISCO-ENTITY-REDUNDANCY-TC-MIB", "CeRedunType", "CeRedunSwitchCommand", "CeRedunMode", "CeRedunScope", "CeRedunArch", "CeRedunStateCategories", "CeRedunReasonCategories", "CeRedunMbrStatus")
ciscoMgmt, = mibBuilder.importSymbols("CISCO-SMI", "ciscoMgmt")
PhysicalIndex, = mibBuilder.importSymbols("ENTITY-MIB", "PhysicalIndex")
InetAddress, InetAddressType = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddress", "InetAddressType")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
ModuleIdentity, Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, TimeTicks, Gauge32, NotificationType, Bits, Unsigned32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "TimeTicks", "Gauge32", "NotificationType", "Bits", "Unsigned32", "iso", "Counter32")
AutonomousType, TimeStamp, RowStatus, StorageType, DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "RowStatus", "StorageType", "DisplayString", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-ENTITY-REDUNDANCY-MIB", ceRedunInternalStatesTable=ceRedunInternalStatesTable, ceRedunGroupTypeName=ceRedunGroupTypeName, ceRedunMbrStorageType=ceRedunMbrStorageType, ceRedunGroupArch=ceRedunGroupArch, ceRedunGroupDefinitionChanged=ceRedunGroupDefinitionChanged, ceRedunMbrAddressType=ceRedunMbrAddressType, ceRedunOneToN=ceRedunOneToN, ceRedunOptionalGroupTypes=ceRedunOptionalGroupTypes, ceRedunMbrMode=ceRedunMbrMode, ceRedunMbrSwitchoverSeconds=ceRedunMbrSwitchoverSeconds, ceRedunGroupTypesEntry=ceRedunGroupTypesEntry, ceRedunCommandMbrNumber=ceRedunCommandMbrNumber, ceRedunMbrConfigTable=ceRedunMbrConfigTable, ceRedunSwitchoverReasonDescr=ceRedunSwitchoverReasonDescr, ceRedunSwitchoverReasonIndex=ceRedunSwitchoverReasonIndex, ceRedunCommandEntry=ceRedunCommandEntry, ceRedunMbrStatusLastChanged=ceRedunMbrStatusLastChanged, ceRedunMbrStatusTable=ceRedunMbrStatusTable, ceRedunGroupCounts=ceRedunGroupCounts, ceRedunMembers=ceRedunMembers, ceRedunMemberStatus=ceRedunMemberStatus, ceRedunGroupRedunType=ceRedunGroupRedunType, ceRedunSwitchoverReasonTable=ceRedunSwitchoverReasonTable, ceRedunGroupEntry=ceRedunGroupEntry, ceRedunSwitchNotifGroup=ceRedunSwitchNotifGroup, ceRedunGroupTypesTable=ceRedunGroupTypesTable, ceRedunGroupStorageType=ceRedunGroupStorageType, ceRedunGroupLastChanged=ceRedunGroupLastChanged, ceRedunGroupIndex=ceRedunGroupIndex, ciscoEntityRedunMIBNotifs=ciscoEntityRedunMIBNotifs, ceRedunMbrPriority=ceRedunMbrPriority, ceRedunMaxMbrsInGroup=ceRedunMaxMbrsInGroup, ceRedunGroupScope=ceRedunGroupScope, ceRedunMbrInternalState=ceRedunMbrInternalState, ceRedunReasonCategory=ceRedunReasonCategory, ceRedunOptionalMbrStatus=ceRedunOptionalMbrStatus, ceRedunProtectStatusNotifGroup=ceRedunProtectStatusNotifGroup, ceRedunRemoteSystem=ceRedunRemoteSystem, ceRedunBidirectional=ceRedunBidirectional, PYSNMP_MODULE_ID=ciscoEntityRedunMIB, ceRedunMbrStatusEntry=ceRedunMbrStatusEntry, ceRedunVendorTypesTable=ceRedunVendorTypesTable, ciscoEntityRedunMIB=ciscoEntityRedunMIB, ceRedunMbrProtectingMbr=ceRedunMbrProtectingMbr, ceRedunEnableStatusChangeNotifs=ceRedunEnableStatusChangeNotifs, ceRedunSwitchoverReasonEntry=ceRedunSwitchoverReasonEntry, ceRedunCommandTable=ceRedunCommandTable, ceRedunUsesGroupName=ceRedunUsesGroupName, ceRedunNextUnusedGroupIndex=ceRedunNextUnusedGroupIndex, ciscoEntityRedunMIBObjects=ciscoEntityRedunMIBObjects, ceRedunMbrSwitchoverReason=ceRedunMbrSwitchoverReason, ciscoEntityRedunMIBConform=ciscoEntityRedunMIBConform, ceRedunGroupDirection=ceRedunGroupDirection, ceRedunCompliances=ceRedunCompliances, ceRedunMbrSwitchoverCounts=ceRedunMbrSwitchoverCounts, ceRedunCommandSwitch=ceRedunCommandSwitch, ceRedunMbrRowStatus=ceRedunMbrRowStatus, ceRedunGroup=ceRedunGroup, ceRedunMemberConfig=ceRedunMemberConfig, ceRedunInternalStatesEntry=ceRedunInternalStatesEntry, ceRedunInternalStateDescr=ceRedunInternalStateDescr, ceRedunVendorTypesEntry=ceRedunVendorTypesEntry, ceRedunGroupObjects=ceRedunGroupObjects, ceRedunGroupTypeIndex=ceRedunGroupTypeIndex, ceRedunGroupTable=ceRedunGroupTable, ceRedunMbrLastSwitchover=ceRedunMbrLastSwitchover, ceRedunMbrNumber=ceRedunMbrNumber, ceRedunStateCategory=ceRedunStateCategory, ceRedunNotifEnables=ceRedunNotifEnables, ceRedunGroupTypeGroup=ceRedunGroupTypeGroup, ceRedunGroupWaitToRestore=ceRedunGroupWaitToRestore, ceRedunCommandsGroup=ceRedunCommandsGroup, ceRedunInternalStateIndex=ceRedunInternalStateIndex, ceRedunMbrRemoteAddress=ceRedunMbrRemoteAddress, ceRedunEventSwitchover=ceRedunEventSwitchover, ceRedunMbrConfigEntry=ceRedunMbrConfigEntry, ceRedunVendorType=ceRedunVendorType, ceRedunGroupRevert=ceRedunGroupRevert, ceRedunProtectStatusChange=ceRedunProtectStatusChange, ceRedunEnableSwitchoverNotifs=ceRedunEnableSwitchoverNotifs, ceRedunMbrLastChanged=ceRedunMbrLastChanged, ceRedunInternalStates=ceRedunInternalStates, ceRedunMbrPhysIndex=ceRedunMbrPhysIndex, ceRedunCompliance=ceRedunCompliance, ceRedunRevertiveGroup=ceRedunRevertiveGroup, ceRedunGroupRowStatus=ceRedunGroupRowStatus, ceRedunGroups=ceRedunGroups, ceRedunMbrStatusCurrent=ceRedunMbrStatusCurrent, ceRedunGroupString=ceRedunGroupString, ceRedunSwitchoverReason=ceRedunSwitchoverReason)
