...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-FEATURE-CONTROL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:44:09 2019
...
Counter64, Integer32, Gauge32, Unsigned32, Counter32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, ObjectIdentity, NotificationType, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Gauge32", "Unsigned32", "Counter32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "ObjectIdentity", "NotificationType", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-FEATURE-CONTROL-MIB", cfcFeatureCtrlName=cfcFeatureCtrlName, cfcFeatureCtrlLastActionResult2=cfcFeatureCtrlLastActionResult2, cfcFeatureCtrlTable=cfcFeatureCtrlTable, cfcFeature=cfcFeature, cfcFeatureCtrlOpStatusReason2=cfcFeatureCtrlOpStatusReason2, cfcFeatureCtrlTag2=cfcFeatureCtrlTag2, cfcFeatureGroup=cfcFeatureGroup, cfcFeatureCtrlName2=cfcFeatureCtrlName2, cfcFeatureCtrl2Table=cfcFeatureCtrl2Table, cfcFeatureSetLastAction=cfcFeatureSetLastAction, CiscoFeatureAction=CiscoFeatureAction, cfcFeatureSetNotifEnable=cfcFeatureSetNotifEnable, cfcFeatureSetName=cfcFeatureSetName, cfcFeatureCtrl2Entry=cfcFeatureCtrl2Entry, ciscoFeatureSetOpStatusChange=ciscoFeatureSetOpStatusChange, cfcNotificationGroupRev=cfcNotificationGroupRev, cfcFeatureCtrlLastAction2=cfcFeatureCtrlLastAction2, cfcFeatureCtrlLastFailureReason2=cfcFeatureCtrlLastFailureReason2, cfcNotifControl=cfcNotifControl, cfcFeatureCtrlIndex=cfcFeatureCtrlIndex, cfcFeatureCtrlAction2=cfcFeatureCtrlAction2, cfcFeatureSetAction=cfcFeatureSetAction, cfcFeatureGroupRev=cfcFeatureGroupRev, cfcFeatureCtrlLastAction=cfcFeatureCtrlLastAction, cfcFeatureCtrlOpStatus=cfcFeatureCtrlOpStatus, cfcFeatureCtrlEntry=cfcFeatureCtrlEntry, PYSNMP_MODULE_ID=ciscoFeatureCtrlMIB, cfcFeatureCtrlAction=cfcFeatureCtrlAction, cfcFeatureSetOpStatusReason=cfcFeatureSetOpStatusReason, cfcFeatureSetNotificationGroup=cfcFeatureSetNotificationGroup, cfcFeatureSetTable=cfcFeatureSetTable, ciscoFeatureCtrlMIB=ciscoFeatureCtrlMIB, CiscoOptionalFeatureSet=CiscoOptionalFeatureSet, CiscoFeatureActionResult=CiscoFeatureActionResult, cfcFeatureCtrlLastActionResult=cfcFeatureCtrlLastActionResult, ciscoFeatureSetCtrlMIBComplianceRev1=ciscoFeatureSetCtrlMIBComplianceRev1, cfcFeatureCtrlIndex2=cfcFeatureCtrlIndex2, cfcFeatureCtrlOpStatus2=cfcFeatureCtrlOpStatus2, CiscoFeatureStatus=CiscoFeatureStatus, cfcFeatureSetEntry=cfcFeatureSetEntry, cfcNotificationGroup=cfcNotificationGroup, CiscoOptionalFeature=CiscoOptionalFeature, cfcFeatureCtrlInstanceNum2=cfcFeatureCtrlInstanceNum2, ciscoFeatureCtrlMIBCompliance=ciscoFeatureCtrlMIBCompliance, cfcFeatureSetLastFailureReason=cfcFeatureSetLastFailureReason, ciscoFeatureCtrlMIBObjects=ciscoFeatureCtrlMIBObjects, cfcFeatureSetLastActionResult=cfcFeatureSetLastActionResult, cfcFeatureSetOpStatus=cfcFeatureSetOpStatus, cfcFeatureCtrlOpStatusReason=cfcFeatureCtrlOpStatusReason, cfcFeatureSetNotificationCtrlGroup=cfcFeatureSetNotificationCtrlGroup, cfcFeatureSetIndex=cfcFeatureSetIndex, ciscoFeatureCtrlMIBNotifs=ciscoFeatureCtrlMIBNotifs, cfcFeatureCtrlLastFailureReason=cfcFeatureCtrlLastFailureReason, ciscoFeatureCtrlMIBConformance=ciscoFeatureCtrlMIBConformance, ciscoFeatureCtrlMIBGroups=ciscoFeatureCtrlMIBGroups, ciscoFeatOpStatusChange=ciscoFeatOpStatusChange, ciscoFeatureCtrlMIBComplianceRev=ciscoFeatureCtrlMIBComplianceRev, cfcFeatureSetGroup=cfcFeatureSetGroup, ciscoFeatureOpStatusChange=ciscoFeatureOpStatusChange, ciscoFeatureCtrlMIBCompliances=ciscoFeatureCtrlMIBCompliances)
