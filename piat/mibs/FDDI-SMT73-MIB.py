...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/FDDI-SMT73-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:29:04 2019
...
Bits, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress, TimeTicks, NotificationType, ModuleIdentity, Integer32, iso, Counter64, Counter32, transmission, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32", "iso", "Counter64", "Counter32", "transmission", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORT=fddimibPORT, fddimibSMT=fddimibSMT, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHTable=fddimibPATHTable, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimib=fddimib, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTUserData=fddimibSMTUserData, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTECMState=fddimibSMTECMState, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORTNumber=fddimibPORTNumber, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACLostCts=fddimibMACLostCts, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATH=fddimibPATH, fddimibMACCounters=fddimibMACCounters, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTTable=fddimibSMTTable, FddiResourceId=FddiResourceId, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTStationAction=fddimibSMTStationAction, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPORTAction=fddimibPORTAction, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTStationId=fddimibSMTStationId, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPATHEntry=fddimibPATHEntry, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACRMTState=fddimibMACRMTState, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACTable=fddimibMACTable, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTIndex=fddimibSMTIndex, FddiTimeNano=FddiTimeNano, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACIndex=fddimibMACIndex, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTEntry=fddimibSMTEntry, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACTMax=fddimibMACTMax, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPATHIndex=fddimibPATHIndex, fddimibMACEntry=fddimibMACEntry, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddi=fddi, fddimibMACTNeg=fddimibMACTNeg, FddiTimeMilli=FddiTimeMilli, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTTable=fddimibPORTTable, fddimibMACTReq=fddimibMACTReq, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMAC=fddimibMAC, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACNumber=fddimibMACNumber, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTMACCts=fddimibSMTMACCts)
