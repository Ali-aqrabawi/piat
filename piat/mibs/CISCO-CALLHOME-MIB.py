...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CALLHOME-MIB
...
CiscoVrfName, CiscoURLString, EntPhysicalIndexOrZero = mibBuilder.importSymbols("CISCO-TC", "CiscoVrfName", "CiscoURLString", "EntPhysicalIndexOrZero")
...
RowStatus, TimeStamp, StorageType, TextualConvention, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "StorageType", "TextualConvention", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("CISCO-CALLHOME-MIB", ccmEventAlertGroupEntry=ccmEventAlertGroupEntry, chMIBCompliance=chMIBCompliance, ccmEventStatsSendCliOutput=ccmEventStatsSendCliOutput, ccmSmtpServerStatusGroup=ccmSmtpServerStatusGroup, ccmOnDemandCliMsgControl=ccmOnDemandCliMsgControl, callHomeDeviceServicePriority=callHomeDeviceServicePriority, ccmSmtpServerStatusTimeStamp=ccmSmtpServerStatusTimeStamp, ccmAlertGroupTypeDeletedNotif=ccmAlertGroupTypeDeletedNotif, callHomeSwInventoryEntry=callHomeSwInventoryEntry, ccmDestProfileTestFailureCause=ccmDestProfileTestFailureCause, ccmCallhomeEvents=ccmCallhomeEvents, ccmSmtpServerStatusEntry=ccmSmtpServerStatusEntry, ccmSmtpServerStatusAvailability=ccmSmtpServerStatusAvailability, ccmDestProfileTestTrigger=ccmDestProfileTestTrigger, sysStreetAddress=sysStreetAddress, callHomeSmtpServerAddr=callHomeSmtpServerAddr, ccmMessageSourceGroup=ccmMessageSourceGroup, chMultipleSmtpServersGroup=chMultipleSmtpServersGroup, ccmOnDemandCliMsgCliList=ccmOnDemandCliMsgCliList, callHomeUserDefMaxCmds=callHomeUserDefMaxCmds, ccmOnDemandMsgStatusGroup=ccmOnDemandMsgStatusGroup, ccmMsgSourceIpAddrType=ccmMsgSourceIpAddrType, CallHomeMsgFormat=CallHomeMsgFormat, ccmEnableSmtpServerNotif=ccmEnableSmtpServerNotif, ccmPeriodicAlertGroupEntry=ccmPeriodicAlertGroupEntry, ccmAaaAuthUserName=ccmAaaAuthUserName, callHomeAlertGroupEnable=callHomeAlertGroupEnable, ccmEventStatsInventory=ccmEventStatsInventory, ccmCallHomeOnDemandActions=ccmCallHomeOnDemandActions, ccmCallHomeProfileTestControl=ccmCallHomeProfileTestControl, ccmMsgSourceInterface=ccmMsgSourceInterface, chSingleSmtpServerGroup=chSingleSmtpServerGroup, ccmDestProfileTestEntry=ccmDestProfileTestEntry, ccmSmartCallHomeCcoId=ccmSmartCallHomeCcoId, ccmEventStatsTable=ccmEventStatsTable, callHomeAlertGroupCapability=callHomeAlertGroupCapability, ccmSmtpServersPriorityGroup=ccmSmtpServersPriorityGroup, callHomeUserDefCmdRowStatus=callHomeUserDefCmdRowStatus, callHomeDestEmailAddressEntry=callHomeDestEmailAddressEntry, callHomeUserDefCmdEntry=callHomeUserDefCmdEntry, ccmOnDemandMsgSendAlertGroup=ccmOnDemandMsgSendAlertGroup, callHomeAlertGroupName=callHomeAlertGroupName, callHomeUserDefCmdTable=callHomeUserDefCmdTable, ccmMIBNotificationsConfigGroup=ccmMIBNotificationsConfigGroup, ccmSmartCallHomeGroup=ccmSmartCallHomeGroup, callHomeSmtpServerPort=callHomeSmtpServerPort, ccmPeriodicAlertGroupDayOfWeek=ccmPeriodicAlertGroupDayOfWeek, ccmCallHomeAaa=ccmCallHomeAaa, ccmCallHomeVrfGroup=ccmCallHomeVrfGroup, chPeriodicSwInventoryInfoGroup=chPeriodicSwInventoryInfoGroup, ccmEventStatsEnvironment=ccmEventStatsEnvironment, PYSNMP_MODULE_ID=ciscoCallHomeMIB, sysContactPhoneNumber=sysContactPhoneNumber, callHomeDestProfileTable=callHomeDestProfileTable, ccmSmtpServersTable=ccmSmtpServersTable, callHomeDestProfileMsgFormat=callHomeDestProfileMsgFormat, ccmPatternAlertGroupStorage=ccmPatternAlertGroupStorage, callHomeSmtpServerUseVrf=callHomeSmtpServerUseVrf, ccmMsgSourceIpAddr=ccmMsgSourceIpAddr, ccmUserDefCmdGroup=ccmUserDefCmdGroup, ccmHttpProxyServerAddrType=ccmHttpProxyServerAddrType, callHomeAlertAction=callHomeAlertAction, ccmSmtpServerStatusTable=ccmSmtpServerStatusTable, ccmCallHomePeriodicMinutesGroup=ccmCallHomePeriodicMinutesGroup, callHomeDestProfileStatus=callHomeDestProfileStatus, callHomeSiteId=callHomeSiteId, CallHomeMsgLevel=CallHomeMsgLevel, ccmSeverityAlertGroupEntry=ccmSeverityAlertGroupEntry, callHomeDestEmailAddressIndex=callHomeDestEmailAddressIndex, ccmSysLogSeverity=ccmSysLogSeverity, ciscoCallHomeMIBObjects=ciscoCallHomeMIBObjects, ccmCallHomeStatus=ccmCallHomeStatus, chSwInventoryInfoGroup1=chSwInventoryInfoGroup1, callHomeSwServiceName=callHomeSwServiceName, ccmOnDemandCliMsgTransport=ccmOnDemandCliMsgTransport, callHomeAlertGroupTypeEntry=callHomeAlertGroupTypeEntry, chMIBCompliance5=chMIBCompliance5, ccmCallHomeSecurity=ccmCallHomeSecurity, ccmPeriodicSwInventoryMsgEnable=ccmPeriodicSwInventoryMsgEnable, ccmPatternAlertGroupTable=ccmPatternAlertGroupTable, ccmSmartCallHomeActions=ccmSmartCallHomeActions, ccmSmtpServersUseVrf=ccmSmtpServersUseVrf, ccmOnDemandMsgSendTrigger=ccmOnDemandMsgSendTrigger, callHomeInventoryNVPairIndex=callHomeInventoryNVPairIndex, ccmMIBNotificationsGroup=ccmMIBNotificationsGroup, ccmPeriodicAlertGroupCfgGroup=ccmPeriodicAlertGroupCfgGroup, chSystemInformationGroup1=chSystemInformationGroup1, callHomeAlertActionFailureCause=callHomeAlertActionFailureCause, ccmPeriodicSwInventoryTimeFrame=ccmPeriodicSwInventoryTimeFrame, callHomeAlertGroupTypeIndex=callHomeAlertGroupTypeIndex, chMIBCompliance3=chMIBCompliance3, chStatisticsGroup=chStatisticsGroup, ccmSmtpServersTblMaxEntries=ccmSmtpServersTblMaxEntries, ccmEventAlertGroupTable=ccmEventAlertGroupTable, ccmOnDemandCliMsgEmail=ccmOnDemandCliMsgEmail, ccmEventStatsTotal=ccmEventStatsTotal, chMIBCompliance6=chMIBCompliance6, chConfigurationGroup2=chConfigurationGroup2, chEmailMsgDispGroup=chEmailMsgDispGroup, ccmCallHomeDiagSignatureInfoTable=ccmCallHomeDiagSignatureInfoTable, chSystemServicePriorityGroup=chSystemServicePriorityGroup, ccmProfileHiMessageSizeGroup=ccmProfileHiMessageSizeGroup, chSwInventoryInfoGroup=chSwInventoryInfoGroup, ccmCallHomeSecurityLevelGroup=ccmCallHomeSecurityLevelGroup, ccmOnDemandMsgSendEntPhyIndex=ccmOnDemandMsgSendEntPhyIndex, ccmHttpCfgGroup=ccmHttpCfgGroup, callHomeAlertActionStatus=callHomeAlertActionStatus, ccmCallHomeDiagSignatureRev=ccmCallHomeDiagSignatureRev, ccmCallHomeConfiguration=ccmCallHomeConfiguration, callHomeInventoryInfoName=callHomeInventoryInfoName, chSystemInformationGroup=chSystemInformationGroup, ccmHttpProxyServerGroup=ccmHttpProxyServerGroup, ccmSingleSmtpServerGroup=ccmSingleSmtpServerGroup, ccmPeriodicAlertGroupEnable=ccmPeriodicAlertGroupEnable, callHomeUserDefCmdIndex=callHomeUserDefCmdIndex, ccmMIBNotificationsGroup1=ccmMIBNotificationsGroup1, ccmEventAlertGroupEnable=ccmEventAlertGroupEnable, ccmCallHomeAlertGroupCfg=ccmCallHomeAlertGroupCfg, ccmPeriodicAlertGroupInterval=ccmPeriodicAlertGroupInterval, ccmProfileTestGroup=ccmProfileTestGroup, ccmSmartCallHomeAnalysisCmd=ccmSmartCallHomeAnalysisCmd, CallHomeTransportMethod=CallHomeTransportMethod, callHomeLastAlertSent=callHomeLastAlertSent, ccmSmartCallHomeTrigger=ccmSmartCallHomeTrigger, ccmSmtpServersPriority=ccmSmtpServersPriority, callHomeSmtpServerAddrType=callHomeSmtpServerAddrType, ccmEventStatsGroup=ccmEventStatsGroup, ccmAlertGroupCapabilityGroup=ccmAlertGroupCapabilityGroup, ciscoCallHomeMIB=ciscoCallHomeMIB, ccmOnDemandCliMsgTacServiceReqId=ccmOnDemandCliMsgTacServiceReqId, ccmCallHomeNotifConfig=ccmCallHomeNotifConfig, ccmCallHomeHttpProxy=ccmCallHomeHttpProxy, ccmCallHomeDiagSignatureTriggerCount=ccmCallHomeDiagSignatureTriggerCount, callHomeDestHttpUrl=callHomeDestHttpUrl, ccmOnDemandCliMsgGroup=ccmOnDemandCliMsgGroup, ccmCallHomeAnonymousReportingGroup=ccmCallHomeAnonymousReportingGroup, ccmAaaAuthEnable=ccmAaaAuthEnable, chMIBCompliance9=chMIBCompliance9, ccmCallHomeDiagSignatureInfoEntry=ccmCallHomeDiagSignatureInfoEntry, ccmSmtpServersPort=ccmSmtpServersPort, ccmEventTime=ccmEventTime, ccmHttpProxyServerPort=ccmHttpProxyServerPort, ccmOnDemandMsgSendProfile=ccmOnDemandMsgSendProfile, ccmProfileAlertGroupsGroup=ccmProfileAlertGroupsGroup, chMIBConformance=chMIBConformance, ccmCallHomeVrfName=ccmCallHomeVrfName, callHomeDestProfileActive=callHomeDestProfileActive, ccmPeriodicAlertGroupMinute=ccmPeriodicAlertGroupMinute, ccmPatternAlertGroupEntry=ccmPatternAlertGroupEntry, ccmCallHomeDiagSignatureType=ccmCallHomeDiagSignatureType, ccmCallHomeStats=ccmCallHomeStats, callHomeDestProfileHiMaxMsgSize=callHomeDestProfileHiMaxMsgSize, ccmEventStatsMsgTypeIndex=ccmEventStatsMsgTypeIndex, ccmEventNotifGroup=ccmEventNotifGroup, ccmAlertGroupTypeAddedNotif=ccmAlertGroupTypeAddedNotif, ccmDestProfileTestMessage=ccmDestProfileTestMessage, ccmOnDemandCliMsgFormat=ccmOnDemandCliMsgFormat, ccmEventStatsTypeIndex=ccmEventStatsTypeIndex, ccmPatternAlertGroupStatus=ccmPatternAlertGroupStatus, ccmSmartCallHomeProfile=ccmSmartCallHomeProfile, callHomeContractId=callHomeContractId, ccmPeriodicAlertGroupDayOfMonth=ccmPeriodicAlertGroupDayOfMonth, ccmEventAlertGroupCfgGroup=ccmEventAlertGroupCfgGroup, ccmDestProfileTestTable=ccmDestProfileTestTable, ccmSeverityAlertGroupCfgGroup=ccmSeverityAlertGroupCfgGroup, chMIBCompliance2=chMIBCompliance2, ccmSmtpServerStatusResult=ccmSmtpServerStatusResult, ccmAlertRateLimitGroup=ccmAlertRateLimitGroup, ccmPatternAlertGroupSeverity=ccmPatternAlertGroupSeverity, AlertGroupList=AlertGroupList, sysContactEmailAddress=sysContactEmailAddress, ccmCallHomeDiagSignatureName=ccmCallHomeDiagSignatureName, ccmEventStatsSystemLog=ccmEventStatsSystemLog, ccmEventStatsTest=ccmEventStatsTest, ccmSeverityAlertGroupTable=ccmSeverityAlertGroupTable, ccmCallHomeDiagSignatureSigner=ccmCallHomeDiagSignatureSigner, ccmAlertsDropped=ccmAlertsDropped, callHomeSwInventoryTable=callHomeSwInventoryTable, ccmSmtpMsgSendFailNotifEnable=ccmSmtpMsgSendFailNotifEnable, callHomeDestProfileName=callHomeDestProfileName, chMIBGroups=chMIBGroups, callHomeDestProfileAlertGroups=callHomeDestProfileAlertGroups, chMIBCompliance1=chMIBCompliance1, ccmSmtpServerFailNotif=ccmSmtpServerFailNotif, ccmEventStatsDiagnostic=ccmEventStatsDiagnostic, callHomeDestProfileMsgLevel=callHomeDestProfileMsgLevel, ccmPeriodicAlertGroupTable=ccmPeriodicAlertGroupTable, ccmProfileMessageLevelGroup=ccmProfileMessageLevelGroup, ccmSmtpServersStatus=ccmSmtpServersStatus, ccmAlertActionGroup=ccmAlertActionGroup, ccmSmtpMsgSendFailNotif=ccmSmtpMsgSendFailNotif, callHomeAlertGroupTypeTable=callHomeAlertGroupTypeTable, ccmEventStatsConfiguration=ccmEventStatsConfiguration, ccmCallHomeNotifications=ccmCallHomeNotifications, ccmDestProfileTestStatus=ccmDestProfileTestStatus, ccmAlertGroupSeverity=ccmAlertGroupSeverity, chMIBCompliance7=chMIBCompliance7, ccmDiagSignatureProfileName=ccmDiagSignatureProfileName, ccmSmtpServersAddrType=ccmSmtpServersAddrType, ccmPeriodicSwInventoryCfg=ccmPeriodicSwInventoryCfg, ccmProfileActivationGroup=ccmProfileActivationGroup, ccmCallHomeAaaGroup=ccmCallHomeAaaGroup, callHomeDestProfileTrnsprtMthd=callHomeDestProfileTrnsprtMthd, callHomeDestType=callHomeDestType, ccmCallHomeSecurityLevel=ccmCallHomeSecurityLevel, callHomeEmailMsgDispNotification=callHomeEmailMsgDispNotification, callHomeDestEmailAddress=callHomeDestEmailAddress, ccmSysLogSeverityGroup=ccmSysLogSeverityGroup, ccmSmtpServersAddr=ccmSmtpServersAddr, ccmCallHomeDiagSignatureFuncDescr=ccmCallHomeDiagSignatureFuncDescr, ccmOnDemandCliMsgTrigger=ccmOnDemandCliMsgTrigger, ccmThrottleConfigurationGroup=ccmThrottleConfigurationGroup, callHomeEmailFrom=callHomeEmailFrom, callHomeDestEmailAddressStatus=callHomeDestEmailAddressStatus, callHomeEnable=callHomeEnable, callHomeInventoryInfoValue=callHomeInventoryInfoValue, ccmEventUrgencyLevel=ccmEventUrgencyLevel, ccmMsgThrottlingEnable=ccmMsgThrottlingEnable, ccmPeriodicSwInventoryInfoGroup1=ccmPeriodicSwInventoryInfoGroup1, CallHomeAlert=CallHomeAlert, chConfigurationGroup1=chConfigurationGroup1, ccmHttpProxyServerUseEnable=ccmHttpProxyServerUseEnable, ccmCallHomeDiagSignatureMaxRuntime=ccmCallHomeDiagSignatureMaxRuntime, ccmSmartCallHomeServiceType=ccmSmartCallHomeServiceType, ccmSmtpMsgSendFailNotifCtrlGroup=ccmSmtpMsgSendFailNotifCtrlGroup, ccmHttpTransportVrfGroup=ccmHttpTransportVrfGroup, ccmCallHomeDiagSignatureGroup=ccmCallHomeDiagSignatureGroup, ccmSmtpServerStatusInitiate=ccmSmtpServerStatusInitiate, ccmEventAlertGroupOperSeverity=ccmEventAlertGroupOperSeverity, callHomeDestEmailAddressTable=callHomeDestEmailAddressTable, ccmCallHomeMessageSource=ccmCallHomeMessageSource, ccmCallHomeVrf=ccmCallHomeVrf, chConfigurationGroup=chConfigurationGroup, ccmAlertRateLimit=ccmAlertRateLimit, ccmPatternAlertGroupCfgGroup=ccmPatternAlertGroupCfgGroup, ccmCallHomeReporting=ccmCallHomeReporting, ccmPeriodicAlertGroupHour=ccmPeriodicAlertGroupHour, ccmEventDescription=ccmEventDescription, ccmOnDemandMsgSendControl=ccmOnDemandMsgSendControl, chMIBCompliance4=chMIBCompliance4, callHomeCustomerId=callHomeCustomerId, callHomeDestProfileEntry=callHomeDestProfileEntry, ccmPeriodicAlertGroupIntervalMinutes=ccmPeriodicAlertGroupIntervalMinutes, ccmSmtpMsgSendFailNotifGroup=ccmSmtpMsgSendFailNotifGroup, ccmEventNotif=ccmEventNotif, callHomeHCAlerts=callHomeHCAlerts, chMIBCompliance8=chMIBCompliance8, ccmEventStatsRequest=ccmEventStatsRequest, ccmOnDemandMsgSendControlGroup=ccmOnDemandMsgSendControlGroup, chMIBCompliances=chMIBCompliances, callHomeDestProfileMaxMsgSize=callHomeDestProfileMaxMsgSize, ccmMaxSyslogAlertGroupPatterns=ccmMaxSyslogAlertGroupPatterns, ccmCallHomeDiagSignature=ccmCallHomeDiagSignature, ccmEventStatsEntry=ccmEventStatsEntry)
mibBuilder.exportSymbols("CISCO-CALLHOME-MIB", callHomeEmailReplyTo=callHomeEmailReplyTo, callHomeAlerts=callHomeAlerts, ccmAlertGroupPattern=ccmAlertGroupPattern, ccmSmtpServersEntry=ccmSmtpServersEntry, ccmHttpProxyServerAddr=ccmHttpProxyServerAddr, ccmDiagSignatureActive=ccmDiagSignatureActive, ccmHttpTransportUseVrf=ccmHttpTransportUseVrf, callHomeUserDefCmdName=callHomeUserDefCmdName, ccmAnonymousReportingEnable=ccmAnonymousReportingEnable, ccmPeriodicSwInventoryTimeOfDay=ccmPeriodicSwInventoryTimeOfDay, ccmCallHomeDiagSignatureAvgRuntime=ccmCallHomeDiagSignatureAvgRuntime, callHomeEmailAddrTblMaxEntries=callHomeEmailAddrTblMaxEntries, ccmConfigurationGroup3=ccmConfigurationGroup3, ccmProfileAlertGroupControlGroup=ccmProfileAlertGroupControlGroup, ccmAlertHCStatisticsGroup=ccmAlertHCStatisticsGroup, ccmCallhomeEventsGroup=ccmCallhomeEventsGroup, ccmOnDemandMsgServAvailable=ccmOnDemandMsgServAvailable, ccmSmtpServersVrfGroup=ccmSmtpServersVrfGroup)
