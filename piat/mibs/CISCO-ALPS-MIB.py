...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ALPS-MIB
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Integer32, Gauge32, Counter32, Bits, Counter64, Unsigned32, iso, ModuleIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "Counter32", "Bits", "Counter64", "Unsigned32", "iso", "ModuleIdentity", "TimeTicks", "MibIdentifier")
RowStatus, TimeStamp, TruthValue, TimeInterval, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TruthValue", "TimeInterval", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-ALPS-MIB", alpsRemPeerConnIdleTimer=alpsRemPeerConnIdleTimer, alpsNotificationGroupRev2=alpsNotificationGroupRev2, alpsX121ToIpTransTable=alpsX121ToIpTransTable, alpsSvcMsgTable=alpsSvcMsgTable, alpsRemPeerConnLocalPort=alpsRemPeerConnLocalPort, alpsAscuEnabled=alpsAscuEnabled, alpsRemPeerCfgEntry=alpsRemPeerCfgEntry, alpsRemPeerConnStatRetry=alpsRemPeerConnStatRetry, alpsIfP1024MaxErrCnt=alpsIfP1024MaxErrCnt, alpsX121ToIpTransRowStatus=alpsX121ToIpTransRowStatus, alpsCktP1024OutPktSize=alpsCktP1024OutPktSize, alpsCktAscuCktName=alpsCktAscuCktName, alpsRemPeerConnDropsQFull=alpsRemPeerConnDropsQFull, alpsCktBaseConnType=alpsCktBaseConnType, alpsCktBaseCurrPeerConnId=alpsCktBaseCurrPeerConnId, alpsRemPeerConnState=alpsRemPeerConnState, alpsCktP1024InPktSize=alpsCktP1024InPktSize, alpsRemPeerCfgTCPQLen=alpsRemPeerCfgTCPQLen, alpsRemPeerConnLastTxRx=alpsRemPeerConnLastTxRx, alpsCktP1024Table=alpsCktP1024Table, alpsCktBaseName=alpsCktBaseName, alpsCktBaseDropsCktDisabled=alpsCktBaseDropsCktDisabled, alpsIfHLinkTable=alpsIfHLinkTable, alpsAscuA1=alpsAscuA1, ciscoAlpsMIB=ciscoAlpsMIB, alpsIfP1024ServMsgDropTermAddr=alpsIfP1024ServMsgDropTermAddr, ciscoAlpsMIBNotificationPrefix=ciscoAlpsMIBNotificationPrefix, alpsAscuGroupRev1=alpsAscuGroupRev1, alpsRemPeerCfgNoCircTimer=alpsRemPeerCfgNoCircTimer, alpsPeerObjects=alpsPeerObjects, PYSNMP_MODULE_ID=ciscoAlpsMIB, alpsCktX25Entry=alpsCktX25Entry, alpsCktP1024MatipCloseDelay=alpsCktP1024MatipCloseDelay, alpsAscuEntry=alpsAscuEntry, alpsMibCompliance=alpsMibCompliance, alpsAddrTransGroup=alpsAddrTransGroup, alpsIpAddress=alpsIpAddress, alpsIfP1024Group=alpsIfP1024Group, alpsIfP1024MinGoodPollResp=alpsIfP1024MinGoodPollResp, alpsCktX25IfIndex=alpsCktX25IfIndex, alpsIfP1024NumAscus=alpsIfP1024NumAscus, alpsCktPartialReject=alpsCktPartialReject, alpsRemPeerRemotePort=alpsRemPeerRemotePort, alpsCktBaseHostLinkType=alpsCktBaseHostLinkType, alpsIfP1024ServMsgFormat=alpsIfP1024ServMsgFormat, alpsCktGroup=alpsCktGroup, alpsRemPeerCfgProtocol=alpsRemPeerCfgProtocol, alpsCktP1024BackupPeerAddr=alpsCktP1024BackupPeerAddr, alpsRemPeerConnType=alpsRemPeerConnType, alpsCktBaseDlcType=alpsCktBaseDlcType, alpsSvcMsgEntry=alpsSvcMsgEntry, alpsPeerConnStatusChange=alpsPeerConnStatusChange, alpsCktBaseAlarmsEnabled=alpsCktBaseAlarmsEnabled, alpsRemPeerConnInPackets=alpsRemPeerConnInPackets, alpsRemPeerCfgAlarmsOn=alpsRemPeerCfgAlarmsOn, alpsRemPeerCfgIpAddr=alpsRemPeerCfgIpAddr, alpsCktX25DlcType=alpsCktX25DlcType, alpsRemPeerAlarmsEnabled=alpsRemPeerAlarmsEnabled, alpsIfHostlinkGroup=alpsIfHostlinkGroup, alpsRemPeerCfgTable=alpsRemPeerCfgTable, alpsRemPeerEntry=alpsRemPeerEntry, AlpsCktName=AlpsCktName, alpsAscuTable=alpsAscuTable, alpsAscuOutPackets=alpsAscuOutPackets, alpsPeerKeepaliveMaxRetries=alpsPeerKeepaliveMaxRetries, alpsRemPeerDropsPeerUnreach=alpsRemPeerDropsPeerUnreach, alpsAscuAutoReset=alpsAscuAutoReset, alpsAscuDownReason=alpsAscuDownReason, alpsCktAscuCktDlcType=alpsCktAscuCktDlcType, alpsCktAscuA2=alpsCktAscuA2, alpsCktX25RemoteX121=alpsCktX25RemoteX121, alpsSvcMsgGroup=alpsSvcMsgGroup, alpsCktP1024RowStatus=alpsCktP1024RowStatus, alpsIfP1024MaxRetrans=alpsIfP1024MaxRetrans, alpsRemPeerLocalPort=alpsRemPeerLocalPort, alpsCktBaseLifeTimeTimer=alpsCktBaseLifeTimeTimer, alpsCktBaseDownReason=alpsCktBaseDownReason, alpsRemPeerConnIpAddr=alpsRemPeerConnIpAddr, alpsIfP1024CurrErrCnt=alpsIfP1024CurrErrCnt, alpsPeerGroup=alpsPeerGroup, alpsCktBaseEnabled=alpsCktBaseEnabled, alpsIfHLinkHostHld=alpsIfHLinkHostHld, alpsAscuGroup=alpsAscuGroup, alpsRemPeerConnProtocol=alpsRemPeerConnProtocol, alpsCktP1024DropsUnkAscu=alpsCktP1024DropsUnkAscu, alpsRemPeerConnTCPQLen=alpsRemPeerConnTCPQLen, alpsCktAscuTable=alpsCktAscuTable, alpsRemPeerOutOctets=alpsRemPeerOutOctets, alpsIfP1024EncapType=alpsIfP1024EncapType, alpsCktP1024DlcType=alpsCktP1024DlcType, alpsCktBaseInPackets=alpsCktBaseInPackets, alpsCktBaseInOctets=alpsCktBaseInOctets, alpsCktP1024SvcMsgIntvl=alpsCktP1024SvcMsgIntvl, alpsIfP1024GATimeout=alpsIfP1024GATimeout, alpsRemPeerRowStatus=alpsRemPeerRowStatus, alpsCktP1024EmtoxX121=alpsCktP1024EmtoxX121, alpsRemPeerTCPQlen=alpsRemPeerTCPQlen, alpsCktP1024Ax25LCN=alpsCktP1024Ax25LCN, alpsCktBaseEntry=alpsCktBaseEntry, alpsIfP1024ServMsgStatusChange=alpsIfP1024ServMsgStatusChange, alpsCktBaseHostLinkNumber=alpsCktBaseHostLinkNumber, alpsCktBaseDropsQOverflow=alpsCktBaseDropsQOverflow, alpsAscuInPackets=alpsAscuInPackets, alpsIfObjects=alpsIfObjects, alpsAscuRetryOption=alpsAscuRetryOption, alpsNotificationGroup=alpsNotificationGroup, alpsRemPeerConnActivation=alpsRemPeerConnActivation, alpsIfP1024GroupRev1=alpsIfP1024GroupRev1, alpsNotificationGroupRev1=alpsNotificationGroupRev1, alpsCktAscuIfIndex=alpsCktAscuIfIndex, alpsIfP1024PollPauseTimeout=alpsIfP1024PollPauseTimeout, alpsSvcMsgNum=alpsSvcMsgNum, alpsCktBasePriPeerAddr=alpsCktBasePriPeerAddr, ciscoAlpsMIBNotifications=ciscoAlpsMIBNotifications, alpsCktP1024Entry=alpsCktP1024Entry, alpsAscuInOctets=alpsAscuInOctets, alpsRemPeerConnUptime=alpsRemPeerConnUptime, alpsAscuFwdStatusOption=alpsAscuFwdStatusOption, alpsAscuOutOctets=alpsAscuOutOctets, alpsRemPeerConnDropsVersion=alpsRemPeerConnDropsVersion, alpsCktP1024WinOut=alpsCktP1024WinOut, alpsPeerKeepaliveTimeout=alpsPeerKeepaliveTimeout, alpsPeerLocalIpAddr=alpsPeerLocalIpAddr, alpsCktStatusChange=alpsCktStatusChange, alpsPeerGroupRev1=alpsPeerGroupRev1, alpsIfHLinkAx25PvcDamp=alpsIfHLinkAx25PvcDamp, alpsRemPeerNumActiveCkts=alpsRemPeerNumActiveCkts, alpsMibConformance=alpsMibConformance, alpsRemPeerConnEntry=alpsRemPeerConnEntry, alpsAscuRowStatus=alpsAscuRowStatus, alpsCktBaseDropsLifeTimeExpd=alpsCktBaseDropsLifeTimeExpd, alpsRemPeerState=alpsRemPeerState, alpsRemPeerConnDropsUnreach=alpsRemPeerConnDropsUnreach, alpsRemPeerConnInOctets=alpsRemPeerConnInOctets, alpsCktBaseRemHld=alpsCktBaseRemHld, alpsCktX25Table=alpsCktX25Table, alpsMibCompliances=alpsMibCompliances, alpsCktX25HostX121=alpsCktX25HostX121, alpsRemPeerConnForeignPort=alpsRemPeerConnForeignPort, alpsCktBaseNumActiveAscus=alpsCktBaseNumActiveAscus, alpsRemPeerConnOutPackets=alpsRemPeerConnOutPackets, alpsRemPeerInPackets=alpsRemPeerInPackets, alpsAscuDropsAscuDown=alpsAscuDropsAscuDown, alpsCktP1024RetryTimer=alpsCktP1024RetryTimer, alpsAscuState=alpsAscuState, alpsX121ToIpTransEntry=alpsX121ToIpTransEntry, alpsX121=alpsX121, alpsCktBaseState=alpsCktBaseState, alpsCktAscuId=alpsCktAscuId, alpsIfHLinkActiveCkts=alpsIfHLinkActiveCkts, alpsAscuId=alpsAscuId, alpsPeerInCallsAcceptFlag=alpsPeerInCallsAcceptFlag, alpsAscuMaxMsgLength=alpsAscuMaxMsgLength, alpsRemPeerConnAlarmsOn=alpsRemPeerConnAlarmsOn, alpsAscuObjects=alpsAscuObjects, alpsIfP1024Table=alpsIfP1024Table, alpsMibComplianceRev2=alpsMibComplianceRev2, alpsCktX25DropsVcReset=alpsCktX25DropsVcReset, alpsPeer=alpsPeer, alpsGroups=alpsGroups, alpsIfP1024Entry=alpsIfP1024Entry, alpsAscuA2=alpsAscuA2, alpsAscuAlarmsEnabled=alpsAscuAlarmsEnabled, alpsMibGroups=alpsMibGroups, alpsIfHLinkEntry=alpsIfHLinkEntry, alpsCktP1024IdleTimer=alpsCktP1024IdleTimer, alpsCktAscuEntry=alpsCktAscuEntry, alpsRemPeerConnLastRxAny=alpsRemPeerConnLastRxAny, alpsCktBaseOutOctets=alpsCktBaseOutOctets, alpsRemPeerIdleTimer=alpsRemPeerIdleTimer, alpsRemPeerConnCreation=alpsRemPeerConnCreation, alpsCktP1024SvcMsgList=alpsCktP1024SvcMsgList, alpsAscuCktName=alpsAscuCktName, alpsAscuDropsAscuDisabled=alpsAscuDropsAscuDisabled, alpsAscuStatusChange=alpsAscuStatusChange, alpsMibComplianceRev1=alpsMibComplianceRev1, ciscoAlpsMIBObjects=ciscoAlpsMIBObjects, alpsRemPeerConnStatIntvl=alpsRemPeerConnStatIntvl, alpsIfP1024PollRespTimeout=alpsIfP1024PollRespTimeout, alpsRemPeerConnNumActCirc=alpsRemPeerConnNumActCirc, alpsSvcMsgRowStatus=alpsSvcMsgRowStatus, alpsCktAscuA1=alpsCktAscuA1, alpsRemPeerCfgActivation=alpsRemPeerCfgActivation, alpsCktBaseCurrentPeer=alpsCktBaseCurrentPeer, alpsCktP1024WinIn=alpsCktP1024WinIn, alpsRemPeerConnOutOctets=alpsRemPeerConnOutOctets, alpsRemPeerConnTable=alpsRemPeerConnTable, alpsCktBaseTable=alpsCktBaseTable, alpsCktObjects=alpsCktObjects, alpsRemPeerIpAddr=alpsRemPeerIpAddr, alpsSvcMsg=alpsSvcMsg, alpsRemPeerOutPackets=alpsRemPeerOutPackets, alpsCktBaseLocalHld=alpsCktBaseLocalHld, alpsRemPeerDropsGiant=alpsRemPeerDropsGiant, alpsIfHLinkNumber=alpsIfHLinkNumber, alpsSvcMsgListNum=alpsSvcMsgListNum, alpsRemPeerCfgIdleTimer=alpsRemPeerCfgIdleTimer, alpsCktOpenFailure=alpsCktOpenFailure, alpsRemPeerConnDownReason=alpsRemPeerConnDownReason, alpsIfP1024PollingRatio=alpsIfP1024PollingRatio, alpsPeerLocalAtpPort=alpsPeerLocalAtpPort, alpsRemPeerInOctets=alpsRemPeerInOctets, alpsCktBaseRowStatus=alpsCktBaseRowStatus, alpsPeerStatusChange=alpsPeerStatusChange, alpsAscuDropsGarbledPkts=alpsAscuDropsGarbledPkts, alpsRemPeerCfgStatRetry=alpsRemPeerCfgStatRetry, alpsCktX25LCN=alpsCktX25LCN, alpsRemPeerConnDropsGiant=alpsRemPeerConnDropsGiant, AlpsAscuA1A2Value=AlpsAscuA1A2Value, alpsRemPeerTable=alpsRemPeerTable, alpsRemPeerCfgRowStatus=alpsRemPeerCfgRowStatus, alpsCktAscuStatus=alpsCktAscuStatus, alpsIfHLinkX25ProtocolType=alpsIfHLinkX25ProtocolType, alpsRemPeerConnIdString=alpsRemPeerConnIdString, alpsRemPeerDropsQFull=alpsRemPeerDropsQFull, alpsIfHLinkEmtoxHostX121=alpsIfHLinkEmtoxHostX121, alpsGlobalObjects=alpsGlobalObjects, alpsRemPeerConnNoCircTimer=alpsRemPeerConnNoCircTimer, alpsRemPeerCfgStatIntvl=alpsRemPeerCfgStatIntvl, alpsRemPeerUptime=alpsRemPeerUptime, alpsCktBaseOutPackets=alpsCktBaseOutPackets)
