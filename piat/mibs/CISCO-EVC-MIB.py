...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-EVC-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:40:08 2019
...
Counter32, Gauge32, TimeTicks, ModuleIdentity, Bits, MibIdentifier, iso, Unsigned32, NotificationType, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "TimeTicks", "ModuleIdentity", "Bits", "MibIdentifier", "iso", "Unsigned32", "NotificationType", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("CISCO-EVC-MIB", cevcSIVlanRewriteStorageType=cevcSIVlanRewriteStorageType, cevcSIPrimaryVlanEntry=cevcSIPrimaryVlanEntry, cevcPortL2ControlProtocolType=cevcPortL2ControlProtocolType, cevcEvcEntry=cevcEvcEntry, cevcSIEntry=cevcSIEntry, cevcSIVlanRewriteSymmetric=cevcSIVlanRewriteSymmetric, cevcSIMatchEncapStorageType=cevcSIMatchEncapStorageType, cevcSIPrimaryVlanEndingVlan=cevcSIPrimaryVlanEndingVlan, cevcEvcCfgUnis=cevcEvcCfgUnis, ciscoEvcMIBObjects=ciscoEvcMIBObjects, ServiceInstanceTargetType=ServiceInstanceTargetType, cevcEvcUniId=cevcEvcUniId, cevcSIForwardBdNumber=cevcSIForwardBdNumber, cevcSICEVlanEndingVlan=cevcSICEVlanEndingVlan, cevcSIForwardBdNumberBase=cevcSIForwardBdNumberBase, cevcSIStorageType=cevcSIStorageType, cevcSIForwardingType=cevcSIForwardingType, CiscoEvcIndexOrZero=CiscoEvcIndexOrZero, CiscoEvcIndex=CiscoEvcIndex, cevcSIVlanRewriteEncapsulation=cevcSIVlanRewriteEncapsulation, cevcSIMatchStorageType=cevcSIMatchStorageType, cevcSIMatchEncapPriorityCos=cevcSIMatchEncapPriorityCos, cevcEvcNotificationConfig=cevcEvcNotificationConfig, cevcUniTable=cevcUniTable, cevcSIMatchCriteriaIndex=cevcSIMatchCriteriaIndex, cevcUniServiceAttributes=cevcUniServiceAttributes, cevcSIGroupRev1=cevcSIGroupRev1, cevcUniPortType=cevcUniPortType, cevcSIMatchEncapRowStatus=cevcSIMatchEncapRowStatus, cevcEvcDeletionNotification=cevcEvcDeletionNotification, cevcSIType=cevcSIType, cevcEvcType=cevcEvcType, cevcSIForwardBdTable=cevcSIForwardBdTable, cevcSIForwardBdNumber4kBitmap=cevcSIForwardBdNumber4kBitmap, cevcViolationCause=cevcViolationCause, ciscoEvcMIBComplianceRev2=ciscoEvcMIBComplianceRev2, cevcEvc=cevcEvc, cevcEvcStateTable=cevcEvcStateTable, cevcSIID=cevcSIID, cevcSIForwardBdNumber3kBitmap=cevcSIForwardBdNumber3kBitmap, cevcEvcUniOperStatus=cevcEvcUniOperStatus, ServiceInstanceInterface=ServiceInstanceInterface, cevcSIVlanRewriteDirection=cevcSIVlanRewriteDirection, cevcSICEVlanRowStatus=cevcSICEVlanRowStatus, cevcSISecondaryVlanRowStatus=cevcSISecondaryVlanRowStatus, cevcSIL2ControlProtocolEntry=cevcSIL2ControlProtocolEntry, PYSNMP_MODULE_ID=ciscoEvcMIB, cevcSIMatchEncapPrimaryCos=cevcSIMatchEncapPrimaryCos, cevcPortMode=cevcPortMode, cevcEvcRowStatus=cevcEvcRowStatus, cevcUniEntry=cevcUniEntry, cevcSIMatchCriteriaGroupRev1=cevcSIMatchCriteriaGroupRev1, cevcUniCEVlanEvcBeginningVlan=cevcUniCEVlanEvcBeginningVlan, cevcMacSecurityViolationNotification=cevcMacSecurityViolationNotification, cevcSIMatchEncapTable=cevcSIMatchEncapTable, CevcMacSecurityViolationCauseType=CevcMacSecurityViolationCauseType, cevcSIForwardGroupRev1=cevcSIForwardGroupRev1, cevcSISecondaryVlanEntry=cevcSISecondaryVlanEntry, ciscoEvcNotificationPrefix=ciscoEvcNotificationPrefix, cevcSISecondaryVlanEndingVlan=cevcSISecondaryVlanEndingVlan, CevcL2ControlProtocolType=CevcL2ControlProtocolType, cevcEvcIdentifier=cevcEvcIdentifier, cevcSICosMatchCriteriaGroup=cevcSICosMatchCriteriaGroup, cevcEvcNotificationGroupRev1=cevcEvcNotificationGroupRev1, cevcMaxNumEvcs=cevcMaxNumEvcs, cevcSICreationType=cevcSICreationType, cevcUniCEVlanEvcEndingVlan=cevcUniCEVlanEvcEndingVlan, cevcSIForwardGroup=cevcSIForwardGroup, cevcSIMatchCriteriaGroup=cevcSIMatchCriteriaGroup, ciscoEvcMIBComplianceRev1=ciscoEvcMIBComplianceRev1, cevcMacAddress=cevcMacAddress, cevcSIName=cevcSIName, cevcSIVlanRewriteGroup=cevcSIVlanRewriteGroup, cevcSICEVlanStorageType=cevcSICEVlanStorageType, cevcSISecondaryVlanTable=cevcSISecondaryVlanTable, cevcEvcUniEntry=cevcEvcUniEntry, cevcSIPrimaryVlanBeginningVlan=cevcSIPrimaryVlanBeginningVlan, cevcSIVlanRewriteVlan1=cevcSIVlanRewriteVlan1, cevcSIStateTable=cevcSIStateTable, cevcSICEVlanEntry=cevcSICEVlanEntry, cevcSISecondaryVlanStorageType=cevcSISecondaryVlanStorageType, cevcSIForwardBdStorageType=cevcSIForwardBdStorageType, cevcEvcUniIndex=cevcEvcUniIndex, cevcSIMatchEncapPayloadTypes=cevcSIMatchEncapPayloadTypes, cevcUniCEVlanEvcTable=cevcUniCEVlanEvcTable, cevcMacSecurityViolation=cevcMacSecurityViolation, cevcSIL2ControlProtocolAction=cevcSIL2ControlProtocolAction, cevcSITarget=cevcSITarget, cevcNumCfgEvcs=cevcNumCfgEvcs, cevcSIGroup=cevcSIGroup, cevcPortEntry=cevcPortEntry, cevcPortMaxNumServiceInstances=cevcPortMaxNumServiceInstances, cevcSIStateEntry=cevcSIStateEntry, cevcSIVlanRewriteVlan2=cevcSIVlanRewriteVlan2, cevcSIForwardBdNumber2kBitmap=cevcSIForwardBdNumber2kBitmap, cevcUniCEVlanEvcEntry=cevcUniCEVlanEvcEntry, cevcSITargetType=cevcSITargetType, cevcSIVlanRewriteEntry=cevcSIVlanRewriteEntry, cevcSIPrimaryVlanTable=cevcSIPrimaryVlanTable, cevcEvcNotifyEnabled=cevcEvcNotifyEnabled, cevcEvcStorageType=cevcEvcStorageType, cevcSIMatchCriteriaTable=cevcSIMatchCriteriaTable, cevcPortL2ControlProtocolEntry=cevcPortL2ControlProtocolEntry, cevcEvcIndex=cevcEvcIndex, cevcSIMatchCriteriaType=cevcSIMatchCriteriaType, cevcPortTable=cevcPortTable, cevcPortL2ControlProtocolAction=cevcPortL2ControlProtocolAction, cevcSIOperStatus=cevcSIOperStatus, cevcSIVlanRewriteAction=cevcSIVlanRewriteAction, cevcSIMatchCriteriaEntry=cevcSIMatchCriteriaEntry, ServiceInstanceTarget=ServiceInstanceTarget, cevcEvcTable=cevcEvcTable, cevcSIVlanRewriteTable=cevcSIVlanRewriteTable, cevcEvcCreationNotification=cevcEvcCreationNotification, cevcUniEvcIndex=cevcUniEvcIndex, ciscoEvcMIB=ciscoEvcMIB, cevcSystem=cevcSystem, cevcSIL2ControlProtocolType=cevcSIL2ControlProtocolType, cevcSIMatchEncapPayloadType=cevcSIMatchEncapPayloadType, cevcSIIndex=cevcSIIndex, cevcSIPrimaryVlanRowStatus=cevcSIPrimaryVlanRowStatus, cevcSIForwardBdRowStatus=cevcSIForwardBdRowStatus, ciscoEvcMIBConformance=ciscoEvcMIBConformance, cevcSICEVlanTable=cevcSICEVlanTable, cevcSICEVlanBeginningVlan=cevcSICEVlanBeginningVlan, cevcEvcOperStatus=cevcEvcOperStatus, cevcSIMatchRowStatus=cevcSIMatchRowStatus, cevcUniIdentifier=cevcUniIdentifier, cevcSIForwardBdEntry=cevcSIForwardBdEntry, cevcMaxMacConfigLimit=cevcMaxMacConfigLimit, cevcSIRowStatus=cevcSIRowStatus, cevcPort=cevcPort, cevcSIMatchEncapEncapsulation=cevcSIMatchEncapEncapsulation, cevcSIPrimaryVlanStorageType=cevcSIPrimaryVlanStorageType, cevcPortMaxNumEVCs=cevcPortMaxNumEVCs, ciscoEvcMIBGroups=ciscoEvcMIBGroups, cevcSIMatchEncapSecondaryCos=cevcSIMatchEncapSecondaryCos, cevcEvcActiveUnis=cevcEvcActiveUnis, cevcPortL2ControlProtocolTable=cevcPortL2ControlProtocolTable, cevcSIForwardBdNumber1kBitmap=cevcSIForwardBdNumber1kBitmap, cevcSystemGroup=cevcSystemGroup, cevcMacSecurityViolationGroup=cevcMacSecurityViolationGroup, cevcEvcUniTable=cevcEvcUniTable, cevcSIMatchEncapEntry=cevcSIMatchEncapEntry, ciscoEvcMIBCompliances=ciscoEvcMIBCompliances, cevcSIMatchEncapValid=cevcSIMatchEncapValid, cevcSIAdminStatus=cevcSIAdminStatus, cevcSIL2ControlProtocolTable=cevcSIL2ControlProtocolTable, cevcSITable=cevcSITable, ciscoEvcMIBCompliance=ciscoEvcMIBCompliance, cevcEvcNotificationConfigGroup=cevcEvcNotificationConfigGroup, cevcServiceInstance=cevcServiceInstance, cevcEvcLocalUniIfIndex=cevcEvcLocalUniIfIndex, cevcSIEvcIndex=cevcSIEvcIndex, cevcEvcGroup=cevcEvcGroup, cevcPortGroup=cevcPortGroup, cevcEvcNotificationGroup=cevcEvcNotificationGroup, cevcEvcStatusChangedNotification=cevcEvcStatusChangedNotification, cevcSISecondaryVlanBeginningVlan=cevcSISecondaryVlanBeginningVlan, cevcEvcStateEntry=cevcEvcStateEntry, ciscoEvcMIBNotifications=ciscoEvcMIBNotifications, cevcSIVlanRewriteRowStatus=cevcSIVlanRewriteRowStatus)
