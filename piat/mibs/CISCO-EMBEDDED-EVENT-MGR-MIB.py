...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-EMBEDDED-EVENT-MGR-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:41:37 2019
...
Unsigned32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter64, Counter32, Gauge32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter64", "Counter32", "Gauge32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("CISCO-EMBEDDED-EVENT-MGR-MIB", cEventMgrMIBObjects=cEventMgrMIBObjects, ceemRegisteredPolicyTable=ceemRegisteredPolicyTable, cEventMgrCompliances=cEventMgrCompliances, cEventMgrGroups=cEventMgrGroups, ceemHistoryEventTable=ceemHistoryEventTable, ceemEventMapTable=ceemEventMapTable, ceemHistoryEventType2=ceemHistoryEventType2, ceemHistoryNotifyType=ceemHistoryNotifyType, ceemRegisteredPolicyEventType8=ceemRegisteredPolicyEventType8, ceemEventMap=ceemEventMap, ceemRegisteredPolicyEntry=ceemRegisteredPolicyEntry, ceemHistoryEventType5=ceemHistoryEventType5, ceemRegisteredPolicyName=ceemRegisteredPolicyName, ceemRegisteredPolicyEventType5=ceemRegisteredPolicyEventType5, cEventMgrRegisteredPolicyGroupSup1=cEventMgrRegisteredPolicyGroupSup1, ceemEventIndex=ceemEventIndex, cEventMgrConformance=cEventMgrConformance, cEventMgrMIBNotif=cEventMgrMIBNotif, ceemRegisteredPolicyIndex=ceemRegisteredPolicyIndex, PYSNMP_MODULE_ID=cEventMgrMIB, ceemRegisteredPolicy=ceemRegisteredPolicy, ceemEventName=ceemEventName, ceemHistoryPolicyIntData2=ceemHistoryPolicyIntData2, ceemRegisteredPolicyNotifFlag=ceemRegisteredPolicyNotifFlag, ceemHistoryEventType3=ceemHistoryEventType3, ceemRegisteredPolicyStatus=ceemRegisteredPolicyStatus, ceemEventMapEntry=ceemEventMapEntry, ceemRegisteredPolicyRunCount=ceemRegisteredPolicyRunCount, cEventMgrServerEvent=cEventMgrServerEvent, ceemRegisteredPolicyRunTime=ceemRegisteredPolicyRunTime, cEventMgrRegisteredPolicyGroup=cEventMgrRegisteredPolicyGroup, ceemRegisteredPolicyRegTime=ceemRegisteredPolicyRegTime, ceemHistory=ceemHistory, ceemHistoryEventEntry=ceemHistoryEventEntry, ceemHistoryPolicyExitStatus=ceemHistoryPolicyExitStatus, ceemRegisteredPolicyEventType4=ceemRegisteredPolicyEventType4, ceemRegisteredPolicyEnabledTime=ceemRegisteredPolicyEnabledTime, ceemRegisteredPolicyEventType7=ceemRegisteredPolicyEventType7, ceemRegisteredPolicyEventType2=ceemRegisteredPolicyEventType2, cEventMgrMIB=cEventMgrMIB, cEventMgrDescrGroup=cEventMgrDescrGroup, cEventMgrNotificationsGroup=cEventMgrNotificationsGroup, ceemRegisteredPolicyEventType1=ceemRegisteredPolicyEventType1, ceemHistoryPolicyStrData=ceemHistoryPolicyStrData, ceemHistoryMaxEventEntries=ceemHistoryMaxEventEntries, cEventMgrHistoryGroup=cEventMgrHistoryGroup, cEventMgrPolicyEvent=cEventMgrPolicyEvent, ceemEventDescrText=ceemEventDescrText, ceemHistoryEventType1=ceemHistoryEventType1, ceemHistoryLastEventEntry=ceemHistoryLastEventEntry, ceemHistoryEventIndex=ceemHistoryEventIndex, ceemRegisteredPolicyEventType6=ceemRegisteredPolicyEventType6, ceemHistoryPolicyPath=ceemHistoryPolicyPath, ceemHistoryPolicyName=ceemHistoryPolicyName, ceemHistoryPolicyIntData1=ceemHistoryPolicyIntData1, cEventMgrComplianceRev1=cEventMgrComplianceRev1, ceemHistoryEventType8=ceemHistoryEventType8, ceemHistoryEventType6=ceemHistoryEventType6, cEventMgrHistoryGroupSup1=cEventMgrHistoryGroupSup1, ceemRegisteredPolicyType=ceemRegisteredPolicyType, cEventMgrCompliance=cEventMgrCompliance, ceemHistoryEventType7=ceemHistoryEventType7, ceemRegisteredPolicyEventType3=ceemRegisteredPolicyEventType3, NotifySource=NotifySource, ceemHistoryEventType4=ceemHistoryEventType4)
