...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-NETSYNC-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:48:15 2019
...
Integer32, IpAddress, Unsigned32, iso, Bits, Counter32, Gauge32, ObjectIdentity, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Unsigned32", "iso", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("CISCO-NETSYNC-MIB", cnsInpSrcQualityLevelRxCfg=cnsInpSrcQualityLevelRxCfg, cnsInpSrcQualityLevelTxCfg=cnsInpSrcQualityLevelTxCfg, cnsT4ClkSrcAlarm=cnsT4ClkSrcAlarm, cnsT4ClkSrcQualityLevelTx=cnsT4ClkSrcQualityLevelTx, cnsInpSrcAlarmClear=cnsInpSrcAlarmClear, CiscoNetsyncNetworkOption=CiscoNetsyncNetworkOption, cnsClkSelGlobNetsyncEnable=cnsClkSelGlobNetsyncEnable, cnsExtOutputTable=cnsExtOutputTable, cnsClkSelGlobClockMode=cnsClkSelGlobClockMode, CiscoNetsyncSSMCap=CiscoNetsyncSSMCap, CiscoNetsyncQualityLevel=CiscoNetsyncQualityLevel, cnsInpSrcFailClear=cnsInpSrcFailClear, ciscoNetsyncMIBConform=ciscoNetsyncMIBConform, CiscoNetsyncESMCCap=CiscoNetsyncESMCCap, ciscoNetsyncMIBNotificationGroup=ciscoNetsyncMIBNotificationGroup, cnsT4ClkSrcQualityLevelRx=cnsT4ClkSrcQualityLevelRx, cnsT4ClkSrcObjectGroup=cnsT4ClkSrcObjectGroup, cnsExtOutQualityLevel=cnsExtOutQualityLevel, cnsT4ClkSrcWtrTime=cnsT4ClkSrcWtrTime, cnsT4ClkSrcIntfType=cnsT4ClkSrcIntfType, cnsInpSrcHoldoffTime=cnsInpSrcHoldoffTime, cnsInpSrcSignalFailure=cnsInpSrcSignalFailure, ciscoNetsyncInputSignalFailureStatus=ciscoNetsyncInputSignalFailureStatus, cnsT4ClkSrcESMCCap=cnsT4ClkSrcESMCCap, cnsT4ClkSrcMSW=cnsT4ClkSrcMSW, PYSNMP_MODULE_ID=ciscoNetsyncMIB, cnsT4ClockSourceEntry=cnsT4ClockSourceEntry, cnsT4ClockSourceTable=cnsT4ClockSourceTable, cnsSelectedInputSourceTable=cnsSelectedInputSourceTable, cnsClkSelGlobalTable=cnsClkSelGlobalTable, cnsInpSrcQualityLevel=cnsInpSrcQualityLevel, cnsMIBEnableStatusNotification=cnsMIBEnableStatusNotification, CiscoNetsyncIfType=CiscoNetsyncIfType, cnsClkSelGlobLastHoldoverSeconds=cnsClkSelGlobLastHoldoverSeconds, cnsExtOutSquelch=cnsExtOutSquelch, cnsInpSrcAlarmInfo=cnsInpSrcAlarmInfo, cnsSelInpSrcMSW=cnsSelInpSrcMSW, cnsExtOutputObjectGroup=cnsExtOutputObjectGroup, ciscoNetsyncMIB=ciscoNetsyncMIB, cnsSelInpSrcTimestamp=cnsSelInpSrcTimestamp, ciscoNetsyncMIBNotifs=ciscoNetsyncMIBNotifs, cnsExtOutName=cnsExtOutName, cnsT4ClkSrcQualityLevelTxCfg=cnsT4ClkSrcQualityLevelTxCfg, ciscoNetsyncMIBGroups=ciscoNetsyncMIBGroups, cnsExtOutIntfType=cnsExtOutIntfType, cnsInpSrcFSW=cnsInpSrcFSW, cnsSelInpSrcPriority=cnsSelInpSrcPriority, cnsT4ClkSrcHoldoffTime=cnsT4ClkSrcHoldoffTime, cnsT4ClkSrcFSW=cnsT4ClkSrcFSW, cnsMIBNotifEnablesGroup=cnsMIBNotifEnablesGroup, cnsClkSelGlobEECOption=cnsClkSelGlobEECOption, ciscoNetsyncSelectedT0Clock=ciscoNetsyncSelectedT0Clock, cnsSelInpSrcQualityLevel=cnsSelInpSrcQualityLevel, CiscoNetsyncClockMode=CiscoNetsyncClockMode, cnsClkSelGlobRevertiveMode=cnsClkSelGlobRevertiveMode, cnsClkSelGlobWtrTime=cnsClkSelGlobWtrTime, cnsT4ClkSrcQualityLevelRxCfg=cnsT4ClkSrcQualityLevelRxCfg, CiscoNetsyncQLMode=CiscoNetsyncQLMode, cnsInpSrcNetsyncIndex=cnsInpSrcNetsyncIndex, cnsInpSrcQualityLevelTx=cnsInpSrcQualityLevelTx, cnsSelInpSrcFSW=cnsSelInpSrcFSW, cnsExtOutSelNetsyncIndex=cnsExtOutSelNetsyncIndex, ciscoNetsyncMIBCompliance=ciscoNetsyncMIBCompliance, cnsT4ClkSrcSignalFailure=cnsT4ClkSrcSignalFailure, cnsInpSrcWtrTime=cnsInpSrcWtrTime, cnsInpSrcName=cnsInpSrcName, cnsSelInpSrcIntfType=cnsSelInpSrcIntfType, cnsExtOutMSW=cnsExtOutMSW, ciscoNetsyncMIBNotifControl=ciscoNetsyncMIBNotifControl, cnsClkSelGlobProcessMode=cnsClkSelGlobProcessMode, cnsInpSrcIntfType=cnsInpSrcIntfType, cnsClkSelGlobHoldoffTime=cnsClkSelGlobHoldoffTime, cnsNotifObjects=cnsNotifObjects, cnsExtOutputEntry=cnsExtOutputEntry, cnsT4ClkSrcName=cnsT4ClkSrcName, cnsClkSelGlobCurrHoldoverSeconds=cnsClkSelGlobCurrHoldoverSeconds, cnsT4ClkSrcPriority=cnsT4ClkSrcPriority, cnsInputSourceTable=cnsInputSourceTable, cnsSelInpSrcNetsyncIndex=cnsSelInpSrcNetsyncIndex, cnsExtOutFSW=cnsExtOutFSW, cnsExtOutListIndex=cnsExtOutListIndex, cnsInpSrcAlarm=cnsInpSrcAlarm, cnsClkSelGlobalEntry=cnsClkSelGlobalEntry, cnsInpSrcLockout=cnsInpSrcLockout, cnsInputSourceObjectGroup=cnsInputSourceObjectGroup, cnsInpSrcQualityLevelRx=cnsInpSrcQualityLevelRx, cnsInpSrcPriority=cnsInpSrcPriority, ciscoNetsyncMIBObjects=ciscoNetsyncMIBObjects, ciscoNetsyncSelectedT4Clock=ciscoNetsyncSelectedT4Clock, cnsInpSrcSSMCap=cnsInpSrcSSMCap, cnsSelectedInputSourceObjectGroup=cnsSelectedInputSourceObjectGroup, cnsClkSelGlobESMCMode=cnsClkSelGlobESMCMode, cnsInpSrcMSW=cnsInpSrcMSW, CiscoNetsyncAlarmInfo=CiscoNetsyncAlarmInfo, cnsT4ClkSrcSSMCap=cnsT4ClkSrcSSMCap, cnsExtOutPriority=cnsExtOutPriority, cnsClkSelGlobalObjectGroup=cnsClkSelGlobalObjectGroup, ciscoNetsyncInputAlarmStatus=ciscoNetsyncInputAlarmStatus, CiscoNetsyncEECOption=CiscoNetsyncEECOption, cnsSelectedInputSourceEntry=cnsSelectedInputSourceEntry, cnsSelInpSrcName=cnsSelInpSrcName, cnsT4ClkSrcAlarmInfo=cnsT4ClkSrcAlarmInfo, cnsT4ClkSrcLockout=cnsT4ClkSrcLockout, cnsInputSourceEntry=cnsInputSourceEntry, cnsClkSelGloProcIndex=cnsClkSelGloProcIndex, ciscoNetsyncMIBCompliances=ciscoNetsyncMIBCompliances, cnsClkSelGlobNetworkOption=cnsClkSelGlobNetworkOption, cnsClkSelGlobNofSources=cnsClkSelGlobNofSources, cnsT4ClkSrcQualityLevel=cnsT4ClkSrcQualityLevel, cnsT4ClkSrcNetsyncIndex=cnsT4ClkSrcNetsyncIndex, ciscoNetsyncMIBTables=ciscoNetsyncMIBTables, cnsInpSrcESMCCap=cnsInpSrcESMCCap)
