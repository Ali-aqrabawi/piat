...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IETF-PIM-MIB
...
cIpMRouteSourceMask, cIpMRouteNextHopSource, cIpMRouteNextHopSourceMask, cIpMRouteAddrType, cIpMRouteNextHopGroup, cIpMRouteNextHopAddress, cIpMRouteGroup, cIpMRouteNextHopIfIndex, cIpMRouteSource, cIpMRouteNextHopAddrType = mibBuilder.importSymbols("CISCO-IETF-IPMROUTE-MIB", "cIpMRouteSourceMask", "cIpMRouteNextHopSource", "cIpMRouteNextHopSourceMask", "cIpMRouteAddrType", "cIpMRouteNextHopGroup", "cIpMRouteNextHopAddress", "cIpMRouteGroup", "cIpMRouteNextHopIfIndex", "cIpMRouteSource", "cIpMRouteNextHopAddrType")
...
mibBuilder.exportSymbols("CISCO-IETF-PIM-MIB", cPimRPMapAddress=cPimRPMapAddress, cPimMIBObjects=cPimMIBObjects, cPimDenseV2MIBGroup=cPimDenseV2MIBGroup, cPimIfIndex=cPimIfIndex, cPimComponentCRPHoldTime=cPimComponentCRPHoldTime, cPimIfCBSRPreference=cPimIfCBSRPreference, cPimInetMRouteAssertMetricPref=cPimInetMRouteAssertMetricPref, cPimIfMode=cPimIfMode, cPimComponentBSRAddress=cPimComponentBSRAddress, cPimIfAddressType=cPimIfAddressType, cPimRPMapGroupMask=cPimRPMapGroupMask, cPimIfNetMask=cPimIfNetMask, cPimRPMapEntry=cPimRPMapEntry, cPimRPMapExpiryTime=cPimRPMapExpiryTime, cPimNbrEntry=cPimNbrEntry, cPimNbrExpiryTime=cPimNbrExpiryTime, cPim=cPim, cPimJoinPruneInterval=cPimJoinPruneInterval, cPimNbrTable=cPimNbrTable, cPimCRPAddrType=cPimCRPAddrType, cPimComponentBSRAddrType=cPimComponentBSRAddrType, cPimRPMapAddrType=cPimRPMapAddrType, cPimCRPTable=cPimCRPTable, cPimMIBCompliances=cPimMIBCompliances, cPimInetMRouteNextHopPruneReason=cPimInetMRouteNextHopPruneReason, cPimIfStatus=cPimIfStatus, cPimIfHelloInterval=cPimIfHelloInterval, cPimIfJoinPruneInterval=cPimIfJoinPruneInterval, cPimNbrUpTime=cPimNbrUpTime, cPimInetMRouteTable=cPimInetMRouteTable, cPimComponentIndex=cPimComponentIndex, cPimDenseV2MIBCompliance=cPimDenseV2MIBCompliance, cPimSparseV2MIBCompliance=cPimSparseV2MIBCompliance, cPimInetMRouteUpstreamAssertTime=cPimInetMRouteUpstreamAssertTime, cPimRPMapTable=cPimRPMapTable, cPimRPMapComponent=cPimRPMapComponent, cPimCRPRowStatus=cPimCRPRowStatus, cPimInetMRouteFlags=cPimInetMRouteFlags, cPimInetMRouteNextHopTable=cPimInetMRouteNextHopTable, cPimNotificationGroup=cPimNotificationGroup, cPimInetMRouteAssertMetric=cPimInetMRouteAssertMetric, cPimComponentStatus=cPimComponentStatus, cPimCRPGroupMask=cPimCRPGroupMask, cPimInetMRouteNextHopEntry=cPimInetMRouteNextHopEntry, cPimV2CRPMIBGroup=cPimV2CRPMIBGroup, cPimAssertGroup=cPimAssertGroup, cPimNotifs=cPimNotifs, ciscoIetfPimMIB=ciscoIetfPimMIB, cPimIfEntry=cPimIfEntry, cPimNbrAddress=cPimNbrAddress, cPimComponentEntry=cPimComponentEntry, cPimIfTable=cPimIfTable, cPimV2MIBGroup=cPimV2MIBGroup, cPimNbrAddressType=cPimNbrAddressType, cPimInetMRouteEntry=cPimInetMRouteEntry, PYSNMP_MODULE_ID=ciscoIetfPimMIB, cPimIfDR=cPimIfDR, cPimIfAddress=cPimIfAddress, cPimNbrLoss=cPimNbrLoss, cPimMIBConformance=cPimMIBConformance, cPimComponentTable=cPimComponentTable, cPimCRPAddress=cPimCRPAddress, cPimComponentBSRExpiryTime=cPimComponentBSRExpiryTime, cPimRPMapHoldTime=cPimRPMapHoldTime, cPimNbrIfIndex=cPimNbrIfIndex, cPimCRPEntry=cPimCRPEntry, cPimCRPGroupAddress=cPimCRPGroupAddress, cPimMIBGroups=cPimMIBGroups, cPimNextHopGroup=cPimNextHopGroup, cPimRPMapGroupAddress=cPimRPMapGroupAddress, cPimInetMRouteAssertRPTBit=cPimInetMRouteAssertRPTBit, cPimIfInetVersion=cPimIfInetVersion)
