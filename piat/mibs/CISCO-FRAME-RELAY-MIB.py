...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-FRAME-RELAY-MIB
...
frDlcmiEntry, frCircuitIfIndex, frCircuitDlci, frCircuitEntry = mibBuilder.importSymbols("RFC1315-MIB", "frDlcmiEntry", "frCircuitIfIndex", "frCircuitDlci", "frCircuitEntry")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
ModuleIdentity, Bits, NotificationType, Unsigned32, Gauge32, TimeTicks, Counter64, ObjectIdentity, Counter32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "Counter32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-FRAME-RELAY-MIB", cfrCircuitEntry=cfrCircuitEntry, cfrConnName=cfrConnName, cfrMapTable=cfrMapTable, cfrConnectionEntry=cfrConnectionEntry, cfrFragNotInOctets=cfrFragNotInOctets, cfrFragPreOutPkts=cfrFragPreOutPkts, cfrExtCircuitIfName=cfrExtCircuitIfName, cfrExtCircuitUncompressIns=cfrExtCircuitUncompressIns, cfrMapEncaps=cfrMapEncaps, cfrCircuitType=cfrCircuitType, cfrSvcMinThruputOut=cfrSvcMinThruputOut, cfrFragTimeoutsIn=cfrFragTimeoutsIn, ciscoFrLmiMIBGroup=ciscoFrLmiMIBGroup, cfrCircuitDropPktsOuts=cfrCircuitDropPktsOuts, cfrExtCircuitSubifIndex=cfrExtCircuitSubifIndex, cfrConnState=cfrConnState, cfrSvcAddrLocal=cfrSvcAddrLocal, ciscoFrMIBCompliance=ciscoFrMIBCompliance, DlciNumber=DlciNumber, cfrMapBroadcast=cfrMapBroadcast, cfrExtCircuitShapePktsDelay=cfrExtCircuitShapePktsDelay, cfrExtCircuitBandwidth=cfrExtCircuitBandwidth, cfrConnSegment2Name=cfrConnSegment2Name, cfrFragUnexpectedBBitSetPkts=cfrFragUnexpectedBBitSetPkts, ciscoExtCircuitMIBGroup=ciscoExtCircuitMIBGroup, cfrCircuitDEins=cfrCircuitDEins, cfrExtCircuitShapeByteLimit=cfrExtCircuitShapeByteLimit, ciscoFrConnMIBGroup=ciscoFrConnMIBGroup, cfrLmiT392Dce=cfrLmiT392Dce, cfrExtCircuitRcvDataRate=cfrExtCircuitRcvDataRate, cfrCircuitTable=cfrCircuitTable, ciscoFrMIBCompliancesRev4=ciscoFrMIBCompliancesRev4, cfrSvcThroughputIn=cfrSvcThroughputIn, cfrFragPreOutOctets=cfrFragPreOutOctets, cfrExtCircuitShapeBytesDelay=cfrExtCircuitShapeBytesDelay, cfrLmiStatusEnqTimeouts=cfrLmiStatusEnqTimeouts, ciscoFrameRelayMIB=ciscoFrameRelayMIB, cfrExtCircuitRoutedDlci=cfrExtCircuitRoutedDlci, cfrExtCircuitMapStatus=cfrExtCircuitMapStatus, cfrExtCircuitMinThruputOut=cfrExtCircuitMinThruputOut, ciscoFrMapMIBGroup=ciscoFrMapMIBGroup, cfrElmiLinkStatus=cfrElmiLinkStatus, cfrElmiNeighborIpAddress=cfrElmiNeighborIpAddress, cfrFragEntry=cfrFragEntry, ciscoFrMIBConformance=ciscoFrMIBConformance, cfrExtCircuitIfType=cfrExtCircuitIfType, cfrLmiUpdateStatusOuts=cfrLmiUpdateStatusOuts, cfrLmiLinkstatus=cfrLmiLinkstatus, ciscoFrMIBGroupRev1=ciscoFrMIBGroupRev1, cfrSvcCommitBurstIn=cfrSvcCommitBurstIn, cfrElmiNeighborTable=cfrElmiNeighborTable, cfrConnSegment2Vpi=cfrConnSegment2Vpi, cfrLmiObjs=cfrLmiObjs, cfrConnSegment1Name=cfrConnSegment1Name, cfrElmiObjs=cfrElmiObjs, cfrExtCircuitMulticast=cfrExtCircuitMulticast, cfrFragAssembledInPkts=cfrFragAssembledInPkts, cfrConnClpBit=cfrConnClpBit, cfrMapRtpHdrCompress=cfrMapRtpHdrCompress, cfrMapAddress=cfrMapAddress, cfrConnSegment1Dlci=cfrConnSegment1Dlci, PYSNMP_MODULE_ID=ciscoFrameRelayMIB, ciscoFrMIBGroups=ciscoFrMIBGroups, cfrLmiUpdateStatusIns=cfrLmiUpdateStatusIns, cfrExtCircuitShapePkts=cfrExtCircuitShapePkts, cfrFragDroppedReAssembledInPkts=cfrFragDroppedReAssembledInPkts, cfrExtCircuitShapeActive=cfrExtCircuitShapeActive, cfrFragOutPkts=cfrFragOutPkts, cfrElmiNeighborPlatformName=cfrElmiNeighborPlatformName, cfrConnSegment2Vci=cfrConnSegment2Vci, cfrElmiNeighborIfIndex=cfrElmiNeighborIfIndex, cfrMapEntry=cfrMapEntry, cfrExtCircuitShapeBytes=cfrExtCircuitShapeBytes, cfrExtCircuitCreateType=cfrExtCircuitCreateType, cfrFragNotInPkts=cfrFragNotInPkts, cfrExtCircuitShapeInterval=cfrExtCircuitShapeInterval, ciscoFrMIBObjects=ciscoFrMIBObjects, cfrConnID=cfrConnID, cfrFragOutOfSeqFragPkts=cfrFragOutOfSeqFragPkts, ciscoFrTsMIBGroup=ciscoFrTsMIBGroup, ciscoFrMIBGroup=ciscoFrMIBGroup, cfrConnFrSscsDlci=cfrConnFrSscsDlci, cfrElmiNeighborEntry=cfrElmiNeighborEntry, cfrLmiStatusOuts=cfrLmiStatusOuts, cfrExtCircuitTable=cfrExtCircuitTable, ciscoFrMIBCompliancesRev2=ciscoFrMIBCompliancesRev2, cfrElmiRemoteStatus=cfrElmiRemoteStatus, cfrConnSegment1VCGroup=cfrConnSegment1VCGroup, cfrExtCircuitShapeByteIncrement=cfrExtCircuitShapeByteIncrement, cfrMapPayloadCompress=cfrMapPayloadCompress, cfrLmiTable=cfrLmiTable, cfrExtCircuitMinThruputIn=cfrExtCircuitMinThruputIn, cfrFragInOctets=cfrFragInOctets, cfrMapIndex=cfrMapIndex, cfrLmiN393Dce=cfrLmiN393Dce, cfrLmiStatusTimeouts=cfrLmiStatusTimeouts, ciscoExtCircuitMIBGroup1=ciscoExtCircuitMIBGroup1, cfrLmiStatusIns=cfrLmiStatusIns, ciscoFrCircuitMIBGroup=ciscoFrCircuitMIBGroup, cfrElmiArStatus=cfrElmiArStatus, cfrFragNotOutOctets=cfrFragNotOutOctets, cfrElmiNeighborDeviceName=cfrElmiNeighborDeviceName, ciscoFrMIBCompliancesRev3=ciscoFrMIBCompliancesRev3, cfrExtCircuitBcastByteOuts=cfrExtCircuitBcastByteOuts, cfrExtCircuitBECNOuts=cfrExtCircuitBECNOuts, ciscoFrMIBCompliances=ciscoFrMIBCompliances, cfrElmiNeighborArStatus=cfrElmiNeighborArStatus, cfrElmiIpAddr=cfrElmiIpAddr, ciscoFrElmiMIBGroup1=ciscoFrElmiMIBGroup1, cfrExtCircuitBcastPktOuts=cfrExtCircuitBcastPktOuts, cfrExtCircuitUncompressOuts=cfrExtCircuitUncompressOuts, cfrFragSeqMissedPkts=cfrFragSeqMissedPkts, cfrFragDroppedFragmentedOutPkts=cfrFragDroppedFragmentedOutPkts, cfrExtCircuitFECNOuts=cfrExtCircuitFECNOuts, cfrFragSize=cfrFragSize, cfrLmiEntry=cfrLmiEntry, ciscoFrElmiMIBGroup=ciscoFrElmiMIBGroup, cfrMapProtocol=cfrMapProtocol, cfrFragType=cfrFragType, ciscoFrMIBCompliancesRev1=ciscoFrMIBCompliancesRev1, cfrConnectionTable=cfrConnectionTable, cfrLmiN392Dce=cfrLmiN392Dce, cfrCircuitObjs=cfrCircuitObjs, CfrMapProtocols=CfrMapProtocols, cfrExtCircuitEntry=cfrExtCircuitEntry, cfrConnDeBit=cfrConnDeBit, cfrElmiEntry=cfrElmiEntry, cfrSvcMinThruputIn=cfrSvcMinThruputIn, cfrElmiTable=cfrElmiTable, cfrSvcTable=cfrSvcTable, cfrConnServiceTranslation=cfrConnServiceTranslation, cfrExtCircuitTxPktRate=cfrExtCircuitTxPktRate, cfrMapType=cfrMapType, cfrSvcEntry=cfrSvcEntry, cfrFragAssembledInOctets=cfrFragAssembledInOctets, cfrLmiEnquiryIns=cfrLmiEnquiryIns, cfrFragTable=cfrFragTable, cfrFragNotOutPkts=cfrFragNotOutPkts, cfrConnectionObjs=cfrConnectionObjs, ciscoFrSvcMIBGroup=ciscoFrSvcMIBGroup, cfrLmiEnquiryOuts=cfrLmiEnquiryOuts, cfrExtCircuitShapeAdapting=cfrExtCircuitShapeAdapting, cfrSvcIdleTime=cfrSvcIdleTime, cfrMapTcpHdrCompress=cfrMapTcpHdrCompress, cfrCircuitDEouts=cfrCircuitDEouts, cfrMapObjs=cfrMapObjs, cfrFragInterleavedOutPkts=cfrFragInterleavedOutPkts, cfrMapPayloadCompressType=cfrMapPayloadCompressType, cfrSvcExcessBurstIn=cfrSvcExcessBurstIn, cfrLmiLinkType=cfrLmiLinkType, cfrExtCircuitRoutedIf=cfrExtCircuitRoutedIf, cfrFragOutOctets=cfrFragOutOctets, ciscoFrFragMIBGroup=ciscoFrFragMIBGroup, cfrConnEfciBit=cfrConnEfciBit, cfrFragInPkts=cfrFragInPkts, cfrExtCircuitRcvPktRate=cfrExtCircuitRcvPktRate, cfrFragObjs=cfrFragObjs, cfrElmiNeighborVendorName=cfrElmiNeighborVendorName, cfrExtCircuitTxDataRate=cfrExtCircuitTxDataRate, cfrSvcObjs=cfrSvcObjs, cfrSvcAddrRemote=cfrSvcAddrRemote)
