...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-LICENSE-MGR-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:40:10 2019
...
NotificationType, TimeTicks, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, ObjectIdentity, Integer32, IpAddress, Bits, ModuleIdentity, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "ObjectIdentity", "Integer32", "IpAddress", "Bits", "ModuleIdentity", "iso", "Unsigned32")
TextualConvention, TruthValue, DisplayString, DateAndTime, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "DateAndTime", "TestAndIncr")
...
mibBuilder.exportSymbols("CISCO-LICENSE-MGR-MIB", clmLicenseRequestCommand=clmLicenseRequestCommand, clmLicenseFeatureName=clmLicenseFeatureName, ciscoLicenseMgrMIBConform=ciscoLicenseMgrMIBConform, ciscoLicenseMgrGroups=ciscoLicenseMgrGroups, clmLicenseExpiryNotify=clmLicenseExpiryNotify, clmLicenseFeatureUsageTable=clmLicenseFeatureUsageTable, clmNotificationGroup=clmNotificationGroup, ciscoLicenseMgrMIB=ciscoLicenseMgrMIB, ciscoLicenseMgrNotifications=ciscoLicenseMgrNotifications, clmLicenseFileContentsTable=clmLicenseFileContentsTable, clmLicenseInformationGroup1=clmLicenseInformationGroup1, clmLicenseInformation=clmLicenseInformation, clmLicenseFileTargetName=clmLicenseFileTargetName, ciscoLicenseMgrCompliance1=ciscoLicenseMgrCompliance1, clmLicenseInstallGroup=clmLicenseInstallGroup, clmNoOfLicenseMaxUsages=clmNoOfLicenseMaxUsages, clmLicenseFileMissingNotify=clmLicenseFileMissingNotify, clmLicenseFileURI=clmLicenseFileURI, clmNoOfMissingUsageLicenses=clmNoOfMissingUsageLicenses, clmNoOfLicenseCurrentUsages=clmNoOfLicenseCurrentUsages, clmLicenseInformationGroup2=clmLicenseInformationGroup2, clmLicenseRequestFeatureName=clmLicenseRequestFeatureName, clmLicenseConfigSpinLock=clmLicenseConfigSpinLock, clmLicenseFeatureUsageEntry=clmLicenseFeatureUsageEntry, clmLicenseFileContentsEntry=clmLicenseFileContentsEntry, clmNotificationsEnableGroup=clmNotificationsEnableGroup, clmLicenseConfigCommandStatus=clmLicenseConfigCommandStatus, ciscoLicenseMgrCompliance=ciscoLicenseMgrCompliance, clmLicenseFileTimeStamp=clmLicenseFileTimeStamp, ciscoLicenseMgrConfig=ciscoLicenseMgrConfig, ciscoLicenseMgrCompliance2=ciscoLicenseMgrCompliance2, PYSNMP_MODULE_ID=ciscoLicenseMgrMIB, clmLicenseRequestSpinLock=clmLicenseRequestSpinLock, clmLicensedAppName=clmLicensedAppName, clmFeatureUsageDetailsEntry=clmFeatureUsageDetailsEntry, clmLicenseFileRowNumber=clmLicenseFileRowNumber, clmLicenseExpiryDate=clmLicenseExpiryDate, clmNoLicenseForFeatureNotify=clmNoLicenseForFeatureNotify, clmNoOfInstalledLicensesGroup=clmNoOfInstalledLicensesGroup, clmLicenseRequestCommandStatus=clmLicenseRequestCommandStatus, clmFeatureUsageDetailsTable=clmFeatureUsageDetailsTable, clmLicenseFileRowContents=clmLicenseFileRowContents, clmLicenseFlag=clmLicenseFlag, ciscoLicenseMgrCompliances=ciscoLicenseMgrCompliances, clmLicenseViolationWarnFlag=clmLicenseViolationWarnFlag, clmLicenseConfiguration=clmLicenseConfiguration, clmLicenseInformationGroup=clmLicenseInformationGroup, clmLicenseFileName=clmLicenseFileName, clmNoOfLicenseFilesInstalled=clmNoOfLicenseFilesInstalled, clmLicenseFileNoOfRows=clmLicenseFileNoOfRows, clmNotificationsEnable=clmNotificationsEnable, clmLicenseRequestGroup=clmLicenseRequestGroup, clmLicenseExpiryWarningNotify=clmLicenseExpiryWarningNotify, clmLicenseConfigCommand=clmLicenseConfigCommand, ciscoLicenseMgrMIBNotifs=ciscoLicenseMgrMIBNotifs, clmNoOfLicensedFeatures=clmNoOfLicensedFeatures, clmHostId=clmHostId, ciscoLicenseMgrMIBObjects=ciscoLicenseMgrMIBObjects, clmLicensedAppIndex=clmLicensedAppIndex, clmLicenseRequestAppName=clmLicenseRequestAppName, clmLicenseGracePeriod=clmLicenseGracePeriod)
