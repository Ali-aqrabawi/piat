...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/DLSW-MIB
...
ModuleIdentity, NotificationType, Bits, Unsigned32, Gauge32, TimeTicks, Counter64, ObjectIdentity, Counter32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Bits", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "Counter32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "MibIdentifier")
...
mibBuilder.exportSymbols("DLSW-MIB", TAddress=TAddress, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitTable=dlswCircuitTable, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBGroup=dlswDirNBGroup, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, MacAddressNC=MacAddressNC, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirLocateNBTable=dlswDirLocateNBTable, dlswTrapCntlTConnProtViolation=dlswTrapCntlTConnProtViolation, dlswTConnTcpConfigKeepAliveInt=dlswTConnTcpConfigKeepAliveInt, dlswSdlcLsLocalIdBlock=dlswSdlcLsLocalIdBlock, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswNodeUpTime=dlswNodeUpTime, dlswCircuitStat=dlswCircuitStat, dlswCircuitGroup=dlswCircuitGroup, dlswDirLocateCompliance=dlswDirLocateCompliance, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswCoreCompliance=dlswCoreCompliance, dlswDirStat=dlswDirStat, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnNBGroup=dlswTConnNBGroup, dlswTConnTcpOperKeepAliveInt=dlswTConnTcpOperKeepAliveInt, dlswIfRowStatus=dlswIfRowStatus, dlswDirMacCacheMisses=dlswDirMacCacheMisses, dlswGroups=dlswGroups, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswDirNBCacheHits=dlswDirNBCacheHits, dlswTConnTcpConfigTcpConnections=dlswTConnTcpConfigTcpConnections, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswTrapControl=dlswTrapControl, dlswTConnTcpCompliance=dlswTConnTcpCompliance, dlswSdlc=dlswSdlc, dlswIfEntry=dlswIfEntry, dlswTConnTcpConfigTable=dlswTConnTcpConfigTable, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswNodeStatus=dlswNodeStatus, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswDirLocateMacEntry=dlswDirLocateMacEntry, dlswDirLocateMacTable=dlswDirLocateMacTable, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswTConnTcpOperTable=dlswTConnTcpOperTable, dlswDirectory=dlswDirectory, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, NBName=NBName, dlswDirNBCacheNextIndex=dlswDirNBCacheNextIndex, dlswDirNBCacheMisses=dlswDirNBCacheMisses, dlswIfSapList=dlswIfSapList, dlswDirNBEntry=dlswDirNBEntry, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitStateTime=dlswCircuitStateTime, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitStatActives=dlswCircuitStatActives, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirCache=dlswDirCache, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, DlswTCPAddress=DlswTCPAddress, dlswTConnTcpOperPrefTcpConnections=dlswTConnTcpOperPrefTcpConnections, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirLocateNBEntry=dlswDirLocateNBEntry, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswSdlcLsRowStatus=dlswSdlcLsRowStatus, dlswNodeVendorID=dlswNodeVendorID, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswNodeResourceNBExclusivity=dlswNodeResourceNBExclusivity, dlswTConnTcpConfigMaxSegmentSize=dlswTConnTcpConfigMaxSegmentSize, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTCPDomain=dlswTCPDomain, dlswDirNBLocationType=dlswDirNBLocationType, dlswSdlcLsLocalIdNum=dlswSdlcLsLocalIdNum, dlswTConnTcpConfigGroup=dlswTConnTcpConfigGroup, dlswTConnTcpOperEntry=dlswTConnTcpOperEntry, dlswDirMacEntries=dlswDirMacEntries, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswDirCompliance=dlswDirCompliance, dlswDirGroup=dlswDirGroup, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswDirMacCacheNextIndex=dlswDirMacCacheNextIndex, dlswDirLocateNBGroup=dlswDirLocateNBGroup, dlswTraps=dlswTraps, dlswNodeVersion=dlswNodeVersion, dlswTrapCntlTConnPartnerReject=dlswTrapCntlTConnPartnerReject, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswTConnConfigGroup=dlswTConnConfigGroup, dlswSdlcGroup=dlswSdlcGroup, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswDirMacLocationType=dlswDirMacLocationType, dlswDirNBNameType=dlswDirNBNameType, dlswSdlcLsLocalMac=dlswSdlcLsLocalMac, dlswDirLocateGroup=dlswDirLocateGroup, dlswDirMacLFSize=dlswDirMacLFSize, PYSNMP_MODULE_ID=dlsw, dlswSdlcLsRemoteSap=dlswSdlcLsRemoteSap, dlswDirMacTable=dlswDirMacTable, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacMac=dlswDirMacMac, dlswDirNBLFSize=dlswDirNBLFSize, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitEntry=dlswCircuitEntry, dlswDirNBEntryType=dlswDirNBEntryType, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirNBEntries=dlswDirNBEntries, dlswTrapTConnProtViolation=dlswTrapTConnProtViolation, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnTcpOperGroup=dlswTConnTcpOperGroup, dlswSdlcLsTable=dlswSdlcLsTable, dlswInterface=dlswInterface, dlswInterfaceGroup=dlswInterfaceGroup, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirLocateMacMatch=dlswDirLocateMacMatch, null=null, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitStatCreates=dlswCircuitStatCreates, dlswCircuitOrigin=dlswCircuitOrigin, dlswNodeNBGroup=dlswNodeNBGroup, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswTConn=dlswTConn, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConnTcpOperTcpConnections=dlswTConnTcpOperTcpConnections, dlswDirLocateNBLocation=dlswDirLocateNBLocation, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswNotificationGroup=dlswNotificationGroup, dlswCircuit=dlswCircuit, dlswMIB=dlswMIB, dlswTConnStatGroup=dlswTConnStatGroup, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswNodeResourceMacExclusivity=dlswNodeResourceMacExclusivity, DlcType=DlcType, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswCircuitPriority=dlswCircuitPriority, dlswDirNBTable=dlswDirNBTable, dlswNodeVersionString=dlswNodeVersionString, dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswDirMacIndex=dlswDirMacIndex, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswNodeGroup=dlswNodeGroup, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCompliances=dlswCompliances, dlswTConnConfigSetupType=dlswTConnConfigSetupType, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswNode=dlswNode, dlswConformance=dlswConformance, dlswIfTable=dlswIfTable, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswDirLocateMacMac=dlswDirLocateMacMac, dlswTrapCntlCircuit=dlswTrapCntlCircuit, EndStationLocation=EndStationLocation, dlswTConnOperGroup=dlswTConnOperGroup, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnOperEntry=dlswTConnOperEntry, dlswDirLocateNBMatch=dlswDirLocateNBMatch, dlswTConnOperState=dlswTConnOperState, dlswCircuitState=dlswCircuitState, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswTConnSpecific=dlswTConnSpecific, dlswDirMacMask=dlswDirMacMask, dlswTConnOperTable=dlswTConnOperTable, dlswDirMacStatus=dlswDirMacStatus, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacEntryType=dlswDirMacEntryType, dlswCircuitS2Location=dlswCircuitS2Location, dlswIfVirtualSegment=dlswIfVirtualSegment, dlswDirNBName=dlswDirNBName, dlswDirNBLocation=dlswDirNBLocation, dlswSdlcLsEntries=dlswSdlcLsEntries, dlsw=dlsw, dlswTConnTcp=dlswTConnTcp, dlswTConnTcpConfigEntry=dlswTConnTcpConfigEntry, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirMacLocation=dlswDirMacLocation, dlswCircuitStatGroup=dlswCircuitStatGroup, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTrapTConnUp=dlswTrapTConnUp, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswSdlcCompliance=dlswSdlcCompliance, dlswTConnStat=dlswTConnStat, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswSdlcLsEntry=dlswSdlcLsEntry, dlswDirLocate=dlswDirLocate, dlswSdlcLsLocalSap=dlswSdlcLsLocalSap, dlswTrapTConnDown=dlswTrapTConnDown, dlswDirMacCacheHits=dlswDirMacCacheHits, LFSize=LFSize, dlswDirLocateMacLocation=dlswDirLocateMacLocation, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswDirLocateNBName=dlswDirLocateNBName, dlswDirNBIndex=dlswDirNBIndex, dlswDomains=dlswDomains)
