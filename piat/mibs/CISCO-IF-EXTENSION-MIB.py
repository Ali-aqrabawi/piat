...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IF-EXTENSION-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:40:38 2019
...
ifAdminStatus, ifType, ifName, ifOperStatus, ifIndex, InterfaceIndexOrZero = mibBuilder.importSymbols("IF-MIB", "ifAdminStatus", "ifType", "ifName", "ifOperStatus", "ifIndex", "InterfaceIndexOrZero")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Gauge32, Bits, Counter32, ModuleIdentity, iso, MibIdentifier, NotificationType, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Counter32", "ModuleIdentity", "iso", "MibIdentifier", "NotificationType", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("CISCO-IF-EXTENSION-MIB", ciscoIfExtensionTableIntfGroup3SupR01=ciscoIfExtensionTableIntfGroup3SupR01, ciscoIfExtensionMIBCompliance11=ciscoIfExtensionMIBCompliance11, ciscoIfExtensionMIBGroups=ciscoIfExtensionMIBGroups, cieIfDot1dBaseMappingPort=cieIfDot1dBaseMappingPort, cieLinkUpDownConfig=cieLinkUpDownConfig, cieIfIgnoreInterruptThresholdConfig=cieIfIgnoreInterruptThresholdConfig, cieIfName=cieIfName, cieIfPacketDiscontinuityTime=cieIfPacketDiscontinuityTime, ciscoIfExtensionMIBCompliance7=ciscoIfExtensionMIBCompliance7, cieIfHighSpeedReceive=cieIfHighSpeedReceive, cieIfVlStatsGroup=cieIfVlStatsGroup, cieInterfacesIndex=cieInterfacesIndex, ciscoIfExtensionMIBCompliance8=ciscoIfExtensionMIBCompliance8, ciscoIfExtDot1qEtherTypeGroup=ciscoIfExtDot1qEtherTypeGroup, cieIfNameMappingEntry=cieIfNameMappingEntry, cieIfDot1dBaseMappingEntry=cieIfDot1dBaseMappingEntry, cieIfIndexPersistence=cieIfIndexPersistence, cieIfUtilTable=cieIfUtilTable, cieIfOutputQueueDrops=cieIfOutputQueueDrops, ciscoIfExtensionMIBCompliance6=ciscoIfExtensionMIBCompliance6, cieIfNoDropVlInPkts=cieIfNoDropVlInPkts, cieIfUtilEntry=cieIfUtilEntry, cieIfIndexPersistenceControlGroup=cieIfIndexPersistenceControlGroup, cieIfDropVlOutPkts=cieIfDropVlOutPkts, cieIfOperStatusCauseDescr=cieIfOperStatusCauseDescr, cieIfFillPatternConfig=cieIfFillPatternConfig, cieInterfacesOperMode=cieInterfacesOperMode, cieLinkUpDownNotifConfigGroup=cieLinkUpDownNotifConfigGroup, ciscoIfExtUtilIntervalGroup=ciscoIfExtUtilIntervalGroup, cieIfVlStatsTable=cieIfVlStatsTable, ciscoIfExtensionTableIntfGroup3SupR02=ciscoIfExtensionTableIntfGroup3SupR02, ciscoIfExtDot1qCustomEtherType=ciscoIfExtDot1qCustomEtherType, ciscoIfExtSystemConfig=ciscoIfExtSystemConfig, cieIfResetCount=cieIfResetCount, ciscoIfExtDot1dBaseMapping=ciscoIfExtDot1dBaseMapping, cieIfKeepAliveEnabled=cieIfKeepAliveEnabled, cieIfIndexPersistenceTable=cieIfIndexPersistenceTable, cieIfOutPktRate=cieIfOutPktRate, cieDelayedLinkUpDownNotifDelay=cieDelayedLinkUpDownNotifDelay, cieIfNoDropVlOutPkts=cieIfNoDropVlOutPkts, ciscoIfExtensionMIBCompliance5=ciscoIfExtensionMIBCompliance5, ciscoIfExtensionMIBConformance=ciscoIfExtensionMIBConformance, ciscoIfExtensionStats=ciscoIfExtensionStats, cieIfOperStatusCause=cieIfOperStatusCause, cieLinkUp=cieLinkUp, InterfaceIndexList=InterfaceIndexList, cieIfDot1dBaseMappingTable=cieIfDot1dBaseMappingTable, cieIfInAbortErrs=cieIfInAbortErrs, cieStandardLinkUpDownVarbinds=cieStandardLinkUpDownVarbinds, cieIfPacketStatsTable=cieIfPacketStatsTable, ciscoIfExtensionMIBCompliance10=ciscoIfExtensionMIBCompliance10, ciscoIfExtensionTablePacketGroup=ciscoIfExtensionTablePacketGroup, cieIfStatusListEntry=cieIfStatusListEntry, InterfaceOwnershipList=InterfaceOwnershipList, cieIfStatusListGroupSup1=cieIfStatusListGroupSup1, ciscoIfExtensionMIBCompliances=ciscoIfExtensionMIBCompliances, cieIfPacketStatsEntry=cieIfPacketStatsEntry, ciscoIfExtensionMIBObjects=ciscoIfExtensionMIBObjects, cieIfLastOutHangTime=cieIfLastOutHangTime, cieDelayedLinkUpDownNotifEnable=cieDelayedLinkUpDownNotifEnable, ciscoIfExtensionMIBNotifications=ciscoIfExtensionMIBNotifications, cieIfLastOutTime=cieIfLastOutTime, ciscoIfExtensionTableIntfGroup2=ciscoIfExtensionTableIntfGroup2, cieLinkUpDownNotifGroup=cieLinkUpDownNotifGroup, InterfaceOperCauseList=InterfaceOperCauseList, cieIfNoDropVlInOctets=cieIfNoDropVlInOctets, ciscoIfExtensionMIBCompliance=ciscoIfExtensionMIBCompliance, cieIfStatusListGroup=cieIfStatusListGroup, cieIfDot1qCustomEtherTypeTable=cieIfDot1qCustomEtherTypeTable, ciscoIfExtensionTableIntfGroup3=ciscoIfExtensionTableIntfGroup3, cieIfInOverrunErrs=cieIfInOverrunErrs, cieIfVlStatsEntry=cieIfVlStatsEntry, cieIfInPktRate=cieIfInPktRate, cieIfIndexGlobalPersistence=cieIfIndexGlobalPersistence, InterfaceOperModeList=InterfaceOperModeList, cieIfIndexPersistenceGroup=cieIfIndexPersistenceGroup, cieIfInputQueueDrops=cieIfInputQueueDrops, cieIfStatusListTable=cieIfStatusListTable, cieIfIgnoreBitErrorsConfig=cieIfIgnoreBitErrorsConfig, cieIfIndex=cieIfIndex, ciscoIfExtensionMIBCompliance15=ciscoIfExtensionMIBCompliance15, ciscoIfExtensionMIBCompliance13=ciscoIfExtensionMIBCompliance13, IfIndexPersistenceState=IfIndexPersistenceState, cieIfDhcpMode=cieIfDhcpMode, cieIfInterval=cieIfInterval, ciscoIfExtensionMIBCompliance3=ciscoIfExtensionMIBCompliance3, cieIfTransceiverFrequencyConfig=cieIfTransceiverFrequencyConfig, PYSNMP_MODULE_ID=ciscoIfExtensionMIB, ciscoIfExtensionMIB=ciscoIfExtensionMIB, cieIfDot1qCustomAdminEtherType=cieIfDot1qCustomAdminEtherType, cieDelayedLinkUpDownNotifNotifEnableGroup=cieDelayedLinkUpDownNotifNotifEnableGroup, cieIfCarrierTransitionCount=cieIfCarrierTransitionCount, cieIfInRuntsErrs=cieIfInRuntsErrs, cieInterfacesOperCause=cieInterfacesOperCause, cieIfDropVlOutOctets=cieIfDropVlOutOctets, cieIfIndexPersistenceEnabled=cieIfIndexPersistenceEnabled, ciscoIfExtensionMIBCompliance12=ciscoIfExtensionMIBCompliance12, ciscoIfExtDot1dBaseMappingGroup=ciscoIfExtDot1dBaseMappingGroup, ciscoIfExtensionAsymmetricalSpeedGroup=ciscoIfExtensionAsymmetricalSpeedGroup, ciscoIfExtensionTableIntfGroup=ciscoIfExtensionTableIntfGroup, ciscoIfExtensionMIBCompliance1=ciscoIfExtensionMIBCompliance1, cieIfNoDropVlOutOctets=cieIfNoDropVlOutOctets, cieIfSpeedReceive=cieIfSpeedReceive, cieSystemMtu=cieSystemMtu, cieIfDot1qCustomEtherTypeEntry=cieIfDot1qCustomEtherTypeEntry, ciscoIfExtIfNameMappingGroup=ciscoIfExtIfNameMappingGroup, cieIfInterfaceEntry=cieIfInterfaceEntry, cieIfInterfaceDiscontinuityTime=cieIfInterfaceDiscontinuityTime, cieLinkUpDownEnable=cieLinkUpDownEnable, cieIfSharedConfig=cieIfSharedConfig, ciscoIfExtensionSystemGroup=ciscoIfExtensionSystemGroup, cieIfIndexPersistenceControl=cieIfIndexPersistenceControl, cieDelayedLinkUpDownNotif=cieDelayedLinkUpDownNotif, ciscoIfExtensionMIBCompliance14=ciscoIfExtensionMIBCompliance14, cieIfStateChangeReason=cieIfStateChangeReason, cieIfSpeedGroupConfig=cieIfSpeedGroupConfig, cieIfLastInTime=cieIfLastInTime, cieIfOwner=cieIfOwner, cieIfNameMappingTable=cieIfNameMappingTable, cieIfInFramingErrs=cieIfInFramingErrs, cieIfDropVlInOctets=cieIfDropVlInOctets, cieIfOutOctetRate=cieIfOutOctetRate, cieIfDropVlInPkts=cieIfDropVlInPkts, ciscoIfExtUtilizationGroup=ciscoIfExtUtilizationGroup, cieLinkUpDownNotifEnableGroup=cieLinkUpDownNotifEnableGroup, cieDelayedLinkUpDownNotifNotifGroup=cieDelayedLinkUpDownNotifNotifGroup, ciscoIfExtIfNameMapping=ciscoIfExtIfNameMapping, cieIfStatusListIndex=cieIfStatusListIndex, ciscoIfExtensionMIBCompliance2=ciscoIfExtensionMIBCompliance2, cieIfInIgnored=cieIfInIgnored, cieIfInterfaceTable=cieIfInterfaceTable, cieIfDot1qCustomOperEtherType=cieIfDot1qCustomOperEtherType, ciscoIfExtUtilization=ciscoIfExtUtilization, ciscoIfExtensionMIBCompliance4=ciscoIfExtensionMIBCompliance4, ciscoIfExtensionMIBCompliance9=ciscoIfExtensionMIBCompliance9, cieInterfaceOwnershipBitmap=cieInterfaceOwnershipBitmap, cieIfMtu=cieIfMtu, cieLinkDown=cieLinkDown, ciscoIfExtensionTableIntfGroup1=ciscoIfExtensionTableIntfGroup1, cieIfContextName=cieIfContextName, cieIfIndexPersistenceEntry=cieIfIndexPersistenceEntry, cieIfInOctetRate=cieIfInOctetRate, cieIfInGiantsErrs=cieIfInGiantsErrs)
