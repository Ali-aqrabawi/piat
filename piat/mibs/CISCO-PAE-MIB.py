...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-PAE-MIB
...
dot1xPaePortEntry, dot1xAuthConfigEntry, PaeControlledPortStatus, dot1xPaePortNumber, dot1xAuthPaeState = mibBuilder.importSymbols("IEEE8021-PAE-MIB", "dot1xPaePortEntry", "dot1xAuthConfigEntry", "PaeControlledPortStatus", "dot1xPaePortNumber", "dot1xAuthPaeState")
InterfaceIndex, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndex")
InetAddressType, InetAddress = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddressType", "InetAddress")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
ObjectIdentity, NotificationType, Integer32, MibIdentifier, Bits, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, ModuleIdentity, iso, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Integer32", "MibIdentifier", "Bits", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "ModuleIdentity", "iso", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-PAE-MIB", cpaeHostInfoEntry=cpaeHostInfoEntry, cpaeMacAuthBypassPortEnabled=cpaeMacAuthBypassPortEnabled, cpaeUserGroupUserAddrType=cpaeUserGroupUserAddrType, cpaePortCapabilitiesConfigGroup=cpaePortCapabilitiesConfigGroup, cpaeHostSessionId=cpaeHostSessionId, cpaePortAuthFailVlanConfigGroup=cpaePortAuthFailVlanConfigGroup, cpaePortAuthFailVlanGroup=cpaePortAuthFailVlanGroup, cpaeGuestVlanNotifEnableGroup=cpaeGuestVlanNotifEnableGroup, cpaeSuppHostInfoEntry=cpaeSuppHostInfoEntry, cpaeAuthFailVlanNotif=cpaeAuthFailVlanNotif, cpaeSuppHostInfoTable=cpaeSuppHostInfoTable, cpaeAuthFailUserEntry=cpaeAuthFailUserEntry, cpaeUserGroupTable=cpaeUserGroupTable, ciscoPaeMIB=ciscoPaeMIB, cpaeHostInfoAddr=cpaeHostInfoAddr, cpaeHostInfoPostureToken=cpaeHostInfoPostureToken, cpaeWebAuthHostEntry=cpaeWebAuthHostEntry, cpaePortIpDevTrackConfGroup=cpaePortIpDevTrackConfGroup, cpaeNoGuestVlanNotifGroup=cpaeNoGuestVlanNotifGroup, cpaeSuppHostAuthMacAddress=cpaeSuppHostAuthMacAddress, cpaeHostInfoUserName=cpaeHostInfoUserName, cpaePortIpDevTrackConfigTable=cpaePortIpDevTrackConfigTable, cpaeHostInfoGroup2=cpaeHostInfoGroup2, cpaeMacAuthBypassGroup3=cpaeMacAuthBypassGroup3, cpaeWebAuthPortTable=cpaeWebAuthPortTable, cpaeWebAuthHostAddrType=cpaeWebAuthHostAddrType, cpaeMacAuthBypassReAuthTimeout=cpaeMacAuthBypassReAuthTimeout, cpaeHostAuthInfoGroup=cpaeHostAuthInfoGroup, cpaeCompliance10=cpaeCompliance10, cpaePortAuthFailVlanGroup2=cpaePortAuthFailVlanGroup2, cpaePortEntryGroup=cpaePortEntryGroup, cpaeSuppHostInfoGroup=cpaeSuppHostInfoGroup, cpaePortAuthFailVlan=cpaePortAuthFailVlan, cpaeWebAuthHostTable=cpaeWebAuthHostTable, cpaePortOperVlanType=cpaePortOperVlanType, cpaeGuestVlanGroup3=cpaeGuestVlanGroup3, cpaeAuthConfigEntry=cpaeAuthConfigEntry, cpaeSuppPortTable=cpaeSuppPortTable, cpaeMacAuthBypassAuthFailTimeout=cpaeMacAuthBypassAuthFailTimeout, cpaeAuthFailVlanMaxAttempts=cpaeAuthFailVlanMaxAttempts, cpaeMIBNotification=cpaeMIBNotification, cpaeMultipleHostGroup=cpaeMultipleHostGroup, cpaeHostInfoAddrType=cpaeHostInfoAddrType, cpaeMacAuthBypassAcctEnable=cpaeMacAuthBypassAcctEnable, cpaeCompliance6=cpaeCompliance6, cpaeNoGuestVlanNotifEnableGrp=cpaeNoGuestVlanNotifEnableGrp, cpaeCompliance=cpaeCompliance, cpaeNoAuthFailVlanNotifGroup=cpaeNoAuthFailVlanNotifGroup, cpaeAuthIabEnabled=cpaeAuthIabEnabled, cpaeWebAuthIpDevTrackingGroup=cpaeWebAuthIpDevTrackingGroup, cpaeUserGroupUserIndex=cpaeUserGroupUserIndex, cpaeWebAuthLoginPage=cpaeWebAuthLoginPage, cpaeHostPostureTokenStr=cpaeHostPostureTokenStr, cpaeAuthConfigGroup=cpaeAuthConfigGroup, cpaeGuestVlanNotifEnable=cpaeGuestVlanNotifEnable, cpaeUserGroupUserName=cpaeUserGroupUserName, cpaeShutdownTimeoutEnabled=cpaeShutdownTimeoutEnabled, cpaeGuestVlanNotifGroup=cpaeGuestVlanNotifGroup, cpaeWebAuthCriticalRecoveryDelay=cpaeWebAuthCriticalRecoveryDelay, cpaePortOperVlan=cpaePortOperVlan, cpaeMacAuthBypassSessionTimeLeft=cpaeMacAuthBypassSessionTimeLeft, cpaeGuestVlanGroup=cpaeGuestVlanGroup, cpaePortIpDevTrackEnabled=cpaePortIpDevTrackEnabled, cpaeCompliance3=cpaeCompliance3, cpaeRadiusConfigGroup=cpaeRadiusConfigGroup, cpaeWebAuthAaaSessionPeriod=cpaeWebAuthAaaSessionPeriod, cpaeAuthFailUserTable=cpaeAuthFailUserTable, cpaeAuthReAuthPeriodSrcAdmin=cpaeAuthReAuthPeriodSrcAdmin, cpaeInGuestVlan=cpaeInGuestVlan, cpaeMacAuthBypassPortEnableGroup=cpaeMacAuthBypassPortEnableGroup, cpaeMacAuthBypassViolation=cpaeMacAuthBypassViolation, cpaeWebAuthPortIpDevTrackEnabled=cpaeWebAuthPortIpDevTrackEnabled, cpaeWebAuthLoginFailedPage=cpaeWebAuthLoginFailedPage, cpaeSuppPortEapProfileName=cpaeSuppPortEapProfileName, cpaeGlobalSecViolationAction=cpaeGlobalSecViolationAction, cpaeMacAuthBypassPortMacAddress=cpaeMacAuthBypassPortMacAddress, cpaeCompliance9=cpaeCompliance9, cpaeWebAuthCriticalGroup=cpaeWebAuthCriticalGroup, cpaeMabPortIpDevTrackConfEntry=cpaeMabPortIpDevTrackConfEntry, cpaeHostAuthPaeState=cpaeHostAuthPaeState, cpaePortIpDevTrackConfigEntry=cpaePortIpDevTrackConfigEntry, cpaeSupplicantObjects=cpaeSupplicantObjects, cpaeHostUrlRedirectGroup=cpaeHostUrlRedirectGroup, cpaeMacAuthBypassPortAuthMethod=cpaeMacAuthBypassPortAuthMethod, cpaeSuppHostPaeState=cpaeSuppHostPaeState, cpaeMacAuthBypassPortTermAction=cpaeMacAuthBypassPortTermAction, cpaeAuthIabConfigGroup=cpaeAuthIabConfigGroup, cpaePortEapolTestGroup=cpaePortEapolTestGroup, cpaeNotificationControl=cpaeNotificationControl, cpaePortEapolTestTable=cpaePortEapolTestTable, cpaeAuthTimeToNextReAuth=cpaeAuthTimeToNextReAuth, cpaeAuthConfigGroup4=cpaeAuthConfigGroup4, cpaeHostInfoGroup3=cpaeHostInfoGroup3, cpaeWebAuthEnabled=cpaeWebAuthEnabled, cpaeWebAuthGroup=cpaeWebAuthGroup, cpaeNoGuestVlanNotif=cpaeNoGuestVlanNotif, cpaeSuppHostStatus=cpaeSuppHostStatus, ReAuthPeriodSource=ReAuthPeriodSource, cpaeAuthReAuthAction=cpaeAuthReAuthAction, cpaeHostBackendState=cpaeHostBackendState, cpaeDot1xSuppToGuestVlanAllowed=cpaeDot1xSuppToGuestVlanAllowed, cpaeUserGroupUserVlan=cpaeUserGroupUserVlan, cpaeDot1xSuppToGuestVlanGroup=cpaeDot1xSuppToGuestVlanGroup, cpaeMIBConformance=cpaeMIBConformance, cpaeWebAuthAaaFailGroup=cpaeWebAuthAaaFailGroup, cpaeGlobalSecViolationGroup=cpaeGlobalSecViolationGroup, cpaeUserGroupUserAddr=cpaeUserGroupUserAddr, cpaeHostInfoTable=cpaeHostInfoTable, cpaeMacAuthBypass=cpaeMacAuthBypass, cpaeGlobalAuthFailMaxAttempts=cpaeGlobalAuthFailMaxAttempts, cpaePortEntry=cpaePortEntry, cpaeMabPortIpDevTrackConfTable=cpaeMabPortIpDevTrackConfTable, cpaeCompliance4=cpaeCompliance4, cpaeCompliance7=cpaeCompliance7, cpaeMacAuthBypassPortReAuth=cpaeMacAuthBypassPortReAuth, cpaeMultipleHost=cpaeMultipleHost, cpaePortEapolTestStatus=cpaePortEapolTestStatus, cpaeMIBGroups=cpaeMIBGroups, cpaeGuestVlanGroup2=cpaeGuestVlanGroup2, cpaeWebAuthSessionPeriod=cpaeWebAuthSessionPeriod, CpaeAuthState=CpaeAuthState, cpaeSuppPortEntry=cpaeSuppPortEntry, cpaeCriticalRecoveryDelay=cpaeCriticalRecoveryDelay, cpaeAuthReAuthPeriodOper=cpaeAuthReAuthPeriodOper, cpaeMabPortIpDevTrackConfGroup=cpaeMabPortIpDevTrackConfGroup, cpaeNoAuthFailVlanNotifEnable=cpaeNoAuthFailVlanNotifEnable, cpaeHostInfoMacAddress=cpaeHostInfoMacAddress, cpaeMIBCompliances=cpaeMIBCompliances, cpaeGuestVlanNotif=cpaeGuestVlanNotif, cpaeRadiusAccountingEnabled=cpaeRadiusAccountingEnabled, cpaeGuestVlanId=cpaeGuestVlanId, cpaeSuppPortProfileGroup=cpaeSuppPortProfileGroup, cpaeAuthConfigGroup3=cpaeAuthConfigGroup3, cpaeWebAuthHostAddress=cpaeWebAuthHostAddress, cpaeNoGuestVlanNotifEnable=cpaeNoGuestVlanNotifEnable, cpaePortOperVlanGroup=cpaePortOperVlanGroup, cpaePortEapolTestLimits=cpaePortEapolTestLimits, cpaeNoAuthFailVlanNotifEnableGrp=cpaeNoAuthFailVlanNotifEnableGrp, cpaeAuthFailVlanNotifEnableGrp=cpaeAuthFailVlanNotifEnableGrp, cpaeMacAuthBypassShutdownTimeout=cpaeMacAuthBypassShutdownTimeout, cpaeWebAuthPortEntry=cpaeWebAuthPortEntry, cpaeSuppHostBackendState=cpaeSuppHostBackendState, cpaeUserGroupUserInterface=cpaeUserGroupUserInterface, cpaeMacAuthBypassPortPostureTok=cpaeMacAuthBypassPortPostureTok, cpaeMacAuthBypassReAuthEnabled=cpaeMacAuthBypassReAuthEnabled, cpaeAuthFailUserName=cpaeAuthFailUserName, cpaeCriticalEapolConfigGroup=cpaeCriticalEapolConfigGroup, cpaeMacAuthBypassPortEntry=cpaeMacAuthBypassPortEntry, cpaeMacAuthBypassPortAuthState=cpaeMacAuthBypassPortAuthState, cpaeHostPostureTokenGroup=cpaeHostPostureTokenGroup, cpaeMacAuthBypassPortInitialize=cpaeMacAuthBypassPortInitialize, cpaeCriticalConfig=cpaeCriticalConfig, cpaePortCapabilitiesEnabled=cpaePortCapabilitiesEnabled, PYSNMP_MODULE_ID=ciscoPaeMIB, cpaeSuppPortCredentialProfileName=cpaeSuppPortCredentialProfileName, cpaeWebAuthPortAaaFailPolicy=cpaeWebAuthPortAaaFailPolicy, cpaeWebAuthHostInitialize=cpaeWebAuthHostInitialize, cpaeUserGroupName=cpaeUserGroupName, cpaePortEapolTestResult=cpaePortEapolTestResult, cpaeMIBObject=cpaeMIBObject, cpaeAuthConfigGroup2=cpaeAuthConfigGroup2, cpaeWebAuthHostSessionTimeLeft=cpaeWebAuthHostSessionTimeLeft, cpaePortEapolTestEntry=cpaePortEapolTestEntry, cpaeMabCriticalRecoveryDelay=cpaeMabCriticalRecoveryDelay, cpaeWebAuthQuietPeriod=cpaeWebAuthQuietPeriod, cpaeAuthPaeState=cpaeAuthPaeState, cpaePortMode=cpaePortMode, cpaeUserGroupGroup=cpaeUserGroupGroup, cpaeWebAuthHostState=cpaeWebAuthHostState, cpaePortTable=cpaePortTable, cpaeUserGroupEntry=cpaeUserGroupEntry, cpaeMacAuthBypassPortTable=cpaeMacAuthBypassPortTable, cpaeGuestVlanNumber=cpaeGuestVlanNumber, cpaeWebAuthUnAuthStateTimeout=cpaeWebAuthUnAuthStateTimeout, cpaeAuthReAuthPeriodSrcOper=cpaeAuthReAuthPeriodSrcOper, cpaeAuthReAuthMax=cpaeAuthReAuthMax, cpaeHostSessionIdGroup=cpaeHostSessionIdGroup, cpaeCriticalEapolEnabled=cpaeCriticalEapolEnabled, cpaeWebAuthMaxRetries=cpaeWebAuthMaxRetries, cpaeCompliance2=cpaeCompliance2, cpaeWebAuthUnAuthTimeoutGroup=cpaeWebAuthUnAuthTimeoutGroup, cpaeShutdownTimeout=cpaeShutdownTimeout, cpaeWebAuth=cpaeWebAuth, cpaeGlobalAuthFailVlanGroup=cpaeGlobalAuthFailVlanGroup, cpaeWebAuthPortEnabled=cpaeWebAuthPortEnabled, cpaePortAuthFailUserInfoGroup=cpaePortAuthFailUserInfoGroup, cpaeMacAuthBypassCriticalGroup=cpaeMacAuthBypassCriticalGroup, cpaeAuthFailVlanNotifEnable=cpaeAuthFailVlanNotifEnable, cpaeSuppHostInfoSuppIndex=cpaeSuppHostInfoSuppIndex, cpaeNoAuthFailVlanNotif=cpaeNoAuthFailVlanNotif, cpaeShutdownTimeoutGroup=cpaeShutdownTimeoutGroup, cpaeCriticalRecoveryDelayGroup=cpaeCriticalRecoveryDelayGroup, cpaeMabPortIpDevTrackEnabled=cpaeMabPortIpDevTrackEnabled, cpaeMacAuthBypassGroup4=cpaeMacAuthBypassGroup4, cpaeCompliance5=cpaeCompliance5, cpaeMacAuthBypassGroup=cpaeMacAuthBypassGroup, cpaeMacAuthBypassPortUrlRedirect=cpaeMacAuthBypassPortUrlRedirect, cpaeCompliance8=cpaeCompliance8, cpaeMabAuditInfoGroup=cpaeMabAuditInfoGroup, cpaeHostUrlRedirection=cpaeHostUrlRedirection, cpaeMacAuthBypassPortSessionId=cpaeMacAuthBypassPortSessionId, cpaeHostInfoHostIndex=cpaeHostInfoHostIndex, cpaeHostInfoGroup=cpaeHostInfoGroup, cpaeAuthFailVlanNotifGroup=cpaeAuthFailVlanNotifGroup, cpaeMacAuthBypassGroup2=cpaeMacAuthBypassGroup2, cpaeWebAuthPortInitialize=cpaeWebAuthPortInitialize, cpaeAuthConfigTable=cpaeAuthConfigTable)
