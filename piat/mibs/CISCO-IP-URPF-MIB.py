...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IP-URPF-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:25:42 2019
...
ModuleIdentity, NotificationType, Unsigned32, IpAddress, Gauge32, ObjectIdentity, Counter32, MibIdentifier, Bits, TimeTicks, Integer32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Unsigned32", "IpAddress", "Gauge32", "ObjectIdentity", "Counter32", "MibIdentifier", "Bits", "TimeTicks", "Integer32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CISCO-IP-URPF-MIB", ciscoIpUrpfMIBVrfObjectGroup=ciscoIpUrpfMIBVrfObjectGroup, cipUrpfDropRateWindow=cipUrpfDropRateWindow, cipUrpfTable=cipUrpfTable, cipUrpfIfDrops=cipUrpfIfDrops, cipUrpfVrf=cipUrpfVrf, cipUrpfIfConfTable=cipUrpfIfConfTable, PYSNMP_MODULE_ID=ciscoIpUrpfMIB, cipUrpfVrfTable=cipUrpfVrfTable, cipUrpfIfDiscontinuityTime=cipUrpfIfDiscontinuityTime, cipUrpfIfIpVersion=cipUrpfIfIpVersion, UnicastRpfOptions=UnicastRpfOptions, cipUrpfDrops=cipUrpfDrops, cipUrpfInterfaceConfig=cipUrpfInterfaceConfig, cipUrpfVrfIfDrops=cipUrpfVrfIfDrops, cipUrpfIfDropRate=cipUrpfIfDropRate, cipUrpfStatistics=cipUrpfStatistics, ciscoIpUrpfMIBGroups=ciscoIpUrpfMIBGroups, cipUrpfVrfIfDiscontinuityTime=cipUrpfVrfIfDiscontinuityTime, ciscoIpUrpfMIBMainObjectGroup=ciscoIpUrpfMIBMainObjectGroup, cipUrpfVrfIfEntry=cipUrpfVrfIfEntry, ciscoIpUrpfMIB=ciscoIpUrpfMIB, cipUrpfIfConfEntry=cipUrpfIfConfEntry, cipUrpfScalar=cipUrpfScalar, cipUrpfIfCheckStrict=cipUrpfIfCheckStrict, cipUrpfDropNotifyHoldDownTime=cipUrpfDropNotifyHoldDownTime, cipUrpfIfNotifyDrHoldDownReset=cipUrpfIfNotifyDrHoldDownReset, cipUrpfIfVrfName=cipUrpfIfVrfName, cipUrpfIfNotifyDropRateThreshold=cipUrpfIfNotifyDropRateThreshold, cipUrpfIfMonEntry=cipUrpfIfMonEntry, cipUrpfIfDropRateNotify=cipUrpfIfDropRateNotify, ciscoIpUrpfMIBCompliance=ciscoIpUrpfMIBCompliance, cipUrpfDropRate=cipUrpfDropRate, cipUrpfComputeInterval=cipUrpfComputeInterval, cipUrpfIfSuppressedDrops=cipUrpfIfSuppressedDrops, cipUrpfVrfIfTable=cipUrpfVrfIfTable, ciscoIpUrpfMIBNotifs=ciscoIpUrpfMIBNotifs, cipUrpfIpVersion=cipUrpfIpVersion, ciscoIpUrpfMIBCompliances=ciscoIpUrpfMIBCompliances, cipUrpfEntry=cipUrpfEntry, ciscoIpUrpfMIBConformance=ciscoIpUrpfMIBConformance, cipUrpfVrfEntry=cipUrpfVrfEntry, cipUrpfVrfName=cipUrpfVrfName, cipUrpfIfDropRateNotifyEnable=cipUrpfIfDropRateNotifyEnable, UnicastRpfType=UnicastRpfType, cipUrpfIfMonTable=cipUrpfIfMonTable, ciscoIpUrpfMIBObjects=ciscoIpUrpfMIBObjects, cipUrpfIfWhichRouteTableID=cipUrpfIfWhichRouteTableID, ciscoIpUrpfMIBNotifyGroup=ciscoIpUrpfMIBNotifyGroup)
