...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IPSEC-TC
# Produced by pysmi-0.3.4 at Sun Apr 21 23:45:48 2019
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, ModuleIdentity, iso, TimeTicks, Counter64, IpAddress, ObjectIdentity, MibIdentifier, Integer32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "ModuleIdentity", "iso", "TimeTicks", "Counter64", "IpAddress", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("CISCO-IPSEC-TC", CIPsecNumCryptoMaps=CIPsecNumCryptoMaps, CIPsecIkePRFAlgorithm=CIPsecIkePRFAlgorithm, CIKEIsakmpDoi=CIKEIsakmpDoi, PYSNMP_MODULE_ID=ciscoIPsecTc, CIPsecIkeAuthMethod=CIPsecIkeAuthMethod, CIPsecEndPtType=CIPsecEndPtType, CIPsecPhase1TunnelIndexOrZero=CIPsecPhase1TunnelIndexOrZero, ciscoIPsecTc=ciscoIPsecTc, CIPsecIkeNegoMode=CIPsecIkeNegoMode, CIPsecPmtu=CIPsecPmtu, CIPsecLifesize=CIPsecLifesize, CIPsecPhase1PeerIdentityType=CIPsecPhase1PeerIdentityType, CIPsecIkeHashAlgorithm=CIPsecIkeHashAlgorithm, CIPsecCryptomapSetBindStatus=CIPsecCryptomapSetBindStatus, CIPsecEncapMode=CIPsecEncapMode, CIPsecLifetime=CIPsecLifetime, CIPsecProtocol=CIPsecProtocol, CIPsecCompAlgorithm=CIPsecCompAlgorithm, CIPsecTunnelStatus=CIPsecTunnelStatus, CIPsecTunnelIdleTime=CIPsecTunnelIdleTime, CIPsecAuthAlgorithm=CIPsecAuthAlgorithm, CIPsecCryptomapType=CIPsecCryptomapType, CIPsecDiffHellmanGrp=CIPsecDiffHellmanGrp, CIPsecSpi=CIPsecSpi, CCryptoMD5Hash=CCryptoMD5Hash, CIPsecPhase1TunnelIndex=CIPsecPhase1TunnelIndex, CIPsecEncryptAlgorithm=CIPsecEncryptAlgorithm, CIPsecPhase2TunnelIndex=CIPsecPhase2TunnelIndex, CIPsecTransform=CIPsecTransform, CIPsecControlProtocol=CIPsecControlProtocol, CIPsecSecuritySuite=CIPsecSecuritySuite, CIKELifetime=CIKELifetime, CIPsecPhase2SaDirection=CIPsecPhase2SaDirection, CIPsecEncryptionKeySize=CIPsecEncryptionKeySize, CIKELifesize=CIKELifesize, CIPsecNATTraversalMode=CIPsecNATTraversalMode)
