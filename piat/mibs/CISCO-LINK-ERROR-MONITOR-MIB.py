...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-LINK-ERROR-MONITOR-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:45:01 2019
...
Bits, IpAddress, ObjectIdentity, ModuleIdentity, iso, Integer32, MibIdentifier, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "ObjectIdentity", "ModuleIdentity", "iso", "Integer32", "MibIdentifier", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("CISCO-LINK-ERROR-MONITOR-MIB", ciscoLinkErrMonMIBCompliances=ciscoLinkErrMonMIBCompliances, ciscoLinkErrMonMIBObjects=ciscoLinkErrMonMIBObjects, clemIfCounterType=clemIfCounterType, clemIfCounterEnable=clemIfCounterEnable, ciscoLinkErrorMonitorMIB=ciscoLinkErrorMonitorMIB, clemNotificationGroup=clemNotificationGroup, clemGlobalObjects=clemGlobalObjects, clemThresholdLow=clemThresholdLow, ciscoLinkErrMonMIBConform=ciscoLinkErrMonMIBConform, clemThresholdCounterType=clemThresholdCounterType, clemNotificationControlGroup=clemNotificationControlGroup, ciscoLinkErrMonMIBGroups=ciscoLinkErrMonMIBGroups, ciscoLinkErrMonMIBNotifs=ciscoLinkErrMonMIBNotifs, clemThresholdHigh=clemThresholdHigh, clemThresholdGroup=clemThresholdGroup, PYSNMP_MODULE_ID=ciscoLinkErrorMonitorMIB, clemEnabled=clemEnabled, ciscoLinkErrMonMIBCompliance=ciscoLinkErrMonMIBCompliance, clemNotifEnable=clemNotifEnable, clemHighThresholdExceeded=clemHighThresholdExceeded, clemGlobalGroup=clemGlobalGroup, clemIfCounterTable=clemIfCounterTable, clemIfCounterGroup=clemIfCounterGroup, clemIfCounterEntry=clemIfCounterEntry, clemLowThresholdExceeded=clemLowThresholdExceeded, clemThresholdEntry=clemThresholdEntry, clemAction=clemAction, clemThresholdTable=clemThresholdTable, clemSamplingInterval=clemSamplingInterval, clemSamplingTimes=clemSamplingTimes, clemInterfaceObjects=clemInterfaceObjects, ClemCounterType=ClemCounterType)
