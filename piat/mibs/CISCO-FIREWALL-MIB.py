...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-FIREWALL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:35:24 2019
...
Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Bits, ModuleIdentity, IpAddress, TimeTicks, Counter64, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Bits", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter64", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32")
RowPointer, DateAndTime, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DateAndTime", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("CISCO-FIREWALL-MIB", cfwNetEventDstIpPort=cfwNetEventDstIpPort, ConnectionEvent=ConnectionEvent, cfwBasicEventIndex=cfwBasicEventIndex, cfwNetEventSrcIpAddress=cfwNetEventSrcIpAddress, cfwNetEventInsideDstIpAddress=cfwNetEventInsideDstIpAddress, cfwStatistics=cfwStatistics, ciscoFirewallMIBNotificationGroup=ciscoFirewallMIBNotificationGroup, cfwNetEventIdentity=cfwNetEventIdentity, cfwHardwareInformation=cfwHardwareInformation, AccessEvent=AccessEvent, cfwBasicEventsTableLastRow=cfwBasicEventsTableLastRow, cfwBasicEventTime=cfwBasicEventTime, ciscoFirewallMIBNotifications=ciscoFirewallMIBNotifications, ciscoFirewallMIBStatisticsGroup=ciscoFirewallMIBStatisticsGroup, cfwBasicEventsTable=cfwBasicEventsTable, ciscoFirewallMIBCompliances=ciscoFirewallMIBCompliances, cfwEvents=cfwEvents, cfwNetEventsEntry=cfwNetEventsEntry, cfwNetEventDstIpAddress=cfwNetEventDstIpAddress, cfwAccessNotification=cfwAccessNotification, cfwNetEvents=cfwNetEvents, Hardware=Hardware, cfwBufferStatType=cfwBufferStatType, cfwConnectionStatValue=cfwConnectionStatValue, cfwConnectionStatTable=cfwConnectionStatTable, cfwNetEventInsideSrcIpPort=cfwNetEventInsideSrcIpPort, cfwContentInspectNotification=cfwContentInspectNotification, ciscoFirewallMIB=ciscoFirewallMIB, cfwConnNotification=cfwConnNotification, AuthenticationEvent=AuthenticationEvent, Services=Services, cfwBasicContentInspEventType=cfwBasicContentInspEventType, cfwNetEventInsideDstIpPort=cfwNetEventInsideDstIpPort, SecurityEvent=SecurityEvent, cfwConnectionStatEntry=cfwConnectionStatEntry, cfwBasicEventsEntry=cfwBasicEventsEntry, ciscoFirewallMIBNotificationGroupRev1=ciscoFirewallMIBNotificationGroupRev1, cfwBufferStatSize=cfwBufferStatSize, ciscoFirewallMIBCompliance=ciscoFirewallMIBCompliance, HardwareStatus=HardwareStatus, ConnectionStat=ConnectionStat, cfwNetEventServiceInformation=cfwNetEventServiceInformation, cfwBasicGenericEventType=cfwBasicGenericEventType, cfwBasicEventDetailsTableRow=cfwBasicEventDetailsTableRow, GenericEvent=GenericEvent, cfwNetEventsTableLastRow=cfwNetEventsTableLastRow, cfwNetEventInterface=cfwNetEventInterface, ciscoFirewallMIBConformance=ciscoFirewallMIBConformance, cfwBasicAccessEventType=cfwBasicAccessEventType, cfwSystem=cfwSystem, cfwAuthNotification=cfwAuthNotification, cfwHardwareStatusValue=cfwHardwareStatusValue, cfwBufferStatsEntry=cfwBufferStatsEntry, cfwNetEventDescription=cfwNetEventDescription, ciscoFirewallMIBObjects=ciscoFirewallMIBObjects, cfwConnectionStatDescription=cfwConnectionStatDescription, cfwBufferStatValue=cfwBufferStatValue, ResourceStatistics=ResourceStatistics, cfwConnectionStatService=cfwConnectionStatService, cfwBasicAuthenticationEventType=cfwBasicAuthenticationEventType, cfwConnectionStatType=cfwConnectionStatType, cfwNetEventSrcIpPort=cfwNetEventSrcIpPort, cfwHardwareType=cfwHardwareType, cfwHardwareStatusDetail=cfwHardwareStatusDetail, ciscoFirewallMIBComplianceRev1=ciscoFirewallMIBComplianceRev1, cfwNetEventService=cfwNetEventService, PYSNMP_MODULE_ID=ciscoFirewallMIB, cfwHardwareStatusEntry=cfwHardwareStatusEntry, cfwSecurityNotification=cfwSecurityNotification, cfwBasicConnectionEventType=cfwBasicConnectionEventType, cfwNetEventsTable=cfwNetEventsTable, cfwNetEventInsideSrcIpAddress=cfwNetEventInsideSrcIpAddress, ciscoFirewallMIBEventsGroup=ciscoFirewallMIBEventsGroup, cfwNetEventIndex=cfwNetEventIndex, cfwConnectionStatCount=cfwConnectionStatCount, cfwBasicEvents=cfwBasicEvents, cfwBasicEventDescription=cfwBasicEventDescription, cfwBufferStatsTable=cfwBufferStatsTable, ciscoFirewallMIBGroups=ciscoFirewallMIBGroups, ContentInspectionEvent=ContentInspectionEvent, cfwBufferStatInformation=cfwBufferStatInformation, ciscoFirewallMIBNotificationPrefix=ciscoFirewallMIBNotificationPrefix, cfwHardwareStatusTable=cfwHardwareStatusTable, cfwBasicSecurityEventType=cfwBasicSecurityEventType, cfwGenericNotification=cfwGenericNotification, cfwStatus=cfwStatus)
