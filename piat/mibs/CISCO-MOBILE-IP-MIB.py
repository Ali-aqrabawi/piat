...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-MOBILE-IP-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:47:25 2019
...
faCOAEntry, mnRegAgentAddress, mnRegistrationEntry, mnState, haMobilityBindingEntry, mnRegCOA, RegistrationFlags, mnHAEntry = mibBuilder.importSymbols("MIP-MIB", "faCOAEntry", "mnRegAgentAddress", "mnRegistrationEntry", "mnState", "haMobilityBindingEntry", "mnRegCOA", "RegistrationFlags", "mnHAEntry")
ZeroBasedCounter32, = mibBuilder.importSymbols("RMON2-MIB", "ZeroBasedCounter32")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Gauge32, Counter32, Unsigned32, TimeTicks, Bits, ModuleIdentity, IpAddress, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Unsigned32", "TimeTicks", "Bits", "ModuleIdentity", "IpAddress", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "NotificationType")
TextualConvention, DisplayString, RowStatus, TruthValue, TimeStamp, TimeInterval, DateAndTime, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "TruthValue", "TimeStamp", "TimeInterval", "DateAndTime", "MacAddress")
...
mibBuilder.exportSymbols("CISCO-MOBILE-IP-MIB", cmiFaAdvertisement=cmiFaAdvertisement, cmiSecPeerIdentifierType=cmiSecPeerIdentifierType, cmiHaDeRegRequestsDenied=cmiHaDeRegRequestsDenied, cmiFaDeRegRepliesValidFromHA=cmiFaDeRegRepliesValidFromHA, ciscoMobileIpComplianceV12R05=ciscoMobileIpComplianceV12R05, ciscoMobileIpHaRegGroup=ciscoMobileIpHaRegGroup, cmiHaMobNet=cmiHaMobNet, cmiFaTotalRegRequests=cmiFaTotalRegRequests, ciscoMobileIpMrNotificationGroup=ciscoMobileIpMrNotificationGroup, cmiMrIfSolicitRetransLimit=cmiMrIfSolicitRetransLimit, cmiHaRegRequestsReceived=cmiHaRegRequestsReceived, cmiMrIfCCoaOnly=cmiMrIfCCoaOnly, cmiMrMaAdvMaxLifetime=cmiMrMaAdvMaxLifetime, cmiMrHATable=cmiMrHATable, cmiMrMobNetEntry=cmiMrMobNetEntry, cmiFaSystem=cmiFaSystem, cmiFaCoaTable=cmiFaCoaTable, cmiMaInterfaceAddressType=cmiMaInterfaceAddressType, ciscoMobileIpMrSystemGroupV3=ciscoMobileIpMrSystemGroupV3, cmiHaRedunSecViolations=cmiHaRedunSecViolations, cmiHaEncapUnavailable=cmiHaEncapUnavailable, cmiMaRegMaxInMinuteRegs=cmiMaRegMaxInMinuteRegs, cmiMrIfTable=cmiMrIfTable, ciscoMobileIpTrapObjectsGroupV2=ciscoMobileIpTrapObjectsGroupV2, cmiFaReRegRepliesValidRelayToMN=cmiFaReRegRepliesValidRelayToMN, cmiHaRegIntervalMaxActiveBindings=cmiHaRegIntervalMaxActiveBindings, cmiMrIfHoldDown=cmiMrIfHoldDown, cmiMrIfStatus=cmiMrIfStatus, cmiHaRegTotalMobilityBindings=cmiHaRegTotalMobilityBindings, CmiRegistrationFlags=CmiRegistrationFlags, ciscoMobileIpGroups=ciscoMobileIpGroups, cmiMrHAPriority=cmiMrHAPriority, cmiFaUnknownChallenge=cmiFaUnknownChallenge, cmiHaRegRecentServDeniedCode=cmiHaRegRecentServDeniedCode, ciscoMobileIpHaRegTunnelStatsGroup=ciscoMobileIpHaRegTunnelStatsGroup, cmiHaCvsesFromMnRejected=cmiHaCvsesFromMnRejected, cmiHaMaxBindingsNotif=cmiHaMaxBindingsNotif, cmiHaMrStatus=cmiHaMrStatus, cmiHaRegTunnelStatsInBitRate=cmiHaRegTunnelStatsInBitRate, cmiNtRegHomeAgent=cmiNtRegHomeAgent, cmiMrTunnelBytesSent=cmiMrTunnelBytesSent, cmiMa=cmiMa, cmiSecTotalViolations=cmiSecTotalViolations, cmiFaAdvertConfTable=cmiFaAdvertConfTable, ciscoMobileIpHaRegIntervalStatsGroup=ciscoMobileIpHaRegIntervalStatsGroup, cmiHaNAICheckFailures=cmiHaNAICheckFailures, cmiSecKey=cmiSecKey, cmiMnRecentAdvReceived=cmiMnRecentAdvReceived, cmiHaMobNetEntry=cmiHaMobNetEntry, cmiNtRegHAAddrType=cmiNtRegHAAddrType, cmiFaRegVisitorChallengeValue=cmiFaRegVisitorChallengeValue, cmiHaRegTunnelStatsDestAddr=cmiHaRegTunnelStatsDestAddr, cmiHaRedunReceivedBUs=cmiHaRedunReceivedBUs, cmiHaRegAvgTimeRegsProcByAAA=cmiHaRegAvgTimeRegsProcByAAA, cmiFaChallengeSupported=cmiFaChallengeSupported, cmiMnDiscovery=cmiMnDiscovery, cmiMrIfRegisteredCoAType=cmiMrIfRegisteredCoAType, cmiSecViolatorIdentifier=cmiSecViolatorIdentifier, ciscoMobileIpHaRegGroupV12R03r2Sup2=ciscoMobileIpHaRegGroupV12R03r2Sup2, cmiMrIfRoamPriority=cmiMrIfRoamPriority, cmiMaAdvMaxRegLifetime=cmiMaAdvMaxRegLifetime, cmiHaRedunReceivedBUAcks=cmiHaRedunReceivedBUAcks, cmiMaRegInLastMinuteRegs=cmiMaRegInLastMinuteRegs, cmiFaAdvertChallengeValue=cmiFaAdvertChallengeValue, PYSNMP_MODULE_ID=ciscoMobileIpMIB, cmiSecViolationEntry=cmiSecViolationEntry, cmiFaInitRegRepliesValidRelayMN=cmiFaInitRegRepliesValidRelayMN, cmiMrIfCCoaRegistration=cmiMrIfCCoaRegistration, cmiMaAdvConfigEntry=cmiMaAdvConfigEntry, cmiMrIfIndex=cmiMrIfIndex, cmiHaMobNetPfxLen=cmiHaMobNetPfxLen, cmiFaRegVisitorIdentifierType=cmiFaRegVisitorIdentifierType, cmiFaRegVisitorEntry=cmiFaRegVisitorEntry, cmiHaInitRegRequestsAccepted=cmiHaInitRegRequestsAccepted, cmiNtRegCOA=cmiNtRegCOA, ciscoMobileIpHaRegGroupV12R02=ciscoMobileIpHaRegGroupV12R02, cmiMrIfCCoaEnable=cmiMrIfCCoaEnable, cmiMrTunnelPktsSent=cmiMrTunnelPktsSent, cmiHaRegServDeniedRequests=cmiHaRegServDeniedRequests, cmiFaDeRegRequestsDiscarded=cmiFaDeRegRequestsDiscarded, cmiHaReRegRequestsDiscarded=cmiHaReRegRequestsDiscarded, ciscoMobileIpMrRegistrationGroup=ciscoMobileIpMrRegistrationGroup, cmiFaRegVisitorTimeGranted=cmiFaRegVisitorTimeGranted, cmiHaRegRequestsDiscarded=cmiHaRegRequestsDiscarded, cmiMrBetterIfDetected=cmiMrBetterIfDetected, cmiMrStateChange=cmiMrStateChange, CmiEntityIdentifierType=CmiEntityIdentifierType, cmiFaRegVisitorTable=cmiFaRegVisitorTable, cmiSecViolatorIdentifierType=cmiSecViolatorIdentifierType, cmiHaRegMnIfID=cmiHaRegMnIfID, cmiFaDeRegRequestsRelayed=cmiFaDeRegRequestsRelayed, cmiHaRegServAcceptedRequests=cmiHaRegServAcceptedRequests, cmiHaMrAddr=cmiHaMrAddr, cmiMrIfCCoaRegRetryRemaining=cmiMrIfCCoaRegRetryRemaining, ciscoMobileIpHaRegGroupV1=ciscoMobileIpHaRegGroupV1, ciscoMobileIpComplianceV12R09=ciscoMobileIpComplianceV12R09, cmiFaInitRegRepliesValidFromHA=cmiFaInitRegRepliesValidFromHA, cmiFaRegVisitorIdentifier=cmiFaRegVisitorIdentifier, cmiFaReRegRequestsReceived=cmiFaReRegRequestsReceived, cmiMrIfSolicitRetransCount=cmiMrIfSolicitRetransCount, cmiMrRedStatePassive=cmiMrRedStatePassive, cmiMrDiscovery=cmiMrDiscovery, cmiHaReverseTunnelUnavailable=cmiHaReverseTunnelUnavailable, ciscoMobileIpComplianceRev1=ciscoMobileIpComplianceRev1, ciscoMobileIpHaRegGroupV12R03r2=ciscoMobileIpHaRegGroupV12R03r2, cmiMrRedStateActive=cmiMrRedStateActive, ciscoMobileIpMIBObjects=ciscoMobileIpMIBObjects, cmiHaReRegRequestsReceived=cmiHaReRegRequestsReceived, cmiFaCoaRegAsymLink=cmiFaCoaRegAsymLink, ciscoMobileIpMrSystemGroupV1=ciscoMobileIpMrSystemGroupV1, cmiFaReverseTunnelBitNotSet=cmiFaReverseTunnelBitNotSet, cmiHaRedunReceivedBIReqs=cmiHaRedunReceivedBIReqs, cmiMaAdvMaxAdvLifetime=cmiMaAdvMaxAdvLifetime, cmiHaRegDateMaxRegsProcLoc=cmiHaRegDateMaxRegsProcLoc, cmiMrIfRegisteredMaAddr=cmiMrIfRegisteredMaAddr, cmiHaReverseTunnelBitNotSet=cmiHaReverseTunnelBitNotSet, cmiMaReg=cmiMaReg, cmiHaRegMnIdentifierType=cmiHaRegMnIdentifierType, cmiMrIfSolicitInterval=cmiMrIfSolicitInterval, cmiSecKey2=cmiSecKey2, cmiMrRegRetransInitial=cmiMrRegRetransInitial, cmiHaRegTunnelStatsEntry=cmiHaRegTunnelStatsEntry, ciscoMobileIpComplianceV12R03=ciscoMobileIpComplianceV12R03, cmiMrIfRoamStatus=cmiMrIfRoamStatus, cmiFaInitRegRequestsDiscarded=cmiFaInitRegRequestsDiscarded, ciscoMobileIpCompliances=ciscoMobileIpCompliances, ciscoMobileIpMaRegGroup=ciscoMobileIpMaRegGroup, cmiSecurity=cmiSecurity, cmiMrHAEntry=cmiMrHAEntry, cmiSecRecentViolationIDHigh=cmiSecRecentViolationIDHigh, cmiSecRecentViolationReason=cmiSecRecentViolationReason, cmiHaRedunReceivedBIAcks=cmiHaRedunReceivedBIAcks, cmiMaAdvAddressType=cmiMaAdvAddressType, cmiFaAdvertChallengeChapSPI=cmiFaAdvertChallengeChapSPI, ciscoMobileIpFaRegGroupV12R03r1=ciscoMobileIpFaRegGroupV12R03r1, cmiMrIfSolicitRetransRemaining=cmiMrIfSolicitRetransRemaining, cmiMaAdvPrefixLengthInclusion=cmiMaAdvPrefixLengthInclusion, cmiFaAdvertChallengeTable=cmiFaAdvertChallengeTable, cmiFaNvsesFromHaNeglected=cmiFaNvsesFromHaNeglected, cmiFaAdvertChallengeWindow=cmiFaAdvertChallengeWindow, ciscoMobileIpFaRegGroupV12R02=ciscoMobileIpFaRegGroupV12R02, cmiHaEncapsulationUnavailable=cmiHaEncapsulationUnavailable, cmiMrRedundancyGroup=cmiMrRedundancyGroup, ciscoMobileIpComplianceV12R07=ciscoMobileIpComplianceV12R07, cmiHa=cmiHa, ciscoMobileIpHaRegGroupV12R03r1=ciscoMobileIpHaRegGroupV12R03r1, ciscoMobileIpComplianceV12R06=ciscoMobileIpComplianceV12R06, cmiMrRegRetransMax=cmiMrRegRetransMax, cmiHaRegTunnelStatsTable=cmiHaRegTunnelStatsTable, cmiMrMaAdvLifetimeRemaining=cmiMrMaAdvLifetimeRemaining, cmiFaDeRegRepliesValidRelayToMN=cmiFaDeRegRepliesValidRelayToMN, cmiFaInterfaceEntry=cmiFaInterfaceEntry, cmiHaRedunTotalSentBIReps=cmiHaRedunTotalSentBIReps, cmiFaRegTotalVisitors=cmiFaRegTotalVisitors, CmiEntityIdentifier=CmiEntityIdentifier, cmiMaRegDateMaxRegsReceived=cmiMaRegDateMaxRegsReceived, cmiHaInitRegRequestsDiscarded=cmiHaInitRegRequestsDiscarded, cmiFaReRegRequestsDiscarded=cmiFaReRegRequestsDiscarded, cmiFaReverseTunnelUnavailable=cmiFaReverseTunnelUnavailable, cmiMrMaHoldDownRemaining=cmiMrMaHoldDownRemaining, cmiHaDeRegRequestsDiscarded=cmiHaDeRegRequestsDiscarded, cmiMnRegistration=cmiMnRegistration, cmiFaRegVisitorHomeAddress=cmiFaRegVisitorHomeAddress, cmiHaRegTunnelStatsSrcAddrType=cmiHaRegTunnelStatsSrcAddrType, cmiHaRedun=cmiHaRedun, cmiMrSystem=cmiMrSystem, cmiFaCvsesFromHaRejected=cmiFaCvsesFromHaRejected, cmiHaRegProcAAAInLastByMinRegs=cmiHaRegProcAAAInLastByMinRegs, cmiMrIfSolicitRetransInitial=cmiMrIfSolicitRetransInitial, cmiFaAdvertIsBusy=cmiFaAdvertIsBusy, cmiMrRegExtendRetry=cmiMrRegExtendRetry, ciscoMobileIpMrSystemGroupV3Sup1=ciscoMobileIpMrSystemGroupV3Sup1, cmiHaMrMultiPathMetricType=cmiHaMrMultiPathMetricType, cmiFaInitRegRequestsReceived=cmiFaInitRegRequestsReceived, cmiMrMaAdvTable=cmiMrMaAdvTable, cmiMrMaIsHa=cmiMrMaIsHa, cmiHaRegMnId=cmiHaRegMnId, cmiTrapObjects=cmiTrapObjects, cmiMrMaAdvEntry=cmiMrMaAdvEntry, ciscoMobileIpComplianceV12R03r1=ciscoMobileIpComplianceV12R03r1, ciscoMobileIpHaMobNetGroup=ciscoMobileIpHaMobNetGroup, cmiTrapControl=cmiTrapControl, cmiMrMultiPath=cmiMrMultiPath, cmiHaRegTunnelStatsDestAddrType=cmiHaRegTunnelStatsDestAddrType, cmiHaRegMobilityBindingEntry=cmiHaRegMobilityBindingEntry, cmiHaCvsesFromFaRejected=cmiHaCvsesFromFaRejected, ciscoMobileIpMrDiscoveryGroup=ciscoMobileIpMrDiscoveryGroup, cmiSecStatus=cmiSecStatus, ciscoMobileIpTrapObjectsGroup=ciscoMobileIpTrapObjectsGroup, ciscoMobileIpHaRedunGroup=ciscoMobileIpHaRedunGroup, cmiMrMaAdvTimeFirstHeard=cmiMrMaAdvTimeFirstHeard, cmiHaRegRequestsDenied=cmiHaRegRequestsDenied, cmiMrHABest=cmiMrHABest, cmiHaRedunSentBIAcks=cmiHaRedunSentBIAcks, cmiMrIfID=cmiMrIfID, ciscoMobileIpMrSystemGroup=ciscoMobileIpMrSystemGroup, cmiSecPeerIdentifier=cmiSecPeerIdentifier, cmiHaNvsesFromFaNeglected=cmiHaNvsesFromFaNeglected, cmiHaRegProcLocInLastMinRegs=cmiHaRegProcLocInLastMinRegs, cmiHaSystemVersion=cmiHaSystemVersion, cmiMrMaIfMacAddress=cmiMrMaIfMacAddress, cmiFaCvsesFromMnRejected=cmiFaCvsesFromMnRejected, cmiHaMnHaAuthFailures=cmiHaMnHaAuthFailures, cmiMnRegFlags=cmiMnRegFlags, cmiHaRegMaxProcByAAAInMinRegs=cmiHaRegMaxProcByAAAInMinRegs, ciscoMobileIpHaRegGroupV12R03=ciscoMobileIpHaRegGroupV12R03, cmiHaRegMaxProcLocInMinRegs=cmiHaRegMaxProcLocInMinRegs, cmiFaCoaTransmitOnly=cmiFaCoaTransmitOnly, CmiMultiPathMetricType=CmiMultiPathMetricType, cmiMaAdvConfigTable=cmiMaAdvConfigTable, cmiSecAlgorithmMode=cmiSecAlgorithmMode, cmiHaDeRegRequestsAccepted=cmiHaDeRegRequestsAccepted, cmiFaRegVisitorRegIsAccepted=cmiFaRegVisitorRegIsAccepted, cmiMrIfSolicitPeriodic=cmiMrIfSolicitPeriodic, ciscoMobileIpFaRegGroupV12R03=ciscoMobileIpFaRegGroupV12R03, cmiHaRegTotalProcByAAARegs=cmiHaRegTotalProcByAAARegs, cmiFaStaleChallenge=cmiFaStaleChallenge, cmiMrRegExtendExpire=cmiMrRegExtendExpire, ciscoMobileIpComplianceRev2=ciscoMobileIpComplianceRev2, cmiMrTunnelBytesRcvd=cmiMrTunnelBytesRcvd, cmiMrMaAddress=cmiMrMaAddress, cmiFaRegVisitorHomeAgentAddress=cmiFaRegVisitorHomeAgentAddress, cmiHaRegTunnelStatsInPkts=cmiHaRegTunnelStatsInPkts, cmiFaRegVisitorRegFlags=cmiFaRegVisitorRegFlags, cmiFaDeRegRequestsReceived=cmiFaDeRegRequestsReceived, cmiHaRegInterval3gpp2MaxActiveBindings=cmiHaRegInterval3gpp2MaxActiveBindings, cmiNtRegHomeAddress=cmiNtRegHomeAddress, cmiFaAdvertChallengeEntry=cmiFaAdvertChallengeEntry, cmiFaRegVisitorRegIDHigh=cmiFaRegVisitorRegIDHigh, cmiMrRegRetransLimit=cmiMrRegRetransLimit, cmiMaAdvMinInterval=cmiMaAdvMinInterval, cmiMrRegistration=cmiMrRegistration, cmiHaRegMnIdentifier=cmiHaRegMnIdentifier, cmiHaMrAddrType=cmiHaMrAddrType, cmiHaRedunTotalSentBUs=cmiHaRedunTotalSentBUs, cmiHaRegTunnelStatsTunnelType=cmiHaRegTunnelStatsTunnelType, cmiHaMobNetTable=cmiHaMobNetTable, cmiMrMobNetPfxLen=cmiMrMobNetPfxLen, cmiMrIfSolicitRetransMax=cmiMrIfSolicitRetransMax, cmiFaCoaInterfaceOnly=cmiFaCoaInterfaceOnly, cmiHaRegDateMaxRegsProcByAAA=cmiHaRegDateMaxRegsProcByAAA, ciscoMobileIpHaRegGroupV12R03r2Sup1=ciscoMobileIpHaRegGroupV12R03r2Sup1, cmiFaReverseTunnelEnable=cmiFaReverseTunnelEnable, cmiHaRegTunnelStatsOutBytes=cmiHaRegTunnelStatsOutBytes, cmiSecViolationTable=cmiSecViolationTable, ciscoMobileIpMIB=ciscoMobileIpMIB, cmiMn=cmiMn, cmiHaRegOverallServTime=cmiHaRegOverallServTime, cmiFaDeRegRequestsDenied=cmiFaDeRegRequestsDenied, cmiMrMaAdvFlags=cmiMrMaAdvFlags, cmiHaRegMnIdType=cmiHaRegMnIdType, cmiMrIfCCoaAddressType=cmiMrIfCCoaAddressType, cmiHaRegCounterEntry=cmiHaRegCounterEntry, cmiFa=cmiFa)
mibBuilder.exportSymbols("CISCO-MOBILE-IP-MIB", cmiMrCoaChange=cmiMrCoaChange, ciscoMobileIpComplianceV12R11=ciscoMobileIpComplianceV12R11, cmiHaRedunFailedBUs=cmiHaRedunFailedBUs, ciscoMobileIpComplianceV12R04=ciscoMobileIpComplianceV12R04, ciscoMobileIpCompliance=ciscoMobileIpCompliance, cmiHaMnRegReqFailed=cmiHaMnRegReqFailed, cmiHaRegMnIfBandwidth=cmiHaRegMnIfBandwidth, cmiMaInterfaceAddress=cmiMaInterfaceAddress, cmiNtRegHomeAddressType=cmiNtRegHomeAddressType, cmiSecAssocEntry=cmiSecAssocEntry, cmiFaInterfaceTable=cmiFaInterfaceTable, cmiFaAdvertConfEntry=cmiFaAdvertConfEntry, cmiFaRegVisitorRegIDLow=cmiFaRegVisitorRegIDLow, cmiFaAdvertChallengeIndex=cmiFaAdvertChallengeIndex, cmiFaNvsesFromMnNeglected=cmiFaNvsesFromMnNeglected, cmiFaAdvertRegRequired=cmiFaAdvertRegRequired, cmiHaRedunFailedBIReps=cmiHaRedunFailedBIReps, cmiMrIfRegisteredMaAddrType=cmiMrIfRegisteredMaAddrType, ciscoMobileIpMnRegistrationGroup=ciscoMobileIpMnRegistrationGroup, cmiNtRegDeniedCode=cmiNtRegDeniedCode, cmiMaAdvResponseSolicitationOnly=cmiMaAdvResponseSolicitationOnly, cmiFaEncapDeliveryStyleSupported=cmiFaEncapDeliveryStyleSupported, cmiHaRegMaxTimeRegsProcByAAA=cmiHaRegMaxTimeRegsProcByAAA, ciscoMobileIpFaAdvertisementGroup=ciscoMobileIpFaAdvertisementGroup, cmiMaAdvMaxInterval=cmiMaAdvMaxInterval, cmiHaRegMnIfDescription=cmiHaRegMnIfDescription, cmiMrHaTunnelIfIndex=cmiMrHaTunnelIfIndex, cmiFaDeliveryStyleUnsupported=cmiFaDeliveryStyleUnsupported, cmiFaRevTunnelSupported=cmiFaRevTunnelSupported, cmiFaRegVisitorRegFlagsRev1=cmiFaRegVisitorRegFlagsRev1, cmiHaMrTable=cmiHaMrTable, cmiHaRegMnIfPathMetricType=cmiHaRegMnIfPathMetricType, cmiFaTotalRegReplies=cmiFaTotalRegReplies, cmiFaReRegRepliesValidFromHA=cmiFaReRegRepliesValidFromHA, cmiMrIfHaTunnelIfIndex=cmiMrIfHaTunnelIfIndex, cmiHaSystem=cmiHaSystem, cmiHaRegRecentServAcceptedTime=cmiHaRegRecentServAcceptedTime, cmiHaMobNetAddressType=cmiHaMobNetAddressType, cmiHaRegTunnelStatsOutPktRate=cmiHaRegTunnelStatsOutPktRate, ciscoMobileIpComplianceV12R02=ciscoMobileIpComplianceV12R02, cmiMrMaAdvMaxRegLifetime=cmiMrMaAdvMaxRegLifetime, cmiMrMobNetTable=cmiMrMobNetTable, cmiMrMultiPathMetricType=cmiMrMultiPathMetricType, cmiMrMobNetStatus=cmiMrMobNetStatus, cmiHaMrEntry=cmiHaMrEntry, cmiHaReg=cmiHaReg, cmiHaRedunTotalSentBIReqs=cmiHaRedunTotalSentBIReqs, cmiHaRedunFailedBIReqs=cmiHaRedunFailedBIReqs, cmiSecReplayMethod=cmiSecReplayMethod, cmiMnAdvFlags=cmiMnAdvFlags, ciscoMobileIpFaRegGroupV12R03r2=ciscoMobileIpFaRegGroupV12R03r2, cmiFaMnTooDistant=cmiFaMnTooDistant, cmiNtRegNAI=cmiNtRegNAI, cmiHaRedunDroppedBIAcks=cmiHaRedunDroppedBIAcks, ciscoMobileIpComplianceV12R10=ciscoMobileIpComplianceV12R10, cmiFaChallengeEnable=cmiFaChallengeEnable, ciscoMobileIpComplianceV12R08=ciscoMobileIpComplianceV12R08, cmiMrMaAdvSequence=cmiMrMaAdvSequence, cmiSecRecentViolationSPI=cmiSecRecentViolationSPI, cmiHaDeRegRequestsReceived=cmiHaDeRegRequestsReceived, cmiHaInitRegRequestsDenied=cmiHaInitRegRequestsDenied, cmiFaReRegRequestsDenied=cmiFaReRegRequestsDenied, cmiHaRegMobilityBindingMacAddress=cmiHaRegMobilityBindingMacAddress, cmiMrMobNetIfIndex=cmiMrMobNetIfIndex, cmiSecAlgorithmType=cmiSecAlgorithmType, cmiHaRegRecentServDeniedTime=cmiHaRegRecentServDeniedTime, ciscoMobileIpSecAssocGroup=ciscoMobileIpSecAssocGroup, cmiMrIfRegisteredCoA=cmiMrIfRegisteredCoA, cmiMrIfCCoaDefaultGw=cmiMrIfCCoaDefaultGw, cmiSecSPI=cmiSecSPI, cmiMnRegistrationTable=cmiMnRegistrationTable, cmiMaAdvStatus=cmiMaAdvStatus, cmiHaMnAAAAuthFailures=cmiHaMnAAAAuthFailures, cmiMnRegistrationEntry=cmiMnRegistrationEntry, cmiMaAdvertisement=cmiMaAdvertisement, cmiFaInitRegRequestsDenied=cmiFaInitRegRequestsDenied, cmiFaReg=cmiFaReg, cmiHaRegTunnelStatsOutBitRate=cmiHaRegTunnelStatsOutBitRate, ciscoMobileIpMrNotificationGroupV3=ciscoMobileIpMrNotificationGroupV3, cmiHaRegMobilityBindingRegFlags=cmiHaRegMobilityBindingRegFlags, ciscoMobileIpSecAssocGroupV12R02=ciscoMobileIpSecAssocGroupV12R02, ciscoMobileIpMIBNotifications=ciscoMobileIpMIBNotifications, cmiHaRedunReceivedBIReps=cmiHaRedunReceivedBIReps, cmiMrNewMA=cmiMrNewMA, cmiMaAdvAddress=cmiMaAdvAddress, cmiHaMobNetAddress=cmiHaMobNetAddress, cmiMrMobNetAddrType=cmiMrMobNetAddrType, ciscoMobileIpSecViolationGroup=ciscoMobileIpSecViolationGroup, cmiHaRedunDroppedBIReps=cmiHaRedunDroppedBIReps, cmiHaRegTunnelStatsInPktRate=cmiHaRegTunnelStatsInPktRate, cmiHaRedunSentBIReps=cmiHaRedunSentBIReps, cmiHaRedunSentBUs=cmiHaRedunSentBUs, CmiSpi=CmiSpi, ciscoMobileIpMIBConformance=ciscoMobileIpMIBConformance, cmiMaAdvertisementGroup=cmiMaAdvertisementGroup, cmiSecAssocTable=cmiSecAssocTable, cmiMrTunnelPktsRcvd=cmiMrTunnelPktsRcvd, cmiMrMaAdvTimeReceived=cmiMrMaAdvTimeReceived, cmiFaMissingChallenge=cmiFaMissingChallenge, cmiMrIfSolicitRetransCurrent=cmiMrIfSolicitRetransCurrent, cmiHaRegIntervalSize=cmiHaRegIntervalSize, cmiHaRedunSentBUAcks=cmiHaRedunSentBUAcks, cmiMrRegLifetime=cmiMrRegLifetime, cmiMrRegNewHa=cmiMrRegNewHa, cmiFaCoaEntry=cmiFaCoaEntry, cmiMrMobNetAddr=cmiMrMobNetAddr, cmiMrCollocatedTunnel=cmiMrCollocatedTunnel, cmiNtRegCOAType=cmiNtRegCOAType, cmiHaMobNetDynamic=cmiHaMobNetDynamic, cmiHaRegMobilityBindingTable=cmiHaRegMobilityBindingTable, cmiMrMaAddressType=cmiMrMaAddressType, cmiMrIfCCoaRegRetry=cmiMrIfCCoaRegRetry, cmiHaMaximumBindings=cmiHaMaximumBindings, ciscoMobileIpMnDiscoveryGroup=ciscoMobileIpMnDiscoveryGroup, cmiMRIfDescription=cmiMRIfDescription, cmiMaAdvInterfaceIndex=cmiMaAdvInterfaceIndex, cmiMrIfCCoaAddress=cmiMrIfCCoaAddress, cmiMrRegExtendInterval=cmiMrRegExtendInterval, cmiMrReverseTunnel=cmiMrReverseTunnel, cmiHaReRegRequestsAccepted=cmiHaReRegRequestsAccepted, cmiSecRecentViolationTime=cmiSecRecentViolationTime, cmiFaMnAAAAuthFailures=cmiFaMnAAAAuthFailures, ciscoMobileIpFaSystemGroup=ciscoMobileIpFaSystemGroup, cmiHaRegTunnelStatsNumUsers=cmiHaRegTunnelStatsNumUsers, cmiMrIfCCoaDefaultGwType=cmiMrIfCCoaDefaultGwType, cmiHaRegTunnelStatsOutPkts=cmiHaRegTunnelStatsOutPkts, ciscoMobileIpMrNotificationGroupV2=ciscoMobileIpMrNotificationGroupV2, cmiHaMrMultiPath=cmiHaMrMultiPath, cmiMrMaAdvRcvIf=cmiMrMaAdvRcvIf, cmiHaMrDynamic=cmiHaMrDynamic, cmiHaMobNetStatus=cmiHaMobNetStatus, cmiSecAssocsCount=cmiSecAssocsCount, CmiTunnelType=CmiTunnelType, cmiHaRegTunnelStatsInBytes=cmiHaRegTunnelStatsInBytes, cmiHaReRegRequestsDenied=cmiHaReRegRequestsDenied, cmiHaRegCounterTable=cmiHaRegCounterTable, cmiFaMnFaAuthFailures=cmiFaMnFaAuthFailures, cmiHaRegTotalProcLocRegs=cmiHaRegTotalProcLocRegs, cmiHaRegIntervalWimaxMaxActiveBindings=cmiHaRegIntervalWimaxMaxActiveBindings, cmiSecRecentViolationIDLow=cmiSecRecentViolationIDLow, ciscoMobileIpFaRegGroup=ciscoMobileIpFaRegGroup, ciscoMobileIpMrSystemGroupV2=ciscoMobileIpMrSystemGroupV2, cmiFaReRegRequestsRelayed=cmiFaReRegRequestsRelayed, ciscoMobileIpHaMobNetGroupSup1=ciscoMobileIpHaMobNetGroupSup1, cmiMrIfEntry=cmiMrIfEntry, cmiHaRegTunnelStatsDataRateInt=cmiHaRegTunnelStatsDataRateInt, cmiFaRegVisitorTimeRemaining=cmiFaRegVisitorTimeRemaining, cmiHaNvsesFromMnNeglected=cmiHaNvsesFromMnNeglected, cmiFaInitRegRequestsRelayed=cmiFaInitRegRequestsRelayed, ciscoMobileIpHaSystemGroupV1=ciscoMobileIpHaSystemGroupV1, cmiHaRegTunnelStatsSrcAddr=cmiHaRegTunnelStatsSrcAddr, cmiHaRedunSentBIReqs=cmiHaRedunSentBIReqs, cmiHaInitRegRequestsReceived=cmiHaInitRegRequestsReceived)
