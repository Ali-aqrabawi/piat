...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DLSW-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:30:59 2019
...
IpAddress, Gauge32, ObjectIdentity, TimeTicks, ModuleIdentity, Counter32, Unsigned32, Integer32, MibIdentifier, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Counter32", "Unsigned32", "Integer32", "MibIdentifier", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64")
TextualConvention, DisplayString, TruthValue, RowStatus, InstancePointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "RowStatus", "InstancePointer")
...
mibBuilder.exportSymbols("CISCO-DLSW-MIB", ciscoDlswCircuitFCResetOpRcvds=ciscoDlswCircuitFCResetOpRcvds, ciscoDlswUpTime=ciscoDlswUpTime, ciscoDlswDirNBEntryType=ciscoDlswDirNBEntryType, ciscoDlswCircuitState=ciscoDlswCircuitState, ciscoDlswTConnOperInCntlPkts=ciscoDlswTConnOperInCntlPkts, ciscoDlswDirLocateGroup=ciscoDlswDirLocateGroup, ciscoDlswMIB=ciscoDlswMIB, ciscoDlswVersionString=ciscoDlswVersionString, ciscoDlswCircuitFCSendGrantedUnits=ciscoDlswCircuitFCSendGrantedUnits, ciscoDlswCircuitFCSendCurrentWndw=ciscoDlswCircuitFCSendCurrentWndw, ciscoDlswTConnConfigTDomain=ciscoDlswTConnConfigTDomain, ciscoDlswDirNBEntries=ciscoDlswDirNBEntries, ciscoDlswTConnOperTDomain=ciscoDlswTConnOperTDomain, ciscoDlswTConnOperFlowCntlMode=ciscoDlswTConnOperFlowCntlMode, ciscoDlswSdlcLsRemoteSap=ciscoDlswSdlcLsRemoteSap, ciscoDlswCircuitS1Dlc=ciscoDlswCircuitS1Dlc, ciscoDlswVirtualSegmentLFSize=ciscoDlswVirtualSegmentLFSize, ciscoDlswNodeNBGroup=ciscoDlswNodeNBGroup, ciscoDlswTConnConfigInitCirRecvWndw=ciscoDlswTConnConfigInitCirRecvWndw, ciscoDlswSdlcLsLocalBlockNum=ciscoDlswSdlcLsLocalBlockNum, ciscoDlswTConnStatCloseIdles=ciscoDlswTConnStatCloseIdles, ciscoDlswTConnSpecific=ciscoDlswTConnSpecific, ciscoDlswTConnConfigTable=ciscoDlswTConnConfigTable, ciscoDlswDirMacStatus=ciscoDlswDirMacStatus, ciscoDlswCoreCompliance=ciscoDlswCoreCompliance, ciscoDlswTConnConfigEntry=ciscoDlswTConnConfigEntry, ciscoDlswDirLocateMacLocation=ciscoDlswDirLocateMacLocation, ciscoDlswDirNBCacheHits=ciscoDlswDirNBCacheHits, ciscoDlswCircuitS2TDomain=ciscoDlswCircuitS2TDomain, ciscoDlswCircuitS2Mac=ciscoDlswCircuitS2Mac, ciscoDlswTConnConfigSetupType=ciscoDlswTConnConfigSetupType, ciscoDlswCircuitFCLargestRecvGranted=ciscoDlswCircuitFCLargestRecvGranted, ciscoDlswTrapCntlTConnPartnerReject=ciscoDlswTrapCntlTConnPartnerReject, ciscoDlswTConnOperConfigIndex=ciscoDlswTConnOperConfigIndex, ciscoDlswInterfaceGroup=ciscoDlswInterfaceGroup, ciscoDlswTConnConfigRemoteTAddr=ciscoDlswTConnConfigRemoteTAddr, ciscoDlswTConnOperNRexRcvds=ciscoDlswTConnOperNRexRcvds, ciscoDlswTConnOperNQexRcvds=ciscoDlswTConnOperNQexRcvds, ciscoDlswVendorID=ciscoDlswVendorID, ciscoDlswTConnTcpOperGroup=ciscoDlswTConnTcpOperGroup, ciscoDlswDirectory=ciscoDlswDirectory, ciscoDlswTConnOperEntry=ciscoDlswTConnOperEntry, ciscoDlswSdlcLsLocalSap=ciscoDlswSdlcLsLocalSap, ciscoDlswIfVirtualSegment=ciscoDlswIfVirtualSegment, ciscoDlswTConnOperICRexSents=ciscoDlswTConnOperICRexSents, ciscoDlswCircuitEntryTime=ciscoDlswCircuitEntryTime, ciscoDlswCircuit=ciscoDlswCircuit, ciscoDlswSdlc=ciscoDlswSdlc, ciscoDlswDirMacTable=ciscoDlswDirMacTable, ciscoDlswDirGroup=ciscoDlswDirGroup, ciscoDlswTrapControl=ciscoDlswTrapControl, ciscoDlswCircuitStat=ciscoDlswCircuitStat, ciscoDlswTConnTcp=ciscoDlswTConnTcp, TAddress=TAddress, ciscoDlswSdlcLsLocalMac=ciscoDlswSdlcLsLocalMac, ciscoDlswTCPDomain=ciscoDlswTCPDomain, ciscoDlswDirMacCacheHits=ciscoDlswDirMacCacheHits, ciscoDlswSdlcCompliance=ciscoDlswSdlcCompliance, ciscoDlswTConnTcpConfigEntry=ciscoDlswTConnTcpConfigEntry, ciscoDlswTConnTcpOperTcpConnections=ciscoDlswTConnTcpOperTcpConnections, ciscoDlswTConnTcpConfigTable=ciscoDlswTConnTcpConfigTable, ciscoDlswDirLocate=ciscoDlswDirLocate, ciscoDlswIfRowStatus=ciscoDlswIfRowStatus, ciscoDlswDirCompliance=ciscoDlswDirCompliance, ciscoDlswDirMacEntries=ciscoDlswDirMacEntries, ciscoDlswTConnOperGroup=ciscoDlswTConnOperGroup, ciscoDlswCircuitTable=ciscoDlswCircuitTable, ciscoDlswTConnOperPartnerVersionStr=ciscoDlswTConnOperPartnerVersionStr, ciscoDlswTrapTConnDown=ciscoDlswTrapTConnDown, ciscoDlswTrapTConnPartnerReject=ciscoDlswTrapTConnPartnerReject, ciscoDlswNode=ciscoDlswNode, ciscoDlswDirLocateMacTable=ciscoDlswDirLocateMacTable, ciscoDlswTConnOperInDataPkts=ciscoDlswTConnOperInDataPkts, ciscoDlswTConnOperState=ciscoDlswTConnOperState, ciscoDlswCircuitEntry=ciscoDlswCircuitEntry, ciscoDlswTConnTcpConfigGroup=ciscoDlswTConnTcpConfigGroup, ciscoDlswCircuitS2CircuitId=ciscoDlswCircuitS2CircuitId, ciscoDlswCircuitDiscReasonRemoteData=ciscoDlswCircuitDiscReasonRemoteData, NBName=NBName, ciscoDlswDirNBEntry=ciscoDlswDirNBEntry, ciscoDlswDirNBLocation=ciscoDlswDirNBLocation, ciscoDlswTConnTcpConfigTcpConnections=ciscoDlswTConnTcpConfigTcpConnections, ciscoDlswDirLocateNBMatch=ciscoDlswDirLocateNBMatch, ciscoDlswTConnConfigGroupDefinition=ciscoDlswTConnConfigGroupDefinition, ciscoDlswResourceMacExclusivity=ciscoDlswResourceMacExclusivity, ciscoDlswTConnConfigSapList=ciscoDlswTConnConfigSapList, ciscoDlswTConnConfigAdvertiseMacNB=ciscoDlswTConnConfigAdvertiseMacNB, ciscoDlswDirLocateNBName=ciscoDlswDirLocateNBName, ciscoDlswSdlcLsTable=ciscoDlswSdlcLsTable, ciscoDlswTraps=ciscoDlswTraps, ciscoDlswDirLocateMacMatch=ciscoDlswDirLocateMacMatch, ciscoDlswDirLocateCompliance=ciscoDlswDirLocateCompliance, ciscoDlswTConnConfigGroup=ciscoDlswTConnConfigGroup, MacAddress=MacAddress, ciscoDlswTConnConfigEntryType=ciscoDlswTConnConfigEntryType, ciscoDlswTConnOperCURexSents=ciscoDlswTConnOperCURexSents, ciscoDlswCircuitFCRecvCurrentWndw=ciscoDlswCircuitFCRecvCurrentWndw, ciscoDlswTConnConfigOpens=ciscoDlswTConnConfigOpens, ciscoDlswDirNBCacheMisses=ciscoDlswDirNBCacheMisses, ciscoDlswTrapTConnProtViolation=ciscoDlswTrapTConnProtViolation, ciscoDlswTConnConfigRowStatus=ciscoDlswTConnConfigRowStatus, ciscoDlswMIBObjects=ciscoDlswMIBObjects, ciscoDlswTConnStat=ciscoDlswTConnStat, ciscoDlswTrapCircuitDown=ciscoDlswTrapCircuitDown, ciscoDlswCoreComplianceV11R01=ciscoDlswCoreComplianceV11R01, ciscoDlswDirMacLFSize=ciscoDlswDirMacLFSize, ciscoDlswTConnOperEntryTime=ciscoDlswTConnOperEntryTime, ciscoDlswSdlcGroup=ciscoDlswSdlcGroup, ciscoDlswTConnTcpOperPrefTcpConnections=ciscoDlswTConnTcpOperPrefTcpConnections, ciscoDlswTConnOperOutDataPkts=ciscoDlswTConnOperOutDataPkts, ciscoDlswTConnOperPartnerVendorID=ciscoDlswTConnOperPartnerVendorID, ciscoDlswTConnTcpConfigKeepAliveInt=ciscoDlswTConnTcpConfigKeepAliveInt, ciscoDlswTConnTcpOperTable=ciscoDlswTConnTcpOperTable, DlcType=DlcType, ciscoDlswCircuitPriority=ciscoDlswCircuitPriority, ciscoDlswTConnOperPartnerNBExcl=ciscoDlswTConnOperPartnerNBExcl, ciscoDlswCircuitOrigin=ciscoDlswCircuitOrigin, ciscoDlswTConnOperPartnerNBInfo=ciscoDlswTConnOperPartnerNBInfo, ciscoDlswDirMacMac=ciscoDlswDirMacMac, ciscoDlswCircuitStateTime=ciscoDlswCircuitStateTime, ciscoDlswCircuitFCHalveWndwSents=ciscoDlswCircuitFCHalveWndwSents, ciscoDlswTConn=ciscoDlswTConn, ciscoDlswDirComplianceV11R01=ciscoDlswDirComplianceV11R01, ciscoDlswDirNBGroup=ciscoDlswDirNBGroup, ciscoDlswTConnConfigLastModifyTime=ciscoDlswTConnConfigLastModifyTime, ciscoDlswInterface=ciscoDlswInterface, ciscoDlswDirNBName=ciscoDlswDirNBName, ciscoDlswCircuitS2Sap=ciscoDlswCircuitS2Sap, ciscoDlswTrapCntlCircuit=ciscoDlswTrapCntlCircuit, ciscoDlswTConnOperRemoteTAddr=ciscoDlswTConnOperRemoteTAddr, ciscoDlswDirCache=ciscoDlswDirCache, ciscoDlswDirLocateMacMac=ciscoDlswDirLocateMacMac, ciscoDlswCircuitStatGroup=ciscoDlswCircuitStatGroup, ciscoDlswTConnOperCURexRcvds=ciscoDlswTConnOperCURexRcvds, DlswTimeStamp=DlswTimeStamp, ciscoDlswTConnTcpConfigMaxSegmentSize=ciscoDlswTConnTcpConfigMaxSegmentSize, ciscoDlswTConnOperConnectTime=ciscoDlswTConnOperConnectTime, ciscoDlswTConnOperICRexRcvds=ciscoDlswTConnOperICRexRcvds, ciscoDlswIfTable=ciscoDlswIfTable, ciscoDlswTConnOperDiscTime=ciscoDlswTConnOperDiscTime, ciscoDlswDirMacMask=ciscoDlswDirMacMask, ciscoDlswTrapCircuitUp=ciscoDlswTrapCircuitUp, ciscoDlswCircuitS2TAddress=ciscoDlswCircuitS2TAddress, ciscoDlswDirStat=ciscoDlswDirStat, ciscoDlswTConnOperCircuits=ciscoDlswTConnOperCircuits, ciscoDlswCircuitFCLargestSendGranted=ciscoDlswCircuitFCLargestSendGranted, ciscoDlswTConnOperDiscActiveCir=ciscoDlswTConnOperDiscActiveCir, ciscoDlswTConnStatActiveConnections=ciscoDlswTConnStatActiveConnections, ciscoDlswDirMacEntryType=ciscoDlswDirMacEntryType, ciscoDlswDirNBLocationType=ciscoDlswDirNBLocationType, ciscoDlswTConnOperPartnerVersion=ciscoDlswTConnOperPartnerVersion, ciscoDlswSdlcLsRemoteMac=ciscoDlswSdlcLsRemoteMac, ciscoDlswTConnOperNRexSents=ciscoDlswTConnOperNRexSents, ciscoDlswTConnOperPartnerMacExcl=ciscoDlswTConnOperPartnerMacExcl, ciscoDlswDirMacIndex=ciscoDlswDirMacIndex, ciscoDlswDirMacCacheMisses=ciscoDlswDirMacCacheMisses, ciscoDlswTConnOperInDataOctets=ciscoDlswTConnOperInDataOctets, ciscoDlswCircuitS1Mac=ciscoDlswCircuitS1Mac, ciscoDlswTConnTcpOperKeepAliveInt=ciscoDlswTConnTcpOperKeepAliveInt, ciscoDlswSdlcComplianceV11R01=ciscoDlswSdlcComplianceV11R01, ciscoDlswDirMacEntry=ciscoDlswDirMacEntry, ciscoDlswStatus=ciscoDlswStatus, ciscoDlswCircuitS1IfIndex=ciscoDlswCircuitS1IfIndex, ciscoDlswTConnConfigLocalTAddr=ciscoDlswTConnConfigLocalTAddr, ciscoDlswStdPacingSupport=ciscoDlswStdPacingSupport, PYSNMP_MODULE_ID=ciscoDlswMIB, ciscoDlswDirMacLocationType=ciscoDlswDirMacLocationType, ciscoDlswCircuitCreates=ciscoDlswCircuitCreates, ciscoDlswTConnOperOutCntlPkts=ciscoDlswTConnOperOutCntlPkts, ciscoDlswVersion=ciscoDlswVersion, ciscoDlswIfEntry=ciscoDlswIfEntry, ciscoDlswActiveCircuits=ciscoDlswActiveCircuits, ciscoDlswCircuitFCResetOpSents=ciscoDlswCircuitFCResetOpSents, ciscoDlswTConnOperPartnerInitPacingWndw=ciscoDlswTConnOperPartnerInitPacingWndw, ciscoDlswDirMacLocation=ciscoDlswDirMacLocation, ciscoDlswDirNBStatus=ciscoDlswDirNBStatus, ciscoDlswCircuitS1RouteInfo=ciscoDlswCircuitS1RouteInfo, ciscoDlswCircuitDiscReasonRemote=ciscoDlswCircuitDiscReasonRemote, ciscoDlswDirNBTable=ciscoDlswDirNBTable, ciscoDlswTConnNBGroup=ciscoDlswTConnNBGroup, ciscoDlswDirNBNameType=ciscoDlswDirNBNameType, ciscoDlswCircuitS2Location=ciscoDlswCircuitS2Location, EndStationLocation=EndStationLocation, ciscoDlswDomains=ciscoDlswDomains, ciscoDlswCircuitGroup=ciscoDlswCircuitGroup, ciscoDlswTrapCntlTConnProtViolation=ciscoDlswTrapCntlTConnProtViolation, ciscoDlswDirNBRowStatus=ciscoDlswDirNBRowStatus, ciscoDlswSdlcLsEntry=ciscoDlswSdlcLsEntry, ciscoDlswTConnStatGroup=ciscoDlswTConnStatGroup, ciscoDlswDirNBIndex=ciscoDlswDirNBIndex, ciscoDlswDirLocateNBEntry=ciscoDlswDirLocateNBEntry, ciscoDlswCircuitS1DlcType=ciscoDlswCircuitS1DlcType, ciscoDlswCircuitFCRecvGrantedUnits=ciscoDlswCircuitFCRecvGrantedUnits, ciscoDlswDirLocateMacEntry=ciscoDlswDirLocateMacEntry, ciscoDlswCircuitFCHalveWndwRcvds=ciscoDlswCircuitFCHalveWndwRcvds, ciscoDlswGroups=ciscoDlswGroups, ciscoDlswTrapCntlTConn=ciscoDlswTrapCntlTConn, ciscoDlswTConnOperDiscReason=ciscoDlswTConnOperDiscReason, ciscoDlswTConnOperPartnerSapList=ciscoDlswTConnOperPartnerSapList, ciscoDlswTConnConfigIndex=ciscoDlswTConnConfigIndex, ciscoDlswConformance=ciscoDlswConformance, ciscoDlswTConnStatCloseBusys=ciscoDlswTConnStatCloseBusys, ciscoDlswDirLocateNBTable=ciscoDlswDirLocateNBTable, ciscoDlswSdlcLsEntries=ciscoDlswSdlcLsEntries, ciscoDlswTConnOperPartnerMacInfo=ciscoDlswTConnOperPartnerMacInfo, ciscoDlswIfSapList=ciscoDlswIfSapList, LFSize=LFSize, ciscoDlswTConnOperCirCreates=ciscoDlswTConnOperCirCreates, ciscoDlswCircuitS1Sap=ciscoDlswCircuitS1Sap, ciscoDlswTConnOperTable=ciscoDlswTConnOperTable, ciscoDlswDirLocateNBLocation=ciscoDlswDirLocateNBLocation, ciscoDlswCircuitDiscReasonLocal=ciscoDlswCircuitDiscReasonLocal, ciscoDlswDirMacRowStatus=ciscoDlswDirMacRowStatus, ciscoDlswSdlcLsRowStatus=ciscoDlswSdlcLsRowStatus, ciscoDlswDirNBLFSize=ciscoDlswDirNBLFSize, ciscoDlswTConnOperOutDataOctets=ciscoDlswTConnOperOutDataOctets, ciscoDlswNodeGroup=ciscoDlswNodeGroup, ciscoDlswResourceNBExclusivity=ciscoDlswResourceNBExclusivity, ciscoDlswTConnOperNQexSents=ciscoDlswTConnOperNQexSents, ciscoDlswSdlcLsLocalIdNum=ciscoDlswSdlcLsLocalIdNum, ciscoDlswDirLocateNBGroup=ciscoDlswDirLocateNBGroup, ciscoDlswCircuitS1CircuitId=ciscoDlswCircuitS1CircuitId, ciscoDlswCompliances=ciscoDlswCompliances, ciscoDlswTConnTcpOperEntry=ciscoDlswTConnTcpOperEntry, ciscoDlswTrapTConnUp=ciscoDlswTrapTConnUp, ciscoDlswTConnOperLocalTAddr=ciscoDlswTConnOperLocalTAddr)
