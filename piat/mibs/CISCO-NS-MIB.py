...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-NS-MIB
...
mibBuilder.exportSymbols("CISCO-NS-MIB", fcNameServerMIBCompliance3=fcNameServerMIBCompliance3, FcGs3RejectReasonCode=FcGs3RejectReasonCode, fcNameServerStatsTable=fcNameServerStatsTable, ciscoNsMIB=ciscoNsMIB, fcNameServerStatsEntry=fcNameServerStatsEntry, fcNameServerOutGetReqs=fcNameServerOutGetReqs, fcNameServerConfiguration=fcNameServerConfiguration, fcNameServerRejReqNotifyEnable=fcNameServerRejReqNotifyEnable, FcNameServerRejReasonExpl=FcNameServerRejReasonExpl, fcNameServerInRegReqs=fcNameServerInRegReqs, fcNameServerDBGroup=fcNameServerDBGroup, fcNameServerStatsGroup=fcNameServerStatsGroup, fcNameServerNodeName=fcNameServerNodeName, fcNameServerNumRows=fcNameServerNumRows, fcNameServerInRscns=fcNameServerInRscns, fcNameServerNotifyGroup=fcNameServerNotifyGroup, fcNameServerInDeRegReqs=fcNameServerInDeRegReqs, fcNameServerClassOfSvc=fcNameServerClassOfSvc, fcNameServerNodeIpAddress=fcNameServerNodeIpAddress, fcNameServerPortFunction=fcNameServerPortFunction, fcNameServerPortIdentifier=fcNameServerPortIdentifier, fcNameServerSymbolicNodeName=fcNameServerSymbolicNodeName, fcNameServerPortType=fcNameServerPortType, fcNameServerStats=fcNameServerStats, fcNameServerSymbolicPortName=fcNameServerSymbolicPortName, fcNameServerPermanentPortName=fcNameServerPermanentPortName, fcNameServerMIBCompliances=fcNameServerMIBCompliances, fcNameServerMIBCompliance2=fcNameServerMIBCompliance2, fcNameServerTotalRejects=fcNameServerTotalRejects, fcNameServerMIBConformance=fcNameServerMIBConformance, fcNameServerEntryAdd=fcNameServerEntryAdd, fcNameServerRejects=fcNameServerRejects, fcNameServerNotification=fcNameServerNotification, fcNameServerProxyPortEntry=fcNameServerProxyPortEntry, fcNameServerRejectRegNotify=fcNameServerRejectRegNotify, fcNameServerMIBCompliance=fcNameServerMIBCompliance, fcNameServerProcAssoc=fcNameServerProcAssoc, fcNameServerMIBCompliance1=fcNameServerMIBCompliance1, ciscoNameServerMIBObjects=ciscoNameServerMIBObjects, fcNameServerFabricPortName=fcNameServerFabricPortName, fcNameServerPortName=fcNameServerPortName, fcNameServerHardAddress=fcNameServerHardAddress, fcNameServerDBGroup1=fcNameServerDBGroup1, fcNameServerTableLastChange=fcNameServerTableLastChange, fcNameServerFC4Type=fcNameServerFC4Type, fcNameServerInformation=fcNameServerInformation, fcNameServerDatabaseFull=fcNameServerDatabaseFull, fcNameServerFC4Features=fcNameServerFC4Features, fcNameServerOutRscns=fcNameServerOutRscns, fcNameServerNotifyControlGroup=fcNameServerNotifyControlGroup, fcNameServerProxyPortName=fcNameServerProxyPortName, fcNameServerMIBGroups=fcNameServerMIBGroups, fcNameServerRejectReasonCode=fcNameServerRejectReasonCode, fcNameServerDBGroup3=fcNameServerDBGroup3, fcNameServerEntryDelete=fcNameServerEntryDelete, fcNameServerInGetReqs=fcNameServerInGetReqs, fcNameServerNotifications=fcNameServerNotifications, PYSNMP_MODULE_ID=ciscoNsMIB, fcNameServerEntry=fcNameServerEntry, fcNameServerProxyPortTable=fcNameServerProxyPortTable, fcNameServerPortIpAddress=fcNameServerPortIpAddress, fcNameServerNotifyGroupRev1=fcNameServerNotifyGroupRev1, fcNameServerRejReasonCodeExp=fcNameServerRejReasonCodeExp, fcNameServerTable=fcNameServerTable, fcNameServerDBGroup2=fcNameServerDBGroup2)
