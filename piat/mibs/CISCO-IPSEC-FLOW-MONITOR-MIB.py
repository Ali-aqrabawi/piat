...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IPSEC-FLOW-MONITOR-MIB
...
ObjectIdentity, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, IpAddress, Integer32, Counter64, iso, Gauge32, NotificationType, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "IpAddress", "Integer32", "Counter64", "iso", "Gauge32", "NotificationType", "Counter32", "MibIdentifier")
TruthValue, TimeInterval, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeInterval", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-IPSEC-FLOW-MONITOR-MIB", cipSecFailPhaseTwo=cipSecFailPhaseTwo, cipSecTunOutAuths=cipSecTunOutAuths, cikeGlobalInP2ExchgInvalids=cikeGlobalInP2ExchgInvalids, cipSecGlobalInAuths=cipSecGlobalInAuths, cikeGlobalOutOctets=cikeGlobalOutOctets, cipSecEndPtHistRemoteProtocol=cipSecEndPtHistRemoteProtocol, cipSecTrapCntlIpSecSetUpFailure=cipSecTrapCntlIpSecSetUpFailure, cipSecFailPktDstAddr=cipSecFailPktDstAddr, cikeTunOutOctets=cikeTunOutOctets, cikeTunHistLocalAddr=cikeTunHistLocalAddr, cipSecGlobalOutPkts=cipSecGlobalOutPkts, cipSecMIBComplianceRev1=cipSecMIBComplianceRev1, cipSecSetUpFailure=cipSecSetUpFailure, cipSecTunHistKeyType=cipSecTunHistKeyType, cipSecGlobalOutAuthFails=cipSecGlobalOutAuthFails, cipSecTrapCntlGroup=cipSecTrapCntlGroup, cikeTunOutNotifys=cikeTunOutNotifys, cipSecTunHistInDecompOctets=cipSecTunHistInDecompOctets, cikeGlobalInDropPkts=cikeGlobalInDropPkts, cipSecTunInPkts=cipSecTunInPkts, cipSecMIBCompliance=cipSecMIBCompliance, cipSecPhase2GWInDecryptFails=cipSecPhase2GWInDecryptFails, cipSecGlobalProtocolUseFails=cipSecGlobalProtocolUseFails, cipSecEndPtHistLocalName=cipSecEndPtHistLocalName, cikePhase1GWDecryptFails=cikePhase1GWDecryptFails, cipSecPhaseTwoGroup=cipSecPhaseTwoGroup, cipSecTunHistOutSaDiffHellmanGrp=cipSecTunHistOutSaDiffHellmanGrp, cipSecPhase2GWOutOctWraps=cipSecPhase2GWOutOctWraps, cikeTunnelEntry=cikeTunnelEntry, cikeGlobalInitTunnels=cikeGlobalInitTunnels, cikeTunInP2SaDelRequests=cikeTunInP2SaDelRequests, cikeTunRemoteValue=cikeTunRemoteValue, cikeSysFailure=cikeSysFailure, cipSecTunOutUncompOctets=cipSecTunOutUncompOctets, cipSecTunHistInSaEncryptAlgo=cipSecTunHistInSaEncryptAlgo, cipSecFailGlobal=cipSecFailGlobal, cipSecEndPtTable=cipSecEndPtTable, cikeGlobalHashValidFails=cikeGlobalHashValidFails, cipSecPhase2GWInReplayDrops=cipSecPhase2GWInReplayDrops, cipSecTunHistOutUncompOctWraps=cipSecTunHistOutUncompOctWraps, cipSecHistory=cipSecHistory, cipSecPhase2GWActiveTunnels=cipSecPhase2GWActiveTunnels, cipSecFailSaSpi=cipSecFailSaSpi, cipSecNotificationGroup=cipSecNotificationGroup, cipSecTunStatus=cipSecTunStatus, cipSecEndPtEntry=cipSecEndPtEntry, cikeTunHistOutNotifys=cikeTunHistOutNotifys, TunnelStatus=TunnelStatus, cipSecTunHistOutUncompOctets=cipSecTunHistOutUncompOctets, cipSecPhase2GWInDecompOctets=cipSecPhase2GWInDecompOctets, cipSecGlobalHcInOctets=cipSecGlobalHcInOctets, cipSecTunHcInDecompOctets=cipSecTunHcInDecompOctets, cipSecPhase2GWSysCapFails=cipSecPhase2GWSysCapFails, cipSecTunOutEncrypts=cipSecTunOutEncrypts, cipSecTunInSaAhAuthAlgo=cipSecTunInSaAhAuthAlgo, cipSecPhaseOne=cipSecPhaseOne, cikePeerCorrRemoteValue=cikePeerCorrRemoteValue, cipSecGlobalOutEncryptFails=cipSecGlobalOutEncryptFails, ciscoIpSecFlowMonitorMIB=ciscoIpSecFlowMonitorMIB, cipSecGlobalOutOctWraps=cipSecGlobalOutOctWraps, cipSecTunInReplayDropPkts=cipSecTunInReplayDropPkts, cikeTunOutPkts=cikeTunOutPkts, cipSecPhase2GWNoSaFails=cipSecPhase2GWNoSaFails, cikeTunOutP2Exchgs=cikeTunOutP2Exchgs, AuthAlgo=AuthAlgo, cipSecMIBGroups=cipSecMIBGroups, cipSecTrapCntlIkeProtocolFail=cipSecTrapCntlIkeProtocolFail, IkePeerType=IkePeerType, cikeTunHistHashAlgo=cikeTunHistHashAlgo, cikeGlobalOutP2Exchgs=cikeGlobalOutP2Exchgs, cipSecFailTime=cipSecFailTime, cipSecTunHistOutAuths=cipSecTunHistOutAuths, cipSecTunTotalRefreshes=cipSecTunTotalRefreshes, cipSecTunHcInOctets=cipSecTunHcInOctets, cipSecEndPtRemoteName=cipSecEndPtRemoteName, cipSecPhase2GWOutUncompOctWraps=cipSecPhase2GWOutUncompOctWraps, cipSecTunKeyType=cipSecTunKeyType, cipSecTrapCntlIpSecEarlyTunTerm=cipSecTrapCntlIpSecEarlyTunTerm, cipSecEndPtRemoteAddr1=cipSecEndPtRemoteAddr1, cipSecGlobalOutEncrypts=cipSecGlobalOutEncrypts, cikeTunHistInP2SaDelRequests=cikeTunHistInP2SaDelRequests, cipSecGlobalHcOutUncompOctets=cipSecGlobalHcOutUncompOctets, cikePeerActiveTime=cikePeerActiveTime, cipSecGlobalOutAuths=cipSecGlobalOutAuths, cipSecTunnelStart=cipSecTunnelStart, cikeGlobalInP2ExchgRejects=cikeGlobalInP2ExchgRejects, cikePeerRemoteValue=cikePeerRemoteValue, cipSecTunInDropPkts=cipSecTunInDropPkts, cipSecNoSa=cipSecNoSa, cipSecTunInDecryptFails=cipSecTunInDecryptFails, cipSecGlobalHcInDecompOctets=cipSecGlobalHcInDecompOctets, cikeTunNegoMode=cikeTunNegoMode, cipSecTunHistIndex=cipSecTunHistIndex, cikePeerLocalType=cikePeerLocalType, cipSecTunHistInOctWraps=cipSecTunHistInOctWraps, cipSecHistPhaseTwo=cipSecHistPhaseTwo, cipSecTunHistTotalRefreshes=cipSecTunHistTotalRefreshes, cikeTunInP2Exchgs=cikeTunInP2Exchgs, cipSecTunIndex=cipSecTunIndex, cipSecPhase2GWInOctWraps=cipSecPhase2GWInOctWraps, cipSecSpiDirection=cipSecSpiDirection, cipSecGlobalHcOutOctets=cipSecGlobalHcOutOctets, cipSecEndPtRemoteAddr2=cipSecEndPtRemoteAddr2, cipSecTunLifeTime=cipSecTunLifeTime, cipSecPhase2GWOutAuths=cipSecPhase2GWOutAuths, cipSecTunHistTotalSas=cipSecTunHistTotalSas, cikeTunnelStart=cikeTunnelStart, cipSecTunSaLifeTimeThreshold=cipSecTunSaLifeTimeThreshold, cipSecGlobalSysCapFails=cipSecGlobalSysCapFails, cikeTunHistPeerIntIndex=cikeTunHistPeerIntIndex, cipSecGlobalOutOctets=cipSecGlobalOutOctets, cikePhase1GWHashValidFails=cikePhase1GWHashValidFails, cikeTunEncryptAlgo=cikeTunEncryptAlgo, cipSecTrapCntlIpSecSysFailure=cipSecTrapCntlIpSecSysFailure, cipSecEndPtHistRemoteAddr2=cipSecEndPtHistRemoteAddr2, cipSecTunHistOutSaAhAuthAlgo=cipSecTunHistOutSaAhAuthAlgo, cikePhase1GWInitTunnels=cikePhase1GWInitTunnels, cipSecTunnelStop=cipSecTunnelStop, TrapStatus=TrapStatus, cipSecTunHcOutOctets=cipSecTunHcOutOctets, cikeTunHistLocalName=cikeTunHistLocalName, cipSecTunHistHcOutOctets=cipSecTunHistHcOutOctets, cipSecMIBNotifications=cipSecMIBNotifications, cipSecPhase2GWInDecrypts=cipSecPhase2GWInDecrypts, cikeFailTable=cikeFailTable, cipSecPhase2GWPreviousTunnels=cipSecPhase2GWPreviousTunnels, cikePhase1GWOutP2ExchgRejects=cikePhase1GWOutP2ExchgRejects, cikeTunHistStartTime=cikeTunHistStartTime, cipSecGlobalInDecompOctets=cipSecGlobalInDecompOctets, cipSecTunHistLifeTime=cipSecTunHistLifeTime, cikeTunnelTable=cikeTunnelTable, cipSecGlobalInPkts=cipSecGlobalInPkts, cikePhase1GWInDropPkts=cikePhase1GWInDropPkts, cipSecSpiValue=cipSecSpiValue, cipSecHistCheckPoint=cipSecHistCheckPoint, cikeTunTotalRefreshes=cikeTunTotalRefreshes, cikePhase1GWStatsTable=cikePhase1GWStatsTable, cipSecTunHistOutEncrypts=cipSecTunHistOutEncrypts, cipSecEndPtHistIndex=cipSecEndPtHistIndex, cikeTunInP2ExchgInvalids=cikeTunInP2ExchgInvalids, cipSecTrapCntlIpSecTunnelStop=cipSecTrapCntlIpSecTunnelStop, cikeTunOutDropPkts=cikeTunOutDropPkts, cipSecTunHistOutAuthFails=cipSecTunHistOutAuthFails, cipSecPhase2GWInDrops=cipSecPhase2GWInDrops, cikeGlobalStats=cikeGlobalStats, cikeGlobalInOctets=cikeGlobalInOctets, cipSecTunIkeTunnelAlive=cipSecTunIkeTunnelAlive, cipSecTunOutPkts=cipSecTunOutPkts, cikeTunHistOutP2ExchgInvalids=cikeTunHistOutP2ExchgInvalids, cikePhase1GWOutP2Exchgs=cikePhase1GWOutP2Exchgs, cipSecTunHistOutSaEspAuthAlgo=cipSecTunHistOutSaEspAuthAlgo, cipSecTrapCntlIpSecNoSa=cipSecTrapCntlIpSecNoSa, cikePhase1GWInPkts=cikePhase1GWInPkts, cipSecTunHistInDecryptFails=cipSecTunHistInDecryptFails, cikeGlobalSysCapFails=cikeGlobalSysCapFails, cikeTunHistOutOctets=cikeTunHistOutOctets, cipSecEndPtHistLocalAddr2=cipSecEndPtHistLocalAddr2, cikePeerEntry=cikePeerEntry, cipSecPhase2GWOutUncompOctets=cipSecPhase2GWOutUncompOctets, cipSecMIBObjects=cipSecMIBObjects, cipSecTrapCntlIkeNoSa=cipSecTrapCntlIkeNoSa, cipSecSpiProtocol=cipSecSpiProtocol, cipSecTunHistIkeTunnelIndex=cipSecTunHistIkeTunnelIndex, cikeTunHistOutP2ExchgRejects=cikeTunHistOutP2ExchgRejects, cikePeerCorrTable=cikePeerCorrTable, cikeGlobalInP2SaDelRequests=cikeGlobalInP2SaDelRequests, cipSecEarlyTunTerm=cipSecEarlyTunTerm, cipSecTunHistHcInDecompOctets=cipSecTunHistHcInDecompOctets, cipSecTunHistOutOctets=cipSecTunHistOutOctets, cipSecPhase2GWOutAuthFails=cipSecPhase2GWOutAuthFails, cipSecSpiIndex=cipSecSpiIndex, cikeTunHistInNotifys=cikeTunHistInNotifys, cipSecTunHistInSaDecompAlgo=cipSecTunHistInSaDecompAlgo, IkeNegoMode=IkeNegoMode, cikePhase1GWOutPkts=cikePhase1GWOutPkts, cikeTunStatus=cikeTunStatus, cikeGlobalActiveTunnels=cikeGlobalActiveTunnels, cikeTunHistDiffHellmanGrp=cikeTunHistDiffHellmanGrp, cikeTunSaRefreshThreshold=cikeTunSaRefreshThreshold, cipSecTunHistInReplayDropPkts=cipSecTunHistInReplayDropPkts, cikePhase1GWNoSaFails=cikePhase1GWNoSaFails, cipSecGlobalNoSaFails=cipSecGlobalNoSaFails, cipSecMIBConformance=cipSecMIBConformance, cikePhase1GWStatsEntry=cikePhase1GWStatsEntry, cipSecHistPhaseOne=cipSecHistPhaseOne, cikeTunHashAlgo=cikeTunHashAlgo, cipSecTrapCntlIpSecTunnelStart=cipSecTrapCntlIpSecTunnelStart, cipSecTunHistOutSaEncryptAlgo=cipSecTunHistOutSaEncryptAlgo, cikeTunHistOutPkts=cikeTunHistOutPkts, cikeTunHistInP2ExchgInvalids=cikeTunHistInP2ExchgInvalids, cikeGlobalOutPkts=cikeGlobalOutPkts, cipSecSpiStatus=cipSecSpiStatus, cipSecEndPtHistTunIndex=cipSecEndPtHistTunIndex, cipSecMIBNotificationPrefix=cipSecMIBNotificationPrefix, cipSecTunLifeSize=cipSecTunLifeSize, cikeTunHistPeerLocalValue=cikeTunHistPeerLocalValue, cipSecTunHistActiveIndex=cipSecTunHistActiveIndex, cipSecEndPtHistLocalAddr1=cipSecEndPtHistLocalAddr1, cipSecTunHistOutEncryptFails=cipSecTunHistOutEncryptFails, cikeTunHistNegoMode=cikeTunHistNegoMode, cipSecTunHistInSaEspAuthAlgo=cipSecTunHistInSaEspAuthAlgo, cipSecTunnelHistTable=cipSecTunnelHistTable, cikePhase1GWOutOctets=cikePhase1GWOutOctets, cipSecGWStatsGroup=cipSecGWStatsGroup, EndPtType=EndPtType, cipSecTunHistHcOutUncompOctets=cipSecTunHistHcOutUncompOctets, cipSecPhase2GWInAuthFails=cipSecPhase2GWInAuthFails, cikeTunInPkts=cikeTunInPkts, cipSecEndPtHistEntry=cipSecEndPtHistEntry, cipSecTunOutOctWraps=cipSecTunOutOctWraps, cikePeerLocalAddr=cikePeerLocalAddr, cikeTunHistActiveIndex=cikeTunHistActiveIndex, cipSecTunOutDropPkts=cipSecTunOutDropPkts, IPSIpAddress=IPSIpAddress, cipSecPhaseTwo=cipSecPhaseTwo, cikePhase1GWActiveTunnels=cikePhase1GWActiveTunnels, cipSecFailEntry=cipSecFailEntry, cipSecTunHcOutUncompOctets=cipSecTunHcOutUncompOctets, cikeNoSa=cikeNoSa, cipSecTunHistHcInOctets=cipSecTunHistHcInOctets, cipSecTunEncapMode=cipSecTunEncapMode, cipSecGlobalInAuthFails=cipSecGlobalInAuthFails, cikeTunHistEncryptAlgo=cikeTunHistEncryptAlgo, cipSecTrapCntlIpSecProtocolFail=cipSecTrapCntlIpSecProtocolFail, cipSecTunOutSaDiffHellmanGrp=cipSecTunOutSaDiffHellmanGrp, cipSecFailTable=cipSecFailTable, cipSecTunInSaDecompAlgo=cipSecTunInSaDecompAlgo, cipSecTunIkeTunnelIndex=cipSecTunIkeTunnelIndex, cipSecTunHistEncapMode=cipSecTunHistEncapMode, cikeGlobalAuthFails=cikeGlobalAuthFails, cipSecEndPtRemoteProtocol=cipSecEndPtRemoteProtocol, cipSecMibLevel=cipSecMibLevel, cipSecEndPtHistActiveIndex=cipSecEndPtHistActiveIndex, cipSecEndPtRemoteType=cipSecEndPtRemoteType, cikePhase1GWSysCapFails=cikePhase1GWSysCapFails, cikePeerLocalValue=cikePeerLocalValue, cipSecGlobalPreviousTunnels=cipSecGlobalPreviousTunnels, cikeGlobalInP2Exchgs=cikeGlobalInP2Exchgs, cikeTunHistRemoteName=cikeTunHistRemoteName, cikePeerCorrLocalType=cikePeerCorrLocalType, cipSecTunOutOctets=cipSecTunOutOctets, cipSecTunOutAuthFails=cipSecTunOutAuthFails, cipSecTrapCntlIkeSysFailure=cipSecTrapCntlIkeSysFailure, IkeHashAlgo=IkeHashAlgo, cipSecTunInSaEspAuthAlgo=cipSecTunInSaEspAuthAlgo, cikeTunHistPeerRemoteType=cikeTunHistPeerRemoteType, cipSecPhase2GWOutDrops=cipSecPhase2GWOutDrops, cipSecPhase2GWOutEncrypts=cipSecPhase2GWOutEncrypts, cikeGlobalOutDropPkts=cikeGlobalOutDropPkts, cipSecTunHistInDecompOctWraps=cipSecTunHistInDecompOctWraps, cipSecTunHistRemoteAddr=cipSecTunHistRemoteAddr, cikePeerCorrLocalValue=cikePeerCorrLocalValue, cikeTunOutP2ExchgRejects=cikeTunOutP2ExchgRejects, cipSecSpiEntry=cipSecSpiEntry)
mibBuilder.exportSymbols("CISCO-IPSEC-FLOW-MONITOR-MIB", cipSecTunOutSaEncryptAlgo=cipSecTunOutSaEncryptAlgo, cipSecFailReason=cipSecFailReason, cikeTunAuthMethod=cikeTunAuthMethod, cipSecEndPtHistLocalProtocol=cipSecEndPtHistLocalProtocol, cikeFailLocalAddr=cikeFailLocalAddr, cikeTunRemoteType=cikeTunRemoteType, cikeTunInDropPkts=cikeTunInDropPkts, cipSecTunCurrentSaInstances=cipSecTunCurrentSaInstances, cikeTunHistAuthMethod=cikeTunHistAuthMethod, cipSecTunInDecrypts=cipSecTunInDecrypts, cikeTunLocalAddr=cikeTunLocalAddr, cipSecTrapCntlIkeTunnelStart=cipSecTrapCntlIkeTunnelStart, cikeTunOutP2SaDelRequests=cikeTunOutP2SaDelRequests, cipSecHistTableSize=cipSecHistTableSize, cipSecTunHistInPkts=cipSecTunHistInPkts, cikePeerCorrIntIndex=cikePeerCorrIntIndex, cikeTunRemoteName=cikeTunRemoteName, cikeTunHistInDropPkts=cikeTunHistInDropPkts, cipSecPhaseOneGroup=cipSecPhaseOneGroup, cipSecTunHistOutSaCompAlgo=cipSecTunHistOutSaCompAlgo, cipSecEndPtIndex=cipSecEndPtIndex, cikeFailLocalValue=cikeFailLocalValue, cikePhase1GWOutP2ExchgInvalids=cikePhase1GWOutP2ExchgInvalids, cipSecMIBCompliances=cipSecMIBCompliances, cipSecEndPtHistTable=cipSecEndPtHistTable, cipSecFailuresGroup=cipSecFailuresGroup, EncapMode=EncapMode, cipSecEndPtHistRemotePort=cipSecEndPtHistRemotePort, cipSecTunOutSaEspAuthAlgo=cipSecTunOutSaEspAuthAlgo, cipSecPhase2GWInPkts=cipSecPhase2GWInPkts, cipSecEndPtLocalAddr2=cipSecEndPtLocalAddr2, DiffHellmanGrp=DiffHellmanGrp, cipSecTunnelTable=cipSecTunnelTable, cikeFailRemoteAddr=cikeFailRemoteAddr, cikePhase1GWPreviousTunnels=cikePhase1GWPreviousTunnels, cipSecFailPhaseOne=cipSecFailPhaseOne, cipSecTunInSaEncryptAlgo=cipSecTunInSaEncryptAlgo, cipSecSpiTable=cipSecSpiTable, cipSecTunInSaDiffHellmanGrp=cipSecTunInSaDiffHellmanGrp, cipSecTunHistInOctets=cipSecTunHistInOctets, cikeGlobalInPkts=cikeGlobalInPkts, cikePhase1GWInitTunnelFails=cikePhase1GWInitTunnelFails, cipSecHistGlobal=cipSecHistGlobal, cipSecTunInOctets=cipSecTunInOctets, cipSecTunOutEncryptFails=cipSecTunOutEncryptFails, cipSecGlobalInDecryptFails=cipSecGlobalInDecryptFails, cikeTunHistInOctets=cikeTunHistInOctets, EncryptAlgo=EncryptAlgo, cikePhase1GWOutDropPkts=cikePhase1GWOutDropPkts, cipSecTunInAuthFails=cipSecTunInAuthFails, cipSecProtocolFailure=cipSecProtocolFailure, cipSecLevels=cipSecLevels, cipSecGlobalInDecompOctWraps=cipSecGlobalInDecompOctWraps, cipSecPhase2GWProtocolUseFails=cipSecPhase2GWProtocolUseFails, cipSecTunHistLocalAddr=cipSecTunHistLocalAddr, cikeGlobalOutP2ExchgRejects=cikeGlobalOutP2ExchgRejects, PYSNMP_MODULE_ID=ciscoIpSecFlowMonitorMIB, cipSecTunHistInAuths=cipSecTunHistInAuths, cipSecTunSaLifeSizeThreshold=cipSecTunSaLifeSizeThreshold, cikeTunHistTotalSas=cikeTunHistTotalSas, cipSecTunHistInDecrypts=cipSecTunHistInDecrypts, cipSecFailTableSize=cipSecFailTableSize, cikeTunHistOutP2SaDelRequests=cikeTunHistOutP2SaDelRequests, cikePeerRemoteAddr=cikePeerRemoteAddr, cipSecPhase2GWOutPkts=cipSecPhase2GWOutPkts, cikeGlobalOutP2ExchgInvalids=cikeGlobalOutP2ExchgInvalids, cikePeerIntIndex=cikePeerIntIndex, cikeTunDiffHellmanGrp=cikeTunDiffHellmanGrp, cikeTunHistTotalRefreshes=cikeTunHistTotalRefreshes, cipSecFailGlobalCntl=cipSecFailGlobalCntl, cikePeerCorrRemoteType=cikePeerCorrRemoteType, CompAlgo=CompAlgo, cipSecEndPtHistLocalType=cipSecEndPtHistLocalType, cikeTunHistOutDropPkts=cikeTunHistOutDropPkts, cikePeerActiveTunnelIndex=cikePeerActiveTunnelIndex, cikeFailRemoteValue=cikeFailRemoteValue, cikeTunHistTermReason=cikeTunHistTermReason, cipSecTunHistInDropPkts=cipSecTunHistInDropPkts, cikeFailReason=cikeFailReason, cikeFailTime=cikeFailTime, cikeTunIndex=cikeTunIndex, cikeFailEntry=cikeFailEntry, cikeTunInP2ExchgRejects=cikeTunInP2ExchgRejects, cipSecPhase2GWInAuths=cipSecPhase2GWInAuths, cikePeerCorrSeqNum=cikePeerCorrSeqNum, cikePeerCorrEntry=cikePeerCorrEntry, cikeCertCrlFailure=cikeCertCrlFailure, cikeTunInNotifys=cikeTunInNotifys, cipSecTunActiveTime=cipSecTunActiveTime, cikeGlobalInNotifys=cikeGlobalInNotifys, cikeTunnelHistTable=cikeTunnelHistTable, cikeTunHistInP2ExchgRejects=cikeTunHistInP2ExchgRejects, cipSecTunOutSaAhAuthAlgo=cipSecTunOutSaAhAuthAlgo, cikeTunHistInP2Exchgs=cikeTunHistInP2Exchgs, cipSecHistoryGroup=cipSecHistoryGroup, cipSecTunInDecompOctets=cipSecTunInDecompOctets, cipSecEndPtRemotePort=cipSecEndPtRemotePort, cipSecTunHistInSaAhAuthAlgo=cipSecTunHistInSaAhAuthAlgo, cikeGlobalDecryptFails=cikeGlobalDecryptFails, cipSecTunHistLifeSize=cipSecTunHistLifeSize, cikePhase1GWInP2SaDelRequests=cikePhase1GWInP2SaDelRequests, cipSecTunExpiredSaInstances=cipSecTunExpiredSaInstances, cipSecFailures=cipSecFailures, cikePhase1GWOutNotifys=cikePhase1GWOutNotifys, cipSecGlobalStats=cipSecGlobalStats, cikeTunHistLifeTime=cikeTunHistLifeTime, cipSecGlobalInReplayDrops=cipSecGlobalInReplayDrops, cikeTunHistInPkts=cikeTunHistInPkts, cikePhase1GWAuthFails=cikePhase1GWAuthFails, cikePhase1GWInNotifys=cikePhase1GWInNotifys, cikeTunLocalValue=cikeTunLocalValue, cipSecGlobalOutUncompOctWraps=cipSecGlobalOutUncompOctWraps, cikePeerTable=cikePeerTable, cikePhase1GWInP2ExchgInvalids=cikePhase1GWInP2ExchgInvalids, cipSecGlobalInOctWraps=cipSecGlobalInOctWraps, cikeTunnelStop=cikeTunnelStop, cipSecEndPtHistRemoteName=cipSecEndPtHistRemoteName, cikeGlobalOutNotifys=cikeGlobalOutNotifys, cipSecGlobalInDecrypts=cipSecGlobalInDecrypts, cipSecEndPtHistRemoteAddr1=cipSecEndPtHistRemoteAddr1, cikeTunRemoteAddr=cikeTunRemoteAddr, cikePhase1GWInP2Exchgs=cikePhase1GWInP2Exchgs, cikeTunHistOutP2Exchgs=cikeTunHistOutP2Exchgs, cipSecFailPktSrcAddr=cipSecFailPktSrcAddr, cipSecPhase2GWInDecompOctWraps=cipSecPhase2GWInDecompOctWraps, cikeProtocolFailure=cikeProtocolFailure, cikeFailRemoteType=cikeFailRemoteType, cikeTunHistActiveTime=cikeTunHistActiveTime, cipSecSysFailure=cipSecSysFailure, cikeTunHistRemoteAddr=cikeTunHistRemoteAddr, cikeGlobalInitTunnelFails=cikeGlobalInitTunnelFails, cipSecEndPtHistLocalPort=cipSecEndPtHistLocalPort, cipSecTrapCntl=cipSecTrapCntl, cipSecEndPtLocalName=cipSecEndPtLocalName, cipSecTunHistTermReason=cipSecTunHistTermReason, cipSecTunInDecompOctWraps=cipSecTunInDecompOctWraps, cikeTunInOctets=cikeTunInOctets, cipSecTunHistOutOctWraps=cipSecTunHistOutOctWraps, cikeFailIndex=cikeFailIndex, cikeTunHistIndex=cikeTunHistIndex, cikePhase1GWRespTunnelFails=cikePhase1GWRespTunnelFails, cikeTunLifeTime=cikeTunLifeTime, cipSecEndPtLocalProtocol=cipSecEndPtLocalProtocol, cipSecGlobalOutDrops=cipSecGlobalOutDrops, cipSecTunHistOutPkts=cipSecTunHistOutPkts, cikePhase1GWOutP2SaDelRequests=cikePhase1GWOutP2SaDelRequests, cikeFailLocalType=cikeFailLocalType, cikeGlobalNoSaFails=cikeGlobalNoSaFails, cipSecEndPtLocalAddr1=cipSecEndPtLocalAddr1, cipSecTunInAuths=cipSecTunInAuths, cipSecTunOutUncompOctWraps=cipSecTunOutUncompOctWraps, cipSecTunHistInAuthFails=cipSecTunHistInAuthFails, cikeTunnelHistEntry=cikeTunnelHistEntry, cikeTunActiveTime=cikeTunActiveTime, cipSecPhase2GWStatsTable=cipSecPhase2GWStatsTable, KeyType=KeyType, cipSecTunnelEntry=cipSecTunnelEntry, cipSecPhase2GWOutOctets=cipSecPhase2GWOutOctets, cipSecFailTunnelIndex=cipSecFailTunnelIndex, cipSecTunHistOutDropPkts=cipSecTunHistOutDropPkts, cipSecEndPtHistRemoteType=cipSecEndPtHistRemoteType, cikeTunHistPeerLocalType=cikeTunHistPeerLocalType, cikePeerRemoteType=cikePeerRemoteType, cipSecTunnelHistEntry=cipSecTunnelHistEntry, cikeTunLocalName=cikeTunLocalName, cikeTunLocalType=cikeTunLocalType, cikeTunOutP2ExchgInvalids=cikeTunOutP2ExchgInvalids, cipSecPhase2GWOutEncryptFails=cipSecPhase2GWOutEncryptFails, cipSecPhase2GWStatsEntry=cipSecPhase2GWStatsEntry, cipSecFailIndex=cipSecFailIndex, cipSecGlobalActiveTunnels=cipSecGlobalActiveTunnels, cipSecGlobalOutUncompOctets=cipSecGlobalOutUncompOctets, cipSecTunRemoteAddr=cipSecTunRemoteAddr, cipSecGlobalInOctets=cipSecGlobalInOctets, cipSecTrapCntlIkeTunnelStop=cipSecTrapCntlIkeTunnelStop, cikeGlobalPreviousTunnels=cikeGlobalPreviousTunnels, cipSecTunLocalAddr=cipSecTunLocalAddr, cipSecGlobalInDrops=cipSecGlobalInDrops, cipSecEndPtLocalPort=cipSecEndPtLocalPort, cikePhase1GWInOctets=cikePhase1GWInOctets, cipSecTunHistInSaDiffHellmanGrp=cipSecTunHistInSaDiffHellmanGrp, cipSecPhase2GWInOctets=cipSecPhase2GWInOctets, cipSecTunHistStartTime=cipSecTunHistStartTime, cipSecLevelsGroup=cipSecLevelsGroup, cikePhase1GWInP2ExchgRejects=cikePhase1GWInP2ExchgRejects, cipSecTunHistActiveTime=cipSecTunHistActiveTime, IkeAuthMethod=IkeAuthMethod, cikePeerCorrIpSecTunIndex=cikePeerCorrIpSecTunIndex, cipSecTunInOctWraps=cipSecTunInOctWraps, cikeTunHistPeerRemoteValue=cikeTunHistPeerRemoteValue, cipSecHistGlobalCntl=cipSecHistGlobalCntl, cipSecEndPtLocalType=cipSecEndPtLocalType, cipSecTunOutSaCompAlgo=cipSecTunOutSaCompAlgo, cipSecTrapCntlIkeCertCrlFailure=cipSecTrapCntlIkeCertCrlFailure, cikeGlobalOutP2SaDelRequests=cikeGlobalOutP2SaDelRequests, cikeGlobalRespTunnelFails=cikeGlobalRespTunnelFails)
