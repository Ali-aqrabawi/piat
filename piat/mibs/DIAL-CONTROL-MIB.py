...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/DIAL-CONTROL-MIB
...
Counter32, NotificationType, Unsigned32, ModuleIdentity, TimeTicks, Gauge32, ObjectIdentity, iso, Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, transmission, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Unsigned32", "ModuleIdentity", "TimeTicks", "Gauge32", "ObjectIdentity", "iso", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "transmission", "Counter64")
...
mibBuilder.exportSymbols("DIAL-CONTROL-MIB", callHistoryGroup=callHistoryGroup, dialCtlPeerStatsTable=dialCtlPeerStatsTable, callActiveSetupTime=callActiveSetupTime, callHistoryConnectTime=callHistoryConnectTime, callActiveEntry=callActiveEntry, dialCtlPeerCfgCallRetries=dialCtlPeerCfgCallRetries, callActiveCallOrigin=callActiveCallOrigin, callActiveReceiveBytes=callActiveReceiveBytes, dialCtlPeerCfgIfType=dialCtlPeerCfgIfType, dialCtlPeerStatsEntry=dialCtlPeerStatsEntry, dialControlMibGroups=dialControlMibGroups, dialCtlPeerCfgTrapEnable=dialCtlPeerCfgTrapEnable, dialCtlPeerCfgSubAddress=dialCtlPeerCfgSubAddress, callHistoryRetainTimer=callHistoryRetainTimer, dialCtlPeerCfgInfoType=dialCtlPeerCfgInfoType, callHistoryCallOrigin=callHistoryCallOrigin, callActiveTransmitBytes=callActiveTransmitBytes, dialCtlPeerCfgId=dialCtlPeerCfgId, dialCtlPeerCfgStatus=dialCtlPeerCfgStatus, dialCtlPeerCallSetup=dialCtlPeerCallSetup, dialCtlTrapEnable=dialCtlTrapEnable, dialControlMib=dialControlMib, dialControlMibTrapPrefix=dialControlMibTrapPrefix, dialCtlPeerStatsRefuseCalls=dialCtlPeerStatsRefuseCalls, dialCtlPeerStatsLastDisconnectText=dialCtlPeerStatsLastDisconnectText, dialCtlPeerCfgTable=dialCtlPeerCfgTable, dialCtlPeerStatsConnectTime=dialCtlPeerStatsConnectTime, callHistoryEntry=callHistoryEntry, dialControlGroup=dialControlGroup, callHistoryPeerAddress=callHistoryPeerAddress, dialCtlPeerCfgSpeed=dialCtlPeerCfgSpeed, callHistoryTransmitPackets=callHistoryTransmitPackets, dialCtlPeerStatsSuccessCalls=dialCtlPeerStatsSuccessCalls, callActiveIndex=callActiveIndex, dialCtlPeerCfgPermission=dialCtlPeerCfgPermission, PYSNMP_MODULE_ID=dialControlMib, callActiveChargedUnits=callActiveChargedUnits, callHistoryDisconnectText=callHistoryDisconnectText, dialControlMibCompliance=dialControlMibCompliance, callNotificationsGroup=callNotificationsGroup, dialControlMibObjects=dialControlMibObjects, dialCtlPeerCallInformation=dialCtlPeerCallInformation, dialCtlPeerStatsAcceptCalls=dialCtlPeerStatsAcceptCalls, AbsoluteCounter32=AbsoluteCounter32, callActivePeerAddress=callActivePeerAddress, callActiveInfoType=callActiveInfoType, dialCtlPeerCfgLowerIf=dialCtlPeerCfgLowerIf, dialCtlPeerStatsLastDisconnectCause=dialCtlPeerStatsLastDisconnectCause, callHistoryPeerId=callHistoryPeerId, dialCtlPeerCfgCarrierDelay=dialCtlPeerCfgCarrierDelay, callHistoryPeerSubAddress=callHistoryPeerSubAddress, dialCtlPeer=dialCtlPeer, dialCtlPeerStatsChargedUnits=dialCtlPeerStatsChargedUnits, callHistoryTableMaxLength=callHistoryTableMaxLength, dialCtlPeerCfgInactivityTimer=dialCtlPeerCfgInactivityTimer, callActivePeerSubAddress=callActivePeerSubAddress, callHistoryReceivePackets=callHistoryReceivePackets, callActiveReceivePackets=callActiveReceivePackets, callActiveLogicalIfIndex=callActiveLogicalIfIndex, dialCtlPeerCfgEntry=dialCtlPeerCfgEntry, callHistoryChargedUnits=callHistoryChargedUnits, dialCtlPeerCfgMinDuration=dialCtlPeerCfgMinDuration, callActiveGroup=callActiveGroup, dialCtlPeerCfgClosedUserGroup=dialCtlPeerCfgClosedUserGroup, callHistoryPeerIfIndex=callHistoryPeerIfIndex, callHistoryTransmitBytes=callHistoryTransmitBytes, callHistoryTable=callHistoryTable, dialControlMibConformance=dialControlMibConformance, dialCtlPeerCfgAnswerAddress=dialCtlPeerCfgAnswerAddress, callActiveTable=callActiveTable, dialCtlAcceptMode=dialCtlAcceptMode, dialControlMibTraps=dialControlMibTraps, dialCtlPeerStatsFailCalls=dialCtlPeerStatsFailCalls, callHistoryDisconnectTime=callHistoryDisconnectTime, callHistoryReceiveBytes=callHistoryReceiveBytes, dialControlMibCompliances=dialControlMibCompliances, dialCtlPeerCfgMaxDuration=dialCtlPeerCfgMaxDuration, dialCtlPeerStatsLastSetupTime=dialCtlPeerStatsLastSetupTime, callHistory=callHistory, callHistoryDisconnectCause=callHistoryDisconnectCause, callActiveConnectTime=callActiveConnectTime, dialCtlConfiguration=dialCtlConfiguration, dialCtlPeerCfgRetryDelay=dialCtlPeerCfgRetryDelay, callHistoryLogicalIfIndex=callHistoryLogicalIfIndex, dialCtlPeerCfgFailureDelay=dialCtlPeerCfgFailureDelay, callActivePeerId=callActivePeerId, dialCtlPeerCfgOriginateAddress=dialCtlPeerCfgOriginateAddress, callActiveTransmitPackets=callActiveTransmitPackets, callHistoryInfoType=callHistoryInfoType, callActive=callActive, callActivePeerIfIndex=callActivePeerIfIndex, callActiveCallState=callActiveCallState)
