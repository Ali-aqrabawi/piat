...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ENTITY-FRU-CONTROL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:40:21 2019
...
entPhysicalIndex, entPhysicalClass, entPhysicalName, entPhysicalVendorType, entPhysicalContainedIn, entPhysicalModelName = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalIndex", "entPhysicalClass", "entPhysicalName", "entPhysicalVendorType", "entPhysicalContainedIn", "entPhysicalModelName")
InetAddress, InetAddressType = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddress", "InetAddressType")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Bits, Counter32, Gauge32, ObjectIdentity, Integer32, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, MibIdentifier, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "Integer32", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "MibIdentifier", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-ENTITY-FRU-CONTROL-MIB", cefcFRUPowerStatusEntry=cefcFRUPowerStatusEntry, cefcFanCoolingCapacity=cefcFanCoolingCapacity, cefcFRUCoolingUnitGroup=cefcFRUCoolingUnitGroup, cefcMIBCompliances=cefcMIBCompliances, cefcIntelliModuleIPAddrType=cefcIntelliModuleIPAddrType, cefcConnectorRatingEntry=cefcConnectorRatingEntry, ModuleResetReasonType=ModuleResetReasonType, cefcChassisCoolingTable=cefcChassisCoolingTable, cefcMIBPowerModeGroup=cefcMIBPowerModeGroup, cefcModuleLocalSwitchingTable=cefcModuleLocalSwitchingTable, cefcFRUDrawnInlineCurrent=cefcFRUDrawnInlineCurrent, cefcFanTrayStatusChange=cefcFanTrayStatusChange, cefcMIBGroups=cefcMIBGroups, cefcTotalDrawnInlineCurrent=cefcTotalDrawnInlineCurrent, cefcPowerSupplyOutputChange=cefcPowerSupplyOutputChange, PowerAdminType=PowerAdminType, cefcPhysicalStatus=cefcPhysicalStatus, cefcFRUFanCoolingUnitGroup=cefcFRUFanCoolingUnitGroup, cefcMaxDefaultInLinePower=cefcMaxDefaultInLinePower, cefcMgmtNotificationsGroup3=cefcMgmtNotificationsGroup3, cefcMIBPhysicalGroup=cefcMIBPhysicalGroup, cefcFRUInserted=cefcFRUInserted, cefcMIBNotificationEnables=cefcMIBNotificationEnables, cefcPhysical=cefcPhysical, cefcFRUPowerSupplyValueTable=cefcFRUPowerSupplyValueTable, cefcModuleResetReason=cefcModuleResetReason, cefcModuleGroupRev1=cefcModuleGroupRev1, cefcFanCoolingCapGroup=cefcFanCoolingCapGroup, cefcMIBPowerCompliance7=cefcMIBPowerCompliance7, PowerOperType=PowerOperType, cefcPowerNonRedundantReason=cefcPowerNonRedundantReason, cefcMIBObjects=cefcMIBObjects, cefcFRUPowerSupplyGroupTable=cefcFRUPowerSupplyGroupTable, cefcPowerSupplyInputEntry=cefcPowerSupplyInputEntry, cefcPowerSupplyOutputEntry=cefcPowerSupplyOutputEntry, cefcMIBPowerCompliance3=cefcMIBPowerCompliance3, cefcMIBPowerFRUControlGroup=cefcMIBPowerFRUControlGroup, FRUCoolingUnit=FRUCoolingUnit, cefcModuleEntry=cefcModuleEntry, cefcMIBPowerFRUValueGroup=cefcMIBPowerFRUValueGroup, cefcMIBInLinePowerControlGroupRev1=cefcMIBInLinePowerControlGroupRev1, cefcPhysicalTable=cefcPhysicalTable, cefcPowerSupplyInputType=cefcPowerSupplyInputType, cefcMaxDefaultHighInLinePower=cefcMaxDefaultHighInLinePower, cefcFanCoolingCapTable=cefcFanCoolingCapTable, cefcFanCoolingCapCapacity=cefcFanCoolingCapCapacity, cefcCoolingGroup=cefcCoolingGroup, ciscoEntityFRUControlMIB=ciscoEntityFRUControlMIB, cefcFanCoolingCapIndex=cefcFanCoolingCapIndex, cefcFanCoolingCapEntry=cefcFanCoolingCapEntry, cefcPowerStatusChange=cefcPowerStatusChange, cefcConnectorRating=cefcConnectorRating, cefcEnablePSOutputChangeNotif=cefcEnablePSOutputChangeNotif, cefcPSOutputModeIndex=cefcPSOutputModeIndex, cefcPSOutputModeCurrent=cefcPSOutputModeCurrent, cefcModuleTable=cefcModuleTable, cefcConnectorRatingGroup=cefcConnectorRatingGroup, cefcFanTrayOperStatus=cefcFanTrayOperStatus, cefcFRUTotalSystemCurrent=cefcFRUTotalSystemCurrent, cefcMIBPowerCompliance5=cefcMIBPowerCompliance5, cefcModuleStatusLastChangeTime=cefcModuleStatusLastChangeTime, cefcUnrecognizedFRU=cefcUnrecognizedFRU, cefcFRUMIBNotificationPrefix=cefcFRUMIBNotificationPrefix, cefcFRUFan=cefcFRUFan, FRUCurrentType=FRUCurrentType, cefcModuleExtGroup=cefcModuleExtGroup, cefcMIBInLinePowerCurrentGroup=cefcMIBInLinePowerCurrentGroup, cefcPowerCapacityGroup=cefcPowerCapacityGroup, cefcMIBNotificationEnablesGroup2=cefcMIBNotificationEnablesGroup2, cefcFRUPowerCapabilityGroup=cefcFRUPowerCapabilityGroup, cefcPowerRedundancyOperMode=cefcPowerRedundancyOperMode, ModuleAdminType=ModuleAdminType, cefcFRUPowerOperStatus=cefcFRUPowerOperStatus, cefcPowerCapacity=cefcPowerCapacity, cefcTotalAvailableCurrent=cefcTotalAvailableCurrent, cefcModuleLocalSwitchingEntry=cefcModuleLocalSwitchingEntry, cefcModuleCoolingEntry=cefcModuleCoolingEntry, cefcMIBPowerOperModeGroup=cefcMIBPowerOperModeGroup, cefcIntelliModuleIPAddr=cefcIntelliModuleIPAddr, cefcModuleAdminStatus=cefcModuleAdminStatus, cefcMIBNotifications=cefcMIBNotifications, cefcCooling=cefcCooling, cefcChassisCoolingEntry=cefcChassisCoolingEntry, cefcPhysicalEntry=cefcPhysicalEntry, cefcMIBPowerCompliance8=cefcMIBPowerCompliance8, PYSNMP_MODULE_ID=ciscoEntityFRUControlMIB, cefcConnectorRatingTable=cefcConnectorRatingTable, cefcMIBConformance=cefcMIBConformance, cefcModule=cefcModule, cefcMIBPowerCompliance9=cefcMIBPowerCompliance9, cefcMgmtNotificationsGroup2=cefcMgmtNotificationsGroup2, cefcModuleUpTime=cefcModuleUpTime, cefcPowerSupplyInputIndex=cefcPowerSupplyInputIndex, cefcCoolingGroup2=cefcCoolingGroup2, cefcFRUPowerSupplyValueEntry=cefcFRUPowerSupplyValueEntry, cefcIntelliModuleGroup=cefcIntelliModuleGroup, cefcModuleLocalSwitchingMode=cefcModuleLocalSwitchingMode, cefcFRUPowerCapability=cefcFRUPowerCapability, cefcMIBPowerRedundancyInfoGroup=cefcMIBPowerRedundancyInfoGroup, cefcFRUDrawnSystemCurrent=cefcFRUDrawnSystemCurrent, cefcFRUCurrent=cefcFRUCurrent, cefcMIBPowerCompliance4=cefcMIBPowerCompliance4, cefcConnector=cefcConnector, cefcIntelliModuleTable=cefcIntelliModuleTable, cefcMIBFanTrayStatusGroup=cefcMIBFanTrayStatusGroup, cefcFRUTotalInlineCurrent=cefcFRUTotalInlineCurrent, cefcMIBPowerCompliance=cefcMIBPowerCompliance, cefcPowerUnits=cefcPowerUnits, cefcFanCoolingCapCapacityUnit=cefcFanCoolingCapCapacityUnit, cefcPowerRedundancyMode=cefcPowerRedundancyMode, cefcChassisPerSlotCoolingCap=cefcChassisPerSlotCoolingCap, cefcMIBInLinePowerControlGroup=cefcMIBInLinePowerControlGroup, cefcModuleResetReasonDescription=cefcModuleResetReasonDescription, cefcFRUPowerAdminStatus=cefcFRUPowerAdminStatus, cefcModuleStateChangeReasonDescr=cefcModuleStateChangeReasonDescr, PowerRedundancyType=PowerRedundancyType, cefcFanCoolingGroup=cefcFanCoolingGroup, cefcFRUPowerStatusTable=cefcFRUPowerStatusTable, cefcFanCoolingCapCurrent=cefcFanCoolingCapCurrent, FRUTimeSeconds=FRUTimeSeconds, cefcPSOutputModeInOperation=cefcPSOutputModeInOperation, cefcFanCoolingCapModeDescr=cefcFanCoolingCapModeDescr, cefcModulePowerConsumptionTable=cefcModulePowerConsumptionTable, cefcFRUPowerSupplyGroupEntry=cefcFRUPowerSupplyGroupEntry, cefcMIBNotificationEnablesGroup=cefcMIBNotificationEnablesGroup, cefcMgmtNotificationsGroup=cefcMgmtNotificationsGroup, cefcMIBEnableStatusNotification=cefcMIBEnableStatusNotification, cefcFRUPowerRealTimeStatusGroup=cefcFRUPowerRealTimeStatusGroup, cefcFanCoolingEntry=cefcFanCoolingEntry, cefcMIBModuleGroup=cefcMIBModuleGroup, cefcModulePowerConsumptionEntry=cefcModulePowerConsumptionEntry, cefcModuleLastClearConfigTime=cefcModuleLastClearConfigTime, cefcMIBPowerCompliance2=cefcMIBPowerCompliance2, cefcMIBModuleLocalSwitchingGroup=cefcMIBModuleLocalSwitchingGroup, cefcIntelliModuleEntry=cefcIntelliModuleEntry, cefcModuleCoolingTable=cefcModuleCoolingTable, cefcFanTrayStatusTable=cefcFanTrayStatusTable, cefcFanCoolingCapacityUnit=cefcFanCoolingCapacityUnit, ModuleOperType=ModuleOperType, cefcModuleCooling=cefcModuleCooling, cefcTotalDrawnCurrent=cefcTotalDrawnCurrent, cefcModuleStatusChange=cefcModuleStatusChange, cefcMIBPowerCompliance6=cefcMIBPowerCompliance6, cefcModuleOperStatus=cefcModuleOperStatus, cefcModulePowerConsumption=cefcModulePowerConsumption, cefcFRUPower=cefcFRUPower, cefcPowerSupplyInputTable=cefcPowerSupplyInputTable, cefcPowerSupplyOutputTable=cefcPowerSupplyOutputTable, cefcFRURemoved=cefcFRURemoved, cefcChassisPerSlotCoolingUnit=cefcChassisPerSlotCoolingUnit, cefcFRURealTimeCurrent=cefcFRURealTimeCurrent, cefcModuleCoolingUnit=cefcModuleCoolingUnit, cefcFanCoolingTable=cefcFanCoolingTable, cefcFanTrayStatusEntry=cefcFanTrayStatusEntry)
