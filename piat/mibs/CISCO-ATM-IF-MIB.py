...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ATM-IF-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:26:20 2019
...
Counter32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, MibIdentifier, Unsigned32, Counter64, IpAddress, Bits, ModuleIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Counter64", "IpAddress", "Bits", "ModuleIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("CISCO-ATM-IF-MIB", ciscoAtmIfMIBGroup3=ciscoAtmIfMIBGroup3, ciscoAtmIfIlmiAddressRegistration=ciscoAtmIfIlmiAddressRegistration, ciscoAtmIfSvcUpcIntentCbr=ciscoAtmIfSvcUpcIntentCbr, ciscoAtmIfSvcMinVci=ciscoAtmIfSvcMinVci, ciscoAtmIfMIBCompliance4=ciscoAtmIfMIBCompliance4, ciscoAtmIfXmitLed=ciscoAtmIfXmitLed, ciscoAtmIfE164Address=ciscoAtmIfE164Address, ciscoAtmIfMIBGroup2=ciscoAtmIfMIBGroup2, ciscoAtmIfIlmiAutoConfiguration=ciscoAtmIfIlmiAutoConfiguration, ciscoAtmIfSvcUpcIntentVbrNrt=ciscoAtmIfSvcUpcIntentVbrNrt, ciscoAtmIfIlmiFSMState=ciscoAtmIfIlmiFSMState, ciscoAtmIfMIB=ciscoAtmIfMIB, ciscoAtmIfSscopUpDownChanges=ciscoAtmIfSscopUpDownChanges, ciscoAtmIfNotifsEnabled=ciscoAtmIfNotifsEnabled, ciscoAtmIfMIBCompliance7=ciscoAtmIfMIBCompliance7, ciscoAtmIfMIBGroup9=ciscoAtmIfMIBGroup9, ciscoAtmIfMIBNotifications=ciscoAtmIfMIBNotifications, ciscoAtmIfTotalConnections=ciscoAtmIfTotalConnections, ciscoAtmIfMIBCompliance3=ciscoAtmIfMIBCompliance3, ciscoAtmIfIlmiAccessGlobalDefaultFilter=ciscoAtmIfIlmiAccessGlobalDefaultFilter, ciscoAtmIfRxCellDiscards=ciscoAtmIfRxCellDiscards, ciscoAtmIfNotifyGroup=ciscoAtmIfNotifyGroup, ciscoAtmIfE164AutoConversionOnly=ciscoAtmIfE164AutoConversionOnly, ciscoAtmIfSvcUpcIntentUbr=ciscoAtmIfSvcUpcIntentUbr, ciscoAtmIfDerivedAESA=ciscoAtmIfDerivedAESA, ciscoAtmIfMIBConformance=ciscoAtmIfMIBConformance, ciscoAtmIfRecvCells=ciscoAtmIfRecvCells, ciscoAtmIfMIBCompliance2=ciscoAtmIfMIBCompliance2, ciscoAtmIfMIBGroup=ciscoAtmIfMIBGroup, AtmAddr=AtmAddr, ciscoAtmIfMIBGroup8=ciscoAtmIfMIBGroup8, ciscoAtmIfMIBGroup6=ciscoAtmIfMIBGroup6, ciscoAtmIfSscopFSMState=ciscoAtmIfSscopFSMState, ciscoAtmIfMIBCompliance=ciscoAtmIfMIBCompliance, ciscoAtmIfPVCs=ciscoAtmIfPVCs, ciscoAtmIfUniType=ciscoAtmIfUniType, ciscoAtmIfMIBGroup5=ciscoAtmIfMIBGroup5, ciscoAtmIfXmitCells=ciscoAtmIfXmitCells, PYSNMP_MODULE_ID=ciscoAtmIfMIB, ciscoAtmIfUniSignallingVersion=ciscoAtmIfUniSignallingVersion, ciscoAtmIfIlmiAccessFilter=ciscoAtmIfIlmiAccessFilter, ciscoAtmIfType=ciscoAtmIfType, ciscoAtmIfPortType=ciscoAtmIfPortType, ciscoAtmIfIlmiConfiguration=ciscoAtmIfIlmiConfiguration, ciscoAtmIfActiveSVPs=ciscoAtmIfActiveSVPs, ciscoAtmIfIlmiKeepAlive=ciscoAtmIfIlmiKeepAlive, ciscoAtmIfSvcUpcIntent=ciscoAtmIfSvcUpcIntent, ciscoAtmIfEvent=ciscoAtmIfEvent, ciscoAtmIfWellKnownVcMode=ciscoAtmIfWellKnownVcMode, ciscoAtmIfMIBGroup10=ciscoAtmIfMIBGroup10, ciscoAtmIfMIBObjects=ciscoAtmIfMIBObjects, ciscoAtmIfTable=ciscoAtmIfTable, ciscoAtmIfRxCellUpcViolations=ciscoAtmIfRxCellUpcViolations, ciscoAtmIfSide=ciscoAtmIfSide, ciscoAtmIfEntry=ciscoAtmIfEntry, ciscoAtmIfRecvLed=ciscoAtmIfRecvLed, ciscoAtmIfSoftVcDestAddress=ciscoAtmIfSoftVcDestAddress, ciscoAtmIfConfigAESA=ciscoAtmIfConfigAESA, UpcMethod=UpcMethod, ciscoAtmIfSignallingAdminStatus=ciscoAtmIfSignallingAdminStatus, ciscoAtmIfSvcUpcIntentVbrRt=ciscoAtmIfSvcUpcIntentVbrRt, ciscoAtmIfMIBCompliance5=ciscoAtmIfMIBCompliance5, ciscoAtmIfAddress=ciscoAtmIfAddress, ciscoAtmIfMIBCompliance6=ciscoAtmIfMIBCompliance6, ciscoAtmIfCdLed=ciscoAtmIfCdLed, ciscoAtmIfSvcUpcIntentAbr=ciscoAtmIfSvcUpcIntentAbr, ciscoAtmIfPVPs=ciscoAtmIfPVPs, ciscoAtmIfAddressType=ciscoAtmIfAddressType, ciscoAtmIfMIBGroup4=ciscoAtmIfMIBGroup4, ciscoAtmIfMIBGroups=ciscoAtmIfMIBGroups, ciscoAtmIfMIBGroup7=ciscoAtmIfMIBGroup7, ciscoAtmIfMIBCompliances=ciscoAtmIfMIBCompliances, NsapAtmAddr=NsapAtmAddr, ciscoAtmIfConfVplIf=ciscoAtmIfConfVplIf, ciscoAtmIfActiveSVCs=ciscoAtmIfActiveSVCs, ciscoAtmIfMIBCompliance8=ciscoAtmIfMIBCompliance8, ciscoAtmIfIlmiUpDownChanges=ciscoAtmIfIlmiUpDownChanges)
