...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-OSPF-TRAP-MIB
...
cospfLsdbType, cospfShamLinksState, cospfShamLinkNbrIpAddr, cospfShamLinkState, cospfShamLinkAreaId, cospfShamLinksRemoteIpAddrType, cospfShamLinkNbrIpAddrType, cospfShamLinksRemoteIpAddr, cospfShamLinkNbrState, cospfShamLinkNeighborId, cospfShamLinksLocalIpAddrType, cospfShamLinkNbrArea, cospfShamLinkLocalIpAddress, cospfAreaNssaTranslatorState, cospfShamLinksAreaId, cospfShamLinkNbrRtrId, cospfShamLinksLocalIpAddr = mibBuilder.importSymbols("CISCO-OSPF-MIB", "cospfLsdbType", "cospfShamLinksState", "cospfShamLinkNbrIpAddr", "cospfShamLinkState", "cospfShamLinkAreaId", "cospfShamLinksRemoteIpAddrType", "cospfShamLinkNbrIpAddrType", "cospfShamLinksRemoteIpAddr", "cospfShamLinkNbrState", "cospfShamLinkNeighborId", "cospfShamLinksLocalIpAddrType", "cospfShamLinkNbrArea", "cospfShamLinkLocalIpAddress", "cospfAreaNssaTranslatorState", "cospfShamLinksAreaId", "cospfShamLinkNbrRtrId", "cospfShamLinksLocalIpAddr")
ciscoExperiment, = mibBuilder.importSymbols("CISCO-SMI", "ciscoExperiment")
ospfLsdbRouterId, ospfVirtIfNeighbor, ospfVirtIfAreaId, ospfNbrRtrId, ospfAreaId, ospfRouterId, ospfLsdbAreaId, ospfLsdbLsid, ospfAddressLessIf, ospfIfIpAddress = mibBuilder.importSymbols("OSPF-MIB", "ospfLsdbRouterId", "ospfVirtIfNeighbor", "ospfVirtIfAreaId", "ospfNbrRtrId", "ospfAreaId", "ospfRouterId", "ospfLsdbAreaId", "ospfLsdbLsid", "ospfAddressLessIf", "ospfIfIpAddress")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Integer32, ModuleIdentity, Bits, NotificationType, MibIdentifier, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, iso, TimeTicks, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "iso", "TimeTicks", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("CISCO-OSPF-TRAP-MIB", cospfConfigErrorType=cospfConfigErrorType, cospfShamLinkStateChange=cospfShamLinkStateChange, cospfShamLinkTxRetransmit=cospfShamLinkTxRetransmit, cospfShamLinkRxBadPacket=cospfShamLinkRxBadPacket, ciscoOspfTrapMIBConform=ciscoOspfTrapMIBConform, ciscoOspfTrapEventGroupRev1=ciscoOspfTrapEventGroupRev1, cospfMaxAgeLsa=cospfMaxAgeLsa, cospfVirtIfTxRetransmit=cospfVirtIfTxRetransmit, ciscoOspfTrapMIBNotifs=ciscoOspfTrapMIBNotifs, ciscoOspfTrapMIB=ciscoOspfTrapMIB, cospfTrapControl=cospfTrapControl, ciscoOspfTrapMIBObjects=ciscoOspfTrapMIBObjects, ciscoOspfTrapMIBGroups=ciscoOspfTrapMIBGroups, cospfPacketSrc=cospfPacketSrc, ciscoOspfTrapMIBCompliance=ciscoOspfTrapMIBCompliance, ciscoOspfTrapMIBComplianceRev1=ciscoOspfTrapMIBComplianceRev1, cospfNssaTranslatorStatusChange=cospfNssaTranslatorStatusChange, cospfSetTrap=cospfSetTrap, cospfOriginateLsa=cospfOriginateLsa, PYSNMP_MODULE_ID=ciscoOspfTrapMIB, cospfShamLinkAuthFailure=cospfShamLinkAuthFailure, ciscoOspfTrapMIBCompliances=ciscoOspfTrapMIBCompliances, cospfVirtIfConfigError=cospfVirtIfConfigError, cospfTxRetransmit=cospfTxRetransmit, ciscoOspfTrapEventGroup=ciscoOspfTrapEventGroup, cospfShamLinkConfigError=cospfShamLinkConfigError, cospfShamLinkNbrStateChange=cospfShamLinkNbrStateChange, cospfShamLinksStateChange=cospfShamLinksStateChange, cospfIfConfigError=cospfIfConfigError, ciscoOspfTrapControlGroup=ciscoOspfTrapControlGroup, cospfPacketType=cospfPacketType)
