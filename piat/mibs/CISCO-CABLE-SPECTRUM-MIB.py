...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CABLE-SPECTRUM-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:48:24 2019
...
TimeTicks, MibIdentifier, ModuleIdentity, Unsigned32, Bits, Gauge32, iso, NotificationType, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Bits", "Gauge32", "iso", "NotificationType", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter32")
TimeStamp, MacAddress, TextualConvention, DisplayString, RowStatus, DateAndTime, TruthValue, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "MacAddress", "TextualConvention", "DisplayString", "RowStatus", "DateAndTime", "TruthValue", "StorageType")
...
mibBuilder.exportSymbols("CISCO-CABLE-SPECTRUM-MIB", ccsCompliance6=ccsCompliance6, ccsSpectrumDataPower=ccsSpectrumDataPower, ccsFiberNodeUpstreamIfIndex=ccsFiberNodeUpstreamIfIndex, PYSNMP_MODULE_ID=ciscoCableSpectrumMIB, ccsSpectrumRequestOperState=ccsSpectrumRequestOperState, ccsSpectrumRequestIndex=ccsSpectrumRequestIndex, ciscoCableSpectrumMIBObjects=ciscoCableSpectrumMIBObjects, ccsCompliance2=ccsCompliance2, ccsUpInSpecGroupGroup=ccsUpInSpecGroupGroup, CCSMeasuredFrequency=CCSMeasuredFrequency, ccsUpSpecMgmtHopCondition=ccsUpSpecMgmtHopCondition, ccsUpSpecMgmtFromModProfile=ccsUpSpecMgmtFromModProfile, ciscoCableSpectrumMIB=ciscoCableSpectrumMIB, ccsCmFlapTotalNum=ccsCmFlapTotalNum, ccsFlapMissNum=ccsFlapMissNum, ccsConfigObjects=ccsConfigObjects, ccsFlapPowerAdjustments=ccsFlapPowerAdjustments, ccsUpSpecMgmtCriteria=ccsUpSpecMgmtCriteria, ccsCmFlapCreateTime=ccsCmFlapCreateTime, ccsFlapUpstreamIfIndex=ccsFlapUpstreamIfIndex, ccsSpecGroupUpstreamIfIndex=ccsSpecGroupUpstreamIfIndex, ccsSNRRequestStoppedTime=ccsSNRRequestStoppedTime, CCSRequestOperState=CCSRequestOperState, ccsSNRRequestStatus=ccsSNRRequestStatus, ccsFlapGroup=ccsFlapGroup, ccsUpSpecMgmtSharedSpectrum=ccsUpSpecMgmtSharedSpectrum, ccsCmFlapInsertionFailNum=ccsCmFlapInsertionFailNum, ccsNotificationGroupRev1=ccsNotificationGroupRev1, ccsUpInFiberNodeGroup=ccsUpInFiberNodeGroup, ccsCmFlapTable=ccsCmFlapTable, ccsSpecGroupFreqType=ccsSpecGroupFreqType, ccsCmFlapLastFlapTime=ccsCmFlapLastFlapTime, ccsNotificationGroup=ccsNotificationGroup, ccsSpectrumRequestEntry=ccsSpectrumRequestEntry, ccsFlapEntry=ccsFlapEntry, ccsCompliance5=ccsCompliance5, ccsFlapHitNum=ccsFlapHitNum, ccsSNRRequestEntry=ccsSNRRequestEntry, ccsFlapInsertionTime=ccsFlapInsertionTime, ccsFlapHits=ccsFlapHits, ccsCmFlapMacAddr=ccsCmFlapMacAddr, ccsUpSpecMgmtFecCorrectThres1=ccsUpSpecMgmtFecCorrectThres1, ccsSpectrumDataFreq=ccsSpectrumDataFreq, ccsUpSpecMgmtToCenterFreq=ccsUpSpecMgmtToCenterFreq, ccsSpectrumRequestStoppedTime=ccsSpectrumRequestStoppedTime, ccsSpecGroupFreqUpper=ccsSpecGroupFreqUpper, ccsCmFlapMissNum=ccsCmFlapMissNum, ccsUpSpecMgmtGroup=ccsUpSpecMgmtGroup, ccsSpectrumRequestLowFreq=ccsSpectrumRequestLowFreq, ccsFlapMissThreshold=ccsFlapMissThreshold, ccsSpectrumRequestStatus=ccsSpectrumRequestStatus, ccsFlapCrcErrorNum=ccsFlapCrcErrorNum, ccsSNRRequestOperState=ccsSNRRequestOperState, ccsFlapObjects=ccsFlapObjects, ccsSpectrumRequestMacAddr=ccsSpectrumRequestMacAddr, ccsUpSpecMgmtToModProfile=ccsUpSpecMgmtToModProfile, ciscoCableSpectrumMIBConformance=ciscoCableSpectrumMIBConformance, ccsUpSpecMgmtSnrThres1=ccsUpSpecMgmtSnrThres1, ccsFlapAging=ccsFlapAging, ccsUpSpecMgmtCnrThres1=ccsUpSpecMgmtCnrThres1, ccsUpSpecMgmtFecCorrectThres2=ccsUpSpecMgmtFecCorrectThres2, ccsUpSpecMgmtSNR=ccsUpSpecMgmtSNR, ccsCompliance=ccsCompliance, ccsSpecGroupFreqLower=ccsSpecGroupFreqLower, ccsUpSpecMgmtGroupRev4=ccsUpSpecMgmtGroupRev4, ccsUpSpecMgmtUpperBoundFreq=ccsUpSpecMgmtUpperBoundFreq, ccsUpSpecMgmtFecUnCorrectThres1=ccsUpSpecMgmtFecUnCorrectThres1, ccsCmFlapHitNum=ccsCmFlapHitNum, ccsUpSpecMgmtTable=ccsUpSpecMgmtTable, ccsUpSpecMgmtEntry=ccsUpSpecMgmtEntry, ccsSpecMgmtNotification=ccsSpecMgmtNotification, ccsFlapGroupRev2=ccsFlapGroupRev2, ccsSNRRequestIndex=ccsSNRRequestIndex, ccsSpecGroupUpstreamRowStatus=ccsSpecGroupUpstreamRowStatus, ccsUpSpecMgmtHopPriority=ccsUpSpecMgmtHopPriority, ccsSpectrumGroup=ccsSpectrumGroup, ccsSNRRequestOperation=ccsSNRRequestOperation, ccsUpSpecMgmtGroupRev1=ccsUpSpecMgmtGroupRev1, ccsSpectrumDataEntry=ccsSpectrumDataEntry, ccsFlapCreateTime=ccsFlapCreateTime, CCSRequestOperation=CCSRequestOperation, ccsSpectrumRequestOperation=ccsSpectrumRequestOperation, ccsSNRRequestStartTime=ccsSNRRequestStartTime, ccsSpectrumDataTable=ccsSpectrumDataTable, ccsSpectrumObjects=ccsSpectrumObjects, ccsUpSpecMgmtToBandWidth=ccsUpSpecMgmtToBandWidth, ccsUpSpecMgmtCNR=ccsUpSpecMgmtCNR, ccsCmFlapEntry=ccsCmFlapEntry, ccsSpecGroupStorage=ccsSpecGroupStorage, ccsUpInSpecGroupEntry=ccsUpInSpecGroupEntry, ccsSpectrumRequestResolution=ccsSpectrumRequestResolution, ccsUpSpecMgmtCnrThres2=ccsUpSpecMgmtCnrThres2, ccsFlapMacAddr=ccsFlapMacAddr, ccsCmFlapLastResetTime=ccsCmFlapLastResetTime, ccsFlapPowerAdjustmentNum=ccsFlapPowerAdjustmentNum, ccsUpSpecMgmtSnrPollPeriod=ccsUpSpecMgmtSnrPollPeriod, ccsSpectrumRequestStartTime=ccsSpectrumRequestStartTime, ccsCmFlapPowerAdjustmentNum=ccsCmFlapPowerAdjustmentNum, ccsSpectrumRequestIfIndex=ccsSpectrumRequestIfIndex, ccsFiberNodeUpstreamRowStatus=ccsFiberNodeUpstreamRowStatus, ciscoCableSpectrumMIBNotificationPrefix=ciscoCableSpectrumMIBNotificationPrefix, ccsSNRRequestMacAddr=ccsSNRRequestMacAddr, ccsUpInFiberNodeTable=ccsUpInFiberNodeTable, ccsFlapGroupRev1=ccsFlapGroupRev1, ccsFlapTable=ccsFlapTable, ccsFlapCrcErrors=ccsFlapCrcErrors, ccsFlapInsertionFailNum=ccsFlapInsertionFailNum, ciscoCableSpectrumMIBGroups=ciscoCableSpectrumMIBGroups, ccsUpSpecMgmtGroupRev2=ccsUpSpecMgmtGroupRev2, ccsSpecGroupFreqIndex=ccsSpecGroupFreqIndex, ccsCompliance4=ccsCompliance4, ciscoCableSpectrumMIBCompliances=ciscoCableSpectrumMIBCompliances, ccsSpecGroupFreqEntry=ccsSpecGroupFreqEntry, ccsSpecGroupFreqTable=ccsSpecGroupFreqTable, ccsFlapMisses=ccsFlapMisses, ccsCmFlapRowStatus=ccsCmFlapRowStatus, ccsFlapTotal=ccsFlapTotal, CCSFrequency=CCSFrequency, ccsSNRRequestTable=ccsSNRRequestTable, ccsUpSpecMgmtFromBandWidth=ccsUpSpecMgmtFromBandWidth, ccsUpSpecMgmtMissedMaintMsgThres=ccsUpSpecMgmtMissedMaintMsgThres, ccsUpSpecMgmtSpecGroup=ccsUpSpecMgmtSpecGroup, ccsCmFlapDownstreamIfIndex=ccsCmFlapDownstreamIfIndex, ccsCmFlapUpstreamIfIndex=ccsCmFlapUpstreamIfIndex, ccsUpSpecMgmtFromCenterFreq=ccsUpSpecMgmtFromCenterFreq, ccsFlapResetNow=ccsFlapResetNow, ccsFlapDownstreamIfIndex=ccsFlapDownstreamIfIndex, ccsSNRRequestSNR=ccsSNRRequestSNR, ccsUpSpecMgmtGroupRev3=ccsUpSpecMgmtGroupRev3, ccsCmFlapCrcErrorNum=ccsCmFlapCrcErrorNum, ccsUpSpecMgmtHopPeriod=ccsUpSpecMgmtHopPeriod, ccsFlapResetAll=ccsFlapResetAll, ccsFlapListMaxSize=ccsFlapListMaxSize, ccsHoppingNotification=ccsHoppingNotification, ccsFiberNodeUpstreamStorage=ccsFiberNodeUpstreamStorage, ccsSpecGroupRowStatus=ccsSpecGroupRowStatus, ccsFlapPowerAdjustThreshold=ccsFlapPowerAdjustThreshold, ccsSpecGroupNumber=ccsSpecGroupNumber, ccsSpecGroupUpstreamStorage=ccsSpecGroupUpstreamStorage, ccsFlapRowStatus=ccsFlapRowStatus, ccsFlapListCurrentSize=ccsFlapListCurrentSize, ccsFlapInsertionFails=ccsFlapInsertionFails, ccsUpInSpecGroupTable=ccsUpInSpecGroupTable, ccsFlapTotalNum=ccsFlapTotalNum, ccsSpecGroupFreqGroup=ccsSpecGroupFreqGroup, ccsFlapLastClearTime=ccsFlapLastClearTime, ccsCompliance3=ccsCompliance3, ccsUpSpecMgmtSnrThres2=ccsUpSpecMgmtSnrThres2, ccsCompliance7=ccsCompliance7, ccsUpInFiberNodeEntry=ccsUpInFiberNodeEntry, ccsSpectrumRequestTable=ccsSpectrumRequestTable, ccsFlapLastFlapTime=ccsFlapLastFlapTime, ccsSpectrumRequestUpperFreq=ccsSpectrumRequestUpperFreq, ccsMIBNotifications=ccsMIBNotifications, ccsFlapLastResetTime=ccsFlapLastResetTime, ccsCmFlapResetNow=ccsCmFlapResetNow, ccsUpSpecMgmtFecUnCorrectThres2=ccsUpSpecMgmtFecUnCorrectThres2, ccsFiberNodeNumber=ccsFiberNodeNumber, ccsFlapClearAll=ccsFlapClearAll)
