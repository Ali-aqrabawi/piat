...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CONTACT-CENTER-APPS-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:27:52 2019
...
Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ObjectIdentity, Counter32, iso, MibIdentifier, Counter64, ModuleIdentity, Unsigned32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ObjectIdentity", "Counter32", "iso", "MibIdentifier", "Counter64", "ModuleIdentity", "Unsigned32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("CISCO-CONTACT-CENTER-APPS-MIB", cccaRouterAppGwEnabled=cccaRouterAppGwEnabled, cccaDialerCampaignMgrStatus=cccaDialerCampaignMgrStatus, cccaPgRouterSideBName=cccaPgRouterSideBName, cccaComponentTableGroup=cccaComponentTableGroup, cccaDialerCallAttemptsPerSec=cccaDialerCallAttemptsPerSec, cccaComponentStatus=cccaComponentStatus, cccaRouterNicCount=cccaRouterNicCount, cccaDialerIdlePorts=cccaDialerIdlePorts, cccaPgNumber=cccaPgNumber, cccaDialerEntry=cccaDialerEntry, cccaLoggerSide=cccaLoggerSide, cccaDialerTable=cccaDialerTable, cccaComponentType=cccaComponentType, cccaInstanceTable=cccaInstanceTable, cccaLoggerEntry=cccaLoggerEntry, cccaTimeZoneOffsetHours=cccaTimeZoneOffsetHours, cccaCgOpenSessions=cccaCgOpenSessions, cccaDialerTableGroup=cccaDialerTableGroup, cccaDistAwType=cccaDistAwType, cccaInstanceTableGroup=cccaInstanceTableGroup, ciscoCcaMIBObjects=ciscoCcaMIBObjects, cccaDialerQueueDepth=cccaDialerQueueDepth, cccaCtiOsServerName=cccaCtiOsServerName, cccaRouterCallsInProgress=cccaRouterCallsInProgress, cccaName=cccaName, cccaComponentElmtIndex=cccaComponentElmtIndex, CcaComponentType=CcaComponentType, ciscoCccaMIBComplianceRev2=ciscoCccaMIBComplianceRev2, cccaLoggerHDSReplication=cccaLoggerHDSReplication, CcaComponentStatus=CcaComponentStatus, cccaCtiOsActiveClients=cccaCtiOsActiveClients, cccaRouterTableGroup=cccaRouterTableGroup, cccaRouterPublicHighAddr=cccaRouterPublicHighAddr, cccaCgPgSideAName=cccaCgPgSideAName, cccaDistAwAdminSiteName=cccaDistAwAdminSiteName, cccaPgRouterSideAName=cccaPgRouterSideAName, cccaIcmNotificationInfoGroup=cccaIcmNotificationInfoGroup, cccaComponentElmtRunID=cccaComponentElmtRunID, cccaEventMessageId=cccaEventMessageId, cccaRouterSide=cccaRouterSide, cccaEventComponentId=cccaEventComponentId, cccaNicEntry=cccaNicEntry, cccaLoggerTableGroup=cccaLoggerTableGroup, cccaLoggerType=cccaLoggerType, cccaEventState=cccaEventState, cccaEventOriginatingSide=cccaEventOriginatingSide, ciscoCcaMIB=ciscoCcaMIB, cccaNicIndex=cccaNicIndex, cccaRouterPGsEnabledCount=cccaRouterPGsEnabledCount, cccaCampaignMgrActiveDialers=cccaCampaignMgrActiveDialers, ciscoCcaMIBNotifs=ciscoCcaMIBNotifs, cccaEventTimestamp=cccaEventTimestamp, cccaComponentElmtTableGroup=cccaComponentElmtTableGroup, cccaGeneralInfoGroupSup1=cccaGeneralInfoGroupSup1, cccaInstanceEntry=cccaInstanceEntry, cccaComponentTable=cccaComponentTable, cccaDistAwRouterSideBName=cccaDistAwRouterSideBName, cccaCgSide=cccaCgSide, cccaComponentIndex=cccaComponentIndex, cccaRouterCallsPerSec=cccaRouterCallsPerSec, cccaPimPeripheralHostName=cccaPimPeripheralHostName, ciscoCcaMIBConform=ciscoCcaMIBConform, cccaPimEntry=cccaPimEntry, cccaCtiOsPeerName=cccaCtiOsPeerName, ciscoCcaMIBCompliances=ciscoCcaMIBCompliances, cccaDialerMediaRouterStatus=cccaDialerMediaRouterStatus, cccaNicStatus=cccaNicStatus, cccaDistAwRouterSideAName=cccaDistAwRouterSideAName, cccaRouterDBWorkerEnabled=cccaRouterDBWorkerEnabled, cccaRouterPrivateHighAddr=cccaRouterPrivateHighAddr, cccaRouterTableGroupSup1=cccaRouterTableGroupSup1, cccaDistAwWebReskillingURL=cccaDistAwWebReskillingURL, cccaGeneralInfo=cccaGeneralInfo, cccaPimPeripheralType=cccaPimPeripheralType, cccaSupportToolsURL=cccaSupportToolsURL, cccaComponentElmtStatus=cccaComponentElmtStatus, cccaPimStatus=cccaPimStatus, cccaDialerCtiServerBName=cccaDialerCtiServerBName, cccaEventOriginatingNodeType=cccaEventOriginatingNodeType, cccaDistAwWebViewEnabled=cccaDistAwWebViewEnabled, cccaRouterDuplexPairName=cccaRouterDuplexPairName, cccaCtiOsPeripheralType=cccaCtiOsPeripheralType, cccaCtiOsCallsInProgress=cccaCtiOsCallsInProgress, cccaLoggerAvgDBWriteTime=cccaLoggerAvgDBWriteTime, cccaCampaignMgrDbUtilization=cccaCampaignMgrDbUtilization, cccaDistAwSide=cccaDistAwSide, cccaCtiOsTableGroup=cccaCtiOsTableGroup, cccaComponentEntry=cccaComponentEntry, cccaDistAwLoggerSideAName=cccaDistAwLoggerSideAName, cccaPgCallsInProgress=cccaPgCallsInProgress, cccaIcmEvent=cccaIcmEvent, cccaLoggerTable=cccaLoggerTable, cccaCgDuplexPairName=cccaCgDuplexPairName, cccaDialerAvgQueueTime=cccaDialerAvgQueueTime, cccaPgAgentsLoggedOn=cccaPgAgentsLoggedOn, cccaWebSetupURL=cccaWebSetupURL, cccaDialerCtiServerAName=cccaDialerCtiServerAName, cccaRouterPrivateNonHighAddr=cccaRouterPrivateNonHighAddr, cccaCtiOsActiveMonitors=cccaCtiOsActiveMonitors, cccaNicType=cccaNicType, cccaCgPgSideBName=cccaCgPgSideBName, cccaRouterTable=cccaRouterTable, cccaDialerBusyCustomerPorts=cccaDialerBusyCustomerPorts, cccaTimeZoneName=cccaTimeZoneName, cccaPgTable=cccaPgTable, cccaCtiOsCgSideBName=cccaCtiOsCgSideBName, cccaCtiOsTable=cccaCtiOsTable, cccaRouterCallsInQueue=cccaRouterCallsInQueue, cccaDistAwWebViewServerName=cccaDistAwWebViewServerName, cccaPgAgentsTalking=cccaPgAgentsTalking, cccaCgOtherSessions=cccaCgOtherSessions, CcaComponentSide=CcaComponentSide, cccaDistAwTableGroup=cccaDistAwTableGroup, cccaCtiOsTableGroupSup1=cccaCtiOsTableGroupSup1, cccaDistAwLoggerSideBName=cccaDistAwLoggerSideBName, cccaLoggerTableGroupSup1=cccaLoggerTableGroupSup1, cccaCampaignMgrQueueDepth=cccaCampaignMgrQueueDepth, cccaPgTableGroup=cccaPgTableGroup, cccaCampaignMgrAvgQueueTime=cccaCampaignMgrAvgQueueTime, cccaGeneralInfoGroup=cccaGeneralInfoGroup, cccaCtiOsCgSideAName=cccaCtiOsCgSideAName, cccaComponentName=cccaComponentName, cccaComponents=cccaComponents, cccaPimTableGroup=cccaPimTableGroup, CcaPeripheralType=CcaPeripheralType, CcaIndex=CcaIndex, PYSNMP_MODULE_ID=ciscoCcaMIB, cccaLoggerDuplexPairName=cccaLoggerDuplexPairName, cccaPgID=cccaPgID, cccaCtiOsEntry=cccaCtiOsEntry, cccaPgTableGroupSup1=cccaPgTableGroupSup1, cccaRouterAgentsLoggedOn=cccaRouterAgentsLoggedOn, cccaPgDuplexPairName=cccaPgDuplexPairName, cccaCgEntry=cccaCgEntry, cccaComponentInfo=cccaComponentInfo, cccaIcmEventsGroup=cccaIcmEventsGroup, ciscoCccaMIBComplianceRev1=ciscoCccaMIBComplianceRev1, cccaDistAwHDSEnabled=cccaDistAwHDSEnabled, cccaDialerCtiServerStatus=cccaDialerCtiServerStatus, cccaPgEntry=cccaPgEntry, cccaCgTable=cccaCgTable, cccaEventOriginatingNode=cccaEventOriginatingNode, cccaDialerBlockedPorts=cccaDialerBlockedPorts, cccaCampaignMgrTable=cccaCampaignMgrTable, cccaCtiOsCallsFailed=cccaCtiOsCallsFailed, cccaDescription=cccaDescription, cccaLoggerRouterSideBName=cccaLoggerRouterSideBName, cccaComponentElmtEntry=cccaComponentElmtEntry, cccaCgTableGroupSup1=cccaCgTableGroupSup1, cccaTimeZoneOffsetMinutes=cccaTimeZoneOffsetMinutes, cccaNicTable=cccaNicTable, ciscoCcaMIBGroups=ciscoCcaMIBGroups, cccaEventSeverity=cccaEventSeverity, cccaEventOriginatingProcessName=cccaEventOriginatingProcessName, cccaEventDmpId=cccaEventDmpId, cccaCampaignMgrEntry=cccaCampaignMgrEntry, cccaNotificationsEnabled=cccaNotificationsEnabled, cccaPimPeripheralName=cccaPimPeripheralName, cccaPgAgentsReady=cccaPgAgentsReady, cccaInstanceName=cccaInstanceName, cccaPimTable=cccaPimTable, cccaCgTableGroup=cccaCgTableGroup, cccaCgID=cccaCgID, cccaNotificationInfo=cccaNotificationInfo, cccaComponentElmtTable=cccaComponentElmtTable, cccaDistAwDuplexPairName=cccaDistAwDuplexPairName, cccaDistAwEntry=cccaDistAwEntry, cccaCgNumber=cccaCgNumber, cccaVersion=cccaVersion, cccaDistAwTable=cccaDistAwTable, cccaDistAwTableGroupSup1=cccaDistAwTableGroupSup1, cccaPgSide=cccaPgSide, cccaInstanceNumber=cccaInstanceNumber, cccaCtiOsPeripheralName=cccaCtiOsPeripheralName, cccaComponentElmtName=cccaComponentElmtName, cccaDialerConfiguredPorts=cccaDialerConfiguredPorts, cccaNicTableGroup=cccaNicTableGroup, cccaEventText=cccaEventText, cccaDialerCampaignMgrName=cccaDialerCampaignMgrName, cccaCampaignMgrTableGroup=cccaCampaignMgrTableGroup, cccaDialerTalkingAgents=cccaDialerTalkingAgents, cccaLoggerRouterSideAName=cccaLoggerRouterSideAName, cccaPgPimCount=cccaPgPimCount, cccaRouterEntry=cccaRouterEntry, cccaRouterPublicNonHighAddr=cccaRouterPublicNonHighAddr, cccaPimNumber=cccaPimNumber, cccaDialerBusyReservationPorts=cccaDialerBusyReservationPorts)
