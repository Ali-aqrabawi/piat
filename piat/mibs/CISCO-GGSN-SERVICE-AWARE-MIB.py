...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-GGSN-SERVICE-AWARE-MIB
...
mibBuilder.exportSymbols("CISCO-GGSN-SERVICE-AWARE-MIB", cGgsnSADccaCcfh=cGgsnSADccaCcfh, cGgsnSATotalCreatedCategories=cGgsnSATotalCreatedCategories, cGgsnSAQsUnknownResponses=cGgsnSAQsUnknownResponses, cGgsnSAQsRequestsUnreplied=cGgsnSAQsRequestsUnreplied, cGgsnSACsgPort=cGgsnSACsgPort, cGgsnSAQsSentRequests=cGgsnSAQsSentRequests, cGgsnSACsgRealAddress2=cGgsnSACsgRealAddress2, cGgsnSACsgQuotaReturnReqs=cGgsnSACsgQuotaReturnReqs, cGgsnSAQsDroppedMsgs=cGgsnSAQsDroppedMsgs, cGgsnSACsgEntry=cGgsnSACsgEntry, cGgsnSATotalGgsnFailures=cGgsnSATotalGgsnFailures, cGgsnSACsgAaaAcctGroup=cGgsnSACsgAaaAcctGroup, CGgsnCsgPathState=CGgsnCsgPathState, cGgsnSAQsSeqnumFailures=cGgsnSAQsSeqnumFailures, cGgsnSADccaProfileTable=cGgsnSADccaProfileTable, cGgsnSADccaUserUnknownNotif=cGgsnSADccaUserUnknownNotif, cggsnSACsgStatisticsEntry=cggsnSACsgStatisticsEntry, cGgsnSADccaSessionFailover=cGgsnSADccaSessionFailover, cGgsnSAMIBComplianceRev4=cGgsnSAMIBComplianceRev4, cGgsnSAQsInvalidMsgFormats=cGgsnSAQsInvalidMsgFormats, cGgsnSATotalDeletedSyncObjects=cGgsnSATotalDeletedSyncObjects, cGgsnSAConfigurationsGroup=cGgsnSAConfigurationsGroup, cGgsnSAMIBCompliance=cGgsnSAMIBCompliance, cGgsnSAQsBadSrcAddressMsgs=cGgsnSAQsBadSrcAddressMsgs, cGgsnSACsgStatsInboundOctets=cGgsnSACsgStatsInboundOctets, cGgsnSAQuotaServerSvcMsgEnabled=cGgsnSAQuotaServerSvcMsgEnabled, cGgsnSAQsMandTlvIncorrectMsgs=cGgsnSAQsMandTlvIncorrectMsgs, cggsnSACsgStatisticsTable=cggsnSACsgStatisticsTable, cGgsnSAQsUnknownMsgs=cGgsnSAQsUnknownMsgs, cGgsnSACsgPathState=cGgsnSACsgPathState, cGgsnSATotalServiceStopMsgs=cGgsnSATotalServiceStopMsgs, cGgsnSAMIBConformance=cGgsnSAMIBConformance, cGgsnSATotalPostpaidConversions=cGgsnSATotalPostpaidConversions, cGgsnSACsgStatsServiceStopReqs=cGgsnSACsgStatsServiceStopReqs, cGgsnSAMIBComplianceRev1=cGgsnSAMIBComplianceRev1, cGgsnSAQsVersionUnSupportedMsgs=cGgsnSAQsVersionUnSupportedMsgs, cGgsnSAQuotaServerEntry=cGgsnSAQuotaServerEntry, cGgsnSATotalCsgFailures=cGgsnSATotalCsgFailures, cGgsnSANotifCsgName=cGgsnSANotifCsgName, cGgsnSAQsRcvdResponses=cGgsnSAQsRcvdResponses, cGgsnSAMIBObjects=cGgsnSAMIBObjects, cGgsnSACsgOutboundMsgs=cGgsnSACsgOutboundMsgs, cGgsnSAQsRcvdRequests=cGgsnSAQsRcvdRequests, cGgsnSADccaDestinationRealm=cGgsnSADccaDestinationRealm, cGgsnSAConfigurations=cGgsnSAConfigurations, cGgsnSACsgInboundMsgs=cGgsnSACsgInboundMsgs, cGgsnSAStatisticsGroup=cGgsnSAStatisticsGroup, cGgsnSAQsNoResponseToMsgs=cGgsnSAQsNoResponseToMsgs, cGgsnSAQsRcvdPathRequests=cGgsnSAQsRcvdPathRequests, cGgsnSAMIBComplianceRev2=cGgsnSAMIBComplianceRev2, cGgsnSAQsIEErrorMsgs=cGgsnSAQsIEErrorMsgs, cGgsnSAMIBNotificationPrefix=cGgsnSAMIBNotificationPrefix, cGgsnSAExtConfigurationsGroup=cGgsnSAExtConfigurationsGroup, cGgsnSANotifGroupR100=cGgsnSANotifGroupR100, cGgsnSACsgQuotaPushMsgs=cGgsnSACsgQuotaPushMsgs, cGgsnSAQuotaServerName=cGgsnSAQuotaServerName, cGgsnSADccaProfileEntry=cGgsnSADccaProfileEntry, cGgsnSAStatisticsGroupR100=cGgsnSAStatisticsGroupR100, cGgsnSACsgStateUpNotif=cGgsnSACsgStateUpNotif, cGgsnSACsgStatistics=cGgsnSACsgStatistics, cGgsnSANotifMgmt=cGgsnSANotifMgmt, cGgsnSAFinalConvertToPostpaidPdps=cGgsnSAFinalConvertToPostpaidPdps, cGgsnSACsgStatsQuotaPushRsps=cGgsnSACsgStatsQuotaPushRsps, cGgsnSATotalCsgEvents=cGgsnSATotalCsgEvents, cGgsnSAQsMandTlvMissingMsgs=cGgsnSAQsMandTlvMissingMsgs, cGgsnSACsgStatsQuotaPushMsgs=cGgsnSACsgStatsQuotaPushMsgs, cGgsnSAQsSentPathRequests=cGgsnSAQsSentPathRequests, cGgsnSACsgStatsGtpAcks=cGgsnSACsgStatsGtpAcks, cGgsnSACsgQuotaReturns=cGgsnSACsgQuotaReturns, cGgsnSADccaNotifEnabled=cGgsnSADccaNotifEnabled, cGgsnSADccaClci=cGgsnSADccaClci, cGgsnSAQuotaServerEchoInterval=cGgsnSAQuotaServerEchoInterval, cGgsnSANotifInfoGroupR100=cGgsnSANotifInfoGroupR100, cGgsnSADccaTriggerRatChange=cGgsnSADccaTriggerRatChange, cGgsnSAQuotaServerN3Requests=cGgsnSAQuotaServerN3Requests, cGgsnSAExtConfigurationsGroupSup1=cGgsnSAExtConfigurationsGroupSup1, cGgsnSANotifCsgVirtualAddress=cGgsnSANotifCsgVirtualAddress, cGgsnSATotalGgsnEvents=cGgsnSATotalGgsnEvents, PYSNMP_MODULE_ID=cGgsnSAMIB, cGgsnSACsgOutboundOctets=cGgsnSACsgOutboundOctets, cGgsnSACsgStatsQuotaReturnReqs=cGgsnSACsgStatsQuotaReturnReqs, cGgsnSACsgVirtualAddressType=cGgsnSACsgVirtualAddressType, cGgsnSATotalRatingChanges=cGgsnSATotalRatingChanges, cGgsnSATotalPostpaidUsers=cGgsnSATotalPostpaidUsers, cGgsnSACsgR100StateDownNotif=cGgsnSACsgR100StateDownNotif, cGgsnSATotalServiceReAuthMsgs=cGgsnSATotalServiceReAuthMsgs, cGgsnSADccaAuthorization=cGgsnSADccaAuthorization, cGgsnSADccaTriggerUserLocChange=cGgsnSADccaTriggerUserLocChange, cGgsnSACsgTable=cGgsnSACsgTable, cGgsnSARejDccaFailures=cGgsnSARejDccaFailures, cGgsnSATotalPrepaidUsers=cGgsnSATotalPrepaidUsers, cGgsnSACsgR100StateUpNotif=cGgsnSACsgR100StateUpNotif, cGgsnSACsgVirtualAddress=cGgsnSACsgVirtualAddress, cGgsnSACsgStatsServiceAuthReqs=cGgsnSACsgStatsServiceAuthReqs, cGgsnSATotalCreatedSyncObjs=cGgsnSATotalCreatedSyncObjs, cGgsnSAMIBGroups=cGgsnSAMIBGroups, cGgsnSADccaRowStatus=cGgsnSADccaRowStatus, cGgsnSACsgStatsServiceAuthResps=cGgsnSACsgStatsServiceAuthResps, cGgsnSAConfigurationsGroupR100=cGgsnSAConfigurationsGroupR100, cGgsnSACsgServiceStopReqs=cGgsnSACsgServiceStopReqs, cGgsnSADccaRatingFailed=cGgsnSADccaRatingFailed, cGgsnSACsgNotifEnabled=cGgsnSACsgNotifEnabled, cGgsnSACsgRowStatus=cGgsnSACsgRowStatus, cGgsnSATotalTerminateCategories=cGgsnSATotalTerminateCategories, cGgsnSADccaTxTimeout=cGgsnSADccaTxTimeout, cGgsnSACsgStatsServiceReAuthReqs=cGgsnSACsgStatsServiceReAuthReqs, cGgsnSAQuotaServerRowStatus=cGgsnSAQuotaServerRowStatus, cGgsnSACsgStatsOutboundMsgs=cGgsnSACsgStatsOutboundMsgs, cGgsnSAQuotaServerT3Response=cGgsnSAQuotaServerT3Response, cGgsnSACsgQuotaPushRsps=cGgsnSACsgQuotaPushRsps, cGgsnSANotifInfoGroup=cGgsnSANotifInfoGroup, cGgsnSANotifCsgPort=cGgsnSANotifCsgPort, cGgsnSACsgStatsOutboundOctets=cGgsnSACsgStatsOutboundOctets, cGgsnSACsgStatsQuotaReturnAccept=cGgsnSACsgStatsQuotaReturnAccept, cGgsnSARejCsgFailures=cGgsnSARejCsgFailures, cGgsnSANotifCsgRealAddress=cGgsnSANotifCsgRealAddress, cGgsnSATotalDeletedCategories=cGgsnSATotalDeletedCategories, cGgsnSACsgRealAddress1=cGgsnSACsgRealAddress1, cGgsnSADccaEndUsrServDeniedNotif=cGgsnSADccaEndUsrServDeniedNotif, cGgsnSAConfigurationsGroupSup1=cGgsnSAConfigurationsGroupSup1, cGgsnSATotalQuotaPushAcks=cGgsnSATotalQuotaPushAcks, cGgsnSANotifInfo=cGgsnSANotifInfo, cGgsnSACsgStateDownNotif=cGgsnSACsgStateDownNotif, cGgsnSAQuotaServerInterface=cGgsnSAQuotaServerInterface, cGgsnSAStatistics=cGgsnSAStatistics, cGgsnSAMIB=cGgsnSAMIB, cGgsnSADccaTriggerQosChange=cGgsnSADccaTriggerQosChange, cGgsnSACsgQuotaPushResps=cGgsnSACsgQuotaPushResps, cGgsnSACsgServiceAuthResps=cGgsnSACsgServiceAuthResps, cGgsnSATotalRAREvents=cGgsnSATotalRAREvents, cGgsnSACsgStatsQuotaReturns=cGgsnSACsgStatsQuotaReturns, cGgsnSATotalDummyQuotas=cGgsnSATotalDummyQuotas, cGgsnSADccaAuthRejectedNotif=cGgsnSADccaAuthRejectedNotif, cGgsnSACsgServiceReAuthReqs=cGgsnSACsgServiceReAuthReqs, cGgsnSAMIBComplianceRev3=cGgsnSAMIBComplianceRev3, cGgsnSANotifCsgVirtualAddrType=cGgsnSANotifCsgVirtualAddrType, cGgsnSACsgServiceAuthReqs=cGgsnSACsgServiceAuthReqs, cGgsnSAQsRcvdNegativeResponses=cGgsnSAQsRcvdNegativeResponses, cGgsnSACsgStatsServiceStopMsgs=cGgsnSACsgStatsServiceStopMsgs, cGgsnSAQuotaServerTable=cGgsnSAQuotaServerTable, cGgsnSAQsSentResponses=cGgsnSAQsSentResponses, cGgsnSACsgGroupName=cGgsnSACsgGroupName, cGgsnSATotalUnknownCategories=cGgsnSATotalUnknownCategories, cGgsnSANotifCsgRealAddressType=cGgsnSANotifCsgRealAddressType, cGgsnSADccaTriggerSgsnChange=cGgsnSADccaTriggerSgsnChange, cGgsnSACsgNumPdps=cGgsnSACsgNumPdps, cGgsnSATotalQuotaGranted=cGgsnSATotalQuotaGranted, cGgsnSANotifGroup=cGgsnSANotifGroup, cGgsnSACsgServiceStopMsgs=cGgsnSACsgServiceStopMsgs, cGgsnSAQsSentPathResponses=cGgsnSAQsSentPathResponses, cGgsnSATotalServiceAuthMsgs=cGgsnSATotalServiceAuthMsgs, cGgsnSATotalBlackListCategories=cGgsnSATotalBlackListCategories, cGgsnSACsgGtpAcks=cGgsnSACsgGtpAcks, cGgsnSAQuotaServerCsgGroup=cGgsnSAQuotaServerCsgGroup, cGgsnSATotalDeletePdps=cGgsnSATotalDeletePdps, cGgsnSADccaProfileName=cGgsnSADccaProfileName, cGgsnSACategoryFsmRtnErrors=cGgsnSACategoryFsmRtnErrors, cGgsnSAServiceAwareStatistics=cGgsnSAServiceAwareStatistics, cGgsnSATotalQuotaReturns=cGgsnSATotalQuotaReturns, cGgsnSADccaTriggerPlmnChange=cGgsnSADccaTriggerPlmnChange, cGgsnSACsgRealAddressType=cGgsnSACsgRealAddressType, cGgsnSANotifications=cGgsnSANotifications, cGgsnSATotalDccaFailures=cGgsnSATotalDccaFailures, cGgsnSACsgStatsInboundMsgs=cGgsnSACsgStatsInboundMsgs, cGgsnSAMIBCompliances=cGgsnSAMIBCompliances, cGgsnSAQuotaServerStatistics=cGgsnSAQuotaServerStatistics, cGgsnSANumServiceAwareApns=cGgsnSANumServiceAwareApns, cGgsnSACsgInboundOctets=cGgsnSACsgInboundOctets, cGgsnSAQsRcvdPathResponses=cGgsnSAQsRcvdPathResponses, cGgsnSATotalDccaEvents=cGgsnSATotalDccaEvents, cGgsnSAServiceAware=cGgsnSAServiceAware, cGgsnSADccaCreditLimReachedNotif=cGgsnSADccaCreditLimReachedNotif, cGgsnSANotifMgmtGroup=cGgsnSANotifMgmtGroup)
