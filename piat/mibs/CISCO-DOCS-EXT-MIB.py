...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DOCS-EXT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:46:14 2019
...
docsIfCmtsCmStatusIndex, docsIfCmtsCmStatusUpChannelIfIndex, docsIfCmtsCmStatusIpAddress, docsIfCmtsMacEntry, docsIfCmtsCmStatusEntry, docsIfCmtsCmStatusMacAddress, TenthdBmV, docsIfCmtsCmStatusDownChannelIfIndex, docsIfUpstreamChannelEntry, docsIfCmtsServiceEntry = mibBuilder.importSymbols("DOCS-IF-MIB", "docsIfCmtsCmStatusIndex", "docsIfCmtsCmStatusUpChannelIfIndex", "docsIfCmtsCmStatusIpAddress", "docsIfCmtsMacEntry", "docsIfCmtsCmStatusEntry", "docsIfCmtsCmStatusMacAddress", "TenthdBmV", "docsIfCmtsCmStatusDownChannelIfIndex", "docsIfUpstreamChannelEntry", "docsIfCmtsServiceEntry")
...
DisplayString, DateAndTime, MacAddress, TruthValue, TextualConvention, TimeInterval, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "MacAddress", "TruthValue", "TextualConvention", "TimeInterval", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("CISCO-DOCS-EXT-MIB", cdxBWQueueEntry=cdxBWQueueEntry, cdxIfUpChannelInputPowerLevel=cdxIfUpChannelInputPowerLevel, cdxCmtsCmCpeGroup=cdxCmtsCmCpeGroup, cdxDocsExtComplianceRev4=cdxDocsExtComplianceRev4, cdxIfCmtsCmStatusLastResetTime=cdxIfCmtsCmStatusLastResetTime, cdxCmtsCmOnOffTrapInterval=cdxCmtsCmOnOffTrapInterval, cdxCmtsCmChOverOpInitiatedTime=cdxCmtsCmChOverOpInitiatedTime, cdxCmCpeCmtsServiceId=cdxCmCpeCmtsServiceId, cdxWBResilNotificationsInterval=cdxWBResilNotificationsInterval, cdxWBResilRFChangeTriggerMoveSecondary=cdxWBResilRFChangeTriggerMoveSecondary, cdxWBResilUpdateTime=cdxWBResilUpdateTime, cdxUpInfoElemStatsNameCode=cdxUpInfoElemStatsNameCode, cdxCmtsUscbDynSfBe=cdxCmtsUscbDynSfBe, cdxCmtsCmCpeGroupRev1=cdxCmtsCmCpeGroupRev1, cdxCpeIpPrefixEntry=cdxCpeIpPrefixEntry, cdxCmtsCmChOverEntry=cdxCmtsCmChOverEntry, cdxCmtsCmCpeGroupRev6=cdxCmtsCmCpeGroupRev6, cdxWBResilCMPartialServiceNotif=cdxWBResilCMPartialServiceNotif, cdxDocsExtComplianceRev10=cdxDocsExtComplianceRev10, cdxQosCtrlUpAdmissionCtrl=cdxQosCtrlUpAdmissionCtrl, cdxCmToCpeTable=cdxCmToCpeTable, cdxCpeIpPrefixCpeMacAddress=cdxCpeIpPrefixCpeMacAddress, cdxCpeToCmCpeMacAddress=cdxCpeToCmCpeMacAddress, cdxBWQueueDepth=cdxBWQueueDepth, cdxCmtsCmChOverSerialNumber=cdxCmtsCmChOverSerialNumber, cdxBWQueueTable=cdxBWQueueTable, cdxBWQueueNameCode=cdxBWQueueNameCode, cdxCpeIpPrefixCmMacAddress=cdxCpeIpPrefixCmMacAddress, PYSNMP_MODULE_ID=ciscoDocsExtMIB, cdxIfCmtsCmStatusAvgOfflineTime=cdxIfCmtsCmStatusAvgOfflineTime, cdxCmtsMtcCmRegistered=cdxCmtsMtcCmRegistered, cdxCpeIpPrefixTable=cdxCpeIpPrefixTable, cdxPrimaryChannelIfIndex=cdxPrimaryChannelIfIndex, cdxCpeToCmStatusIndex=cdxCpeToCmStatusIndex, cdxIfUpChannelMaxUGSLastFiveMins=cdxIfUpChannelMaxUGSLastFiveMins, cdxDocsExtComplianceRev3=cdxDocsExtComplianceRev3, cdxCmtsMtcCmUnregistered=cdxCmtsMtcCmUnregistered, cdxWBResilRFUp=cdxWBResilRFUp, cdxCmtsUsBondingGrpId=cdxCmtsUsBondingGrpId, cdxCmtsMtcCmGroup=cdxCmtsMtcCmGroup, cdxDocsExtComplianceRev11=cdxDocsExtComplianceRev11, cdxCmCpeCmStatusIndex=cdxCmCpeCmStatusIndex, cdxIfUpChannelAvgUGSLastFiveMins=cdxIfUpChannelAvgUGSLastFiveMins, cdxCpeIpPrefixType=cdxCpeIpPrefixType, cdxCmtsUscbDynSfUgs=cdxCmtsUscbDynSfUgs, cdxIfUpChannelModulationProfile=cdxIfUpChannelModulationProfile, cdxBWQueueOrder=cdxBWQueueOrder, cdxCmToCpeCmMacAddress=cdxCmToCpeCmMacAddress, cdxIfUpChannelCmTotal=cdxIfUpChannelCmTotal, cdxQosCtrlGroup=cdxQosCtrlGroup, cdxIfCmtsServiceHCInPackets=cdxIfCmtsServiceHCInPackets, cdxCmCpeMacAddress=cdxCmCpeMacAddress, cdxCmtsUscbDescr=cdxCmtsUscbDescr, cdxCpeToCmInetAddressType=cdxCpeToCmInetAddressType, cdxCmtsCmDMICLockNotification=cdxCmtsCmDMICLockNotification, cdxDocsExtComplianceRev9=cdxDocsExtComplianceRev9, cdxQosCtrlUpMaxRsvdBWPercent=cdxQosCtrlUpMaxRsvdBWPercent, cdxCmtsUscbStaticSfRtps=cdxCmtsUscbStaticSfRtps, cdxCmtsCmRegistered=cdxCmtsCmRegistered, cdxIfCmtsCmStatusOnlineTimes=cdxIfCmtsCmStatusOnlineTimes, cdxCmtsCmDMICMode=cdxCmtsCmDMICMode, cdxIfCmtsCmStatusMaxOnlineTime=cdxIfCmtsCmStatusMaxOnlineTime, cdxCmtsCmCpeGroupRev8=cdxCmtsCmCpeGroupRev8, cdxIfCmtsCmStatusMinOnlineTime=cdxIfCmtsCmStatusMinOnlineTime, cdxCmtsCmStatusExtTable=cdxCmtsCmStatusExtTable, cdxIfCmtsCmStatusDynSidCount=cdxIfCmtsCmStatusDynSidCount, cdxCmtsCmEntry=cdxCmtsCmEntry, cdxWBResilRFChangeTriggerPercentage=cdxWBResilRFChangeTriggerPercentage, cdxNotifGroupExt=cdxNotifGroupExt, cdxWBResilObjects=cdxWBResilObjects, cdxCmCpeEntry=cdxCmCpeEntry, cdxCmtsCmChOverNotification=cdxCmtsCmChOverNotification, cdxCmCpeTable=cdxCmCpeTable, cdxRFtoPrimaryChannelMappingEntry=cdxRFtoPrimaryChannelMappingEntry, cdxCmtsCmCpeGroupRev3=cdxCmtsCmCpeGroupRev3, cdxCmtsServiceExtTable=cdxCmtsServiceExtTable, ciscoDocsExtNotifications=ciscoDocsExtNotifications, cdxSpecMgmtObjects=cdxSpecMgmtObjects, cdxCmtsMtcUpstreamBondGrp=cdxCmtsMtcUpstreamBondGrp, cdxIfUpChannelRangeSlots=cdxIfUpChannelRangeSlots, cdxCmtsUscbDynSfNrtps=cdxCmtsUscbDynSfNrtps, cdxWBResilRFDown=cdxWBResilRFDown, CdxUpstreamBondGrpList=CdxUpstreamBondGrpList, cdxWBResilEventTotalDupCount=cdxWBResilEventTotalDupCount, cdxIfCmtsServiceHCOutPackets=cdxIfCmtsServiceHCOutPackets, cdxCmtsCmTable=cdxCmtsCmTable, cdxCmtsUscbStaticSfUgs=cdxCmtsUscbStaticSfUgs, cdxCmtsCmQosProfile=cdxCmtsCmQosProfile, cdxSpecMgmtGroupRev3=cdxSpecMgmtGroupRev3, cdxCmToCpeInetAddressType=cdxCmToCpeInetAddressType, cdxQosCtrlUpAdmissionRejects=cdxQosCtrlUpAdmissionRejects, cdxCpeToCmEntry=cdxCpeToCmEntry, cdxCmtsUscbStaticSfUgsad=cdxCmtsUscbStaticSfUgsad, cdxCmtsMtcCmEntry=cdxCmtsMtcCmEntry, cdxCmtsCmCpeObjects=cdxCmtsCmCpeObjects, cdxQosIfRateLimitShpGranularity=cdxQosIfRateLimitShpGranularity, cdxCmtsMtcCmTotal=cdxCmtsMtcCmTotal, cdxCmCpeDeleteNow=cdxCmCpeDeleteNow, cdxCmtsCmStatusDMICEntry=cdxCmtsCmStatusDMICEntry, cdxQosCtrlUpTable=cdxQosCtrlUpTable, cdxCmtsCmStatusDMICTable=cdxCmtsCmStatusDMICTable, cdxCmtsUscbStaticSfNrtps=cdxCmtsUscbStaticSfNrtps, cdxUpInfoElemStatsIEType=cdxUpInfoElemStatsIEType, cdxIfCmtsServiceOutPackets=cdxIfCmtsServiceOutPackets, cdxCmtsCmOnOffTrapEnable=cdxCmtsCmOnOffTrapEnable, cdxQosCtrlUpReservedBW=cdxQosCtrlUpReservedBW, cdxIfUpChannelCmActive=cdxIfUpChannelCmActive, cdxCmtsUscbStaticSfBe=cdxCmtsUscbStaticSfBe, cdxCmtsMtcCmTable=cdxCmtsMtcCmTable, cdxCmtsUscbSflowGroup=cdxCmtsUscbSflowGroup, cdxCmtsCmCurrCpeNumber=cdxCmtsCmCurrCpeNumber, cdxWBResilRFChangeTriggerCount=cdxWBResilRFChangeTriggerCount, cdxPrimaryChanneltoRFMappingTable=cdxPrimaryChanneltoRFMappingTable, cdxCmtsCmDMICLockQos=cdxCmtsCmDMICLockQos, CdxResettableCounter32=CdxResettableCounter32, cdxBWQueueDiscards=cdxBWQueueDiscards, cdxCmtsCmChOverMacAddress=cdxCmtsCmChOverMacAddress, cdxCmtsCmChOverDownFrequency=cdxCmtsCmChOverDownFrequency, cdxCmtsCmChOverTrapOnCompletion=cdxCmtsCmChOverTrapOnCompletion, cdxCmtsCmStatusDMICMode=cdxCmtsCmStatusDMICMode, cdxNotifGroup=cdxNotifGroup, ciscoDocsExtNotificationsPrefix=ciscoDocsExtNotificationsPrefix, cdxDocsExtComplianceRev2=cdxDocsExtComplianceRev2, cdxWBResilGroup=cdxWBResilGroup, cdxPrimaryChanneltoRFMappingEntry=cdxPrimaryChanneltoRFMappingEntry, cdxIfCmtsCmStatusAvgOnlineTime=cdxIfCmtsCmStatusAvgOnlineTime, cdxDocsExtComplianceRev1=cdxDocsExtComplianceRev1, cdxSpecMgmtGroup=cdxSpecMgmtGroup, cdxCpeToCmInetAddress=cdxCpeToCmInetAddress, cdxIfUpstreamChannelExtTable=cdxIfUpstreamChannelExtTable, cdxCmtsCmCpeGroupRev5=cdxCmtsCmCpeGroupRev5, cdxDocsExtComplianceRev5=cdxDocsExtComplianceRev5, cdxQosMaxUpBWExcessRequests=cdxQosMaxUpBWExcessRequests, cdxCmtsServiceExtEntry=cdxCmtsServiceExtEntry, cdxQosIfRateLimitAlgm=cdxQosIfRateLimitAlgm, cdxIfUpChannelWidth=cdxIfUpChannelWidth, cdxQosQueueGroup=cdxQosQueueGroup, cdxCmtsCmCpeGroupRev2=cdxCmtsCmCpeGroupRev2, cdxCmtsMacExtTable=cdxCmtsMacExtTable, cdxQosIfRateLimitEntry=cdxQosIfRateLimitEntry, cdxIfUpChannelAvgUGSLastOneHour=cdxIfUpChannelAvgUGSLastOneHour, cdxCmtsCmCpeGroupRev7=cdxCmtsCmCpeGroupRev7, cdxDownstreamGroup=cdxDownstreamGroup, cdxCmtsMtcCmSfObjects=cdxCmtsMtcCmSfObjects, cdxIfCmtsServiceHCInOctets=cdxIfCmtsServiceHCInOctets, cdxIfCmtsCmStatusAddlInfo=cdxIfCmtsCmStatusAddlInfo, cdxCpeToCmTable=cdxCpeToCmTable, cdxIfUpChannelMinUGSLastFiveMins=cdxIfUpChannelMinUGSLastFiveMins, cdxWBResilEventTotalCount=cdxWBResilEventTotalCount, cdxCpeIpPrefixLen=cdxCpeIpPrefixLen, cdxQosQueueObjects=cdxQosQueueObjects, cdxNotifGroupRev1=cdxNotifGroupRev1, cdxCmtsCmChOverTimeExpiration=cdxCmtsCmChOverTimeExpiration, cdxCmtsCmCpeDeleteGroup=cdxCmtsCmCpeDeleteGroup, cdxIfCmtsServiceHCOutOctets=cdxIfCmtsServiceHCOutOctets, cdxCpeIpPrefixAddress=cdxCpeIpPrefixAddress, cdxQosCtrlObjects=cdxQosCtrlObjects, cdxCpeToCmMacAddress=cdxCpeToCmMacAddress, cdxCMtsMtcCmOperational=cdxCMtsMtcCmOperational, cdxIfUpChannelCmRegistered=cdxIfUpChannelCmRegistered, cdxCmtsMacExtEntry=cdxCmtsMacExtEntry, cdxDocsExtCompliances=cdxDocsExtCompliances, cdxCmCpeAccessGroup=cdxCmCpeAccessGroup, cdxCmtsCmChOverUpChannelId=cdxCmtsCmChOverUpChannelId, cdxDocsExtGroups=cdxDocsExtGroups, cdxQosCtrlUpMaxVirtualBW=cdxQosCtrlUpMaxVirtualBW, cdxQosCtrlGroupExt=cdxQosCtrlGroupExt, cdxCmtsUscbSflowEntry=cdxCmtsUscbSflowEntry, cdxCmtsUscbSfPri=cdxCmtsUscbSfPri, cdxCmtsMtcCmWideband=cdxCmtsMtcCmWideband, cdxCmtsCmOnOffNotification=cdxCmtsCmOnOffNotification, cdxIfUpChannelMinUGSLastOneHour=cdxIfUpChannelMinUGSLastOneHour, cdxCmtsCmDefaultMaxCpes=cdxCmtsCmDefaultMaxCpes, cdxWBResilEventType=cdxWBResilEventType, cdxRFtoPrimaryChannelMappingTable=cdxRFtoPrimaryChannelMappingTable, cdxCmCpeResetNow=cdxCmCpeResetNow, cdxCmToCpeInetAddress=cdxCmToCpeInetAddress, cdxIfCmtsCmStatusMinOfflineTime=cdxIfCmtsCmStatusMinOfflineTime, cdxCpeIpPrefixGroup=cdxCpeIpPrefixGroup, cdxPhysicalRFIfIndex=cdxPhysicalRFIfIndex, cdxCmCpeIfIndex=cdxCmCpeIfIndex, cdxCmtsCmTotal=cdxCmtsCmTotal, cdxCmtsCmStatusValue=cdxCmtsCmStatusValue, cdxUpInfoElemStatsEntry=cdxUpInfoElemStatsEntry, cdxIfUpChannelMaxUGSLastOneHour=cdxIfUpChannelMaxUGSLastOneHour, cdxWBResilCMFullServiceNotif=cdxWBResilCMFullServiceNotif, cdxWBResilRFChangeDampenTime=cdxWBResilRFChangeDampenTime, cdxWBResilEvent=cdxWBResilEvent, cdxDocsExtCompliance=cdxDocsExtCompliance, cdxWBResilNotificationEnable=cdxWBResilNotificationEnable, cdxCmCpeIpAddress=cdxCmCpeIpAddress, cdxCmtsCmStatusDMICUnLock=cdxCmtsCmStatusDMICUnLock, cdxCmtsMtcTcsId=cdxCmtsMtcTcsId, cdxBWQueueMaxDepth=cdxBWQueueMaxDepth, cdxQosCtrlGroupRev1=cdxQosCtrlGroupRev1, cdxCmtsMtcCmOffline=cdxCmtsMtcCmOffline, cdxCmtsUscbSflowTable=cdxCmtsUscbSflowTable, cdxDownstreamObjects=cdxDownstreamObjects, cdxCmtsCmStatusExtEntry=cdxCmtsCmStatusExtEntry, cdxWBResilEventLevel=cdxWBResilEventLevel, cdxQosIfRateLimitExpWt=cdxQosIfRateLimitExpWt, cdxIfCmtsCmStatusMaxOfflineTime=cdxIfCmtsCmStatusMaxOfflineTime, cdxIfCmtsCmStatusPercentOnline=cdxIfCmtsCmStatusPercentOnline, cdxUpInfoElemStatsTable=cdxUpInfoElemStatsTable, cdxCpeIpPrefixCpeType=cdxCpeIpPrefixCpeType, ciscoDocsExtConformance=ciscoDocsExtConformance, cdxIfUpChannelNumActiveUGS=cdxIfUpChannelNumActiveUGS, cdxCmtsCmCpeGroupRev4=cdxCmtsCmCpeGroupRev4, cdxCmtsCmChOverTable=cdxCmtsCmChOverTable, cdxCmtsUscbDynSfRtps=cdxCmtsUscbDynSfRtps, cdxDocsExtComplianceRev6=cdxDocsExtComplianceRev6, cdxQosCtrlUpEntry=cdxQosCtrlUpEntry, ciscoDocsExtMIBObjects=ciscoDocsExtMIBObjects, cdxIfUpChannelAvgContSlots=cdxIfUpChannelAvgContSlots, cdxQosIfRateLimitShpMaxDelay=cdxQosIfRateLimitShpMaxDelay, cdxCmtsCmChOverRowStatus=cdxCmtsCmChOverRowStatus, ciscoDocsExtMIB=ciscoDocsExtMIB, cdxBWQueueNumServedBeforeYield=cdxBWQueueNumServedBeforeYield, cdxCmToCpeEntry=cdxCmToCpeEntry, cdxCmtsUscbDynSfUgsad=cdxCmtsUscbDynSfUgsad, cdxIfUpstreamChannelExtEntry=cdxIfUpstreamChannelExtEntry, cdxCmtsCmChOverState=cdxCmtsCmChOverState, cdxCmtsUscbSfTotal=cdxCmtsUscbSfTotal, cdxBWQueueType=cdxBWQueueType, cdxDocsExtComplianceRev7=cdxDocsExtComplianceRev7, cdxSpecMgmtGroupRev1=cdxSpecMgmtGroupRev1, cdxQosIfRateLimitTable=cdxQosIfRateLimitTable, cdxDocsExtComplianceRev12=cdxDocsExtComplianceRev12, cdxQosCtrlGroupRev2=cdxQosCtrlGroupRev2, cdxCmCpeType=cdxCmCpeType, cdxSpecMgmtGroupRev2=cdxSpecMgmtGroupRev2, cdxDocsExtComplianceRev8=cdxDocsExtComplianceRev8, cdxIfCmtsCmStatusOnlineTimesNum=cdxIfCmtsCmStatusOnlineTimesNum, cdxCmtsCmMaxCpeNumber=cdxCmtsCmMaxCpeNumber, cdxCmtsCmActive=cdxCmtsCmActive, cdxIfUpChannelAvgUtil=cdxIfUpChannelAvgUtil, cdxIfCmtsServiceOutOctets=cdxIfCmtsServiceOutOctets, cdxQosMaxDownBWExcessPackets=cdxQosMaxDownBWExcessPackets)
