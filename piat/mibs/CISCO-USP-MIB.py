...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-USP-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:30:50 2019
...
Counter32, Unsigned32, Integer32, MibIdentifier, ModuleIdentity, Gauge32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, iso, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Integer32", "MibIdentifier", "ModuleIdentity", "Gauge32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "iso", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("CISCO-USP-MIB", cuspSystemUpTime=cuspSystemUpTime, cuspMaxDroppedCPSOneMin=cuspMaxDroppedCPSOneMin, cuspServerGroupEntry=cuspServerGroupEntry, ciscoUspMIBConform=ciscoUspMIBConform, ciscoUspMIBCompliances=ciscoUspMIBCompliances, cuspThresholdValues=cuspThresholdValues, cuspElementFailedCalls=cuspElementFailedCalls, cuspConfiguredMemory=cuspConfiguredMemory, cuspSystemStateAlertEnable=cuspSystemStateAlertEnable, cuspServerGroupAlert=cuspServerGroupAlert, cuspScalar=cuspScalar, cuspElementName=cuspElementName, cuspNoOfMessagesRecieved=cuspNoOfMessagesRecieved, cuspConnectionExceptionAlert=cuspConnectionExceptionAlert, cuspCallsDroppedExceedingLicense=cuspCallsDroppedExceedingLicense, cuspDroppedCallsOneSec=cuspDroppedCallsOneSec, cuspBackupProcessFailAlert=cuspBackupProcessFailAlert, cuspElementTable=cuspElementTable, cuspElementEntry=cuspElementEntry, cuspServerGroupTable=cuspServerGroupTable, cuspLicenseStateAlert=cuspLicenseStateAlert, cuspAvgCallsRoutedOneMin=cuspAvgCallsRoutedOneMin, cuspMessageStats=cuspMessageStats, cuspElementPort=cuspElementPort, cuspElementTransport=cuspElementTransport, cuspElementTotalCalls=cuspElementTotalCalls, cuspServerGroupAlertEnable=cuspServerGroupAlertEnable, cuspServerGroupNetwork=cuspServerGroupNetwork, cuspServerGroupElementAlertEnable=cuspServerGroupElementAlertEnable, ciscoUspMIBMainObjectGroup=ciscoUspMIBMainObjectGroup, cuspTable=cuspTable, cuspTotalCalls=cuspTotalCalls, cuspLastCounterResetTime=cuspLastCounterResetTime, cuspLicenseLimit=cuspLicenseLimit, cuspMemoryThresholdValue=cuspMemoryThresholdValue, cuspNotifDetail=cuspNotifDetail, cuspCPS=cuspCPS, cuspExtensiveLoggingAlert=cuspExtensiveLoggingAlert, cuspDiskSpaceUsed=cuspDiskSpaceUsed, cuspTotalFailedCalls=cuspTotalFailedCalls, ciscoUspMIB=ciscoUspMIB, cuspCallStats=cuspCallStats, cuspElementStatus=cuspElementStatus, cuspServerGroupStatus=cuspServerGroupStatus, cuspMaxCallsRoutedOneMin=cuspMaxCallsRoutedOneMin, cuspBackupProcessFailAlertEnable=cuspBackupProcessFailAlertEnable, cuspSmartAgentState=cuspSmartAgentState, cuspNotifControlInfo=cuspNotifControlInfo, cuspDiskSpaceThresholdValue=cuspDiskSpaceThresholdValue, cuspMemoryThresholdAlert=cuspMemoryThresholdAlert, ciscoUspMIBObjects=ciscoUspMIBObjects, cuspServerGroupPingStatus=cuspServerGroupPingStatus, cuspElementWeight=cuspElementWeight, cuspServerGroupLBType=cuspServerGroupLBType, cuspAvgDroppedCPSOneMin=cuspAvgDroppedCPSOneMin, ciscoUspMIBGroups=ciscoUspMIBGroups, cuspCallsRoutedOneSec=cuspCallsRoutedOneSec, cuspElementIndex=cuspElementIndex, cuspDiskSpaceThresholdAlertEnable=cuspDiskSpaceThresholdAlertEnable, cuspLicenseExceededAlert=cuspLicenseExceededAlert, cuspDiskSpaceThresholdAlert=cuspDiskSpaceThresholdAlert, ciscoUspMIBNotifyGroup=ciscoUspMIBNotifyGroup, cuspElementQValue=cuspElementQValue, cuspLicenseExceededAlertEnable=cuspLicenseExceededAlertEnable, cuspLicenseStateAlertEnable=cuspLicenseStateAlertEnable, cuspExtensiveLoggingAlertEnable=cuspExtensiveLoggingAlertEnable, cuspMemoryThresholdAlertEnable=cuspMemoryThresholdAlertEnable, cuspConnectionExceptionAlertEnable=cuspConnectionExceptionAlertEnable, cuspStrayMessageCount=cuspStrayMessageCount, cuspServerGroupIndex=cuspServerGroupIndex, ciscoUspMIBNotifs=ciscoUspMIBNotifs, cuspSystemStateAlert=cuspSystemStateAlert, cuspLicenseState=cuspLicenseState, PYSNMP_MODULE_ID=ciscoUspMIB, cuspMaxCPSOneMin=cuspMaxCPSOneMin, cuspServerGroupName=cuspServerGroupName, cuspSystemState=cuspSystemState, ciscoUspMIBModuleCompliance=ciscoUspMIBModuleCompliance, cuspAvgCPSOneMin=cuspAvgCPSOneMin, cuspServerGroupElementAlert=cuspServerGroupElementAlert, cuspNotifSeverity=cuspNotifSeverity, cuspMemoryUsed=cuspMemoryUsed)
