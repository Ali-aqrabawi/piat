...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-VOICE-APPS-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:44:10 2019
...
Integer32, Counter64, ModuleIdentity, ObjectIdentity, TimeTicks, IpAddress, Unsigned32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "IpAddress", "Unsigned32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("CISCO-VOICE-APPS-MIB", cvaWorkflowInstallScriptName=cvaWorkflowInstallScriptName, cvaModuleRunTimeFailure=cvaModuleRunTimeFailure, cvaModuleFailureInfo=cvaModuleFailureInfo, cvaProcessStop=cvaProcessStop, ciscoVoiceAppsMIBObjects=ciscoVoiceAppsMIBObjects, cvaNotificationInfoGroup=cvaNotificationInfoGroup, ciscoVoiceAppsMIBConformance=ciscoVoiceAppsMIBConformance, cvaNotificationGroup=cvaNotificationGroup, cvaWorkflowInstallName=cvaWorkflowInstallName, cvaWorkflowInstallTable=cvaWorkflowInstallTable, cvaProcessStart=cvaProcessStart, ciscoVoiceAppsMIBCompliances=ciscoVoiceAppsMIBCompliances, PYSNMP_MODULE_ID=ciscoVoiceAppsMIB, cvaModuleInfoGroup=cvaModuleInfoGroup, cvaModuleFailureMessage=cvaModuleFailureMessage, cvaModuleFailureCause=cvaModuleFailureCause, ciscoVoiceAppsMIB=ciscoVoiceAppsMIB, ciscoVoiceAppsMIBGroups=ciscoVoiceAppsMIBGroups, ciscoVoiceAppsMIBCompliance=ciscoVoiceAppsMIBCompliance, ciscoVoiceAppsMIBNotificationPrefix=ciscoVoiceAppsMIBNotificationPrefix, cvaNotificationEnable=cvaNotificationEnable, cvaModuleStart=cvaModuleStart, cvaWorkflowInstallIndex=cvaWorkflowInstallIndex, cvaModuleName=cvaModuleName, cvaAlarmSeverity=cvaAlarmSeverity, ciscoVoiceAppsMIBNotifications=ciscoVoiceAppsMIBNotifications, cvaModuleStop=cvaModuleStop, cvaProcessId=cvaProcessId, cvaGeneralInfo=cvaGeneralInfo, cvaWorkflowInstallLocator=cvaWorkflowInstallLocator, cvaModuleRunTimeFailureCause=cvaModuleRunTimeFailureCause, cvaWorkflowInstallEnable=cvaWorkflowInstallEnable, cvaModuleFailureName=cvaModuleFailureName, cvaWorkflowInstallEntry=cvaWorkflowInstallEntry)
