...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-OSPF-MIB
...
ospfVirtIfEntry, Metric, ospfLsdbRouterId, ospfIfEntry, RouterID, HelloRange, ospfLsdbAreaId, AreaID, PositiveInteger, ospfLsdbLsid, UpToMaxAge, ospfAreaEntry = mibBuilder.importSymbols("OSPF-MIB", "ospfVirtIfEntry", "Metric", "ospfLsdbRouterId", "ospfIfEntry", "RouterID", "HelloRange", "ospfLsdbAreaId", "AreaID", "PositiveInteger", "ospfLsdbLsid", "UpToMaxAge", "ospfAreaEntry")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Integer32, ModuleIdentity, Bits, NotificationType, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, iso, TimeTicks, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "iso", "TimeTicks", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("CISCO-OSPF-MIB", cospfShamLinkEntry=cospfShamLinkEntry, cospfVirtLocalLsdbNeighbor=cospfVirtLocalLsdbNeighbor, cospfGroups=cospfGroups, cospfVirtLocalLsdbAge=cospfVirtLocalLsdbAge, cospfAreaTable=cospfAreaTable, cospfShamLinkNbrOptions=cospfShamLinkNbrOptions, cospfLocalLsdbLsid=cospfLocalLsdbLsid, cospfVirtIfLsaCksumSum=cospfVirtIfLsaCksumSum, cospfShamLinksAreaId=cospfShamLinksAreaId, cospfShamLinkNbrLsRetransQLen=cospfShamLinkNbrLsRetransQLen, cospfLsdbEntry=cospfLsdbEntry, cospfVirtLocalLsdbChecksum=cospfVirtLocalLsdbChecksum, cospfLsdbAdvertisement=cospfLsdbAdvertisement, cospfLsdbSequence=cospfLsdbSequence, cospfAreaNssaTranslatorState=cospfAreaNssaTranslatorState, cospfShamLinkNbrEntry=cospfShamLinkNbrEntry, cospfVirtLocalLsdbEntry=cospfVirtLocalLsdbEntry, cospfIfEntry=cospfIfEntry, cospfOpaqueLsaSupport=cospfOpaqueLsaSupport, cospfTrafficEngineeringSupport=cospfTrafficEngineeringSupport, cospfLocalLsdbEntry=cospfLocalLsdbEntry, cospfShamLinksGroup=cospfShamLinksGroup, cospf=cospf, cospfOpaqueASLsaCount=cospfOpaqueASLsaCount, cospfLsdbType=cospfLsdbType, cospfLsdbAge=cospfLsdbAge, cospfShamLinksEvents=cospfShamLinksEvents, cospfVirtLocalLsdbRouterId=cospfVirtLocalLsdbRouterId, cospfCompliance=cospfCompliance, cospfShamLinkNbrGroup=cospfShamLinkNbrGroup, cospfLocalLsdbSequence=cospfLocalLsdbSequence, cospfOpaqueASLsaCksumSum=cospfOpaqueASLsaCksumSum, cospfShamLinkHelloInterval=cospfShamLinkHelloInterval, cospfShamLinkNbrRtrId=cospfShamLinkNbrRtrId, cospfShamLinksRtrDeadInterval=cospfShamLinksRtrDeadInterval, cospfShamLinkNbrIpAddrType=cospfShamLinkNbrIpAddrType, cospfVirtIfGroup=cospfVirtIfGroup, cospfComplianceRev1=cospfComplianceRev1, cospfLocalLsdbTable=cospfLocalLsdbTable, cospfShamLinksLocalIpAddrType=cospfShamLinksLocalIpAddrType, cospfShamLinksState=cospfShamLinksState, cospfVirtLocalLsdbSequence=cospfVirtLocalLsdbSequence, cospfLocalLsdbAdvertisement=cospfLocalLsdbAdvertisement, cospfAreaNssaTranslatorEvents=cospfAreaNssaTranslatorEvents, cospfConformance=cospfConformance, cospfShamLinkNbrIpAddr=cospfShamLinkNbrIpAddr, cospfShamLinkMetric=cospfShamLinkMetric, cospfShamLinkGroup=cospfShamLinkGroup, cospfLocalLsdbType=cospfLocalLsdbType, cospfShamLinkNbrState=cospfShamLinkNbrState, cospfShamLinksHelloInterval=cospfShamLinksHelloInterval, cospfShamLinkRetransInterval=cospfShamLinkRetransInterval, cospfLocalLsdbChecksum=cospfLocalLsdbChecksum, cospfLocalLsdbIpAddress=cospfLocalLsdbIpAddress, cospfLsdbChecksum=cospfLsdbChecksum, cospfShamLinksRemoteIpAddr=cospfShamLinksRemoteIpAddr, cospfVirtLocalLsdbGroup=cospfVirtLocalLsdbGroup, cospfShamLinkNbrTable=cospfShamLinkNbrTable, cospfCompliances=cospfCompliances, cospfShamLinkTable=cospfShamLinkTable, cospfBasicGroup=cospfBasicGroup, cospfVirtIfEntry=cospfVirtIfEntry, cospfLocalLsdbRouterId=cospfLocalLsdbRouterId, cospfLocalLsdbGroup=cospfLocalLsdbGroup, cospfIfLsaCount=cospfIfLsaCount, cospfLsdbGroup=cospfLsdbGroup, cospfAreaGroup=cospfAreaGroup, cospfShamLinksRetransInterval=cospfShamLinksRetransInterval, cospfRFC1583Compatibility=cospfRFC1583Compatibility, cospfShamLinkRtrDeadInterval=cospfShamLinkRtrDeadInterval, cospfLsdbTable=cospfLsdbTable, cospfIfGroup=cospfIfGroup, cospfIfLsaCksumSum=cospfIfLsaCksumSum, cospfOpaqueAreaLsaCksumSum=cospfOpaqueAreaLsaCksumSum, cospfOpaqueAreaLsaCount=cospfOpaqueAreaLsaCount, cospfVirtLocalLsdbTransitArea=cospfVirtLocalLsdbTransitArea, cospfShamLinkNbrArea=cospfShamLinkNbrArea, cospfGeneralGroup=cospfGeneralGroup, cospfVirtLocalLsdbTable=cospfVirtLocalLsdbTable, cospfShamLinkEvents=cospfShamLinkEvents, cospfVirtLocalLsdbAdvertisement=cospfVirtLocalLsdbAdvertisement, cospfVirtIfLsaCount=cospfVirtIfLsaCount, cospfShamLinksTable=cospfShamLinksTable, cospfVirtIfTable=cospfVirtIfTable, PYSNMP_MODULE_ID=cospf, cospfShamLinkAreaId=cospfShamLinkAreaId, cospfShamLinksMetric=cospfShamLinksMetric, cospfAreaNssaTranslatorRole=cospfAreaNssaTranslatorRole, cospfShamLinkNbrHelloSuppressed=cospfShamLinkNbrHelloSuppressed, cospfAreaEntry=cospfAreaEntry, cospfShamLinkState=cospfShamLinkState, cospfShamLinkLocalIpAddress=cospfShamLinkLocalIpAddress, cospfLocalLsdbAge=cospfLocalLsdbAge, cospfShamLinksLocalIpAddr=cospfShamLinksLocalIpAddr, cospfLocalLsdbAddressLessIf=cospfLocalLsdbAddressLessIf, cospfVirtLocalLsdbType=cospfVirtLocalLsdbType, cospfIfTable=cospfIfTable, cospfShamLinksEntry=cospfShamLinksEntry, cospfShamLinkNeighborId=cospfShamLinkNeighborId, cospfVirtLocalLsdbLsid=cospfVirtLocalLsdbLsid, cospfShamLinksRemoteIpAddrType=cospfShamLinksRemoteIpAddrType, cospfShamLinkNbrEvents=cospfShamLinkNbrEvents)
