...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/DOCS-IF3-MIB
...
DocsisUpstreamType, DocsisQosVersion, DocsEqualizerData, TenthdBmV, TenthdB = mibBuilder.importSymbols("DOCS-IF-MIB", "DocsisUpstreamType", "DocsisQosVersion", "DocsEqualizerData", "TenthdBmV", "TenthdB")
...
Bits, TimeTicks, Unsigned32, MibIdentifier, Counter64, ObjectIdentity, NotificationType, Integer32, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "Counter64", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Counter32")
DisplayString, DateAndTime, RowStatus, StorageType, MacAddress, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "RowStatus", "StorageType", "MacAddress", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-IF3-MIB", docsIf3MdChCfgRowStatus=docsIf3MdChCfgRowStatus, docsIf3RxChCfgRcId=docsIf3RxChCfgRcId, docsIf3RxChStatusEntry=docsIf3RxChStatusEntry, docsIf3CmtsCmCtrlCmdMacAddr=docsIf3CmtsCmCtrlCmdMacAddr, docsIf3CmEventCtrlEntry=docsIf3CmEventCtrlEntry, docsIf3CmEventNotif=docsIf3CmEventNotif, docsIf3RxModuleCfgFirstCenterFrequency=docsIf3RxModuleCfgFirstCenterFrequency, docsIf3RxChCfgRowStatus=docsIf3RxChCfgRowStatus, docsIf3RxModuleStatusEntry=docsIf3RxModuleStatusEntry, CmtsCmRegState=CmtsCmRegState, docsIf3CmtsCmUsStatusCorrecteds=docsIf3CmtsCmUsStatusCorrecteds, docsIf3RxChStatusRcRmConnectivityId=docsIf3RxChStatusRcRmConnectivityId, docsIf3MdNodeStatusMdCmSgId=docsIf3MdNodeStatusMdCmSgId, docsIf3MdCfgTable=docsIf3MdCfgTable, docsIf3MdDsSgStatusEntry=docsIf3MdDsSgStatusEntry, docsIf3MdCfgMultRxChModeEnabled=docsIf3MdCfgMultRxChModeEnabled, docsIf3MdChCfgEntry=docsIf3MdChCfgEntry, docsIf3CmtsCmRegStatusRcpId=docsIf3CmtsCmRegStatusRcpId, docsIf3CmStatusUsTxPower=docsIf3CmStatusUsTxPower, docsIf3CmStatusUsT3Timeouts=docsIf3CmStatusUsT3Timeouts, docsIf3RxChCfgRcRmConnectivityId=docsIf3RxChCfgRcRmConnectivityId, docsIf3RxModuleStatusTable=docsIf3RxModuleStatusTable, docsIf3CmtsEventCtrlStatus=docsIf3CmtsEventCtrlStatus, docsIf3MdUsToDsChMappingDsIfIndex=docsIf3MdUsToDsChMappingDsIfIndex, docsIf3Mib=docsIf3Mib, docsIf3CmtsCmRegStatusEnergyMgtOperStatus=docsIf3CmtsCmRegStatusEnergyMgtOperStatus, docsIf3MdUsToDsChMappingMdIfIndex=docsIf3MdUsToDsChMappingMdIfIndex, docsIf3CmStatusTable=docsIf3CmStatusTable, docsIf3CmSpectrumAnalysisCtrlCmdWindowFunction=docsIf3CmSpectrumAnalysisCtrlCmdWindowFunction, docsIf3CmEm1x1StatsNumberTimesCrossedBelowDsEntryThrshlds=docsIf3CmEm1x1StatsNumberTimesCrossedBelowDsEntryThrshlds, docsIf3CmStatusEntry=docsIf3CmStatusEntry, docsIf3CmtsSpectrumAnalysisMeasTable=docsIf3CmtsSpectrumAnalysisMeasTable, docsIf3CmDpvStatsGrpId=docsIf3CmDpvStatsGrpId, docsIf3DsChSetTable=docsIf3DsChSetTable, docsIf3CmEnergyMgt1x1CfgExitBitrateThrshld=docsIf3CmEnergyMgt1x1CfgExitBitrateThrshld, docsIf3CmtsCmEmStatsTable=docsIf3CmtsCmEmStatsTable, docsIf3CmtsCmCtrlCmdMuteUsChId=docsIf3CmtsCmCtrlCmdMuteUsChId, docsIf3CmtsCmRegStatusTcsId=docsIf3CmtsCmRegStatusTcsId, docsIf3CmSpectrumAnalysisCtrlCmdSegmentFrequencySpan=docsIf3CmSpectrumAnalysisCtrlCmdSegmentFrequencySpan, docsIf3CmtsCmRegStatusRcsId=docsIf3CmtsCmRegStatusRcsId, docsIf3CmtsCmUsStatusUnerroreds=docsIf3CmtsCmUsStatusUnerroreds, docsIf3CmEventCtrlStatus=docsIf3CmEventCtrlStatus, docsIf3CmStatusUsT4Timeouts=docsIf3CmStatusUsT4Timeouts, docsIf3CmSpectrumAnalysisCtrlCmdFirstSegmentCenterFrequency=docsIf3CmSpectrumAnalysisCtrlCmdFirstSegmentCenterFrequency, docsIf3MdCfgMcastDsidFwdEnabled=docsIf3MdCfgMcastDsidFwdEnabled, docsIf3RxChStatusTable=docsIf3RxChStatusTable, docsIf3CmtsEventCtrlTable=docsIf3CmtsEventCtrlTable, docsIf3CmMdCfgEntry=docsIf3CmMdCfgEntry, docsIf3RxChCfgTable=docsIf3RxChCfgTable, docsIf3CmCapabilitiesReq=docsIf3CmCapabilitiesReq, docsIf3SignalQualityExtRxMerSamples=docsIf3SignalQualityExtRxMerSamples, docsIf3CmtsCmCtrlCmdDisableForwarding=docsIf3CmtsCmCtrlCmdDisableForwarding, docsIf3DsBondingGrpStatusEntry=docsIf3DsBondingGrpStatusEntry, docsIf3CmtsEventCtrlEventId=docsIf3CmtsEventCtrlEventId, docsIf3CmtsGroup=docsIf3CmtsGroup, docsIf3CmStatusInvalidRegRsps=docsIf3CmStatusInvalidRegRsps, docsIf3CmtsCmRegStatusValue=docsIf3CmtsCmRegStatusValue, docsIf3CmtsEventNotif=docsIf3CmtsEventNotif, docsIf3RxModuleCfgRmRmConnectivityId=docsIf3RxModuleCfgRmRmConnectivityId, docsIf3RccCfgRowStatus=docsIf3RccCfgRowStatus, docsIf3CmSpectrumAnalysisCtrlCmdEquivalentNoiseBandwidth=docsIf3CmSpectrumAnalysisCtrlCmdEquivalentNoiseBandwidth, RangingState=RangingState, docsIf3RccStatusRccStatusId=docsIf3RccStatusRccStatusId, docsIf3MdNodeStatusMdUsSgId=docsIf3MdNodeStatusMdUsSgId, docsIf3CmSpectrumAnalysisCtrlCmd=docsIf3CmSpectrumAnalysisCtrlCmd, docsIf3CmStatusUsTable=docsIf3CmStatusUsTable, docsIf3RxModuleStatusRmRmConnectivityId=docsIf3RxModuleStatusRmRmConnectivityId, docsIf3SignalQualityExtTable=docsIf3SignalQualityExtTable, ChId=ChId, AttrAggrRuleMask=AttrAggrRuleMask, docsIf3UsChSetId=docsIf3UsChSetId, docsIf3CmtsSignalQualityExtExpectedRxSignalPower=docsIf3CmtsSignalQualityExtExpectedRxSignalPower, docsIf3CmMdCfgIpProvModeStorageType=docsIf3CmMdCfgIpProvModeStorageType, docsIf3RxChStatusChIfIndex=docsIf3RxChStatusChIfIndex, docsIf3CmtsCmRegStatusMdCmSgId=docsIf3CmtsCmRegStatusMdCmSgId, docsIf3RxChStatusPrimaryDsIndicator=docsIf3RxChStatusPrimaryDsIndicator, docsIf3RxModuleCfgTable=docsIf3RxModuleCfgTable, docsIf3MibObjects=docsIf3MibObjects, docsIf3RccCfgRcpId=docsIf3RccCfgRcpId, docsIf3CmStatusT2Timeouts=docsIf3CmStatusT2Timeouts, docsIf3MdCfgEntry=docsIf3MdCfgEntry, docsIf3CmtsSpectrumAnalysisMeasTimeInterval=docsIf3CmtsSpectrumAnalysisMeasTimeInterval, docsIf3CmEnergyMgt1x1CfgEntryBitrateThrshld=docsIf3CmEnergyMgt1x1CfgEntryBitrateThrshld, docsIf3CmSpectrumAnalysisCtrlCmdEnable=docsIf3CmSpectrumAnalysisCtrlCmdEnable, docsIf3UsBondingGrpStatusEntry=docsIf3UsBondingGrpStatusEntry, docsIf3MdCfgSendUdcRulesEnabled=docsIf3MdCfgSendUdcRulesEnabled, docsIf3MdCfgBpi2EnforceCtrl=docsIf3MdCfgBpi2EnforceCtrl, ChSetId=ChSetId, docsIf3RxModuleCfgRowStatus=docsIf3RxModuleCfgRowStatus, docsIf3RxChCfgEntry=docsIf3RxChCfgEntry, docsIf3MdDsSgStatusMdDsSgId=docsIf3MdDsSgStatusMdDsSgId, docsIf3CmtsCmRegStatusTable=docsIf3CmtsCmRegStatusTable, docsIf3CmtsCmUsStatusSignalNoise=docsIf3CmtsCmUsStatusSignalNoise, docsIf3CmtsCmUsStatusEqData=docsIf3CmtsCmUsStatusEqData, docsIf3CmtsCmUsStatusIsMuted=docsIf3CmtsCmUsStatusIsMuted, docsIf3CmtsCmUsStatusChIfIndex=docsIf3CmtsCmUsStatusChIfIndex, docsIf3CmtsCmRegStatusLastRegTime=docsIf3CmtsCmRegStatusLastRegTime, docsIf3MdChCfgChIfIndex=docsIf3MdChCfgChIfIndex, docsIf3UsChSetChList=docsIf3UsChSetChList, docsIf3CmSpectrumAnalysisCtrlCmdLastSegmentCenterFrequency=docsIf3CmSpectrumAnalysisCtrlCmdLastSegmentCenterFrequency, docsIf3UsBondingGrpStatusChSetId=docsIf3UsBondingGrpStatusChSetId, docsIf3CmStatusEnergyMgt1x1OperStatus=docsIf3CmStatusEnergyMgt1x1OperStatus, docsIf3CmtsSignalQualityExtCNIR=docsIf3CmtsSignalQualityExtCNIR, docsIf3CmSpectrumAnalysisCtrlCmdNumberOfAverages=docsIf3CmSpectrumAnalysisCtrlCmdNumberOfAverages, docsIf3CmEm1x1StatsNumberTimesCrossedBelowUsEntryThrshlds=docsIf3CmEm1x1StatsNumberTimesCrossedBelowUsEntryThrshlds, docsIf3MdUsToDsChMappingTable=docsIf3MdUsToDsChMappingTable, docsIf3MibGroups=docsIf3MibGroups, docsIf3MdUsSgStatusChSetId=docsIf3MdUsSgStatusChSetId, docsIf3CmtsCmRegStatusIPv6LinkLocal=docsIf3CmtsCmRegStatusIPv6LinkLocal, docsIf3CmtsCmRegStatusRccStatusId=docsIf3CmtsCmRegStatusRccStatusId, ScdmaSelectionString=ScdmaSelectionString, docsIf3CmMdCfgIpProvMode=docsIf3CmMdCfgIpProvMode, docsIf3DsChSetChList=docsIf3DsChSetChList, docsIf3BondingGrpCfgDsidReseqWaitTime=docsIf3BondingGrpCfgDsidReseqWaitTime, docsIf3MdCfgEarlyAuthEncrCtrl=docsIf3MdCfgEarlyAuthEncrCtrl, docsIf3MdCfgCmStatusEvCtlEnabled=docsIf3MdCfgCmStatusEvCtlEnabled, docsIf3CmEnergyMgtCfgCyclePeriod=docsIf3CmEnergyMgtCfgCyclePeriod, Tlv8=Tlv8, docsIf3CmStatusUsModulationType=docsIf3CmStatusUsModulationType, docsIf3MdChCfgSfProvAttrMask=docsIf3MdChCfgSfProvAttrMask, docsIf3RccStatusTable=docsIf3RccStatusTable, docsIf3DsBondingGrpStatusCfgId=docsIf3DsBondingGrpStatusCfgId, docsIf3CmEventCtrlTable=docsIf3CmEventCtrlTable, docsIf3BondingGrpCfgEntry=docsIf3BondingGrpCfgEntry, docsIf3CmtsCmRegStatusQosVersion=docsIf3CmtsCmRegStatusQosVersion, docsIf3RccCfgRccCfgId=docsIf3RccCfgRccCfgId, docsIf3MdNodeStatusMdDsSgId=docsIf3MdNodeStatusMdDsSgId, docsIf3CmEventCtrlEventId=docsIf3CmEventCtrlEventId, docsIf3CmStatusUsT3Exceededs=docsIf3CmStatusUsT3Exceededs, docsIf3MdCfgIpProvMode=docsIf3MdCfgIpProvMode, docsIf3UsBondingGrpStatusMdUsSgId=docsIf3UsBondingGrpStatusMdUsSgId, docsIf3CmDpvStatsLastClearTime=docsIf3CmDpvStatsLastClearTime, docsIf3CmMdCfgTable=docsIf3CmMdCfgTable, docsIf3DsBondingGrpStatusChSetId=docsIf3DsBondingGrpStatusChSetId, docsIf3MdNodeStatusTable=docsIf3MdNodeStatusTable, CmRegState=CmRegState, docsIf3UsBondingGrpStatusCfgId=docsIf3UsBondingGrpStatusCfgId, docsIf3CmStatusUCCsSuccesses=docsIf3CmStatusUCCsSuccesses, docsIf3CmtsSpectrumAnalysisMeasEntry=docsIf3CmtsSpectrumAnalysisMeasEntry, docsIf3CmEm1x1StatsTable=docsIf3CmEm1x1StatsTable, docsIf3CmtsCmUsStatusRangingStatus=docsIf3CmtsCmUsStatusRangingStatus, docsIf3CmSpectrumAnalysisMeasAmplitudeData=docsIf3CmSpectrumAnalysisMeasAmplitudeData, docsIf3BondingGrpCfgRowStatus=docsIf3BondingGrpCfgRowStatus, docsIf3CmtsCmUsStatusModulationType=docsIf3CmtsCmUsStatusModulationType, docsIf3CmMdCfgIpProvModeResetOnChangeHoldOffTimer=docsIf3CmMdCfgIpProvModeResetOnChangeHoldOffTimer, docsIf3MdCfgMddInterval=docsIf3MdCfgMddInterval, docsIf3CmtsSignalQualityExtEntry=docsIf3CmtsSignalQualityExtEntry, docsIf3RccCfgTable=docsIf3RccCfgTable, PYSNMP_MODULE_ID=docsIf3Mib, AttributeMask=AttributeMask, docsIf3RxChCfgChIfIndex=docsIf3RxChCfgChIfIndex, docsIf3Notifications=docsIf3Notifications, docsIf3BondingGrpCfgDir=docsIf3BondingGrpCfgDir, docsIf3SignalQualityExtRxMER=docsIf3SignalQualityExtRxMER, docsIf3BondingGrpCfgSfProvAttrMask=docsIf3BondingGrpCfgSfProvAttrMask, docsIf3CmtsCmEmStatsEntry=docsIf3CmtsCmEmStatsEntry, docsIf3CmEm1x1StatsTotalDurationBelowUsThrshlds=docsIf3CmEm1x1StatsTotalDurationBelowUsThrshlds, docsIf3CmStatusUsRangingAborteds=docsIf3CmStatusUsRangingAborteds, docsIf3CmStatusUsIsMuted=docsIf3CmStatusUsIsMuted, docsIf3RxModuleCfgRmId=docsIf3RxModuleCfgRmId, docsIf3UsChExtScdmaSelectionStringActiveCodes=docsIf3UsChExtScdmaSelectionStringActiveCodes, docsIf3BondingGrpCfgDsidReseqWarnThrshld=docsIf3BondingGrpCfgDsidReseqWarnThrshld, docsIf3DsBondingGrpStatusTable=docsIf3DsBondingGrpStatusTable, docsIf3CmCapabilitiesRsp=docsIf3CmCapabilitiesRsp, docsIf3MdDsSgStatusChSetId=docsIf3MdDsSgStatusChSetId, docsIf3CmtsNotificationGroup=docsIf3CmtsNotificationGroup, docsIf3CmEnergyMgt1x1CfgDirection=docsIf3CmEnergyMgt1x1CfgDirection, docsIf3MdCfgServiceTypeIdList=docsIf3MdCfgServiceTypeIdList, docsIf3CmDpvStatsAvgLatency=docsIf3CmDpvStatsAvgLatency, docsIf3UsChExtSacCodeHoppingSelectionMode=docsIf3UsChExtSacCodeHoppingSelectionMode, docsIf3RxChStatusRcId=docsIf3RxChStatusRcId, docsIf3RccCfgVendorSpecific=docsIf3RccCfgVendorSpecific, docsIf3CmtsCmRegStatusIPv6Addr=docsIf3CmtsCmRegStatusIPv6Addr, docsIf3CmDpvStatsTable=docsIf3CmDpvStatsTable, docsIf3CmSpectrumAnalysisMeasTotalSegmentPower=docsIf3CmSpectrumAnalysisMeasTotalSegmentPower, docsIf3MibConformance=docsIf3MibConformance, docsIf3CmStatusValue=docsIf3CmStatusValue, docsIf3CmtsCmUsStatusHighResolutionTimingOffset=docsIf3CmtsCmUsStatusHighResolutionTimingOffset, docsIf3RccStatusRcpId=docsIf3RccStatusRcpId, docsIf3BondingGrpCfgTable=docsIf3BondingGrpCfgTable, docsIf3MdChCfgIsPriCapableDs=docsIf3MdChCfgIsPriCapableDs, IfDirection=IfDirection, docsIf3CmSpectrumAnalysisMeasFrequency=docsIf3CmSpectrumAnalysisMeasFrequency, docsIf3CmtsCmCtrl=docsIf3CmtsCmCtrl, docsIf3CmEm1x1StatsEntry=docsIf3CmEm1x1StatsEntry, docsIf3CmtsCmRegStatusMdIfIndex=docsIf3CmtsCmRegStatusMdIfIndex, docsIf3CmEnergyMgt1x1CfgExitTimeThrshld=docsIf3CmEnergyMgt1x1CfgExitTimeThrshld, docsIf3UsChExtTable=docsIf3UsChExtTable, docsIf3CmtsCmRegStatusId=docsIf3CmtsCmRegStatusId, docsIf3CmtsSpectrumAnalysisMeasRowStatus=docsIf3CmtsSpectrumAnalysisMeasRowStatus, docsIf3MdCfgEnergyMgt1x1Enabled=docsIf3MdCfgEnergyMgt1x1Enabled, docsIf3RccStatusValidityCodeText=docsIf3RccStatusValidityCodeText, docsIf3CmEnergyMgt1x1CfgTable=docsIf3CmEnergyMgt1x1CfgTable, ChannelList=ChannelList, docsIf3CmEnergyMgtCfgFeatureEnabled=docsIf3CmEnergyMgtCfgFeatureEnabled, docsIf3CmStatusInvalidMaps=docsIf3CmStatusInvalidMaps, docsIf3CmEm1x1StatsTotalDuration=docsIf3CmEm1x1StatsTotalDuration, docsIf3CmEnergyMgt1x1CfgEntryTimeThrshld=docsIf3CmEnergyMgt1x1CfgEntryTimeThrshld, Dsid=Dsid, docsIf3CmStatusUCCFails=docsIf3CmStatusUCCFails, docsIf3MdCfgDownChannelAnnex=docsIf3MdCfgDownChannelAnnex, AmplitudeData=AmplitudeData, docsIf3UsChExtEntry=docsIf3UsChExtEntry, docsIf3CmSpectrumAnalysisMeasEntry=docsIf3CmSpectrumAnalysisMeasEntry, docsIf3BondingGrpCfgCfgId=docsIf3BondingGrpCfgCfgId, docsIf3CmtsCmCtrlCmdCommit=docsIf3CmtsCmCtrlCmdCommit, docsIf3RxModuleStatusRmId=docsIf3RxModuleStatusRmId, docsIf3CmDpvStatsEntry=docsIf3CmDpvStatsEntry, docsIf3RxModuleCfgEntry=docsIf3RxModuleCfgEntry, docsIf3DsChSetId=docsIf3DsChSetId, docsIf3CmtsCmRegStatusAddrResolutionReqs=docsIf3CmtsCmRegStatusAddrResolutionReqs, docsIf3CmEnergyMgtCfg=docsIf3CmEnergyMgtCfg, docsIf3CmEm1x1StatsTotalDurationBelowUsDsThrshlds=docsIf3CmEm1x1StatsTotalDurationBelowUsDsThrshlds, docsIf3DsChSetEntry=docsIf3DsChSetEntry, docsIf3ObsoleteGroup=docsIf3ObsoleteGroup, docsIf3RccStatusRccCfgId=docsIf3RccStatusRccCfgId, docsIf3MdUsToDsChMappingEntry=docsIf3MdUsToDsChMappingEntry, docsIf3MdUsSgStatusMdUsSgId=docsIf3MdUsSgStatusMdUsSgId, docsIf3CmtsSignalQualityExtTable=docsIf3CmtsSignalQualityExtTable, docsIf3CmtsCmEmStatsEm1x1ModeTotalDuration=docsIf3CmtsCmEmStatsEm1x1ModeTotalDuration, docsIf3MdDsSgStatusTable=docsIf3MdDsSgStatusTable, docsIf3RccCfgDescription=docsIf3RccCfgDescription, docsIf3MdUsSgStatusTable=docsIf3MdUsSgStatusTable, docsIf3MdCfgUsFreqRange=docsIf3MdCfgUsFreqRange, docsIf3CmCompliance=docsIf3CmCompliance, docsIf3BondingGrpCfgChList=docsIf3BondingGrpCfgChList, docsIf3UsChSetEntry=docsIf3UsChSetEntry, docsIf3MdNodeStatusEntry=docsIf3MdNodeStatusEntry, docsIf3CmGroup=docsIf3CmGroup, docsIf3MdUsToDsChMappingUsIfIndex=docsIf3MdUsToDsChMappingUsIfIndex, SpectrumAnalysisWindowFunction=SpectrumAnalysisWindowFunction, docsIf3CmStatusResets=docsIf3CmStatusResets, docsIf3CmDpvStatsMinLatency=docsIf3CmDpvStatsMinLatency, docsIf3CmtsCmUsStatusMicroreflections=docsIf3CmtsCmUsStatusMicroreflections, docsIf3CmtsCmUsStatusEntry=docsIf3CmtsCmUsStatusEntry, docsIf3RccStatusEntry=docsIf3RccStatusEntry, docsIf3MdCfgMultTxChModeEnabled=docsIf3MdCfgMultTxChModeEnabled, docsIf3CmStatusInvalidRangingRsps=docsIf3CmStatusInvalidRangingRsps, docsIf3CmMdCfgIpProvModeResetOnChange=docsIf3CmMdCfgIpProvModeResetOnChange, docsIf3RccCfgEntry=docsIf3RccCfgEntry, docsIf3MdUsSgStatusEntry=docsIf3MdUsSgStatusEntry, docsIf3CmSpectrumAnalysisCtrlCmdInactivityTimeout=docsIf3CmSpectrumAnalysisCtrlCmdInactivityTimeout, docsIf3SignalQualityExtEntry=docsIf3SignalQualityExtEntry, docsIf3CmStatusT1Timeouts=docsIf3CmStatusT1Timeouts, docsIf3CmtsCmCtrlCmdMuteInterval=docsIf3CmtsCmCtrlCmdMuteInterval, docsIf3MdChCfgChId=docsIf3MdChCfgChId, docsIf3RccStatusValidityCode=docsIf3RccStatusValidityCode, docsIf3MdNodeStatusNodeName=docsIf3MdNodeStatusNodeName, docsIf3CmCapabilities=docsIf3CmCapabilities, docsIf3CmStatusInvalidUcds=docsIf3CmStatusInvalidUcds, docsIf3CmtsCmRegStatusEnergyMgtEnabled=docsIf3CmtsCmRegStatusEnergyMgtEnabled, docsIf3CmtsEventCtrlEntry=docsIf3CmtsEventCtrlEntry, docsIf3CmEnergyMgt1x1CfgEntry=docsIf3CmEnergyMgt1x1CfgEntry, docsIf3CmSpectrumAnalysisCtrlCmdNumBinsPerSegment=docsIf3CmSpectrumAnalysisCtrlCmdNumBinsPerSegment)
mibBuilder.exportSymbols("DOCS-IF3-MIB", docsIf3CmtsCmRegStatusEntry=docsIf3CmtsCmRegStatusEntry, docsIf3MibCompliances=docsIf3MibCompliances, docsIf3CmStatusUsEntry=docsIf3CmStatusUsEntry, docsIf3RxModuleStatusFirstCenterFrequency=docsIf3RxModuleStatusFirstCenterFrequency, docsIf3UsChSetTable=docsIf3UsChSetTable, docsIf3CmDpvStatsNumMeas=docsIf3CmDpvStatsNumMeas, docsIf3UsBondingGrpStatusTable=docsIf3UsBondingGrpStatusTable, docsIf3CmStatusUsRangingStatus=docsIf3CmStatusUsRangingStatus, docsIf3MdCfgCmUdcEnabled=docsIf3MdCfgCmUdcEnabled, docsIf3CmStatusCode=docsIf3CmStatusCode, docsIf3CmtsCmUsStatusTable=docsIf3CmtsCmUsStatusTable, docsIf3MdChCfgTable=docsIf3MdChCfgTable, docsIf3MdCfgTftpProxyEnabled=docsIf3MdCfgTftpProxyEnabled, docsIf3CmDpvStatsMaxLatency=docsIf3CmDpvStatsMaxLatency, docsIf3CmSpectrumAnalysisMeasTable=docsIf3CmSpectrumAnalysisMeasTable, docsIf3CmDpvStatsLastMeasTime=docsIf3CmDpvStatsLastMeasTime, docsIf3MdCfgSrcAddrVerifEnabled=docsIf3MdCfgSrcAddrVerifEnabled, RcpId=RcpId, docsIf3CmNotificationGroup=docsIf3CmNotificationGroup, docsIf3CmtsCmRegStatusIPv4Addr=docsIf3CmtsCmRegStatusIPv4Addr, docsIf3CmtsCmUsStatusRxPower=docsIf3CmtsCmUsStatusRxPower, docsIf3RxChCfgPrimaryDsIndicator=docsIf3RxChCfgPrimaryDsIndicator, docsIf3CmEm1x1StatsTotalDurationBelowDsThrshlds=docsIf3CmEm1x1StatsTotalDurationBelowDsThrshlds, docsIf3CmtsCmUsStatusUncorrectables=docsIf3CmtsCmUsStatusUncorrectables, docsIf3CmStatusUsEqData=docsIf3CmStatusUsEqData, docsIf3DsBondingGrpStatusMdDsSgId=docsIf3DsBondingGrpStatusMdDsSgId, docsIf3CmtsCompliance=docsIf3CmtsCompliance, docsIf3CmDpvStatsLastMeasLatency=docsIf3CmDpvStatsLastMeasLatency, docsIf3CmtsSpectrumAnalysisMeasAmplitudeData=docsIf3CmtsSpectrumAnalysisMeasAmplitudeData, docsIf3CmStatusLostSyncs=docsIf3CmStatusLostSyncs, docsIf3CmtsCmRegStatusMacAddr=docsIf3CmtsCmRegStatusMacAddr)
