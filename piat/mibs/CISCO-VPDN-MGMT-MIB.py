...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-VPDN-MGMT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:46:41 2019
...
TimeTicks, ObjectIdentity, NotificationType, Gauge32, Counter32, Integer32, MibIdentifier, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "Counter32", "Integer32", "MibIdentifier", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("CISCO-VPDN-MGMT-MIB", cvpdnUnameToFailHistUname=cvpdnUnameToFailHistUname, cvpdnBundlesWithMoreThanTwoLinks=cvpdnBundlesWithMoreThanTwoLinks, cvpdnTunnelAttrRemoteInetAddressType=cvpdnTunnelAttrRemoteInetAddressType, cvpdnUnameToFailHistLocalInitConn=cvpdnUnameToFailHistLocalInitConn, cvpdnTunnelSessionMultilink=cvpdnTunnelSessionMultilink, cvpdnTunnelSessionInfo=cvpdnTunnelSessionInfo, cvpdnUserToFailHistInfoGroup=cvpdnUserToFailHistInfoGroup, cvpdnTunnelAttrGroup=cvpdnTunnelAttrGroup, cvpdnSessionAttrGroup=cvpdnSessionAttrGroup, cvpdnTunnelSessionTable=cvpdnTunnelSessionTable, cvpdnTunnelAttrLocalIpAddress=cvpdnTunnelAttrLocalIpAddress, cvpdnNotifSessionID=cvpdnNotifSessionID, cvpdnTunnelSessionId=cvpdnTunnelSessionId, cvpdnTunnelAttrState=cvpdnTunnelAttrState, cvpdnUnameToFailHistFailType=cvpdnUnameToFailHistFailType, cvpdnTunnelSessionDS1ChannelIndex=cvpdnTunnelSessionDS1ChannelIndex, cvpdnSystemGroup=cvpdnSystemGroup, cvpdnSystemEntry=cvpdnSystemEntry, cvpdnSessionAttrMultilink=cvpdnSessionAttrMultilink, cvpdnUnameToFailHistLocalName=cvpdnUnameToFailHistLocalName, cvpdnUnameToFailHistSourceInetType=cvpdnUnameToFailHistSourceInetType, cvpdnBundlesWithTwoLinks=cvpdnBundlesWithTwoLinks, cvpdnBundleEndpoint=cvpdnBundleEndpoint, cvpdnTunnelSessionBytesIn=cvpdnTunnelSessionBytesIn, cvpdnSessionAttrMultilinkBundle=cvpdnSessionAttrMultilinkBundle, cvpdnTunnelAttrEntry=cvpdnTunnelAttrEntry, cvpdnTunnelAttrLocalInetAddressType=cvpdnTunnelAttrLocalInetAddressType, cvpdnUnameToFailHistTunnelId=cvpdnUnameToFailHistTunnelId, cvpdnMultilinkGroup=cvpdnMultilinkGroup, cvpdnBundleEndpointClass=cvpdnBundleEndpointClass, cvpdnTunnelAttrNetworkServiceType=cvpdnTunnelAttrNetworkServiceType, cvpdnBundleTable=cvpdnBundleTable, cvpdnTunnelAttrGroupRev1=cvpdnTunnelAttrGroupRev1, cvpdnTunnelSessionDS1PortIndex=cvpdnTunnelSessionDS1PortIndex, cvpdnUnameToFailHistRemoteName=cvpdnUnameToFailHistRemoteName, cvpdnBundleChildTunnelId=cvpdnBundleChildTunnelId, cvpdnTunnelSessionInfoGroup=cvpdnTunnelSessionInfoGroup, cvpdnUserToFailHistInfoEntry=cvpdnUserToFailHistInfoEntry, ciscoVpdnMgmtMIBComplianceRev3=ciscoVpdnMgmtMIBComplianceRev3, cvpdnTunnelSessionCallDuration=cvpdnTunnelSessionCallDuration, cvpdnSessionTotal=cvpdnSessionTotal, cvpdnSessionAttrDS1PortIndex=cvpdnSessionAttrDS1PortIndex, cvpdnTunnelSessionDevicePhyId=cvpdnTunnelSessionDevicePhyId, cvpdnTunnelAttrDeniedUsers=cvpdnTunnelAttrDeniedUsers, cvpdnSessionAttrMultilinkIfIndex=cvpdnSessionAttrMultilinkIfIndex, cvpdnTunnelTable=cvpdnTunnelTable, cvpdnSystemFailedConnReq=cvpdnSystemFailedConnReq, cvpdnTunnelAttrOrigCause=cvpdnTunnelAttrOrigCause, cvpdnBundleChildSessionId=cvpdnBundleChildSessionId, cvpdnNotifSessionEvent=cvpdnNotifSessionEvent, cvpdnTunnelSessionModemCallStartIndex=cvpdnTunnelSessionModemCallStartIndex, cvpdnBundleEndpointType=cvpdnBundleEndpointType, cvpdnTunnelSessionDeviceType=cvpdnTunnelSessionDeviceType, cvpdnTunnelAttrSoftshut=cvpdnTunnelAttrSoftshut, cvpdnNotifEnabledGroup=cvpdnNotifEnabledGroup, cvpdnSessionAttrPacketsIn=cvpdnSessionAttrPacketsIn, cvpdnSessionAttrGroupRev1=cvpdnSessionAttrGroupRev1, cvpdnTunnelAttrRemoteEndpointName=cvpdnTunnelAttrRemoteEndpointName, cvpdnUnameToFailHistDestInetType=cvpdnUnameToFailHistDestInetType, cvpdnMultilinkGroupRev1=cvpdnMultilinkGroupRev1, cvpdnTunnelState=cvpdnTunnelState, cvpdnSessionAttrModemCallStartIndex=cvpdnSessionAttrModemCallStartIndex, cvpdnTunnelAttrLocalInetAddress=cvpdnTunnelAttrLocalInetAddress, cvpdnSessionAttrDS1ChannelIndex=cvpdnSessionAttrDS1ChannelIndex, cvpdnBundleChildEntry=cvpdnBundleChildEntry, ciscoVpdnMgmtMIBNotifs=ciscoVpdnMgmtMIBNotifs, EndpointClass=EndpointClass, cvpdnTunnelAttrRemoteInetAddress=cvpdnTunnelAttrRemoteInetAddress, cvpdnTemplateActiveSessions=cvpdnTemplateActiveSessions, cvpdnTunnelLocalName=cvpdnTunnelLocalName, cvpdnTunnelAttrActiveSessions=cvpdnTunnelAttrActiveSessions, cvpdnTunnelSessionPacketsIn=cvpdnTunnelSessionPacketsIn, cvpdnTunnelSourceIpAddress=cvpdnTunnelSourceIpAddress, cvpdnTunnelAttrSourceInetAddress=cvpdnTunnelAttrSourceInetAddress, cvpdnMultilinkInfo=cvpdnMultilinkInfo, cvpdnUnameToFailHistFailReason=cvpdnUnameToFailHistFailReason, cvpdnTunnelSoftshut=cvpdnTunnelSoftshut, cvpdnTunnelRemoteEndpointName=cvpdnTunnelRemoteEndpointName, cvpdnTunnelAttrTable=cvpdnTunnelAttrTable, cvpdnTunnelRemoteName=cvpdnTunnelRemoteName, cvpdnSessionAttrSentPktsDropped=cvpdnSessionAttrSentPktsDropped, cvpdnSessionAttrDS1SlotIndex=cvpdnSessionAttrDS1SlotIndex, cvpdnSessionAttrTable=cvpdnSessionAttrTable, cvpdnBundleLastChanged=cvpdnBundleLastChanged, cvpdnSessionAttrModemCallStartTime=cvpdnSessionAttrModemCallStartTime, TunnelType=TunnelType, ciscoVpdnMgmtMIBComplianceRev4=ciscoVpdnMgmtMIBComplianceRev4, cvpdnUnameToFailHistSourceInetAddr=cvpdnUnameToFailHistSourceInetAddr, cvpdnTunnelSessionEntry=cvpdnTunnelSessionEntry, ciscoVpdnMgmtMIB=ciscoVpdnMgmtMIB, cvpdnSessionAttrModemPortIndex=cvpdnSessionAttrModemPortIndex, cvpdnSessionAttrState=cvpdnSessionAttrState, cvpdnTunnelInfoGroup=cvpdnTunnelInfoGroup, cvpdnSessionAttrPacketsOut=cvpdnSessionAttrPacketsOut, cvpdnTunnelTotal=cvpdnTunnelTotal, cvpdnSystemSuccessConnReq=cvpdnSystemSuccessConnReq, cvpdnTunnelOrigCause=cvpdnTunnelOrigCause, cvpdnSessionAttrModemSlotIndex=cvpdnSessionAttrModemSlotIndex, cvpdnTunnelAttrLocalName=cvpdnTunnelAttrLocalName, cvpdnSessionAttrSessionId=cvpdnSessionAttrSessionId, ciscoVpdnMgmtMIBGroups=ciscoVpdnMgmtMIBGroups, cvpdnUnameToFailHistDestInetAddr=cvpdnUnameToFailHistDestInetAddr, cvpdnSystemTable=cvpdnSystemTable, cvpdnUserToFailHistInfo=cvpdnUserToFailHistInfo, cvpdnTunnelSessionDeviceCallerId=cvpdnTunnelSessionDeviceCallerId, ciscoVpdnMgmtMIBComplianceRev1=ciscoVpdnMgmtMIBComplianceRev1, cvpdnTunnelAttrRemoteName=cvpdnTunnelAttrRemoteName, cvpdnTunnelSessionPacketsOut=cvpdnTunnelSessionPacketsOut, cvpdnSessionAttrBytesIn=cvpdnSessionAttrBytesIn, cvpdnSystemTunnelTotal=cvpdnSystemTunnelTotal, cvpdnTunnelAttrSourceIpAddress=cvpdnTunnelAttrSourceIpAddress, cvpdnBundleLinkCount=cvpdnBundleLinkCount, cvpdnBundleChildTable=cvpdnBundleChildTable, cvpdnTunnelAttrRemoteTunnelId=cvpdnTunnelAttrRemoteTunnelId, cvpdnBundlePeerIpAddr=cvpdnBundlePeerIpAddr, cvpdnTunnelSessionBytesOut=cvpdnTunnelSessionBytesOut, cvpdnTunnelActiveSessions=cvpdnTunnelActiveSessions, cvpdnTunnelLocalIpAddress=cvpdnTunnelLocalIpAddress, cvpdnUnameToFailHistDestIp=cvpdnUnameToFailHistDestIp, cvpdnSessionAttrUserName=cvpdnSessionAttrUserName, cvpdnSessionAttrBytesOut=cvpdnSessionAttrBytesOut, ciscoVpdnMgmtMIBConformance=ciscoVpdnMgmtMIBConformance, cvpdnTunnelSessionState=cvpdnTunnelSessionState, cvpdnSessionAttrCallDuration=cvpdnSessionAttrCallDuration, cvpdnNotifSession=cvpdnNotifSession, cvpdnTunnelNetworkServiceType=cvpdnTunnelNetworkServiceType, ciscoVpdnMgmtMIBComplianceRev5=ciscoVpdnMgmtMIBComplianceRev5, cvpdnUnameToFailHistCount=cvpdnUnameToFailHistCount, cvpdnTemplateName=cvpdnTemplateName, cvpdnTemplateTable=cvpdnTemplateTable, cvpdnBundleChildTunnelType=cvpdnBundleChildTunnelType, cvpdnSystemInfoGroup=cvpdnSystemInfoGroup, cvpdnSessionNotifGroup=cvpdnSessionNotifGroup, cvpdnConfigGroup=cvpdnConfigGroup, cvpdnTunnelAttrTunnelId=cvpdnTunnelAttrTunnelId, cvpdnBundleEntry=cvpdnBundleEntry, ciscoVpdnMgmtMIBCompliances=ciscoVpdnMgmtMIBCompliances, cvpdnSystemNotifSessionEnabled=cvpdnSystemNotifSessionEnabled, cvpdnTunnelSessionDS1SlotIndex=cvpdnTunnelSessionDS1SlotIndex, cvpdnUnameToFailHistSourceIp=cvpdnUnameToFailHistSourceIp, ciscoVpdnMgmtMIBCompliance=ciscoVpdnMgmtMIBCompliance, cvpdnSessionAttrDeviceCallerId=cvpdnSessionAttrDeviceCallerId, cvpdnTunnelInfo=cvpdnTunnelInfo, ciscoVpdnMgmtMIBObjects=ciscoVpdnMgmtMIBObjects, cvpdnSystemTunnelType=cvpdnSystemTunnelType, cvpdnSystemDeniedUsersTotal=cvpdnSystemDeniedUsersTotal, cvpdnUnameToFailHistUserId=cvpdnUnameToFailHistUserId, cvpdnBundlePeerIpAddrType=cvpdnBundlePeerIpAddrType, cvpdnTemplateGroup=cvpdnTemplateGroup, cvpdnTemplateEntry=cvpdnTemplateEntry, cvpdnTunnelLocalInitConnection=cvpdnTunnelLocalInitConnection, cvpdnSessionAttrRecvPktsDropped=cvpdnSessionAttrRecvPktsDropped, cvpdnUserToFailHistInfoTable=cvpdnUserToFailHistInfoTable, cvpdnSystemClearSessions=cvpdnSystemClearSessions, cvpdnSystemSessionTotal=cvpdnSystemSessionTotal, cvpdnTunnelTunnelId=cvpdnTunnelTunnelId, ciscoVpdnMgmtMIBComplianceRev2=ciscoVpdnMgmtMIBComplianceRev2, cvpdnUserToFailHistInfoGroupRev1=cvpdnUserToFailHistInfoGroupRev1, cvpdnTunnelSessionUserName=cvpdnTunnelSessionUserName, cvpdnTunnelAttrLocalInitConnection=cvpdnTunnelAttrLocalInitConnection, cvpdnDeniedUsersTotal=cvpdnDeniedUsersTotal, cvpdnTunnelSessionModemSlotIndex=cvpdnTunnelSessionModemSlotIndex, cvpdnTunnelRemoteIpAddress=cvpdnTunnelRemoteIpAddress, cvpdnTemplateInfo=cvpdnTemplateInfo, cvpdnSystemInfo=cvpdnSystemInfo, PYSNMP_MODULE_ID=ciscoVpdnMgmtMIB, cvpdnBundlesWithOneLink=cvpdnBundlesWithOneLink, cvpdnSessionAttrDevicePhyId=cvpdnSessionAttrDevicePhyId, cvpdnTunnelAttrSourceInetAddressType=cvpdnTunnelAttrSourceInetAddressType, cvpdnTunnelEntry=cvpdnTunnelEntry, cvpdnSessionAttrDeviceType=cvpdnSessionAttrDeviceType, cvpdnUnameToFailHistFailTime=cvpdnUnameToFailHistFailTime, cvpdnTunnelSessionModemCallStartTime=cvpdnTunnelSessionModemCallStartTime, cvpdnTunnelDeniedUsers=cvpdnTunnelDeniedUsers, cvpdnSystemInitialConnReq=cvpdnSystemInitialConnReq, cvpdnBundleName=cvpdnBundleName, cvpdnTunnelSessionModemPortIndex=cvpdnTunnelSessionModemPortIndex, cvpdnTunnelAttrRemoteIpAddress=cvpdnTunnelAttrRemoteIpAddress, cvpdnTunnelRemoteTunnelId=cvpdnTunnelRemoteTunnelId, cvpdnSessionAttrVirtualCircuitID=cvpdnSessionAttrVirtualCircuitID, cvpdnSessionAttrEntry=cvpdnSessionAttrEntry)
