...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-TRUSTSEC-MIB
...
CtsSecurityGroupTag, CtsPasswordEncryptionType, CtsGenerationId, CtsCredentialRecordType, CtsAcsAuthorityIdentity = mibBuilder.importSymbols("CISCO-TRUSTSEC-TC-MIB", "CtsSecurityGroupTag", "CtsPasswordEncryptionType", "CtsGenerationId", "CtsCredentialRecordType", "CtsAcsAuthorityIdentity")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Bits, iso, Integer32, Counter32, TimeTicks, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Bits", "iso", "Integer32", "Counter32", "TimeTicks", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("CISCO-TRUSTSEC-MIB", ctsEnvDataRefreshInterval=ctsEnvDataRefreshInterval, ciscoTrustSecCredentialsGroup=ciscoTrustSecCredentialsGroup, ciscoTrustSecMIBCompliances=ciscoTrustSecMIBCompliances, ctsSecurityGroupTagId=ctsSecurityGroupTagId, ctsSwKeystoreFileErrNotifEnable=ctsSwKeystoreFileErrNotifEnable, ciscoTrustSecMIB=ciscoTrustSecMIB, ctsKeystoreFwVersion=ctsKeystoreFwVersion, ciscoTrustSecMIBNotifs=ciscoTrustSecMIBNotifs, ctsEnvSecurityGroupNameSgtGenId=ctsEnvSecurityGroupNameSgtGenId, ciscoTrustSecMIBConform=ciscoTrustSecMIBConform, ctsNotifsInfoObjects=ctsNotifsInfoObjects, ctsAuthzCacheFileErrNotif=ctsAuthzCacheFileErrNotif, ctsPacType=ctsPacType, ctsCriticalAuthEnabled=ctsCriticalAuthEnabled, ciscoTrustSecCacheGroup=ciscoTrustSecCacheGroup, ctsEnvSecurityGroupTagGenId=ctsEnvSecurityGroupTagGenId, ctsDevicePasswordType=ctsDevicePasswordType, ctsNotifMessageString=ctsNotifMessageString, ctsCacheObjects=ctsCacheObjects, ctsCriticalAuthViewDefaultPmk=ctsCriticalAuthViewDefaultPmk, ctsEnvSecurityGroupNameTable=ctsEnvSecurityGroupNameTable, ctsEnvDataAction=ctsEnvDataAction, ciscoTrustSecCrtclAuthGroup=ciscoTrustSecCrtclAuthGroup, PYSNMP_MODULE_ID=ciscoTrustSecMIB, ctsCacheFileAccessErrNotifEnable=ctsCacheFileAccessErrNotifEnable, ctsEnvSecurityGroupTagId=ctsEnvSecurityGroupTagId, ctsKeystorePacRecordName=ctsKeystorePacRecordName, ciscoTrustSecMIBCompliance4=ciscoTrustSecMIBCompliance4, ctsKeystoreRxBadFragmentLengths=ctsKeystoreRxBadFragmentLengths, ctsEnvDataLastUpdate=ctsEnvDataLastUpdate, ciscoTrustSecMIBGroups=ciscoTrustSecMIBGroups, ctsCredentialObjects=ctsCredentialObjects, ctsKeystoreType=ctsKeystoreType, ctsPacInfoTable=ctsPacInfoTable, ctsSapRandomNumberFailNotif=ctsSapRandomNumberFailNotif, ctsCacheFileAccessErrNotif=ctsCacheFileAccessErrNotif, ctsSrcEntropyFailNotif=ctsSrcEntropyFailNotif, ctsCriticalAuthDefaultPmk=ctsCriticalAuthDefaultPmk, ctsSrcEntropyFailNotifEnable=ctsSrcEntropyFailNotifEnable, ctsFileErrNotifReason=ctsFileErrNotifReason, ciscoTrustSecFileErrNotifsInfoGroup=ciscoTrustSecFileErrNotifsInfoGroup, ctsEnvironmentDataObjects=ctsEnvironmentDataObjects, ctsKeystoreCorruptions=ctsKeystoreCorruptions, ctsSapRandomNumberFailNotifEnable=ctsSapRandomNumberFailNotifEnable, ciscoTrustSecMIBCompliance2=ciscoTrustSecMIBCompliance2, ctsCredentialsClearAll=ctsCredentialsClearAll, ctsCriticalAuthPeerSgt=ctsCriticalAuthPeerSgt, ctsPacAcsAuthId=ctsPacAcsAuthId, ciscoTrustSecNotifsMessageStringInfoGroup=ciscoTrustSecNotifsMessageStringInfoGroup, ciscoTrustSecMIBCompliance=ciscoTrustSecMIBCompliance, ctsSwKeystoreSyncFailNotifReason=ctsSwKeystoreSyncFailNotifReason, ciscoTrustSecHwKeystoreInfoGroup=ciscoTrustSecHwKeystoreInfoGroup, ciscoTrustSecSwKeystoreNotifsControlGroup=ciscoTrustSecSwKeystoreNotifsControlGroup, ctsKeystorePasswordRecordEntry=ctsKeystorePasswordRecordEntry, ctsPacAcsDescription=ctsPacAcsDescription, ciscoTrustSecEnvDataGroup=ciscoTrustSecEnvDataGroup, ctsKeystoreRxTimeouts=ctsKeystoreRxTimeouts, ctsKeystoreFwAlerts=ctsKeystoreFwAlerts, ctsCriticalAuthPeerSgtTrust=ctsCriticalAuthPeerSgtTrust, ctsCacheNvStorage=ctsCacheNvStorage, ciscoTrustSecMIBObjects=ciscoTrustSecMIBObjects, ctsKeystorePacRecordTable=ctsKeystorePacRecordTable, ctsEnvSecurityGroupNameEntry=ctsEnvSecurityGroupNameEntry, ctsDeviceId=ctsDeviceId, ciscoTrustSecMIBCompliance3=ciscoTrustSecMIBCompliance3, ctsCriticalAuthFallback=ctsCriticalAuthFallback, ctsCacheClear=ctsCacheClear, ctsCacheEnabled=ctsCacheEnabled, ctsSgtAssignmentMethod=ctsSgtAssignmentMethod, ctsKeystorePasswordRecordType=ctsKeystorePasswordRecordType, ctsDevicePassword=ctsDevicePassword, ctsSwKeystoreSyncFailNotifEnable=ctsSwKeystoreSyncFailNotifEnable, ctsKeystorePacRecordType=ctsKeystorePacRecordType, ctsEnvDataLastDownloadStatus=ctsEnvDataLastDownloadStatus, ciscoTrustSecEnvSecGroupNameGroup=ciscoTrustSecEnvSecGroupNameGroup, ctsPacStatus=ctsPacStatus, ciscoTrustSecCtrDrbgNotifsGroup=ciscoTrustSecCtrDrbgNotifsGroup, ctsPacInfoEntry=ctsPacInfoEntry, ctsEnvDataSource=ctsEnvDataSource, ctsKeystorePasswordRecordTable=ctsKeystorePasswordRecordTable, ciscoTrustSecSgtGroup=ciscoTrustSecSgtGroup, ctsSwKeystoreSyncFailNotif=ctsSwKeystoreSyncFailNotif, ctsEnvDataTimeToRefresh=ctsEnvDataTimeToRefresh, ctsEnvDataTimeLeft=ctsEnvDataTimeLeft, ciscoTrustSecSwKeystoreNotifsGroup=ciscoTrustSecSwKeystoreNotifsGroup, ctsAuthzCacheFileErrNotifEnable=ctsAuthzCacheFileErrNotifEnable, ctsEnvSecurityGroupNameSgt=ctsEnvSecurityGroupNameSgt, ctsSgtObjects=ctsSgtObjects, ctsKeystoreFwResets=ctsKeystoreFwResets, ciscoTrustSecCacheFileNotifsControlGroup=ciscoTrustSecCacheFileNotifsControlGroup, ctsEnvSecurityGroupNameSgtFlag=ctsEnvSecurityGroupNameSgtFlag, ciscoTrustSecSgtAssignmentGroup=ciscoTrustSecSgtAssignmentGroup, ciscoTrustSecCtrDrbgNotifsControlGroup=ciscoTrustSecCtrDrbgNotifsControlGroup, ctsEnvSecurityGroupName=ctsEnvSecurityGroupName, ctsNotifsControlObjects=ctsNotifsControlObjects, ctsKeystorePacRecordEntry=ctsKeystorePacRecordEntry, ctsPacExpirationTime=ctsPacExpirationTime, ctsKeystorePasswordRecordName=ctsKeystorePasswordRecordName, ciscoTrustSecSwKeystoreNotifsInfoGroup=ciscoTrustSecSwKeystoreNotifsInfoGroup, ctsPacTimeToRefresh=ctsPacTimeToRefresh, ctsSwKeystoreFileErrNotif=ctsSwKeystoreFileErrNotif, ctsCriticalAuthObjects=ctsCriticalAuthObjects, ciscoTrustSecCacheFileNotifsGroup=ciscoTrustSecCacheFileNotifsGroup, ctsKeystoreRxBadChecksums=ctsKeystoreRxBadChecksums)
