...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-MVPN-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:32:10 2019
...
Integer32, Counter64, MibIdentifier, Counter32, IpAddress, Bits, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "MibIdentifier", "Counter32", "IpAddress", "Bits", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity")
DisplayString, RowStatus, TimeStamp, TimeInterval, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TimeStamp", "TimeInterval", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("CISCO-MVPN-MIB", ciscoMvpnGenericEntry=ciscoMvpnGenericEntry, ciscoMvpnGeneric=ciscoMvpnGeneric, ciscoMvpnBgpMdtUpdateTable=ciscoMvpnBgpMdtUpdateTable, ciscoMvpnMrouteMdtType=ciscoMvpnMrouteMdtType, ciscoMvpnBgpMdtUpdNhAddrType=ciscoMvpnBgpMdtUpdNhAddrType, ciscoMvpnMdtJnSendMdtGroup=ciscoMvpnMdtJnSendMdtGroup, ciscoMvpnMdtDataWildcardBits=ciscoMvpnMdtDataWildcardBits, ciscoMvpnConfig=ciscoMvpnConfig, ciscoMvpnMvrfNumber=ciscoMvpnMvrfNumber, ciscoMvpnModuleFullCompliance=ciscoMvpnModuleFullCompliance, ciscoMvpnMIBMdtDataGroup=ciscoMvpnMIBMdtDataGroup, ciscoMvpnMdtDefaultTable=ciscoMvpnMdtDefaultTable, ciscoMvpnMIB=ciscoMvpnMIB, ciscoMvpnNotificationEnable=ciscoMvpnNotificationEnable, ciscoMvpnMdtJnSendTable=ciscoMvpnMdtJnSendTable, ciscoMvpnMIBMrouteMdtGroup=ciscoMvpnMIBMrouteMdtGroup, ciscoMvpnTunnelGroup=ciscoMvpnTunnelGroup, ciscoMvpnMdtDataRowStatus=ciscoMvpnMdtDataRowStatus, ciscoMvpnMrouteMdtEntry=ciscoMvpnMrouteMdtEntry, ciscoMvpnNotificationGroup=ciscoMvpnNotificationGroup, ciscoMvpnMdtJnRcvGrpAddrType=ciscoMvpnMdtJnRcvGrpAddrType, ciscoMvpnMdtDataRangeAddress=ciscoMvpnMdtDataRangeAddress, ciscoMvpnMIBGenericGroup=ciscoMvpnMIBGenericGroup, ciscoMvpnMrouteMvrfGroup=ciscoMvpnMrouteMvrfGroup, ciscoMvpnMrouteMdtGroup=ciscoMvpnMrouteMdtGroup, ciscoMvpnMrouteMvrfGrpAddrType=ciscoMvpnMrouteMvrfGrpAddrType, ciscoMvpnMdtJnSendEntry=ciscoMvpnMdtJnSendEntry, ciscoMvpnMrouteMdtTable=ciscoMvpnMrouteMdtTable, ciscoMvpnMvrfChange=ciscoMvpnMvrfChange, ciscoMvpnBgpMdtUpdateRd=ciscoMvpnBgpMdtUpdateRd, ciscoMvpnMdtDefaultAddrType=ciscoMvpnMdtDefaultAddrType, ciscoMvpnMIBMdtJnRcvGroup=ciscoMvpnMIBMdtJnRcvGroup, ciscoMvpnScalarGroup=ciscoMvpnScalarGroup, ciscoMvpnGenericTable=ciscoMvpnGenericTable, ciscoMvpnMrouteMdtGrpAddrType=ciscoMvpnMrouteMdtGrpAddrType, ciscoMvpnTunnelName=ciscoMvpnTunnelName, ciscoMvpnMIBMdtJnSendGroup=ciscoMvpnMIBMdtJnSendGroup, ciscoMvpnGenOperStatusChange=ciscoMvpnGenOperStatusChange, ciscoMvpnMdtJnSendSrcAddrType=ciscoMvpnMdtJnSendSrcAddrType, ciscoMvpnScalars=ciscoMvpnScalars, ciscoMvpnMdtDataTable=ciscoMvpnMdtDataTable, ciscoMvpnMdtDataEntry=ciscoMvpnMdtDataEntry, ciscoMvpnMdtJnRcvEntry=ciscoMvpnMdtJnRcvEntry, ciscoMvpnGenOperChangeTime=ciscoMvpnGenOperChangeTime, ciscoMvpnMdtJnSendGroup=ciscoMvpnMdtJnSendGroup, ciscoMvpnTunnelMvrf=ciscoMvpnTunnelMvrf, ciscoMvpnMdtJnRcvExpTime=ciscoMvpnMdtJnRcvExpTime, ciscoMvpnMdtDefaultEntry=ciscoMvpnMdtDefaultEntry, ciscoMvpnProtocol=ciscoMvpnProtocol, ciscoMvpnGroups=ciscoMvpnGroups, ciscoMvpnBgpMdtUpdateGroup=ciscoMvpnBgpMdtUpdateGroup, ciscoMvpnMrouteUpDownStreamInfo=ciscoMvpnMrouteUpDownStreamInfo, PYSNMP_MODULE_ID=ciscoMvpnMIB, ciscoMvpnBgpMdtUpdGrpAddrType=ciscoMvpnBgpMdtUpdGrpAddrType, ciscoMvpnMrouteMvrfSrcAddrType=ciscoMvpnMrouteMvrfSrcAddrType, ciscoMvpnMdtEncapsType=ciscoMvpnMdtEncapsType, ciscoMvpnMdtDefaultAddress=ciscoMvpnMdtDefaultAddress, ciscoMvpnBgpMdtUpdSrcAddrType=ciscoMvpnBgpMdtUpdSrcAddrType, ciscoMvpnMIBBgpMdtUpdateGroup=ciscoMvpnMIBBgpMdtUpdateGroup, ciscoMvpnMdtJnRcvTable=ciscoMvpnMdtJnRcvTable, ciscoMvpnMdtDataThreshold=ciscoMvpnMdtDataThreshold, ciscoMvpnGenRowStatus=ciscoMvpnGenRowStatus, ciscoMvpnGenAssociatedInterfaces=ciscoMvpnGenAssociatedInterfaces, ciscoMvpnBgpMdtUpdOrigAddrType=ciscoMvpnBgpMdtUpdOrigAddrType, ciscoMvpnCompliances=ciscoMvpnCompliances, ciscoMvpnTunnelEntry=ciscoMvpnTunnelEntry, ciscoMvpnMdtJnSendSource=ciscoMvpnMdtJnSendSource, ciscoMvpnMdtJnSendMdtGrpAddrType=ciscoMvpnMdtJnSendMdtGrpAddrType, ciscoMvpnObjects=ciscoMvpnObjects, ciscoMvpnMdtDefaultRowStatus=ciscoMvpnMdtDefaultRowStatus, ciscoMvpnNotifications=ciscoMvpnNotifications, ciscoMvpnBgpMdtUpdateOriginator=ciscoMvpnBgpMdtUpdateOriginator, ciscoMvpnMdtJnRcvUpTime=ciscoMvpnMdtJnRcvUpTime, ciscoMvpnBgpMdtUpdateNexthop=ciscoMvpnBgpMdtUpdateNexthop, ciscoMvpnBgpMdtUpdateSource=ciscoMvpnBgpMdtUpdateSource, ciscoMvpnMIBMdtDefaultGroup=ciscoMvpnMIBMdtDefaultGroup, ciscoMvpnConformance=ciscoMvpnConformance, ciscoMvpnTunnelTable=ciscoMvpnTunnelTable, ciscoMvpnMdtJnSendMdtRefCt=ciscoMvpnMdtJnSendMdtRefCt, ciscoMvpnMdtJnSendGrpAddrType=ciscoMvpnMdtJnSendGrpAddrType, ciscoMvpnMdtJnRcvSource=ciscoMvpnMdtJnRcvSource, ciscoMvpnMdtJnRcvSrcAddrType=ciscoMvpnMdtJnRcvSrcAddrType, ciscoMvpnModuleReadOnlyCompliance=ciscoMvpnModuleReadOnlyCompliance, ciscoMvpnMrouteMvrfSource=ciscoMvpnMrouteMvrfSource, ciscoMvpnBgpMdtUpdateEntry=ciscoMvpnBgpMdtUpdateEntry, ciscoMvpnMdtDataRangeAddrType=ciscoMvpnMdtDataRangeAddrType, ciscoMvpnMdtDataWildcardType=ciscoMvpnMdtDataWildcardType, ciscoMvpnMdtJnRcvGroup=ciscoMvpnMdtJnRcvGroup)
