...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ITP-GSCCP-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:34:51 2019
...
CItpTcTranslationType, CItpTcPointCode, CItpTcTableLoadStatus, CItpTcGtaLongAddr, CItpTcNetworkName, CItpTcNAI, CItpTcURL, CItpTcSubSystemNumber, CItpTcDisplayPC, CItpTcGtaLongDisplayLen, CItpTcXuaName, CItpTcGtaLongDisplay, CItpTcNumberingPlan = mibBuilder.importSymbols("CISCO-ITP-TC-MIB", "CItpTcTranslationType", "CItpTcPointCode", "CItpTcTableLoadStatus", "CItpTcGtaLongAddr", "CItpTcNetworkName", "CItpTcNAI", "CItpTcURL", "CItpTcSubSystemNumber", "CItpTcDisplayPC", "CItpTcGtaLongDisplayLen", "CItpTcXuaName", "CItpTcGtaLongDisplay", "CItpTcNumberingPlan")
ciscoMgmt, = mibBuilder.importSymbols("CISCO-SMI", "ciscoMgmt")
EntPhysicalIndexOrZero, = mibBuilder.importSymbols("CISCO-TC", "EntPhysicalIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Bits, Counter64, ModuleIdentity, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, Gauge32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Bits", "Counter64", "ModuleIdentity", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "Gauge32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("CISCO-ITP-GSCCP-MIB", CgsccpGttMapType=CgsccpGttMapType, CgsccpGttPrefName=CgsccpGttPrefName, cgsccpGttAppGr2Network=cgsccpGttAppGr2Network, cgsccpGttPref=cgsccpGttPref, cgsccpGttMapQ752T7E4=cgsccpGttMapQ752T7E4, cgsccpInstGttConfigTS=cgsccpInstGttConfigTS, cgsccpGttAppGr2RowStatus=cgsccpGttAppGr2RowStatus, ciscoGsccpGttGtaGroup=ciscoGsccpGttGtaGroup, cgsccpGttAppGr2Mult=cgsccpGttAppGr2Mult, CgsccpClass=CgsccpClass, PYSNMP_MODULE_ID=ciscoGsccpMIB, CgsccpGttAppType=CgsccpGttAppType, cgsccpGttAppGrNumUsed=cgsccpGttAppGrNumUsed, cgsccpGttMapReRouteOnCong=cgsccpGttMapReRouteOnCong, cgsccpGttMapQ752T7E3Fail=cgsccpGttMapQ752T7E3Fail, cgsccpGttAppGrMult=cgsccpGttAppGrMult, cgsccpGttMap=cgsccpGttMap, cgsccpGttAppGrAsName=cgsccpGttAppGrAsName, cgsccpGttMapCongLvl2=cgsccpGttMapCongLvl2, cgsccpInstReassUnsup=cgsccpInstReassUnsup, cgsccpGttMapDisplaySS=cgsccpGttMapDisplaySS, cgsccpGttAppGr2Ssn=cgsccpGttAppGr2Ssn, cgsccpInstRsrFromMtp=cgsccpInstRsrFromMtp, CgsccpGttTransType=CgsccpGttTransType, cgsccpInstUDTSMsgsAttempted=cgsccpInstUDTSMsgsAttempted, cgsccpGttErrorsDpcCongested=cgsccpGttErrorsDpcCongested, cgsccpSSNTable=cgsccpSSNTable, cgsccpGttAppGrTableEntry=cgsccpGttAppGrTableEntry, ciscoGsccpGttPrefGroupRev1=ciscoGsccpGttPrefGroupRev1, cgsccpGttGtaResType=cgsccpGttGtaResType, cgsccpGttAppGrRefCount=cgsccpGttAppGrRefCount, cgsccpGttTranslateRate=cgsccpGttTranslateRate, cgsccpGttSelPostPrefConv=cgsccpGttSelPostPrefConv, cgsccpGttNextSelName=cgsccpGttNextSelName, cgsccpInstUDTSMsgsRcvd=cgsccpInstUDTSMsgsRcvd, ciscoGsccpGttMapGroupSup1=ciscoGsccpGttMapGroupSup1, cgsccpGttErrorsSelectorNotFound=cgsccpGttErrorsSelectorNotFound, cgsccpGttConPointCode=cgsccpGttConPointCode, cgsccpGttSel=cgsccpGttSel, cgsccpGttAppGr2EntNum=cgsccpGttAppGr2EntNum, cgsccpGttErrorsSccpUnqualified=cgsccpGttErrorsSccpUnqualified, cgsccpInstSelTableEntries=cgsccpInstSelTableEntries, cgsccpSSNClassXUDTMsgsRcvd=cgsccpSSNClassXUDTMsgsRcvd, ciscoGsccpLocalSsStateChange=ciscoGsccpLocalSsStateChange, cgsccpGttMapRefCount=cgsccpGttMapRefCount, cgsccpInstMapTableEntries=cgsccpInstMapTableEntries, cgsccpGttConPcListName=cgsccpGttConPcListName, cgsccpGttSelTableEntry=cgsccpGttSelTableEntry, ciscoGsccpSOGReceived=ciscoGsccpSOGReceived, cgsccpGttPrefRowStatus=cgsccpGttPrefRowStatus, cgsccpGttSelRowStatus=cgsccpGttSelRowStatus, cgsccpGttSelNumPerf=cgsccpGttSelNumPerf, ciscoGsccpGttPrefGroup=ciscoGsccpGttPrefGroup, ciscoGsccpNotificationsGroup=ciscoGsccpNotificationsGroup, cgsccpGttGtaAsName=cgsccpGttGtaAsName, cgsccpInstLUDTSMsgsRcvd=cgsccpInstLUDTSMsgsRcvd, cgsccpGttTranslateTableEntry=cgsccpGttTranslateTableEntry, cgsccpGttQ752T7E2=cgsccpGttQ752T7E2, cgsccpGttPref2InAddr=cgsccpGttPref2InAddr, ciscoGsccpGttSelGroupSup1=ciscoGsccpGttSelGroupSup1, cgsccpInstErrorIndicator=cgsccpInstErrorIndicator, cgsccpGttErrorPeriod=cgsccpGttErrorPeriod, cgsccpInstCrFromMtp=cgsccpInstCrFromMtp, CgsccpGttQOS=CgsccpGttQOS, cgsccpGttAppGrRi=cgsccpGttAppGrRi, CgsccpGttSelName=CgsccpGttSelName, cgsccpGttSelTable=cgsccpGttSelTable, ciscoGsccpMIBNotifs=ciscoGsccpMIBNotifs, ciscoGsccpMIBObjects=ciscoGsccpMIBObjects, cgsccpGttErrorsDpcUnavailable=cgsccpGttErrorsDpcUnavailable, cgsccpGttPrefName=cgsccpGttPrefName, cgsccpGttErrorsUnequipedSS=cgsccpGttErrorsUnequipedSS, CgsccpConPcListName=CgsccpConPcListName, cgsccpInstTableEntry=cgsccpInstTableEntry, cgsccpInstTable=cgsccpInstTable, cgsccpGttSelQOS=cgsccpGttSelQOS, ciscoGsccpMIBCompliance=ciscoGsccpMIBCompliance, ciscoGsccpInstTableEntryGroupSup1=ciscoGsccpInstTableEntryGroupSup1, cgsccpGttSelTT=cgsccpGttSelTT, cgsccpGttGtaResMap=cgsccpGttGtaResMap, cgsccpGttPrefItemNAI=cgsccpGttPrefItemNAI, cgsccpGttAppGr2Type=cgsccpGttAppGr2Type, cgsccpGttAppGrType=cgsccpGttAppGrType, cgsccpGttGtaTable=cgsccpGttGtaTable, cgsccpGttPref2=cgsccpGttPref2, cgsccpGttAppGr=cgsccpGttAppGr, cgsccpInstErrFromMtp=cgsccpInstErrFromMtp, cgsccpGttMapMultInd=cgsccpGttMapMultInd, cgsccpGttGtaNetwork=cgsccpGttGtaNetwork, ciscoGsccpGttErrorsGroup=ciscoGsccpGttErrorsGroup, cgsccpGttErrorsRouteFailure=cgsccpGttErrorsRouteFailure, cgsccpGttPref2ItemNP=cgsccpGttPref2ItemNP, cgsccpGttGtaRowStatus=cgsccpGttGtaRowStatus, CgsccpGttMapPcStatus=CgsccpGttMapPcStatus, cgsccpGttMapCongStatus=cgsccpGttMapCongStatus, cgsccpInstLUDTMsgsRcvd=cgsccpInstLUDTMsgsRcvd, cgsccpGttMapPcStatus=cgsccpGttMapPcStatus, cgsccpInstRowStatus=cgsccpInstRowStatus, CgsccpGttGlobalTitleInd=CgsccpGttGlobalTitleInd, cgsccpGttPrefOutAddr=cgsccpGttPrefOutAddr, cgsccpGttAppGrNetwork=cgsccpGttAppGrNetwork, cgsccpGttPref2TableEntry=cgsccpGttPref2TableEntry, cgsccpGttConPc=cgsccpGttConPc, cgsccpGttPrefItemNP=cgsccpGttPrefItemNP, ciscoGsccpMIBComplianceRev5=ciscoGsccpMIBComplianceRev5, ciscoGsccpNotificationsGroupSup1=ciscoGsccpNotificationsGroupSup1, cgsccpGttPrefTblNAI=cgsccpGttPrefTblNAI, ciscoGsccpMIBCompliances=ciscoGsccpMIBCompliances, cgsccpGttAppGr2RefCount=cgsccpGttAppGr2RefCount, cgsccpGttPref2OutAddr=cgsccpGttPref2OutAddr, cgsccpInstTotalGttMsgs=cgsccpInstTotalGttMsgs, cgsccpGttErrorsTableEntry=cgsccpGttErrorsTableEntry, ciscoGsccpSegReassUnsup=ciscoGsccpSegReassUnsup, cgsccpGttTranslateEntry=cgsccpGttTranslateEntry, cgsccpGttPrefTblNP=cgsccpGttPrefTblNP, cgsccpGttPref2TblNP=cgsccpGttPref2TblNP, cgsccpInstUDTMsgsRcvd=cgsccpInstUDTMsgsRcvd, cgsccpInstPrefTableEntries=cgsccpInstPrefTableEntries, cgsccpGttSelRefCount=cgsccpGttSelRefCount, ciscoGsccpGttSsnClassGroup=ciscoGsccpGttSsnClassGroup, cgsccpInstMapNotFound=cgsccpInstMapNotFound, cgsccpGttAppGrTable=cgsccpGttAppGrTable, cgsccpGttTranslateTable=cgsccpGttTranslateTable, cgsccpGttSelNAI=cgsccpGttSelNAI, cgsccpGttGtaQOS=cgsccpGttGtaQOS, cgsccpSSNClassUDTMsgsRcvd=cgsccpSSNClassUDTMsgsRcvd, cgsccpInstUDTMsgsSent=cgsccpInstUDTMsgsSent, ciscoGsccpGttSelGroup=ciscoGsccpGttSelGroup, cgsccpInstReassFail=cgsccpInstReassFail, ciscoGsccpNotificationsInfoGroup=ciscoGsccpNotificationsInfoGroup, cgsccpGttMapAdjacent=cgsccpGttMapAdjacent, cgsccpGttMapLastSsUsed=cgsccpGttMapLastSsUsed, cgsccpGttAppGrNewSsn=cgsccpGttAppGrNewSsn, cgsccpGttMapQ752T7E3Un=cgsccpGttMapQ752T7E3Un, cgsccpGttMapTableEntry=cgsccpGttMapTableEntry, CgsccpGttMapSsStatus=CgsccpGttMapSsStatus, cgsccpGttMapQ752T7E6=cgsccpGttMapQ752T7E6, cgsccpGttMapType=cgsccpGttMapType, cgsccpClassIdx=cgsccpClassIdx, cgsccpGttGtaTTorSSN=cgsccpGttGtaTTorSSN, cgsccpGttPref2Name=cgsccpGttPref2Name, ciscoGsccpGlobalEntryGroupSup1=ciscoGsccpGlobalEntryGroupSup1, cgsccpGttErrorsSsCongested=cgsccpGttErrorsSsCongested, CgsccpGttMultInd=CgsccpGttMultInd, cgsccpGttTranslatePeriod=cgsccpGttTranslatePeriod, cgsccpGttMapAltUsed=cgsccpGttMapAltUsed, cgsccpGttAppGr2Table=cgsccpGttAppGr2Table, cgsccpGttErrorsSccpUnavailable=cgsccpGttErrorsSccpUnavailable, cgsccpLocalDisplaySS=cgsccpLocalDisplaySS, cgsccpGttMapCongLvl3=cgsccpGttMapCongLvl3, ciscoGsccpMIB=ciscoGsccpMIB, ciscoGsccpMIBComplianceRev6=ciscoGsccpMIBComplianceRev6, cgsccpGttMapCongLvl1=cgsccpGttMapCongLvl1, cgsccpGttNextSelRefed=cgsccpGttNextSelRefed, ciscoGsccpGttLoadTable=ciscoGsccpGttLoadTable, cgsccpGttAppGrEntNum=cgsccpGttAppGrEntNum, cgsccpGttErrorsGtaNotFound=cgsccpGttErrorsGtaNotFound, cgsccpGttAppGr2Name=cgsccpGttAppGr2Name, ciscoGsccpGlobalEntryGroup=ciscoGsccpGlobalEntryGroup, cgsccpGttGtaAddrDisp=cgsccpGttGtaAddrDisp, cgsccpGttTransErrorsNotifEnabled=cgsccpGttTransErrorsNotifEnabled, cgsccpGttMapSsn=cgsccpGttMapSsn, cgsccpGttAppGr2TableEntry=cgsccpGttAppGr2TableEntry, CgsccpGttDisplaySS=CgsccpGttDisplaySS, cgsccpGttMapRowStatus=cgsccpGttMapRowStatus, cgsccpSSNNumAllows=cgsccpSSNNumAllows, cgsccpGttConPcRowStatus=cgsccpGttConPcRowStatus, cgsccpGttPref2RowStatus=cgsccpGttPref2RowStatus, cgsccpGttErrorsReassFailure=cgsccpGttErrorsReassFailure, cgsccpInstCrefToMtp=cgsccpInstCrefToMtp, cgsccpGttGtaTableEntry=cgsccpGttGtaTableEntry, cgsccpGttConPcTableEntry=cgsccpGttConPcTableEntry, cgsccpGttErrorsTable=cgsccpGttErrorsTable, CgsccpGttRoutingInd=CgsccpGttRoutingInd, ciscoGsccpGttMapStateChange=ciscoGsccpGttMapStateChange, cgsccpGttGtaResPc=cgsccpGttGtaResPc, cgsccpGttErrorsSsUnavailable=cgsccpGttErrorsSsUnavailable, ciscoGsccpGttAppGroupRev2=ciscoGsccpGttAppGroupRev2, cgsccpInstXUDTMsgsSent=cgsccpInstXUDTMsgsSent, cgsccpInstSegUnsup=cgsccpInstSegUnsup, cgsccpGttPref2ItemNAI=cgsccpGttPref2ItemNAI, ciscoGsccpMIBGroups=ciscoGsccpMIBGroups, cgsccpSSNClassTable=cgsccpSSNClassTable, cgsccpInstGtaTableEntries=cgsccpInstGtaTableEntries, cgsccpGttConPcTable=cgsccpGttConPcTable, cgsccpInstInvalidGttFormat=cgsccpInstInvalidGttFormat, cgsccpInstXUDTSMsgsRcvd=cgsccpInstXUDTSMsgsRcvd, cgsccpGttMapPc=cgsccpGttMapPc, cgsccpGttMapQ752T7E5=cgsccpGttMapQ752T7E5, cgsccpGttPref2TblNAI=cgsccpGttPref2TblNAI, cgsccpGttErrorsReassUnsupported=cgsccpGttErrorsReassUnsupported, cgsccpGttMapBackupSsn=cgsccpGttMapBackupSsn, cgsccpScalars=cgsccpScalars, cgsccpGttAppGr2NumUsed=cgsccpGttAppGr2NumUsed, cgsccpGttTranslateSample=cgsccpGttTranslateSample, cgsccpGttTranslateTS=cgsccpGttTranslateTS, cgsccpInstTotalMsgs=cgsccpInstTotalMsgs, cgsccpInstLUDTMsgsSent=cgsccpInstLUDTMsgsSent, cgsccpGttAppGrPc=cgsccpGttAppGrPc, cgsccpGttGtaRoutingInd=cgsccpGttGtaRoutingInd, CgsccpGttAppName=CgsccpGttAppName, cgsccpGttPrefTable=cgsccpGttPrefTable, cgsccpSSNEntry=cgsccpSSNEntry, cgsccpGttAppGr2AsName=cgsccpGttAppGr2AsName, ciscoGsccpGttErrors=ciscoGsccpGttErrors, CgsccpGttAppCost=CgsccpGttAppCost, cgsccpGttAppGr2Weight=cgsccpGttAppGr2Weight, cgsccpGttAppGrRowStatus=cgsccpGttAppGrRowStatus, cgsccpGttErrorsHopViolation=cgsccpGttErrorsHopViolation, ciscoGsccpGttGtaGroupRev2=ciscoGsccpGttGtaGroupRev2, cgsccpGttAppGr2Pc=cgsccpGttAppGr2Pc, cgsccpInstLUDTSMsgsSent=cgsccpInstLUDTSMsgsSent, cgsccpGttAppGr2Ri=cgsccpGttAppGr2Ri, cgsccpSSNClassEntry=cgsccpSSNClassEntry, cgsccpInstGttConfigStatus=cgsccpInstGttConfigStatus, cgsccpGttAppGr2Cost=cgsccpGttAppGr2Cost, cgsccpGttMapBackupPc=cgsccpGttMapBackupPc, cgsccpGttMapUsed=cgsccpGttMapUsed, cgsccpSSN=cgsccpSSN, cgsccpGttPrefInAddr=cgsccpGttPrefInAddr, ciscoGsccpRmtCongestion=ciscoGsccpRmtCongestion, cgsccpGttPref2Table=cgsccpGttPref2Table, CgsccpGttGtaResType=CgsccpGttGtaResType, ciscoGsccpMIBConform=ciscoGsccpMIBConform, cgsccpGttLoadTableNotifEnabled=cgsccpGttLoadTableNotifEnabled, cgsccpGttMapSccpUnavail=cgsccpGttMapSccpUnavail, cgsccpGttMapStateNotifEnabled=cgsccpGttMapStateNotifEnabled, ciscoGsccpGttErrorsGroupSup1=ciscoGsccpGttErrorsGroupSup1, cgsccpGttErrorsMapNotFound=cgsccpGttErrorsMapNotFound, cgsccpGttSelName=cgsccpGttSelName, cgsccpInstSegFail=cgsccpInstSegFail, ciscoGsccpMIBComplianceRev2=ciscoGsccpMIBComplianceRev2, ciscoGsccpMIBComplianceRev7=ciscoGsccpMIBComplianceRev7, ciscoGsccpMIBComplianceRev3=ciscoGsccpMIBComplianceRev3, cgsccpInstXUDTSMsgsAttempted=cgsccpInstXUDTSMsgsAttempted, cgsccpGttAppGrSsn=cgsccpGttAppGrSsn, cgsccpInstConPcTableEntries=cgsccpInstConPcTableEntries, cgsccpInstQ752T7E13=cgsccpInstQ752T7E13, cgsccpInstXUDTMsgsRcvd=cgsccpInstXUDTMsgsRcvd, cgsccpInstQ752T7E1=cgsccpInstQ752T7E1, cgsccpInstXUDTSMsgsSent=cgsccpInstXUDTSMsgsSent, cgsccpGttPref2EncodingScheme=cgsccpGttPref2EncodingScheme, cgsccpInstQ752Unqualified=cgsccpInstQ752Unqualified, cgsccpGttMapTable=cgsccpGttMapTable, cgsccpGttMapSSPRcvd=cgsccpGttMapSSPRcvd, ciscoGsccpNotificationsGroupSup2=ciscoGsccpNotificationsGroupSup2, cgsccpInstUDTSMsgsSent=cgsccpInstUDTSMsgsSent, cgsccpGttAppGr2=cgsccpGttAppGr2, cgsccpInstCrToMtp=cgsccpInstCrToMtp, ciscoGsccpGttAppGroup=ciscoGsccpGttAppGroup, cgsccpSSNClassXUDTMsgsSent=cgsccpSSNClassXUDTMsgsSent, cgsccpGttPrefTableEntry=cgsccpGttPrefTableEntry, cgsccpNotificationsInfo=cgsccpNotificationsInfo, ciscoGsccpGttMapGroup=ciscoGsccpGttMapGroup)
mibBuilder.exportSymbols("CISCO-ITP-GSCCP-MIB", cgsccpGttErrorsSegFailure=cgsccpGttErrorsSegFailure, CgsccpGttMapCongStatus=CgsccpGttMapCongStatus, cgsccpGttMapDisplayPC=cgsccpGttMapDisplayPC, cgsccpGttGtaSelName=cgsccpGttGtaSelName, ciscoGsccpGttAppGroupRev3=ciscoGsccpGttAppGroupRev3, cgsccpGttGta=cgsccpGttGta, cgsccpGttGtaTTorSSNvalue=cgsccpGttGtaTTorSSNvalue, cgsccpInst=cgsccpInst, cgsccpSsn=cgsccpSsn, cgsccpGttTranslateSlot=cgsccpGttTranslateSlot, cgsccpGttGtaAddrLen=cgsccpGttGtaAddrLen, cgsccpInstLocalMsgs=cgsccpInstLocalMsgs, cgsccpGttGtaResAppGroup=cgsccpGttGtaResAppGroup, cgsccpInstConfigTS=cgsccpInstConfigTS, cgsccpGttErrorsSegUnsupported=cgsccpGttErrorsSegUnsupported, cgsccpSSNNumProhibits=cgsccpSSNNumProhibits, ciscoGsccpGttPrefGroupSup1=ciscoGsccpGttPrefGroupSup1, ciscoGsccpGttSsnGroup=ciscoGsccpGttSsnGroup, ciscoGsccpInstTableEntryGroupRev1=ciscoGsccpInstTableEntryGroupRev1, ciscoGsccpMIBComplianceRev4=ciscoGsccpMIBComplianceRev4, ciscoGsccpGlobalEntryGroupRev1=ciscoGsccpGlobalEntryGroupRev1, cgsccpGttSelNP=cgsccpGttSelNP, cgsccpGttErrorsIncorrectFormat=cgsccpGttErrorsIncorrectFormat, cgsccpGttTranslatePhysicalIndex=cgsccpGttTranslatePhysicalIndex, ciscoGsccpInstTableEntryGroup=ciscoGsccpInstTableEntryGroup, cgsccpGttSelPrePrefConv=cgsccpGttSelPrePrefConv, cgsccpInstLastURL=cgsccpInstLastURL, cgsccpGttErrorRecoveryCount=cgsccpGttErrorRecoveryCount, cgsccpGttMapSsStatus=cgsccpGttMapSsStatus, cgsccpInstRsrToMtp=cgsccpInstRsrToMtp, cgsccpSSNClassLUDTMsgsRcvd=cgsccpSSNClassLUDTMsgsRcvd, cgsccpLocalSsStatus=cgsccpLocalSsStatus, cgsccpGttMapConPcList=cgsccpGttMapConPcList, cgsccpGttAppGrCost=cgsccpGttAppGrCost, cgsccpGttAppGr2NewSsn=cgsccpGttAppGr2NewSsn, cgsccpSSNClassUDTMsgsSent=cgsccpSSNClassUDTMsgsSent, cgsccpClassSsn=cgsccpClassSsn, cgsccpSSNClassLUDTMsgsSent=cgsccpSSNClassLUDTMsgsSent, cgsccpInstQ752T7E7=cgsccpInstQ752T7E7, ciscoGsccpMIBComplianceRev1=ciscoGsccpMIBComplianceRev1, cgsccpGttGtaAddr=cgsccpGttGtaAddr, cgsccpInstAppGrTableEntries=cgsccpInstAppGrTableEntries, cgsccpGttTranslate=cgsccpGttTranslate, cgsccpGttSelGTI=cgsccpGttSelGTI, ciscoGsccpGttConPcGroup=ciscoGsccpGttConPcGroup, cgsccpInstCrefFromMtp=cgsccpInstCrefFromMtp, cgsccpGttErrors=cgsccpGttErrors, cgsccpGttMapSSARcvd=cgsccpGttMapSSARcvd, cgsccpGttAppGrName=cgsccpGttAppGrName, cgsccpInstErrToMtp=cgsccpInstErrToMtp)
