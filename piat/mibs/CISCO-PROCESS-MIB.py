...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-PROCESS-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:28:52 2019
...
Counter32, Unsigned32, Gauge32, Bits, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Integer32, NotificationType, Counter64, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Gauge32", "Bits", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Integer32", "NotificationType", "Counter64", "iso", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-PROCESS-MIB", cpmThreadPriority=cpmThreadPriority, cpmCPUHistoryTable=cpmCPUHistoryTable, cpmCPUHistoryTotalUtil=cpmCPUHistoryTotalUtil, cpmCoreLoadAvg5min=cpmCoreLoadAvg5min, ciscoProcessMIBNotifs=ciscoProcessMIBNotifs, cProcessMIBComplianceRev1=cProcessMIBComplianceRev1, cpmProcessPID=cpmProcessPID, cpmCPUHistoryProcUtil=cpmCPUHistoryProcUtil, cpmCPUMemoryKernelReservedOvrflw=cpmCPUMemoryKernelReservedOvrflw, cpmCPUTotalHCGroup=cpmCPUTotalHCGroup, cpmCPUTotal5min=cpmCPUTotal5min, cpmCPURisingThresholdValue=cpmCPURisingThresholdValue, cpmVirtualProcessHCGroup=cpmVirtualProcessHCGroup, cpmThreadHCGroup=cpmThreadHCGroup, cpmCPUTotal1min=cpmCPUTotal1min, cpmProcessExtEntry=cpmProcessExtEntry, ciscoProcessMIBConformance=ciscoProcessMIBConformance, cpmCPUTotal5sec=cpmCPUTotal5sec, cpmCPUMemoryCommitted=cpmCPUMemoryCommitted, cpmProcessExtRevEntry=cpmProcessExtRevEntry, cpmCPUTotalOverflowGroup=cpmCPUTotalOverflowGroup, cpmProcExtHCMemFreedRev=cpmProcExtHCMemFreedRev, cpmThreadCpuUtilization=cpmThreadCpuUtilization, cpmCPUMemoryHCUsed=cpmCPUMemoryHCUsed, cpmProcessHCTextSegmentSize=cpmProcessHCTextSegmentSize, cpmCPUMemoryFreeOvrflw=cpmCPUMemoryFreeOvrflw, ciscoProcessMIBNotifPrefix=ciscoProcessMIBNotifPrefix, cpmProcExtUtil5Min=cpmProcExtUtil5Min, cpmCPUPosixMemoryGroup=cpmCPUPosixMemoryGroup, cpmProcessType=cpmProcessType, cpmCPUInterruptMonIntervalValue=cpmCPUInterruptMonIntervalValue, cpmProcessTimeCreated=cpmProcessTimeCreated, cpmProcExtMemAllocatedRev=cpmProcExtMemAllocatedRev, cpmVirtualProcessInvokeCount=cpmVirtualProcessInvokeCount, cpmCPUHistoryReportSize=cpmCPUHistoryReportSize, cpmThreadGroup=cpmThreadGroup, cpmProcessExtTable=cpmProcessExtTable, cpmProcExtPriorityRev=cpmProcExtPriorityRev, cpmCoreLoadAvg1min=cpmCoreLoadAvg1min, cpmCPUMemoryHCLowest=cpmCPUMemoryHCLowest, cpmProcessuSecs=cpmProcessuSecs, cpmCPUTotalGroupRev=cpmCPUTotalGroupRev, cpmCPUTotalGroupRev1=cpmCPUTotalGroupRev1, cpmCPUMemoryHCCommitted=cpmCPUMemoryHCCommitted, cProcessMIBComplianceRev4=cProcessMIBComplianceRev4, cpmCore5min=cpmCore5min, cpmProcessAverageUSecs=cpmProcessAverageUSecs, cProcessMIBComplianceRev3=cProcessMIBComplianceRev3, cpmVirtualProcess=cpmVirtualProcess, cpmProcessExtRevOverflowGroup=cpmProcessExtRevOverflowGroup, cProcessMIBComplianceRev5=cProcessMIBComplianceRev5, cpmCPUFallingThreshold=cpmCPUFallingThreshold, cpmCPUProcessHistoryTable=cpmCPUProcessHistoryTable, cpmCPUTotalPhysicalIndex=cpmCPUTotalPhysicalIndex, cpmProcessHCDynamicMemorySize=cpmProcessHCDynamicMemorySize, cpmThreadTable=cpmThreadTable, cpmProcExtMemAllocated=cpmProcExtMemAllocated, cpmProcessExtGroup=cpmProcessExtGroup, cpmCPU=cpmCPU, cpmVirtualProcessOverflowGroup=cpmVirtualProcessOverflowGroup, cpmCPULoadAvg1min=cpmCPULoadAvg1min, cpmProcessStackSizeOvrflw=cpmProcessStackSizeOvrflw, cpmThreadOverflowGroup=cpmThreadOverflowGroup, cpmThreadHCStackSize=cpmThreadHCStackSize, cpmVirtualProcessHCMemFreed=cpmVirtualProcessHCMemFreed, cpmThreadID=cpmThreadID, cpmCPUMemoryUsedOvrflw=cpmCPUMemoryUsedOvrflw, cpmProcessExtGroupRev=cpmProcessExtGroupRev, cpmThreadStackSize=cpmThreadStackSize, cpmProcessRespawnCount=cpmProcessRespawnCount, cpmVirtualProcessMemAllocatedOvrflw=cpmVirtualProcessMemAllocatedOvrflw, cpmThreadName=cpmThreadName, cpmCPUMemoryFree=cpmCPUMemoryFree, cpmVirtualProcessGroup=cpmVirtualProcessGroup, cpmProcessName=cpmProcessName, cpmPosixProcessGroup=cpmPosixProcessGroup, cpmCPUHistoryInterruptUtil=cpmCPUHistoryInterruptUtil, cpmCoreLoadAvg15min=cpmCoreLoadAvg15min, cpmVirtualProcessEntry=cpmVirtualProcessEntry, cpmCPUThresholdEntry=cpmCPUThresholdEntry, cpmCPULoadAvg15min=cpmCPULoadAvg15min, cpmProcessMemoryCore=cpmProcessMemoryCore, cpmProcessLastRestartUser=cpmProcessLastRestartUser, cpmCPUMemoryLowest=cpmCPUMemoryLowest, cpmProcessEntry=cpmProcessEntry, cpmCPUMonInterval=cpmCPUMonInterval, CPULoadAverage=CPULoadAverage, cpmProcExtUtil5SecRev=cpmProcExtUtil5SecRev, cpmCPUProcessHistoryEntry=cpmCPUProcessHistoryEntry, cpmProcExtRuntime=cpmProcExtRuntime, cpmProcessExtRevHCGroup=cpmProcessExtRevHCGroup, cpmCPUMemoryUsed=cpmCPUMemoryUsed, cpmProcExtUtil1MinRev=cpmProcExtUtil1MinRev, cpmCPUHistoryProcId=cpmCPUHistoryProcId, cProcessMIBCompliance=cProcessMIBCompliance, cpmProcessDataSegmentSize=cpmProcessDataSegmentSize, cpmProcessDataSegmentSizeOvrflw=cpmProcessDataSegmentSizeOvrflw, cpmCPUFallingThresholdPeriod=cpmCPUFallingThresholdPeriod, cpmProcessRespawnAfterLastPatch=cpmProcessRespawnAfterLastPatch, cpmProcExtPriority=cpmProcExtPriority, cpmProcessRespawn=cpmProcessRespawn, cpmCPUMemoryHCFree=cpmCPUMemoryHCFree, cpmProcessGroup=cpmProcessGroup, cpmCore1min=cpmCore1min, cpmProcExtUtil1Min=cpmProcExtUtil1Min, cpmProcessStackSize=cpmProcessStackSize, cpmProcessDynamicMemorySizeOvrflw=cpmProcessDynamicMemorySizeOvrflw, cpmProcExtHCMemAllocatedRev=cpmProcExtHCMemAllocatedRev, cpmVirtualProcessName=cpmVirtualProcessName, cpmCPUThresholdEntryStatus=cpmCPUThresholdEntryStatus, cpmCPUProcessHistoryIndex=cpmCPUProcessHistoryIndex, cpmProcessTable=cpmProcessTable, cProcessMIBComplianceRev2=cProcessMIBComplianceRev2, PYSNMP_MODULE_ID=ciscoProcessMIB, cpmThread=cpmThread, cpmVirtualProcessMemFreedOvrflw=cpmVirtualProcessMemFreedOvrflw, ciscoProcessMIB=ciscoProcessMIB, cpmCPUTotalGroup=cpmCPUTotalGroup, cpmProcessHCStackSize=cpmProcessHCStackSize, cpmCPUHistoryProcCreated=cpmCPUHistoryProcCreated, cpmCPUHistoryGroup=cpmCPUHistoryGroup, cpmProcessTextSegmentSize=cpmProcessTextSegmentSize, cpmVirtualProcessID=cpmVirtualProcessID, cpmProcExtMemFreedRev=cpmProcExtMemFreedRev, cpmCPUThresholdClass=cpmCPUThresholdClass, cpmCore5sec=cpmCore5sec, cpmThreadStackSizeOvrflw=cpmThreadStackSizeOvrflw, cpmCorePhysicalIndex=cpmCorePhysicalIndex, cpmCPUHistoryProcName=cpmCPUHistoryProcName, cpmCPULoadAvg5min=cpmCPULoadAvg5min, cpmProcessDynamicMemorySize=cpmProcessDynamicMemorySize, cpmCPUMemoryLowestOvrflw=cpmCPUMemoryLowestOvrflw, cpmCPUTotalTable=cpmCPUTotalTable, cpmProcExtUtil5Sec=cpmProcExtUtil5Sec, cpmCPUHistoryThreshold=cpmCPUHistoryThreshold, cpmProcExtRuntimeRev=cpmProcExtRuntimeRev, cpmVirtualProcessRuntime=cpmVirtualProcessRuntime, cpmCPURisingThreshold=cpmCPURisingThreshold, cpmCPUTotal5secRev=cpmCPUTotal5secRev, cpmCPUFallingThresholdValue=cpmCPUFallingThresholdValue, cpmThreadBlockingProcess=cpmThreadBlockingProcess, cpmProcExtInvokedRev=cpmProcExtInvokedRev, cpmCPUHistorySize=cpmCPUHistorySize, cpmCPUHistoryReportId=cpmCPUHistoryReportId, cpmProcExtUtil5MinRev=cpmProcExtUtil5MinRev, cpmCPUThresholdNotificationGroup=cpmCPUThresholdNotificationGroup, cpmCPUThresholdTable=cpmCPUThresholdTable, cpmCPUMemoryCommittedOvrflw=cpmCPUMemoryCommittedOvrflw, ciscoProcessMIBObjects=ciscoProcessMIBObjects, cpmCPURisingThresholdPeriod=cpmCPURisingThresholdPeriod, cpmCPUTotal5minRev=cpmCPUTotal5minRev, cpmCPUHistoryEntry=cpmCPUHistoryEntry, cpmCPULoadAvgGroup=cpmCPULoadAvgGroup, cpmVirtualProcessMemFreed=cpmVirtualProcessMemFreed, cpmVirtualProcessUtil1Min=cpmVirtualProcessUtil1Min, cpmCPUMemoryKernelReserved=cpmCPUMemoryKernelReserved, cpmCoreTable=cpmCoreTable, cpmProcess=cpmProcess, cpmProcessExtRevTable=cpmProcessExtRevTable, cpmCPUThresholdGroup=cpmCPUThresholdGroup, cpmCPUTotalIndex=cpmCPUTotalIndex, cpmProcessTextSegmentSizeOvrflw=cpmProcessTextSegmentSizeOvrflw, cpmProcessGroupRev=cpmProcessGroupRev, cpmCompliances=cpmCompliances, cpmVirtualProcessTable=cpmVirtualProcessTable, cpmVirtualProcessMemAllocated=cpmVirtualProcessMemAllocated, cpmCPUTotal1minRev=cpmCPUTotal1minRev, cpmVirtualProcessUtil5Sec=cpmVirtualProcessUtil5Sec, cpmCPUTotalMemoryCommitGroup=cpmCPUTotalMemoryCommitGroup, cpmCoreEntry=cpmCoreEntry, cpmProcExtMemFreed=cpmProcExtMemFreed, cpmCPUTotalMonIntervalValue=cpmCPUTotalMonIntervalValue, cpmCPUHistory=cpmCPUHistory, cpmThreadState=cpmThreadState, cpmCPUTotalEntry=cpmCPUTotalEntry, cpmThreadEntry=cpmThreadEntry, cpmVirtualProcessUtil5Min=cpmVirtualProcessUtil5Min, cpmCPUHistoryCreatedTime=cpmCPUHistoryCreatedTime, cpmVirtualProcessHCMemAllocated=cpmVirtualProcessHCMemAllocated, cpmProcExtInvoked=cpmProcExtInvoked, cpmProcExtMemFreedRevOvrflw=cpmProcExtMemFreedRevOvrflw, cpmProcExtMemAllocatedRevOvrflw=cpmProcExtMemAllocatedRevOvrflw, cpmCPUMemoryHCKernelReserved=cpmCPUMemoryHCKernelReserved, cpmGroups=cpmGroups, cpmProcessHCDataSegmentSize=cpmProcessHCDataSegmentSize, cpmCoreIndex=cpmCoreIndex, cProcessMIBComplianceRev=cProcessMIBComplianceRev, cpmCoreGroup=cpmCoreGroup)
