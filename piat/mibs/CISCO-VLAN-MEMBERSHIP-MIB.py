...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-VLAN-MEMBERSHIP-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:27:39 2019
...
ModuleIdentity, IpAddress, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Integer32, Bits, Counter32, iso, Counter64, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Integer32", "Bits", "Counter32", "iso", "Counter64", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-VLAN-MEMBERSHIP-MIB", vmMembershipGroup3=vmMembershipGroup3, vmMembershipSummaryTable=vmMembershipSummaryTable, vmPortStatus=vmPortStatus, vmVQPWrongDomain=vmVQPWrongDomain, vmMembershipPortRangeIndex=vmMembershipPortRangeIndex, vmStatus=vmStatus, vmVmpsRetries=vmVmpsRetries, vmVmpsCurrent=vmVmpsCurrent, ciscoVlanMembershipMIBObjects=ciscoVlanMembershipMIBObjects, vmVQPDenied=vmVQPDenied, vmVoiceVlanTable=vmVoiceVlanTable, vmMIBCompliance7=vmMIBCompliance7, vmVoiceVlanGroup=vmVoiceVlanGroup, vmVoiceVlanCdpVerifyEnable=vmVoiceVlanCdpVerifyEnable, vmVmpsVQPVersion=vmVmpsVQPVersion, vmVQPClientGroup=vmVQPClientGroup, vmVlans3k=vmVlans3k, vmMembershipGroup=vmMembershipGroup, vmVlans=vmVlans, vmVQPWrongVersion=vmVQPWrongVersion, vmStatusGroup=vmStatusGroup, vmVQPShutdown=vmVQPShutdown, vmVlans2k=vmVlans2k, vmMIBGroups=vmMIBGroups, vmVmpsReconfirm=vmVmpsReconfirm, vmMembership=vmMembership, vmVlanType=vmVlanType, vm1kVlanGroup=vm1kVlanGroup, vmVoiceVlanEntry=vmVoiceVlanEntry, vmVlanCreationGroup=vmVlanCreationGroup, vmMembershipEntry=vmMembershipEntry, vmMembershipSummaryEntry=vmMembershipSummaryEntry, vmMembershipSummaryExtTable=vmMembershipSummaryExtTable, vmVQPResponses=vmVQPResponses, vmMembershipSummaryMemberPorts=vmMembershipSummaryMemberPorts, vmNotifications=vmNotifications, vmMembershipTable=vmMembershipTable, vmVlans4k=vmVlans4k, vmMIBCompliance6=vmMIBCompliance6, vmVQPNotificationsGroup=vmVQPNotificationsGroup, vmVmpsChange=vmVmpsChange, vmVmpsReconfirmResult=vmVmpsReconfirmResult, vmVmpsPrimary=vmVmpsPrimary, vmMembershipExtGroup=vmMembershipExtGroup, vmVoiceVlanExtGroup=vmVoiceVlanExtGroup, vmVQPQueries=vmVQPQueries, vmVmpsIpAddress=vmVmpsIpAddress, vmVmpsRowStatus=vmVmpsRowStatus, vmVmpsChanges=vmVmpsChanges, vmMembershipSummaryMember2kPorts=vmMembershipSummaryMember2kPorts, vmNotificationsEnabled=vmNotificationsEnabled, vmMIBCompliances=vmMIBCompliances, vmVmps=vmVmps, vmMIBCompliance=vmMIBCompliance, vmMIBCompliance2=vmMIBCompliance2, vmMembershipGroup2=vmMembershipGroup2, vm4kVlanGroup=vm4kVlanGroup, vmVlan=vmVlan, PYSNMP_MODULE_ID=ciscoVlanMembershipMIB, vmVoiceVlanId=vmVoiceVlanId, vmVoiceVlan=vmVoiceVlan, vmNotificationsPrefix=vmNotificationsPrefix, vmVlanCreationMode=vmVlanCreationMode, ciscoVlanMembershipMIB=ciscoVlanMembershipMIB, vmStatistics=vmStatistics, vmMembershipSummaryVlanIndex=vmMembershipSummaryVlanIndex, vmMIBConformance=vmMIBConformance, vmMIBCompliance3=vmMIBCompliance3, vmInsufficientResources=vmInsufficientResources, vmMIBCompliance4=vmMIBCompliance4, vmVmpsReconfirmInterval=vmVmpsReconfirmInterval, vmVmpsTable=vmVmpsTable, vmMIBCompliance5=vmMIBCompliance5, vmVmpsEntry=vmVmpsEntry, vmMembershipSummaryExtPorts=vmMembershipSummaryExtPorts, vmMembershipSummaryExtEntry=vmMembershipSummaryExtEntry)
