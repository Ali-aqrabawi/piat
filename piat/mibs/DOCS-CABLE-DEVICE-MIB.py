...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/DOCS-CABLE-DEVICE-MIB
...
diffServMIBClfrElementGroup, diffServMIBDataPathGroup, diffServMultiFieldClfrSrcAddr, diffServMIBActionGroup, diffServMIBClfrGroup, diffServMIBCounterGroup, diffServClfrStorage, diffServMultiFieldClfrAddrType, diffServDataPathStorage, diffServMultiFieldClfrDstAddr, diffServClfrElementStorage, diffServClfrStatus, diffServDataPathStatus, diffServAlgDropStatus, diffServCountActStorage, diffServAlgDropType, diffServActionStorage, diffServMIBMultiFieldClfrGroup, diffServMIBAlgDropGroup, diffServAlgDropStorage, diffServClfrElementStatus, diffServMIBDscpMarkActGroup, diffServMultiFieldClfrStorage = mibBuilder.importSymbols("DIFFSERV-MIB", "diffServMIBClfrElementGroup", "diffServMIBDataPathGroup", "diffServMultiFieldClfrSrcAddr", "diffServMIBActionGroup", "diffServMIBClfrGroup", "diffServMIBCounterGroup", "diffServClfrStorage", "diffServMultiFieldClfrAddrType", "diffServDataPathStorage", "diffServMultiFieldClfrDstAddr", "diffServClfrElementStorage", "diffServClfrStatus", "diffServDataPathStatus", "diffServAlgDropStatus", "diffServCountActStorage", "diffServAlgDropType", "diffServActionStorage", "diffServMIBMultiFieldClfrGroup", "diffServMIBAlgDropGroup", "diffServAlgDropStorage", "diffServClfrElementStatus", "diffServMIBDscpMarkActGroup", "diffServMultiFieldClfrStorage")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
InetAddress, InetAddressType = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddress", "InetAddressType")
ZeroBasedCounter32, = mibBuilder.importSymbols("RMON2-MIB", "ZeroBasedCounter32")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Bits, zeroDotZero, mib_2, Unsigned32, TimeTicks, MibIdentifier, Counter64, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, iso, ModuleIdentity, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "zeroDotZero", "mib-2", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter64", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "iso", "ModuleIdentity", "IpAddress", "Counter32")
DisplayString, DateAndTime, RowStatus, StorageType, TextualConvention, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "RowStatus", "StorageType", "TextualConvention", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-CABLE-DEVICE-MIB", docsDevCpeInetRowStatus=docsDevCpeInetRowStatus, docsDevNmAccessTrapVersion=docsDevNmAccessTrapVersion, docsDevFilterIpDaddr=docsDevFilterIpDaddr, docsDevSoftwareGroup=docsDevSoftwareGroup, docsDevEvControl=docsDevEvControl, docsDevFilterLLCGroup=docsDevFilterLLCGroup, docsDevEvThrottleThreshold=docsDevEvThrottleThreshold, docsDevFilterPolicyIndex=docsDevFilterPolicyIndex, docsDevFilterTosTable=docsDevFilterTosTable, docsDevNmAccessGroup=docsDevNmAccessGroup, docsDevServerTimeAddressType=docsDevServerTimeAddressType, docsDevSwFilename=docsDevSwFilename, docsDevSwOperStatus=docsDevSwOperStatus, docsDevNmAccessControl=docsDevNmAccessControl, docsDevNmAccessTable=docsDevNmAccessTable, docsDevGroupsV2=docsDevGroupsV2, docsDevFilterIpIndex=docsDevFilterIpIndex, docsDevEvThrottleInterval=docsDevEvThrottleInterval, docsDevEvReporting=docsDevEvReporting, docsDevSTPControl=docsDevSTPControl, docsDevFilterPolicyTable=docsDevFilterPolicyTable, docsDevNotification=docsDevNotification, docsDevFilterLLCProtocol=docsDevFilterLLCProtocol, docsDevServerTime=docsDevServerTime, docsDevServerTimeAddress=docsDevServerTimeAddress, docsDevEvPriority=docsDevEvPriority, docsDevFilterIpDirection=docsDevFilterIpDirection, docsDevFilterIpDestPortHigh=docsDevFilterIpDestPortHigh, docsDevFilterIpIfIndex=docsDevFilterIpIfIndex, docsDevCpeSource=docsDevCpeSource, docsDevNmAccessExtGroup=docsDevNmAccessExtGroup, docsDevCpeInetEntry=docsDevCpeInetEntry, docsDevEvText=docsDevEvText, docsDevCpeInetTable=docsDevCpeInetTable, docsDevCpeInetAddr=docsDevCpeInetAddr, docsDevEvSyslogAddressType=docsDevEvSyslogAddressType, docsDevEvSyslogAddress=docsDevEvSyslogAddress, docsDevEvThrottleThresholdExceeded=docsDevEvThrottleThresholdExceeded, docsDevEvFirstTime=docsDevEvFirstTime, docsDevServerTftp=docsDevServerTftp, docsDevIgmpModeControl=docsDevIgmpModeControl, docsDevCpeTable=docsDevCpeTable, docsDevFilterPolicyEntry=docsDevFilterPolicyEntry, docsDevEvLevel=docsDevEvLevel, docsDevFilterIpDmask=docsDevFilterIpDmask, docsDevNmAccessInterfaces=docsDevNmAccessInterfaces, docsDevNmAccessStatus=docsDevNmAccessStatus, docsDevEvThrottleInhibited=docsDevEvThrottleInhibited, docsDevEvThrottleAdminStatus=docsDevEvThrottleAdminStatus, docsDevCpeStatus=docsDevCpeStatus, docsDevFilterIpProtocol=docsDevFilterIpProtocol, docsDevFilterIpDefault=docsDevFilterIpDefault, docsDevCpeIp=docsDevCpeIp, docsDevFilterPolicyPtr=docsDevFilterPolicyPtr, docsDevFilterIpStatus=docsDevFilterIpStatus, docsDevFilterIpPolicyId=docsDevFilterIpPolicyId, docsDevBasicCompliance=docsDevBasicCompliance, docsDevSwServer=docsDevSwServer, docsDevFilterTosStatus=docsDevFilterTosStatus, docsDevNmAccessCommunity=docsDevNmAccessCommunity, docsDevFilterTosOrMask=docsDevFilterTosOrMask, docsDevCpeGroup=docsDevCpeGroup, docsDevFilterIpTosMask=docsDevFilterIpTosMask, docsDevFilterIpEntry=docsDevFilterIpEntry, docsDevFilterTosAndMask=docsDevFilterTosAndMask, docsDevConformance=docsDevConformance, docsDevNmAccessEntry=docsDevNmAccessEntry, docsDevFilterIpTos=docsDevFilterIpTos, docsDevServerGroup=docsDevServerGroup, docsDevFilterGroup=docsDevFilterGroup, docsDevEventEntry=docsDevEventEntry, docsDevSoftwareGroupV2=docsDevSoftwareGroupV2, docsDevCpeInetType=docsDevCpeInetType, docsDevEvId=docsDevEvId, docsDevEvent=docsDevEvent, docsDevEventGroupV2=docsDevEventGroupV2, docsDevCompliances=docsDevCompliances, docsDevNmAccessIpMask=docsDevNmAccessIpMask, docsDevSoftware=docsDevSoftware, docsDevRole=docsDevRole, docsDevMIBObjects=docsDevMIBObjects, docsDevCpe=docsDevCpe, docsDevMaxCpe=docsDevMaxCpe, docsDevNmAccessIp=docsDevNmAccessIp, docsDevServerGroupV2=docsDevServerGroupV2, docsDevBaseMaxCpeGroup=docsDevBaseMaxCpeGroup, docsDevServerDhcpAddressType=docsDevServerDhcpAddressType, docsDevFilterIpSourcePortHigh=docsDevFilterIpSourcePortHigh, docsDevBase=docsDevBase, docsDevEvSyslog=docsDevEvSyslog, docsDevFilterIpMatches=docsDevFilterIpMatches, docsDevFilterIpDestPortLow=docsDevFilterIpDestPortLow, docsDevServerDhcp=docsDevServerDhcp, docsDevFilterIpSmask=docsDevFilterIpSmask, docsDevEvLastTime=docsDevEvLastTime, docsDevFilter=docsDevFilter, docsDevCpeIpMax=docsDevCpeIpMax, PYSNMP_MODULE_ID=docsDev, docsDevEvIndex=docsDevEvIndex, docsDevServerConfigFile=docsDevServerConfigFile, docsDevSerialNumber=docsDevSerialNumber, docsDevFilterLLCUnmatchedAction=docsDevFilterLLCUnmatchedAction, docsDevFilterLLCMatches=docsDevFilterLLCMatches, docsDevFilterLLCTable=docsDevFilterLLCTable, docsDevSwServerTransportProtocol=docsDevSwServerTransportProtocol, docsDevServerDhcpAddress=docsDevServerDhcpAddress, docsDevSwServerAddress=docsDevSwServerAddress, docsDevFilterLLCProtocolType=docsDevFilterLLCProtocolType, docsDevGroups=docsDevGroups, docsDevBaseIgmpGroup=docsDevBaseIgmpGroup, docsDevCmCompliance=docsDevCmCompliance, docsDevFilterIpContinue=docsDevFilterIpContinue, docsDevFilterLLCIndex=docsDevFilterLLCIndex, docsDevFilterPolicyStatus=docsDevFilterPolicyStatus, docsDevServerBootState=docsDevServerBootState, docsDevServer=docsDevServer, docsDevEvCounts=docsDevEvCounts, docsDevInetCpeGroup=docsDevInetCpeGroup, docsDevSwCurrentVers=docsDevSwCurrentVers, docsDevEvControlEntry=docsDevEvControlEntry, docsDevFilterIpTable=docsDevFilterIpTable, docsDevCompliancesV2=docsDevCompliancesV2, docsDev=docsDev, docsDevEvControlTable=docsDevEvControlTable, docsDevNmAccessIndex=docsDevNmAccessIndex, docsDevSwAdminStatus=docsDevSwAdminStatus, docsDevCpeEntry=docsDevCpeEntry, docsDevFilterLLCStatus=docsDevFilterLLCStatus, docsDevEventGroup=docsDevEventGroup, docsDevNotifications=docsDevNotifications, docsDevFilterLLCIfIndex=docsDevFilterLLCIfIndex, docsDevFilterIpSourcePortLow=docsDevFilterIpSourcePortLow, docsDevServerConfigTftpAddressType=docsDevServerConfigTftpAddressType, docsDevFilterTosIndex=docsDevFilterTosIndex, docsDevEventTable=docsDevEventTable, docsDevResetNow=docsDevResetNow, docsDevCpeEnroll=docsDevCpeEnroll, docsDevDateTime=docsDevDateTime, docsDevFilterLLCEntry=docsDevFilterLLCEntry, docsDevCmtsCompliance=docsDevCmtsCompliance, docsDevCpeInetSource=docsDevCpeInetSource, docsDevFilterPolicyId=docsDevFilterPolicyId, docsDevBaseGroup=docsDevBaseGroup, docsDevFilterTosEntry=docsDevFilterTosEntry, docsDevFilterIpBroadcast=docsDevFilterIpBroadcast, docsDevFilterIpControl=docsDevFilterIpControl, docsDevServerConfigTftpAddress=docsDevServerConfigTftpAddress, docsDevSwServerAddressType=docsDevSwServerAddressType, docsDevFilterIpSaddr=docsDevFilterIpSaddr)
