...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/MPLS-VPN-MIB
...
ModuleIdentity, Counter32, Bits, Counter64, experimental, IpAddress, Gauge32, Integer32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Bits", "Counter64", "experimental", "IpAddress", "Gauge32", "Integer32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Unsigned32", "NotificationType")
TimeStamp, RowStatus, TruthValue, TextualConvention, DisplayString, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TruthValue", "TextualConvention", "DisplayString", "StorageType")
...
mibBuilder.exportSymbols("MPLS-VPN-MIB", mplsVpnVrfBgpPAtrASPathSegment=mplsVpnVrfBgpPAtrASPathSegment, mplsVpnVrfBgpNbrAddrTable=mplsVpnVrfBgpNbrAddrTable, mplsNumVrfSecIllglLblThrshExcd=mplsNumVrfSecIllglLblThrshExcd, mplsVpnObjects=mplsVpnObjects, mplsNumVrfRouteMidThreshExceeded=mplsNumVrfRouteMidThreshExceeded, mplsVpnVrfBgpPAtrLocalPref=mplsVpnVrfBgpPAtrLocalPref, mplsVpnVrfBgpPAtrIpAddrPrefixLen=mplsVpnVrfBgpPAtrIpAddrPrefixLen, mplsVpnVrfConfRouteMaxThreshTime=mplsVpnVrfConfRouteMaxThreshTime, mplsVpnVrfBgpPAtrCalcLocalPref=mplsVpnVrfBgpPAtrCalcLocalPref, mplsVpnVrfRouteType=mplsVpnVrfRouteType, mplsVpnIfConfStorageType=mplsVpnIfConfStorageType, mplsVpnVrfBgpNbrStorageType=mplsVpnVrfBgpNbrStorageType, mplsVpnVrfBgpPAtrMultiExitDisc=mplsVpnVrfBgpPAtrMultiExitDisc, mplsVpnConnectedInterfaces=mplsVpnConnectedInterfaces, mplsVpnIfGroup=mplsVpnIfGroup, mplsVpnConfiguredVrfs=mplsVpnConfiguredVrfs, mplsVpnIfConfTable=mplsVpnIfConfTable, mplsVpnVrfConfMidRouteThreshold=mplsVpnVrfConfMidRouteThreshold, mplsVpnVrfConfRowStatus=mplsVpnVrfConfRowStatus, mplsVpnPerfGroup=mplsVpnPerfGroup, mplsVpnVrfBgpNbrPrefixEntry=mplsVpnVrfBgpNbrPrefixEntry, MplsVpnRouteDistinguisher=MplsVpnRouteDistinguisher, mplsVpnIfConfRowStatus=mplsVpnIfConfRowStatus, mplsVpnModuleCompliance=mplsVpnModuleCompliance, mplsVpnVrfRouteMetric4=mplsVpnVrfRouteMetric4, mplsVpnVrfBgpPAtrNextHop=mplsVpnVrfBgpPAtrNextHop, mplsVpnVrfRouteTable=mplsVpnVrfRouteTable, mplsVpnVrfPerfTable=mplsVpnVrfPerfTable, mplsVpnVrfBgpPAtrAggregatorAddr=mplsVpnVrfBgpPAtrAggregatorAddr, mplsVpnVrfPerfEntry=mplsVpnVrfPerfEntry, mplsVpnVrfRouteDistinguisher=mplsVpnVrfRouteDistinguisher, mplsVpnVrfRouteProto=mplsVpnVrfRouteProto, mplsVpnVrfCreationTime=mplsVpnVrfCreationTime, mplsVpnVrfRouteTargetIndex=mplsVpnVrfRouteTargetIndex, mplsVpnVrfPerfRoutesAdded=mplsVpnVrfPerfRoutesAdded, mplsVpnVrfRouteIfIndex=mplsVpnVrfRouteIfIndex, mplsVpnVrfBgpPAtrPeer=mplsVpnVrfBgpPAtrPeer, mplsVrfIfDown=mplsVrfIfDown, mplsVpnVrfRouteDestAddrType=mplsVpnVrfRouteDestAddrType, mplsVpnVrfRouteTargetDescr=mplsVpnVrfRouteTargetDescr, PYSNMP_MODULE_ID=mplsVpnMIB, mplsVpnVrfVpnId=mplsVpnVrfVpnId, mplsVpnVrfRouteTargetTable=mplsVpnVrfRouteTargetTable, mplsVpnVrfTable=mplsVpnVrfTable, mplsVpnVrfBgpPAtrOrigin=mplsVpnVrfBgpPAtrOrigin, mplsVpnVrfRouteStorageType=mplsVpnVrfRouteStorageType, mplsVpnVrfActiveInterfaces=mplsVpnVrfActiveInterfaces, mplsVpnVrfAssociatedInterfaces=mplsVpnVrfAssociatedInterfaces, mplsVpnVrfSecTable=mplsVpnVrfSecTable, mplsVpnCompliances=mplsVpnCompliances, mplsVpnConformance=mplsVpnConformance, mplsVpnVrfBgpPAtrUnknown=mplsVpnVrfBgpPAtrUnknown, mplsVpnVrfBgpNbrGroup=mplsVpnVrfBgpNbrGroup, mplsVpnVrfPerfCurrNumRoutes=mplsVpnVrfPerfCurrNumRoutes, mplsVpnVrfRouteTargetType=mplsVpnVrfRouteTargetType, mplsVpnVrfBgpPAtrAggregatorAS=mplsVpnVrfBgpPAtrAggregatorAS, mplsVpnVrfOperStatus=mplsVpnVrfOperStatus, mplsVpnVrfSecEntry=mplsVpnVrfSecEntry, mplsVpnVrfBgpPAtrBest=mplsVpnVrfBgpPAtrBest, mplsVpnActiveVrfs=mplsVpnActiveVrfs, mplsVpnVrfDescription=mplsVpnVrfDescription, mplsVpnVrfRouteMetric3=mplsVpnVrfRouteMetric3, mplsVpnScalarGroup=mplsVpnScalarGroup, mplsVpnVrfRouteMask=mplsVpnVrfRouteMask, mplsVpnVrfConfHighRouteThreshold=mplsVpnVrfConfHighRouteThreshold, mplsVpnVrfConfStorageType=mplsVpnVrfConfStorageType, mplsVpnVrfBgpNbrType=mplsVpnVrfBgpNbrType, mplsVpnVrfRouteNextHopAddrType=mplsVpnVrfRouteNextHopAddrType, mplsVpnVrfRouteTargetGroup=mplsVpnVrfRouteTargetGroup, mplsVpnVrfSecIllegalLblVltns=mplsVpnVrfSecIllegalLblVltns, mplsVpnNotificationGroup=mplsVpnNotificationGroup, mplsVpnMIB=mplsVpnMIB, mplsVpnVrfConfMaxPossibleRoutes=mplsVpnVrfConfMaxPossibleRoutes, mplsVpnVrfBgpPrefixGroup=mplsVpnVrfBgpPrefixGroup, mplsVpnVrfPerfRoutesDeleted=mplsVpnVrfPerfRoutesDeleted, mplsVpnVrfBgpNbrAddr=mplsVpnVrfBgpNbrAddr, MplsVpnName=MplsVpnName, mplsVpnVrfRouteDest=mplsVpnVrfRouteDest, mplsVpnVrfSecIllegalLblRcvThrsh=mplsVpnVrfSecIllegalLblRcvThrsh, mplsVpnVrfConfMaxRoutes=mplsVpnVrfConfMaxRoutes, mplsVpnVrfRouteEntry=mplsVpnVrfRouteEntry, mplsVpnGroups=mplsVpnGroups, mplsVpnVrfRouteTarget=mplsVpnVrfRouteTarget, mplsVrfIfUp=mplsVrfIfUp, mplsVpnVrfRouteNextHopAS=mplsVpnVrfRouteNextHopAS, mplsVpnVrfRouteMetric5=mplsVpnVrfRouteMetric5, mplsVpnScalars=mplsVpnScalars, mplsVpnVrfRouteMaskAddrType=mplsVpnVrfRouteMaskAddrType, mplsVpnVrfBgpNbrPrefixTable=mplsVpnVrfBgpNbrPrefixTable, mplsVpnRoute=mplsVpnRoute, mplsVpnVrfRouteTargetEntry=mplsVpnVrfRouteTargetEntry, mplsVpnNotifications=mplsVpnNotifications, mplsVpnVrfEntry=mplsVpnVrfEntry, mplsVpnVrfName=mplsVpnVrfName, mplsVpnIfConfIndex=mplsVpnIfConfIndex, mplsVpnVrfRouteMetric2=mplsVpnVrfRouteMetric2, mplsNumVrfRouteMaxThreshExceeded=mplsNumVrfRouteMaxThreshExceeded, mplsVpnVrfBgpNbrAddrEntry=mplsVpnVrfBgpNbrAddrEntry, mplsVpnVrfRouteGroup=mplsVpnVrfRouteGroup, mplsVpnConf=mplsVpnConf, mplsVpnVrfBgpNbrRole=mplsVpnVrfBgpNbrRole, mplsVpnNotificationEnable=mplsVpnNotificationEnable, mplsVpnIfVpnClassification=mplsVpnIfVpnClassification, mplsVpnVrfBgpNbrIndex=mplsVpnVrfBgpNbrIndex, mplsVpnVrfBgpNbrRowStatus=mplsVpnVrfBgpNbrRowStatus, mplsVpnIfLabelEdgeType=mplsVpnIfLabelEdgeType, mplsVpnVrfRouteNextHop=mplsVpnVrfRouteNextHop, mplsVpnVrfGroup=mplsVpnVrfGroup, mplsVpnVrfRouteMetric1=mplsVpnVrfRouteMetric1, mplsVpnPerf=mplsVpnPerf, mplsVpnVrfRouteTos=mplsVpnVrfRouteTos, mplsVpnVrfRouteAge=mplsVpnVrfRouteAge, mplsVpnSecGroup=mplsVpnSecGroup, mplsVpnVrfRouteTargetRowStatus=mplsVpnVrfRouteTargetRowStatus, mplsVpnVrfRouteInfo=mplsVpnVrfRouteInfo, mplsVpnVrfBgpPAtrAtomicAggregate=mplsVpnVrfBgpPAtrAtomicAggregate, mplsVpnVrfRouteRowStatus=mplsVpnVrfRouteRowStatus, mplsVpnIfConfEntry=mplsVpnIfConfEntry, mplsVpnVrfConfLastChanged=mplsVpnVrfConfLastChanged, mplsVpnIfVpnRouteDistProtocol=mplsVpnIfVpnRouteDistProtocol, mplsVpnVrfBgpPAtrIpAddrPrefix=mplsVpnVrfBgpPAtrIpAddrPrefix)
