...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/AIRESPACE-SWITCHING-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:28:18 2019
...
NotificationType, Integer32, Bits, ModuleIdentity, Counter32, IpAddress, iso, Gauge32, TimeTicks, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "iso", "Gauge32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64")
TextualConvention, RowStatus, MacAddress, PhysAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "MacAddress", "PhysAddress", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("AIRESPACE-SWITCHING-MIB", agentSerialParityType=agentSerialParityType, switchingTraps=switchingTraps, agentInterfaceType=agentInterfaceType, agentSwitchInfoGroup=agentSwitchInfoGroup, agentNetworkRouteIPNetmask=agentNetworkRouteIPNetmask, agentNtpServerEntry=agentNtpServerEntry, agentDhcpScopeRowStatus=agentDhcpScopeRowStatus, agentFreeMemory=agentFreeMemory, agentNetworkWebAdminCertRegenerateCmdInvoke=agentNetworkWebAdminCertRegenerateCmdInvoke, agentNetworkRouteConfigTable=agentNetworkRouteConfigTable, agentDhcpScopeNetbiosNameServerAddress2=agentDhcpScopeNetbiosNameServerAddress2, agentDhcpScopeDefaultRouterAddress3=agentDhcpScopeDefaultRouterAddress3, agentInterfaceDnsHostName=agentInterfaceDnsHostName, productGroup4=productGroup4, agentTotalMemory=agentTotalMemory, agentApCoverageProfileFailTrapCount=agentApCoverageProfileFailTrapCount, vlanDeleteLastTrap=vlanDeleteLastTrap, agentLoginSessionUserName=agentLoginSessionUserName, agentLagDetailedConfigTable=agentLagDetailedConfigTable, agentLagDetailedPortSpeed=agentLagDetailedPortSpeed, agentNetworkGvrpStatus=agentNetworkGvrpStatus, agentWcpControllerInfoSlotNumber=agentWcpControllerInfoSlotNumber, agentDhcpScopeDnsServerAddress2=agentDhcpScopeDnsServerAddress2, agentSnmpVersion1Status=agentSnmpVersion1Status, agentSwitchAddressAgingTimeoutTable=agentSwitchAddressAgingTimeoutTable, agentProductGroup=agentProductGroup, agentWcpPeerPortNumber=agentWcpPeerPortNumber, agentLagSummaryPortsBitMask=agentLagSummaryPortsBitMask, agentTransferDownloadFilename=agentTransferDownloadFilename, agentTrapLogTotal=agentTrapLogTotal, agentSnmpAuthenticationTrapFlag=agentSnmpAuthenticationTrapFlag, agentNetworkMulticastMode=agentNetworkMulticastMode, agentSnmpCommunityStatus=agentSnmpCommunityStatus, agentInventoryFipsModeEnabled=agentInventoryFipsModeEnabled, agentInventoryIsGigECardPresent=agentInventoryIsGigECardPresent, portStatsPktsTx1519to1530Octets=portStatsPktsTx1519to1530Octets, agentTrapLogTrap=agentTrapLogTrap, agentTrapLogGroup=agentTrapLogGroup, agentLagSummaryFlushTimer=agentLagSummaryFlushTimer, agentInventoryProductName=agentInventoryProductName, agentNetworkManagementVlan=agentNetworkManagementVlan, agentSaveConfig=agentSaveConfig, powerSupplyStatusChangeTrap=powerSupplyStatusChangeTrap, portStatsPktsTx128to255Octets=portStatsPktsTx128to255Octets, agentSwitchInfoPowerSupply2Present=agentSwitchInfoPowerSupply2Present, agentPortSTPMode=agentPortSTPMode, agentNetworkPeerToPeerBlockingMode=agentNetworkPeerToPeerBlockingMode, agentNtpServerTable=agentNtpServerTable, bsnSwitchingCompliances=bsnSwitchingCompliances, agentInventorySysDescription=agentInventorySysDescription, agentInterfaceAPManagementFeature=agentInterfaceAPManagementFeature, bsnSwitchingAgentInfoGroup=bsnSwitchingAgentInfoGroup, agentPortIfIndex=agentPortIfIndex, agentSSHAllowNewMode=agentSSHAllowNewMode, agentTransferConfigGroup=agentTransferConfigGroup, agentTrapLogEntry=agentTrapLogEntry, agentInventoryIsForeignAPSupported=agentInventoryIsForeignAPSupported, agentApLoadProfileFailTrapCount=agentApLoadProfileFailTrapCount, agentNetworkWebMode=agentNetworkWebMode, agentLagSummaryConfigTable=agentLagSummaryConfigTable, agentSnmpV3UserConfigEntry=agentSnmpV3UserConfigEntry, agentCurrentCPUUtilization=agentCurrentCPUUtilization, agentSnmpV3UserAuthenticationType=agentSnmpV3UserAuthenticationType, agentPortConfigTable=agentPortConfigTable, agentLoginSessionIndex=agentLoginSessionIndex, vlanRestoreFailureTrap=vlanRestoreFailureTrap, agentWcpControllerInfoTable=agentWcpControllerInfoTable, agentNetworkWebAuthCertRegenerateCmdInvoke=agentNetworkWebAuthCertRegenerateCmdInvoke, agentPortDot1dBasePort=agentPortDot1dBasePort, vlanDefaultCfgFailureTrap=vlanDefaultCfgFailureTrap, agentNetworkDsPortNumber=agentNetworkDsPortNumber, bsnSwitchingAgentSystemGroup=bsnSwitchingAgentSystemGroup, agentLagDetailedLagIndex=agentLagDetailedLagIndex, agentInterfaceName=agentInterfaceName, agentInventoryMachineModel=agentInventoryMachineModel, agentSerialCharacterSize=agentSerialCharacterSize, agentSnmpTrapReceiverStatus=agentSnmpTrapReceiverStatus, agentInterfaceDhcpProtocol=agentInterfaceDhcpProtocol, agentClearConfig=agentClearConfig, agentSwitchInfoPowerSupply1Present=agentSwitchInfoPowerSupply1Present, bsnSwitchingTrap=bsnSwitchingTrap, agentInventoryMachineType=agentInventoryMachineType, agentInventorySerialNumber=agentInventorySerialNumber, bsnSwitchingObsGroup=bsnSwitchingObsGroup, agentInterfaceConfigEntry=agentInterfaceConfigEntry, agentDhcpScopeLeaseTime=agentDhcpScopeLeaseTime, agentNetworkUserIdleTimeout=agentNetworkUserIdleTimeout, agentSwitchInfoLwappTransportMode=agentSwitchInfoLwappTransportMode, portStatsPktsTx65to127Octets=portStatsPktsTx65to127Octets, agentSnmpV3ConfigGroup=agentSnmpV3ConfigGroup, agentLoginSessionConnectionType=agentLoginSessionConnectionType, agentSwitchAddressAgingTimeoutEntry=agentSwitchAddressAgingTimeoutEntry, agentSwitchInfoPowerSupply1Operational=agentSwitchInfoPowerSupply1Operational, agentInventoryGroup=agentInventoryGroup, agentServicePortIPAddress=agentServicePortIPAddress, agentWcpControllerInfoPortNumber=agentWcpControllerInfoPortNumber, agentTransferDownloadTftpTimeout=agentTransferDownloadTftpTimeout, agentLoginSessionTable=agentLoginSessionTable, agentNetworkRouteIPAddress=agentNetworkRouteIPAddress, agentNtpPollingInterval=agentNtpPollingInterval, agentDot3adAggPortLACPMode=agentDot3adAggPortLACPMode, agentDhcpScopeDnsDomainName=agentDhcpScopeDnsDomainName, agentSnmpBroadcastStormTrapFlag=agentSnmpBroadcastStormTrapFlag, agentSnmpV3UserAuthenticationPassword=agentSnmpV3UserAuthenticationPassword, agentTransferConfigurationFileEncryptionKey=agentTransferConfigurationFileEncryptionKey, agentSnmpCommunityConfigEntry=agentSnmpCommunityConfigEntry, portStatsEntry=portStatsEntry, fanFailureTrap=fanFailureTrap, agentPortType=agentPortType, agentLagDetailedIfIndex=agentLagDetailedIfIndex, agentInterfaceMacAddress=agentInterfaceMacAddress, portStatsPktsTx64Octets=portStatsPktsTx64Octets, agentSnmpV3UserAccessMode=agentSnmpV3UserAccessMode, agentSnmpV3UserConfigTable=agentSnmpV3UserConfigTable, agentLagConfigGroup=agentLagConfigGroup, agentServicePortConfigGroup=agentServicePortConfigGroup, PYSNMP_MODULE_ID=bsnSwitching, agentServicePortBurnedInMacAddress=agentServicePortBurnedInMacAddress, agentWcpControllerInfoIpAddress=agentWcpControllerInfoIpAddress, agentTelnetLoginTimeout=agentTelnetLoginTimeout, agentSerialBaudrate=agentSerialBaudrate, agentInterfaceVlanQuarantine=agentInterfaceVlanQuarantine, agentDhcpScopeTable=agentDhcpScopeTable, agentSnmpTrapReceiverName=agentSnmpTrapReceiverName, agentTransferDownloadMode=agentTransferDownloadMode, portStatsPktsTx512to1023Octets=portStatsPktsTx512to1023Octets, agentApAssociateDisassociateTrapCount=agentApAssociateDisassociateTrapCount, agentLagSummaryName=agentLagSummaryName, agentLagSummaryLagIndex=agentLagSummaryLagIndex, agentNtpServerIndex=agentNtpServerIndex, broadcastStormEndTrap=broadcastStormEndTrap, agentNetworkWebAdminCertType=agentNetworkWebAdminCertType, agentInventoryIsCryptoCardPresent=agentInventoryIsCryptoCardPresent, productGroup2=productGroup2, agentDhcpScopeIndex=agentDhcpScopeIndex, agentApNoiseProfileFailTrapCount=agentApNoiseProfileFailTrapCount, agentTrapLogIndex=agentTrapLogIndex, agentInterfacePortNo=agentInterfacePortNo, agentDhcpScopeNetmask=agentDhcpScopeNetmask, agentPortGarpLeaveAllTime=agentPortGarpLeaveAllTime, agentLoginSessionIPAddress=agentLoginSessionIPAddress, agentInterfaceAclName=agentInterfaceAclName, agentLagSummaryStpMode=agentLagSummaryStpMode, agentDhcpScopeName=agentDhcpScopeName, agentPortConfigEntry=agentPortConfigEntry, agentSnmpCommunityEnabled=agentSnmpCommunityEnabled, agentSystemGroup=agentSystemGroup, agentLagConfigCreate=agentLagConfigCreate, agentSnmpTrapFlagsConfigGroup=agentSnmpTrapFlagsConfigGroup, agentSnmpV3UserEncryptionType=agentSnmpV3UserEncryptionType, broadcastStormStartTrap=broadcastStormStartTrap, agentInventoryManufacturerName=agentInventoryManufacturerName, agentDhcpScopeState=agentDhcpScopeState, agentSnmpMultipleUsersTrapFlag=agentSnmpMultipleUsersTrapFlag, portStatsTable=portStatsTable, agentSerialTimeout=agentSerialTimeout, agentNetworkRouteGateway=agentNetworkRouteGateway, agentInterfaceIPAddress=agentInterfaceIPAddress, agentTransferUploadDataType=agentTransferUploadDataType, portStatsPktsRx1519to1530Octets=portStatsPktsRx1519to1530Octets, agentNetworkConfigGroup=agentNetworkConfigGroup, agentTransferUploadServerIP=agentTransferUploadServerIP, portStatsIndex=portStatsIndex, agentInterfaceVlanId=agentInterfaceVlanId, agentInventoryMaxNumberOfAPsSupported=agentInventoryMaxNumberOfAPsSupported, agentWcpControllerInfoEntry=agentWcpControllerInfoEntry, agentSwitchLwappTransportMode=agentSwitchLwappTransportMode, agentInterfaceIPGateway=agentInterfaceIPGateway, agentPortMirrorMode=agentPortMirrorMode, agentServicePortDefaultGateway=agentServicePortDefaultGateway, agentDot3adAggPort=agentDot3adAggPort, portStatsPktsTxOversizeOctets=portStatsPktsTxOversizeOctets, agentNetworkRouteConfigEntry=agentNetworkRouteConfigEntry, agentDhcpScopeDnsServerAddress1=agentDhcpScopeDnsServerAddress1, agentTransferDownloadTftpMaxRetries=agentTransferDownloadTftpMaxRetries, agentPortAutoNegAdminStatus=agentPortAutoNegAdminStatus, agentLagConfigMode=agentLagConfigMode, agentSpanningTreeMode=agentSpanningTreeMode, agentServicePortConfigProtocol=agentServicePortConfigProtocol, agentClearLoginSessions=agentClearLoginSessions, agentSnmpCommunityAccessMode=agentSnmpCommunityAccessMode, agentPortPhysicalMode=agentPortPhysicalMode, agentWcpSlotNumber=agentWcpSlotNumber, agentNetworkWebAuthCertType=agentNetworkWebAuthCertType, agentClearTrapLog=agentClearTrapLog, agentSwitchBroadcastControlMode=agentSwitchBroadcastControlMode, agentWcpInfoGroup=agentWcpInfoGroup, agentPortAdminMode=agentPortAdminMode, agentPortLinkTrapMode=agentPortLinkTrapMode, agentTransferDownloadGroup=agentTransferDownloadGroup, agentNetworkSubnetMask=agentNetworkSubnetMask, agentResourceInfoGroup=agentResourceInfoGroup, agentNetworkAllowMgmtViaWireless=agentNetworkAllowMgmtViaWireless, agentLagSummaryAddPort=agentLagSummaryAddPort, multipleUsersTrap=multipleUsersTrap, agentInfoGroup=agentInfoGroup, vlanRequestFailureTrap=vlanRequestFailureTrap, linkFailureTrap=linkFailureTrap, agentInterfaceConfigTable=agentInterfaceConfigTable, agentDhcpScopeNetbiosNameServerAddress3=agentDhcpScopeNetbiosNameServerAddress3, bsnSwitchingAgentStatsGroup=bsnSwitchingAgentStatsGroup, agentLagSummaryStatus=agentLagSummaryStatus, agentNetworkBurnedInMacAddress=agentNetworkBurnedInMacAddress, agentSnmpTrapReceiverEnabled=agentSnmpTrapReceiverEnabled, agentSerialHWFlowControlMode=agentSerialHWFlowControlMode, agentDhcpScopeDefaultRouterAddress2=agentDhcpScopeDefaultRouterAddress2, agentDhcpScopePoolStartAddress=agentDhcpScopePoolStartAddress, agentInventoryBurnedInMacAddress=agentInventoryBurnedInMacAddress, agentInterfaceRowStatus=agentInterfaceRowStatus, agentLoginSessionStatus=agentLoginSessionStatus, agentLagDetailedConfigEntry=agentLagDetailedConfigEntry, agentSnmpLinkUpDownTrapFlag=agentSnmpLinkUpDownTrapFlag, agentSerialGroup=agentSerialGroup, portStatsPktsTx1024to1518Octets=portStatsPktsTx1024to1518Octets, agentInventoryIsCryptoCard2Present=agentInventoryIsCryptoCard2Present, agentWcpDeviceName=agentWcpDeviceName, agentSnmpConfigGroup=agentSnmpConfigGroup, agentPortGarpJoinTime=agentPortGarpJoinTime, agentInterfaceSecondaryDhcpAddress=agentInterfaceSecondaryDhcpAddress, agentPortDefaultType=agentPortDefaultType, agentClearPortStats=agentClearPortStats, agentNetworkDefaultGateway=agentNetworkDefaultGateway, agentPortGvrpStatus=agentPortGvrpStatus, agentPortMulticastApplianceMode=agentPortMulticastApplianceMode, agentWcpControllerTableChecksum=agentWcpControllerTableChecksum, agentDot3adAggPortTable=agentDot3adAggPortTable, agentTelnetMaxSessions=agentTelnetMaxSessions, agentInterfaceIPNetmask=agentInterfaceIPNetmask, agentDhcpScopeEntry=agentDhcpScopeEntry, agentLoginSessionSessionTime=agentLoginSessionSessionTime, agentLagSummaryLinkTrap=agentLagSummaryLinkTrap, agentInventoryProductVersion=agentInventoryProductVersion, agentNetworkBroadcastSsidMode=agentNetworkBroadcastSsidMode, agentTransferUploadPath=agentTransferUploadPath, agentTransferDownloadDataType=agentTransferDownloadDataType, agentNetworkSecureWebMode=agentNetworkSecureWebMode, stats=stats, agentNetworkSecureWebPassword=agentNetworkSecureWebPassword, stpInstanceTopologyChangeTrap=stpInstanceTopologyChangeTrap, agentTransferDownloadServerIP=agentTransferDownloadServerIP, agentTransferUploadMode=agentTransferUploadMode, agentSnmpTrapReceiverIPAddress=agentSnmpTrapReceiverIPAddress, agentConfigGroup=agentConfigGroup, agentWcpPortNumber=agentWcpPortNumber, agentTelnetConfigGroup=agentTelnetConfigGroup, agentSnmpV3UserName=agentSnmpV3UserName, agentTransferUploadGroup=agentTransferUploadGroup, agentPortDot3FlowControlMode=agentPortDot3FlowControlMode, agentSwitchConfigGroup=agentSwitchConfigGroup, agentRadioUpDownTrapCount=agentRadioUpDownTrapCount, agentClearSwitchStats=agentClearSwitchStats, agentTransferUploadFilename=agentTransferUploadFilename, bsnSwitching=bsnSwitching, agentInventoryOperatingSystem=agentInventoryOperatingSystem)
mibBuilder.exportSymbols("AIRESPACE-SWITCHING-MIB", agentTrapLogTotalSinceLastViewed=agentTrapLogTotalSinceLastViewed, productGroup1=productGroup1, agentTelnetAllowNewMode=agentTelnetAllowNewMode, agentDhcpScopePoolEndAddress=agentDhcpScopePoolEndAddress, bsnSwitchingCompliance=bsnSwitchingCompliance, agentServicePortSubnetMask=agentServicePortSubnetMask, agentTransferUploadStart=agentTransferUploadStart, agentDhcpScopeNetbiosNameServerAddress1=agentDhcpScopeNetbiosNameServerAddress1, agentDhcpScopeDefaultRouterAddress1=agentDhcpScopeDefaultRouterAddress1, agentInterfacePrimaryDhcpAddress=agentInterfacePrimaryDhcpAddress, agentSnmpCommunityConfigTable=agentSnmpCommunityConfigTable, agentInterfaceBackupPortNo=agentInterfaceBackupPortNo, agentSwitchAddressAgingTimeout=agentSwitchAddressAgingTimeout, agentPortClearStats=agentPortClearStats, agentWcpPeerIpAddress=agentWcpPeerIpAddress, agentSnmpVersion3Status=agentSnmpVersion3Status, agentSwitchInfoPowerSupply2Operational=agentSwitchInfoPowerSupply2Operational, agentLagSummaryConfigEntry=agentLagSummaryConfigEntry, agentNetworkMulticastGroupAddress=agentNetworkMulticastGroupAddress, agentDhcpScopeNetwork=agentDhcpScopeNetwork, agentTransferUploadStatus=agentTransferUploadStatus, agentNtpServerRowStatus=agentNtpServerRowStatus, agentApInterferenceProfileFailTrapCount=agentApInterferenceProfileFailTrapCount, agentSwitchDot3FlowControlMode=agentSwitchDot3FlowControlMode, agentTransferDownloadPath=agentTransferDownloadPath, portStatsPktsTx256to511Octets=portStatsPktsTx256to511Octets, agentPortIanaType=agentPortIanaType, agentSnmpV3UserEncryptionPassword=agentSnmpV3UserEncryptionPassword, agentLoginSessionEntry=agentLoginSessionEntry, agentLoginSessionIdleTime=agentLoginSessionIdleTime, agentSnmpTrapPortNumber=agentSnmpTrapPortNumber, agentTrapLogTable=agentTrapLogTable, agentInterfaceActivePortNo=agentInterfaceActivePortNo, agentSnmpV3UserStatus=agentSnmpV3UserStatus, agentSnmpCommunityName=agentSnmpCommunityName, agentLagSummaryDeletePort=agentLagSummaryDeletePort, agentCLIConfigGroup=agentCLIConfigGroup, stpInstanceNewRootTrap=stpInstanceNewRootTrap, agentPortPowerMode=agentPortPowerMode, agentDhcpConfigGroup=agentDhcpConfigGroup, agentNetworkArpTimeout=agentNetworkArpTimeout, agentTransferDownloadStart=agentTransferDownloadStart, agentPortPhysicalStatus=agentPortPhysicalStatus, agentTrapLogSystemTime=agentTrapLogSystemTime, agentPortSTPState=agentPortSTPState, agentSnmpCommunityIPMask=agentSnmpCommunityIPMask, agentDhcpScopeDnsServerAddress3=agentDhcpScopeDnsServerAddress3, agentSnmpCommunityIPAddress=agentSnmpCommunityIPAddress, agentTransferDownloadStatus=agentTransferDownloadStatus, agentNetworkRouteStatus=agentNetworkRouteStatus, agentPortOperationalStatus=agentPortOperationalStatus, bsnSwitchingGroups=bsnSwitchingGroups, agentNtpServerAddress=agentNtpServerAddress, agentInventoryMaintenanceLevel=agentInventoryMaintenanceLevel, agentDot3adAggPortEntry=agentDot3adAggPortEntry, bsnSwitchingAgentConfigGroup=bsnSwitchingAgentConfigGroup, agentSerialStopBits=agentSerialStopBits, agentNetworkIPAddress=agentNetworkIPAddress, agentLagSummaryAdminMode=agentLagSummaryAdminMode, agentSpanningTreeConfigGroup=agentSpanningTreeConfigGroup, productGroup3=productGroup3, agentNtpConfigGroup=agentNtpConfigGroup, agentPortGarpLeaveTime=agentPortGarpLeaveTime, agentTransferConfigurationFileEncryption=agentTransferConfigurationFileEncryption, agentSnmpSpanningTreeTrapFlag=agentSnmpSpanningTreeTrapFlag, agentResetSystem=agentResetSystem, agentClearLags=agentClearLags, agentSnmpVersion2cStatus=agentSnmpVersion2cStatus, agentSnmpTrapReceiverConfigEntry=agentSnmpTrapReceiverConfigEntry, agentSnmpTrapReceiverConfigTable=agentSnmpTrapReceiverConfigTable, agentNetworkConfigProtocol=agentNetworkConfigProtocol)
