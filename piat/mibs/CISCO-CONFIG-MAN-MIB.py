...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CONFIG-MAN-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:47:46 2019
...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Counter32, Unsigned32, ModuleIdentity, Integer32, Bits, iso, IpAddress, NotificationType, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Counter32", "Unsigned32", "ModuleIdentity", "Integer32", "Bits", "iso", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-CONFIG-MAN-MIB", ccmCLIHistoryCommandTable=ccmCLIHistoryCommandTable, ccmHistoryEventCommandSource=ccmHistoryEventCommandSource, ccmHistoryEventTime=ccmHistoryEventTime, ccmHistoryEventCommandSourceAddrRev1=ccmHistoryEventCommandSourceAddrRev1, ccmCLIHistoryCommand=ccmCLIHistoryCommand, ccmHistoryEventTerminalUser=ccmHistoryEventTerminalUser, ccmCLIHistoryMaxCmdEntries=ccmCLIHistoryMaxCmdEntries, ccmCLIHistoryCommandIndex=ccmCLIHistoryCommandIndex, ccmCLIRunningConfigChanged=ccmCLIRunningConfigChanged, ciscoConfigManCTIDObjectGroup=ciscoConfigManCTIDObjectGroup, ciscoConfigManMIBObjects=ciscoConfigManMIBObjects, ccmHistoryEventCommandSourceAddress=ccmHistoryEventCommandSourceAddress, ciscoConfigManMIBComplianceRev4=ciscoConfigManMIBComplianceRev4, HistoryEventMedium=HistoryEventMedium, ccmCLICfgRunConfNotifEnable=ccmCLICfgRunConfNotifEnable, ciscoConfigManCTIDNotifyGroup=ciscoConfigManCTIDNotifyGroup, ccmHistoryEventRcpUser=ccmHistoryEventRcpUser, ccmHistoryRunningLastChanged=ccmHistoryRunningLastChanged, ccmHistoryEventTerminalNumber=ccmHistoryEventTerminalNumber, ccmHistoryEventTerminalType=ccmHistoryEventTerminalType, ccmHistoryEventConfigSource=ccmHistoryEventConfigSource, ccmHistoryEventConfigDestination=ccmHistoryEventConfigDestination, ccmHistoryEventServerAddress=ccmHistoryEventServerAddress, ccmCTID=ccmCTID, ccmCTIDObjects=ccmCTIDObjects, ccmHistoryEventEntry=ccmHistoryEventEntry, ccmCLIHistory=ccmCLIHistory, ccmHistoryEventServerAddrRev1=ccmHistoryEventServerAddrRev1, ccmHistoryEventServerAddrType=ccmHistoryEventServerAddrType, ciscoConfigManMIBNotifications=ciscoConfigManMIBNotifications, ccmCLIHistoryCommandEntry=ccmCLIHistoryCommandEntry, ccmCTIDLastChangeTime=ccmCTIDLastChangeTime, ccmHistoryEventFile=ccmHistoryEventFile, ccmCTIDRolledOverNotifEnable=ccmCTIDRolledOverNotifEnable, ciscoConfigManMIBComplianceRev3=ciscoConfigManMIBComplianceRev3, ccmHistoryEventIndex=ccmHistoryEventIndex, ccmHistoryEventCommandSourceAddrType=ccmHistoryEventCommandSourceAddrType, ciscoConfigManMIBNotificationPrefix=ciscoConfigManMIBNotificationPrefix, ciscoConfigManCLIHistCmdGroup=ciscoConfigManCLIHistCmdGroup, ccmHistoryRunningLastSaved=ccmHistoryRunningLastSaved, ccmHistoryStartupLastChanged=ccmHistoryStartupLastChanged, ccmCLIHistoryCmdEntries=ccmCLIHistoryCmdEntries, ciscoConfigManMIBConformance=ciscoConfigManMIBConformance, ciscoConfigManMIB=ciscoConfigManMIB, ccmHistoryEventEntriesBumped=ccmHistoryEventEntriesBumped, ccmCTIDWhoChanged=ccmCTIDWhoChanged, ciscoConfigManMIBCompliances=ciscoConfigManMIBCompliances, ccmCTIDRolledOver=ccmCTIDRolledOver, ccmHistoryCLICmdEntriesBumped=ccmHistoryCLICmdEntriesBumped, ccmHistoryMaxEventEntries=ccmHistoryMaxEventEntries, ciscoConfigManMIBGroups=ciscoConfigManMIBGroups, PYSNMP_MODULE_ID=ciscoConfigManMIB, ccmHistoryEventTerminalLocation=ccmHistoryEventTerminalLocation, ccmHistoryEventTable=ccmHistoryEventTable, ciscoConfigManEvent=ciscoConfigManEvent, ciscoConfigManHistNotifyGroup=ciscoConfigManHistNotifyGroup, ciscoConfigManHistoryGroupRev2=ciscoConfigManHistoryGroupRev2, ciscoConfigManHistoryGroup=ciscoConfigManHistoryGroup, ccmCLICfg=ccmCLICfg, ccmCLIHistoryCmdEntriesAllowed=ccmCLIHistoryCmdEntriesAllowed, ccmHistoryEventVirtualHostName=ccmHistoryEventVirtualHostName, ccmHistory=ccmHistory, ciscoConfigManHistoryGroupRev1=ciscoConfigManHistoryGroupRev1, ciscoConfigManMIBComplianceRev2=ciscoConfigManMIBComplianceRev2, ciscoConfigManMIBCompliance=ciscoConfigManMIBCompliance)
