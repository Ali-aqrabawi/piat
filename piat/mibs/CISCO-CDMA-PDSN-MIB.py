...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CDMA-PDSN-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:31:17 2019
...
mibBuilder.exportSymbols("CISCO-CDMA-PDSN-MIB", cCdmaPcfSoRpUpdIpAddrType=cCdmaPcfSoRpUpdIpAddrType, cCdmaClusterSessionHighReached=cCdmaClusterSessionHighReached, cCdmaActiveConnTime=cCdmaActiveConnTime, cCdmaPcfSoRpRegServiceOption=cCdmaPcfSoRpRegServiceOption, cCdmaPcfTotal=cCdmaPcfTotal, cCdmaPdsnMIBConformance=cCdmaPdsnMIBConformance, cCdmaPppRenegAddrMismatchReqs=cCdmaPppRenegAddrMismatchReqs, cCdmaRpSessUpdStats=cCdmaRpSessUpdStats, cCdmaRpRegBadReqFailures=cCdmaRpRegBadReqFailures, cCdmaPppInsufResReleases=cCdmaPppInsufResReleases, cCdmaFailHistBsid=cCdmaFailHistBsid, cCdmaPcfSoRpUpdMNAuthFails=cCdmaPcfSoRpUpdMNAuthFails, cCdmaSimpleIpFlowTotal=cCdmaSimpleIpFlowTotal, cCdmaRpSessUpdDeniedReqs=cCdmaRpSessUpdDeniedReqs, cCdmaPdsnMIBComplianceRev1=cCdmaPdsnMIBComplianceRev1, cCdmaProxyMobileIpFlowTotal=cCdmaProxyMobileIpFlowTotal, cCdmaReceivedSipPkts=cCdmaReceivedSipPkts, cCdmaPcfSoRpSessUpdTxdReqs=cCdmaPcfSoRpSessUpdTxdReqs, cCdmaServiceAffectedLevel=cCdmaServiceAffectedLevel, cCdmaSessUpdAckInvMSIDLenErrs=cCdmaSessUpdAckInvMSIDLenErrs, cCdmaSessionMaxNotifEnabled=cCdmaSessionMaxNotifEnabled, cCdmaPdsnPcfSoRpRegGroupSup1=cCdmaPdsnPcfSoRpRegGroupSup1, cCdmaSessionMoMtInd=cCdmaSessionMoMtInd, cCdmaRpSessUpdAlwaysON=cCdmaRpSessUpdAlwaysON, cCdmaRegReqDuplicateGREKeyErrs=cCdmaRegReqDuplicateGREKeyErrs, cCdmaPcfSoPppServiceOption=cCdmaPcfSoPppServiceOption, cCdmaSessionKey=cCdmaSessionKey, cCdmaTransmittedSipPkts=cCdmaTransmittedSipPkts, cCdmaPcfSoRpDeRegAirlinkStops=cCdmaPcfSoRpDeRegAirlinkStops, cCdmaPdsnStatusChange=cCdmaPdsnStatusChange, cCdmaPcfErrorTotal=cCdmaPcfErrorTotal, cCdmaRpSessUpdReasonParamNotUpdated=cCdmaRpSessUpdReasonParamNotUpdated, cCdmaRpUpdDeniedReqs=cCdmaRpUpdDeniedReqs, cCdmaPppPdsnReleases=cCdmaPppPdsnReleases, cCdmaRegUpdAckInvMSIDLenErrs=cCdmaRegUpdAckInvMSIDLenErrs, cCdmaFailHistInfoTable=cCdmaFailHistInfoTable, cCdmaSessionGREToIPPkts=cCdmaSessionGREToIPPkts, cCdmaPppLcpFailures=cCdmaPppLcpFailures, cCdmaSessionSentOctets=cCdmaSessionSentOctets, cCdmaPcfSoRpSessUpdDeniedReqs=cCdmaPcfSoRpSessUpdDeniedReqs, cCdmaPcfSoRpSessUpdIpAddrType=cCdmaPcfSoRpSessUpdIpAddrType, cCdmaFailSessionEsn2=cCdmaFailSessionEsn2, cCdmaSessUpdAckInvConnectionIDErrs=cCdmaSessUpdAckInvConnectionIDErrs, cCdmaAddressDynamicPMIPs=cCdmaAddressDynamicPMIPs, cCdmaInvCheckSumPktDiscards=cCdmaInvCheckSumPktDiscards, cCdmaPcfSoRpReRegAirlinkStarts=cCdmaPcfSoRpReRegAirlinkStarts, cCdmaPcfSoRpHandoffRegDeniedReqs=cCdmaPcfSoRpHandoffRegDeniedReqs, cCdmaRpRegInsuffResFailures=cCdmaRpRegInsuffResFailures, cCdmaSessionConnStartTime=cCdmaSessionConnStartTime, cCdmaRpSessUpdInitTransmittedReqs=cCdmaRpSessUpdInitTransmittedReqs, cCdmaSrEnabled=cCdmaSrEnabled, ciscoCdmaPdsnMIB=ciscoCdmaPdsnMIB, cCdmaRegReqInvVSEErrs=cCdmaRegReqInvVSEErrs, cCdmaPppNegoBapCons=cCdmaPppNegoBapCons, cCdmaPcfSoRpUpdNotAckedReqs=cCdmaPcfSoRpUpdNotAckedReqs, cCdmaClusterMemberEntry=cCdmaClusterMemberEntry, cCdmaRpInitRegDiscardedReqs=cCdmaRpInitRegDiscardedReqs, cCdmaSessionFlowTechnology=cCdmaSessionFlowTechnology, cCdmaRpRegMNAuthFailures=cCdmaRpRegMNAuthFailures, cCdmaPppNegoMrruCons=cCdmaPppNegoMrruCons, cCdmaSessionA11FaIp=cCdmaSessionA11FaIp, cCdmaRegReqMismatchSPIErrs=cCdmaRegReqMismatchSPIErrs, cCdmaSessionRcvdPkts=cCdmaSessionRcvdPkts, cCdmaRpDeRegHandoffAcceptedReqs=cCdmaRpDeRegHandoffAcceptedReqs, cCdmaRegUpdAckInvRUAEKeyErrs=cCdmaRegUpdAckInvRUAEKeyErrs, cCdmaRpSessUpdBadReqFailures=cCdmaRpSessUpdBadReqFailures, cCdmaRpReRegDiscardedReqs=cCdmaRpReRegDiscardedReqs, cCdmaPppEchoRequestTimeouts=cCdmaPppEchoRequestTimeouts, cCdmaPppSetupStats=cCdmaPppSetupStats, cCdmaAffectedAddress=cCdmaAffectedAddress, cCdmaRpUpdRpLifeExpReqs=cCdmaRpUpdRpLifeExpReqs, cCdmaSessUpdAckMissingRUAEErrs=cCdmaSessUpdAckMissingRUAEErrs, cCdmaPcfIpAddress=cCdmaPcfIpAddress, cCdmaRpUpdHandoffAcceptedReqs=cCdmaRpUpdHandoffAcceptedReqs, cCdmaRegReqReRegInDisconnectErrs=cCdmaRegReqReRegInDisconnectErrs, cCdmaPcfSoRpReRegRcvdReqs=cCdmaPcfSoRpReRegRcvdReqs, cCdmaPcfSoRpUpdOtherReaReqs=cCdmaPcfSoRpUpdOtherReaReqs, cCdmaRpInterPCFDormantHandoffs=cCdmaRpInterPCFDormantHandoffs, cCdmaFailSessionA11HaIp=cCdmaFailSessionA11HaIp, cCdmaAddressDynamicSIPs=cCdmaAddressDynamicSIPs, cCdmaRegUpdAckNoSessionErrs=cCdmaRegUpdAckNoSessionErrs, cCdmaSessionEntry=cCdmaSessionEntry, cCdmaSessUpdAckNoSessionErrs=cCdmaSessUpdAckNoSessionErrs, cCdmaPppStats=cCdmaPppStats, cCdmaServiceOptionStats=cCdmaServiceOptionStats, cCdmaPppAuthEapAttempts=cCdmaPppAuthEapAttempts, CCdmaServiceOption=CCdmaServiceOption, cCdmaAddressSchemeStats=cCdmaAddressSchemeStats, cCdmaFailHistInfo=cCdmaFailHistInfo, cCdmaSessionHighReached=cCdmaSessionHighReached, cCdmaAffectedMemberStatus=cCdmaAffectedMemberStatus, cCdmaRPDeRegAcceptedReplies=cCdmaRPDeRegAcceptedReplies, cCdmaRpUpdBadReqFailures=cCdmaRpUpdBadReqFailures, cCdmaSessionDiscardedOutPkts=cCdmaSessionDiscardedOutPkts, cCdmaPppRenegAnidChanges=cCdmaPppRenegAnidChanges, cCdmaSoRpUpdHandoffInitTxdReqs=cCdmaSoRpUpdHandoffInitTxdReqs, cCdmaPcfMaxAllowed=cCdmaPcfMaxAllowed, cCdmaRegReqMissingSSEErrs=cCdmaRegReqMissingSSEErrs, cCdmaPppNegoVjCompCons=cCdmaPppNegoVjCompCons, cCdmaHDLCoGRESessionTotal=cCdmaHDLCoGRESessionTotal, cCdmaRpSessUpdAcceptedReqs=cCdmaRpSessUpdAcceptedReqs, cCdmaPppIPCPPdsnA10Releases=cCdmaPppIPCPPdsnA10Releases, cCdmaFailSessionMsidType=cCdmaFailSessionMsidType, cCdmaPppCompressAscendCons=cCdmaPppCompressAscendCons, cCdmaRegUpdAckInvOrderErrs=cCdmaRegUpdAckInvOrderErrs, cCdmaRegUpdAckInvVSEErrs=cCdmaRegUpdAckInvVSEErrs, cCdmaNotifObjects=cCdmaNotifObjects, cCdmaPcfSoRpUpdInitTxdReqs=cCdmaPcfSoRpUpdInitTxdReqs, cCdmaPppCompressStackCons=cCdmaPppCompressStackCons, cCdmaRpUpdTransmittedReqs=cCdmaRpUpdTransmittedReqs, cCdmaPcfSessionMaxTotal=cCdmaPcfSessionMaxTotal, cCdmaRegReqStartBeforeSetupErrs=cCdmaRegReqStartBeforeSetupErrs, cCdmaSessionFailTotal=cCdmaSessionFailTotal, cCdmaRPRegUpdAckErrors=cCdmaRPRegUpdAckErrors, cCdmaNotifPdsnGroupRev2=cCdmaNotifPdsnGroupRev2, cCdmaMSIDFlowTotal=cCdmaMSIDFlowTotal, cCdmaServingPdsnHostname=cCdmaServingPdsnHostname, cCdmaPppAuthAAATimeouts=cCdmaPppAuthAAATimeouts, cCdmaPppLcpFailuresUnknown=cCdmaPppLcpFailuresUnknown, cCdmaPppAuthPapTimeouts=cCdmaPppAuthPapTimeouts, cCdmaPcfSoRpSessUpdNotAckedReqs=cCdmaPcfSoRpSessUpdNotAckedReqs, cCdmaSessUpdAckMissingSSEErrs=cCdmaSessUpdAckMissingSSEErrs, cCdmaRpRegReasonlUnSpecFailures=cCdmaRpRegReasonlUnSpecFailures, cCdmaRegReqInvPakLenErrs=cCdmaRegReqInvPakLenErrs, cCdmaRpSessUpdReTransmittedReqs=cCdmaRpSessUpdReTransmittedReqs, cCdmaPppAuthChapSuccesses=cCdmaPppAuthChapSuccesses, cCdmaPppLifetimeExpiryReleases=cCdmaPppLifetimeExpiryReleases, cCdmaRPRegReqErrors=cCdmaRPRegReqErrors, cCdmaPppLcpFailuresMaxRetrans=cCdmaPppLcpFailuresMaxRetrans, cCdmaRpRegDiscardedReqs=cCdmaRpRegDiscardedReqs, cCdmaPppIpcpFailuresMaxRetrans=cCdmaPppIpcpFailuresMaxRetrans, cCdmaRegReqGREKeyChngNoSetupErrs=cCdmaRegReqGREKeyChngNoSetupErrs, cCdmaPcfSoRpSessUpdIpAddr=cCdmaPcfSoRpSessUpdIpAddr, cCdmaPdsnMIBNotifs=cCdmaPdsnMIBNotifs, cCdmaNoSessionPktDiscards=cCdmaNoSessionPktDiscards, cCdmaPcfSoRpInitRegDiscardedReqs=cCdmaPcfSoRpInitRegDiscardedReqs, cCdmaSoRpUpdHandoffBadReqFails=cCdmaSoRpUpdHandoffBadReqFails, cCdmaRegUpdAckInvSPIErrs=cCdmaRegUpdAckInvSPIErrs, cCdmaAddressStaticSIPs=cCdmaAddressStaticSIPs, cCdmaPcfSoRpSessUpdReaUnSpecFails=cCdmaPcfSoRpSessUpdReaUnSpecFails, cCdmaRpRplyPCFNoSecOrParseErrs=cCdmaRpRplyPCFNoSecOrParseErrs, cCdmaRPRegAcceptedReplies=cCdmaRPRegAcceptedReplies, cCdmaSessionRegReqFailedNotif=cCdmaSessionRegReqFailedNotif, cCdmaRpUpdPcfHandoffs=cCdmaRpUpdPcfHandoffs, cCdmaRPSessUpdAckErrors=cCdmaRPSessUpdAckErrors, cCdmaClusterCtrlTable=cCdmaClusterCtrlTable, cCdmaPppLowerLayerReleaseFailures=cCdmaPppLowerLayerReleaseFailures, cCdmaPcfSoRpHandoffRegAcptdReqs=cCdmaPcfSoRpHandoffRegAcptdReqs, cCdmaRpUpdHandoffIdMismatchFails=cCdmaRpUpdHandoffIdMismatchFails, cCdmaRpDeRegDiscardedReqs=cCdmaRpDeRegDiscardedReqs, cCdmaFlowSimpleIpFailures=cCdmaFlowSimpleIpFailures, cCdmaPppLCPPdsnA10Releases=cCdmaPppLCPPdsnA10Releases, cCdmaRegReqMemFailErrs=cCdmaRegReqMemFailErrs, cCdmaSystemPdsnGroupRev2=cCdmaSystemPdsnGroupRev2, cCdmaPcfSoPppSetupStatsEntry=cCdmaPcfSoPppSetupStatsEntry, cCdmaServiceOptionSucesses=cCdmaServiceOptionSucesses, cCdmaPcfSoPppConnSuccesses=cCdmaPcfSoPppConnSuccesses, cCdmaRegReqInvAppTypeInVSEErrs=cCdmaRegReqInvAppTypeInVSEErrs, cCdmaPppReNegoStats=cCdmaPppReNegoStats, cCdmaRpUpdHandoffReTxdReqs=cCdmaRpUpdHandoffReTxdReqs, cCdmaRpUpdHandoffBadReqFails=cCdmaRpUpdHandoffBadReqFails, cCdmaPppEnterLcpNums=cCdmaPppEnterLcpNums, cCdmaRegReqInvVendorIDInVSEErrs=cCdmaRegReqInvVendorIDInVSEErrs, cCdmaSoRpUpdHandoffReTxdReqs=cCdmaSoRpUpdHandoffReTxdReqs, cCdmaPcfSoRpReRegDiscardedReqs=cCdmaPcfSoRpReRegDiscardedReqs, cCdmaRegReqInvMSIDLenErrs=cCdmaRegReqInvMSIDLenErrs, cCdmaNoGREKeyPktDiscards=cCdmaNoGREKeyPktDiscards, cCdmaActiveSessions=cCdmaActiveSessions, cCdmaRegUpdAckMemFailErrs=cCdmaRegUpdAckMemFailErrs, cCdmaPppAuthSuccesses=cCdmaPppAuthSuccesses, cCdmaRpUpdDiscardedAcks=cCdmaRpUpdDiscardedAcks, cCdmaReceivedMipKiloOctets=cCdmaReceivedMipKiloOctets, cCdmaRPRegAdminProhibFailures=cCdmaRPRegAdminProhibFailures, cCdmaRpDeRegAirlinkStops=cCdmaRpDeRegAirlinkStops, cCdmaRegReqAcctDupAttrErrs=cCdmaRegReqAcctDupAttrErrs, cCdmaRegReqInitNoSetupErrs=cCdmaRegReqInitNoSetupErrs, cCdmaPppNoRemoteIpAddressReleases=cCdmaPppNoRemoteIpAddressReleases, cCdmaFailSessionEsn=cCdmaFailSessionEsn, cCdmaPppAuthPcfA10Releases=cCdmaPppAuthPcfA10Releases, cCdmaFailHistFailType=cCdmaFailHistFailType, cCdmaPppConnectionOtherFailures=cCdmaPppConnectionOtherFailures, cCdmaAddressDynamicMIPs=cCdmaAddressDynamicMIPs, cCdmaRpRegAdminProhibFailures=cCdmaRpRegAdminProhibFailures, cCdmaClusterSessLowThreshold=cCdmaClusterSessLowThreshold, cCdmaTransmittedPmipKiloOctets=cCdmaTransmittedPmipKiloOctets, cCdmaPcfMaxAllowedNotif=cCdmaPcfMaxAllowedNotif, cCdmaReceivedPmipPkts=cCdmaReceivedPmipPkts, cCdmaRpHandoffRegAcceptedReqs=cCdmaRpHandoffRegAcceptedReqs, PYSNMP_MODULE_ID=ciscoCdmaPdsnMIB, cCdmaPppLCPPcfA10Releases=cCdmaPppLCPPcfA10Releases, cCdmaPcfSoRpUpdRpLifeExpReqs=cCdmaPcfSoRpUpdRpLifeExpReqs, cCdmaPppEnterIpcpNums=cCdmaPppEnterIpcpNums, cCdmaRegReqAcctInvLenAttrErrs=cCdmaRegReqAcctInvLenAttrErrs, cCdmaPPPoGRESessionTotal=cCdmaPPPoGRESessionTotal, cCdmaClusterMemberStatusChange=cCdmaClusterMemberStatusChange, cCdmaPppRenegByMobileReqs=cCdmaPppRenegByMobileReqs, cCdmaRpReRegAirlinkStarts=cCdmaRpReRegAirlinkStarts, cCdmaPppPreLCPPcfA10Releases=cCdmaPppPreLCPPcfA10Releases, cCdmaPppOtherReasonReleases=cCdmaPppOtherReasonReleases, cCdmaPcfSoRpDeRegRcvdReqs=cCdmaPcfSoRpDeRegRcvdReqs, cCdmaClusterMemberStatusChange2=cCdmaClusterMemberStatusChange2, cCdmaSessUpdAckInvRUAEKeyErrs=cCdmaSessUpdAckInvRUAEKeyErrs, cCdmaRpSessUpdIdentMismatchFailures=cCdmaRpSessUpdIdentMismatchFailures, cCdmaHandoffStats=cCdmaHandoffStats, cCdmaAddressStaticMIPs=cCdmaAddressStaticMIPs, cCdmaPcfSoRpSessUpdServiceOption=cCdmaPcfSoRpSessUpdServiceOption, cCdmaPppReleaseStats=cCdmaPppReleaseStats, cCdmaSessionUserFlowIpAddress=cCdmaSessionUserFlowIpAddress, cCdmaEstablishedSessions=cCdmaEstablishedSessions, cCdmaRPUpdValidRequests=cCdmaRPUpdValidRequests, cCdmaRegUpdAckMissingRUAEErrs=cCdmaRegUpdAckMissingRUAEErrs, cCdmaRpUpdReasonUnSpecFailures=cCdmaRpUpdReasonUnSpecFailures, cCdmaRpRegReqMaxSessionReachedErrs=cCdmaRpRegReqMaxSessionReachedErrs, cCdmaRpUpdHandoffInitTxdReqs=cCdmaRpUpdHandoffInitTxdReqs, cCdmaPppSrvUnavailReleases=cCdmaPppSrvUnavailReleases, cCdmaPdsnMIBNotifPrefix=cCdmaPdsnMIBNotifPrefix, cCdmaPcfSoRpUpdIdMismatFails=cCdmaPcfSoRpUpdIdMismatFails, cCdmaPcfSoRpUpdStatsEntry=cCdmaPcfSoRpUpdStatsEntry, cCdmaTrafficStats=cCdmaTrafficStats, cCdmaPcfSoRpSessUpdRNPDIT=cCdmaPcfSoRpSessUpdRNPDIT, cCdmaServiceOptionTable=cCdmaServiceOptionTable, cCdmaPcfSoRpUpdReTxdReqs=cCdmaPcfSoRpUpdReTxdReqs, cCdmaPppAuthPapAttempts=cCdmaPppAuthPapAttempts, cCdmaInvGREProtoPktDiscards=cCdmaInvGREProtoPktDiscards, cCdmaClusterType=cCdmaClusterType, cCdmaPcfSoPppConnInitiateReqs=cCdmaPcfSoPppConnInitiateReqs, cCdmaSoRpUpdHandoffDeniedReqs=cCdmaSoRpUpdHandoffDeniedReqs, cCdmaSessUpdAckInvVSEErrs=cCdmaSessUpdAckInvVSEErrs, cCdmaPcfSoRpUpdDiscardedAcks=cCdmaPcfSoRpUpdDiscardedAcks, cCdmaPcfSoRpUpdServiceOption=cCdmaPcfSoRpUpdServiceOption, cCdmaPppAuthPhaseReceivedTermreqs=cCdmaPppAuthPhaseReceivedTermreqs, cCdmaRpUpdNotAckedReqs=cCdmaRpUpdNotAckedReqs, cCdmaSessionNai=cCdmaSessionNai, cCdmaPppLcpTermReleases=cCdmaPppLcpTermReleases, cCdmaSoRpUpdHandoffAcceptedReqs=cCdmaSoRpUpdHandoffAcceptedReqs, cCdmaAddressStaticPMIPs=cCdmaAddressStaticPMIPs, cCdmaRpSessUpdReasonUnSpecFailures=cCdmaRpSessUpdReasonUnSpecFailures, cCdmaRPRegValidRequests=cCdmaRPRegValidRequests, cCdmaPcfTable=cCdmaPcfTable, cCdmaSessionLowReached2=cCdmaSessionLowReached2, cCdmaTransmittedPmipPkts=cCdmaTransmittedPmipPkts, cCdmaSessionConnId=cCdmaSessionConnId, cCdmaRPRegIdentMismatchFailures=cCdmaRPRegIdentMismatchFailures, cCdmaRpInitRegAcceptedReqs=cCdmaRpInitRegAcceptedReqs, cCdmaClusterSessHighThreshold=cCdmaClusterSessHighThreshold, cCdmaClusterMemberAddress=cCdmaClusterMemberAddress, cCdmaFailHistInfoEntry=cCdmaFailHistInfoEntry, cCdmaPcfSoRpRegBadReqFails=cCdmaPcfSoRpRegBadReqFails, cCdmaPdsnCluster=cCdmaPdsnCluster, cCdmaPcfSoRpRegDiscardedReqs=cCdmaPcfSoRpRegDiscardedReqs, cCdmaSessionMaxAllowed=cCdmaSessionMaxAllowed, cCdmaFailHistFailTime=cCdmaFailHistFailTime, cCdmaPcfSoRpRegNoRsrcFails=cCdmaPcfSoRpRegNoRsrcFails, cCdmaRpUpdOtherReasonReqs=cCdmaRpUpdOtherReasonReqs)
mibBuilder.exportSymbols("CISCO-CDMA-PDSN-MIB", CCdmaMsidType=CCdmaMsidType, cCdmaPcfSoRpSessUpdMNAuthFails=cCdmaPcfSoRpSessUpdMNAuthFails, cCdmaClusterTotalMembers=cCdmaClusterTotalMembers, cCdmaFlowMobilIpSuccesses=cCdmaFlowMobilIpSuccesses, cCdmaRPRegUpdErrors=cCdmaRPRegUpdErrors, cCdmaRPUpdMNAuthenFailures=cCdmaRPUpdMNAuthenFailures, cCdmaPppCompressMsftCons=cCdmaPppCompressMsftCons, cCdmaRPRegReplyErrors=cCdmaRPRegReplyErrors, cCdmaPppRenegFailures=cCdmaPppRenegFailures, cCdmaSessionMsid=cCdmaSessionMsid, cCdmaPcfSoRpRegStats=cCdmaPcfSoRpRegStats, cCdmaSessionHighThreshold=cCdmaSessionHighThreshold, cCdmaPcfSoRpRegIpAddrType=cCdmaPcfSoRpRegIpAddrType, cCdmaPcfSoRpHandoffRegDiscardedReqs=cCdmaPcfSoRpHandoffRegDiscardedReqs, cCdmaPcfMaxAllowedNotifEnabled=cCdmaPcfMaxAllowedNotifEnabled, cCdmaPppAuthEapFailures=cCdmaPppAuthEapFailures, cCdmaPppCompressDeflateCons=cCdmaPppCompressDeflateCons, cCdmaPcfSoRpRegIpAddr=cCdmaPcfSoRpRegIpAddr, cCdmaPppSessTimeoutReleases=cCdmaPppSessTimeoutReleases, cCdmaStatusIS2OOSes=cCdmaStatusIS2OOSes, cCdmaPppAuthChapTimeouts=cCdmaPppAuthChapTimeouts, cCdmaPcfSoRpSessUpdRcvdAcks=cCdmaPcfSoRpSessUpdRcvdAcks, cCdmaRpUpdIdentMismatchFailures=cCdmaRpUpdIdentMismatchFailures, cCdmaPppRenegSuccesses=cCdmaPppRenegSuccesses, cCdmaSoRpUpdHandoffNotAckedReqs=cCdmaSoRpUpdHandoffNotAckedReqs, cCdmaRPRegBadRequestFailures=cCdmaRPRegBadRequestFailures, cCdmaPcfSoRpUpdStats=cCdmaPcfSoRpUpdStats, cCdmaSoRpUpdHandoffAdmProhibFails=cCdmaSoRpUpdHandoffAdmProhibFails, cCdmaSessionEsn=cCdmaSessionEsn, cCdmaPppAuthMschapTimeouts=cCdmaPppAuthMschapTimeouts, cCdmaPcfSoRpUpdBadReqFails=cCdmaPcfSoRpUpdBadReqFails, cCdmaPppPreLCPPdsnA10Releases=cCdmaPppPreLCPPdsnA10Releases, cCdmaPppIpcpPhaseSentTermreqs=cCdmaPppIpcpPhaseSentTermreqs, cCdmaSessUpdAckInvMNIDTypeErrs=cCdmaSessUpdAckInvMNIDTypeErrs, cCdmaSessionDiscardedInPkts=cCdmaSessionDiscardedInPkts, cCdmaRpRegReceivedReqs=cCdmaRpRegReceivedReqs, cCdmaSystemStatus=cCdmaSystemStatus, cCdmaRPRegLifeTimeZeroRequests=cCdmaRPRegLifeTimeZeroRequests, cCdmaRegReqDupAppTypeInVSEErrs=cCdmaRegReqDupAppTypeInVSEErrs, cCdmaRPUpdIdentMismatchFailures=cCdmaRPUpdIdentMismatchFailures, cCdmaPcfSoRpUpdAcptdReqs=cCdmaPcfSoRpUpdAcptdReqs, cCdmaIdChangeHandoffs=cCdmaIdChangeHandoffs, cCdmaPppIpcpFailures=cCdmaPppIpcpFailures, cCdmaRpUpdHandoffReceivedAcks=cCdmaRpUpdHandoffReceivedAcks, cCdmaNotifPdsnGroupRev1=cCdmaNotifPdsnGroupRev1, cCdmaFailSessionA11FaIp=cCdmaFailSessionA11FaIp, cCdmaClusterMemberTable=cCdmaClusterMemberTable, cCdmaPppAuthEapSuccesses=cCdmaPppAuthEapSuccesses, cCdmaPcfSoPppSetupStats=cCdmaPcfSoPppSetupStats, cCdmaRpHandoffRegDiscardedReqs=cCdmaRpHandoffRegDiscardedReqs, cCdmaRpReRegDeniedReqs=cCdmaRpReRegDeniedReqs, cCdmaSessUpdAckInvPakLenErrs=cCdmaSessUpdAckInvPakLenErrs, cCdmaRpUpdHandoffNotAckedReqs=cCdmaRpUpdHandoffNotAckedReqs, cCdmaPppAuthMschapSuccesses=cCdmaPppAuthMschapSuccesses, cCdmaRpUpdAdminProhibFailures=cCdmaRpUpdAdminProhibFailures, cCdmaPppCompressNegoFailures=cCdmaPppCompressNegoFailures, cCdmaPppRenegLcpIpcpReqs=cCdmaPppRenegLcpIpcpReqs, cCdmaRegReqInvOrderErrs=cCdmaRegReqInvOrderErrs, cCdmaRpRegDeniedReqs=cCdmaRpRegDeniedReqs, cCdmaRpUpdReceivedAcks=cCdmaRpUpdReceivedAcks, cCdmaSessUpdAckInvOrderErrs=cCdmaSessUpdAckInvOrderErrs, cCdmaReceivedPmipKiloOctets=cCdmaReceivedPmipKiloOctets, cCdmaRegUpdAckMissingSSEErrs=cCdmaRegUpdAckMissingSSEErrs, cCdmaPcfSoPppSetupIpAddr=cCdmaPcfSoPppSetupIpAddr, cCdmaPcfSoPppSetupIpAddrType=cCdmaPcfSoPppSetupIpAddrType, cCdmaRpSessUpdNotAckedReqs=cCdmaRpSessUpdNotAckedReqs, cCdmaPppReceivedEchoReplies=cCdmaPppReceivedEchoReplies, cCdmaPdsnMIBComplianceRev4=cCdmaPdsnMIBComplianceRev4, cCdmaPcfSoRpRegNoRevTunFails=cCdmaPcfSoRpRegNoRevTunFails, cCdmaRpSessUpdReceivedAcks=cCdmaRpSessUpdReceivedAcks, cCdmaFlowUnknownTypeFailures=cCdmaFlowUnknownTypeFailures, cCdmaSessionPppCompressEnabled=cCdmaSessionPppCompressEnabled, cCdmaRegUpdMemFailErrs=cCdmaRegUpdMemFailErrs, cCdmaFlowVpdnFailures=cCdmaFlowVpdnFailures, cCdmaTransmittedSDBOctets=cCdmaTransmittedSDBOctets, cCdmaRegReqInvFlagsErrs=cCdmaRegReqInvFlagsErrs, cCdmaRpUpdHandoffAdmProhibFails=cCdmaRpUpdHandoffAdmProhibFails, cCdmaPcfSoRpUpdTxdReqs=cCdmaPcfSoRpUpdTxdReqs, cCdmaPppNegoIpCons=cCdmaPppNegoIpCons, cCdmaFailHistCanId=cCdmaFailHistCanId, cCdmaClusterMemberStatus=cCdmaClusterMemberStatus, cCdmaClusterMemberInfo=cCdmaClusterMemberInfo, cCdmaRpSessUpdDiscardedAcks=cCdmaRpSessUpdDiscardedAcks, cCdmaPppLcpPhaseReceivedTermreqs=cCdmaPppLcpPhaseReceivedTermreqs, cCdmaRegReqStopOnDormantErrs=cCdmaRegReqStopOnDormantErrs, cCdmaSessUpdAckInvMNIDErrs=cCdmaSessUpdAckInvMNIDErrs, cCdmaPdsnMIBComplianceRev2=cCdmaPdsnMIBComplianceRev2, cCdmaAffectedCtrlStatus=cCdmaAffectedCtrlStatus, cCdmaPcfSoRpUpdStatsTable=cCdmaPcfSoRpUpdStatsTable, cCdmaRegReqSameGREKeySetupRcvdErrs=cCdmaRegReqSameGREKeySetupRcvdErrs, cCdmaSessionFlowCount=cCdmaSessionFlowCount, cCdmaSessionPdsnAuthenTimer=cCdmaSessionPdsnAuthenTimer, cCdmaPppRenegOtherReasonReqs=cCdmaPppRenegOtherReasonReqs, cCdmaPppEnterAuthNums=cCdmaPppEnterAuthNums, cCdmaFlowProxyIpFailures=cCdmaFlowProxyIpFailures, cCdmaServiceOptionFailures=cCdmaServiceOptionFailures, cCdmaPcfSoRpRegMNAuthFails=cCdmaPcfSoRpRegMNAuthFails, cCdmaRpUpdHandoffDiscardedAcks=cCdmaRpUpdHandoffDiscardedAcks, cCdmaRegRplyMemFailErrs=cCdmaRegRplyMemFailErrs, cCdmaPcfSoRpInitRegAcptdReqs=cCdmaPcfSoRpInitRegAcptdReqs, cCdmaPcfSoRpRegBadCVSEFails=cCdmaPcfSoRpRegBadCVSEFails, cCdmaPdsnMIBComplianceRev6=cCdmaPdsnMIBComplianceRev6, cCdmaRpDeRegHandoffDeniedReqs=cCdmaRpDeRegHandoffDeniedReqs, cCdmaRegReqAcctInvSeqNumErrs=cCdmaRegReqAcctInvSeqNumErrs, cCdmaRegUpdAckInvPakLenErrs=cCdmaRegUpdAckInvPakLenErrs, cCdmaRpSessUpdRNPDIT=cCdmaRpSessUpdRNPDIT, cCdmaPppConFormedBundles=cCdmaPppConFormedBundles, cCdmaRpSessUpdTransmittedReqs=cCdmaRpSessUpdTransmittedReqs, cCdmaPppIpcpOptionIssueFailures=cCdmaPppIpcpOptionIssueFailures, cCdmaPcfSoRpSessUpdStatsTable=cCdmaPcfSoRpSessUpdStatsTable, cCdmaRegReqAcctUnknwnAttrErrs=cCdmaRegReqAcctUnknwnAttrErrs, cCdmaPppAdminReleases=cCdmaPppAdminReleases, cCdmaPppNegoIpxCons=cCdmaPppNegoIpxCons, cCdmaPcfInfo=cCdmaPcfInfo, cCdmaRpReRegAcceptedReqs=cCdmaRpReRegAcceptedReqs, cCdmaPcfSoRpRegStatsTable=cCdmaPcfSoRpRegStatsTable, cCdmaRegReqInvAirlinkRecErrs=cCdmaRegReqInvAirlinkRecErrs, cCdmaServiceTotalOptions=cCdmaServiceTotalOptions, cCdmaPcfSoRpSessUpdReTxdReqs=cCdmaPcfSoRpSessUpdReTxdReqs, cCdmaPcfSessionTotal=cCdmaPcfSessionTotal, cCdmaPppAuthMschapFailures=cCdmaPppAuthMschapFailures, cCdmaSessionTunnelProt=cCdmaSessionTunnelProt, cCdmaPppAuthPhaseSentTermreqs=cCdmaPppAuthPhaseSentTermreqs, cCdmaRpInitRegReceivedReqs=cCdmaRpInitRegReceivedReqs, cCdmaPppIpcpSuccesses=cCdmaPppIpcpSuccesses, cCdmaPppMobileReleases=cCdmaPppMobileReleases, cCdmaPdsnMIBComplianceRev3=cCdmaPdsnMIBComplianceRev3, cCdmaClusterRole=cCdmaClusterRole, cCdmaRPRegTBitNotSetFailures=cCdmaRPRegTBitNotSetFailures, cCdmaInterPcfHandoffs=cCdmaInterPcfHandoffs, cCdmaRegReqAcctRecRetransErrs=cCdmaRegReqAcctRecRetransErrs, cCdmaPcfSoRpSessUpdAlwaysOn=cCdmaPcfSoRpSessUpdAlwaysOn, cCdmaRPRegBadCVSEFailures=cCdmaRPRegBadCVSEFailures, cCdmaPppLcpSuccesses=cCdmaPppLcpSuccesses, cCdmaRpUpdInitTransmittedReqs=cCdmaRpUpdInitTransmittedReqs, cCdmaPppConnectionInitiateReqs=cCdmaPppConnectionInitiateReqs, cCdmaSessionTotal=cCdmaSessionTotal, cCdmaRpRegAcceptedReqs=cCdmaRpRegAcceptedReqs, cCdmaRegReqInvMNIDTypeErrs=cCdmaRegReqInvMNIDTypeErrs, cCdmaPcfSoRpRegIdMismatFails=cCdmaPcfSoRpRegIdMismatFails, cCdmaPppAuthMschapAttempts=cCdmaPppAuthMschapAttempts, cCdmaRPRegMNAuthenFailures=cCdmaRPRegMNAuthenFailures, cCdmaPcfSoRpRegRcvdReqs=cCdmaPcfSoRpRegRcvdReqs, cCdmaRpErrors=cCdmaRpErrors, cCdmaSystemPdsnGroupRev4=cCdmaSystemPdsnGroupRev4, cCdmaPcfSoRpSessUpdStats=cCdmaPcfSoRpSessUpdStats, cCdmaRPUpdBadRequestFailures=cCdmaRPUpdBadRequestFailures, cCdmaPcfSoPppConnAborts=cCdmaPcfSoPppConnAborts, cCdmaRpRegReasonUnSpecFailures=cCdmaRpRegReasonUnSpecFailures, cCdmaFailSessionMsid=cCdmaFailSessionMsid, cCdmaClusterMemberLoad=cCdmaClusterMemberLoad, cCdmaRpInterPCFActiveHandoffs=cCdmaRpInterPCFActiveHandoffs, cCdmaNotifPdsnGroup=cCdmaNotifPdsnGroup, cCdmaPcfSoRpSessUpdAcptdReqs=cCdmaPcfSoRpSessUpdAcptdReqs, cCdmaRpReRegAirlinkStops=cCdmaRpReRegAirlinkStops, cCdmaSessionHaIpAddress=cCdmaSessionHaIpAddress, cCdmaPcfSoRpRegStatsEntry=cCdmaPcfSoRpRegStatsEntry, cCdmaRegUpdAckInvMNIDTypeErrs=cCdmaRegUpdAckInvMNIDTypeErrs, cCdmaPdsnMIBCompliance=cCdmaPdsnMIBCompliance, cCdmaPcfSoRpUpdAdmnFails=cCdmaPcfSoRpUpdAdmnFails, cCdmaPcfSoRpInitRegRcvdReqs=cCdmaPcfSoRpInitRegRcvdReqs, cCdmaPppRenegConnectionsAborted=cCdmaPppRenegConnectionsAborted, cCdmaSessionInfo=cCdmaSessionInfo, cCdmaDormantSessions=cCdmaDormantSessions, cCdmaSessionGREFromIPPkts=cCdmaSessionGREFromIPPkts, cCdmaRpUpdHandoffDeniedReqs=cCdmaRpUpdHandoffDeniedReqs, cCdmaPcfSoRpSessUpdIdMismatFails=cCdmaPcfSoRpSessUpdIdMismatFails, cCdmaPerformanceStats=cCdmaPerformanceStats, cCdmaSessionAddressingScheme=cCdmaSessionAddressingScheme, cCdmaSessionFlowEntry=cCdmaSessionFlowEntry, cCdmaServiceOptionIndex=cCdmaServiceOptionIndex, cCdmaRegReqStartOnCloseErrs=cCdmaRegReqStartOnCloseErrs, cCdmaPppRenegTotalReqs=cCdmaPppRenegTotalReqs, cCdmaRPUpdateStats=cCdmaRPUpdateStats, cCdmaPppAuthPapFailures=cCdmaPppAuthPapFailures, cCdmaSessionSentPkts=cCdmaSessionSentPkts, cCdmaSessionFlowTable=cCdmaSessionFlowTable, cCdmaPppRenegByPdsnReqs=cCdmaPppRenegByPdsnReqs, cCdmaPppSrvIntReleases=cCdmaPppSrvIntReleases, cCdmaRpDeRegAcceptedReqs=cCdmaRpDeRegAcceptedReqs, cCdmaRpUpdHandoffReaUnSpecFails=cCdmaRpUpdHandoffReaUnSpecFails, cCdmaPcfSoRpInitRegDeniedReqs=cCdmaPcfSoRpInitRegDeniedReqs, cCdmaRpRegUnknownPdsnFailures=cCdmaRpRegUnknownPdsnFailures, cCdmaRPRegReasonUnSpecFailures=cCdmaRPRegReasonUnSpecFailures, cCdmaPppAuthMsidSuccesses=cCdmaPppAuthMsidSuccesses, cCdmaPppMiscStats=cCdmaPppMiscStats, cCdmaFailSessionKey=cCdmaFailSessionKey, cCdmaPcfSoRpSessUpdBadReqFails=cCdmaPcfSoRpSessUpdBadReqFails, cCdmaTransmittedMipKiloOctets=cCdmaTransmittedMipKiloOctets, cCdmaClusterCtrlEntry=cCdmaClusterCtrlEntry, cCdmaSystemPdsnGroupRev5=cCdmaSystemPdsnGroupRev5, cCdmaPdsnMIBCompliances=cCdmaPdsnMIBCompliances, cCdmaPcfSoRpSessUpdParamNotUpdated=cCdmaPcfSoRpSessUpdParamNotUpdated, cCdmaPppAuthSkips=cCdmaPppAuthSkips, cCdmaPppL2tpTunnelReleases=cCdmaPppL2tpTunnelReleases, cCdmaPcfSoPppConnFails=cCdmaPcfSoPppConnFails, cCdmaPcfSoRpRegPcfUnknwnFails=cCdmaPcfSoRpRegPcfUnknwnFails, cCdmaRpRegBadCVSEFailures=cCdmaRpRegBadCVSEFailures, cCdmaStatusOOS2ISes=cCdmaStatusOOS2ISes, cCdmaClusterCommon=cCdmaClusterCommon, cCdmaSessionA11HaIp=cCdmaSessionA11HaIp, cCdmaRegReqInvConnectionIDErrs=cCdmaRegReqInvConnectionIDErrs, cCdmaPcfSoRpRegDeniedReqs=cCdmaPcfSoRpRegDeniedReqs, cCdmaPcfSoRpUpdIpAddr=cCdmaPcfSoRpUpdIpAddr, ciscoCdmaPdsnMIBObjects=ciscoCdmaPdsnMIBObjects, cCdmaRpSessUpdMNAuthenFailures=cCdmaRpSessUpdMNAuthenFailures, cCdmaRpUpdMNAuthenFailures=cCdmaRpUpdMNAuthenFailures, cCdmaRegRplyInternalErrs=cCdmaRegRplyInternalErrs, cCdmaPppIdleTimeoutReleases=cCdmaPppIdleTimeoutReleases, cCdmaPppIPCPPcfA10Releases=cCdmaPppIPCPPcfA10Releases, cCdmaPppConnectionSuccesses=cCdmaPppConnectionSuccesses, cCdmaRPUpdReasonUnSpecFailures=cCdmaRPUpdReasonUnSpecFailures, cCdmaPppAuthMsidAttempts=cCdmaPppAuthMsidAttempts, cCdmaClusterControllerInfo=cCdmaClusterControllerInfo, cCdmaClusterTotalControllers=cCdmaClusterTotalControllers, cCdmaSessUpdInternalErrs=cCdmaSessUpdInternalErrs, cCdmaPppTotalReleases=cCdmaPppTotalReleases, cCdmaThresholdConfig=cCdmaThresholdConfig, cCdmaSessionRegLifeTime=cCdmaSessionRegLifeTime, cCdmaFailSessionIndex=cCdmaFailSessionIndex, cCdmaPdsnMIBComplianceRev5=cCdmaPdsnMIBComplianceRev5, cCdmaRegReqDeRegNoSessionErrs=cCdmaRegReqDeRegNoSessionErrs, cCdmaRegUpdAckInvProtocolErrs=cCdmaRegUpdAckInvProtocolErrs, cCdmaPcfSoPppCurrentConns=cCdmaPcfSoPppCurrentConns, cCdmaRegReqFailedNotifEnabled=cCdmaRegReqFailedNotifEnabled, cCdmaRegReqInvAppSubTypeInVSEErrs=cCdmaRegReqInvAppSubTypeInVSEErrs, cCdmaPcfSoRpSessUpdStatsEntry=cCdmaPcfSoRpSessUpdStatsEntry, cCdmaPcfSoRpSessUpdInitTxdReqs=cCdmaPcfSoRpSessUpdInitTxdReqs, cCdmaPcfSoRpReRegDeniedReqs=cCdmaPcfSoRpReRegDeniedReqs, cCdmaRegReqInitRcvdStopErrs=cCdmaRegReqInitRcvdStopErrs, cCdmaSessionStatus=cCdmaSessionStatus, cCdmaPppCompressOtherCons=cCdmaPppCompressOtherCons, cCdmaPppAuthPapSuccesses=cCdmaPppAuthPapSuccesses, cCdmaFlowTypeStats=cCdmaFlowTypeStats, cCdmaNotifPdsnGroupRev3=cCdmaNotifPdsnGroupRev3, cCdmaPcfSoRpReRegAcptdReqs=cCdmaPcfSoRpReRegAcptdReqs, cCdmaPcfEntry=cCdmaPcfEntry, cCdmaSystemVersion=cCdmaSystemVersion, cCdmaVPDNFlowTotal=cCdmaVPDNFlowTotal, cCdmaNotifConfig=cCdmaNotifConfig, cCdmaSessUpdAckInvProtocolErrs=cCdmaSessUpdAckInvProtocolErrs, cCdmaPcfSoRpReRegAirlinkStops=cCdmaPcfSoRpReRegAirlinkStops, cCdmaSessionMaxAllowedNotif=cCdmaSessionMaxAllowedNotif, cCdmaRpRegStats=cCdmaRpRegStats, cCdmaPppBadLengthPktDiscards=cCdmaPppBadLengthPktDiscards, cCdmaRPUpdAcceptedReplies=cCdmaRPUpdAcceptedReplies, cCdmaFlowSimpleIpSuccesses=cCdmaFlowSimpleIpSuccesses, cCdmaRpUpdReTransmittedReqs=cCdmaRpUpdReTransmittedReqs, cCdmaPdsnPcfSoPppGroup=cCdmaPdsnPcfSoPppGroup, cCdmaRpRegTBitNotSetFailures=cCdmaRpRegTBitNotSetFailures, cCdmaSoRpUpdHandoffDiscardedAcks=cCdmaSoRpUpdHandoffDiscardedAcks, cCdmaRpDeRegReceivedReqs=cCdmaRpDeRegReceivedReqs, cCdmaClusterSessionLowReached=cCdmaClusterSessionLowReached, cCdmaPcfSoRpRegUnkPdsnFails=cCdmaPcfSoRpRegUnkPdsnFails)
mibBuilder.exportSymbols("CISCO-CDMA-PDSN-MIB", cCdmaSoRpUpdHandoffReaUnSpecFails=cCdmaSoRpUpdHandoffReaUnSpecFails, cCdmaConfig=cCdmaConfig, cCdmaSessUpdMemFailErrs=cCdmaSessUpdMemFailErrs, cCdmaRpUpdStats=cCdmaRpUpdStats, cCdmaPppRetransmittedEchoReqs=cCdmaPppRetransmittedEchoReqs, cCdmaPcfSoRpDeRegDiscardedReqs=cCdmaPcfSoRpDeRegDiscardedReqs, cCdmaSessionFaIp=cCdmaSessionFaIp, cCdmaRegUpdInternalErrs=cCdmaRegUpdInternalErrs, cCdmaInterPdsnHandoffs=cCdmaInterPdsnHandoffs, cCdmaPppAuthChapAttempts=cCdmaPppAuthChapAttempts, cCdmaRpHandoffRegReceivedReqs=cCdmaRpHandoffRegReceivedReqs, cCdmaNotifSeverityLevel=cCdmaNotifSeverityLevel, cCdmaPppCurrentConnections=cCdmaPppCurrentConnections, cCdmaClusterTotalSessions=cCdmaClusterTotalSessions, cCdmaFailHistServiceOption=cCdmaFailHistServiceOption, cCdmaPppAuthFailures=cCdmaPppAuthFailures, cCdmaFlowMobileIpFailures=cCdmaFlowMobileIpFailures, cCdmaPppConnectionFailures=cCdmaPppConnectionFailures, cCdmaPppIpcpPhaseReceivedTermreqs=cCdmaPppIpcpPhaseReceivedTermreqs, cCdmaRegUpdAckInvConnectionIDErrs=cCdmaRegUpdAckInvConnectionIDErrs, cCdmaRPRegNoRevTunnelFailures=cCdmaRPRegNoRevTunnelFailures, cCdmaSessionLowThreshold=cCdmaSessionLowThreshold, cCdmaRegReqInitRcvdSDBErrs=cCdmaRegReqInitRcvdSDBErrs, cCdmaRpUpdAcceptedReqs=cCdmaRpUpdAcceptedReqs, cCdmaReceivedSipKiloOctets=cCdmaReceivedSipKiloOctets, cCdmaSessionTable=cCdmaSessionTable, cCdmaRpDeRegDeniedReqs=cCdmaRpDeRegDeniedReqs, CCdmaServiceAffectedLevel=CCdmaServiceAffectedLevel, cCdmaPppTransmittedEchoReqs=cCdmaPppTransmittedEchoReqs, cCdmaRegReqStartOnActiveErrs=cCdmaRegReqStartOnActiveErrs, cCdmaPcfSoRpUpdRcvdAcks=cCdmaPcfSoRpUpdRcvdAcks, cCdmaClusterCtrlStatusChange2=cCdmaClusterCtrlStatusChange2, cCdmaSessionRcvdOctets=cCdmaSessionRcvdOctets, cCdmaRPUpdAdminProhibFailures=cCdmaRPUpdAdminProhibFailures, cCdmaPppAuthMsidFailures=cCdmaPppAuthMsidFailures, cCdmaPcfSoRpRegTBitNSetFails=cCdmaPcfSoRpRegTBitNSetFails, cCdmaFlowProxyIpSuccesses=cCdmaFlowProxyIpSuccesses, cCdmaPppLcpOptionIssueFailures=cCdmaPppLcpOptionIssueFailures, cCdmaSystemInfo=cCdmaSystemInfo, cCdmaPppAuthChapFailures=cCdmaPppAuthChapFailures, cCdmaPppUnknownProtocolPktDiscards=cCdmaPppUnknownProtocolPktDiscards, cCdmaAddressDynamicVPDNs=cCdmaAddressDynamicVPDNs, cCdmaRegReqInvMNIDErrs=cCdmaRegReqInvMNIDErrs, cCdmaPppAuthPdsnA10Releases=cCdmaPppAuthPdsnA10Releases, cCdmaPcfSoRpDeRegDeniedReqs=cCdmaPcfSoRpDeRegDeniedReqs, cCdmaSoRpUpdHandoffIdMismatchFails=cCdmaSoRpUpdHandoffIdMismatchFails, cCdmaSystemPdsnGroupRev3=cCdmaSystemPdsnGroupRev3, cCdmaRpRegNoRevTunnelFailures=cCdmaRpRegNoRevTunnelFailures, cCdmaSessionFormatErrorNotif=cCdmaSessionFormatErrorNotif, cCdmaRegReqInvMHAEKeyErrs=cCdmaRegReqInvMHAEKeyErrs, cCdmaSessionMsidType=cCdmaSessionMsidType, cCdmaRPSessUpdErrors=cCdmaRPSessUpdErrors, cCdmaSessUpdAckMemFailErrs=cCdmaSessUpdAckMemFailErrs, cCdmaRpUpdHandoffMNAuthenFails=cCdmaRpUpdHandoffMNAuthenFails, cCdmaPppAuthStats=cCdmaPppAuthStats, CCdmaSystemStatus=CCdmaSystemStatus, cCdmaPcfSoRpUpdReaUnSpecFails=cCdmaPcfSoRpUpdReaUnSpecFails, cCdmaFailSessionConnId=cCdmaFailSessionConnId, cCdmaFlowVpdnSuccesses=cCdmaFlowVpdnSuccesses, cCdmaRegReqInvSPIErrs=cCdmaRegReqInvSPIErrs, cCdmaClusterCtrlStatus=cCdmaClusterCtrlStatus, cCdmaSystemPdsnGroupRev1=cCdmaSystemPdsnGroupRev1, cCdmaSoRpUpdPcfHandoffs=cCdmaSoRpUpdPcfHandoffs, cCdmaClusterMemberAddressType=cCdmaClusterMemberAddressType, cCdmaRPRegUnknownHAAddrFailures=cCdmaRPRegUnknownHAAddrFailures, cCdmaFailHistPanId=cCdmaFailHistPanId, cCdmaPcfSoRpRegAcptdReqs=cCdmaPcfSoRpRegAcptdReqs, cCdmaSessionLowReached=cCdmaSessionLowReached, cCdmaTransmittedSipKiloOctets=cCdmaTransmittedSipKiloOctets, cCdmaPdsnMIBGroups=cCdmaPdsnMIBGroups, cCdmaTransmittedSDBPkts=cCdmaTransmittedSDBPkts, cCdmaSystemPdsnGroupSup1=cCdmaSystemPdsnGroupSup1, cCdmaPppMissEchoReleases=cCdmaPppMissEchoReleases, cCdmaPcfSoRpSessUpdDiscardedAcks=cCdmaPcfSoRpSessUpdDiscardedAcks, cCdmaClusterCtrlStatusChange=cCdmaClusterCtrlStatusChange, cCdmaRpInitRegDeniedReqs=cCdmaRpInitRegDeniedReqs, cCdmaPppCompressNegoCons=cCdmaPppCompressNegoCons, cCdmaStatusChangeStats=cCdmaStatusChangeStats, cCdmaSessionVJCompressEnabled=cCdmaSessionVJCompressEnabled, cCdmaSoRpUpdHandoffMNAuthenFails=cCdmaSoRpUpdHandoffMNAuthenFails, cCdmaRpHandoffRegDeniedReqs=cCdmaRpHandoffRegDeniedReqs, cCdmaPcfSoRpUpdPPPtermReqs=cCdmaPcfSoRpUpdPPPtermReqs, cCdmaRpRegIdMismatchFailures=cCdmaRpRegIdMismatchFailures, cCdmaMobileIpFlowTotal=cCdmaMobileIpFlowTotal, cCdmaSoRpUpdHandoffReceivedAcks=cCdmaSoRpUpdHandoffReceivedAcks, cCdmaClusterCtrlAddress=cCdmaClusterCtrlAddress, cCdmaSessUpdAckInvSPIErrs=cCdmaSessUpdAckInvSPIErrs, cCdmaRegReqDupCVSEErrs=cCdmaRegReqDupCVSEErrs, cCdmaRegReqInvProtocolErrs=cCdmaRegReqInvProtocolErrs, cCdmaServiceOptionEntry=cCdmaServiceOptionEntry, cCdmaPppLcpPhaseSentTermreqs=cCdmaPppLcpPhaseSentTermreqs, cCdmaTransmittedMipPkts=cCdmaTransmittedMipPkts, cCdmaAddressStaticVPDNs=cCdmaAddressStaticVPDNs, cCdmaAffectedAddressType=cCdmaAffectedAddressType, cCdmaRPRegInsuffResFailures=cCdmaRPRegInsuffResFailures, cCdmaSessionRegTimeToExpire=cCdmaSessionRegTimeToExpire, cCdmaPppDeregisterByPcfReleases=cCdmaPppDeregisterByPcfReleases, cCdmaPppAuthMaxRetransFailures=cCdmaPppAuthMaxRetransFailures, cCdmaSessionServiceOption=cCdmaSessionServiceOption, cCdmaSystemPdsnGroup=cCdmaSystemPdsnGroup, cCdmaFormatErrorNotifEnabled=cCdmaFormatErrorNotifEnabled, cCdmaPcfSoRpDeRegAcptdReqs=cCdmaPcfSoRpDeRegAcptdReqs, cCdmaRegReqMissingMHAEErrs=cCdmaRegReqMissingMHAEErrs, cCdmaClusterCtrlAddressType=cCdmaClusterCtrlAddressType, cCdmaRegUpdAckInvMNIDErrs=cCdmaRegUpdAckInvMNIDErrs, cCdmaReleasedSessions=cCdmaReleasedSessions, cCdmaSessionPdsnIp=cCdmaSessionPdsnIp, cCdmaPppIpcpFailuresUnknown=cCdmaPppIpcpFailuresUnknown, cCdmaPppConnectionsAborted=cCdmaPppConnectionsAborted, cCdmaPcfSoRpHandoffRegRcvdReqs=cCdmaPcfSoRpHandoffRegRcvdReqs, cCdmaRpReRegReceivedReqs=cCdmaRpReRegReceivedReqs, cCdmaReceivedMipPkts=cCdmaReceivedMipPkts, cCdmaRPRegistrationStats=cCdmaRPRegistrationStats, cCdmaPcfSoPppSetupStatsTable=cCdmaPcfSoPppSetupStatsTable, cCdmaSessionPdsnMaxFailHistory=cCdmaSessionPdsnMaxFailHistory, cCdmaPcfSoRpRegAdmnFails=cCdmaPcfSoRpRegAdmnFails, cCdmaPppAddrFilterReleases=cCdmaPppAddrFilterReleases, cCdmaPcfSoRpUpdDeniedReqs=cCdmaPcfSoRpUpdDeniedReqs, cCdmaRpUpdPPPtermReqs=cCdmaRpUpdPPPtermReqs, cCdmaPdsnPcfSoRpRegGroup=cCdmaPdsnPcfSoRpRegGroup)
