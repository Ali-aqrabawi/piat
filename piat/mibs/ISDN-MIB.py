...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/ISDN-MIB
...
IpAddress, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, TimeTicks, MibIdentifier, iso, ObjectIdentity, NotificationType, Counter64, transmission, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "TimeTicks", "MibIdentifier", "iso", "ObjectIdentity", "NotificationType", "Counter64", "transmission", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ISDN-MIB", isdnSignalingTable=isdnSignalingTable, isdnMibDirectoryGroup=isdnMibDirectoryGroup, isdnBasicRateTable=isdnBasicRateTable, isdnSignalingStatus=isdnSignalingStatus, isdnDirectorySigIndex=isdnDirectorySigIndex, isdnSignalingCallingAddress=isdnSignalingCallingAddress, isdnSigStatsInConnected=isdnSigStatsInConnected, IsdnSignalingProtocol=IsdnSignalingProtocol, isdnMibEndpointGroup=isdnMibEndpointGroup, isdnSigStatsOutConnected=isdnSigStatsOutConnected, isdnBearerCallOrigin=isdnBearerCallOrigin, isdnDirectoryEntry=isdnDirectoryEntry, isdnMibTrapPrefix=isdnMibTrapPrefix, isdnSignalingInfoTrapEnable=isdnSignalingInfoTrapEnable, isdnBearerPeerSubAddress=isdnBearerPeerSubAddress, isdnLapdTable=isdnLapdTable, isdnSignalingEntry=isdnSignalingEntry, isdnBearerCallSetupTime=isdnBearerCallSetupTime, isdnBearerEntry=isdnBearerEntry, isdnMibBearerGroup=isdnMibBearerGroup, isdnEndpointIfIndex=isdnEndpointIfIndex, isdnBearerCallConnectTime=isdnBearerCallConnectTime, isdnEndpointSpid=isdnEndpointSpid, isdnMibBasicRateGroup=isdnMibBasicRateGroup, PYSNMP_MODULE_ID=isdnMib, isdnDirectoryNumber=isdnDirectoryNumber, isdnEndpointIfType=isdnEndpointIfType, isdnMibCompliances=isdnMibCompliances, isdnSignalingBchannelCount=isdnSignalingBchannelCount, isdnBearerGroup=isdnBearerGroup, isdnEndpointTeiValue=isdnEndpointTeiValue, isdnDirectoryTable=isdnDirectoryTable, isdnBearerChannelNumber=isdnBearerChannelNumber, isdnSignalingIndex=isdnSignalingIndex, isdnMibObjects=isdnMibObjects, isdnDirectoryStatus=isdnDirectoryStatus, isdnMibCallInformation=isdnMibCallInformation, isdnBasicRateGroup=isdnBasicRateGroup, isdnEndpointEntry=isdnEndpointEntry, isdnBearerInfoType=isdnBearerInfoType, isdnBasicRateLineTopology=isdnBasicRateLineTopology, isdnMibConformance=isdnMibConformance, isdnLapdPrimaryChannel=isdnLapdPrimaryChannel, isdnBearerTable=isdnBearerTable, isdnMibNotificationsGroup=isdnMibNotificationsGroup, isdnSignalingStatsEntry=isdnSignalingStatsEntry, isdnMibGroups=isdnMibGroups, isdnBearerOperStatus=isdnBearerOperStatus, isdnEndpointStatus=isdnEndpointStatus, isdnMib=isdnMib, isdnBearerMultirate=isdnBearerMultirate, isdnSigStatsChargedUnits=isdnSigStatsChargedUnits, isdnSigStatsInCalls=isdnSigStatsInCalls, isdnBearerChargedUnits=isdnBearerChargedUnits, isdnLapdPeerSabme=isdnLapdPeerSabme, isdnBasicRateEntry=isdnBasicRateEntry, isdnDirectoryIndex=isdnDirectoryIndex, isdnEndpointGroup=isdnEndpointGroup, isdnSignalingProtocol=isdnSignalingProtocol, isdnSigStatsOutCalls=isdnSigStatsOutCalls, isdnSignalingIfIndex=isdnSignalingIfIndex, isdnEndpointTable=isdnEndpointTable, isdnSignalingGroup=isdnSignalingGroup, isdnEndpointTeiType=isdnEndpointTeiType, isdnEndpointIndex=isdnEndpointIndex, isdnBearerChannelType=isdnBearerChannelType, isdnSignalingSubAddress=isdnSignalingSubAddress, isdnDirectoryGroup=isdnDirectoryGroup, isdnMibTraps=isdnMibTraps, isdnSignalingGetIndex=isdnSignalingGetIndex, isdnSignalingStatsTable=isdnSignalingStatsTable, isdnMibSignalingGroup=isdnMibSignalingGroup, isdnMibCompliance=isdnMibCompliance, isdnBasicRateIfMode=isdnBasicRateIfMode, isdnLapdOperStatus=isdnLapdOperStatus, isdnBasicRateIfType=isdnBasicRateIfType, isdnLapdEntry=isdnLapdEntry, isdnEndpointGetIndex=isdnEndpointGetIndex, isdnLapdRecvdFrmr=isdnLapdRecvdFrmr, isdnBearerPeerAddress=isdnBearerPeerAddress, isdnBasicRateSignalMode=isdnBasicRateSignalMode)
