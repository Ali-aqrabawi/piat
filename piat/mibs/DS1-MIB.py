...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/DS1-MIB
...
mibBuilder.exportSymbols("DS1-MIB", dsx1FarEndCurrentPCVs=dsx1FarEndCurrentPCVs, dsx1Channelization=dsx1Channelization, dsx1ChanMappingEntry=dsx1ChanMappingEntry, dsx1TotalEntry=dsx1TotalEntry, dsx1CurrentUASs=dsx1CurrentUASs, dsx1IntervalLESs=dsx1IntervalLESs, dsx1FarEndTotalLESs=dsx1FarEndTotalLESs, dsx1ChanMappedIfIndex=dsx1ChanMappedIfIndex, dsx1FarEndIntervalESs=dsx1FarEndIntervalESs, dsx1Ds1ChannelNumber=dsx1Ds1ChannelNumber, dsx1FarEndTotalPCVs=dsx1FarEndTotalPCVs, ds1NCompliance=ds1NCompliance, PYSNMP_MODULE_ID=ds1, dsx1TotalLESs=dsx1TotalLESs, ds1NearEndStatGroup=ds1NearEndStatGroup, dsx1IntervalDMs=dsx1IntervalDMs, dsx1CurrentDMs=dsx1CurrentDMs, dsx1ChanMappingTable=dsx1ChanMappingTable, ds1Conformance=ds1Conformance, dsx1InvalidIntervals=dsx1InvalidIntervals, dsx1IntervalValidData=dsx1IntervalValidData, dsx1TotalBESs=dsx1TotalBESs, dsx1FarEndCurrentIndex=dsx1FarEndCurrentIndex, ds1NearEndStatisticsGroup=ds1NearEndStatisticsGroup, dsx1FarEndTotalIndex=dsx1FarEndTotalIndex, dsx1FarEndIntervalUASs=dsx1FarEndIntervalUASs, dsx1FarEndValidIntervals=dsx1FarEndValidIntervals, dsx1FarEndTotalTable=dsx1FarEndTotalTable, dsx1IntervalEntry=dsx1IntervalEntry, ds1MibE1PriCompliance=ds1MibE1PriCompliance, ds1Traps=ds1Traps, ds1ChanMappingGroup=ds1ChanMappingGroup, ds1DeprecatedGroup=ds1DeprecatedGroup, dsx1FarEndTimeElapsed=dsx1FarEndTimeElapsed, dsx1FarEndTotalDMs=dsx1FarEndTotalDMs, dsx1TotalLCVs=dsx1TotalLCVs, dsx1TransmitClockSource=dsx1TransmitClockSource, dsx1IntervalTable=dsx1IntervalTable, dsx1TotalSESs=dsx1TotalSESs, dsx1FracTable=dsx1FracTable, ds1NearEndOptionalConfigGroup=ds1NearEndOptionalConfigGroup, ds1NMibE1PriNCompliance=ds1NMibE1PriNCompliance, dsx1FracIndex=dsx1FracIndex, dsx1CurrentBESs=dsx1CurrentBESs, dsx1LineStatusChangeTrapEnable=dsx1LineStatusChangeTrapEnable, ds1NMibT1PriNCompliance=ds1NMibT1PriNCompliance, dsx1LineIndex=dsx1LineIndex, dsx1FarEndCurrentESs=dsx1FarEndCurrentESs, dsx1SendCode=dsx1SendCode, ds1J1Compliance=ds1J1Compliance, dsx1FarEndTotalSEFSs=dsx1FarEndTotalSEFSs, ds1MibT1PriCompliance=ds1MibT1PriCompliance, dsx1FarEndTotalESs=dsx1FarEndTotalESs, dsx1FarEndIntervalBESs=dsx1FarEndIntervalBESs, ds1NearEndConfigGroup=ds1NearEndConfigGroup, ds1NearEndConfigurationGroup=ds1NearEndConfigurationGroup, dsx1LineCoding=dsx1LineCoding, dsx1FarEndCurrentDMs=dsx1FarEndCurrentDMs, ds1TransStatsGroup=ds1TransStatsGroup, dsx1FarEndIntervalLESs=dsx1FarEndIntervalLESs, dsx1CurrentIndex=dsx1CurrentIndex, dsx1FarEndCurrentUASs=dsx1FarEndCurrentUASs, dsx1Fdl=dsx1Fdl, dsx1FarEndCurrentSEFSs=dsx1FarEndCurrentSEFSs, dsx1IntervalESs=dsx1IntervalESs, dsx1FracNumber=dsx1FracNumber, dsx1IntervalPCVs=dsx1IntervalPCVs, dsx1CurrentSESs=dsx1CurrentSESs, ds1Ds2Compliance=ds1Ds2Compliance, dsx1FarEndTotalBESs=dsx1FarEndTotalBESs, dsx1FarEndInvalidIntervals=dsx1FarEndInvalidIntervals, dsx1IntervalIndex=dsx1IntervalIndex, dsx1IntervalLCVs=dsx1IntervalLCVs, ds1MibT1PriNCompliance=ds1MibT1PriNCompliance, dsx1TotalSEFSs=dsx1TotalSEFSs, dsx1CurrentCSSs=dsx1CurrentCSSs, dsx1FarEndCurrentEntry=dsx1FarEndCurrentEntry, dsx1FarEndTotalUASs=dsx1FarEndTotalUASs, dsx1TotalIndex=dsx1TotalIndex, dsx1FarEndIntervalPCVs=dsx1FarEndIntervalPCVs, dsx1ValidIntervals=dsx1ValidIntervals, dsx1CircuitIdentifier=dsx1CircuitIdentifier, ds1Compliance=ds1Compliance, dsx1IntervalUASs=dsx1IntervalUASs, dsx1IfIndex=dsx1IfIndex, dsx1FarEndIntervalCSSs=dsx1FarEndIntervalCSSs, dsx1FarEndIntervalValidData=dsx1FarEndIntervalValidData, dsx1FarEndIntervalNumber=dsx1FarEndIntervalNumber, dsx1ConfigTable=dsx1ConfigTable, dsx1LineImpedance=dsx1LineImpedance, dsx1CurrentTable=dsx1CurrentTable, ds1NearEndCfgGroup=ds1NearEndCfgGroup, dsx1FarEndCurrentBESs=dsx1FarEndCurrentBESs, dsx1CurrentPCVs=dsx1CurrentPCVs, dsx1CurrentLESs=dsx1CurrentLESs, dsx1TotalDMs=dsx1TotalDMs, dsx1CurrentSEFSs=dsx1CurrentSEFSs, dsx1CurrentESs=dsx1CurrentESs, ds1Compliances=ds1Compliances, ds1NearEndOptionalTrapGroup=ds1NearEndOptionalTrapGroup, dsx1CurrentLCVs=dsx1CurrentLCVs, dsx1TotalTable=dsx1TotalTable, ds1Groups=ds1Groups, dsx1IntervalCSSs=dsx1IntervalCSSs, dsx1TotalESs=dsx1TotalESs, dsx1FarEndIntervalSEFSs=dsx1FarEndIntervalSEFSs, dsx1LoopbackConfig=dsx1LoopbackConfig, ds1MibE1PriNCompliance=ds1MibE1PriNCompliance, dsx1FracIfIndex=dsx1FracIfIndex, dsx1LineStatusChange=dsx1LineStatusChange, dsx1SignalMode=dsx1SignalMode, dsx1IntervalNumber=dsx1IntervalNumber, dsx1TotalUASs=dsx1TotalUASs, dsx1LoopbackStatus=dsx1LoopbackStatus, ds1DS2Group=ds1DS2Group, dsx1FarEndCurrentCSSs=dsx1FarEndCurrentCSSs, ds1FarEndNGroup=ds1FarEndNGroup, ds1FarEndGroup=ds1FarEndGroup, dsx1TotalCSSs=dsx1TotalCSSs, dsx1FarEndTotalCSSs=dsx1FarEndTotalCSSs, dsx1TimeElapsed=dsx1TimeElapsed, dsx1IntervalBESs=dsx1IntervalBESs, dsx1TotalPCVs=dsx1TotalPCVs, dsx1IntervalSEFSs=dsx1IntervalSEFSs, dsx1FarEndTotalEntry=dsx1FarEndTotalEntry, dsx1ConfigEntry=dsx1ConfigEntry, dsx1LineType=dsx1LineType, dsx1LineMode=dsx1LineMode, dsx1LineStatus=dsx1LineStatus, dsx1FracEntry=dsx1FracEntry, dsx1FarEndIntervalSESs=dsx1FarEndIntervalSESs, dsx1FarEndCurrentTable=dsx1FarEndCurrentTable, dsx1FarEndIntervalDMs=dsx1FarEndIntervalDMs, dsx1LineLength=dsx1LineLength, dsx1LineStatusLastChange=dsx1LineStatusLastChange, dsx1FarEndCurrentSESs=dsx1FarEndCurrentSESs, dsx1FarEndTotalSESs=dsx1FarEndTotalSESs, dsx1IntervalSESs=dsx1IntervalSESs, dsx1FarEndIntervalEntry=dsx1FarEndIntervalEntry, dsx1CurrentEntry=dsx1CurrentEntry, ds1=ds1, dsx1FarEndIntervalIndex=dsx1FarEndIntervalIndex, dsx1FarEndIntervalTable=dsx1FarEndIntervalTable, dsx1FarEndCurrentLESs=dsx1FarEndCurrentLESs, dsx1LineBuildOut=dsx1LineBuildOut)
