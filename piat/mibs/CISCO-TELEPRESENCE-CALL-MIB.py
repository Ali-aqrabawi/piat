...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-TELEPRESENCE-CALL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:35:50 2019
...
TimeTicks, MibIdentifier, iso, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Counter64, ModuleIdentity, Unsigned32, IpAddress, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "iso", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Counter64", "ModuleIdentity", "Unsigned32", "IpAddress", "NotificationType", "Gauge32")
DateAndTime, TruthValue, RowStatus, VariablePointer, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TruthValue", "RowStatus", "VariablePointer", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-CALL-MIB", ctpcRxMaxPeriodLostPackets=ctpcRxMaxPeriodLostPackets, ctpcTxCallLostPackets=ctpcTxCallLostPackets, ciscoTelepresenceCallMIBObjects=ciscoTelepresenceCallMIBObjects, ctpcRxDscpPrevious=ctpcRxDscpPrevious, ctpcStatTotalCalls=ctpcStatTotalCalls, ctpcDirection=ctpcDirection, ctpcRxCallAuthFailure=ctpcRxCallAuthFailure, ctpcTxCallBitRate=ctpcTxCallBitRate, ciscoTpCallMIBComplianceRev2=ciscoTpCallMIBComplianceRev2, ciscoTpCallStatisticsGroupSup3=ciscoTpCallStatisticsGroupSup3, ctpcMaxCallJitterRecTime=ctpcMaxCallJitterRecTime, ctpcRxIDRPackets=ctpcRxIDRPackets, ciscoTpCallMIBCompliance=ciscoTpCallMIBCompliance, ctpcStatMonitorObjects=ctpcStatMonitorObjects, ctpcLocalAddrType=ctpcLocalAddrType, CtpcStreamSourceType=CtpcStreamSourceType, ctpcRxVideoHorzPixels=ctpcRxVideoHorzPixels, ctpcTableSize=ctpcTableSize, ciscoTpCallMIBComplianceRev4=ciscoTpCallMIBComplianceRev4, ctpcMgmtSysConnEventHistLastIndex=ctpcMgmtSysConnEventHistLastIndex, ctpcTxPeriodLostPackets=ctpcTxPeriodLostPackets, ctpcAvgPeriodLatency=ctpcAvgPeriodLatency, ctpcRxMaxCallLostPackets=ctpcRxMaxCallLostPackets, ctpcStatEventHistory=ctpcStatEventHistory, ctpcMgmtSysConnEventHistTableSize=ctpcMgmtSysConnEventHistTableSize, ctpcStatEventTimeStamp=ctpcStatEventTimeStamp, ctpcMgmtSysConnEventHistoryIndex=ctpcMgmtSysConnEventHistoryIndex, ciscoTpCallInformationGroupSup2=ciscoTpCallInformationGroupSup2, ctpcStatNotifyEnable=ctpcStatNotifyEnable, ctpcRxPeriodBitRate=ctpcRxPeriodBitRate, ctpcInfoObjects=ctpcInfoObjects, ctpcIndex=ctpcIndex, ctpcRxTotalBytes=ctpcRxTotalBytes, ctpcRxCodec=ctpcRxCodec, ctpcStatEventHistoryIndex=ctpcStatEventHistoryIndex, ctpcState=ctpcState, ctpcStatEventHistLastIndex=ctpcStatEventHistLastIndex, ctpcStatEventCrossedValue=ctpcStatEventCrossedValue, ciscoTpCallMIBGroups=ciscoTpCallMIBGroups, ctpcType=ctpcType, ctpcStatMonitoredEntry=ctpcStatMonitoredEntry, ctpcRxCoSCurrent=ctpcRxCoSCurrent, ctpcStreamType=ctpcStreamType, ctpcStatNotificaion=ctpcStatNotificaion, ctpcRxDscpCurrent=ctpcRxDscpCurrent, ctpcLocalDirNumEntry=ctpcLocalDirNumEntry, CtpcCodecType=CtpcCodecType, ciscoTelepresenceCallMIBNotifs=ciscoTelepresenceCallMIBNotifs, ctpcCallTermReason=ctpcCallTermReason, ctpcStartDateAndTime=ctpcStartDateAndTime, ctpcMgmtSysConnStatus=ctpcMgmtSysConnStatus, ctpcInitialBitRate=ctpcInitialBitRate, ctpcLocalAddr=ctpcLocalAddr, ctpcTxDscpAudioConfigured=ctpcTxDscpAudioConfigured, CtpcStatThreshCrossedType=CtpcStatThreshCrossedType, ctpcMgmtSysConnEventTimeStamp=ctpcMgmtSysConnEventTimeStamp, ctpcRxLostPackets=ctpcRxLostPackets, ctpcTxLostPackets=ctpcTxLostPackets, ciscoTelepresenceCallMIB=ciscoTelepresenceCallMIB, ctpcRxCallBitRate=ctpcRxCallBitRate, ctpcMgmtSysConnEventSIPRespCode=ctpcMgmtSysConnEventSIPRespCode, ctpcTxDestAddrType=ctpcTxDestAddrType, CtpcStatAlarmMode=CtpcStatAlarmMode, ctpcRxDuplicatePackets=ctpcRxDuplicatePackets, ciscoTpCallInformationGroupSup1=ciscoTpCallInformationGroupSup1, ciscoTpCallStatisticsGroupSup1=ciscoTpCallStatisticsGroupSup1, ctpcAttributes=ctpcAttributes, ctpcMaxPeriodJitter=ctpcMaxPeriodJitter, ctpcMediaDestPort=ctpcMediaDestPort, ctpcExtNumberMask=ctpcExtNumberMask, ctpcRxTotalPackets=ctpcRxTotalPackets, ctpcStatMonitoredUnit=ctpcStatMonitoredUnit, ctpcStatEventHistoryEntry=ctpcStatEventHistoryEntry, ciscoTpCallConfigurationGroup=ciscoTpCallConfigurationGroup, ctpcTxDestAddr=ctpcTxDestAddr, CtpcStatMonitoredAttribute=CtpcStatMonitoredAttribute, ctpcStatStreamSourceTable=ctpcStatStreamSourceTable, ctpcTable=ctpcTable, ctpcStatEventCrossedType=ctpcStatEventCrossedType, ciscoTpCallMIBCompliances=ciscoTpCallMIBCompliances, ctpcStatOverallCallTime=ctpcStatOverallCallTime, ctpcTxShapingWindow=ctpcTxShapingWindow, ciscoTpCallStatisticsGroupSup2=ciscoTpCallStatisticsGroupSup2, ctpcStatEventHistTableSize=ctpcStatEventHistTableSize, ctpcTxVideoHorzPixels=ctpcTxVideoHorzPixels, ctpcStatRisingThreshold=ctpcStatRisingThreshold, ciscoTpCallStatisticsGroup=ciscoTpCallStatisticsGroup, ctpcLatestBitRate=ctpcLatestBitRate, ctpcStatOverallCalls=ctpcStatOverallCalls, CtpcMgmtSysConnStatusCode=CtpcMgmtSysConnStatusCode, ctpcMgmtSysAddrType=ctpcMgmtSysAddrType, CtpcE164Address=CtpcE164Address, ctpcStreamSource=ctpcStreamSource, ctpcLocalDirNumTable=ctpcLocalDirNumTable, ctpcMode=ctpcMode, ctpcRxLatePackets=ctpcRxLatePackets, ciscoTpCallInformationGroup=ciscoTpCallInformationGroup, ctpcStatFallingThreshold=ctpcStatFallingThreshold, ctpcMgmtSysConnFailNotification=ctpcMgmtSysConnFailNotification, ctpcRxVideoVertPixels=ctpcRxVideoVertPixels, ctpcActiveMgmtSysIndex=ctpcActiveMgmtSysIndex, ctpcSecurity=ctpcSecurity, ctpcStatEventMonObjectInst=ctpcStatEventMonObjectInst, CtpcAttributes=CtpcAttributes, CtpcStatMonitoredAttributeUnit=CtpcStatMonitoredAttributeUnit, CtpcCallTerminationCode=CtpcCallTerminationCode, ciscoTpCallNotificationGroupRev1=ciscoTpCallNotificationGroupRev1, ctpcMaxCallJitter=ctpcMaxCallJitter, ctpcMgmtSysConnEventHistory=ctpcMgmtSysConnEventHistory, ctpcStatStreamSourceEntry=ctpcStatStreamSourceEntry, ciscoTpCallNotificationGroup=ciscoTpCallNotificationGroup, ctpcLocalDirNum=ctpcLocalDirNum, ctpcTxTotalPackets=ctpcTxTotalPackets, ctpcMgmtSysEntry=ctpcMgmtSysEntry, ctpcStatStreamTypeTable=ctpcStatStreamTypeTable, ctpcStatMonitoredStatus=ctpcStatMonitoredStatus, ctpcRxPeriodLostPackets=ctpcRxPeriodLostPackets, ctpcStatMonitoredTable=ctpcStatMonitoredTable, ctpcStatObjects=ctpcStatObjects, ctpcRxOutOfOrderPackets=ctpcRxOutOfOrderPackets, ctpcMgmtSysConnEventHistoryTable=ctpcMgmtSysConnEventHistoryTable, ciscoTpCallMIBComplianceRev1=ciscoTpCallMIBComplianceRev1, ciscoTpCallMIBComplianceRev3=ciscoTpCallMIBComplianceRev3, ciscoTelepresenceCallMIBConform=ciscoTelepresenceCallMIBConform, ctpcMediaSrcPort=ctpcMediaSrcPort, ctpcMgmtSysConnNotifyEnable=ctpcMgmtSysConnNotifyEnable, ctpcMgmtSysAddr=ctpcMgmtSysAddr, ctpcTxCodec=ctpcTxCodec, ctpcAvgCallLatency=ctpcAvgCallLatency, ciscoTpCallMgmtSysConnEventHistGroup=ciscoTpCallMgmtSysConnEventHistGroup, ctpcRxCoSPrevious=ctpcRxCoSPrevious, ciscoTpCallMIBComplianceRev5=ciscoTpCallMIBComplianceRev5, ctpcTxPeriodBitRate=ctpcTxPeriodBitRate, ctpcTxTotalBytes=ctpcTxTotalBytes, ctpcStatEventHistoryTable=ctpcStatEventHistoryTable, ctpcStatTotalCallTime=ctpcStatTotalCallTime, ctpcMaxCallLatencyRecTime=ctpcMaxCallLatencyRecTime, ctpcMaxPeriodLatency=ctpcMaxPeriodLatency, ctpcTableLastIndex=ctpcTableLastIndex, ctpcMgmtSysTable=ctpcMgmtSysTable, PYSNMP_MODULE_ID=ciscoTelepresenceCallMIB, ctpcRxActive=ctpcRxActive, ctpcAvgPeriodJitter=ctpcAvgPeriodJitter, ctpcMgmtSysConnEventStatus=ctpcMgmtSysConnEventStatus, ctpcRowStatus=ctpcRowStatus, ctpcTxFrameRate=ctpcTxFrameRate, ctpcRxMaxCallLostPacketsRecTime=ctpcRxMaxCallLostPacketsRecTime, ctpcAvgCallJitter=ctpcAvgCallJitter, ctpcRxFrameRate=ctpcRxFrameRate, ctpcTxVideoVertPixels=ctpcTxVideoVertPixels, ctpcDuration=ctpcDuration, ctpcRxShapingWindow=ctpcRxShapingWindow, ctpcMgmtSysIndex=ctpcMgmtSysIndex, ctpcStatMonitoredStreamType=ctpcStatMonitoredStreamType, ctpcSamplePeriod=ctpcSamplePeriod, ctpcStatMonitoredType=ctpcStatMonitoredType, CtpcStreamMediaType=CtpcStreamMediaType, ctpcEntry=ctpcEntry, CtpcRemoteDeviceType=CtpcRemoteDeviceType, ctpcLocalDirNumIndex=ctpcLocalDirNumIndex, ctpcTxIDRPackets=ctpcTxIDRPackets, ciscoTpCallEventHistoryGroup=ciscoTpCallEventHistoryGroup, ctpcRemoteDirNum=ctpcRemoteDirNum, ctpcRemoteDevice=ctpcRemoteDevice, CtpcStateCode=CtpcStateCode, ctpcMaxCallLatency=ctpcMaxCallLatency, ctpcMgmtSysSIPRespCode=ctpcMgmtSysSIPRespCode, ctpcLocalSIPCallId=ctpcLocalSIPCallId, ctpcObjects=ctpcObjects, ctpcTxActive=ctpcTxActive, ctpcStatStartupAlarm=ctpcStatStartupAlarm, ctpcRxCallLostPackets=ctpcRxCallLostPackets, ctpcTxDscpTelepresenceConfigured=ctpcTxDscpTelepresenceConfigured, ctpcMgmtSysConnEventNotification=ctpcMgmtSysConnEventNotification, ctpcMgmtSysConnEventHistoryEntry=ctpcMgmtSysConnEventHistoryEntry, ctpcStatStreamTypeEntry=ctpcStatStreamTypeEntry)
