...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IPSEC-PROVISIONING-MIB
...
CIPsecNumCryptoMaps, CIPsecSecuritySuite, CIPsecLifetime, CIPsecEncapMode, CIPsecCryptomapType, CIPsecTunnelIdleTime, CIPsecDiffHellmanGrp, CIPsecLifesize, CIPsecTransform = mibBuilder.importSymbols("CISCO-IPSEC-TC", "CIPsecNumCryptoMaps", "CIPsecSecuritySuite", "CIPsecLifetime", "CIPsecEncapMode", "CIPsecCryptomapType", "CIPsecTunnelIdleTime", "CIPsecDiffHellmanGrp", "CIPsecLifesize", "CIPsecTransform")
...
mibBuilder.exportSymbols("CISCO-IPSEC-PROVISIONING-MIB", ciscoIPsecProvisioningMIBObjects=ciscoIPsecProvisioningMIBObjects, cipsCryMapPeerAddr=cipsCryMapPeerAddr, cipsStaticCryptomapSetEntry=cipsStaticCryptomapSetEntry, cipsIfStaticCryptomapSetName=cipsIfStaticCryptomapSetName, cipsXformSetStatus=cipsXformSetStatus, cipsCryptomapSetIfStatus=cipsCryptomapSetIfStatus, cipsStaticCryptomapSetNumTED=cipsStaticCryptomapSetNumTED, cipsStaticCryptomapLifesize=cipsStaticCryptomapLifesize, PYSNMP_MODULE_ID=ciscoIPsecProvisioningMIB, cipsStaticCryptomapIdleTimeout=cipsStaticCryptomapIdleTimeout, cipsStaticCryptomapIpFilter=cipsStaticCryptomapIpFilter, cipsCryptoMaps=cipsCryptoMaps, cipsXformSetName=cipsXformSetName, cipsNumTEDCryptomapSets=cipsNumTEDCryptomapSets, cipsStaticCryptomapSetNumSAs=cipsStaticCryptomapSetNumSAs, cipsCntlAllNotifs=cipsCntlAllNotifs, cipsStaticCryotomapNextPIndex=cipsStaticCryotomapNextPIndex, ciscoIPsecCryptomapPeerGroup=ciscoIPsecCryptomapPeerGroup, ciscoIPsecProvInfoGroup=ciscoIPsecProvInfoGroup, cipsIfCryptomapSetInfoEntry=cipsIfCryptomapSetInfoEntry, cipsIPsecXformSetEntry=cipsIPsecXformSetEntry, ciscoIPsecProvNotifGroup=ciscoIPsecProvNotifGroup, cipsXformSetSuite=cipsXformSetSuite, cipsStaticCryptomapCurPAddrType=cipsStaticCryptomapCurPAddrType, cipsXformSetEncryptionXform=cipsXformSetEncryptionXform, cipsCryptoMapGeneral=cipsCryptoMapGeneral, ciscoIPsecProvisioningMIBNotifs=ciscoIPsecProvisioningMIBNotifs, cipsNumStaticCryptomapSets=cipsNumStaticCryptomapSets, cipsStaticCryptomapEntry=cipsStaticCryptomapEntry, cipsIPsecXformSetTable=cipsIPsecXformSetTable, cipsCntlCryptomapAdded=cipsCntlCryptomapAdded, cipsStaticCryptomapSetName=cipsStaticCryptomapSetName, ciscoIPsecProvStCryptomapGroup=ciscoIPsecProvStCryptomapGroup, cipsStaticCryptomapDescr=cipsStaticCryptomapDescr, cipsIfCryptomapSetInfoTable=cipsIfCryptomapSetInfoTable, cipsNotificationCntl=cipsNotificationCntl, cipsCntlCryptomapSetAttached=cipsCntlCryptomapSetAttached, cipsStaticCryptomapSetNumIsakmp=cipsStaticCryptomapSetNumIsakmp, cipsTunnelIdleTimeout=cipsTunnelIdleTimeout, ciscoIPsecProvCryptomapAttached=ciscoIPsecProvCryptomapAttached, cipsStaticCryptomapType=cipsStaticCryptomapType, cipsNumDynamicCryptomapSets=cipsNumDynamicCryptomapSets, cipsXformSetId=cipsXformSetId, cipsStaticCryptomapSetTable=cipsStaticCryptomapSetTable, ciscoIPsecProvDynCryptomapGroup=ciscoIPsecProvDynCryptomapGroup, cipsStaticCryptomapSetNumDynamic=cipsStaticCryptomapSetNumDynamic, cipsCryMapPeerStatus=cipsCryMapPeerStatus, ciscoIPsecProvCryptomapAdded=ciscoIPsecProvCryptomapAdded, cipsStaticCryptomapNumPeers=cipsStaticCryptomapNumPeers, cipsStaticCryptomapAutoPeer=cipsStaticCryptomapAutoPeer, cipsCntlCryptomapSetDetached=cipsCntlCryptomapSetDetached, cipsStaticCryptomapSetNumManual=cipsStaticCryptomapSetNumManual, cipsStaticCryptomapTable=cipsStaticCryptomapTable, cipsStaticCryptomapPriority=cipsStaticCryptomapPriority, ciscoIPsecProvMIBGroups=ciscoIPsecProvMIBGroups, cipsCryptomapSetIfEntry=cipsCryptomapSetIfEntry, ciscoIPsecProvisioningMIBConform=ciscoIPsecProvisioningMIBConform, ciscoIPsecProvXformsGroup=ciscoIPsecProvXformsGroup, cipsIPsecCryMapPeerTable=cipsIPsecCryMapPeerTable, cipsCryMapPeerIndex=cipsCryMapPeerIndex, cipsXformSetIntegrityXformEsp=cipsXformSetIntegrityXformEsp, cipsStaticCryptomapLifetime=cipsStaticCryptomapLifetime, cipsTunnelLifesize=cipsTunnelLifesize, cipsStaticCryptomapLevelHost=cipsStaticCryptomapLevelHost, cipsIPsecGlobals=cipsIPsecGlobals, cipsIPsecTransforms=cipsIPsecTransforms, cipsXformSetMode=cipsXformSetMode, cipsStaticCryptomapStatus=cipsStaticCryptomapStatus, ciscoIPsecProvNotifCntlGroup=ciscoIPsecProvNotifCntlGroup, ciscoIPsecProvGlobalsGroup=ciscoIPsecProvGlobalsGroup, ciscoIPsecProvMIBCompliance=ciscoIPsecProvMIBCompliance, cipsStaticCryptomapCurPAddr=cipsStaticCryptomapCurPAddr, cipsCryMapPeerAddrType=cipsCryMapPeerAddrType, cipsCryptomapSetIfTable=cipsCryptomapSetIfTable, cipsStaticCryptomapPfs=cipsStaticCryptomapPfs, ciscoIPsecProvMIBCompliances=ciscoIPsecProvMIBCompliances, ciscoIPsecProvMIBComplianceRev1=ciscoIPsecProvMIBComplianceRev1, cipsCryMapPeerOrder=cipsCryMapPeerOrder, cipsCntlCryptomapDeleted=cipsCntlCryptomapDeleted, cipsStaticCryptomapXformSetList=cipsStaticCryptomapXformSetList, cipsTunnelLifetime=cipsTunnelLifetime, ciscoIPsecProvCryptomapDeleted=ciscoIPsecProvCryptomapDeleted, ciscoIPsecProvTedCryptomapGroup=ciscoIPsecProvTedCryptomapGroup, ciscoIPsecProvCryptomapDetached=ciscoIPsecProvCryptomapDetached, cipsXformSetCompressionXform=cipsXformSetCompressionXform, cipsXformSetIntegrityXformAh=cipsXformSetIntegrityXformAh, cipsStaticCryptomapSetSize=cipsStaticCryptomapSetSize, ciscoIPsecProvisioningMIB=ciscoIPsecProvisioningMIB, cipsIPsecCryMapPeerEntry=cipsIPsecCryMapPeerEntry)
