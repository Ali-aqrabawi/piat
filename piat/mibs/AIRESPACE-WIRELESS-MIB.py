...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/AIRESPACE-WIRELESS-MIB
...
Bits, IpAddress, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Unsigned32, Counter64, ObjectIdentity, NotificationType, ModuleIdentity, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Unsigned32", "Counter64", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("AIRESPACE-WIRELESS-MIB", bsnTrap=bsnTrap, bsnRadiusAuthClientRoundTripTime=bsnRadiusAuthClientRoundTripTime, bsnAPAuthorizationEntry=bsnAPAuthorizationEntry, bsnAPIfStationRSSICoverageIndex=bsnAPIfStationRSSICoverageIndex, bsnDot11QosProfileQueueDepth=bsnDot11QosProfileQueueDepth, bsnSensedTemperatureTooLow=bsnSensedTemperatureTooLow, bsnAPNoiseProfileUpdatedToPass=bsnAPNoiseProfileUpdatedToPass, bsnMobilityDynamicDiscovery=bsnMobilityDynamicDiscovery, bsnRogueClientFirstReported=bsnRogueClientFirstReported, bsnMeshNodeEthernetBridge=bsnMeshNodeEthernetBridge, bsnDot11EssVpnIkeDHGroup=bsnDot11EssVpnIkeDHGroup, bsnGlobalDot11bDataRate18Mhz=bsnGlobalDot11bDataRate18Mhz, bsnRadiusAccServerRowStatus=bsnRadiusAccServerRowStatus, bsnMobileStationTxRetries=bsnMobileStationTxRetries, bsnAPGroupVlanName=bsnAPGroupVlanName, bsnDot11QosProfileDesc=bsnDot11QosProfileDesc, bsnAPIfDot11MultiDomainCapabilityEnabled=bsnAPIfDot11MultiDomainCapabilityEnabled, bsnRogueClientDot11MacAddress=bsnRogueClientDot11MacAddress, bsnCustomSignatureTable=bsnCustomSignatureTable, bsnGlobalDot11aFastRoamingVoipPercentage=bsnGlobalDot11aFastRoamingVoipPercentage, bsnRrmDot11aSignalMeasurementInterval=bsnRrmDot11aSignalMeasurementInterval, bsnAPCoverageFailedClients=bsnAPCoverageFailedClients, bsnLinkTestEntry=bsnLinkTestEntry, bsnCustomSignatureQuietTime=bsnCustomSignatureQuietTime, bsnAPIfWlanOverrideRowStatus=bsnAPIfWlanOverrideRowStatus, bsnGlobalDot11aCurrentChannel=bsnGlobalDot11aCurrentChannel, bsnAuthFailureUserName=bsnAuthFailureUserName, bsnSyslogEnable=bsnSyslogEnable, bsnMobileStationE2eVersion=bsnMobileStationE2eVersion, bsnAPIfDot11NumberofChannels=bsnAPIfDot11NumberofChannels, bsnMobileStationSampleTime=bsnMobileStationSampleTime, bsnAPIfRxNeighborIpAddress=bsnAPIfRxNeighborIpAddress, bsnStandardSignaturePrecedence=bsnStandardSignaturePrecedence, bsnRFMobilityDomainName=bsnRFMobilityDomainName, bsnGlobalDot11bDynamicChannelUpdateInterval=bsnGlobalDot11bDynamicChannelUpdateInterval, bsnGlobalDot11bDataRate9Mhz=bsnGlobalDot11bDataRate9Mhz, bsnAuthFailureUserType=bsnAuthFailureUserType, bsnMobilityConfig=bsnMobilityConfig, bsnDot11EssMacFiltering=bsnDot11EssMacFiltering, bsnRADIUSServerNotResponding=bsnRADIUSServerNotResponding, bsnRogueClientAirespaceAPName=bsnRogueClientAirespaceAPName, bsnTemperatureAlarmLowLimit=bsnTemperatureAlarmLowLimit, bsnBridgingSharedSecretKey=bsnBridgingSharedSecretKey, bsnWrasTrapRev1=bsnWrasTrapRev1, bsnEss=bsnEss, bsnGlobalDot11bCFPMaxDuration=bsnGlobalDot11bCFPMaxDuration, bsnGlobalDot11aConfig=bsnGlobalDot11aConfig, bsnMeshNodeParentMacAddress=bsnMeshNodeParentMacAddress, bsnAPDot3MacAddress=bsnAPDot3MacAddress, bsnRadiusAccClientResponses=bsnRadiusAccClientResponses, bsnAPAuthCertificateType=bsnAPAuthCertificateType, bsnThirdPartyAPMirrorMode=bsnThirdPartyAPMirrorMode, bsnWrasIpsecCertName=bsnWrasIpsecCertName, bsnAPDisassociated=bsnAPDisassociated, bsnAPReasonCodeTrapVariable=bsnAPReasonCodeTrapVariable, bsnRadiusAccClientServerPortNumber=bsnRadiusAccClientServerPortNumber, bsnDuplicateIpTrapVariable=bsnDuplicateIpTrapVariable, bsnMacFilterRowStatus=bsnMacFilterRowStatus, bsnWrasCompliance=bsnWrasCompliance, bsnLocalManagementUserEntry=bsnLocalManagementUserEntry, bsnRrmDot11bGlobalGroupInterval=bsnRrmDot11bGlobalGroupInterval, bsnRogueAPDetectingAPMacAddress=bsnRogueAPDetectingAPMacAddress, bsnTagRssiDataApName=bsnTagRssiDataApName, bsnAPIfPhyAntennaDiversity=bsnAPIfPhyAntennaDiversity, bsnNotifiesReceived=bsnNotifiesReceived, bsnMobilityAnchorWlanSsid=bsnMobilityAnchorWlanSsid, bsnPreamblePolicyEnforced=bsnPreamblePolicyEnforced, bsnMeshNodeAPType=bsnMeshNodeAPType, bsnRadiusAuthServerKeyWrapKEKkey=bsnRadiusAuthServerKeyWrapKEKkey, bsnCustomSignaturePatternOffSetStart=bsnCustomSignaturePatternOffSetStart, bsnDot11EssVpnIkeAuthMode=bsnDot11EssVpnIkeAuthMode, bsnAPIfStationSNRCoverageIndex=bsnAPIfStationSNRCoverageIndex, bsnGlobalDot11bFastRoamingVoipPercentage=bsnGlobalDot11bFastRoamingVoipPercentage, bsnAPEntry=bsnAPEntry, bsnMobileStationStatsTable=bsnMobileStationStatsTable, bsnLocalManagementUserAccessMode=bsnLocalManagementUserAccessMode, bsnDot11EssRadiusAuthPrimaryServer=bsnDot11EssRadiusAuthPrimaryServer, bsnGlobalDot11h=bsnGlobalDot11h, bsnStandardSignaturePatternString=bsnStandardSignaturePatternString, bsnDot11EssSessionTimeout=bsnDot11EssSessionTimeout, bsnAclRuleEndSourcePort=bsnAclRuleEndSourcePort, bsnAPIfRadarDetectedChannelNumber=bsnAPIfRadarDetectedChannelNumber, bsnBlackListClientDescription=bsnBlackListClientDescription, bsnTotalHandoffRequestsIgnored=bsnTotalHandoffRequestsIgnored, bsnEssGroupRev1=bsnEssGroupRev1, bsnUtility=bsnUtility, bsnGlobalDot11bShortRetryLimit=bsnGlobalDot11bShortRetryLimit, bsnMobileStationByUserMacAddress=bsnMobileStationByUserMacAddress, bsnDot11EssVpnIkePhase1Mode=bsnDot11EssVpnIkePhase1Mode, bsnGlobalDot11aRxSopThreshold=bsnGlobalDot11aRxSopThreshold, bsnAPMonitorOnlyMode=bsnAPMonitorOnlyMode, bsnRogueAPContainmentLevel=bsnRogueAPContainmentLevel, bsnAPRadioCardRxFailure=bsnAPRadioCardRxFailure, bsnMeshNeighState=bsnMeshNeighState, bsnGlobalDot11bShortPreambleOptionImplemented=bsnGlobalDot11bShortPreambleOptionImplemented, bsnRadiusAuthClientAccessRejects=bsnRadiusAuthClientAccessRejects, bsnRogueClientTotalDetectingAPs=bsnRogueClientTotalDetectingAPs, bsnValidateRogueClientsAgainstAAA=bsnValidateRogueClientsAgainstAAA, bsnMobilityGroupDirectoryTable=bsnMobilityGroupDirectoryTable, bsnAPIfDot11MacFragmentationThreshold=bsnAPIfDot11MacFragmentationThreshold, bsnGlobalDot11bDataRate11Mhz=bsnGlobalDot11bDataRate11Mhz, bsnRrmDot11aLoadMeasurementInterval=bsnRrmDot11aLoadMeasurementInterval, bsnGlobalDot11AuthenticationResponseTimeOut=bsnGlobalDot11AuthenticationResponseTimeOut, bsnRadiusAccServerAddress=bsnRadiusAccServerAddress, bsnDot11EssNumberOfMobileStations=bsnDot11EssNumberOfMobileStations, bsnMobileStationMobilityStatus=bsnMobileStationMobilityStatus, bsnMobileStationEapType=bsnMobileStationEapType, bsnRogueAPFirstReported=bsnRogueAPFirstReported, bsnAPIfPhyTxPowerControl=bsnAPIfPhyTxPowerControl, bsnDot11EssWPAAuthKeyMgmtMode=bsnDot11EssWPAAuthKeyMgmtMode, bsnRogueClientLastHeard=bsnRogueClientLastHeard, bsnTrustedApHasInvalidSsid=bsnTrustedApHasInvalidSsid, bsnRogueAPSsid=bsnRogueAPSsid, bsnAPIfPhyAntennaType=bsnAPIfPhyAntennaType, bsnWrasIpsecCertStatus=bsnWrasIpsecCertStatus, bsnAPIfThroughputThreshold=bsnAPIfThroughputThreshold, bsnTemperatureSensorClear=bsnTemperatureSensorClear, bsnMobileStationByIpMacAddress=bsnMobileStationByIpMacAddress, bsnRadiusAuthClientAccessRequests=bsnRadiusAuthClientAccessRequests, bsnRadarChannelCleared=bsnRadarChannelCleared, bsnAPGroupsVlanDescription=bsnAPGroupsVlanDescription, bsnLocalManagementUserPassword=bsnLocalManagementUserPassword, bsnGlobalDot11a80211eMaxBandwidth=bsnGlobalDot11a80211eMaxBandwidth, bsnGlobalDot11aCFPPeriod=bsnGlobalDot11aCFPPeriod, bsnAPGroupsVlanMappingEntry=bsnAPGroupsVlanMappingEntry, bsnTagTimeInterval=bsnTagTimeInterval, bsnGlobalDot11bConfig=bsnGlobalDot11bConfig, bsnTotalAnchorDenyReceived=bsnTotalAnchorDenyReceived, bsnAPIfDot11TxPowerLevel6=bsnAPIfDot11TxPowerLevel6, bsnRrmDot11aGlobalGroupInterval=bsnRrmDot11aGlobalGroupInterval, bsnCustomSignatureName=bsnCustomSignatureName, bsnLocalNetUserPassword=bsnLocalNetUserPassword, bsnAAARadiusCompatibilityMode=bsnAAARadiusCompatibilityMode, bsnAPIfDot11CountryString=bsnAPIfDot11CountryString, bsnGlobalDot11bInputsForDTP=bsnGlobalDot11bInputsForDTP, bsnRogueAPTable=bsnRogueAPTable, bsnTotalPingPongHandoffRequestsDropped=bsnTotalPingPongHandoffRequestsDropped, bsnWpsTrapControlEnable=bsnWpsTrapControlEnable, bsnMaxRogueCount=bsnMaxRogueCount, bsnTotalAnchorTransferred=bsnTotalAnchorTransferred, bsnApIpAddress=bsnApIpAddress, bsnCustomSignatureFrameType=bsnCustomSignatureFrameType, bsnDot11EssQualityOfService=bsnDot11EssQualityOfService, bsnDot11EssVpnAuthTransform=bsnDot11EssVpnAuthTransform, bsnStationAPMacAddr=bsnStationAPMacAddr, bsnAPIfLoadProfileState=bsnAPIfLoadProfileState, bsnTagBatteryStatus=bsnTagBatteryStatus, bsnAPIfDot11MacShortRetryLimit=bsnAPIfDot11MacShortRetryLimit, bsnMobilityStatsReset=bsnMobilityStatsReset, bsnAPIfRecommendedRTSThreshold=bsnAPIfRecommendedRTSThreshold, bsnMobileStationEssIndex=bsnMobileStationEssIndex, bsnRadiusAccServerStatsEntry=bsnRadiusAccServerStatsEntry, bsnAPIfDot11MacMaxTransmitMSDULifetime=bsnAPIfDot11MacMaxTransmitMSDULifetime, bsnFastSSIDChangeFeature=bsnFastSSIDChangeFeature, bsnMobileStationWepState=bsnMobileStationWepState, bsnRogueAPEntry=bsnRogueAPEntry, bsnDot11EssSsid=bsnDot11EssSsid, bsnAuthenticationFailure=bsnAuthenticationFailure, bsnRadiusAuthServerKeyWrapMACKkey=bsnRadiusAuthServerKeyWrapMACKkey, bsnAPIfDot11MultiDomainCapabilityImplemented=bsnAPIfDot11MultiDomainCapabilityImplemented, bsnMobileStationStatusCode=bsnMobileStationStatusCode, bsnAPIfDot11CurrentCCAMode=bsnAPIfDot11CurrentCCAMode, bsnRadiusAuthServerInetAddress=bsnRadiusAuthServerInetAddress, radioCoreDumpTrap=radioCoreDumpTrap, bsnGlobalDot11Group=bsnGlobalDot11Group, bsnRxMulticastQueueFull=bsnRxMulticastQueueFull, bsnRadiusAuthServerNetworkUserConfig=bsnRadiusAuthServerNetworkUserConfig, bsnAPIsStaticIP=bsnAPIsStaticIP, bsnGlobalDot11aHighBandNetwork=bsnGlobalDot11aHighBandNetwork, bsnAclRuleStartDestinationPort=bsnAclRuleStartDestinationPort, bsnRogueAPChannel=bsnRogueAPChannel, bsnAPIfRxNeighborChannel=bsnAPIfRxNeighborChannel, bsnMacFilterInterfaceName=bsnMacFilterInterfaceName, bsnAPChannelNumberTrapVariable=bsnAPChannelNumberTrapVariable, bsnCustomSignatureEnable=bsnCustomSignatureEnable, bsnLinkTestId=bsnLinkTestId, bsnMobilityGroupDirectoryEntry=bsnMobilityGroupDirectoryEntry, bsnStandardSignatureFrameType=bsnStandardSignatureFrameType, bsnStandardSignatureName=bsnStandardSignatureName, bsnApIfNoOfUsers=bsnApIfNoOfUsers, bsnMobileStationByUsernameTable=bsnMobileStationByUsernameTable, bsnAPIfSniffChannel=bsnAPIfSniffChannel, bsnAPNeighborAuthConfig=bsnAPNeighborAuthConfig, bsnRogueClientBSSID=bsnRogueClientBSSID, bsnExternalPolicyServerAddress=bsnExternalPolicyServerAddress, bsnDot11EssVpnEncrTransform=bsnDot11EssVpnEncrTransform, bsnDot11EssBroadcastSsid=bsnDot11EssBroadcastSsid, bsnMobileStationEntry=bsnMobileStationEntry, bsnMobileStationShortPreambleOptionImplemented=bsnMobileStationShortPreambleOptionImplemented, bsnRogueAPAirespaceAPLastHeard=bsnRogueAPAirespaceAPLastHeard, bsnWireless=bsnWireless, bsnGlobalDot11RogueTimer=bsnGlobalDot11RogueTimer, bsnRadiusAuthServerInetAddressType=bsnRadiusAuthServerInetAddressType, bsnRadiusAccServerKey=bsnRadiusAccServerKey, bsnAPIfRFUtilizationThreshold=bsnAPIfRFUtilizationThreshold, bsnAPAuthRowStatus=bsnAPAuthRowStatus, bsnDot11EssRadiusAcctPrimaryServer=bsnDot11EssRadiusAcctPrimaryServer, bsnMobileStationStatsEntry=bsnMobileStationStatsEntry, bsnGlobalDot11LoadBalancing=bsnGlobalDot11LoadBalancing, bsnTotalHandoffRequestsDropped=bsnTotalHandoffRequestsDropped, bsnGlobalDot11MultiDomainCapabilityEnabled=bsnGlobalDot11MultiDomainCapabilityEnabled, bsnAPAssociated=bsnAPAssociated, bsnTagTable=bsnTagTable, bsnGlobalDot11bPBCCOptionImplemented=bsnGlobalDot11bPBCCOptionImplemented, bsnWatchListClientTable=bsnWatchListClientTable, bsnAPIfStationRSSICoverageInfoEntry=bsnAPIfStationRSSICoverageInfoEntry, bsnAPIfStationSNRCoverageInfoEntry=bsnAPIfStationSNRCoverageInfoEntry, bsnRogueAPDot11MacAddr=bsnRogueAPDot11MacAddr, bsnMeshNodeChannel=bsnMeshNodeChannel, bsnGlobalDot11bCFPPeriod=bsnGlobalDot11bCFPPeriod, bsnAPRadioCardTxFailure=bsnAPRadioCardTxFailure, bsnImpersonatedAPMacAddr=bsnImpersonatedAPMacAddr, bsnAPStaticIPAddress=bsnAPStaticIPAddress, bsnCustomSignaturePatternEntry=bsnCustomSignaturePatternEntry, bsnGlobalDot11bChannelUpdateCmdStatus=bsnGlobalDot11bChannelUpdateCmdStatus, bsnThirdPartyAPTable=bsnThirdPartyAPTable, bsnRfIdTagConfig=bsnRfIdTagConfig, bsnAclRuleProtocol=bsnAclRuleProtocol, bsnDot11WiredQosProtocol=bsnDot11WiredQosProtocol, bsnMacFilterAddress=bsnMacFilterAddress, bsnAAAMacDelimiter=bsnAAAMacDelimiter, bsnRfIdTagAutoTimeoutStatus=bsnRfIdTagAutoTimeoutStatus, bsnStandardSignatureVersion=bsnStandardSignatureVersion, bsnRrmDot11bGlobalAutomaticGrouping=bsnRrmDot11bGlobalAutomaticGrouping, bsnPingTestMinTimeInterval=bsnPingTestMinTimeInterval, bsnUtilityGroupRev1=bsnUtilityGroupRev1, bsnGlobalDot11aCFPMaxDuration=bsnGlobalDot11aCFPMaxDuration, bsnDot11StationAuthenticateFail=bsnDot11StationAuthenticateFail, bsnMobileStationRSSI=bsnMobileStationRSSI, bsnRogueAPContainmentChannels=bsnRogueAPContainmentChannels, bsnMeshNeighSnrUp=bsnMeshNeighSnrUp, bsnMobileStationSsid=bsnMobileStationSsid, bsnRrmDot11aCoverageMeasurementInterval=bsnRrmDot11aCoverageMeasurementInterval, bsnAPAuthorizationFailure=bsnAPAuthorizationFailure, bsnWrasIpsecCertificateUpdate=bsnWrasIpsecCertificateUpdate, bsnMobility=bsnMobility, bsnExcessive80211AssocFailures=bsnExcessive80211AssocFailures, bsnAPIfDot11MacRTSThreshold=bsnAPIfDot11MacRTSThreshold, bsnAPNeighborAuthStatus=bsnAPNeighborAuthStatus, bsnRrmDot11bForeignNoiseThreshold=bsnRrmDot11bForeignNoiseThreshold, bsnGlobalDot11bDataRate54Mhz=bsnGlobalDot11bDataRate54Mhz, bsnRogueAPTotalClients=bsnRogueAPTotalClients, bsnAPInvalidRadioType=bsnAPInvalidRadioType, bsnMobileStationTxExcessiveRetries=bsnMobileStationTxExcessiveRetries, bsnRrmDot11aGlobalAutomaticGrouping=bsnRrmDot11aGlobalAutomaticGrouping, bsnRFNetworkName=bsnRFNetworkName, bsnRogueClientAirespaceAPRSSI=bsnRogueClientAirespaceAPRSSI, bsnAPIfDot11EDThreshold=bsnAPIfDot11EDThreshold, bsnGlobalDot11bShortPreamble=bsnGlobalDot11bShortPreamble, bsnDot11EssWebPassthroughEmail=bsnDot11EssWebPassthroughEmail, bsnDot11EssAdminStatus=bsnDot11EssAdminStatus, bsnRogueClientChannelNumber=bsnRogueClientChannelNumber, bsnGlobalDot11bDTPCSupport=bsnGlobalDot11bDTPCSupport, bsnDot11EssEntry=bsnDot11EssEntry)
mibBuilder.exportSymbols("AIRESPACE-WIRELESS-MIB", bsnMeshNodeTxNeighReq=bsnMeshNodeTxNeighReq, bsnAPIfRSSILevel=bsnAPIfRSSILevel, bsnRadiusAuthServerStatus=bsnRadiusAuthServerStatus, bsnGlobalDot11bLongRetryLimit=bsnGlobalDot11bLongRetryLimit, bsnDot11Ess7920PhoneSupport=bsnDot11Ess7920PhoneSupport, bsnTrustedApRadioPolicyUsed=bsnTrustedApRadioPolicyUsed, bsnGlobalDot11aDynamicChannelAssignment=bsnGlobalDot11aDynamicChannelAssignment, bsnMeshNeighLinkSnr=bsnMeshNeighLinkSnr, bsnStandardSignaturePatternOffSetStart=bsnStandardSignaturePatternOffSetStart, bsnRadiusAuthServerMgmtUserConfig=bsnRadiusAuthServerMgmtUserConfig, bsnDot11EssBlacklistTimeout=bsnDot11EssBlacklistTimeout, bsnDot11802Dot1PTag=bsnDot11802Dot1PTag, bsnCustomSignatureDescription=bsnCustomSignatureDescription, bsnGlobalDot11bNumberofChannels=bsnGlobalDot11bNumberofChannels, bsnTagLastReported=bsnTagLastReported, bsnDot11EssStaticWEPEncryptionType=bsnDot11EssStaticWEPEncryptionType, bsnRrmDot11bRFUtilizationThreshold=bsnRrmDot11bRFUtilizationThreshold, bsnMeshNodePoorNeighSnr=bsnMeshNodePoorNeighSnr, bsnBlackListClientRowStatus=bsnBlackListClientRowStatus, bsnIpsecErrorCount=bsnIpsecErrorCount, bsnAPIfDot11MultipleRetryCount=bsnAPIfDot11MultipleRetryCount, bsnGroupDirectoryMemberIPAddress=bsnGroupDirectoryMemberIPAddress, bsnTrapsGroup=bsnTrapsGroup, bsnRrmDot11a=bsnRrmDot11a, bsnBlackListClientTable=bsnBlackListClientTable, bsnGlobalDot11bDataRate6Mhz=bsnGlobalDot11bDataRate6Mhz, bsnEncryptionPolicyEnforced=bsnEncryptionPolicyEnforced, bsnAPIfDot11DTIMPeriod=bsnAPIfDot11DTIMPeriod, bsnAPIPAddressFallback=bsnAPIPAddressFallback, bsnRogueAPType=bsnRogueAPType, bsnAPCoverageProfileUpdatedToPass=bsnAPCoverageProfileUpdatedToPass, bsnRrmDot11aMobilesThreshold=bsnRrmDot11aMobilesThreshold, bsnRogueClientPerRogueAPEntry=bsnRogueClientPerRogueAPEntry, bsnAPIfCellSiteConfigId=bsnAPIfCellSiteConfigId, bsnLocalNetUserRemainingTime=bsnLocalNetUserRemainingTime, bsnAdhocRogueAutoContained=bsnAdhocRogueAutoContained, bsnAPGroupsVlanTable=bsnAPGroupsVlanTable, bsnDot11EssWPAEncryptionType=bsnDot11EssWPAEncryptionType, bsnMobileStationReasonCode=bsnMobileStationReasonCode, bsnAPIfSlotId=bsnAPIfSlotId, bsnAPInterferenceProfileUpdatedToPass=bsnAPInterferenceProfileUpdatedToPass, bsnDuplicateIpTrapClear=bsnDuplicateIpTrapClear, bsnMobilityStats=bsnMobilityStats, bsnAPIfInterferenceProfileState=bsnAPIfInterferenceProfileState, bsnAPIfDot11RTSFailureCount=bsnAPIfDot11RTSFailureCount, bsnRadiusAccServerEntry=bsnRadiusAccServerEntry, bsnMeshNeighTxParent=bsnMeshNeighTxParent, bsnGlobalDot11bDTIMPeriod=bsnGlobalDot11bDTIMPeriod, bsnIpsecEspAuthFailureTrap=bsnIpsecEspAuthFailureTrap, bsnMobileStationRssiDataApMacAddress=bsnMobileStationRssiDataApMacAddress, bsnWrasObsTrap=bsnWrasObsTrap, bsnRadiusAuthClientUnknownTypes=bsnRadiusAuthClientUnknownTypes, bsnRogueAPState=bsnRogueAPState, bsnRadiusAccServerInetAddressType=bsnRadiusAccServerInetAddressType, bsnAPName=bsnAPName, bsnAPIfDot11BSSID=bsnAPIfDot11BSSID, bsnExternalPolicyServerRowStatus=bsnExternalPolicyServerRowStatus, bsnAPIfRxNeighborChannelWidth=bsnAPIfRxNeighborChannelWidth, bsnTagBytesReceived=bsnTagBytesReceived, bsnRogueAPTrapEnable=bsnRogueAPTrapEnable, bsnAPIfDot11PhyChannelTable=bsnAPIfDot11PhyChannelTable, bsnRrmDot11aRFUtilizationThreshold=bsnRrmDot11aRFUtilizationThreshold, bsnRadiusAccServerIndex=bsnRadiusAccServerIndex, bsnBlackListClientMacAddress=bsnBlackListClientMacAddress, bsnCurrentImportedClients=bsnCurrentImportedClients, bsnDot11EssCreated=bsnDot11EssCreated, bsnSuiteRespondFailures=bsnSuiteRespondFailures, bsnMeshNeighsTable=bsnMeshNeighsTable, PYSNMP_MODULE_ID=bsnWireless, bsnAPIfDot11CFPPeriod=bsnAPIfDot11CFPPeriod, bsnThirdPartyAPInterface=bsnThirdPartyAPInterface, bsnIpsecInvalidCookieTrap=bsnIpsecInvalidCookieTrap, bsnTotalHandoffRequestsDenied=bsnTotalHandoffRequestsDenied, bsnAPIfDot11FrameDuplicateCount=bsnAPIfDot11FrameDuplicateCount, bsnGlobalDot11bRTSThreshold=bsnGlobalDot11bRTSThreshold, bsnGlobalDot11aFastRoamingMode=bsnGlobalDot11aFastRoamingMode, bsnMobileStationByIpEntry=bsnMobileStationByIpEntry, bsnRogueAPSSID=bsnRogueAPSSID, bsnAPIfDot11WEPUndecryptableCount=bsnAPIfDot11WEPUndecryptableCount, bsnIpsecGroup=bsnIpsecGroup, bsnGlobalDot11bFastRoamingMode=bsnGlobalDot11bFastRoamingMode, bsnMobileStationByUsernameEntry=bsnMobileStationByUsernameEntry, bsnAPIfType=bsnAPIfType, bsnDot11StationBlacklisted=bsnDot11StationBlacklisted, bsnCustomSignatureFrequency=bsnCustomSignatureFrequency, bsnDot11EssRadiusAuthTertiaryServer=bsnDot11EssRadiusAuthTertiaryServer, bsnAPBootVersion=bsnAPBootVersion, bsnClearTrapVariable=bsnClearTrapVariable, bsnRogueClientLastReported=bsnRogueClientLastReported, bsnDot11QosBurstRealTimeDataRate=bsnDot11QosBurstRealTimeDataRate, bsnGlobalDot11bFirstChannelNumber=bsnGlobalDot11bFirstChannelNumber, bsnGlobalDot11bCurrentChannel=bsnGlobalDot11bCurrentChannel, bsnGlobalDot11aDataRate54Mhz=bsnGlobalDot11aDataRate54Mhz, bsnAPIfWlanOverrideEntry=bsnAPIfWlanOverrideEntry, bsnRadiusAuthClientTimeouts=bsnRadiusAuthClientTimeouts, bsnCustomSignatureVersion=bsnCustomSignatureVersion, bsnPOEControllerFailure=bsnPOEControllerFailure, bsnAPRemoteModeSupport=bsnAPRemoteModeSupport, bsnTagRssiDataTable=bsnTagRssiDataTable, bsnRogueAPAirespaceAPEntry=bsnRogueAPAirespaceAPEntry, bsnAPIfPoorSNRClients=bsnAPIfPoorSNRClients, bsnPingTestRowStatus=bsnPingTestRowStatus, bsnApGroup=bsnApGroup, bsnNavDosAttackSourceMacAddr=bsnNavDosAttackSourceMacAddr, bsnAPIfRxNeighborsTable=bsnAPIfRxNeighborsTable, bsnAPIfLoadRxUtilization=bsnAPIfLoadRxUtilization, bsnRrmDot11b=bsnRrmDot11b, bsnRadarChannelDetected=bsnRadarChannelDetected, bsnWepKeyDecryptError=bsnWepKeyDecryptError, bsnMobilityProtocolPortNum=bsnMobilityProtocolPortNum, bsnMeshNodeInsufficientMemory=bsnMeshNodeInsufficientMemory, bsnAPIfDot11NumberSupportedPowerLevels=bsnAPIfDot11NumberSupportedPowerLevels, bsnRogueAPChannelWidth=bsnRogueAPChannelWidth, bsnGlobalDot11bDataRate5AndHalfMhz=bsnGlobalDot11bDataRate5AndHalfMhz, bsnStandardSignatureMacFreq=bsnStandardSignatureMacFreq, bsnAP=bsnAP, bsnAclRuleSourceIpAddress=bsnAclRuleSourceIpAddress, bsnDot11EssRSNSecurity=bsnDot11EssRSNSecurity, bsnMeshNeighUnadjustedEase=bsnMeshNeighUnadjustedEase, bsnWrasDepGroup=bsnWrasDepGroup, bsnRrmDot11bGroupLeaderMacAddr=bsnRrmDot11bGroupLeaderMacAddr, bsnAPReset=bsnAPReset, bsnAclRuleEntry=bsnAclRuleEntry, bsnTotalReceiveErrors=bsnTotalReceiveErrors, bsnMobileStationCFPollRequest=bsnMobileStationCFPollRequest, bsnWrasCompliances=bsnWrasCompliances, bsnMobileStationRssiDataEntry=bsnMobileStationRssiDataEntry, bsnMobileStationInterface=bsnMobileStationInterface, bsnNetworkStateChanged=bsnNetworkStateChanged, bsnTotalHandoffRequestsSent=bsnTotalHandoffRequestsSent, bsnLocalManagementUserName=bsnLocalManagementUserName, bsnTrustedApEncryptionUsed=bsnTrustedApEncryptionUsed, bsnAPIfMobilesThreshold=bsnAPIfMobilesThreshold, bsnGlobalDot11bMaxReceiveLifetime=bsnGlobalDot11bMaxReceiveLifetime, bsnUsersEntry=bsnUsersEntry, bsnDot11EssStaticWEPKeyIndex=bsnDot11EssStaticWEPKeyIndex, bsnAPIfForeignNoiseThreshold=bsnAPIfForeignNoiseThreshold, bsnGlobalDot11aBeaconPeriod=bsnGlobalDot11aBeaconPeriod, bsnRadiusAuthKeyWrapEnable=bsnRadiusAuthKeyWrapEnable, bsnTagEntry=bsnTagEntry, bsnAPSoftwareVersion=bsnAPSoftwareVersion, bsnGlobalDot11bPowerUpdateCmdInvoke=bsnGlobalDot11bPowerUpdateCmdInvoke, bsnAPCoverageThresholdTrapVariable=bsnAPCoverageThresholdTrapVariable, bsnDot11StationAssociate=bsnDot11StationAssociate, bsnMobileStationRssiDataTable=bsnMobileStationRssiDataTable, bsnTagRssiDataApMacAddress=bsnTagRssiDataApMacAddress, bsnRogueClientEntry=bsnRogueClientEntry, bsnRfIdTagDataTimeout=bsnRfIdTagDataTimeout, bsnGlobalDot11bBeaconPeriod=bsnGlobalDot11bBeaconPeriod, bsnGlobalDot11aLowBandNetwork=bsnGlobalDot11aLowBandNetwork, bsnRrmDot11bMobilesThreshold=bsnRrmDot11bMobilesThreshold, bsnAPGroupsVlanMappingTable=bsnAPGroupsVlanMappingTable, bsnAPIfNoiseProfileState=bsnAPIfNoiseProfileState, bsnAPIfDot11CountersTable=bsnAPIfDot11CountersTable, bsnAPIfNoiseChannelNo=bsnAPIfNoiseChannelNo, bsnDot11StationDeauthenticate=bsnDot11StationDeauthenticate, bsnMobileStationSnr=bsnMobileStationSnr, bsnMeshNodeRole=bsnMeshNodeRole, bsnAPIfMacOperationParamEntry=bsnAPIfMacOperationParamEntry, bsnRadiusAccClientTimeouts=bsnRadiusAccClientTimeouts, bsnSystemCurrentTime=bsnSystemCurrentTime, bsnStationReasonCode=bsnStationReasonCode, bsnMeshNeighRxParent=bsnMeshNeighRxParent, bsnCustomSignaturePatternIndex=bsnCustomSignaturePatternIndex, bsnCustomSignaturePatternMask=bsnCustomSignaturePatternMask, bsnMobileStationCcxVersion=bsnMobileStationCcxVersion, bsnMeshNeighMacAddress=bsnMeshNeighMacAddress, bsnMeshNodeRxNeighRsp=bsnMeshNodeRxNeighRsp, bsnRadiusAccServerIPSecEncryption=bsnRadiusAccServerIPSecEncryption, bsnAPInterferenceProfileFailed=bsnAPInterferenceProfileFailed, bsnExternalPolicyServerEntry=bsnExternalPolicyServerEntry, bsnMeshNeighType=bsnMeshNeighType, bsnRogueAPAirespaceAPPreamble=bsnRogueAPAirespaceAPPreamble, bsnAPIfInterferenceUtilization=bsnAPIfInterferenceUtilization, bsnTrustedApRadioPolicyRequired=bsnTrustedApRadioPolicyRequired, bsnExternalPolicyServerTable=bsnExternalPolicyServerTable, bsnDot11EssRSNAuthPresharedKeyHex=bsnDot11EssRSNAuthPresharedKeyHex, bsnGlobalDot11bCFPollable=bsnGlobalDot11bCFPollable, bsnAPIfPhyChannelAssignment=bsnAPIfPhyChannelAssignment, bsnGlobalDot11aFirstChannelNumber=bsnGlobalDot11aFirstChannelNumber, bsnTagPacketsReceived=bsnTagPacketsReceived, bsnMobileStationPacketsSent=bsnMobileStationPacketsSent, bsnGlobalDot11aDataRate24Mhz=bsnGlobalDot11aDataRate24Mhz, bsnAPIfLoadParametersEntry=bsnAPIfLoadParametersEntry, bsnAclName=bsnAclName, bsnMobilityAnchorSwitchIPAddress=bsnMobilityAnchorSwitchIPAddress, bsnMemberCurrentExportedClients=bsnMemberCurrentExportedClients, bsnRogueAPChannelNumber=bsnRogueAPChannelNumber, bsnMobileStationIpAddress=bsnMobileStationIpAddress, bsnThirdPartyAPRowStatus=bsnThirdPartyAPRowStatus, bsnAPIfForeignInterferenceThreshold=bsnAPIfForeignInterferenceThreshold, bsnMeshNodeBackhaulRAP=bsnMeshNodeBackhaulRAP, bsnTotalAnchorRequestsReceived=bsnTotalAnchorRequestsReceived, bsnAPIfTable=bsnAPIfTable, bsnTagDot11MacAddress=bsnTagDot11MacAddress, bsnMeshNodeEntry=bsnMeshNodeEntry, bsnAclRuleDscp=bsnAclRuleDscp, bsnAPContainedAsARogue=bsnAPContainedAsARogue, bsnGlobalDot11aChannelUpdateCmdInvoke=bsnGlobalDot11aChannelUpdateCmdInvoke, bsnAPIfDot11MacMaxReceiveLifetime=bsnAPIfDot11MacMaxReceiveLifetime, bsnAPIfSNRLevel=bsnAPIfSNRLevel, bsnCustomSignaturePatternString=bsnCustomSignaturePatternString, bsnDot11EssRSNAllowTKIPClients=bsnDot11EssRSNAllowTKIPClients, bsnMeshNodeHops=bsnMeshNodeHops, bsnAPLoadProfileUpdatedToPass=bsnAPLoadProfileUpdatedToPass, bsnGlobalDot11bNetworkStatus=bsnGlobalDot11bNetworkStatus, bsnThirdPartyAPMacAddress=bsnThirdPartyAPMacAddress, bsnRadiusAccServerIPSecIKEPhase1=bsnRadiusAccServerIPSecIKEPhase1, bsnDot11StationTrapControlMask=bsnDot11StationTrapControlMask, bsnDot11EssAAAOverride=bsnDot11EssAAAOverride, bsnDot11EssWPAAuthPresharedKeyHex=bsnDot11EssWPAAuthPresharedKeyHex, bsnMobileStationTable=bsnMobileStationTable, bsnIpsecEspReplayFailureTrap=bsnIpsecEspReplayFailureTrap, bsnMeshNodeBackhaul=bsnMeshNodeBackhaul, bsnRogueClientTable=bsnRogueClientTable, bsnAPLocation=bsnAPLocation, bsnWrasIpsecCertPassword=bsnWrasIpsecCertPassword, bsnIpsecSuiteNegFailure=bsnIpsecSuiteNegFailure, bsnDot11EssTable=bsnDot11EssTable, bsnAPIfDot11TxPowerLevel5=bsnAPIfDot11TxPowerLevel5, bsnAPLoadProfileFailed=bsnAPLoadProfileFailed, bsnRogueClientRadioType=bsnRogueClientRadioType, bsnAPIfProfileParamAssignment=bsnAPIfProfileParamAssignment, bsnRrmDot11aCoverageThreshold=bsnRrmDot11aCoverageThreshold, bsnLinkTestLocalRSSI=bsnLinkTestLocalRSSI, bsnLinkTestSendPktCount=bsnLinkTestSendPktCount, bsnAPNeighborAuthAlarmThreshold=bsnAPNeighborAuthAlarmThreshold, bsnStandardSignaturePatternRowStatus=bsnStandardSignaturePatternRowStatus, bsnMobileStationRssiDataApIfType=bsnMobileStationRssiDataApIfType, bsnTagRssiDataApIfSlotId=bsnTagRssiDataApIfSlotId, bsnAPIfRxNeighborsEntry=bsnAPIfRxNeighborsEntry, bsnStandardSignatureRowStatus=bsnStandardSignatureRowStatus, bsnGlobalDot11CountryIndex=bsnGlobalDot11CountryIndex, bsnMobileStationEncryptionCypher=bsnMobileStationEncryptionCypher, bsnDot11EssInterfaceName=bsnDot11EssInterfaceName, bsnRadiusAuthServerAddress=bsnRadiusAuthServerAddress, bsnAPIfRecommendedFragmentationThreshold=bsnAPIfRecommendedFragmentationThreshold, bsnMobileStationPerRadioPerVapEntry=bsnMobileStationPerRadioPerVapEntry, bsnWrasIpsecCertificate=bsnWrasIpsecCertificate, bsnAPMirrorMode=bsnAPMirrorMode, bsnMobileStationSessionTimeout=bsnMobileStationSessionTimeout, bsnTotalStateTransitionsDisallowed=bsnTotalStateTransitionsDisallowed, bsnPrimaryMwarForAPs=bsnPrimaryMwarForAPs, bsnRrmDot11aThroughputThreshold=bsnRrmDot11aThroughputThreshold, bsnAPIfDot11RetryCount=bsnAPIfDot11RetryCount, bsnGlobalDot11aChannelUpdateCmdStatus=bsnGlobalDot11aChannelUpdateCmdStatus, bsnRrmDot11bNoiseMeasurementInterval=bsnRrmDot11bNoiseMeasurementInterval, bsnAPIfChannelNoiseInfoTable=bsnAPIfChannelNoiseInfoTable, bsnGlobalDot11aDataRate12Mhz=bsnGlobalDot11aDataRate12Mhz, bsnDot11EssDeleted=bsnDot11EssDeleted, bsnMobileStationVlanId=bsnMobileStationVlanId, bsnAPIfDot11MacLongRetryLimit=bsnAPIfDot11MacLongRetryLimit, bsnStandardSignatureFrequency=bsnStandardSignatureFrequency, bsnUserPassword=bsnUserPassword)
mibBuilder.exportSymbols("AIRESPACE-WIRELESS-MIB", bsnTrustedApIsMissing=bsnTrustedApIsMissing, bsnAPIfUpDownCause=bsnAPIfUpDownCause, bsnGlobalDot11aTIThreshold=bsnGlobalDot11aTIThreshold, bsnRadiusAccServerStatus=bsnRadiusAccServerStatus, bsnStandardSignaturePatternEntry=bsnStandardSignaturePatternEntry, bsnTotalHandoffRepliesReceived=bsnTotalHandoffRepliesReceived, bsnGlobalDot11hChannelSwitchEnable=bsnGlobalDot11hChannelSwitchEnable, bsnRadiusAccServerKeyFormat=bsnRadiusAccServerKeyFormat, bsnIpsecEspInvalidSpiTrap=bsnIpsecEspInvalidSpiTrap, bsnAPIfDot11CFPMaxDuration=bsnAPIfDot11CFPMaxDuration, bsnAPIfDot11SmtParamsConfigType=bsnAPIfDot11SmtParamsConfigType, bsnAPPrimaryMwarName=bsnAPPrimaryMwarName, bsnCustomSignatureInterval=bsnCustomSignatureInterval, bsnAclTable=bsnAclTable, bsnAPGroupsVlanFeature=bsnAPGroupsVlanFeature, bsnDot11QosAverageDataRate=bsnDot11QosAverageDataRate, bsnMobileStationPolicyErrors=bsnMobileStationPolicyErrors, bsnMeshNodeTable=bsnMeshNodeTable, bsnRadiusAuthServerStatsEntry=bsnRadiusAuthServerStatsEntry, bsnAPIfChannelInterferenceInfoTable=bsnAPIfChannelInterferenceInfoTable, bsnMeshNeighParentChange=bsnMeshNeighParentChange, bsnSyslog=bsnSyslog, bsnMobileStationStatus=bsnMobileStationStatus, bsnAutoContainRoguesAdvertisingSsid=bsnAutoContainRoguesAdvertisingSsid, bsnExcessive80211AuthFailures=bsnExcessive80211AuthFailures, bsnAPTable=bsnAPTable, bsnLinkTestLocalSNR=bsnLinkTestLocalSNR, bsnExternalPolicyServerKey=bsnExternalPolicyServerKey, bsnTotalCommunicationErrors=bsnTotalCommunicationErrors, bsnRogueAPContainmentMode=bsnRogueAPContainmentMode, bsnMobileStationRssiDataApIfSlotId=bsnMobileStationRssiDataApIfSlotId, bsnPingTestIPAddress=bsnPingTestIPAddress, bsnResponderCookie=bsnResponderCookie, bsnGlobalDot11hPowerConstraint=bsnGlobalDot11hPowerConstraint, bsnRogueAPDot11MacAddress=bsnRogueAPDot11MacAddress, bsnGlobalDot11aDTIMPeriod=bsnGlobalDot11aDTIMPeriod, bsnWrasDot11aPeerIpAddress=bsnWrasDot11aPeerIpAddress, bsnUpdateSystemTime=bsnUpdateSystemTime, bsnAPRegulatoryDomainMismatch=bsnAPRegulatoryDomainMismatch, bsnGlobalDot11bRxSopThreshold=bsnGlobalDot11bRxSopThreshold, bsnAPDown=bsnAPDown, bsnTrustedApHasInvalidRadioPolicy=bsnTrustedApHasInvalidRadioPolicy, bsnDot11Ess8021xSecurity=bsnDot11Ess8021xSecurity, bsnWatchListClientEntry=bsnWatchListClientEntry, bsnExternalPolicyServerConnectionStatus=bsnExternalPolicyServerConnectionStatus, bsnRogueClientDot11MacAddr=bsnRogueClientDot11MacAddr, bsnDot11EssRowStatus=bsnDot11EssRowStatus, bsnMobileStationSecurityPolicyStatus=bsnMobileStationSecurityPolicyStatus, bsnRogueAPAirespaceAPSNR=bsnRogueAPAirespaceAPSNR, bsnWatchListClientType=bsnWatchListClientType, bsnMobilityGroupMemberRowStatus=bsnMobilityGroupMemberRowStatus, bsnAPRadioCardRxFailureClear=bsnAPRadioCardRxFailureClear, bsnAPTrapControlMask=bsnAPTrapControlMask, bsnAPIfDot11FCSErrorCount=bsnAPIfDot11FCSErrorCount, bsnThirdPartyAP802Dot1XRequired=bsnThirdPartyAP802Dot1XRequired, bsnMobileStationPacketsReceived=bsnMobileStationPacketsReceived, bsnGlobalDot11aChannelAgilityEnabled=bsnGlobalDot11aChannelAgilityEnabled, bsnMobileStationUserName=bsnMobileStationUserName, bsnSignatureAttackDetected=bsnSignatureAttackDetected, bsnTotalImportedClients=bsnTotalImportedClients, bsnPingTestAvgTimeInterval=bsnPingTestAvgTimeInterval, bsnWlanIdTrapVariable=bsnWlanIdTrapVariable, bsnRadiusAuthClientMalformedAccessResponses=bsnRadiusAuthClientMalformedAccessResponses, locationNotifyTrap=locationNotifyTrap, bsnAPIfPhyTxPowerLevel=bsnAPIfPhyTxPowerLevel, bsnRadiusAuthServerIPSecIKEPhase1=bsnRadiusAuthServerIPSecIKEPhase1, bsnDot11EssVpnIkeLifetime=bsnDot11EssVpnIkeLifetime, bsnTooManyUnsuccessLoginAttempts=bsnTooManyUnsuccessLoginAttempts, bsnTagStatsTable=bsnTagStatsTable, bsnTrustedApPolicyConfig=bsnTrustedApPolicyConfig, bsnWrasDot11bPeerIpAddress=bsnWrasDot11bPeerIpAddress, bsnRrmDot11bAPDefault=bsnRrmDot11bAPDefault, bsnGlobalDot11bPicoCellMode=bsnGlobalDot11bPicoCellMode, bsnAPNameTrapVariable=bsnAPNameTrapVariable, bsnRogueAPDetected=bsnRogueAPDetected, bsnCurrentRadiosCount=bsnCurrentRadiosCount, bsnAPPortNumberTrapVariable=bsnAPPortNumberTrapVariable, bsnCustomSignatureMacInfo=bsnCustomSignatureMacInfo, bsnGlobalDot11aMaxReceiveLifetime=bsnGlobalDot11aMaxReceiveLifetime, bsnSignatureAttackerMacAddress=bsnSignatureAttackerMacAddress, bsnGlobalDot11aLongRetryLimit=bsnGlobalDot11aLongRetryLimit, bsnStandardSignatureAction=bsnStandardSignatureAction, ProfileState=ProfileState, bsnDot11QosProfileTable=bsnDot11QosProfileTable, bsnAuthenticationFailureTrapEnable=bsnAuthenticationFailureTrapEnable, bsnIpsecSPI=bsnIpsecSPI, bsnRadiusAuthServerStatsTable=bsnRadiusAuthServerStatsTable, bsnMobileStationAPIfSlotId=bsnMobileStationAPIfSlotId, bsnAPNoiseProfileFailed=bsnAPNoiseProfileFailed, bsnInitiatorCookie=bsnInitiatorCookie, bsnWatchListClientRowStatus=bsnWatchListClientRowStatus, bsnMeshNodeTxNeighRsp=bsnMeshNodeTxNeighRsp, bsnMobileStationChannelAgilityEnabled=bsnMobileStationChannelAgilityEnabled, bsnConfigSaved=bsnConfigSaved, bsnMemberTotalHandoffErrors=bsnMemberTotalHandoffErrors, bsnAPIfPhyChannelNumber=bsnAPIfPhyChannelNumber, bsnDot11EssDhcpServerIpAddress=bsnDot11EssDhcpServerIpAddress, bsnTotalHandoffErrors=bsnTotalHandoffErrors, bsnMemberTotalImportedClients=bsnMemberTotalImportedClients, bsnRogueAPOnNetwork=bsnRogueAPOnNetwork, bsnEssGroup=bsnEssGroup, bsnExternalPolicyServerAdminStatus=bsnExternalPolicyServerAdminStatus, bsnInterferenceAfterChannelUpdate=bsnInterferenceAfterChannelUpdate, bsnDot11EssRadioPolicy=bsnDot11EssRadioPolicy, bsnWrasDot11bGroupEntry=bsnWrasDot11bGroupEntry, bsnMeshNodeParentChanges=bsnMeshNodeParentChanges, bsnAPIfStationSNRCoverageInfoTable=bsnAPIfStationSNRCoverageInfoTable, bsnGlobalDot11aMediumOccupancyLimit=bsnGlobalDot11aMediumOccupancyLimit, bsnDot11EssStaticWEPSecurity=bsnDot11EssStaticWEPSecurity, bsnCustomSignatureRowStatus=bsnCustomSignatureRowStatus, bsnAPIfDot11TIThreshold=bsnAPIfDot11TIThreshold, bsnAPIfWlanOverrideTable=bsnAPIfWlanOverrideTable, bsnGlobalDot11aDynamicTxPowerControlInterval=bsnGlobalDot11aDynamicTxPowerControlInterval, heartbeatLossTrap=heartbeatLossTrap, bsnDot11EssVpnSharedKeySize=bsnDot11EssVpnSharedKeySize, bsnAPIfMultiDomainCapabilityTable=bsnAPIfMultiDomainCapabilityTable, bsnStandardSignaturePatternMask=bsnStandardSignaturePatternMask, bsnGlobalDot11bFastRoamingVoipMinRate=bsnGlobalDot11bFastRoamingVoipMinRate, bsnGlobalDot11aShortRetryLimit=bsnGlobalDot11aShortRetryLimit, bsnAAALocalDatabaseSize=bsnAAALocalDatabaseSize, bsnClientWatchListFeature=bsnClientWatchListFeature, bsnDot11EssIpsecPassthruSecurity=bsnDot11EssIpsecPassthruSecurity, bsnGlobalDot11bFragmentationThreshold=bsnGlobalDot11bFragmentationThreshold, bsnGlobalDot11bDataRate12Mhz=bsnGlobalDot11bDataRate12Mhz, bsnRrmDot11aGroup=bsnRrmDot11aGroup, bsnAclRuleRowStatus=bsnAclRuleRowStatus, bsnIkeTotalInitFailures=bsnIkeTotalInitFailures, bsnDot11EssStaticWEPKeyFormat=bsnDot11EssStaticWEPKeyFormat, bsnMobileStationAuthenticationAlgorithm=bsnMobileStationAuthenticationAlgorithm, bsnMobilityAnchorsTable=bsnMobilityAnchorsTable, bsnAPFunctionalityDisabled=bsnAPFunctionalityDisabled, bsnRadiusAccServerTable=bsnRadiusAccServerTable, bsnAclRuleEndDestinationPort=bsnAclRuleEndDestinationPort, bsnDot11EssRadiusAuthSecondaryServer=bsnDot11EssRadiusAuthSecondaryServer, bsnLocalNetUserLifetime=bsnLocalNetUserLifetime, invalidRadioTrap=invalidRadioTrap, bsnAPAuthorizationFailureCause=bsnAPAuthorizationFailureCause, bsnRadiusAuthServerIPSecAuth=bsnRadiusAuthServerIPSecAuth, bsnGlobalDot11=bsnGlobalDot11, bsnWrasObsGroup=bsnWrasObsGroup, bsnMobileStationMacAddress=bsnMobileStationMacAddress, bsnAPGroupsVlanMappingSsid=bsnAPGroupsVlanMappingSsid, bsnMobileStationByIpTable=bsnMobileStationByIpTable, bsnDuplicateIpReportedByAP=bsnDuplicateIpReportedByAP, bsnWpaMicErrorCounterActivated=bsnWpaMicErrorCounterActivated, bsnPingTestId=bsnPingTestId, bsnWatchListClientKey=bsnWatchListClientKey, bsnDot11EssRSNWPACompatibilityMode=bsnDot11EssRSNWPACompatibilityMode, bsnAclRuleDirection=bsnAclRuleDirection, bsnAclRuleDestinationIpNetmask=bsnAclRuleDestinationIpNetmask, bsnSignatureType=bsnSignatureType, bsnNotifiesSent=bsnNotifiesSent, bsnLinkTestClientRSSI=bsnLinkTestClientRSSI, bsnGlobalDot11aInputsForDCA=bsnGlobalDot11aInputsForDCA, bsnAclRuleStartSourcePort=bsnAclRuleStartSourcePort, bsnTotalHandoffDeniesReceived=bsnTotalHandoffDeniesReceived, bsnAPIfRadarChannelStatisticsTable=bsnAPIfRadarChannelStatisticsTable, bsnRrmDot11bChannelMonitorList=bsnRrmDot11bChannelMonitorList, bsnAPAuthorizationTable=bsnAPAuthorizationTable, bsnTrapControl=bsnTrapControl, bsnLinkTestTable=bsnLinkTestTable, bsnRadiusAccClientPendingRequests=bsnRadiusAccClientPendingRequests, bsnUserName=bsnUserName, bsnAPIfDot11MulticastTransmittedFrameCount=bsnAPIfDot11MulticastTransmittedFrameCount, bsnAPIfProfileThresholdConfigEntry=bsnAPIfProfileThresholdConfigEntry, bsnAPGroupsVlanRowStatus=bsnAPGroupsVlanRowStatus, bsnDot11QosProfileEntry=bsnDot11QosProfileEntry, bsnLocalNetUserRowStatus=bsnLocalNetUserRowStatus, bsnMobileStationCFPollable=bsnMobileStationCFPollable, bsnAPNumOfSlots=bsnAPNumOfSlots, bsnMobileStationMacAddr=bsnMobileStationMacAddr, bsnDot11QosMaxRFUsagePerAP=bsnDot11QosMaxRFUsagePerAP, bsnGlobalDot11bDataRate24Mhz=bsnGlobalDot11bDataRate24Mhz, bsnTotalHandoffRequestsReceived=bsnTotalHandoffRequestsReceived, bsnRemoteUdpPort=bsnRemoteUdpPort, bsnLicenseKeyFeatureSetTrapVariable=bsnLicenseKeyFeatureSetTrapVariable, bsnRadiusAccServerIPSecIKELifetime=bsnRadiusAccServerIPSecIKELifetime, bsnRadiusAuthServerIPSecIKELifetime=bsnRadiusAuthServerIPSecIKELifetime, bsnWrasIpsecCACertificate=bsnWrasIpsecCACertificate, bsnGlobalDot11aDynamicChannelUpdateInterval=bsnGlobalDot11aDynamicChannelUpdateInterval, bsnAPIfRxNeighborRSSI=bsnAPIfRxNeighborRSSI, bsnDot11EssExternalPolicyValidation=bsnDot11EssExternalPolicyValidation, bsnGlobalDot11bDot11gSupport=bsnGlobalDot11bDot11gSupport, bsnWrasIpsecCertTable=bsnWrasIpsecCertTable, bsnAPIfLoadParametersTable=bsnAPIfLoadParametersTable, bsnGlobalDot11bPhy=bsnGlobalDot11bPhy, bsnRrmDot11bLoadMeasurementInterval=bsnRrmDot11bLoadMeasurementInterval, bsnMemberTotalExportedClients=bsnMemberTotalExportedClients, bsnGlobalDot11aDTPCSupport=bsnGlobalDot11aDTPCSupport, bsnAclRuleSourceIpNetmask=bsnAclRuleSourceIpNetmask, bsnPingTestSendCount=bsnPingTestSendCount, bsnTotalResourceErrors=bsnTotalResourceErrors, bsnAPIfDot11RTSSuccessCount=bsnAPIfDot11RTSSuccessCount, bsnMobileStationPerRadioPerVapTable=bsnMobileStationPerRadioPerVapTable, bsnAPCurrentChannelChanged=bsnAPCurrentChannelChanged, bsnRogueClientAirespaceAPSlotId=bsnRogueClientAirespaceAPSlotId, bsnTagRssiDataSnr=bsnTagRssiDataSnr, bsnSignatureConfig=bsnSignatureConfig, bsnRadiusAccServerIPSec=bsnRadiusAccServerIPSec, bsnAclNewRuleIndex=bsnAclNewRuleIndex, bsnGlobalDot11bInputsForDCA=bsnGlobalDot11bInputsForDCA, bsnRadiusAuthClientAccessAccepts=bsnRadiusAuthClientAccessAccepts, bsnSignatureName=bsnSignatureName, bsnAPIfRegulatoryDomainSupport=bsnAPIfRegulatoryDomainSupport, bsnMobileStationApMode=bsnMobileStationApMode, bsnAPIfInterferencePower=bsnAPIfInterferencePower, bsnStandardSignatureDescription=bsnStandardSignatureDescription, bsnAllowAuthorizeApAgainstAAA=bsnAllowAuthorizeApAgainstAAA, bsnGlobalDot11bMaxTransmitMSDULifetime=bsnGlobalDot11bMaxTransmitMSDULifetime, bsnAPIfRecommendedRFParametersTable=bsnAPIfRecommendedRFParametersTable, bsnMobileStationTxFiltered=bsnMobileStationTxFiltered, bsnDot11EssWepAllowSharedKeyAuth=bsnDot11EssWepAllowSharedKeyAuth, bsnExcessiveWebAuthFailures=bsnExcessiveWebAuthFailures, bsnStandardSignaturePatternTable=bsnStandardSignaturePatternTable, bsnDot11EssWebSecurity=bsnDot11EssWebSecurity, bsnGlobalDot11bMediumOccupancyLimit=bsnGlobalDot11bMediumOccupancyLimit, bsnRadiusAccServerNetworkUserConfig=bsnRadiusAccServerNetworkUserConfig, bsnSensedTemperatureTooHigh=bsnSensedTemperatureTooHigh, bsnGlobalDot11hChannelSwitchMode=bsnGlobalDot11hChannelSwitchMode, bsnMobilityGroupMemberIPAddress=bsnMobilityGroupMemberIPAddress, bsnRogueClientAirespaceAPEntry=bsnRogueClientAirespaceAPEntry, bsnAPIfDot11CountersEntry=bsnAPIfDot11CountersEntry, bsnMacFilterEntry=bsnMacFilterEntry, bsnRadiusAuthClientServerPortNumber=bsnRadiusAuthClientServerPortNumber, bsnRrmDot11bMobileMinExceptionLevel=bsnRrmDot11bMobileMinExceptionLevel, bsnRemoteIPv4Address=bsnRemoteIPv4Address, bsnLinkTest=bsnLinkTest, bsnGlobalDot11aDataRate18Mhz=bsnGlobalDot11aDataRate18Mhz, bsnRrmDot11bSetFactoryDefault=bsnRrmDot11bSetFactoryDefault, bsnAAACurrentLocalDatabaseSize=bsnAAACurrentLocalDatabaseSize, bsnAPPortNumber=bsnAPPortNumber, bsnRadiusAuthServerEntry=bsnRadiusAuthServerEntry, bsnIkeTotalInitNoResponses=bsnIkeTotalInitNoResponses, bsnGlobalDot11aDataRate9Mhz=bsnGlobalDot11aDataRate9Mhz, bsnMemberCurrentAnchoredClients=bsnMemberCurrentAnchoredClients, bsnAPIOSVersion=bsnAPIOSVersion, bsnApMaxRogueCountClear=bsnApMaxRogueCountClear, bsnApBigNavDosAttack=bsnApBigNavDosAttack, bsnAPIfSmtParamTable=bsnAPIfSmtParamTable, bsnRogueAPAirespaceAPTable=bsnRogueAPAirespaceAPTable, bsnRrmDot11bCoverageThreshold=bsnRrmDot11bCoverageThreshold, bsnAPPreviousChannelNumberTrapVariable=bsnAPPreviousChannelNumberTrapVariable, bsnLicenseRadioCount=bsnLicenseRadioCount, bsnMeshNeighAdjustedEase=bsnMeshNeighAdjustedEase, bsnMobilityGroupMemberGroupName=bsnMobilityGroupMemberGroupName, bsnApRegulatoryDomain=bsnApRegulatoryDomain, bsnDot11ModePolicyEnforced=bsnDot11ModePolicyEnforced, bsnMeshNeighSnrDown=bsnMeshNeighSnrDown, bsnGlobalDot11aPhy=bsnGlobalDot11aPhy, bsnPingTestTable=bsnPingTestTable, bsnRadiusAuthClientPacketsDropped=bsnRadiusAuthClientPacketsDropped, bsnOverAirProvisionApMode=bsnOverAirProvisionApMode, bsnWrasDot11bGroupTable=bsnWrasDot11bGroupTable, bsnMobileStationRssiDataLastHeard=bsnMobileStationRssiDataLastHeard)
mibBuilder.exportSymbols("AIRESPACE-WIRELESS-MIB", bsnAPIfDBNoisePower=bsnAPIfDBNoisePower, bsnRadioTypePolicyEnforced=bsnRadioTypePolicyEnforced, bsnRrmDot11bForeignInterferenceThreshold=bsnRrmDot11bForeignInterferenceThreshold, bsnMobileStationPolicyManagerState=bsnMobileStationPolicyManagerState, bsnRfIdTagStatus=bsnRfIdTagStatus, bsnAclRuleDestinationIpAddress=bsnAclRuleDestinationIpAddress, bsnAPBridgingSupport=bsnAPBridgingSupport, bsnExternalPolicyServerIndex=bsnExternalPolicyServerIndex, bsnTotalTransmitErrors=bsnTotalTransmitErrors, WEPKeytype=WEPKeytype, bsnCurrentExportedClients=bsnCurrentExportedClients, bsnAclRowStatus=bsnAclRowStatus, bsnSignatureDescription=bsnSignatureDescription, bsnSensorTemperature=bsnSensorTemperature, bsnAPIfAntennaGain=bsnAPIfAntennaGain, bsnRadiusAccServerRetransmitTimeout=bsnRadiusAccServerRetransmitTimeout, bsnTemperatureSensorFailure=bsnTemperatureSensorFailure, bsnPingTestEntry=bsnPingTestEntry, bsnRogueLocationDiscoveryProtocol=bsnRogueLocationDiscoveryProtocol, bsnGlobalDot11hConfig=bsnGlobalDot11hConfig, bsnDot11EssVpnSharedKey=bsnDot11EssVpnSharedKey, bsnMeshNodeNeighTimeout=bsnMeshNodeNeighTimeout, bsnAPIfPacketsSniffingFeature=bsnAPIfPacketsSniffingFeature, bsnGlobalDot11aNumberofChannels=bsnGlobalDot11aNumberofChannels, bsnStandardSignatureConfigType=bsnStandardSignatureConfigType, bsnInterferenceBeforeChannelUpdate=bsnInterferenceBeforeChannelUpdate, bsnRogueClientAirespaceAPTable=bsnRogueClientAirespaceAPTable, bsnAcceptSelfSignedCertificate=bsnAcceptSelfSignedCertificate, bsnAPIfDown=bsnAPIfDown, bsnRogueAPMaxDetectedRSSI=bsnRogueAPMaxDetectedRSSI, bsnAPIfChannelNoiseInfoEntry=bsnAPIfChannelNoiseInfoEntry, bsnGlobalDot11Config=bsnGlobalDot11Config, bsnGlobalDot11bPowerUpdateCmdStatus=bsnGlobalDot11bPowerUpdateCmdStatus, bsnAPIfDot11BeaconPeriod=bsnAPIfDot11BeaconPeriod, bsnAPParamUpdateTrapControlMask=bsnAPParamUpdateTrapControlMask, bsnBlackListClientEntry=bsnBlackListClientEntry, bsnDot11EssWPAAuthPresharedKey=bsnDot11EssWPAAuthPresharedKey, bsnMaximumNumberOfConcurrentLogins=bsnMaximumNumberOfConcurrentLogins, bsnRadiosExceedLicenseCount=bsnRadiosExceedLicenseCount, bsnInterferenceEnergyBeforeChannelUpdate=bsnInterferenceEnergyBeforeChannelUpdate, bsnMobileStationBytesSent=bsnMobileStationBytesSent, bsnAPImpersonationDetected=bsnAPImpersonationDetected, bsnIpsecIkeNegFailure=bsnIpsecIkeNegFailure, bsnRrmDot11aMobileMinExceptionLevel=bsnRrmDot11aMobileMinExceptionLevel, bsnRadiusAuthServerKeyFormat=bsnRadiusAuthServerKeyFormat, bsnClientMacAddr=bsnClientMacAddr, bsnRrmDot11aForeignInterferenceThreshold=bsnRrmDot11aForeignInterferenceThreshold, bsnIpsecTrapsMask=bsnIpsecTrapsMask, bsnMeshNeighPoorSnr=bsnMeshNeighPoorSnr, bsnGlobalDot11aDataRate6Mhz=bsnGlobalDot11aDataRate6Mhz, bsnAPIfWlanOverrideSsid=bsnAPIfWlanOverrideSsid, bsnRadiusAuthServerRetransmitTimeout=bsnRadiusAuthServerRetransmitTimeout, bsnRogueAPMaxRssiRadioType=bsnRogueAPMaxRssiRadioType, bsnRadiusAuthCacheCredentialsLocally=bsnRadiusAuthCacheCredentialsLocally, bsnAPIfEntry=bsnAPIfEntry, bsnRrmDot11aCoverageExceptionLevel=bsnRrmDot11aCoverageExceptionLevel, bsnTotalHandoffAsLocalReceived=bsnTotalHandoffAsLocalReceived, bsnAPCurrentTxPowerChanged=bsnAPCurrentTxPowerChanged, bsnRadiusAccClientPacketsDropped=bsnRadiusAccClientPacketsDropped, bsnStationAPIfSlotId=bsnStationAPIfSlotId, bsnDot11EssVpnQotdServerAddress=bsnDot11EssVpnQotdServerAddress, bsnDot11QosBurstDataRate=bsnDot11QosBurstDataRate, bsnAPIfSmtParamEntry=bsnAPIfSmtParamEntry, bsnSystemTimezoneDelta=bsnSystemTimezoneDelta, bsnPolicyForMisconfiguredAps=bsnPolicyForMisconfiguredAps, bsnAPIfCoverageThreshold=bsnAPIfCoverageThreshold, bsnTraps=bsnTraps, bsnIpsec=bsnIpsec, bsnAPIfOperStatus=bsnAPIfOperStatus, bsnTrustedApHasInvalidEncryption=bsnTrustedApHasInvalidEncryption, bsnTotalHandoffEndRequestsReceived=bsnTotalHandoffEndRequestsReceived, bsnMobileStationAID=bsnMobileStationAID, bsnTrustedApEntryExpirationTimeout=bsnTrustedApEntryExpirationTimeout, bsnLocalManagementUserTable=bsnLocalManagementUserTable, bsnRadiusAuthServerIndex=bsnRadiusAuthServerIndex, bsnStandardSignatureInterval=bsnStandardSignatureInterval, bsnRadiusAuthServerTable=bsnRadiusAuthServerTable, bsnRadiusAuthServerKeyWrapFormat=bsnRadiusAuthServerKeyWrapFormat, bsnRrmDot11bGroupingDone=bsnRrmDot11bGroupingDone, bsnDot11Ess80211ePolicySetting=bsnDot11Ess80211ePolicySetting, bsnIsakmpInvalidCookies=bsnIsakmpInvalidCookies, bsnRadiusAccServerIPSecAuth=bsnRadiusAccServerIPSecAuth, bsnAPIfRadarChannelStatisticsEntry=bsnAPIfRadarChannelStatisticsEntry, bsnClientRssi=bsnClientRssi, bsnUserEssIndex=bsnUserEssIndex, bsnMobileStationRssiDataApName=bsnMobileStationRssiDataApName, bsnMeshNeighsEntry=bsnMeshNeighsEntry, bsnUtilityGroup=bsnUtilityGroup, bsnTagType=bsnTagType, bsnAPRadioCardTxFailureClear=bsnAPRadioCardTxFailureClear, bsnDot11EssRSNAuthPresharedKey=bsnDot11EssRSNAuthPresharedKey, bsnAPCertificateType=bsnAPCertificateType, bsnAPIfDot11TxPowerLevel3=bsnAPIfDot11TxPowerLevel3, bsnRadiusAccClientUnknownTypes=bsnRadiusAccClientUnknownTypes, bsnUserIpAddress=bsnUserIpAddress, bsnMobileStationAnchorAddress=bsnMobileStationAnchorAddress, bsnTotalAnchorGrantReceived=bsnTotalAnchorGrantReceived, bsnLocalNetUserStartTime=bsnLocalNetUserStartTime, BsnSignaturePatternOffSetStart=BsnSignaturePatternOffSetStart, bsnAPIfStationCountOnRSSI=bsnAPIfStationCountOnRSSI, bsnRadiusAccClientRequests=bsnRadiusAccClientRequests, bsnMacFilterWlanId=bsnMacFilterWlanId, bsnStationUserName=bsnStationUserName, bsnRrmDot11bGroupLastUpdateTime=bsnRrmDot11bGroupLastUpdateTime, bsnTotalHandoffs=bsnTotalHandoffs, bsnRrmDot11aNoiseMeasurementInterval=bsnRrmDot11aNoiseMeasurementInterval, bsnTotalClientHandoffAsForeign=bsnTotalClientHandoffAsForeign, bsnApHasNoRadioCards=bsnApHasNoRadioCards, bsnWrasIpsecCertEntry=bsnWrasIpsecCertEntry, bsnRogueAPDetectingAPRadioType=bsnRogueAPDetectingAPRadioType, bsnRrmDot11aGroupLeaderMacAddr=bsnRrmDot11aGroupLeaderMacAddr, bsnSyslogRemoteAddress=bsnSyslogRemoteAddress, bsnIPTheftORReuse=bsnIPTheftORReuse, bsnAPGroupsVlanEntry=bsnAPGroupsVlanEntry, bsnAPAuthMacAddress=bsnAPAuthMacAddress, bsnDot11EssRadiusAcctSecondaryServer=bsnDot11EssRadiusAcctSecondaryServer, bsnStandardSignatureTable=bsnStandardSignatureTable, bsnGlobalDot11aMaxTransmitMSDULifetime=bsnGlobalDot11aMaxTransmitMSDULifetime, bsnMobilityGroupMemberMacAddress=bsnMobilityGroupMemberMacAddress, bsnAPGroupsVlanName=bsnAPGroupsVlanName, bsnAPIfPhyAntennaOptions=bsnAPIfPhyAntennaOptions, bsnAPIfDot11PhyChannelEntry=bsnAPIfDot11PhyChannelEntry, bsnMobileStationPerRadioPerVapIndex=bsnMobileStationPerRadioPerVapIndex, bsnTagRssiData=bsnTagRssiData, bsnBridgingPolicyConfig=bsnBridgingPolicyConfig, bsnAclApplyMode=bsnAclApplyMode, bsnExternalPolicyServerAclName=bsnExternalPolicyServerAclName, bsnGlobalDot11aNetworkStatus=bsnGlobalDot11aNetworkStatus, bsnAPIfMacOperationParamTable=bsnAPIfMacOperationParamTable, bsnGlobalDot11bDataRate1Mhz=bsnGlobalDot11bDataRate1Mhz, bsnMobilityGroup=bsnMobilityGroup, bsnGlobalDot11bDynamicTransmitPowerControl=bsnGlobalDot11bDynamicTransmitPowerControl, bsnAPIfRecommendedTxPowerLevel=bsnAPIfRecommendedTxPowerLevel, bsnStandardSignatureMacInfo=bsnStandardSignatureMacInfo, bsnMemberCurrentImportedClients=bsnMemberCurrentImportedClients, bsnLinkTestRowStatus=bsnLinkTestRowStatus, bsnRadiusAuthClientAccessChallenges=bsnRadiusAuthClientAccessChallenges, bsnAPIfRecommendedRFParametersEntry=bsnAPIfRecommendedRFParametersEntry, bsnRrmDot11aGroupLastUpdateTime=bsnRrmDot11aGroupLastUpdateTime, bsnGlobalDot11bCurrentTxPowerLevel=bsnGlobalDot11bCurrentTxPowerLevel, bsnLinkTestStatus=bsnLinkTestStatus, bsnTotalExportedClients=bsnTotalExportedClients, bsnImpersonatingSourceMacAddr=bsnImpersonatingSourceMacAddr, bsnDot11StationAssociateFail=bsnDot11StationAssociateFail, bsnIkeTotalRespFailures=bsnIkeTotalRespFailures, bsnTotalResponsesRetransmitted=bsnTotalResponsesRetransmitted, bsnStandardSignaturePatternOffset=bsnStandardSignaturePatternOffset, bsnMaxRogueCountExceeded=bsnMaxRogueCountExceeded, bsnGlobalDot11bDynamicTxPowerControlInterval=bsnGlobalDot11bDynamicTxPowerControlInterval, bsnTrustedApPreambleUsed=bsnTrustedApPreambleUsed, bsnStandardSignatureEntry=bsnStandardSignatureEntry, bsnSuiteInitFailures=bsnSuiteInitFailures, bsnAPAdminStatus=bsnAPAdminStatus, bsnAPIfDot11OperationalRateSet=bsnAPIfDot11OperationalRateSet, bsnRadiusAccServerStatsTable=bsnRadiusAccServerStatsTable, bsnAPIfWlanOverride=bsnAPIfWlanOverride, bsnStationMacAddress=bsnStationMacAddress, bsnMaxRogueCountClear=bsnMaxRogueCountClear, bsnExcessive8021xAuthFailures=bsnExcessive8021xAuthFailures, bsnRrmDot11aChannelMonitorList=bsnRrmDot11aChannelMonitorList, bsnConfigSaveTrapEnable=bsnConfigSaveTrapEnable, bsnDot11EssVpnContivityMode=bsnDot11EssVpnContivityMode, bsnGlobalDot11aDataRate48Mhz=bsnGlobalDot11aDataRate48Mhz, bsnAPIfLoadChannelUtilization=bsnAPIfLoadChannelUtilization, bsnRadiusAccClientRoundTripTime=bsnRadiusAccClientRoundTripTime, bsnLocalNetUserDescription=bsnLocalNetUserDescription, bsnRadiusAuthServerIPSecDHGroup=bsnRadiusAuthServerIPSecDHGroup, bsnAPIfDot11TxPowerLevel7=bsnAPIfDot11TxPowerLevel7, bsnAPIfStationRSSICoverageInfoTable=bsnAPIfStationRSSICoverageInfoTable, bsnGlobalDot11aCurrentTxPowerLevel=bsnGlobalDot11aCurrentTxPowerLevel, bsnIkeAuthMethod=bsnIkeAuthMethod, bsnMobileStationMirrorMode=bsnMobileStationMirrorMode, bsnAutoContainTrustedClientsOnRogueAps=bsnAutoContainTrustedClientsOnRogueAps, bsnGlobalDot11bMaximumTransmitPowerLevel=bsnGlobalDot11bMaximumTransmitPowerLevel, bsnUserAccessMode=bsnUserAccessMode, bsnDot11EssWPASecurity=bsnDot11EssWPASecurity, bsnGlobalDot11bDynamicChannelAssignment=bsnGlobalDot11bDynamicChannelAssignment, bsnWrasDot11bPeerMacAddress=bsnWrasDot11bPeerMacAddress, bsnBridgingZeroTouchConfig=bsnBridgingZeroTouchConfig, bsnAclRuleTable=bsnAclRuleTable, bsnAPTertiaryMwarName=bsnAPTertiaryMwarName, bsnMeshNodeGroup=bsnMeshNodeGroup, bsnAPIfLoadNumOfClients=bsnAPIfLoadNumOfClients, bsnSignatureAttackChannel=bsnSignatureAttackChannel, bsnRrmDot11aAPDefault=bsnRrmDot11aAPDefault, bsnRogueAPAirespaceAPSlotId=bsnRogueAPAirespaceAPSlotId, bsnRADIUSServerTrapEnable=bsnRADIUSServerTrapEnable, bsnAPGroupsVlanMappingInterfaceName=bsnAPGroupsVlanMappingInterfaceName, bsnGlobalDot11aMediumBandNetwork=bsnGlobalDot11aMediumBandNetwork, bsnNetworkState=bsnNetworkState, bsnAPIfRadarSignalLastHeard=bsnAPIfRadarSignalLastHeard, bsnDot11EssWebPassthru=bsnDot11EssWebPassthru, bsnMeshNodeRxNeighReq=bsnMeshNodeRxNeighReq, bsnWrasDot11aGroupEntry=bsnWrasDot11aGroupEntry, bsnRadiusAccClientMalformedResponses=bsnRadiusAccClientMalformedResponses, bsnAppleTalkEnabled=bsnAppleTalkEnabled, bsnTrapsGroupRev1=bsnTrapsGroupRev1, bsnThirdPartyAPIpAddress=bsnThirdPartyAPIpAddress, bsnGroupDirectoryDicoveryType=bsnGroupDirectoryDicoveryType, bsnAPIfDot11MaximumTransmitPowerLevel=bsnAPIfDot11MaximumTransmitPowerLevel, bsnAPGroupsVlanConfig=bsnAPGroupsVlanConfig, bsnDot11EssL2tpSecurity=bsnDot11EssL2tpSecurity, bsnRrmDot11aForeignNoiseThreshold=bsnRrmDot11aForeignNoiseThreshold, bsnGlobalDot11aFastRoamingVoipMinRate=bsnGlobalDot11aFastRoamingVoipMinRate, bsnAPIfNumberOfVaps=bsnAPIfNumberOfVaps, bsnAPIfProfileThresholdConfigTable=bsnAPIfProfileThresholdConfigTable, bsnStandardSignatureEnable=bsnStandardSignatureEnable, bsnAPIfUp=bsnAPIfUp, bsnCustomSignaturePatternOffset=bsnCustomSignaturePatternOffset, bsnCustomSignaturePatternTable=bsnCustomSignaturePatternTable, bsnRogueApAutoContained=bsnRogueApAutoContained, bsnMobileStationProtocol=bsnMobileStationProtocol, bsnThirdPartyAPEntry=bsnThirdPartyAPEntry, bsnGlobalDot11bDataRate36Mhz=bsnGlobalDot11bDataRate36Mhz, bsnClientExclusionPolicyConfig=bsnClientExclusionPolicyConfig, bsnStandardSignaturePatternIndex=bsnStandardSignaturePatternIndex, bsnRogueAPContainmentChannelCount=bsnRogueAPContainmentChannelCount, bsnGlobalDot11a=bsnGlobalDot11a, bsnAPIfCoverageProfileState=bsnAPIfCoverageProfileState, bsnWrasGroups=bsnWrasGroups, bsnRogueAPLastReported=bsnRogueAPLastReported, bsnAPSerialNumber=bsnAPSerialNumber, bsnRadiusAccServerInetAddress=bsnRadiusAccServerInetAddress, bsnWrasIpsecCACertificateUpdate=bsnWrasIpsecCACertificateUpdate, bsnRogueAPTotalDetectingAPs=bsnRogueAPTotalDetectingAPs, bsnMobileStationByUserName=bsnMobileStationByUserName, bsnCustomSignatureConfigType=bsnCustomSignatureConfigType, bsnAPIfRxNeighborMacAddress=bsnAPIfRxNeighborMacAddress, bsnCustomSignaturePrecedence=bsnCustomSignaturePrecedence, bsnPingTestReceivedCount=bsnPingTestReceivedCount, bsnDot11EssDhcpRequired=bsnDot11EssDhcpRequired, bsnDot11EssWmePolicySetting=bsnDot11EssWmePolicySetting, bsnAPIfAdminStatus=bsnAPIfAdminStatus, bsnOperatingTemperatureEnvironment=bsnOperatingTemperatureEnvironment, bsnRogueAPOnWiredNetwork=bsnRogueAPOnWiredNetwork, bsnAPIfMobileMinExceptionLevel=bsnAPIfMobileMinExceptionLevel, bsnTotalClientHandoffAsLocal=bsnTotalClientHandoffAsLocal, bsnApFallbackEnabled=bsnApFallbackEnabled, bsnDot11Ess8021xEncryptionType=bsnDot11Ess8021xEncryptionType, bsnRadiusAuthClientAccessRetransmissions=bsnRadiusAuthClientAccessRetransmissions, bsnWrasDot11aPeerMacAddress=bsnWrasDot11aPeerMacAddress, bsnRogueClientAirespaceAPLastHeard=bsnRogueClientAirespaceAPLastHeard, bsnAPStatsTimer=bsnAPStatsTimer, bsnTotalHandoffAsForeignReceived=bsnTotalHandoffAsForeignReceived, bsnAlertIfTrustedApMissing=bsnAlertIfTrustedApMissing, bsnSignatureCheckState=bsnSignatureCheckState, bsnRogueClientState=bsnRogueClientState, bsnRogueClientAirespaceAPSNR=bsnRogueClientAirespaceAPSNR, bsnRadiusAuthServerRowStatus=bsnRadiusAuthServerRowStatus, bsnAPIfRecommendedChannelNumber=bsnAPIfRecommendedChannelNumber, bsnAPIfChannelInterferenceInfoEntry=bsnAPIfChannelInterferenceInfoEntry, bsnGlobalDot11bChannelAgilityEnabled=bsnGlobalDot11bChannelAgilityEnabled, bsnInterferenceEnergyAfterChannelUpdate=bsnInterferenceEnergyAfterChannelUpdate, bsnRogueClientPerRogueAPTable=bsnRogueClientPerRogueAPTable)
mibBuilder.exportSymbols("AIRESPACE-WIRELESS-MIB", bsnGlobalDot11MultiDomainCapabilityImplemented=bsnGlobalDot11MultiDomainCapabilityImplemented, bsnAPIfDot11MacParamsConfigType=bsnAPIfDot11MacParamsConfigType, bsnMobilityGroupMembersTable=bsnMobilityGroupMembersTable, bsnRadiusAccServerIPSecDHGroup=bsnRadiusAccServerIPSecDHGroup, bsnDot11EssRadiusAcctTertiaryServer=bsnDot11EssRadiusAcctTertiaryServer, bsnExternalPolicyServerPortNumber=bsnExternalPolicyServerPortNumber, bsnAPNetmask=bsnAPNetmask, bsnAPIfProfileStateTable=bsnAPIfProfileStateTable, bsnMobileStationExtStatsTable=bsnMobileStationExtStatsTable, bsnMeshNeighSnr=bsnMeshNeighSnr, bsnLinkTestSendPktLength=bsnLinkTestSendPktLength, bsn80211SecurityTrapControlMask=bsn80211SecurityTrapControlMask, bsnAPIfWlanOverrideId=bsnAPIfWlanOverrideId, bsnAPIfDot11ReceivedFragmentCount=bsnAPIfDot11ReceivedFragmentCount, bsnDot11EssAclName=bsnDot11EssAclName, bsnTagStatsEntry=bsnTagStatsEntry, bsnValidateSsidForTrustedAp=bsnValidateSsidForTrustedAp, bsnLocalNetUserWlanId=bsnLocalNetUserWlanId, bsnSignatureAttackFrequency=bsnSignatureAttackFrequency, bsnTotalAnchorRequestsSent=bsnTotalAnchorRequestsSent, bsnAPCoverageProfileFailed=bsnAPCoverageProfileFailed, bsnGlobalDot11aMaximumTransmitPowerLevel=bsnGlobalDot11aMaximumTransmitPowerLevel, bsnRogueAPAirespaceAPName=bsnRogueAPAirespaceAPName, bsnAPGroupsVlanMappingRowStatus=bsnAPGroupsVlanMappingRowStatus, bsnDot11EssBlacklistingCapability=bsnDot11EssBlacklistingCapability, bsnRogueAPDetectedOnWiredNetwork=bsnRogueAPDetectedOnWiredNetwork, bsnDot11EssIPv6Bridging=bsnDot11EssIPv6Bridging, bsnDot11EssRSNAuthKeyMgmtMode=bsnDot11EssRSNAuthKeyMgmtMode, bsnRogueAPClassType=bsnRogueAPClassType, bsnAPIfPortNumber=bsnAPIfPortNumber, BsnTxtSignatureMacInfo=BsnTxtSignatureMacInfo, bsnAPClearConfig=bsnAPClearConfig, bsnCustomSignatureMacFreq=bsnCustomSignatureMacFreq, bsnRrmIsDot11bGroupLeader=bsnRrmIsDot11bGroupLeader, bsnLocalNetUserEntry=bsnLocalNetUserEntry, bsnAPGateway=bsnAPGateway, bsnSystemClockTime=bsnSystemClockTime, bsnNetworkType=bsnNetworkType, bsnMobilityAnchorRowStatus=bsnMobilityAnchorRowStatus, countryChangeTrap=countryChangeTrap, bsnRrm=bsnRrm, bsnRadiusAuthServerRFC3576=bsnRadiusAuthServerRFC3576, bsnAPMacAddrTrapVariable=bsnAPMacAddrTrapVariable, bsnSignatureMacInfo=bsnSignatureMacInfo, bsnAPSlotIdTrapVariable=bsnAPSlotIdTrapVariable, bsnTrustedApEncryptionRequired=bsnTrustedApEncryptionRequired, bsnTotalAnchorRequestsGranted=bsnTotalAnchorRequestsGranted, bsnUsersTable=bsnUsersTable, bsnNoiseBeforeChannelUpdate=bsnNoiseBeforeChannelUpdate, bsnMeshNodeBackhaulPAP=bsnMeshNodeBackhaulPAP, bsnMobilityAnchorsEntry=bsnMobilityAnchorsEntry, bsnAPIfDot11FailedCount=bsnAPIfDot11FailedCount, bsnAutoContainAdhocNetworks=bsnAutoContainAdhocNetworks, bsnMeshNodeMalformedNeighPackets=bsnMeshNodeMalformedNeighPackets, bsnAPIfAbsolutePowerList=bsnAPIfAbsolutePowerList, bsnTagRssiDataLastHeard=bsnTagRssiDataLastHeard, bsnRogueAPAirespaceAPRSSI=bsnRogueAPAirespaceAPRSSI, bsnMobileStationDeleteAction=bsnMobileStationDeleteAction, bsnGlobalDot11aPowerUpdateCmdStatus=bsnGlobalDot11aPowerUpdateCmdStatus, bsnRadiusAccClientBadAuthenticators=bsnRadiusAccClientBadAuthenticators, bsnDot11EssVpnPassthruGateway=bsnDot11EssVpnPassthruGateway, bsnRogueAPRowStatus=bsnRogueAPRowStatus, bsnDot11EssIndex=bsnDot11EssIndex, bsnAPIfDot11TxPowerLevel8=bsnAPIfDot11TxPowerLevel8, bsnMobileStationByIpAddress=bsnMobileStationByIpAddress, bsnLocalManagementUserRowStatus=bsnLocalManagementUserRowStatus, bsnDot11EssCraniteSecurity=bsnDot11EssCraniteSecurity, bsnAPIfMultiDomainCapabilityEntry=bsnAPIfMultiDomainCapabilityEntry, bsnAclEntry=bsnAclEntry, bsnAclRuleIndex=bsnAclRuleIndex, bsnDuplicateIpAddressReported=bsnDuplicateIpAddressReported, bsnAPIfChannelList=bsnAPIfChannelList, bsnMacFilterDescription=bsnMacFilterDescription, bsnStationBlacklistingReasonCode=bsnStationBlacklistingReasonCode, bsnSystemTimezoneDaylightSavings=bsnSystemTimezoneDaylightSavings, bsnRadiusAccClientRetransmissions=bsnRadiusAccClientRetransmissions, bsnLicenseKeyTrapVariable=bsnLicenseKeyTrapVariable, bsnApGroupRev1=bsnApGroupRev1, bsnDot11StationDisassociate=bsnDot11StationDisassociate, bsnTrapVariable=bsnTrapVariable, bsnRrmDot11aGroupingDone=bsnRrmDot11aGroupingDone, bsnMobileStationBytesReceived=bsnMobileStationBytesReceived, bsnAPIfInterferenceChannelNo=bsnAPIfInterferenceChannelNo, bsnGlobalDot11bDataRate48Mhz=bsnGlobalDot11bDataRate48Mhz, bsnGlobalDot11aDataRate36Mhz=bsnGlobalDot11aDataRate36Mhz, bsnRogueAdhocMode=bsnRogueAdhocMode, bsnTrustedApPreambleRequired=bsnTrustedApPreambleRequired, bsnRtpProtocolPriority=bsnRtpProtocolPriority, bsnAPIfDot11FirstChannelNumber=bsnAPIfDot11FirstChannelNumber, bsnAPUp=bsnAPUp, bsnAAA=bsnAAA, bsnUserInterfaceName=bsnUserInterfaceName, bsnAPIfDot11PhyTxPowerTable=bsnAPIfDot11PhyTxPowerTable, bsnRogueAutoContainFeature=bsnRogueAutoContainFeature, bsnRrmDot11bGroup=bsnRrmDot11bGroup, bsnSignatureAttackPreced=bsnSignatureAttackPreced, bsnMeshNodeBlacklistPackets=bsnMeshNodeBlacklistPackets, bsnAPIfDot11TransmittedFragmentCount=bsnAPIfDot11TransmittedFragmentCount, bsnClientSnr=bsnClientSnr, bsnMeshNodeDataRate=bsnMeshNodeDataRate, bsnGlobalDot11b=bsnGlobalDot11b, bsnPingTestStatus=bsnPingTestStatus, bsnGlobalDot11bDataRate2Mhz=bsnGlobalDot11bDataRate2Mhz, bsnRadiusAuthServerIPSecEncryption=bsnRadiusAuthServerIPSecEncryption, bsnPing=bsnPing, bsnCustomSignatureState=bsnCustomSignatureState, bsnVirtualGatewayAddress=bsnVirtualGatewayAddress, bsnAPIfStationCountOnSNR=bsnAPIfStationCountOnSNR, bsnTagRssiDataEntry=bsnTagRssiDataEntry, bsnApFunctionalityDisableReasonCode=bsnApFunctionalityDisableReasonCode, bsnAPIfDot11PhyTxPowerEntry=bsnAPIfDot11PhyTxPowerEntry, bsnGlobalDot11aFragmentationThreshold=bsnGlobalDot11aFragmentationThreshold, locationNotifyContent=locationNotifyContent, bsnGlobalDot11GroupRev1=bsnGlobalDot11GroupRev1, bsnLinkTestReceivedPktCount=bsnLinkTestReceivedPktCount, bsnDot11EssIpsecSecurity=bsnDot11EssIpsecSecurity, bsnMobileStationPortNumber=bsnMobileStationPortNumber, bsnAPIfCoverageExceptionLevel=bsnAPIfCoverageExceptionLevel, unsupportedAPTrap=unsupportedAPTrap, bsnAPEthernetMacAddress=bsnAPEthernetMacAddress, bsnMeshNeighRapEase=bsnMeshNeighRapEase, bsnRrmDot11bCoverageExceptionLevel=bsnRrmDot11bCoverageExceptionLevel, bsnAPType=bsnAPType, bsnSystemTimezoneDeltaMinutes=bsnSystemTimezoneDeltaMinutes, bsnDot11EssStaticWEPDefaultKey=bsnDot11EssStaticWEPDefaultKey, bsnApMaxRogueCountExceeded=bsnApMaxRogueCountExceeded, bsnDot11EssFortressSecurity=bsnDot11EssFortressSecurity, bsnRogueClientAirespaceAPMacAddress=bsnRogueClientAirespaceAPMacAddress, bsnGlobalDot11aCFPollRequest=bsnGlobalDot11aCFPollRequest, bsnMacFilterTable=bsnMacFilterTable, bsnNoiseAfterChannelUpdate=bsnNoiseAfterChannelUpdate, bsnGlobalDot11aDynamicTransmitPowerControl=bsnGlobalDot11aDynamicTransmitPowerControl, bsnTrustedApHasInvalidPreamble=bsnTrustedApHasInvalidPreamble, bsnMemberTotalCommunicationErrors=bsnMemberTotalCommunicationErrors, bsnDot11EssSecurityAuthType=bsnDot11EssSecurityAuthType, bsnDot11ResetProfileToDefault=bsnDot11ResetProfileToDefault, bsnDot11QosProfileName=bsnDot11QosProfileName, bsnUserRowStatus=bsnUserRowStatus, bsnRogueAPRadioType=bsnRogueAPRadioType, bsnRogueClientContainmentLevel=bsnRogueClientContainmentLevel, bsnStandardSignatureState=bsnStandardSignatureState, bsnCustomSignatureEntry=bsnCustomSignatureEntry, bsnGlobalDot11aPowerUpdateCmdInvoke=bsnGlobalDot11aPowerUpdateCmdInvoke, bsnWrasDot11aGroupTable=bsnWrasDot11aGroupTable, bsnRadiusAuthServerKey=bsnRadiusAuthServerKey, bsnRogueAPAirespaceAPMacAddress=bsnRogueAPAirespaceAPMacAddress, bsnGlobalDot11aRTSThreshold=bsnGlobalDot11aRTSThreshold, bsnTemperatureAlarmHighLimit=bsnTemperatureAlarmHighLimit, bsnRrmIsDot11aGroupLeader=bsnRrmIsDot11aGroupLeader, bsnTotalHandoffRequests=bsnTotalHandoffRequests, bsnGlobalDot11bChannelUpdateCmdInvoke=bsnGlobalDot11bChannelUpdateCmdInvoke, bsnRadiusAuthClientBadAuthenticators=bsnRadiusAuthClientBadAuthenticators, bsnAPProfileTrapControlMask=bsnAPProfileTrapControlMask, bsnRrmDot11bCoverageMeasurementInterval=bsnRrmDot11bCoverageMeasurementInterval, bsnAAARadiusCallStationIdType=bsnAAARadiusCallStationIdType, bsnAAAGroupRev1=bsnAAAGroupRev1, bsnGlobalDot11aPicoCellMode=bsnGlobalDot11aPicoCellMode, bsnAAAGroup=bsnAAAGroup, bsnAPModel=bsnAPModel, bsnTotalAnchorTransferReceived=bsnTotalAnchorTransferReceived, bsnAPIfPhyAntennaIndex=bsnAPIfPhyAntennaIndex, bsnAPIfProfileStateEntry=bsnAPIfProfileStateEntry, bsnRrmDot11aSetFactoryDefault=bsnRrmDot11aSetFactoryDefault, bsnRadiusAuthClientPendingRequests=bsnRadiusAuthClientPendingRequests, bsnMobilityGroupMembersEntry=bsnMobilityGroupMembersEntry, bsnRogueAPAirespaceAPWepMode=bsnRogueAPAirespaceAPWepMode, bsnGlobalDot11b80211eMaxBandwidth=bsnGlobalDot11b80211eMaxBandwidth, bsnLocalNetUserName=bsnLocalNetUserName, bsnAPIfLoadTxUtilization=bsnAPIfLoadTxUtilization, bsnAPIfDot11ACKFailureCount=bsnAPIfDot11ACKFailureCount, bsnGlobalDot11aInputsForDTP=bsnGlobalDot11aInputsForDTP, bsnAPIfDot11MediumOccupancyLimit=bsnAPIfDot11MediumOccupancyLimit, bsnTagRssiDataApIfType=bsnTagRssiDataApIfType, bsnMeshNodeRoutingState=bsnMeshNodeRoutingState, bsnAPIfSniffServerIPAddress=bsnAPIfSniffServerIPAddress, bsnGlobalDot11aCFPollable=bsnGlobalDot11aCFPollable, bsnAPCoverageTotalClients=bsnAPCoverageTotalClients, bsnUserType=bsnUserType, bsnRogueAPAirespaceAPWpaMode=bsnRogueAPAirespaceAPWpaMode, bsnRrmDot11bThroughputThreshold=bsnRrmDot11bThroughputThreshold, bsnRadiusAuthServerIPSec=bsnRadiusAuthServerIPSec, bsnWrasComplianceRev1=bsnWrasComplianceRev1, bsnAPAuthHashKey=bsnAPAuthHashKey, bsnWrasObsGroupRev1=bsnWrasObsGroupRev1, bsnPingTestMaxTimeInterval=bsnPingTestMaxTimeInterval, bsnTotalAnchorRequestsDenied=bsnTotalAnchorRequestsDenied, bsnRogueAPRemoved=bsnRogueAPRemoved, bsnAclRuleAction=bsnAclRuleAction, bsnGlobalDot11bEDThreshold=bsnGlobalDot11bEDThreshold, bsnMemberTotalAnchoredClients=bsnMemberTotalAnchoredClients, bsnDot11QosAvgRealTimeDataRate=bsnDot11QosAvgRealTimeDataRate, bsnAPIfDot11TransmittedFrameCount=bsnAPIfDot11TransmittedFrameCount, bsnMeshNeighLastUpdate=bsnMeshNeighLastUpdate, bsnGlobalDot11PrivacyOptionImplemented=bsnGlobalDot11PrivacyOptionImplemented, bsnAPIfDot11TxPowerLevel1=bsnAPIfDot11TxPowerLevel1, bsnAPIfDot11MulticastReceivedFrameCount=bsnAPIfDot11MulticastReceivedFrameCount, bsnAPIfDot11TxPowerLevel4=bsnAPIfDot11TxPowerLevel4, bsnCustomSignatureAction=bsnCustomSignatureAction, bsnMobileStationExtStatsEntry=bsnMobileStationExtStatsEntry, bsnMobileStationPBCCOptionImplemented=bsnMobileStationPBCCOptionImplemented, bsnMobileStationAPMacAddr=bsnMobileStationAPMacAddr, bsnMobileStationRssiData=bsnMobileStationRssiData, bsnCustomSignaturePatternRowStatus=bsnCustomSignaturePatternRowStatus, bsnGroupDirectoryMemberMacAddress=bsnGroupDirectoryMemberMacAddress, bsnRrmDot11bSignalMeasurementInterval=bsnRrmDot11bSignalMeasurementInterval, bsnAPOperationStatus=bsnAPOperationStatus, bsnLocalNetUserTable=bsnLocalNetUserTable, bsnAPSecondaryMwarName=bsnAPSecondaryMwarName, bsnAPIfRxNeighborSlot=bsnAPIfRxNeighborSlot, bsnAPIfPhyAntennaMode=bsnAPIfPhyAntennaMode, bsnExternalPolicyServerFailures=bsnExternalPolicyServerFailures, bsnWrasTrap=bsnWrasTrap, bsnLinkTestMacAddress=bsnLinkTestMacAddress, bsnAPIfDot11TxPowerLevel2=bsnAPIfDot11TxPowerLevel2, bsnGlobalDot11bCFPollRequest=bsnGlobalDot11bCFPollRequest, bsnRrmGroup=bsnRrmGroup, bsnStandardSignatureQuietTime=bsnStandardSignatureQuietTime, bsnRogueAPDetectingAPName=bsnRogueAPDetectingAPName, bsnMobileStationPolicyType=bsnMobileStationPolicyType)
