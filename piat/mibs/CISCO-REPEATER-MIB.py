...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-REPEATER-MIB
...
mibBuilder.exportSymbols("CISCO-REPEATER-MIB", ciscoRptrTrapAlgorithm=ciscoRptrTrapAlgorithm, ciscoRptrMIBComplianceV11R01=ciscoRptrMIBComplianceV11R01, ciscoRptrMIBGlobalsGroup=ciscoRptrMIBGlobalsGroup, ciscoRptrPortIllegalAddrLastHeard=ciscoRptrPortIllegalAddrLastHeard, ciscoRptrMIBTraps=ciscoRptrMIBTraps, ciscoRptrPortLastIllegalAddrCount=ciscoRptrPortLastIllegalAddrCount, ciscoRptrPortAllowedSrcAddr=ciscoRptrPortAllowedSrcAddr, ciscoRptrPortIllegalAddrTrapAcked=ciscoRptrPortIllegalAddrTrapAcked, ciscoRptrPortMDIStatus=ciscoRptrPortMDIStatus, ciscoRptrMIBTrapPrefix=ciscoRptrMIBTrapPrefix, ciscoRptrPortIllegalAddrFirstHeard=ciscoRptrPortIllegalAddrFirstHeard, ciscoRptrMIBPortGroupV11R01=ciscoRptrMIBPortGroupV11R01, ciscoRptrMIBObjects=ciscoRptrMIBObjects, ciscoRptrPortTable=ciscoRptrPortTable, ciscoRptrMIBGroup=ciscoRptrMIBGroup, ciscoRptrMIBGroups=ciscoRptrMIBGroups, ciscoRptrPortLinkTestFailed=ciscoRptrPortLinkTestFailed, ciscoRptrPortLastIllegalSrcAddr=ciscoRptrPortLastIllegalSrcAddr, ciscoRptrPortAllowedSrcAddrStatus=ciscoRptrPortAllowedSrcAddrStatus, ciscoRptrMIBCompliance=ciscoRptrMIBCompliance, ciscoRptrPortEntry=ciscoRptrPortEntry, ciscoRptrPortLinkTestEnabled=ciscoRptrPortLinkTestEnabled, ciscoRptrMIB=ciscoRptrMIB, ciscoRptrMIBCompliances=ciscoRptrMIBCompliances, ciscoRptrPortAutoPolarityCorrected=ciscoRptrPortAutoPolarityCorrected, PYSNMP_MODULE_ID=ciscoRptrMIB, ciscoRptrPortIllegalAddrTotalCount=ciscoRptrPortIllegalAddrTotalCount, ciscoRptrMIBglobal=ciscoRptrMIBglobal, ciscoRptrPortIllegalAddrTrapEnabled=ciscoRptrPortIllegalAddrTrapEnabled, ciscoRptrIllegalSrcAddrTrap=ciscoRptrIllegalSrcAddrTrap, ciscoRptrPortSrcAddrCtrl=ciscoRptrPortSrcAddrCtrl, ciscoRptrMIBConformance=ciscoRptrMIBConformance, ciscoRptrPortAutoPolarityEnabled=ciscoRptrPortAutoPolarityEnabled)
