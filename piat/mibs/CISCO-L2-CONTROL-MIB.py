...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-L2-CONTROL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:26:09 2019
...
iso, Integer32, Gauge32, Counter64, IpAddress, NotificationType, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Gauge32", "Counter64", "IpAddress", "NotificationType", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-L2-CONTROL-MIB", clcFdbIfVlanInfoEntry=clcFdbIfVlanInfoEntry, clcIfMacLimitNotifsGroup=clcIfMacLimitNotifsGroup, ciscoL2ControlMIB=ciscoL2ControlMIB, clcIfMacLimitHigh=clcIfMacLimitHigh, clcFdbMacAddressStatsType=clcFdbMacAddressStatsType, ciscoL2ControlMIBNotifs=ciscoL2ControlMIBNotifs, PYSNMP_MODULE_ID=ciscoL2ControlMIB, clcIfMacLimitTable=clcIfMacLimitTable, clcIfVlanMacLimitLowNotifEnable=clcIfVlanMacLimitLowNotifEnable, clcMacAddressLimitGroup=clcMacAddressLimitGroup, clcIfMacAddressLimitObjects=clcIfMacAddressLimitObjects, ciscoL2ControlMIBGroups=ciscoL2ControlMIBGroups, clcIfVlanMacLimitGlobalConfig=clcIfVlanMacLimitGlobalConfig, clcIfMacLimitEnableGroup=clcIfMacLimitEnableGroup, clcMacLimitNotifEnable=clcMacLimitNotifEnable, clcVlanMacLimitStatus=clcVlanMacLimitStatus, clcIfMacLimitHighNotifEnable=clcIfMacLimitHighNotifEnable, clcVlanMacLimitNotifControlGroup1=clcVlanMacLimitNotifControlGroup1, clcMacLimitExceededActionDefault=clcMacLimitExceededActionDefault, clcVlanMacLimitIndex=clcVlanMacLimitIndex, ciscoL2ControlMIBCompliance=ciscoL2ControlMIBCompliance, ClcMacAddressStatsType=ClcMacAddressStatsType, clcIfVlanMacLimitHigh=clcIfVlanMacLimitHigh, clcIfVlanMacLimitLowNotif=clcIfVlanMacLimitLowNotif, clcVlanMacLimitHigh=clcVlanMacLimitHigh, clcIfVlanMacLimitVlanIndex=clcIfVlanMacLimitVlanIndex, clcIfVlanMacLimitEnableGroup=clcIfVlanMacLimitEnableGroup, clcMacAddressStatsObjects=clcMacAddressStatsObjects, clcFdbIfInfoEntry=clcFdbIfInfoEntry, clcIfVlanMacLimitEnable=clcIfVlanMacLimitEnable, clcMacAddressLimitGroup1=clcMacAddressLimitGroup1, clcIfMacAddressLimitGroup=clcIfMacAddressLimitGroup, clcMacLimitInterval=clcMacLimitInterval, clcMacLimitHighDefault=clcMacLimitHighDefault, clcMacAddressLimitIntervalGroup=clcMacAddressLimitIntervalGroup, ciscoL2ControlMIBCompliance2=ciscoL2ControlMIBCompliance2, clcVlanMaxMacLimit=clcVlanMaxMacLimit, clcIfVlanMacLimitTable=clcIfVlanMacLimitTable, clcVlanMacLimitNotifsGroup1=clcVlanMacLimitNotifsGroup1, clcUnicastFloodObjects=clcUnicastFloodObjects, clcIfMacLimitLowExceedAction=clcIfMacLimitLowExceedAction, clcMaxMacLimitDefault=clcMaxMacLimitDefault, clcIfMacLimitEnable=clcIfMacLimitEnable, clcIfMacLimitLowNotif=clcIfMacLimitLowNotif, clcUnicastFloodGroup=clcUnicastFloodGroup, clcMacLimitHighNotifEnable=clcMacLimitHighNotifEnable, clcIfMacLimitGlobalConfig=clcIfMacLimitGlobalConfig, clcIfMacLimitHighNotif=clcIfMacLimitHighNotif, ciscoL2ControlMIBCompliance3=ciscoL2ControlMIBCompliance3, clcIfMacLimitHighExceedAction=clcIfMacLimitHighExceedAction, clcIfMacLimitLow=clcIfMacLimitLow, clcVlanMacLimitHighNotif=clcVlanMacLimitHighNotif, clcFdbIfVlanMacUsage=clcFdbIfVlanMacUsage, clcMacAddressLimitObjects=clcMacAddressLimitObjects, clcVlanMacLimitEnable=clcVlanMacLimitEnable, clcFdbVlanInfoEntry=clcFdbVlanInfoEntry, clcVlanMacLimitHighExceedAction=clcVlanMacLimitHighExceedAction, clcIfVlanMacLimitEntry=clcIfVlanMacLimitEntry, ciscoL2ControlMIBObjects=ciscoL2ControlMIBObjects, clcVlanMacLimitNotif=clcVlanMacLimitNotif, clcIfMacLimitIfIndex=clcIfMacLimitIfIndex, clcUnicastFloodOperEnable=clcUnicastFloodOperEnable, MacLimitExceededAction=MacLimitExceededAction, clcFdbMacAddressStatsTable=clcFdbMacAddressStatsTable, ciscoL2ControlMIBConformance=ciscoL2ControlMIBConformance, clcFdbVlanMacUsage=clcFdbVlanMacUsage, clcFdbIfInfoTable=clcFdbIfInfoTable, clcVlanMacLimitNotifsGroup=clcVlanMacLimitNotifsGroup, clcUnicastFloodAdminEnable=clcUnicastFloodAdminEnable, clcVlanMacAddressLimitGroup1=clcVlanMacAddressLimitGroup1, clcUnicastFloodTable=clcUnicastFloodTable, clcVlanMacLimitNotifControlGroup=clcVlanMacLimitNotifControlGroup, clcIfVlanMacLimitNotifsGroup=clcIfVlanMacLimitNotifsGroup, clcIfVlanMacLimitIfIndex=clcIfVlanMacLimitIfIndex, clcVlanMacAddressLimitGroup=clcVlanMacAddressLimitGroup, clcMacLimitExceedNotifOption=clcMacLimitExceedNotifOption, clcMacLimitHighExceedActionDef=clcMacLimitHighExceedActionDef, clcIfMacLimitLowNotifEnable=clcIfMacLimitLowNotifEnable, clcMacLimitEnable=clcMacLimitEnable, clcIfMacLimitEntry=clcIfMacLimitEntry, clcIfMacLimitNotifControlGroup=clcIfMacLimitNotifControlGroup, ciscoL2ControlMIBCompliances=ciscoL2ControlMIBCompliances, clcIfVlanMacLimitHiExceedAction=clcIfVlanMacLimitHiExceedAction, clcIfVlanMacAddressLimitObjects=clcIfVlanMacAddressLimitObjects, clcIfVlanMacLimitLow=clcIfVlanMacLimitLow, clcIfVlanMacLimitHighNotif=clcIfVlanMacLimitHighNotif, clcIfVlanMacLimitHighNotifEnable=clcIfVlanMacLimitHighNotifEnable, clcFdbVlanInfoTable=clcFdbVlanInfoTable, clcFdbIfMacUsage=clcFdbIfMacUsage, clcIfVlanMacLimitNotifControlGroup=clcIfVlanMacLimitNotifControlGroup, clcMacAddressStatsGroup=clcMacAddressStatsGroup, clcIfVlanMacLimitLowExceedAction=clcIfVlanMacLimitLowExceedAction, clcVlanMacLimitEntry=clcVlanMacLimitEntry, clcIfVlanMacAddressLimitGroup=clcIfVlanMacAddressLimitGroup, clcVlanMacLimitGlobalConfig=clcVlanMacLimitGlobalConfig, clcFdbMacAddressStatsEntry=clcFdbMacAddressStatsEntry, clcIfVlanMacLimitStatus=clcIfVlanMacLimitStatus, clcVlanMacLimitEnableGroup=clcVlanMacLimitEnableGroup, clcUnicastFloodEntry=clcUnicastFloodEntry, clcVlanMacLimitTable=clcVlanMacLimitTable, clcFdbMacAddressStatsNumber=clcFdbMacAddressStatsNumber, clcVlanMacLimitExceededAction=clcVlanMacLimitExceededAction, clcIfMacLimitStatus=clcIfMacLimitStatus, clcFdbIfVlanInfoTable=clcFdbIfVlanInfoTable)
