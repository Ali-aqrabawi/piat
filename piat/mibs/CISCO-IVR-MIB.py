...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IVR-MIB
...
FcNameId, DomainId, FcAddressId, VsanIndex = mibBuilder.importSymbols("CISCO-ST-TC", "FcNameId", "DomainId", "FcAddressId", "VsanIndex")
...
mibBuilder.exportSymbols("CISCO-IVR-MIB", civrZoneEnforcedZoneName=civrZoneEnforcedZoneName, civrTopologyConfigSwitchVsan4k=civrTopologyConfigSwitchVsan4k, civrZoneDeactivationDoneNotify=civrZoneDeactivationDoneNotify, civrTopologyConfigRowStatus=civrTopologyConfigRowStatus, civrZoneEnforcedZoneTable=civrZoneEnforcedZoneTable, civrTopologyAfidConfTable=civrTopologyAfidConfTable, civrZoneMemberNumber=civrZoneMemberNumber, civrZoneSetZoneList=civrZoneSetZoneList, civrZoneSetStatusEntry=civrZoneSetStatusEntry, civrTopologyActivateTime=civrTopologyActivateTime, civrZoneSetLastChange=civrZoneSetLastChange, civrZoneEnforcedZoneSetZoneList=civrZoneEnforcedZoneSetZoneList, civrEnabledDeviceSwitchWwn=civrEnabledDeviceSwitchWwn, civrZoneMemberEntry=civrZoneMemberEntry, civrTopologyClearAfidConfig=civrTopologyClearAfidConfig, civrZoneMemberID=civrZoneMemberID, civrZoneSetActivate=civrZoneSetActivate, civDomainIdConflictVsan=civDomainIdConflictVsan, CIvrZoneMemberType=CIvrZoneMemberType, civrTopologyAfidConfEntry=civrTopologyAfidConfEntry, civrEnabledDeviceDomainId=civrEnabledDeviceDomainId, civrZoneConfigurationGroup=civrZoneConfigurationGroup, civrNotificationGroupRev2=civrNotificationGroupRev2, civrZoneEnforcedZoneMemberList=civrZoneEnforcedZoneMemberList, civrActiveZonesetChecksum=civrActiveZonesetChecksum, civrStatsGroup=civrStatsGroup, civrZoneMemberParentIndex=civrZoneMemberParentIndex, civrZoneClearFullZoneDb=civrZoneClearFullZoneDb, civrTopologyAfidConfSwitchVsan2k=civrTopologyAfidConfSwitchVsan2k, civrZoneMemberAFId=civrZoneMemberAFId, civrAfidMisConfigRemoteSWwn=civrAfidMisConfigRemoteSWwn, civrTopologyAfidConfSwitchWwn=civrTopologyAfidConfSwitchWwn, civrZoneMemberType=civrZoneMemberType, civrZoneSetTableNextIndex=civrZoneSetTableNextIndex, civrAfidConfigNotify=civrAfidConfigNotify, civrZoneServerMIBCompliance=civrZoneServerMIBCompliance, civrZoneEnforcedZoneMemberType=civrZoneEnforcedZoneMemberType, civrZoneServerMIBComplianceRev1=civrZoneServerMIBComplianceRev1, civrZoneMemberFabricId=civrZoneMemberFabricId, civrZoneSetChecksum=civrZoneSetChecksum, civrTopologyDefaultAfidChecksum=civrTopologyDefaultAfidChecksum, civrZoneSetRowStatus=civrZoneSetRowStatus, civrZoneEntry=civrZoneEntry, cimIvrGeneric=cimIvrGeneric, civrTopologyIvrSrvGrpVsan4k=civrTopologyIvrSrvGrpVsan4k, civrZoneLastChange=civrZoneLastChange, civrZoneEnforcedZoneNumber=civrZoneEnforcedZoneNumber, civrZoneEnforcedZoneMemberVsan=civrZoneEnforcedZoneMemberVsan, civrZoneName=civrZoneName, civrEnabledDeviceCapability=civrEnabledDeviceCapability, civrFcidNatMode=civrFcidNatMode, civrZoneEnforcedZoneReadOnly=civrZoneEnforcedZoneReadOnly, cimIvrStats=cimIvrStats, civrTopologyIvrSrvGrpName=civrTopologyIvrSrvGrpName, civrAfidMisConfigLocalAfid=civrAfidMisConfigLocalAfid, civrZoneEnforcedZoneMemberTable=civrZoneEnforcedZoneMemberTable, cimIvrZoneMember=cimIvrZoneMember, civrTopologyActivate=civrTopologyActivate, civrZoneSetNumber=civrZoneSetNumber, civrTopologyActiveSwitchVsan4k=civrTopologyActiveSwitchVsan4k, ciscoIvrMIBObjects=ciscoIvrMIBObjects, civrZoneSetStatus=civrZoneSetStatus, civrTopologyActive=civrTopologyActive, civrZoneIndex=civrZoneIndex, civrZoneServerMIBCompliances=civrZoneServerMIBCompliances, civrEnabledDeviceEntry=civrEnabledDeviceEntry, civrZoneEnforcedZoneMemberAFId=civrZoneEnforcedZoneMemberAFId, civrZoneConfigurationGroupRev2=civrZoneConfigurationGroupRev2, civrZoneSetDeActivate=civrZoneSetDeActivate, civrTopologyConfigSwitchWwn=civrTopologyConfigSwitchWwn, civrZoneMemberRowStatus=civrZoneMemberRowStatus, civrEnabledDeviceAutoFabricId=civrEnabledDeviceAutoFabricId, civrAfidMisConfigVsan=civrAfidMisConfigVsan, civrNotificationGroup=civrNotificationGroup, cimIvrZoneset=cimIvrZoneset, civrTopologyConfigEntry=civrTopologyConfigEntry, civrZoneSetIndex=civrZoneSetIndex, civrVsanTopologyAutoDisc=civrVsanTopologyAutoDisc, civrTopologyDefaultAfidTable=civrTopologyDefaultAfidTable, civrTopologyActiveTable=civrTopologyActiveTable, civrTopologyAfidConfSwitchVsan4k=civrTopologyAfidConfSwitchVsan4k, civrAfidMisConfigRemoteAfid=civrAfidMisConfigRemoteAfid, civrZoneCopyZoneSetEnforcdToFull=civrZoneCopyZoneSetEnforcdToFull, civrTopologyConfigTable=civrTopologyConfigTable, civrTopologyActiveEntry=civrTopologyActiveEntry, civrTopologyDefaultAfidSwitchWwn=civrTopologyDefaultAfidSwitchWwn, cimIvrZone=cimIvrZone, civrZoneReadOnly=civrZoneReadOnly, civrTopologyActiveAutoFabricId=civrTopologyActiveAutoFabricId, civrZoneEnforcedZoneMemberEntry=civrZoneEnforcedZoneMemberEntry, civrZoneSetTable=civrZoneSetTable, civrZoneEnforcedZoneQosPriority=civrZoneEnforcedZoneQosPriority, civrTopologyDefaultAfidEntry=civrTopologyDefaultAfidEntry, civrTopologyDefaultAfidId=civrTopologyDefaultAfidId, civrZoneEnforcedZoneSetActvtTime=civrZoneEnforcedZoneSetActvtTime, civrTopologyAfidConfRowStatus=civrTopologyAfidConfRowStatus, civrTopologyIvrSrvGrpEntry=civrTopologyIvrSrvGrpEntry, civrTopologyClearConfigured=civrTopologyClearConfigured, ciscoIvrMIBNotifications=ciscoIvrMIBNotifications, PYSNMP_MODULE_ID=ciscoIvrMIB, civrAfidMisConfigLocalSWwn=civrAfidMisConfigLocalSWwn, civrVirtualDomainsGroup=civrVirtualDomainsGroup, civrZoneEnforcedZoneMemberNumber=civrZoneEnforcedZoneMemberNumber, civrZoneNumber=civrZoneNumber, civrTopologyGroupRev2=civrTopologyGroupRev2, civrZoneRowStatus=civrZoneRowStatus, civrZoneEnforcedZoneSetName=civrZoneEnforcedZoneSetName, civrTopologyConfigAutoFabricId=civrTopologyConfigAutoFabricId, civrTopologyCopyActiveToConfig=civrTopologyCopyActiveToConfig, civrTopologyIvrSrvGrpTable=civrTopologyIvrSrvGrpTable, cimIvrTopology=cimIvrTopology, civrZonesetActivateForce=civrZonesetActivateForce, civrZoneServerMIBGroups=civrZoneServerMIBGroups, civrTopologyActiveSwitchVsan2k=civrTopologyActiveSwitchVsan2k, civrTopologyAfidConfigChecksum=civrTopologyAfidConfigChecksum, civrEnabledDeviceVsan=civrEnabledDeviceVsan, civrZoneActivationDoneNotify=civrZoneActivationDoneNotify, civrTopologyIvrSrvGrpVsan2k=civrTopologyIvrSrvGrpVsan2k, civrZoneTable=civrZoneTable, civrZoneSetStatusTable=civrZoneSetStatusTable, civrAddIvrVirtualDomainsVsans2k=civrAddIvrVirtualDomainsVsans2k, civrZoneSetActvatDeactvatResult=civrZoneSetActvatDeactvatResult, civrEnabledDeviceTable=civrEnabledDeviceTable, civrTopologyMisConfigReason=civrTopologyMisConfigReason, CIvrChecksum=CIvrChecksum, civrZoneServerMIBComplianceRev2=civrZoneServerMIBComplianceRev2, civrTopologyAfidConfId=civrTopologyAfidConfId, civrZoneSetActDeactPartialSucss=civrZoneSetActDeactPartialSucss, civrTopologyConfigSwitchVsan2k=civrTopologyConfigSwitchVsan2k, civrTopologyActiveSwitchWwn=civrTopologyActiveSwitchWwn, civrZoneMemberLunID=civrZoneMemberLunID, civrZoneMemberIndex=civrZoneMemberIndex, civrTopologyGroup=civrTopologyGroup, civrTopologyIvrSrvGrpRowStatus=civrTopologyIvrSrvGrpRowStatus, civrZoneTableNextIndex=civrZoneTableNextIndex, civrDomainConflictNotify=civrDomainConflictNotify, civrZoneMemberTable=civrZoneMemberTable, cimIvrVirtualDomains=cimIvrVirtualDomains, civrTopologyConfiguredChecksum=civrTopologyConfiguredChecksum, civrTopologyActiveChecksum=civrTopologyActiveChecksum, CIvrAutonomousFabricId=CIvrAutonomousFabricId, civrAddIvrVirtualDomainsVsans4k=civrAddIvrVirtualDomainsVsans4k, civrZoneMemberList=civrZoneMemberList, civrZonesetDbChecksum=civrZonesetDbChecksum, civrZoneEnforcedZoneMemberLunID=civrZoneEnforcedZoneMemberLunID, civrZoneMemberVsan=civrZoneMemberVsan, civrGenericGroup=civrGenericGroup, ciscoIvrMIBConformance=ciscoIvrMIBConformance, civrTopologyDefaultAfidStatus=civrTopologyDefaultAfidStatus, civrZoneEnforcedZoneMemberID=civrZoneEnforcedZoneMemberID, civrZoneSetEntry=civrZoneSetEntry, civrZoneEnforcedZoneEntry=civrZoneEnforcedZoneEntry, cimIvrConfiguration=cimIvrConfiguration, civrZoneQosPriority=civrZoneQosPriority, civrZoneSetName=civrZoneSetName, ciscoIvrMIB=ciscoIvrMIB)
