...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DSP-MGMT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:36:24 2019
...
Counter64, NotificationType, Bits, ObjectIdentity, Gauge32, TimeTicks, Counter32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Bits", "ObjectIdentity", "Gauge32", "TimeTicks", "Counter32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("CISCO-DSP-MGMT-MIB", cdspCardLastResetTime=cdspCardLastResetTime, cdspMIBEnableCardStatusNotification=cdspMIBEnableCardStatusNotification, cdspRtcpTimerControl=cdspRtcpTimerControl, cdspCardStatusEntry=cdspCardStatusEntry, cdspMgmtComplianceRev4=cdspMgmtComplianceRev4, ciscoDspMgmtMIB=ciscoDspMgmtMIB, cdspMgmtComplianceRev7=cdspMgmtComplianceRev7, cdspNormalDsp=cdspNormalDsp, cdspLastAlarmCauseText=cdspLastAlarmCauseText, cdspXAvailableBearerBandwidth=cdspXAvailableBearerBandwidth, cdspVoiceParamTable=cdspVoiceParamTable, cdspVadAdaptive=cdspVadAdaptive, cdspMgmtComplianceRev3=cdspMgmtComplianceRev3, cdspMgmtGroups=cdspMgmtGroups, cdspMgmtGeneralInfoGroupRev1=cdspMgmtGeneralInfoGroupRev1, cdspUtilInfoGroup=cdspUtilInfoGroup, cdspTranscodeProfileRowStatus=cdspTranscodeProfileRowStatus, cdspMgmtCompliance=cdspMgmtCompliance, cdspVqmControl=cdspVqmControl, cdspCurrentUtilCap=cdspCurrentUtilCap, cdspSigBearerChannelSplit=cdspSigBearerChannelSplit, cdspTranscodeProfileMaxAvailSess=cdspTranscodeProfileMaxAvailSess, cdspTranscodeProfileMaxConfSess=cdspTranscodeProfileMaxConfSess, cdspCardResourceUtilization=cdspCardResourceUtilization, cdspNx64Dsp=cdspNx64Dsp, cdspCardStatusTable=cdspCardStatusTable, cdspCurrentAvlbCap=cdspCurrentAvlbCap, cdspEnableOperStateNotification=cdspEnableOperStateNotification, cdspRtcpXrGminDefault=cdspRtcpXrGminDefault, cdspCodecTemplateSupported=cdspCodecTemplateSupported, cdspFailedDsp=cdspFailedDsp, cdspMtpProfileMaxConfSoftSess=cdspMtpProfileMaxConfSoftSess, cdspMIBCardStateNotification=cdspMIBCardStateNotification, cdspCardState=cdspCardState, cdspInUseChannels=cdspInUseChannels, cdspMgmtComplianceRev8=cdspMgmtComplianceRev8, cdspObjects=cdspObjects, cdspAlarms=cdspAlarms, cdspMgmtNotificationsGroupRev1=cdspMgmtNotificationsGroupRev1, cdspRtcpXrExtRfactor=cdspRtcpXrExtRfactor, cdspUtilObjects=cdspUtilObjects, cdspCardIndex=cdspCardIndex, cdspMgmtNotifications=cdspMgmtNotifications, cdspXNumberOfBearerCalls=cdspXNumberOfBearerCalls, cdspStatusXTable=cdspStatusXTable, cdspActiveChannels=cdspActiveChannels, cdspCardVideoPoolUtilizationThreshold=cdspCardVideoPoolUtilizationThreshold, cdspCodecPoolIndex=cdspCodecPoolIndex, cdspOperStateNotification=cdspOperStateNotification, cdspMgmtCompliances=cdspMgmtCompliances, cdspVoiceInfoGroupRev2=cdspVoiceInfoGroupRev2, cdspDspfarmUtilObjects=cdspDspfarmUtilObjects, cdspTransCodingGroup1=cdspTransCodingGroup1, cdspCardMaxChanPerDSP=cdspCardMaxChanPerDSP, cdspMgmtVideoInfoGroup=cdspMgmtVideoInfoGroup, cdspUtilEntry=cdspUtilEntry, cdspTotalDsp=cdspTotalDsp, cdspNumCongestionOccurrence=cdspNumCongestionOccurrence, cdspRtcpXrControl=cdspRtcpXrControl, cdspRtcpTransInterval=cdspRtcpTransInterval, cdspLastAlarmTime=cdspLastAlarmTime, cdspTotalChannels=cdspTotalChannels, cdspMgmtExtGeneralInfoGroup=cdspMgmtExtGeneralInfoGroup, cdspTranscodeProfileEntry=cdspTranscodeProfileEntry, cdspDspNum=cdspDspNum, cdspTransparentIpIp=cdspTransparentIpIp, cdspCardLastHiWaterUtilization=cdspCardLastHiWaterUtilization, cdspMtpProfileEntry=cdspMtpProfileEntry, cdspXAvailableSigBandwidth=cdspXAvailableSigBandwidth, cdspMIBNotificationPrefix=cdspMIBNotificationPrefix, cdspStatusEntry=cdspStatusEntry, cdspTotAvailTranscodeSess=cdspTotAvailTranscodeSess, cdspMgmtComplianceRev10=cdspMgmtComplianceRev10, cdspMgmtComplianceRev2=cdspMgmtComplianceRev2, cdspPktLossConcealment=cdspPktLossConcealment, cdspRtpSidPayloadType=cdspRtpSidPayloadType, cdspDtmfPowerTwist=cdspDtmfPowerTwist, cdspMIBNotifications=cdspMIBNotifications, cdspMtpProfileMaxAvailHardSess=cdspMtpProfileMaxAvailHardSess, cdspVoiceInfoGroupRev1=cdspVoiceInfoGroupRev1, cdspVoiceInfoGroup=cdspVoiceInfoGroup, cdspMgmtObjects=cdspMgmtObjects, cdspVqmThreshSES=cdspVqmThreshSES, cdspOperState=cdspOperState, cdspTransCodingGroup=cdspTransCodingGroup, cdspMtpProfileTable=cdspMtpProfileTable, cdspVoiceObjects=cdspVoiceObjects, cdspMtpProfileMaxConfHardSess=cdspMtpProfileMaxConfHardSess, cdspCongestedDsp=cdspCongestedDsp, cdspVideoUsageNotification=cdspVideoUsageNotification, cdspCardObjects=cdspCardObjects, cdspMgmtComplianceRev1=cdspMgmtComplianceRev1, cdspChannelExtGroup=cdspChannelExtGroup, cdspDspfarmObjects=cdspDspfarmObjects, cdspStatusTable=cdspStatusTable, cdspTranscodeProfileId=cdspTranscodeProfileId, cdspMgmtConformance=cdspMgmtConformance, cdspTotUnusedMtpSess=cdspTotUnusedMtpSess, PYSNMP_MODULE_ID=ciscoDspMgmtMIB, cdspMgmtNotificationsGroup=cdspMgmtNotificationsGroup, cdspGlobMaxAvailTranscodeSess=cdspGlobMaxAvailTranscodeSess, cdspMgmtComplianceRev6=cdspMgmtComplianceRev6, cdspCardVideoPoolUtilization=cdspCardVideoPoolUtilization, cdspXNumberOfSigCalls=cdspXNumberOfSigCalls, cdspMgmtComplianceRev9=cdspMgmtComplianceRev9, cdspChannelGroup=cdspChannelGroup, cdspDspSwitchOverThreshold=cdspDspSwitchOverThreshold, cdspTranscodeProfileTable=cdspTranscodeProfileTable, cdspMgmtVideoNotificationsGroup=cdspMgmtVideoNotificationsGroup, cdspVideoUsageNotificationEnable=cdspVideoUsageNotificationEnable, cdspStatusXEntry=cdspStatusXEntry, cdspTotAvailMtpSess=cdspTotAvailMtpSess, cdspMgmtComplianceRev11=cdspMgmtComplianceRev11, cdspMtpProfileId=cdspMtpProfileId, cdspMtpProfileRowStatus=cdspMtpProfileRowStatus, cdspGlobMaxConfTranscodeSess=cdspGlobMaxConfTranscodeSess, cdspUtilTable=cdspUtilTable, cdspRtcpRecvMultiplier=cdspRtcpRecvMultiplier, cdspMgmtComplianceRev5=cdspMgmtComplianceRev5, cdspMgmtExtGeneralInfoGroupRev1=cdspMgmtExtGeneralInfoGroupRev1, cdspVoiceParamEntry=cdspVoiceParamEntry, cdspLastAlarmCause=cdspLastAlarmCause, cdspVoiceModeIpIp=cdspVoiceModeIpIp, cdspVideoOutOfResourceNotification=cdspVideoOutOfResourceNotification, cdspTotUnusedTranscodeSess=cdspTotUnusedTranscodeSess, cdspDtmfPowerLevel=cdspDtmfPowerLevel, cdspRtcpXrTransMultiplier=cdspRtcpXrTransMultiplier, cdspMIBNotificationEnables=cdspMIBNotificationEnables, cdspDspfarmInfoGroup=cdspDspfarmInfoGroup, cdspRtcpControl=cdspRtcpControl, cdspVideoOutOfResourceNotificationEnable=cdspVideoOutOfResourceNotificationEnable, cdspVQMGroup=cdspVQMGroup, cdspMgmtGeneralInfoGroup=cdspMgmtGeneralInfoGroup)
