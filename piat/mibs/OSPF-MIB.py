...
# Produced by pysmi-0.3.4 at Sun Apr 21 23:29:07 2019
...
Integer32, mib_2, ModuleIdentity, Bits, NotificationType, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, iso, TimeTicks, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "iso", "TimeTicks", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("OSPF-MIB", ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartExitReason=ospfRestartExitReason, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsdbType=ospfAsLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostGroup2=ospfHostGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfMulticastExtensions=ospfMulticastExtensions, ospfSpfRuns=ospfSpfRuns, ospfAdminStat=ospfAdminStat, ospfIfAdminStat=ospfIfAdminStat, ospfAddressLessIf=ospfAddressLessIf, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricTable=ospfIfMetricTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbType=ospfExtLsdbType, ospfNbrGroup=ospfNbrGroup, UpToMaxAge=UpToMaxAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbTable=ospfLsdbTable, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaGroup2=ospfAreaGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfRxNewLsas=ospfRxNewLsas, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVersionNumber=ospfVersionNumber, PYSNMP_MODULE_ID=ospf, ospfHostMetric=ospfHostMetric, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfIpAddress=ospfIfIpAddress, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaSummary=ospfAreaSummary, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLsdbSequence=ospfLsdbSequence, ospfCompliances=ospfCompliances, ospfIfStatus=ospfIfStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRouteGroup=ospfRouteGroup, ospfIntraArea=ospfIntraArea, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfRouterId=ospfRouterId, RouterID=RouterID, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfDemand=ospfIfDemand, ospfAreaTable=ospfAreaTable, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfGroups=ospfGroups, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrState=ospfNbrState, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubStatus=ospfStubStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfLsdbAge=ospfLsdbAge, PositiveInteger=PositiveInteger, ospfStubMetric=ospfStubMetric, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfCompliance=ospfCompliance, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfDemandExtensions=ospfDemandExtensions, ospfIfEntry=ospfIfEntry, ospfHostIpAddress=ospfHostIpAddress, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAsLsaCount=ospfAsLsaCount, ospfIfGroup2=ospfIfGroup2, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfType=ospfIfType, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrOptions=ospfNbrOptions, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfState=ospfIfState, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaEntry=ospfAreaEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfConformance=ospfConformance, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, TOSType=TOSType, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostTOS=ospfHostTOS, ospfInterArea=ospfInterArea, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrTable=ospfNbrTable, ospfIfEvents=ospfIfEvents, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfState=ospfVirtIfState, HelloRange=HelloRange, ospfStubAreaEntry=ospfStubAreaEntry, ospfRestartSupport=ospfRestartSupport, ospfStubTOS=ospfStubTOS, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrGroup2=ospfVirtNbrGroup2, BigMetric=BigMetric, ospfExternLsaCount=ospfExternLsaCount, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaId=ospfAreaId, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostEntry=ospfHostEntry, ospfHostStatus=ospfHostStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfImportAsExtern=ospfImportAsExtern, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfRestartInterval=ospfRestartInterval, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostGroup=ospfHostGroup, Metric=Metric, ospfVirtIfTable=ospfVirtIfTable, ospfHostTable=ospfHostTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfGroup=ospfIfGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfCompliance2=ospfCompliance2, ospfNbrEvents=ospfNbrEvents, ospfBasicGroup=ospfBasicGroup, Status=Status, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfTransitDelay=ospfIfTransitDelay, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, OspfAuthenticationType=OspfAuthenticationType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbTable=ospfAsLsdbTable, ospf=ospf, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfHelloInterval=ospfIfHelloInterval, ospfExternalType1=ospfExternalType1, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRestartAge=ospfRestartAge, ospfIfMetricStatus=ospfIfMetricStatus, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, AreaID=AreaID, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAuthType=ospfAuthType, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrPriority=ospfNbrPriority, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbType=ospfLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2)
