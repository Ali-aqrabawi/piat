...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-SNA-LLC-MIB
...
TimeStamp, TextualConvention, MacAddress, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "MacAddress", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CISCO-SNA-LLC-MIB", llcPortAdminMaxUnackedIPDUsSend=llcPortAdminMaxUnackedIPDUsSend, llcPortAdminTable=llcPortAdminTable, llcCcOperRejTimer=llcCcOperRejTimer, llcCcOperCreateTime=llcCcOperCreateTime, llcCcStatsIFramesOut=llcCcStatsIFramesOut, llcCcOperMaxIPDUOctetsRcv=llcCcOperMaxIPDUOctetsRcv, llcCcOperLastFailCause=llcCcOperLastFailCause, llcSapStatsTable=llcSapStatsTable, llcSapAdminMaxUnackedIPDUsSend=llcSapAdminMaxUnackedIPDUsSend, llcCcRSap=llcCcRSap, llcCcStatsREJsOut=llcCcStatsREJsOut, llcCcGroup=llcCcGroup, llcSapStatsREJsOut=llcSapStatsREJsOut, llcCcOperPbitTimer=llcCcOperPbitTimer, llcSapOperTable=llcSapOperTable, llcPortAdminInactTimer=llcPortAdminInactTimer, llcCoreCompliance=llcCoreCompliance, llcCcAdminInactTimer=llcCcAdminInactTimer, llcSapAdminEntry=llcSapAdminEntry, llcSapStatsTESTResponsesIn=llcSapStatsTESTResponsesIn, llcSapStatsDisconnectFRMRRcv=llcSapStatsDisconnectFRMRRcv, llcSapStatsSABMEsInABM=llcSapStatsSABMEsInABM, llcCcOperMaxUnackedIPDUsSend=llcCcOperMaxUnackedIPDUsSend, llcCcOperMaxIPDUOctetsSend=llcCcOperMaxIPDUOctetsSend, llcSapOperEntry=llcSapOperEntry, llcPortStatsPDUsIn=llcPortStatsPDUsIn, llcSapStatsXIDCommandsOut=llcSapStatsXIDCommandsOut, PYSNMP_MODULE_ID=ciscoSnaLlcMIB, llcPortStatsTESTResponsesOut=llcPortStatsTESTResponsesOut, llcCoreCcGroup=llcCoreCcGroup, llcCcAdminDelayAckCount=llcCcAdminDelayAckCount, llcPortGroup=llcPortGroup, llcCcStatsLocalBusies=llcCcStatsLocalBusies, llcCcStatsIOctetsOut=llcCcStatsIOctetsOut, llcCcOperEntry=llcCcOperEntry, llcPortAdminBusyTimer=llcPortAdminBusyTimer, llcSapStatsDMsInABM=llcSapStatsDMsInABM, llcSapStatsSFramesIn=llcSapStatsSFramesIn, llcCcAdminNw=llcCcAdminNw, llcSapStatsREJsIn=llcSapStatsREJsIn, llcCoreSapGroup=llcCoreSapGroup, llcCcOperTable=llcCcOperTable, llcPortOperEntry=llcPortOperEntry, llcSapStatsLocalBusies=llcSapStatsLocalBusies, llcSapStatsDisconnectTimer=llcSapStatsDisconnectTimer, llcSapAdminNw=llcSapAdminNw, llcCcStatsTable=llcCcStatsTable, llcSapStatsIFramesOut=llcSapStatsIFramesOut, llcPortAdminRejTimer=llcPortAdminRejTimer, llcPortAdminMaxRetransmits=llcPortAdminMaxRetransmits, llcCcAdminRejTimer=llcCcAdminRejTimer, ciscoSnaLlcMIBObjects=ciscoSnaLlcMIBObjects, llcSapStatsXIDResponsesIn=llcSapStatsXIDResponsesIn, llcCcAdminMaxUnackedIPDUsRcv=llcCcAdminMaxUnackedIPDUsRcv, llcCcOperLastFailTime=llcCcOperLastFailTime, llcSapAdminPbitTimer=llcSapAdminPbitTimer, llcCcAdminBounce=llcCcAdminBounce, llcSapStatsIFramesIn=llcSapStatsIFramesIn, llcPortStatsTable=llcPortStatsTable, llcCcAdminMaxRetransmits=llcCcAdminMaxRetransmits, llcCcAdminBusyTimer=llcCcAdminBusyTimer, llcCcOperLastWwCause=llcCcOperLastWwCause, llcSapStatsEntry=llcSapStatsEntry, llcSapStatsUIOctetsIn=llcSapStatsUIOctetsIn, llcCcStatsRetransmitsOut=llcCcStatsRetransmitsOut, snaLlcMIBConformance=snaLlcMIBConformance, llcPortAdminMaxUnackedIPDUsRcv=llcPortAdminMaxUnackedIPDUsRcv, llcSapOperHiWaterNumCcs=llcSapOperHiWaterNumCcs, llcPortAdminAckTimer=llcPortAdminAckTimer, llcCcAdminTable=llcCcAdminTable, llcSapNumber=llcSapNumber, llcCcAdminDelayAckTimer=llcCcAdminDelayAckTimer, llcPortStatsOctetsIn=llcPortStatsOctetsIn, llcSapStatsWwCount=llcSapStatsWwCount, llcSapAdminDelayAckCount=llcSapAdminDelayAckCount, llcSapStatsRemoteBusies=llcSapStatsRemoteBusies, llcCcStatsREJsIn=llcCcStatsREJsIn, llcPortAdminMaxCcs=llcPortAdminMaxCcs, llcPortStatsPDUsOut=llcPortStatsPDUsOut, llcCcOperMaxUnackedIPDUsRcv=llcCcOperMaxUnackedIPDUsRcv, llcCcAdminPbitTimer=llcCcAdminPbitTimer, snaLlcMIBNotifications=snaLlcMIBNotifications, llcSapStatsUIFramesOut=llcSapStatsUIFramesOut, llcSapStatsTESTCommandsIn=llcSapStatsTESTCommandsIn, llcPortAdminMaxSaps=llcPortAdminMaxSaps, llcCcOperNw=llcCcOperNw, llcPortOperHiWaterNumSaps=llcPortOperHiWaterNumSaps, llcSapStatsTESTResponsesOut=llcSapStatsTESTResponsesOut, llcSapAdminAckTimer=llcSapAdminAckTimer, llcCcOperLastModifyTime=llcCcOperLastModifyTime, llcSapStatsTESTCommandsOut=llcSapStatsTESTCommandsOut, llcSapStatsIOctetsOut=llcSapStatsIOctetsOut, llcSapStatsConnectOk=llcSapStatsConnectOk, llcPortStatsTESTCommandsIn=llcPortStatsTESTCommandsIn, snaLlcMIBNotificationPrefix=snaLlcMIBNotificationPrefix, llcPortOperLastModifyTime=llcPortOperLastModifyTime, llcCcStatsWwCount=llcCcStatsWwCount, llcPortOperTable=llcPortOperTable, llcPortStatsEntry=llcPortStatsEntry, llcSapGroup=llcSapGroup, llcCcAdminRowStatus=llcCcAdminRowStatus, llcCcRMac=llcCcRMac, llcSapStatsXIDResponsesOut=llcSapStatsXIDResponsesOut, llcSapAdminInactTimer=llcSapAdminInactTimer, llcPortVirtualIndex=llcPortVirtualIndex, llcCcStatsSFramesIn=llcCcStatsSFramesIn, llcPortOperSimRim=llcPortOperSimRim, llcSapStatsConnectFail=llcSapStatsConnectFail, llcSapAdminTable=llcSapAdminTable, llcSapAdminRejTimer=llcSapAdminRejTimer, snaLlcMIBGroups=snaLlcMIBGroups, llcSapAdminMaxRetransmits=llcSapAdminMaxRetransmits, llcSapStatsUIOctetsOut=llcSapStatsUIOctetsOut, llcPortAdminPbitTimer=llcPortAdminPbitTimer, llcPortOperNumSaps=llcPortOperNumSaps, llcCcStatsSFramesOut=llcCcStatsSFramesOut, llcPortAdminEntry=llcPortAdminEntry, snaLlcMIBCompliances=snaLlcMIBCompliances, llcCcOperLastFailFRMRInfo=llcCcOperLastFailFRMRInfo, llcCcStatsRemoteBusies=llcCcStatsRemoteBusies, llcSapAdminMaxUnackedIPDUsRcv=llcSapAdminMaxUnackedIPDUsRcv, llcCcStatsEntry=llcCcStatsEntry, llcSapStatsSFramesOut=llcSapStatsSFramesOut, llcSapStatsXIDCommandsIn=llcSapStatsXIDCommandsIn, llcCcOperWw=llcCcOperWw, llcPortAdminMaxPDUOctets=llcPortAdminMaxPDUOctets, llcCcOperDelayAckCount=llcCcOperDelayAckCount, llcSapOperStatus=llcSapOperStatus, llcSapStatsDisconnectFRMRSend=llcSapStatsDisconnectFRMRSend, llcCcOperState=llcCcOperState, llcCcStatsIOctetsIn=llcCcStatsIOctetsIn, llcPortStatsUnknownSaps=llcPortStatsUnknownSaps, llcCcAdminAckTimer=llcCcAdminAckTimer, llcSapStatsDisconnect=llcSapStatsDisconnect, llcPortStatsLocalBusies=llcPortStatsLocalBusies, llcSapStatsUIFramesIn=llcSapStatsUIFramesIn, llcPortAdminDelayAckTimer=llcPortAdminDelayAckTimer, llcCcOperBusyTimer=llcCcOperBusyTimer, llcPortAdminName=llcPortAdminName, llcCcOperDelayAckTimer=llcCcOperDelayAckTimer, llcSapAdminBusyTimer=llcSapAdminBusyTimer, llcPortOperMacAddress=llcPortOperMacAddress, llcSapAdminDelayAckTimer=llcSapAdminDelayAckTimer, llcSapOperLlc2Support=llcSapOperLlc2Support, llcSapOperNumCcs=llcSapOperNumCcs, llcSapStatsIOctetsIn=llcSapStatsIOctetsIn, llcSapStatsRetransmitsOut=llcSapStatsRetransmitsOut, llcCorePortGroup=llcCorePortGroup, llcCcAdminEntry=llcCcAdminEntry, llcPortAdminNw=llcPortAdminNw, ciscoSnaLlcMIB=ciscoSnaLlcMIB, llcCcStatusChange=llcCcStatusChange, llcSapAdminMaxPDUOctets=llcSapAdminMaxPDUOctets, llcPortStatsOctetsOut=llcPortStatsOctetsOut, llcPortAdminDelayAckCount=llcPortAdminDelayAckCount, llcCcAdminMaxUnackedIPDUsSend=llcCcAdminMaxUnackedIPDUsSend, llcCcAdminMaxPDUOctets=llcCcAdminMaxPDUOctets, llcCcOperInactTimer=llcCcOperInactTimer, llcCcOperAckTimer=llcCcOperAckTimer, llcCcStatsIFramesIn=llcCcStatsIFramesIn, llcCcOperMaxRetransmits=llcCcOperMaxRetransmits)
