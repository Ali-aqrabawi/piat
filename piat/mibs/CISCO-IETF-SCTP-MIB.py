...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IETF-SCTP-MIB
...
mibBuilder.exportSymbols("CISCO-IETF-SCTP-MIB", cSctpStatRecCtrlChunks=cSctpStatRecCtrlChunks, cSctpAssocRemAddressMaxPathRtx=cSctpAssocRemAddressMaxPathRtx, cSctpMaxInitRetr=cSctpMaxInitRetr, cSctpObjects=cSctpObjects, cSctpStatFragmentedUsrMessages=cSctpStatFragmentedUsrMessages, cSctpGroups=cSctpGroups, cSctpCurrEstab=cSctpCurrEstab, cSctpStatRecOrderChunks=cSctpStatRecOrderChunks, cSctpRtoMin=cSctpRtoMin, cSctpRtoAlgorithm=cSctpRtoAlgorithm, cSctpLookupRemHostNameTable=cSctpLookupRemHostNameTable, cSctpStatRecUnorderChunks=cSctpStatRecUnorderChunks, cSctpAssocRemHostName=cSctpAssocRemHostName, cSctpLookupRemPortTable=cSctpLookupRemPortTable, cSctpLookupRemPrimIPAddrEntry=cSctpLookupRemPrimIPAddrEntry, cSctpLookupRemIPAddrStartTime=cSctpLookupRemIPAddrStartTime, cSctpAssocLocalAddressEntry=cSctpAssocLocalAddressEntry, cSctpAssocLocalAddressStartTime=cSctpAssocLocalAddressStartTime, cSctpLookupRemHostNameEntry=cSctpLookupRemHostNameEntry, cSctpLookupRemIPAddrTable=cSctpLookupRemIPAddrTable, cSctpAssocTablesVariablesGroup=cSctpAssocTablesVariablesGroup, cSctpAssocLocalAddressIP=cSctpAssocLocalAddressIP, cSctpRtoMax=cSctpRtoMax, cSctpLookupRemIPAddrEntry=cSctpLookupRemIPAddrEntry, cSctpInverseGroup=cSctpInverseGroup, cSctpCompliances=cSctpCompliances, cSctpStatSentSCTPPacks=cSctpStatSentSCTPPacks, cSctpStateStatGroup=cSctpStateStatGroup, cSctpMIB=cSctpMIB, cSctpAssocMaxRetr=cSctpAssocMaxRetr, cSctpStatRecSCTPPacks=cSctpStatRecSCTPPacks, cSctpAssocRemSCTPPort=cSctpAssocRemSCTPPort, cSctpAssocRemAddressIPType=cSctpAssocRemAddressIPType, cSctpStatSentOrderChunks=cSctpStatSentOrderChunks, cSctpAssocT1expireds=cSctpAssocT1expireds, cSctpAssocOutStreams=cSctpAssocOutStreams, cSctpAssocStartTime=cSctpAssocStartTime, cSctpLookupRemPrimIPAddrTable=cSctpLookupRemPrimIPAddrTable, cSctpAssocStatGroup=cSctpAssocStatGroup, InetPortNumber=InetPortNumber, cSctpScalars=cSctpScalars, cSctpAssocRemAddressTable=cSctpAssocRemAddressTable, cSctpOtherStatGroup=cSctpOtherStatGroup, PYSNMP_MODULE_ID=cSctpMIB, cSctpAssocRemPrimaryAddressType=cSctpAssocRemPrimaryAddressType, cSctpActiveEstabs=cSctpActiveEstabs, cSctpCompliance=cSctpCompliance, cSctpAssocTable=cSctpAssocTable, cSctpAssocRemAddressHBFlag=cSctpAssocRemAddressHBFlag, cSctpAssocId=cSctpAssocId, cSctpAssocLocalAddressIPType=cSctpAssocLocalAddressIPType, cSctpLookupRemHostNameStartTime=cSctpLookupRemHostNameStartTime, cSctpAssocLocalAddressTable=cSctpAssocLocalAddressTable, cSctpAssocRemAddressIP=cSctpAssocRemAddressIP, cSctpAborteds=cSctpAborteds, cSctpAssocHeartBeatTimer=cSctpAssocHeartBeatTimer, cSctpStatChecksumErrors=cSctpStatChecksumErrors, cSctpGeneralVariablesGroup=cSctpGeneralVariablesGroup, cSctpMaxAssoc=cSctpMaxAssoc, cSctpAssocRemPrimaryAddress=cSctpAssocRemPrimaryAddress, cSctpLookupLocalPortEntry=cSctpLookupLocalPortEntry, cSctpLookupRemPortStartTime=cSctpLookupRemPortStartTime, cSctpAssocRemAddressStatus=cSctpAssocRemAddressStatus, cSctpValCookieLife=cSctpValCookieLife, cSctpAssocRemAddressEntry=cSctpAssocRemAddressEntry, cSctpStatSentUnorderChunks=cSctpStatSentUnorderChunks, cSctpLookupLocalPortStartTime=cSctpLookupLocalPortStartTime, cSctpConformance=cSctpConformance, cSctpRtoInitial=cSctpRtoInitial, cSctpShutdowns=cSctpShutdowns, cSctpAssocT2expireds=cSctpAssocT2expireds, cSctpAssocEntry=cSctpAssocEntry, cSctpAssocState=cSctpAssocState, cSctpLookupRemPrimIPAddrStartTime=cSctpLookupRemPrimIPAddrStartTime, cSctpStatOutOfBlues=cSctpStatOutOfBlues, cSctpStatSentCtrlChunks=cSctpStatSentCtrlChunks, cSctpAssocRemAddressStartTime=cSctpAssocRemAddressStartTime, cSctpAssocInStreams=cSctpAssocInStreams, cSctpAssocLocalSCTPPort=cSctpAssocLocalSCTPPort, cSctpLookupLocalPortTable=cSctpLookupLocalPortTable, cSctpLookupRemPortEntry=cSctpLookupRemPortEntry, cSctpPassiveEstabs=cSctpPassiveEstabs, cSctpTables=cSctpTables, cSctpAssocRtxChunks=cSctpAssocRtxChunks, cSctpStatReassembledUsrMessages=cSctpStatReassembledUsrMessages, cSctpAssocRemAddressRtx=cSctpAssocRemAddressRtx, cSctpAssocRemAddressRTO=cSctpAssocRemAddressRTO)
