...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-PRIVATE-VLAN-MIB
...
Gauge32, Unsigned32, Bits, ModuleIdentity, TimeTicks, Counter32, Counter64, IpAddress, MibIdentifier, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Bits", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "IpAddress", "MibIdentifier", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("CISCO-PRIVATE-VLAN-MIB", cpvlanVlanObjects=cpvlanVlanObjects, cpvlanSVIMappingTable=cpvlanSVIMappingTable, cpvlanVlanEditAssocPrimaryVlan=cpvlanVlanEditAssocPrimaryVlan, cpvlanVlanEditEntry=cpvlanVlanEditEntry, ciscoPrivateVlanMIB=ciscoPrivateVlanMIB, cpvlanVlanPrivateVlanType=cpvlanVlanPrivateVlanType, cpvlanPortObjects=cpvlanPortObjects, PrivateVlanType=PrivateVlanType, cpvlanPrivatePortGroup=cpvlanPrivatePortGroup, cpvlanVlanTable=cpvlanVlanTable, cpvlanPortModeTable=cpvlanPortModeTable, cpvlanTrunkPortDynamicState=cpvlanTrunkPortDynamicState, cpvlanTrunkPortTable=cpvlanTrunkPortTable, cpvlanPrivatePortEntry=cpvlanPrivatePortEntry, cpvlanVlanEditTable=cpvlanVlanEditTable, cpvlanSVIObjects=cpvlanSVIObjects, cpvlanSVIMappingGroup=cpvlanSVIMappingGroup, VlanIndexOrZero=VlanIndexOrZero, cpvlanMIBCompliances=cpvlanMIBCompliances, cpvlanVlanEditPrivateVlanType=cpvlanVlanEditPrivateVlanType, cpvlanPromPortEntry=cpvlanPromPortEntry, cpvlanPortMode=cpvlanPortMode, VlanIndexBitmap=VlanIndexBitmap, cpvlanTrunkPortEncapOperType=cpvlanTrunkPortEncapOperType, cpvlanTrunkPortSecondaryVlans2k=cpvlanTrunkPortSecondaryVlans2k, cpvlanSVIMappingPrimarySVI=cpvlanSVIMappingPrimarySVI, cpvlanTrunkPortSecondaryVlans=cpvlanTrunkPortSecondaryVlans, PYSNMP_MODULE_ID=ciscoPrivateVlanMIB, cpvlanVlanEntry=cpvlanVlanEntry, cpvlanSVIMappingVlanIndex=cpvlanSVIMappingVlanIndex, cpvlanPromPortGroup=cpvlanPromPortGroup, cpvlanTrunkPortNormalVlans=cpvlanTrunkPortNormalVlans, cpvlanVlanGroup=cpvlanVlanGroup, cpvlanPromPortSecondaryRemap3k=cpvlanPromPortSecondaryRemap3k, cpvlanMIBObjects=cpvlanMIBObjects, cpvlanPromPort4kGroup=cpvlanPromPort4kGroup, cpvlanVlanAssociatedPrimaryVlan=cpvlanVlanAssociatedPrimaryVlan, cpvlanMIBConformance=cpvlanMIBConformance, cpvlanPromPortSecondaryRemap=cpvlanPromPortSecondaryRemap, cpvlanMIBGroups=cpvlanMIBGroups, cpvlanPrivatePortTable=cpvlanPrivatePortTable, cpvlanPromPortMultiPrimaryVlan=cpvlanPromPortMultiPrimaryVlan, cpvlanTrunkPortEntry=cpvlanTrunkPortEntry, cpvlanPortModeEntry=cpvlanPortModeEntry, cpvlanTrunkPortEncapType=cpvlanTrunkPortEncapType, cpvlanTrunkPortNormalVlans3k=cpvlanTrunkPortNormalVlans3k, cpvlanMIBCompliance=cpvlanMIBCompliance, cpvlanTrunkPortNormalVlans4k=cpvlanTrunkPortNormalVlans4k, cpvlanTrunkPortSecondaryVlans3k=cpvlanTrunkPortSecondaryVlans3k, cpvlanPromPortTwoWayRemapCapable=cpvlanPromPortTwoWayRemapCapable, cpvlanTrunkPortNormalVlans2k=cpvlanTrunkPortNormalVlans2k, cpvlanTrunkPortGroup=cpvlanTrunkPortGroup, cpvlanPortModeGroup=cpvlanPortModeGroup, cpvlanPrivatePortSecondaryVlan=cpvlanPrivatePortSecondaryVlan, cpvlanTrunkPortNativeVlan=cpvlanTrunkPortNativeVlan, cpvlanSVIMappingEntry=cpvlanSVIMappingEntry, cpvlanPromPortSecondaryRemap4k=cpvlanPromPortSecondaryRemap4k, cpvlanPromPortSecondaryRemap2k=cpvlanPromPortSecondaryRemap2k, cpvlanTrunkPortDynamicStatus=cpvlanTrunkPortDynamicStatus, cpvlanTrunkPortSecondaryVlans4k=cpvlanTrunkPortSecondaryVlans4k, cpvlanPromPortTable=cpvlanPromPortTable)
