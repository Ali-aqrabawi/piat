...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-LICENSE-MGMT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:26:49 2019
...
TimeTicks, Bits, iso, Counter64, MibIdentifier, Unsigned32, NotificationType, Integer32, ObjectIdentity, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "iso", "Counter64", "MibIdentifier", "Unsigned32", "NotificationType", "Integer32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32")
DisplayString, RowStatus, TruthValue, TextualConvention, StorageType, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TruthValue", "TextualConvention", "StorageType", "DateAndTime")
...
mibBuilder.exportSymbols("CISCO-LICENSE-MGMT-MIB", clmgmtLicenseServerAddressType=clmgmtLicenseServerAddressType, clmgmtLicenseErrorNotifEnable=clmgmtLicenseErrorNotifEnable, ciscoLicenseMgmtMIBConform=ciscoLicenseMgmtMIBConform, clmgmtFeatureValidityPeriodRemaining=clmgmtFeatureValidityPeriodRemaining, clmgmtLicenseDeploymentGroup=clmgmtLicenseDeploymentGroup, clmgmtLicenseStatus=clmgmtLicenseStatus, clmgmtLicenseErrorNotifGroup=clmgmtLicenseErrorNotifGroup, clmgmtFeatureEndDate=clmgmtFeatureEndDate, clmgmtLicenseIndex=clmgmtLicenseIndex, ciscoLicenseMgmtGroups=ciscoLicenseMgmtGroups, clmgmtFeatureVersion=clmgmtFeatureVersion, clmgmtLicenseActionEntry=clmgmtLicenseActionEntry, clmgmtLicenseStoreTotalSize=clmgmtLicenseStoreTotalSize, clmgmtLicenseCounted=clmgmtLicenseCounted, ciscoLicenseMgmtCompliance=ciscoLicenseMgmtCompliance, clmgmtDevCredServerPassword=clmgmtDevCredServerPassword, ClmgmtLicenseIndexOrZero=ClmgmtLicenseIndexOrZero, clmgmtLicenseAcceptEULA=clmgmtLicenseAcceptEULA, clmgmtLicenseInstalled=clmgmtLicenseInstalled, clmgmtLicenseNotifObjects=clmgmtLicenseNotifObjects, clmgmtDevCredRowStatus=clmgmtDevCredRowStatus, clmgmtLicenseActionStorageType=clmgmtLicenseActionStorageType, clmgmtDevCredExportActionIndex=clmgmtDevCredExportActionIndex, clmgmtFeatureName=clmgmtFeatureName, clmgmtLicenseJobQPosition=clmgmtLicenseJobQPosition, clmgmtDevCredCommandState=clmgmtDevCredCommandState, clmgmtNextFreeDevCredExportActionIndex=clmgmtNextFreeDevCredExportActionIndex, clmgmtFeatureIndex=clmgmtFeatureIndex, clmgmtLicenseDeploymentNotifEnable=clmgmtLicenseDeploymentNotifEnable, clmgmtLicenseActionState=clmgmtLicenseActionState, clmgmtLicenseStopOnFailure=clmgmtLicenseStopOnFailure, clmgmtDevCredServerAddressType=clmgmtDevCredServerAddressType, clmgmtLicenseType=clmgmtLicenseType, clmgmtLicenseFeatureVersion=clmgmtLicenseFeatureVersion, clmgmtDevCredServerUsername=clmgmtDevCredServerUsername, ciscoLicenseMgmtMIBNotifs=ciscoLicenseMgmtMIBNotifs, clmgmtLicenseServerUsername=clmgmtLicenseServerUsername, ClmgmtLicenseActionState=ClmgmtLicenseActionState, clmgmtLicenseFeatureName=clmgmtLicenseFeatureName, clmgmtLicenseSubscriptionExpired=clmgmtLicenseSubscriptionExpired, clmgmtLicenseActionResultTable=clmgmtLicenseActionResultTable, clmgmtLicenseInformationGroup=clmgmtLicenseInformationGroup, clmgmtLicensableFeatureTable=clmgmtLicensableFeatureTable, clmgmtLicenseUsageCountExceeded=clmgmtLicenseUsageCountExceeded, clmgmtLicenseBackupFile=clmgmtLicenseBackupFile, ClmgmtLicenseIndex=ClmgmtLicenseIndex, clmgmtLicenseComments=clmgmtLicenseComments, clmgmtLicenseInformation=clmgmtLicenseInformation, clmgmtLicenseNotEnforced=clmgmtLicenseNotEnforced, clmgmtDevCredCommand=clmgmtDevCredCommand, clmgmtLicenseStoreInfoTable=clmgmtLicenseStoreInfoTable, clmgmtLicenseRTUUsageNotifGroup=clmgmtLicenseRTUUsageNotifGroup, clmgmtLicenseInfoTable=clmgmtLicenseInfoTable, clmgmtLicenseDeviceInfoEntry=clmgmtLicenseDeviceInfoEntry, clmgmtLicenseEULAAccepted=clmgmtLicenseEULAAccepted, clmgmtLicenseActionResultEntry=clmgmtLicenseActionResultEntry, clmgmtLicenseActionFailCause=clmgmtLicenseActionFailCause, clmgmtLicenseExpiredPeriod=clmgmtLicenseExpiredPeriod, clmgmtLicenseUsageNotifEnable=clmgmtLicenseUsageNotifEnable, clmgmtLicenseSubscriptionExpiryWarning=clmgmtLicenseSubscriptionExpiryWarning, ciscoLicenseMgmtMIB=ciscoLicenseMgmtMIB, clmgmtLicenseDeviceInformation=clmgmtLicenseDeviceInformation, clmgmtDevCredEntPhysicalIndex=clmgmtDevCredEntPhysicalIndex, clmgmtLicenseActionIndex=clmgmtLicenseActionIndex, clmgmtLicenseActionTable=clmgmtLicenseActionTable, clmgmtLicenseValidityPeriodRemaining=clmgmtLicenseValidityPeriodRemaining, ciscoLicenseMgmtComplianceRev1=ciscoLicenseMgmtComplianceRev1, clmgmtFeatureStartDate=clmgmtFeatureStartDate, clmgmtLicenseRehostTicketFile=clmgmtLicenseRehostTicketFile, clmgmtLicenseInfoEntry=clmgmtLicenseInfoEntry, clmgmtLicenseMaxUsageCount=clmgmtLicenseMaxUsageCount, clmgmtLicenseExpired=clmgmtLicenseExpired, clmgmtLicenseUsageCountAboutToExceed=clmgmtLicenseUsageCountAboutToExceed, clmgmtDevCredExportFile=clmgmtDevCredExportFile, clmgmtDevCredCommandFailCause=clmgmtDevCredCommandFailCause, clmgmtDevCredServerAddress=clmgmtDevCredServerAddress, clmgmtLicenseActionLicenseIndex=clmgmtLicenseActionLicenseIndex, clmgmtLicenseNumber=clmgmtLicenseNumber, clmgmtLicenseActionEntPhysicalIndex=clmgmtLicenseActionEntPhysicalIndex, clmgmtFeaturePeriodUsed=clmgmtFeaturePeriodUsed, clmgmtLicenseUsageNotifGroup=clmgmtLicenseUsageNotifGroup, clmgmtLicenseRevoked=clmgmtLicenseRevoked, clmgmtLicenseFile=clmgmtLicenseFile, clmgmtDefaultLicenseStore=clmgmtDefaultLicenseStore, clmgmtDevCredExportActionEntry=clmgmtDevCredExportActionEntry, clmgmtLicenseIndivActionFailCause=clmgmtLicenseIndivActionFailCause, clmgmtLicenseStoreSizeRemaining=clmgmtLicenseStoreSizeRemaining, clmgmtLicenseConfiguration=clmgmtLicenseConfiguration, clmgmtLicenseServerPassword=clmgmtLicenseServerPassword, clmgmtLicenseStore=clmgmtLicenseStore, clmgmtLicenseSubscriptionExtExpiryWarning=clmgmtLicenseSubscriptionExtExpiryWarning, clmgmtLicenseServerAddress=clmgmtLicenseServerAddress, clmgmtDevCredTransferProtocol=clmgmtDevCredTransferProtocol, clmgmtLicenseNotificationEnableGroup=clmgmtLicenseNotificationEnableGroup, clmgmtLicensePeriodUsed=clmgmtLicensePeriodUsed, clmgmtNextFreeLicenseActionIndex=clmgmtNextFreeLicenseActionIndex, clmgmtLicenseDeviceInformationGroup=clmgmtLicenseDeviceInformationGroup, clmgmtLicenseStoreIndex=clmgmtLicenseStoreIndex, ClmgmtLicenseActionFailCause=ClmgmtLicenseActionFailCause, clmgmtDevCredExportActionTable=clmgmtDevCredExportActionTable, clmgmtLicenseRTUGroup=clmgmtLicenseRTUGroup, clmgmtLicenseDevCredGroup=clmgmtLicenseDevCredGroup, clmgmtLicenseEULAStatus=clmgmtLicenseEULAStatus, clmgmtLicenseIndivActionState=clmgmtLicenseIndivActionState, clmgmtLicensableFeatureEntry=clmgmtLicensableFeatureEntry, clmgmtLicenseSubscriptionGroup=clmgmtLicenseSubscriptionGroup, clmgmtLicenseActionTransferProtocol=clmgmtLicenseActionTransferProtocol, clmgmtLicenseStartDate=clmgmtLicenseStartDate, clmgmtFeatureWhatIsCounted=clmgmtFeatureWhatIsCounted, clmgmtLicenseExpiryWarning=clmgmtLicenseExpiryWarning, clmgmtLicenseStoreUsed=clmgmtLicenseStoreUsed, clmgmtLicenseStoreName=clmgmtLicenseStoreName, clmgmtLicenseEULAFile=clmgmtLicenseEULAFile, clmgmtDevCredStorageType=clmgmtDevCredStorageType, clmgmtLicenseDeploymentNotifGroup=clmgmtLicenseDeploymentNotifGroup, ciscoLicenseMgmtCompliances=ciscoLicenseMgmtCompliances, clmgmtLicenseValidityPeriod=clmgmtLicenseValidityPeriod, clmgmtLicenseUsageCountRemaining=clmgmtLicenseUsageCountRemaining, clmgmtLicensePermissionTicketFile=clmgmtLicensePermissionTicketFile, ciscoLicenseMgmtMIBObjects=ciscoLicenseMgmtMIBObjects, clmgmtLicenseSubscriptionUsageNotifGroup=clmgmtLicenseSubscriptionUsageNotifGroup, clmgmtLicenseEvalRTUTransitionWarning=clmgmtLicenseEvalRTUTransitionWarning, PYSNMP_MODULE_ID=ciscoLicenseMgmtMIB, clmgmtLicenseEvalRTUTransition=clmgmtLicenseEvalRTUTransition, clmgmtLicenseAction=clmgmtLicenseAction, clmgmtLicenseActionRowStatus=clmgmtLicenseActionRowStatus, clmgmtLicenseStoreInfoEntry=clmgmtLicenseStoreInfoEntry, clmgmtLicensableFeatureInformationGroup=clmgmtLicensableFeatureInformationGroup, ClmgmtLicenseTransferProtocol=ClmgmtLicenseTransferProtocol, clmgmtLicenseStoreInformationGroup=clmgmtLicenseStoreInformationGroup, clmgmtLicenseCleared=clmgmtLicenseCleared, clmgmtLicenseEndDate=clmgmtLicenseEndDate, clmgmtLicenseDeviceInfoTable=clmgmtLicenseDeviceInfoTable)
