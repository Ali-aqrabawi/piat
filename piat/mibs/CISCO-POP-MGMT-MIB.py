...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-POP-MGMT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:25:18 2019
...
Bits, NotificationType, ModuleIdentity, Counter32, iso, ObjectIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, TimeTicks, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ModuleIdentity", "Counter32", "iso", "ObjectIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "TimeTicks", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-POP-MGMT-MIB", cpmDS0BusyoutAdminStatus=cpmDS0BusyoutAdminStatus, cpmActiveCallSummary=cpmActiveCallSummary, cpmOutOctets=cpmOutOctets, cpmComplianceRev2=cpmComplianceRev2, cpmDS0StatusEntry=cpmDS0StatusEntry, cpmDS1UsageGroup=cpmDS1UsageGroup, cpmISDNCfgBChanInUseForAnalog=cpmISDNCfgBChanInUseForAnalog, cpmMIBComplianceRev4=cpmMIBComplianceRev4, cpmISDNCallsRejected=cpmISDNCallsRejected, cpmInOctets=cpmInOctets, cpmDS0UsageTable=cpmDS0UsageTable, cpmDS1DS0UsageEntry=cpmDS1DS0UsageEntry, cpmISDNCallsClearedAbnormally=cpmISDNCallsClearedAbnormally, cpmUserIpAddr=cpmUserIpAddr, cpmMIBGroups=cpmMIBGroups, cpmActiveCallSummaryGroup=cpmActiveCallSummaryGroup, cpmDS0BusyoutSource=cpmDS0BusyoutSource, cpmConfiguredType=cpmConfiguredType, cpmDS0Usage=cpmDS0Usage, cpmRemotePhoneNumber=cpmRemotePhoneNumber, cpmDS1TotalV120Calls=cpmDS1TotalV120Calls, cpmCallDisconnectTimeIndex=cpmCallDisconnectTimeIndex, cpmTTYNumber=cpmTTYNumber, cpmMIBCompliances=cpmMIBCompliances, cpmActiveModemPort=cpmActiveModemPort, cpmActiveEntryChannel=cpmActiveEntryChannel, cpmChannelIndex=cpmChannelIndex, cpmDS1TotalV110Calls=cpmDS1TotalV110Calls, cpmCallVolume=cpmCallVolume, cpmDS1InOctets=cpmDS1InOctets, cpmModemSlot=cpmModemSlot, cpmDS0UsageGroupRev1=cpmDS0UsageGroupRev1, cpmDS0BusyoutNotifyEnable=cpmDS0BusyoutNotifyEnable, cpmDS1OutOctets=cpmDS1OutOctets, cpmISDNCfgBChannelCalls=cpmISDNCfgBChannelCalls, cpmCallStartTimeIndex=cpmCallStartTimeIndex, cpmCallVolumeGroup=cpmCallVolumeGroup, cpmCallVolSuccISDNDigital=cpmCallVolSuccISDNDigital, cpmActiveEntrySlot=cpmActiveEntrySlot, cpmNotificationGroupRev1=cpmNotificationGroupRev1, cpmDS1InPackets=cpmDS1InPackets, cpmISDNCfgBChannelAnalogCalls=cpmISDNCfgBChannelAnalogCalls, cpmActiveUserIpAddr=cpmActiveUserIpAddr, cpmMIBComplianceRev5=cpmMIBComplianceRev5, cpmDS0UsageGroup=cpmDS0UsageGroup, cpmTotalISDNSyncPPPCalls=cpmTotalISDNSyncPPPCalls, cpmDS1CurrentIdle=cpmDS1CurrentIdle, cpmActiveLocalPhoneNumber=cpmActiveLocalPhoneNumber, cpmDS1CurrentOutOfService=cpmDS1CurrentOutOfService, cpmISDNCfgBChanInUseForVoice=cpmISDNCfgBChanInUseForVoice, cpmActiveCallSummaryEntry=cpmActiveCallSummaryEntry, cpmCallCount=cpmCallCount, cpmDS1TotalCalls=cpmDS1TotalCalls, cpmActiveUserID=cpmActiveUserID, cpmDS1PortIndex=cpmDS1PortIndex, cpmDS1LoopbackNotification=cpmDS1LoopbackNotification, cpmCallDuration=cpmCallDuration, cpmCallHistorySummaryTable=cpmCallHistorySummaryTable, cpmDS1TotalDigitalCalls=cpmDS1TotalDigitalCalls, cpmDS0CallType=cpmDS0CallType, cpmActiveModemSlot=cpmActiveModemSlot, cpmL2Encapsulation=cpmL2Encapsulation, cpmActiveCallDuration=cpmActiveCallDuration, cpmCallHistorySummaryIndex=cpmCallHistorySummaryIndex, cpmSystemGroup=cpmSystemGroup, cpmSW56CfgBChannelsInUse=cpmSW56CfgBChannelsInUse, cpmDS0ConfigFunction=cpmDS0ConfigFunction, cpmDS0BusyoutTime=cpmDS0BusyoutTime, cpmActiveCallSummaryIndex=cpmActiveCallSummaryIndex, cpmActiveEntryPort=cpmActiveEntryPort, cpmDS0BusyoutNotification=cpmDS0BusyoutNotification, cpmActiveCallStartTimeIndex=cpmActiveCallStartTimeIndex, cpmISDNCfgBChannelsTimeInUseAnlg=cpmISDNCfgBChannelsTimeInUseAnlg, cpmEntrySlot=cpmEntrySlot, cpmMIBComplianceRev1=cpmMIBComplianceRev1, cpmV120Calls=cpmV120Calls, cpmOutPackets=cpmOutPackets, cpmNotifications=cpmNotifications, cpmModemCallsClearedAbnormally=cpmModemCallsClearedAbnormally, cpmDS1ActiveDS0sHighWaterMark=cpmDS1ActiveDS0sHighWaterMark, cpmLocalPhoneNumber=cpmLocalPhoneNumber, cpmDS0InterfaceIndex=cpmDS0InterfaceIndex, cpmDS0BusyoutStatus=cpmDS0BusyoutStatus, cpmDS0UsageEntry=cpmDS0UsageEntry, cpmActiveTTYNumber=cpmActiveTTYNumber, cpmDS1LoopbackNotifyConfigGroup=cpmDS1LoopbackNotifyConfigGroup, cpmDS0StatusGroup=cpmDS0StatusGroup, cpmMIBConformance=cpmMIBConformance, cpmDS0StatusTable=cpmDS0StatusTable, cpmDS1CurrentBusyout=cpmDS1CurrentBusyout, cpmCallHistorySummaryRetainTimer=cpmCallHistorySummaryRetainTimer, cPopMgmtMIBNotificationPrefix=cPopMgmtMIBNotificationPrefix, cpmCallHistorySummary=cpmCallHistorySummary, cpmModemPort=cpmModemPort, cpmISDNNoResource=cpmISDNNoResource, cpmCallVolAnalogCallClearedNormally=cpmCallVolAnalogCallClearedNormally, cpmInPackets=cpmInPackets, cpmDS1TotalAnalogCalls=cpmDS1TotalAnalogCalls, ciscoPopMgmtMIB=ciscoPopMgmtMIB, cpmCallHistorySummaryEntry=cpmCallHistorySummaryEntry, cpmActiveDS0sHighWaterMark=cpmActiveDS0sHighWaterMark, cpmISDNCfgBChannelsInUse=cpmISDNCfgBChannelsInUse, cpmActiveRemotePhoneNumber=cpmActiveRemotePhoneNumber, cpmDS0BusyoutAllow=cpmDS0BusyoutAllow, cpmCallHistorySummaryTableMaxLength=cpmCallHistorySummaryTableMaxLength, cpmEntryPort=cpmEntryPort, cpmDS1DS0UsageTable=cpmDS1DS0UsageTable, cpmDS1UsageSlotIndex=cpmDS1UsageSlotIndex, cpmNotificationGroup=cpmNotificationGroup, cpmV110Calls=cpmV110Calls, cpmISDNCfgActiveDChannels=cpmISDNCfgActiveDChannels, cpmCallFailure=cpmCallFailure, cpmDS1ActiveDS0s=cpmDS1ActiveDS0s, cpmMIBCompliance=cpmMIBCompliance, cpmDS1UsagePortIndex=cpmDS1UsagePortIndex, cpmCASCfgBChanInUseForVoice=cpmCASCfgBChanInUseForVoice, cpmISDNCfgBChannelsTimeInUse=cpmISDNCfgBChannelsTimeInUse, cpmDS0Status=cpmDS0Status, cpmCallHistorySummaryGroup=cpmCallHistorySummaryGroup, cpmPPPCalls=cpmPPPCalls, cpmCallType=cpmCallType, cpmModemNoResource=cpmModemNoResource, PYSNMP_MODULE_ID=ciscoPopMgmtMIB, cpmActiveCallSummaryTable=cpmActiveCallSummaryTable, cpmActiveCallType=cpmActiveCallType, cpmMIBComplianceRev3=cpmMIBComplianceRev3, cpmEntryChannel=cpmEntryChannel, cpmDS0UsageGroupRev2=cpmDS0UsageGroupRev2, cpmModemCallsRejected=cpmModemCallsRejected, cpmUserID=cpmUserID, cpmDS0OperStatus=cpmDS0OperStatus, cpmDS1SlotIndex=cpmDS1SlotIndex, cpmActiveDS0s=cpmActiveDS0s, cpmTimeInUse=cpmTimeInUse, cpmDS1LoopbackNotifyConfig=cpmDS1LoopbackNotifyConfig, cpmCallFailureGroup=cpmCallFailureGroup, ciscoPopMgmtMIBObjects=ciscoPopMgmtMIBObjects, cpmDS1OutPackets=cpmDS1OutPackets, cpmDS1LoopbackNotifyEnable=cpmDS1LoopbackNotifyEnable, cpmDS1TotalTimeInUse=cpmDS1TotalTimeInUse, cpmAssociatedInterface=cpmAssociatedInterface)
