...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/DIFFSERV-MIB
...
ModuleIdentity, Integer32, NotificationType, Counter32, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, TimeTicks, Bits, IpAddress, mib_2, zeroDotZero, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "NotificationType", "Counter32", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "TimeTicks", "Bits", "IpAddress", "mib-2", "zeroDotZero", "Unsigned32", "MibIdentifier")
StorageType, AutonomousType, TextualConvention, DisplayString, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "StorageType", "AutonomousType", "TextualConvention", "DisplayString", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("DIFFSERV-MIB", diffServActionNextFree=diffServActionNextFree, diffServMinRateTable=diffServMinRateTable, diffServMultiFieldClfrSrcL4PortMin=diffServMultiFieldClfrSrcL4PortMin, diffServTBParamId=diffServTBParamId, diffServSchedulerEntry=diffServSchedulerEntry, diffServRandomDropMaxThreshBytes=diffServRandomDropMaxThreshBytes, diffServQNext=diffServQNext, diffServAlgDropSpecific=diffServAlgDropSpecific, diffServMeterEntry=diffServMeterEntry, diffServMaxRateEntry=diffServMaxRateEntry, diffServQMaxRate=diffServQMaxRate, diffServActionSpecific=diffServActionSpecific, diffServAlgDropTable=diffServAlgDropTable, diffServMeter=diffServMeter, diffServAction=diffServAction, diffServMIBFullCompliance=diffServMIBFullCompliance, diffServMIBAlgDropGroup=diffServMIBAlgDropGroup, diffServSchedulerMethod=diffServSchedulerMethod, diffServMIBCompliances=diffServMIBCompliances, diffServMIBSchedulerGroup=diffServMIBSchedulerGroup, diffServMeterId=diffServMeterId, diffServMultiFieldClfrSrcPrefixLength=diffServMultiFieldClfrSrcPrefixLength, diffServQMinRate=diffServQMinRate, diffServMinRateAbsolute=diffServMinRateAbsolute, diffServMeterStatus=diffServMeterStatus, diffServMIBTBParamGroup=diffServMIBTBParamGroup, diffServMeterSucceedNext=diffServMeterSucceedNext, diffServQId=diffServQId, diffServTBParamSrTCMAware=diffServTBParamSrTCMAware, diffServTBParamStorage=diffServTBParamStorage, diffServClfrElementId=diffServClfrElementId, diffServRandomDropStorage=diffServRandomDropStorage, diffServMaxRateLevel=diffServMaxRateLevel, diffServSchedulerNextFree=diffServSchedulerNextFree, diffServMultiFieldClfrEntry=diffServMultiFieldClfrEntry, diffServMultiFieldClfrNextFree=diffServMultiFieldClfrNextFree, diffServMeterSpecific=diffServMeterSpecific, diffServCountActPkts=diffServCountActPkts, diffServTBParamType=diffServTBParamType, IndexInteger=IndexInteger, diffServMIBQGroup=diffServMIBQGroup, diffServClfrElementStatus=diffServClfrElementStatus, diffServClfrNextFree=diffServClfrNextFree, diffServMinRateId=diffServMinRateId, diffServCountActEntry=diffServCountActEntry, diffServSchedulerPriority=diffServSchedulerPriority, diffServClfrStatus=diffServClfrStatus, diffServTBParamTswTCM=diffServTBParamTswTCM, diffServMeterFailNext=diffServMeterFailNext, diffServMultiFieldClfrDstPrefixLength=diffServMultiFieldClfrDstPrefixLength, diffServAlgDropStorage=diffServAlgDropStorage, diffServMIBAdmin=diffServMIBAdmin, diffServClfrElementNextFree=diffServClfrElementNextFree, diffServMIBMeterGroup=diffServMIBMeterGroup, diffServQNextFree=diffServQNextFree, diffServSchedulerMinRate=diffServSchedulerMinRate, diffServQStorage=diffServQStorage, diffServRandomDropStatus=diffServRandomDropStatus, diffServActionStatus=diffServActionStatus, diffServMinRatePriority=diffServMinRatePriority, diffServSchedulerTable=diffServSchedulerTable, diffServMultiFieldClfrStatus=diffServMultiFieldClfrStatus, diffServClfrElementSpecific=diffServClfrElementSpecific, diffServCountActId=diffServCountActId, diffServDataPathEntry=diffServDataPathEntry, diffServAlgDropNextFree=diffServAlgDropNextFree, diffServClassifier=diffServClassifier, diffServRandomDropMinThreshPkts=diffServRandomDropMinThreshPkts, diffServClfrElementPrecedence=diffServClfrElementPrecedence, diffServTBParam=diffServTBParam, diffServMIBMinRateGroup=diffServMIBMinRateGroup, PYSNMP_MODULE_ID=diffServMib, diffServCountActTable=diffServCountActTable, diffServAlgDropType=diffServAlgDropType, diffServRandomDropEntry=diffServRandomDropEntry, diffServMIBDataPathGroup=diffServMIBDataPathGroup, diffServMultiFieldClfrFlowId=diffServMultiFieldClfrFlowId, diffServClfrStorage=diffServClfrStorage, diffServAlgDropStatus=diffServAlgDropStatus, diffServMaxRateThreshold=diffServMaxRateThreshold, diffServClfrElementEntry=diffServClfrElementEntry, diffServSchedulerStatus=diffServSchedulerStatus, diffServCountActNextFree=diffServCountActNextFree, diffServMIBRandomDropGroup=diffServMIBRandomDropGroup, diffServMinRateStorage=diffServMinRateStorage, diffServClfrElementNext=diffServClfrElementNext, diffServMaxRateRelative=diffServMaxRateRelative, IndexIntegerNextFree=IndexIntegerNextFree, diffServMIBMaxRateGroup=diffServMIBMaxRateGroup, diffServMIBMultiFieldClfrGroup=diffServMIBMultiFieldClfrGroup, diffServCountActOctets=diffServCountActOctets, diffServMultiFieldClfrStorage=diffServMultiFieldClfrStorage, diffServSchedulerStorage=diffServSchedulerStorage, diffServMaxRateStatus=diffServMaxRateStatus, diffServTBParamRate=diffServTBParamRate, diffServActionStorage=diffServActionStorage, diffServAlgDropQMeasure=diffServAlgDropQMeasure, diffServTBParamTable=diffServTBParamTable, diffServMaxRateId=diffServMaxRateId, diffServRandomDropSamplingRate=diffServRandomDropSamplingRate, diffServMultiFieldClfrDscp=diffServMultiFieldClfrDscp, diffServDataPathStorage=diffServDataPathStorage, diffServMinRateNextFree=diffServMinRateNextFree, diffServDscpMarkActTable=diffServDscpMarkActTable, diffServRandomDropProbMax=diffServRandomDropProbMax, diffServDataPathIfDirection=diffServDataPathIfDirection, diffServActionInterface=diffServActionInterface, diffServRandomDropNextFree=diffServRandomDropNextFree, diffServMultiFieldClfrDstL4PortMin=diffServMultiFieldClfrDstL4PortMin, diffServMultiFieldClfrSrcAddr=diffServMultiFieldClfrSrcAddr, diffServAlgDropEntry=diffServAlgDropEntry, diffServMIBReadOnlyCompliance=diffServMIBReadOnlyCompliance, diffServAlgDrop=diffServAlgDrop, diffServAlgDropOctets=diffServAlgDropOctets, diffServSchedulers=diffServSchedulers, diffServMIBClfrGroup=diffServMIBClfrGroup, diffServAlgRandomDropPkts=diffServAlgRandomDropPkts, diffServMeterStorage=diffServMeterStorage, diffServDataPathStart=diffServDataPathStart, diffServMIBConformance=diffServMIBConformance, diffServClfrId=diffServClfrId, diffServMeterNextFree=diffServMeterNextFree, diffServMinRateStatus=diffServMinRateStatus, diffServMIBObjects=diffServMIBObjects, diffServMIBGroups=diffServMIBGroups, diffServDataPathTable=diffServDataPathTable, diffServMinRateRelative=diffServMinRateRelative, diffServTBParamSrTCMBlind=diffServTBParamSrTCMBlind, diffServAlgRandomDropOctets=diffServAlgRandomDropOctets, diffServMaxRateNextFree=diffServMaxRateNextFree, diffServTBParamSimpleTokenBucket=diffServTBParamSimpleTokenBucket, diffServRandomDropId=diffServRandomDropId, diffServTBMeters=diffServTBMeters, diffServActionEntry=diffServActionEntry, diffServRandomDropMinThreshBytes=diffServRandomDropMinThreshBytes, diffServRandomDropTable=diffServRandomDropTable, diffServDataPath=diffServDataPath, diffServMultiFieldClfrSrcL4PortMax=diffServMultiFieldClfrSrcL4PortMax, diffServTBParamTrTCMBlind=diffServTBParamTrTCMBlind, diffServMultiFieldClfrProtocol=diffServMultiFieldClfrProtocol, diffServQStatus=diffServQStatus, diffServQTable=diffServQTable, diffServSchedulerMaxRate=diffServSchedulerMaxRate, diffServAlgDropQThreshold=diffServAlgDropQThreshold, diffServClfrElementStorage=diffServClfrElementStorage, diffServQEntry=diffServQEntry, diffServTBParamBurstSize=diffServTBParamBurstSize, diffServTBParamAvgRate=diffServTBParamAvgRate, diffServMeterTable=diffServMeterTable, diffServSchedulerWFQ=diffServSchedulerWFQ, diffServMIBDscpMarkActGroup=diffServMIBDscpMarkActGroup, diffServActionId=diffServActionId, diffServMIBCounterGroup=diffServMIBCounterGroup, diffServAlgDropPkts=diffServAlgDropPkts, diffServMultiFieldClfrDstAddr=diffServMultiFieldClfrDstAddr, diffServAlgDropId=diffServAlgDropId, diffServTBParamStatus=diffServTBParamStatus, diffServAlgDropNext=diffServAlgDropNext, diffServRandomDropWeight=diffServRandomDropWeight, diffServQueue=diffServQueue, diffServMIBActionGroup=diffServMIBActionGroup, IfDirection=IfDirection, diffServMultiFieldClfrId=diffServMultiFieldClfrId, diffServTBParamEntry=diffServTBParamEntry, diffServActionNext=diffServActionNext, diffServRandomDropMaxThreshPkts=diffServRandomDropMaxThreshPkts, diffServActionTable=diffServActionTable, diffServMinRateEntry=diffServMinRateEntry, diffServMultiFieldClfrAddrType=diffServMultiFieldClfrAddrType, diffServCountActStorage=diffServCountActStorage, diffServMaxRateStorage=diffServMaxRateStorage, diffServDscpMarkActEntry=diffServDscpMarkActEntry, diffServTBParamTrTCMAware=diffServTBParamTrTCMAware, diffServSchedulerWRR=diffServSchedulerWRR, diffServMultiFieldClfrTable=diffServMultiFieldClfrTable, diffServClfrTable=diffServClfrTable, diffServSchedulerId=diffServSchedulerId, diffServClfrElementTable=diffServClfrElementTable, diffServSchedulerNext=diffServSchedulerNext, diffServCountActStatus=diffServCountActStatus, diffServMultiFieldClfrDstL4PortMax=diffServMultiFieldClfrDstL4PortMax, diffServMaxRateAbsolute=diffServMaxRateAbsolute, diffServMib=diffServMib, diffServDataPathStatus=diffServDataPathStatus, diffServTBParamNextFree=diffServTBParamNextFree, diffServMaxRateTable=diffServMaxRateTable, diffServDscpMarkActDscp=diffServDscpMarkActDscp, diffServScheduler=diffServScheduler, diffServClfrEntry=diffServClfrEntry, diffServTBParamInterval=diffServTBParamInterval, diffServMIBClfrElementGroup=diffServMIBClfrElementGroup)
