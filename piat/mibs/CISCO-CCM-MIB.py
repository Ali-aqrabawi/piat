...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CCM-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:41:43 2019
...
Integer32, Unsigned32, Counter32, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, iso, ObjectIdentity, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter32", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "iso", "ObjectIdentity", "Counter64", "Bits")
...
mibBuilder.exportSymbols("CISCO-CCM-MIB", ccmGatekeeperInfo=ccmGatekeeperInfo, ccmNotificationsInfo=ccmNotificationsInfo, ccmRegionIndex=ccmRegionIndex, ccmProductTypeTable=ccmProductTypeTable, ccmCallManagerFailed=ccmCallManagerFailed, ccmPhoneFailed=ccmPhoneFailed, ccmCTIDeviceInetAddressIPv6=ccmCTIDeviceInetAddressIPv6, ccmH323DevRmtCM3InetAddressType=ccmH323DevRmtCM3InetAddressType, ccmMIBNotifications=ccmMIBNotifications, ccmPhoneExtensionTable=ccmPhoneExtensionTable, ccmCTIDeviceTimeLastRegistered=ccmCTIDeviceTimeLastRegistered, ccmSIPDeviceInfoGroupRev2=ccmSIPDeviceInfoGroupRev2, ccmMediaDeviceInetAddressIPv6=ccmMediaDeviceInetAddressIPv6, ccmVoiceMailDeviceInfoGroupRev1=ccmVoiceMailDeviceInfoGroupRev1, ccmGatewayRegFailCauseCode=ccmGatewayRegFailCauseCode, ccmGlobalInfo=ccmGlobalInfo, ccmClusterId=ccmClusterId, ccmPhoneFailedIPv4Attribute=ccmPhoneFailedIPv4Attribute, ccmTimeZoneName=ccmTimeZoneName, ccmEntry=ccmEntry, ccmGatekeeperInetAddress=ccmGatekeeperInetAddress, ccmVMailDevDirNum=ccmVMailDevDirNum, ccmPhoneStatusUpdateTableStateId=ccmPhoneStatusUpdateTableStateId, ccmPhoneFailedInetAddress=ccmPhoneFailedInetAddress, ccmNotificationsInfoGroupRev1=ccmNotificationsInfoGroupRev1, ccmProductType=ccmProductType, ccmTable=ccmTable, ccmPhoneStatusUpdateEntry=ccmPhoneStatusUpdateEntry, ccmTimeZoneIndex=ccmTimeZoneIndex, ccmPhoneInetAddress=ccmPhoneInetAddress, ccmRejectedCTIDevices=ccmRejectedCTIDevices, ccmGatewayFailed=ccmGatewayFailed, ccmVoiceMailDeviceDirNumEntry=ccmVoiceMailDeviceDirNumEntry, ccmH323DeviceInfoGroupRev3=ccmH323DeviceInfoGroupRev3, ciscoCcmMIBObjects=ciscoCcmMIBObjects, ccmGatewayTrunkStatus=ccmGatewayTrunkStatus, ccmPhoneExtension=ccmPhoneExtension, ccmActivePhones=ccmActivePhones, ccmGroupTftpDefault=ccmGroupTftpDefault, ccmGatewayDChannelStatus=ccmGatewayDChannelStatus, ccmCTIDeviceInfoGroupRev2=ccmCTIDeviceInfoGroupRev2, ccmPhoneStatusPhoneIndex=ccmPhoneStatusPhoneIndex, ccmRegionSrcIndex=ccmRegionSrcIndex, ccmPhoneStatusUpdateTable=ccmPhoneStatusUpdateTable, ccmPhoneInfoGroupRev1=ccmPhoneInfoGroupRev1, ccmVoiceMailDeviceInfo=ccmVoiceMailDeviceInfo, ccmVoiceMailDeviceDirNumTable=ccmVoiceMailDeviceDirNumTable, ccmPhoneExtensionEntry=ccmPhoneExtensionEntry, ccmMediaDeviceRegFailReason=ccmMediaDeviceRegFailReason, ccmInfoGroupRev4=ccmInfoGroupRev4, ccmGatewayFailCauseCode=ccmGatewayFailCauseCode, ccmMediaDeviceName=ccmMediaDeviceName, ccmVMailDevRegFailReason=ccmVMailDevRegFailReason, ccmDevicePoolEntry=ccmDevicePoolEntry, ccmVoiceMailDeviceTable=ccmVoiceMailDeviceTable, ccmGatewayName=ccmGatewayName, ccmTLSDevInetAddressType=ccmTLSDevInetAddressType, ccmPhoneUnregReason=ccmPhoneUnregReason, ccmCallManagerStartTime=ccmCallManagerStartTime, ccmPhoneTimeLastError=ccmPhoneTimeLastError, ccmMediaDeviceUnregReason=ccmMediaDeviceUnregReason, ccmGatekeeperTable=ccmGatekeeperTable, ccmGatewayPhysIfL2Status=ccmGatewayPhysIfL2Status, ccmPhoneStatusUpdateReason=ccmPhoneStatusUpdateReason, ccmPhoneInfoGroupRev4=ccmPhoneInfoGroupRev4, ccmInetAddress=ccmInetAddress, ccmPhoneStatus=ccmPhoneStatus, ccmTLSConnFailTime=ccmTLSConnFailTime, ccmCTIDeviceTable=ccmCTIDeviceTable, ccmGatewayTableStateId=ccmGatewayTableStateId, ccmPhoneInetAddressIPv6=ccmPhoneInetAddressIPv6, ccmPhoneFailedRegFailReason=ccmPhoneFailedRegFailReason, ccmPhoneExtnIndex=ccmPhoneExtnIndex, ccmPhFailedTblLastAddedIndex=ccmPhFailedTblLastAddedIndex, ccmCTIDeviceIndex=ccmCTIDeviceIndex, ccmCTIDeviceStatusReason=ccmCTIDeviceStatusReason, ciscoCcmMIBConformance=ciscoCcmMIBConformance, ciscoCcmMIBCompliance=ciscoCcmMIBCompliance, ccmGatewayDevicePoolIndex=ccmGatewayDevicePoolIndex, ccmDevicePoolRegionIndex=ccmDevicePoolRegionIndex, CcmSIPTransportProtocolType=CcmSIPTransportProtocolType, ccmH323DeviceEntry=ccmH323DeviceEntry, ciscoCcmMIBComplianceRev5=ciscoCcmMIBComplianceRev5, ccmH323DevProductTypeIndex=ccmH323DevProductTypeIndex, ccmVMailDevDirNumIndex=ccmVMailDevDirNumIndex, ccmDescription=ccmDescription, ccmSIPDevInetAddress=ccmSIPDevInetAddress, ccmPhoneStatusUnregReason=ccmPhoneStatusUnregReason, ccmGatewayTimeLastRegistered=ccmGatewayTimeLastRegistered, ccmH323DeviceTable=ccmH323DeviceTable, ccmCTIDeviceInfo=ccmCTIDeviceInfo, ccmGatewayInetAddress=ccmGatewayInetAddress, ccmRegisteredVoiceMailDevices=ccmRegisteredVoiceMailDevices, ccmGatekeeperEntry=ccmGatekeeperEntry, ccmH323DevInetAddressType=ccmH323DevInetAddressType, ccmRejectedMediaDevices=ccmRejectedMediaDevices, ciscoCcmMIBCompliances=ciscoCcmMIBCompliances, ccmSIPDeviceInfoGroupRev1=ccmSIPDeviceInfoGroupRev1, ccmGatekeeperDescription=ccmGatekeeperDescription, ccmCTIDeviceInfoGroupRev1=ccmCTIDeviceInfoGroupRev1, ccmPhoneInetAddressType=ccmPhoneInetAddressType, ccmH323DevRmtCM1InetAddress=ccmH323DevRmtCM1InetAddress, ccmVoiceMailDeviceInfoGroupRev2=ccmVoiceMailDeviceInfoGroupRev2, ccmPhoneLoadID=ccmPhoneLoadID, ccmCTIDevicePoolIndex=ccmCTIDevicePoolIndex, ccmSIPDeviceInfoGroup=ccmSIPDeviceInfoGroup, ccmName=ccmName, ccmCTIDeviceDirNumTable=ccmCTIDeviceDirNumTable, ccmH323TableEntries=ccmH323TableEntries, ccmGatekeeperInfoGroup=ccmGatekeeperInfoGroup, ccmPhoneIPv4Attribute=ccmPhoneIPv4Attribute, ccmGatewayInfo=ccmGatewayInfo, ccmPhoneExtnStatus=ccmPhoneExtnStatus, ccmRegisteredPhones=ccmRegisteredPhones, ccmGatewayType=ccmGatewayType, ccmSIPDevInetAddressType=ccmSIPDevInetAddressType, ccmTLSDevName=ccmTLSDevName, ccmVMailDevTimeLastStatusUpdt=ccmVMailDevTimeLastStatusUpdt, ccmStatus=ccmStatus, ccmInfoGroupRev2=ccmInfoGroupRev2, ccmMediaDeviceTable=ccmMediaDeviceTable, ccmNotificationsInfoGroupRev4=ccmNotificationsInfoGroupRev4, ccmMediaDeviceType=ccmMediaDeviceType, ccmMIBNotificationPrefix=ccmMIBNotificationPrefix, ccmPhoneE911Location=ccmPhoneE911Location, ccmGatewayTrunkEntry=ccmGatewayTrunkEntry, ccmPhoneActiveLoadID=ccmPhoneActiveLoadID, ccmUnregisteredVoiceMailDevices=ccmUnregisteredVoiceMailDevices, ccmSIPDevInetAddressIPv4=ccmSIPDevInetAddressIPv4, ccmPhoneInfoGroupRev6=ccmPhoneInfoGroupRev6, ccmPhoneUpdates=ccmPhoneUpdates, ccmCTIDeviceDirNumIndex=ccmCTIDeviceDirNumIndex, ccmPhoneIpAddress=ccmPhoneIpAddress, ccmMediaDeviceDevicePoolIndex=ccmMediaDeviceDevicePoolIndex, CcmIndex=CcmIndex, ccmNotificationsInfoGroupRev2=ccmNotificationsInfoGroupRev2, ccmInetAddress2=ccmInetAddress2, ccmH323DevRmtCM2InetAddressType=ccmH323DevRmtCM2InetAddressType, ccmPhoneInfoGroupRev2=ccmPhoneInfoGroupRev2, ccmPhoneFailedTable=ccmPhoneFailedTable, ccmIndex=ccmIndex, ccmPhoneUserName=ccmPhoneUserName, ccmGatekeeperIndex=ccmGatekeeperIndex, ccmPhoneFailedAlarmInterval=ccmPhoneFailedAlarmInterval, ccmPhoneInfoGroupRev5=ccmPhoneInfoGroupRev5, ccmPhoneFailedInetAddressType=ccmPhoneFailedInetAddressType, ccmGatekeeperType=ccmGatekeeperType, ccmMaliCallCalledDeviceName=ccmMaliCallCalledDeviceName, ccmRegisteredGateways=ccmRegisteredGateways, ccmRegionDestIndex=ccmRegionDestIndex, ccmGatewayDChannelNumber=ccmGatewayDChannelNumber, ccmVMailDevProductId=ccmVMailDevProductId, ccmVMailDevStatusReason=ccmVMailDevStatusReason, ccmMaliCallCallingPartyName=ccmMaliCallCallingPartyName, ccmGatewayEntry=ccmGatewayEntry, ccmPhoneExtensionInetAddressType=ccmPhoneExtensionInetAddressType, ccmCTIDeviceTimeLastStatusUpdt=ccmCTIDeviceTimeLastStatusUpdt, ccmSIPDeviceTable=ccmSIPDeviceTable, ccmH323DevCnfgGKInetAddress=ccmH323DevCnfgGKInetAddress, ccmGatewayInfoGroupRev2=ccmGatewayInfoGroupRev2, ccmPhoneStatusRegFailReason=ccmPhoneStatusRegFailReason, ccmUnregisteredMediaDevices=ccmUnregisteredMediaDevices, ccmH323DevAltGK3InetAddress=ccmH323DevAltGK3InetAddress, ccmAlarmConfigInfo=ccmAlarmConfigInfo, ccmH323DevRmtCM3InetAddress=ccmH323DevRmtCM3InetAddress, ccmPhoneStatusUpdate=ccmPhoneStatusUpdate, ccmMaliCallCallingPartyNumber=ccmMaliCallCallingPartyNumber, ccmPhoneFailedEntry=ccmPhoneFailedEntry, ccmGatewayFailedReason=ccmGatewayFailedReason, ccmH323DevStatus=ccmH323DevStatus, ccmPhoneIndex=ccmPhoneIndex, ccmMediaDeviceInfo=ccmMediaDeviceInfo, ccmMediaDeviceStatusReason=ccmMediaDeviceStatusReason, ccmH323DevAltGK1InetAddressType=ccmH323DevAltGK1InetAddressType, ccmPhoneTable=ccmPhoneTable, ccmH323DevUnregReason=ccmH323DevUnregReason, ccmPhoneType=ccmPhoneType, ccmH323DevAltGK4InetAddressType=ccmH323DevAltGK4InetAddressType, ccmSIPInPortNumber=ccmSIPInPortNumber, ccmPhoneStatusReason=ccmPhoneStatusReason, ccmPhStatUpdtTblLastAddedIndex=ccmPhStatUpdtTblLastAddedIndex, ccmMediaDeviceDescription=ccmMediaDeviceDescription, ccmVMailDevInetAddressType=ccmVMailDevInetAddressType, ccmSIPDeviceEntry=ccmSIPDeviceEntry, ccmCTIDeviceRegFailReason=ccmCTIDeviceRegFailReason, ccmTimeZoneTable=ccmTimeZoneTable, ccmDevicePoolTimeZoneIndex=ccmDevicePoolTimeZoneIndex, ccmGatekeeperDevicePoolIndex=ccmGatekeeperDevicePoolIndex, ccmCTIDeviceInetAddress=ccmCTIDeviceInetAddress, ccmMediaDeviceInetAddress=ccmMediaDeviceInetAddress, ccmPhoneFailedMacAddress=ccmPhoneFailedMacAddress, ccmSystemVersion=ccmSystemVersion, ccmPhoneName=ccmPhoneName, ccmCTIDeviceEntry=ccmCTIDeviceEntry, ccmNotificationsInfoGroup=ccmNotificationsInfoGroup, ccmRejectedPhones=ccmRejectedPhones, ccmPhoneFailedInetAddressIPv4=ccmPhoneFailedInetAddressIPv4, ciscoCcmMIBComplianceRev1=ciscoCcmMIBComplianceRev1, ccmRegionAvailableBandWidth=ccmRegionAvailableBandWidth, ccmGatekeeperInetAddressType=ccmGatekeeperInetAddressType, ccmGatewayDescription=ccmGatewayDescription, ccmMediaResourceListExhausted=ccmMediaResourceListExhausted, ccmSIPDevIndex=ccmSIPDevIndex, ccmH323DevRegFailReason=ccmH323DevRegFailReason, ccmGatewayLayer2Change=ccmGatewayLayer2Change, ccmVMailDevTimeLastRegistered=ccmVMailDevTimeLastRegistered, ccmPhoneTableStateId=ccmPhoneTableStateId, ccmNotificationsGroupRev2=ccmNotificationsGroupRev2, ccmH323DevAltGK2InetAddressType=ccmH323DevAltGK2InetAddressType, ccmSIPDeviceInfo=ccmSIPDeviceInfo, ccmPhoneTimeLastStatusUpdt=ccmPhoneTimeLastStatusUpdt, ccmGatewayTable=ccmGatewayTable, ccmRegionEntry=ccmRegionEntry, ccmRejectedVoiceMailDevices=ccmRejectedVoiceMailDevices, ccmCTIDeviceDirNum=ccmCTIDeviceDirNum, ccmVMailDevDescription=ccmVMailDevDescription, ccmPhoneFailures=ccmPhoneFailures, ccmTLSConnectionFailReasonCode=ccmTLSConnectionFailReasonCode, ccmMediaDeviceInetAddressType=ccmMediaDeviceInetAddressType, ccmPhoneExtnEntry=ccmPhoneExtnEntry, ccmPhoneStatusUpdateType=ccmPhoneStatusUpdateType, ccmPhoneExtnTable=ccmPhoneExtnTable, ccmSIPDevDescription=ccmSIPDevDescription, ccmCTIDeviceInetAddressIPv4=ccmCTIDeviceInetAddressIPv4, ccmCTIDeviceType=ccmCTIDeviceType, ccmInetAddress2Type=ccmInetAddress2Type, ccmCTIDeviceName=ccmCTIDeviceName, ccmH323DevAltGK1InetAddress=ccmH323DevAltGK1InetAddress, ccmH323DeviceInfoGroup=ccmH323DeviceInfoGroup, ccmMaliciousCall=ccmMaliciousCall, ccmGroupIndex=ccmGroupIndex, ccmCTIDeviceStatus=ccmCTIDeviceStatus, ccmMediaResourceType=ccmMediaResourceType, ccmH323DevRmtCM1InetAddressType=ccmH323DevRmtCM1InetAddressType, ccmPhoneDevicePoolIndex=ccmPhoneDevicePoolIndex, ccmCTIDeviceDirNumEntry=ccmCTIDeviceDirNumEntry, ccmCTIDeviceDescription=ccmCTIDeviceDescription, ccmAlarmSeverity=ccmAlarmSeverity, ccmInetAddressType=ccmInetAddressType, ccmProductCategory=ccmProductCategory, CcmDevUnregCauseCode=CcmDevUnregCauseCode, ccmMaliCallTime=ccmMaliCallTime, ccmCTIDeviceInfoGroupRev4=ccmCTIDeviceInfoGroupRev4, ccmRegionName=ccmRegionName, ccmQualityRprtTime=ccmQualityRprtTime, ccmMediaDeviceInfoGroupRev1=ccmMediaDeviceInfoGroupRev1, ccmH323DeviceInfoGroupRev1=ccmH323DeviceInfoGroupRev1, ccmGatewayInetAddressType=ccmGatewayInetAddressType, ccmMediaDeviceStatus=ccmMediaDeviceStatus, ccmDevicePoolTable=ccmDevicePoolTable, ccmH323DevProductId=ccmH323DevProductId, ccmH323DevTimeLastStatusUpdt=ccmH323DevTimeLastStatusUpdt, ccmTimeZoneEntry=ccmTimeZoneEntry, ccmPhoneFailedInetAddressIPv6=ccmPhoneFailedInetAddressIPv6)
mibBuilder.exportSymbols("CISCO-CCM-MIB", ccmQualityRprtSourceDevName=ccmQualityRprtSourceDevName, ccmPhoneFailedName=ccmPhoneFailedName, ccmSIPDevInetAddressIPv6=ccmSIPDevInetAddressIPv6, ccmPhoneExtnInetAddressType=ccmPhoneExtnInetAddressType, ccmGatewayInfoGroupRev1=ccmGatewayInfoGroupRev1, ccmPhoneExtensionIndex=ccmPhoneExtensionIndex, ccmProductTypeEntry=ccmProductTypeEntry, ccmPhoneStatusUpdateIndex=ccmPhoneStatusUpdateIndex, ccmNotificationsInfoGroupRev5=ccmNotificationsInfoGroupRev5, ccmTimeZoneOffsetMinutes=ccmTimeZoneOffsetMinutes, ccmPhoneFailedIPv6Attribute=ccmPhoneFailedIPv6Attribute, ccmMediaDeviceInfoGroupRev3=ccmMediaDeviceInfoGroupRev3, ccmMediaDeviceInfoGroup=ccmMediaDeviceInfoGroup, ccmH323DevAltGK3InetAddressType=ccmH323DevAltGK3InetAddressType, ccmRouteListName=ccmRouteListName, ccmGatewayTrunkInfo=ccmGatewayTrunkInfo, ccmUnregisteredCTIDevices=ccmUnregisteredCTIDevices, ccmPhoneExtnInetAddress=ccmPhoneExtnInetAddress, ccmTimeZoneOffset=ccmTimeZoneOffset, ccmRegionTable=ccmRegionTable, CcmDeviceStatus=CcmDeviceStatus, ccmH323DevAltGK4InetAddress=ccmH323DevAltGK4InetAddress, ccmNotificationsGroupRev3=ccmNotificationsGroupRev3, ccmCMGroupMappingCMPriority=ccmCMGroupMappingCMPriority, ccmVMailDevName=ccmVMailDevName, ccmPhoneInfoGroupRev3=ccmPhoneInfoGroupRev3, ccmMediaDeviceTimeLastRegistered=ccmMediaDeviceTimeLastRegistered, ccmH323DevName=ccmH323DevName, ccmVMailDevStatus=ccmVMailDevStatus, ccmH323DevAltGK2InetAddress=ccmH323DevAltGK2InetAddress, ccmGatewayInfoGroupRev3=ccmGatewayInfoGroupRev3, CcmIndexOrZero=CcmIndexOrZero, ccmCallManagerAlarmEnable=ccmCallManagerAlarmEnable, ccmSIPOutPortNumber=ccmSIPOutPortNumber, CcmPhoneProtocolType=CcmPhoneProtocolType, ciscoCcmMIBComplianceRev7=ciscoCcmMIBComplianceRev7, ccmPhoneFailedStorePeriod=ccmPhoneFailedStorePeriod, ccmNotificationsInfoGroupRev3=ccmNotificationsInfoGroupRev3, ccmVoiceMailDeviceEntry=ccmVoiceMailDeviceEntry, ccmGatewayInfoGroupRev4=ccmGatewayInfoGroupRev4, ccmDevicePoolName=ccmDevicePoolName, ccmGatewayStatusReason=ccmGatewayStatusReason, ccmTimeZoneOffsetHours=ccmTimeZoneOffsetHours, ccmRejectedGateways=ccmRejectedGateways, ciscoCcmMIBComplianceRev4=ciscoCcmMIBComplianceRev4, ccmGroupTable=ccmGroupTable, ccmMaliCallCalledPartyName=ccmMaliCallCalledPartyName, ccmActiveGateways=ccmActiveGateways, ccmSIPTableEntries=ccmSIPTableEntries, ciscoCcmMIBComplianceRev3=ciscoCcmMIBComplianceRev3, ccmDevicePoolIndex=ccmDevicePoolIndex, ccmPhoneLastError=ccmPhoneLastError, ccmGatewayIndex=ccmGatewayIndex, ccmPhoneExtnMultiLines=ccmPhoneExtnMultiLines, ccmPhoneRegFailReason=ccmPhoneRegFailReason, ccmGroupEntry=ccmGroupEntry, ccmVMailDevInetAddress=ccmVMailDevInetAddress, ccmPhoneEntry=ccmPhoneEntry, ccmCTIDeviceTableStateId=ccmCTIDeviceTableStateId, ccmCTIDeviceProductTypeIndex=ccmCTIDeviceProductTypeIndex, ccmH323DevInetAddress=ccmH323DevInetAddress, ccmGatewayProductTypeIndex=ccmGatewayProductTypeIndex, ccmGatewayPhysIfIndex=ccmGatewayPhysIfIndex, ccmTLSConnectionFailure=ccmTLSConnectionFailure, ccmPhoneExtensionTableStateId=ccmPhoneExtensionTableStateId, ccmGatewayRegFailReason=ccmGatewayRegFailReason, ccmPhoneIPv6Attribute=ccmPhoneIPv6Attribute, ccmUnregisteredPhones=ccmUnregisteredPhones, ccmPhoneProtocol=ccmPhoneProtocol, ccmRegionPairEntry=ccmRegionPairEntry, ccmRegionPairTable=ccmRegionPairTable, ccmPhoneFailedIndex=ccmPhoneFailedIndex, ciscoCcmMIBComplianceRev2=ciscoCcmMIBComplianceRev2, ccmQualityReportAlarmEnable=ccmQualityReportAlarmEnable, ccmInstallationId=ccmInstallationId, ccmVMailDevUnregReason=ccmVMailDevUnregReason, ccmPhoneStatusUpdateAlarmInterv=ccmPhoneStatusUpdateAlarmInterv, ccmVersion=ccmVersion, ccmGatewayProductId=ccmGatewayProductId, ccmMediaDeviceTimeLastStatusUpdt=ccmMediaDeviceTimeLastStatusUpdt, ccmSIPDevName=ccmSIPDevName, ccmH323DevCnfgGKInetAddressType=ccmH323DevCnfgGKInetAddressType, ccmH323DevIndex=ccmH323DevIndex, ccmGatewayTimeLastStatusUpdt=ccmGatewayTimeLastStatusUpdt, ccmNotificationsGroupRev1=ccmNotificationsGroupRev1, ccmMediaDeviceInfoGroupRev2=ccmMediaDeviceInfoGroupRev2, ccmPhoneExtensionInetAddress=ccmPhoneExtensionInetAddress, ccmPhoneStatusUpdateTime=ccmPhoneStatusUpdateTime, ccmProductTypeIndex=ccmProductTypeIndex, ccmGatewayTrunkTable=ccmGatewayTrunkTable, ciscoCcmMIBComplianceRev6=ciscoCcmMIBComplianceRev6, CcmDevFailCauseCode=CcmDevFailCauseCode, ccmGroupMappingTable=ccmGroupMappingTable, ccmPhoneExtensionMultiLines=ccmPhoneExtensionMultiLines, ccmH323DevTimeLastRegistered=ccmH323DevTimeLastRegistered, ccmVMailDevIndex=ccmVMailDevIndex, ccmMediaDeviceEntry=ccmMediaDeviceEntry, ccmH323DevStatusReason=ccmH323DevStatusReason, ccmInfoGroup=ccmInfoGroup, ccmNotificationsGroup=ccmNotificationsGroup, ccmGatewayStatus=ccmGatewayStatus, ccmMediaDeviceInetAddressIPv4=ccmMediaDeviceInetAddressIPv4, ccmGroupName=ccmGroupName, ccmPhoneStatusUpdateStorePeriod=ccmPhoneStatusUpdateStorePeriod, ccmSIPDevProductTypeIndex=ccmSIPDevProductTypeIndex, ccmVMailDevProductTypeIndex=ccmVMailDevProductTypeIndex, ccmCTIDeviceAppInfo=ccmCTIDeviceAppInfo, ccmCTIDeviceInetAddressType=ccmCTIDeviceInetAddressType, PYSNMP_MODULE_ID=ciscoCcmMIB, ccmPhoneProductTypeIndex=ccmPhoneProductTypeIndex, ccmMaliciousCallAlarmEnable=ccmMaliciousCallAlarmEnable, ccmQualityReport=ccmQualityReport, ccmGatewayAlarmEnable=ccmGatewayAlarmEnable, ccmRegisteredMediaDevices=ccmRegisteredMediaDevices, ccmGroupMappingEntry=ccmGroupMappingEntry, ccmGatewayInfoGroup=ccmGatewayInfoGroup, ccmGeneralInfo=ccmGeneralInfo, ccmPhoneExtn=ccmPhoneExtn, ccmH323DevAltGK5InetAddress=ccmH323DevAltGK5InetAddress, ccmRouteListExhausted=ccmRouteListExhausted, ccmInActiveGateways=ccmInActiveGateways, ccmH323DevAltGK5InetAddressType=ccmH323DevAltGK5InetAddressType, ccmPhoneInfo=ccmPhoneInfo, ccmPhonePhysicalAddress=ccmPhonePhysicalAddress, ccmPhoneTimeLastRegistered=ccmPhoneTimeLastRegistered, ccmCTIDeviceDirNumTableStateId=ccmCTIDeviceDirNumTableStateId, ccmUnregisteredGateways=ccmUnregisteredGateways, ciscoCcmMIB=ciscoCcmMIB, ccmH323DevDescription=ccmH323DevDescription, ccmMediaDeviceInfoGroupRev4=ccmMediaDeviceInfoGroupRev4, ccmProductName=ccmProductName, ccmQualityRprtClusterId=ccmQualityRprtClusterId, ccmGatekeeperName=ccmGatekeeperName, ccmMaliCallCalledPartyNumber=ccmMaliCallCalledPartyNumber, ccmH323DevRmtCM2InetAddress=ccmH323DevRmtCM2InetAddress, ccmGatekeeperStatus=ccmGatekeeperStatus, ccmPhoneFailedTime=ccmPhoneFailedTime, ccmPhoneInfoGroup=ccmPhoneInfoGroup, ccmCTIDeviceInfoGroup=ccmCTIDeviceInfoGroup, ccmInfoGroupRev1=ccmInfoGroupRev1, ccmSIPOutTransportProtocolType=ccmSIPOutTransportProtocolType, ccmCTIDeviceUnregReason=ccmCTIDeviceUnregReason, ccmRegisteredCTIDevices=ccmRegisteredCTIDevices, ccmQualityRprtReasonCode=ccmQualityRprtReasonCode, ccmGatewayTrunkType=ccmGatewayTrunkType, ccmMediaResourceListName=ccmMediaResourceListName, ciscoCcmMIBGroups=ciscoCcmMIBGroups, ccmMaliCallCallingDeviceName=ccmMaliCallCallingDeviceName, ccmPartiallyRegisteredPhones=ccmPartiallyRegisteredPhones, ccmH323DevActGKInetAddressType=ccmH323DevActGKInetAddressType, ccmPhoneExtensionIpAddress=ccmPhoneExtensionIpAddress, ccmVoiceMailDeviceInfoGroup=ccmVoiceMailDeviceInfoGroup, ccmPhoneFailCauseCode=ccmPhoneFailCauseCode, ccmGatewayTrunkName=ccmGatewayTrunkName, ccmH323DevActGKInetAddress=ccmH323DevActGKInetAddress, ccmCTIDeviceInfoGroupRev3=ccmCTIDeviceInfoGroupRev3, CcmDeviceProductId=CcmDeviceProductId, ccmDevicePoolGroupIndex=ccmDevicePoolGroupIndex, CcmDevRegFailCauseCode=CcmDevRegFailCauseCode, ccmGatewayUnregReason=ccmGatewayUnregReason, ccmTrunkGatewayIndex=ccmTrunkGatewayIndex, ccmSIPInTransportProtocolType=ccmSIPInTransportProtocolType, ccmFailCauseCode=ccmFailCauseCode, ccmQualityReportAlarmConfigInfo=ccmQualityReportAlarmConfigInfo, ccmPhoneInetAddressIPv4=ccmPhoneInetAddressIPv4, ccmGatewayTrunkIndex=ccmGatewayTrunkIndex, ccmH323DeviceInfoGroupRev2=ccmH323DeviceInfoGroupRev2, ccmMediaDeviceProductTypeIndex=ccmMediaDeviceProductTypeIndex, ccmPhoneDescription=ccmPhoneDescription, ccmH323DeviceInfo=ccmH323DeviceInfo, ccmInfoGroupRev3=ccmInfoGroupRev3, ccmMediaDeviceIndex=ccmMediaDeviceIndex, ccmTLSDevInetAddress=ccmTLSDevInetAddress, ccmQualityRprtCategory=ccmQualityRprtCategory, CcmDeviceLineStatus=CcmDeviceLineStatus, ccmInActivePhones=ccmInActivePhones)
