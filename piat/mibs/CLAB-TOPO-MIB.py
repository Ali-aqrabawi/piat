...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CLAB-TOPO-MIB
...
mibBuilder.exportSymbols("CLAB-TOPO-MIB", clabTopoCompliance=clabTopoCompliance, clabTopoFiberNodeCfgRowStatus=clabTopoFiberNodeCfgRowStatus, clabTopoChFnCfgChIfIndex=clabTopoChFnCfgChIfIndex, clabTopoFiberNodeCfgEntry=clabTopoFiberNodeCfgEntry, clabTopoMib=clabTopoMib, clabTopoMibGroups=clabTopoMibGroups, clabTopoFiberNodeCfgTable=clabTopoFiberNodeCfgTable, PYSNMP_MODULE_ID=clabTopoMib, clabTopoChFnCfgEntry=clabTopoChFnCfgEntry, clabTopoChFnCfgTable=clabTopoChFnCfgTable, clabTopoChFnCfgRowStatus=clabTopoChFnCfgRowStatus, clabTopoFiberNodeCfgNodeDescr=clabTopoFiberNodeCfgNodeDescr, clabTopoMibConformance=clabTopoMibConformance, clabTopoGroup=clabTopoGroup, NodeName=NodeName, clabTopoMibCompliances=clabTopoMibCompliances, clabTopoFiberNodeCfgNodeName=clabTopoFiberNodeCfgNodeName, clabTopoMibObjects=clabTopoMibObjects)
