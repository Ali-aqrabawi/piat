...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/ATM2-MIB
...
atmVclVpi, atmInterfaceConfEntry, atmVclEntry, atmVcCrossConnectEntry, atmVclVci, atmVplVpi, atmVpCrossConnectEntry, atmMIBObjects, atmVplEntry = mibBuilder.importSymbols("ATM-MIB", "atmVclVpi", "atmInterfaceConfEntry", "atmVclEntry", "atmVcCrossConnectEntry", "atmVclVci", "atmVplVpi", "atmVpCrossConnectEntry", "atmMIBObjects", "atmVplEntry")
AtmIlmiNetworkPrefix, AtmVcIdentifier, AtmInterfaceType, AtmSigDescrParamIndex, AtmAddr, AtmTrafficDescrParamIndex, AtmVpIdentifier = mibBuilder.importSymbols("ATM-TC-MIB", "AtmIlmiNetworkPrefix", "AtmVcIdentifier", "AtmInterfaceType", "AtmSigDescrParamIndex", "AtmAddr", "AtmTrafficDescrParamIndex", "AtmVpIdentifier")
...
mibBuilder.exportSymbols("ATM2-MIB", atmSigEmitTimerExpireds=atmSigEmitTimerExpireds, atmAal5VclStatEntry=atmAal5VclStatEntry, atmVplStatTotalCellIns=atmVplStatTotalCellIns, atmVcCrossConnectXTable=atmVcCrossConnectXTable, atmInterfaceCurrentMaxSvccVpi=atmInterfaceCurrentMaxSvccVpi, PYSNMP_MODULE_ID=atm2MIB, atmSigDetectClgPtyEvents=atmSigDetectClgPtyEvents, atmIfRegAddrAddress=atmIfRegAddrAddress, atmIfRegAddrAddressSource=atmIfRegAddrAddressSource, atm2MIBGroups=atm2MIBGroups, atmVplStatTable=atmVplStatTable, atmSigSupportHiLyrInfo=atmSigSupportHiLyrInfo, atmInterfaceCurrentMaxSvpcVpi=atmInterfaceCurrentMaxSvpcVpi, atmAddrVclTable=atmAddrVclTable, atmSigDetectMsgErrors=atmSigDetectMsgErrors, atmCommonGroup=atmCommonGroup, atmSvcVpCrossConnectLowIfIndex=atmSvcVpCrossConnectLowIfIndex, atmIlmiSrvcRegParm1=atmIlmiSrvcRegParm1, atmSigSupportBlliRepeatInd=atmSigSupportBlliRepeatInd, atmIlmiSrvcRegRowStatus=atmIlmiSrvcRegRowStatus, atmSwitchAddressRowStatus=atmSwitchAddressRowStatus, atmSigSupportAALInfo=atmSigSupportAALInfo, atmVpCrossConnectXTable=atmVpCrossConnectXTable, atmSigSupportCldPtySubAddr=atmSigSupportCldPtySubAddr, atmIntfActualType=atmIntfActualType, atmCurrentlyFailingPVplTimeStamp=atmCurrentlyFailingPVplTimeStamp, atmVclStatEntry=atmVclStatEntry, atmVclGenTable=atmVclGenTable, atmSigSupportPrefCarrier=atmSigSupportPrefCarrier, atmSvcVcCrossConnectLowVpi=atmSvcVcCrossConnectLowVpi, atmIntfLeafSetupRequests=atmIntfLeafSetupRequests, atmVplStatTotalDiscards=atmVplStatTotalDiscards, atmIntfIlmiConPollInactFactor=atmIntfIlmiConPollInactFactor, atmInterfaceExtTable=atmInterfaceExtTable, atmInterfaceExtEntry=atmInterfaceExtEntry, atmSwitchAddressIndex=atmSwitchAddressIndex, atmIntfIlmiOperStatus=atmIntfIlmiOperStatus, atmSigSSCOPErrdPdus=atmSigSSCOPErrdPdus, atmInterfaceCurrentMinSvccVci=atmInterfaceCurrentMinSvccVci, atmAddrVclVci=atmAddrVclVci, atmAal5VclStatTable=atmAal5VclStatTable, atmSwitchServcSigGroup=atmSwitchServcSigGroup, atmVplStatClp0CellOuts=atmVplStatClp0CellOuts, atmVpCrossConnectUserName=atmVpCrossConnectUserName, atmVplStatClp0CellIns=atmVplStatClp0CellIns, atmVplLogicalPortTable=atmVplLogicalPortTable, atm2MIBTraps=atm2MIBTraps, atmInterfaceConfMinSvccVci=atmInterfaceConfMinSvccVci, atmSigSupportLoLyrInfo=atmSigSupportLoLyrInfo, atmVplStatTotalCellOuts=atmVplStatTotalCellOuts, atmCurrentlyFailingPVplTable=atmCurrentlyFailingPVplTable, atmSvcVcCrossConnectIndex=atmSvcVcCrossConnectIndex, atmAal5VclInOctets=atmAal5VclInOctets, atmVcCrossConnectXEntry=atmVcCrossConnectXEntry, atmSigInEstabls=atmSigInEstabls, atmCurrentlyFailingPVclEntry=atmCurrentlyFailingPVclEntry, atmSwitchAddressEntry=atmSwitchAddressEntry, atmIntfIlmiFsmState=atmIntfIlmiFsmState, atmVclStatClp0Tagged=atmVclStatClp0Tagged, atmAddrVclEntry=atmAddrVclEntry, atmVclStatClp0CellOuts=atmVclStatClp0CellOuts, atmSigDetectCldPtyEvents=atmSigDetectCldPtyEvents, atmSigStatTable=atmSigStatTable, atmSvcVpCrossConnectLowVpi=atmSvcVpCrossConnectLowVpi, atmSigEmitUnavailRoutes=atmSigEmitUnavailRoutes, atmIlmiNetPrefixPrefix=atmIlmiNetPrefixPrefix, atmSigDescrParamBlliPktSize=atmSigDescrParamBlliPktSize, atmVplLogicalPortIndex=atmVplLogicalPortIndex, atmHostGroup=atmHostGroup, atmSvcVcCrossConnectHighVpi=atmSvcVcCrossConnectHighVpi, atm2MIBCompliance=atm2MIBCompliance, atmCurrentlyFailingPVclTable=atmCurrentlyFailingPVclTable, atmSvcVcCrossConnectHighIfIndex=atmSvcVcCrossConnectHighIfIndex, atmSigDescrParamBlliSnapId=atmSigDescrParamBlliSnapId, atmIntfSigVccTxTrafficDescrIndex=atmIntfSigVccTxTrafficDescrIndex, atmSwitchGroup=atmSwitchGroup, atmVclAddrTable=atmVclAddrTable, atmSvcVpCrossConnectEntry=atmSvcVpCrossConnectEntry, atmIntfActualSide=atmIntfActualSide, atmSvcVcCrossConnectLowIfIndex=atmSvcVcCrossConnectLowIfIndex, atmIlmiSrvcRegIndex=atmIlmiSrvcRegIndex, atmAal5VclInPkts=atmAal5VclInPkts, atmSigDescrParamRowStatus=atmSigDescrParamRowStatus, atmAal5VclOutOctets=atmAal5VclOutOctets, atmServcGroup=atmServcGroup, atmPvcTrapsPrefix=atmPvcTrapsPrefix, atmSigDetectTimerExpireds=atmSigDetectTimerExpireds, atmSvcVcCrossConnectRowStatus=atmSvcVcCrossConnectRowStatus, atmSvcVpCrossConnectTable=atmSvcVpCrossConnectTable, atmSigSupportEntry=atmSigSupportEntry, atmIntfCurrentlyFailingPVcls=atmIntfCurrentlyFailingPVcls, atmSigDetectUnavailRoutes=atmSigDetectUnavailRoutes, atmIntfConfigSide=atmIntfConfigSide, atmIlmiSrvcRegTable=atmIlmiSrvcRegTable, atmVpCrossConnectProviderName=atmVpCrossConnectProviderName, atmIlmiNetworkPrefixEntry=atmIlmiNetworkPrefixEntry, atmIlmiSrvcRegEntry=atmIlmiSrvcRegEntry, atmSvcVcCrossConnectHighVci=atmSvcVcCrossConnectHighVci, atmSigDescrParamEntry=atmSigDescrParamEntry, atmSvcVpCrossConnectCreationTime=atmSvcVpCrossConnectCreationTime, atmSigEmitClgPtyEvents=atmSigEmitClgPtyEvents, atmIfRegAddrRowStatus=atmIfRegAddrRowStatus, atm2MIBObjects=atm2MIBObjects, atmAddrVclVpi=atmAddrVclVpi, atmPvcTraps=atmPvcTraps, atmVclStatTotalCellIns=atmVclStatTotalCellIns, atmInterfaceConfMaxSvpcVpi=atmInterfaceConfMaxSvpcVpi, atmInterfaceConfMaxSvccVpi=atmInterfaceConfMaxSvccVpi, atmSwitchServcNotifGroup=atmSwitchServcNotifGroup, atmIntfCurrentlyFailingPVpls=atmIntfCurrentlyFailingPVpls, atmSigDescrParamBlliLayer3=atmSigDescrParamBlliLayer3, atmHostSigDescrGroup=atmHostSigDescrGroup, atmSigDetectRestarts=atmSigDetectRestarts, atmSigDescrParamAalSscsType=atmSigDescrParamAalSscsType, atmVcCrossConnectUserName=atmVcCrossConnectUserName, atmIntfSigVccRxTrafficDescrIndex=atmIntfSigVccRxTrafficDescrIndex, atmSigDetectSetupAttempts=atmSigDetectSetupAttempts, atmIfRegisteredAddrEntry=atmIfRegisteredAddrEntry, atmIlmiSrvcRegServiceID=atmIlmiSrvcRegServiceID, atmSwitchServcGroup=atmSwitchServcGroup, atmSvcVcCrossConnectCreationTime=atmSvcVcCrossConnectCreationTime, atmVplStatClp0Discards=atmVplStatClp0Discards, atmIlmiSrvcRegAddressIndex=atmIlmiSrvcRegAddressIndex, atmSigOutEstabls=atmSigOutEstabls, atmCommonStatsGroup=atmCommonStatsGroup, atmAddrVclAddrType=atmAddrVclAddrType, atmSigSupportClgPtyNumDel=atmSigSupportClgPtyNumDel, atmSigDescrParamBhliType=atmSigDescrParamBhliType, atmIfRegisteredAddrTable=atmIfRegisteredAddrTable, atmVclGenSigDescrIndex=atmVclGenSigDescrIndex, atmIntfPvcFailuresTrapEnable=atmIntfPvcFailuresTrapEnable, atmIlmiSrvcRegATMAddress=atmIlmiSrvcRegATMAddress, atmVclStatTotalCellOuts=atmVclStatTotalCellOuts, atmVplStatEntry=atmVplStatEntry, atmIntfIlmiCheckConPollIntvl=atmIntfIlmiCheckConPollIntvl, atmSigSupportTable=atmSigSupportTable, atmSigDescrParamBhliInfo=atmSigDescrParamBhliInfo, atmSigEmitMsgErrors=atmSigEmitMsgErrors, atmVclStatTable=atmVclStatTable, atmCurrentlyFailingPVclTimeStamp=atmCurrentlyFailingPVclTimeStamp, atmVplLogicalPortEntry=atmVplLogicalPortEntry, atmSvcVpCrossConnectRowStatus=atmSvcVpCrossConnectRowStatus, atmSvcVcCrossConnectLowVci=atmSvcVcCrossConnectLowVci, atmCurrentlyFailingPVplEntry=atmCurrentlyFailingPVplEntry, atmIntfPvcFailures=atmIntfPvcFailures, atmSvcVpCrossConnectIndex=atmSvcVpCrossConnectIndex, atmVcCrossConnectProviderName=atmVcCrossConnectProviderName, atmSvcVcCrossConnectEntry=atmSvcVcCrossConnectEntry, atmAal5VclOutPkts=atmAal5VclOutPkts, atmIntfIlmiPublicPrivateIndctr=atmIntfIlmiPublicPrivateIndctr, atmSigEmitRestarts=atmSigEmitRestarts, atmVclStatClp0CellIns=atmVclStatClp0CellIns, atmSigDescrParamBbcConnConf=atmSigDescrParamBbcConnConf, atmIntfConfigType=atmIntfConfigType, atmVclStatTotalDiscards=atmVclStatTotalDiscards, atmVclAddrAddr=atmVclAddrAddr, atmIfRegAddrOrgScope=atmIfRegAddrOrgScope, atmIntfLeafSetupFailures=atmIntfLeafSetupFailures, atmVclAddrEntry=atmVclAddrEntry, atmSigDescrParamBlliOuiPid=atmSigDescrParamBlliOuiPid, atmIlmiNetPrefixRowStatus=atmIlmiNetPrefixRowStatus, atmSigEmitUnavailResrcs=atmSigEmitUnavailResrcs, atmSigSupportClgPtySubAddr=atmSigSupportClgPtySubAddr, atmSigDescrParamIndex=atmSigDescrParamIndex, atmVplStatClp0Tagged=atmVplStatClp0Tagged, atmSigStatEntry=atmSigStatEntry, atmIntfPvcNotificationInterval=atmIntfPvcNotificationInterval, atmSwitchAddressAddress=atmSwitchAddressAddress, atmVclAddrRowStatus=atmVclAddrRowStatus, atmVclGenEntry=atmVclGenEntry, atmSigDetectUnavailResrcs=atmSigDetectUnavailResrcs, atmSwitchAddressTable=atmSwitchAddressTable, atmSigDescrParamAalType=atmSigDescrParamAalType, atmVclStatClp0Discards=atmVclStatClp0Discards, atmSigEmitCldPtyEvents=atmSigEmitCldPtyEvents, atmSigDescrParamBlliLayer2=atmSigDescrParamBlliLayer2, atmVplLogicalPortDef=atmVplLogicalPortDef, atmSvcVpCrossConnectHighVpi=atmSvcVpCrossConnectHighVpi, atmVpCrossConnectXEntry=atmVpCrossConnectXEntry, atmSvcVpCrossConnectHighIfIndex=atmSvcVpCrossConnectHighIfIndex, atmSigEmitSetupAttempts=atmSigEmitSetupAttempts, atmIntfIlmiEstablishConPollIntvl=atmIntfIlmiEstablishConPollIntvl, atmSigSSCOPConEvents=atmSigSSCOPConEvents, atmIntfPvcFailuresTrap=atmIntfPvcFailuresTrap, atmVclAddrType=atmVclAddrType, atmSvcVcCrossConnectTable=atmSvcVcCrossConnectTable, atm2MIBCompliances=atm2MIBCompliances, atmAddrVclAtmIfIndex=atmAddrVclAtmIfIndex, atmIntfIlmiAdminStatus=atmIntfIlmiAdminStatus, atmIlmiNetworkPrefixTable=atmIlmiNetworkPrefixTable, atm2MIBConformance=atm2MIBConformance, atmSigDescrParamTable=atmSigDescrParamTable, atm2MIB=atm2MIB)
