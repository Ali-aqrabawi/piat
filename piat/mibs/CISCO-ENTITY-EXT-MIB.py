...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ENTITY-EXT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:32:48 2019
...
entPhysicalName, entPhysicalIndex, entPhysicalContainedIn, entPhysicalEntry, entPhysicalDescr = mibBuilder.importSymbols("ENTITY-MIB", "entPhysicalName", "entPhysicalIndex", "entPhysicalContainedIn", "entPhysicalEntry", "entPhysicalDescr")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Integer32, iso, NotificationType, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, Bits, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "NotificationType", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Bits", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-ENTITY-EXT-MIB", ceExtEntityLEDEntry=ceExtEntityLEDEntry, ciscoEntityExtMIBCompliances=ciscoEntityExtMIBCompliances, ciscoEntityExtMIBComplianceRev1=ciscoEntityExtMIBComplianceRev1, ceExtProcessorRam=ceExtProcessorRam, ceExtConfigRegNext=ceExtConfigRegNext, ceExtEntDoorCloseNotif=ceExtEntDoorCloseNotif, ciscoEntityExtMIBComplianceRev6=ciscoEntityExtMIBComplianceRev6, ciscoEntityExtLEDGroup=ciscoEntityExtLEDGroup, BootImageList=BootImageList, ceExtBreakOutPortInserted=ceExtBreakOutPortInserted, ceExtSysBootImageListGroupRev1=ceExtSysBootImageListGroupRev1, ciscoExtEntityPhysicalGroup=ciscoExtEntityPhysicalGroup, ceExtUSBModemTable=ceExtUSBModemTable, ceExtPhyProcessorHCGroup=ceExtPhyProcessorHCGroup, ceExtEntityLEDType=ceExtEntityLEDType, ceExtEntPhysicalEntry=ceExtEntPhysicalEntry, ceExtUSBModemGroup=ceExtUSBModemGroup, ceExtPhysicalProcessorGroup=ceExtPhysicalProcessorGroup, ceExtEntDoorNotifGroup=ceExtEntDoorNotifGroup, ceExtMIBNotificationPrefix=ceExtMIBNotificationPrefix, ceExtNVRAMSize=ceExtNVRAMSize, ceExtPhysicalProcessorEntry=ceExtPhysicalProcessorEntry, ceExtUSBModemPlugInNotif=ceExtUSBModemPlugInNotif, ceExtBreakOutPortNotifGroup=ceExtBreakOutPortNotifGroup, ceExtSysBootImageList=ceExtSysBootImageList, ceExtEntDoorNotifEnable=ceExtEntDoorNotifEnable, ceExtUSBModemIMEI=ceExtUSBModemIMEI, ceExtBreakOutPortNotifControlGroup=ceExtBreakOutPortNotifControlGroup, ceExtEntBreakOutPortNotifEnable=ceExtEntBreakOutPortNotifEnable, ceExtEntityLEDColor=ceExtEntityLEDColor, ceExtUSBModemServiceProvider=ceExtUSBModemServiceProvider, ceExtUSBModemSignalStrength=ceExtUSBModemSignalStrength, ceExtPhyProcessorOverflowGroup=ceExtPhyProcessorOverflowGroup, ceExtNotificationControlObjects=ceExtNotificationControlObjects, ceExtProcessorRamOverflow=ceExtProcessorRamOverflow, ceExtUsbModemNotificationsGroup=ceExtUsbModemNotificationsGroup, ceExtEntUsbModemNotifEnable=ceExtEntUsbModemNotifEnable, ceExtEntDoorOpenNotif=ceExtEntDoorOpenNotif, ceExtConfigRegister=ceExtConfigRegister, ConfigRegisterValue=ConfigRegisterValue, ceExtEntDoorNotifControlGroup=ceExtEntDoorNotifControlGroup, ceExtUSBModemPlugOutNotif=ceExtUSBModemPlugOutNotif, ciscoEntityExtMIBComplianceRev3=ciscoEntityExtMIBComplianceRev3, ciscoEntityExtMIBComplianceRev2=ciscoEntityExtMIBComplianceRev2, ceExtHCProcessorRam=ceExtHCProcessorRam, ciscoEntityExtMIBGroups=ciscoEntityExtMIBGroups, ceExtPhysicalProcessorTable=ceExtPhysicalProcessorTable, ciscoEntityExtMIBComplianceRev4=ciscoEntityExtMIBComplianceRev4, ciscoEntityExtMIBObjects=ciscoEntityExtMIBObjects, ceExtUsbModemNotifControlGroup=ceExtUsbModemNotifControlGroup, ceExtEntPhysicalTable=ceExtEntPhysicalTable, PYSNMP_MODULE_ID=ciscoEntityExtMIB, ceExtUSBModemIMSI=ceExtUSBModemIMSI, ceExtConfigRegTable=ceExtConfigRegTable, ciscoEntityExtMIBConformance=ciscoEntityExtMIBConformance, ceExtConfigRegEntry=ceExtConfigRegEntry, ceEntPhysicalSecondSerialNum=ceEntPhysicalSecondSerialNum, ciscoEntityExtMIBComplianceRev5=ciscoEntityExtMIBComplianceRev5, ceExtSysBootImageListGroup=ceExtSysBootImageListGroup, ciscoEntityExtMIB=ciscoEntityExtMIB, ceExtEntityLEDTable=ceExtEntityLEDTable, ceExtUSBModemEntry=ceExtUSBModemEntry, ciscoEntityExtMIBNotifications=ciscoEntityExtMIBNotifications, ceExtKickstartImageList=ceExtKickstartImageList, ceExtBreakOutPortRemoved=ceExtBreakOutPortRemoved, ciscoEntityExtConfigRegGroup=ciscoEntityExtConfigRegGroup, ciscoEntityExtMIBCompliance=ciscoEntityExtMIBCompliance, ceExtNVRAMUsed=ceExtNVRAMUsed)
