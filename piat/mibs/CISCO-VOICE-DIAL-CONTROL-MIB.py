...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-VOICE-DIAL-CONTROL-MIB
...
cvCommonDcCallHistoryCoderTypeRate, CvcGUid, CvcCoderTypeRate, CvcCallReferenceIdOrZero, CvcInBandSignaling, CvcFaxTransmitRate, CvcSpeechCoderRate = mibBuilder.importSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", "cvCommonDcCallHistoryCoderTypeRate", "CvcGUid", "CvcCoderTypeRate", "CvcCallReferenceIdOrZero", "CvcInBandSignaling", "CvcFaxTransmitRate", "CvcSpeechCoderRate")
DnisMapname, = mibBuilder.importSymbols("CISCO-VOICE-DNIS-MIB", "DnisMapname")
callActivePeerAddress, callActiveSetupTime, AbsoluteCounter32, callActiveIndex, callActivePeerId = mibBuilder.importSymbols("DIAL-CONTROL-MIB", "callActivePeerAddress", "callActiveSetupTime", "AbsoluteCounter32", "callActiveIndex", "callActivePeerId")
...
DisplayString, TimeStamp, RowStatus, TruthValue, DateAndTime, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "TruthValue", "DateAndTime", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("CISCO-VOICE-DIAL-CONTROL-MIB", cvVoIPPeerCfgPoorQoVNotificationEnable=cvVoIPPeerCfgPoorQoVNotificationEnable, cvVoIPCallHistoryCoderTypeRate=cvVoIPCallHistoryCoderTypeRate, cvCallDurationStatsIntvlDurUnits=cvCallDurationStatsIntvlDurUnits, cvCallLegRateStatsIntvlDurUnits=cvCallLegRateStatsIntvlDurUnits, cvPeerCommonCfgIncomingDnisDigits=cvPeerCommonCfgIncomingDnisDigits, cvVoIPCallActivePtime=cvVoIPCallActivePtime, cvVoIPCallActiveRemoteIPAddress=cvVoIPCallActiveRemoteIPAddress, cvCallDurationStatsEntry=cvCallDurationStatsEntry, cvVoicePeerCfgForwardDigits=cvVoicePeerCfgForwardDigits, cvCallHistoryAccountCode=cvCallHistoryAccountCode, cvdcFallbackNotification=cvdcFallbackNotification, cvVoIPCallHistoryRemSigIPAddrT=cvVoIPCallHistoryRemSigIPAddrT, cvPeerCommonCfgApplicationName=cvPeerCommonCfgApplicationName, cvVoicePeerCfgDIDCallEnable=cvVoicePeerCfgDIDCallEnable, cvCallVolConnEntry=cvCallVolConnEntry, cvCallHistoryNoiseLevel=cvCallHistoryNoiseLevel, cvCallRate=cvCallRate, cvVoIPCallHistoryRoundTripDelay=cvVoIPCallHistoryRoundTripDelay, cvPeerCommonCfgTargetTrunkGrpLabel=cvPeerCommonCfgTargetTrunkGrpLabel, cvCallHistoryCallId=cvCallHistoryCallId, cvVoIPCallActiveOctetAligned=cvVoIPCallActiveOctetAligned, cvVoIPCallActiveSessionTarget=cvVoIPCallActiveSessionTarget, cvVoicePeerCfgDialDigitsPrefix=cvVoicePeerCfgDialDigitsPrefix, cvVoicePeerCfgEchoCancellerTest=cvVoicePeerCfgEchoCancellerTest, cvVoIPCallActiveBitRates=cvVoIPCallActiveBitRates, cvdcMIBComplianceRev3=cvdcMIBComplianceRev3, cvdcMIBComplianceRev9=cvdcMIBComplianceRev9, cvVoIPCallHistoryCRC=cvVoIPCallHistoryCRC, cvVoIPPeerCfgOctetAligned=cvVoIPPeerCfgOctetAligned, cvVoIPPeerCfgUDPChecksumEnable=cvVoIPPeerCfgUDPChecksumEnable, cvGeneralDSCPPolicyNotificationEnable=cvGeneralDSCPPolicyNotificationEnable, cvdcVoiceCfgGroup=cvdcVoiceCfgGroup, cvVoIPCallActiveEarlyPackets=cvVoIPCallActiveEarlyPackets, cvVoIPCallActiveGapFillWithPrediction=cvVoIPCallActiveGapFillWithPrediction, cvVoIPCallHistoryRemMediaIPAddr=cvVoIPCallHistoryRemMediaIPAddr, cvCallActiveCoderTypeRate=cvCallActiveCoderTypeRate, cvVoIPPeerCfgTechPrefix=cvVoIPPeerCfgTechPrefix, cvActiveCallWMIndex=cvActiveCallWMIndex, cvVoIPCallActiveRemSigPort=cvVoIPCallActiveRemSigPort, cvVoIPCallHistoryVADEnable=cvVoIPCallHistoryVADEnable, cvActiveCallWMValue=cvActiveCallWMValue, cvCallGroupSup1=cvCallGroupSup1, cvdcPolicyViolationNotification=cvdcPolicyViolationNotification, cvCallRateStatsTable=cvCallRateStatsTable, cvVoIPPeerCfgMinAcceptableQoSVideo=cvVoIPPeerCfgMinAcceptableQoSVideo, cvVoIPCallActiveLostPackets=cvVoIPCallActiveLostPackets, cvdcMIBObjects=cvdcMIBObjects, cvVoIPPeerCfgCoderMode=cvVoIPPeerCfgCoderMode, cvCallActiveAccountCode=cvCallActiveAccountCode, cvVoIPCallGroupRev6=cvVoIPCallGroupRev6, cvGeneralPoorQoVNotificationEnable=cvGeneralPoorQoVNotificationEnable, cvVoIPCallActiveLoWaterPlayoutDelay=cvVoIPCallActiveLoWaterPlayoutDelay, cvGatewayCallHistory=cvGatewayCallHistory, cvdcGeneralCfgGroupRev1=cvdcGeneralCfgGroupRev1, cvActiveCallStatsTable=cvActiveCallStatsTable, cvSipMsgRateWMIndex=cvSipMsgRateWMIndex, cvdcNotificationGroupRev1=cvdcNotificationGroupRev1, cvVoIPCallHistoryRemMediaIPAddrT=cvVoIPCallHistoryRemMediaIPAddrT, cvActiveCallStatsAvgVal=cvActiveCallStatsAvgVal, cvActiveCallWMTable=cvActiveCallWMTable, cvVoIPCallActiveProtocolCallId=cvVoIPCallActiveProtocolCallId, cvVoicePeerCfgEntry=cvVoicePeerCfgEntry, cvCallGroupRev3=cvCallGroupRev3, PYSNMP_MODULE_ID=ciscoVoiceDialControlMIB, cvCallActiveTxDuration=cvCallActiveTxDuration, cvdcMIBNotifications=cvdcMIBNotifications, cvVoIPCallGroupSup1=cvVoIPCallGroupSup1, cvCallRateMonitorTime=cvCallRateMonitorTime, cvdcMIBCompliance=cvdcMIBCompliance, cvdcMIBComplianceRev4=cvdcMIBComplianceRev4, cvVoIPCallHistoryModeChgNeighbor=cvVoIPCallHistoryModeChgNeighbor, cvdcMIBGroups=cvdcMIBGroups, cvPeerCfgPeerType=cvPeerCfgPeerType, cvCallRateStatsIntvlDurUnits=cvCallRateStatsIntvlDurUnits, CvAmrNbRtpEncap=CvAmrNbRtpEncap, cvActiveCallWMEntry=cvActiveCallWMEntry, cvSipMsgRateWMValue=cvSipMsgRateWMValue, cvGeneralConfiguration=cvGeneralConfiguration, cvCallHistoryImgPageCount=cvCallHistoryImgPageCount, cvCallActiveDS0sLowNotifyEnable=cvCallActiveDS0sLowNotifyEnable, cvCallActiveCallingName=cvCallActiveCallingName, cvVoIPCallGroupSup3=cvVoIPCallGroupSup3, cvPeerCfgIfIndex=cvPeerCfgIfIndex, cvVoicePeerCfgCasGroup=cvVoicePeerCfgCasGroup, cvCallVolumeWMTableSize=cvCallVolumeWMTableSize, cvdcVoIPCfgGroupRev3=cvdcVoIPCfgGroupRev3, cvActiveCallWMts=cvActiveCallWMts, cvVoIPPeerCfgDesiredQoS=cvVoIPPeerCfgDesiredQoS, cvCallLegRateWMEntry=cvCallLegRateWMEntry, cvdcMIBComplianceRev13=cvdcMIBComplianceRev13, cvCallLegRateStatsAvgVal=cvCallLegRateStatsAvgVal, cvPeerCommonCfgSourceTrunkGrpLabel=cvPeerCommonCfgSourceTrunkGrpLabel, cvCallHistoryCoderTypeRate=cvCallHistoryCoderTypeRate, cvSipMsgRateStatsEntry=cvSipMsgRateStatsEntry, cvVoIPCallActiveCoderMode=cvVoIPCallActiveCoderMode, cvSipMsgRateWMts=cvSipMsgRateWMts, cvVoIPCallActiveRoundTripDelay=cvVoIPCallActiveRoundTripDelay, cvCallVolConnMaxCallConnectionLicenese=cvCallVolConnMaxCallConnectionLicenese, cvVoIPCallGroupRev4=cvVoIPCallGroupRev4, cvCallActiveCallId=cvCallActiveCallId, cvCallActiveERLLevel=cvCallActiveERLLevel, cvGatewayCallActive=cvGatewayCallActive, cvCallVolIfEntry=cvCallVolIfEntry, cvVoIPCallHistoryTable=cvVoIPCallHistoryTable, cvVoIPPeerCfgInBandSignaling=cvVoIPPeerCfgInBandSignaling, cvActiveCallStatsMaxVal=cvActiveCallStatsMaxVal, cvdcNotificationGroupRev3=cvdcNotificationGroupRev3, cvVoIPCallActiveGapFillWithSilence=cvVoIPCallActiveGapFillWithSilence, cvVoIPCallActiveRobustSorting=cvVoIPCallActiveRobustSorting, cvActiveCallStatsIntvlDurUnits=cvActiveCallStatsIntvlDurUnits, cvCallRateWMIntvlDurUnits=cvCallRateWMIntvlDurUnits, cvCallActiveERLLevelRev1=cvCallActiveERLLevelRev1, ccVoIPCallActivePolicyName=ccVoIPCallActivePolicyName, cvdcMIBComplianceRev18=cvdcMIBComplianceRev18, cvVoIPCallActiveRemSigIPAddrT=cvVoIPCallActiveRemSigIPAddrT, cvdcNotificationGroup=cvdcNotificationGroup, cvCallDurationStatsMaxVal=cvCallDurationStatsMaxVal, cvCallVolume=cvCallVolume, cvVoIPCallActiveMaxPtime=cvVoIPCallActiveMaxPtime, cvVoicePeerCfgSessionTarget=cvVoicePeerCfgSessionTarget, cvVoIPCallActiveSelectedQoS=cvVoIPCallActiveSelectedQoS, cvVoIPCallActiveEncap=cvVoIPCallActiveEncap, cvVoIPPeerCfgMediaSetting=cvVoIPPeerCfgMediaSetting, cvPeer=cvPeer, cvCallDurationStatsAvgVal=cvCallDurationStatsAvgVal, cvVoIPCallHistoryRemSigIPAddr=cvVoIPCallHistoryRemSigIPAddr, cvdcMIBComplianceRev20=cvdcMIBComplianceRev20, cvVoIPCallHistoryRemMediaPort=cvVoIPCallHistoryRemMediaPort, cvVoIPCallHistoryLostPackets=cvVoIPCallHistoryLostPackets, cvVoIPCallHistoryProtocolCallId=cvVoIPCallHistoryProtocolCallId, cvdcMIBComplianceRev19=cvdcMIBComplianceRev19, cvCallActiveImgPageCount=cvCallActiveImgPageCount, cvCallHistoryVoiceTxDuration=cvCallHistoryVoiceTxDuration, cvCallDurationStatsThreshold=cvCallDurationStatsThreshold, cvdcMIBComplianceRev6=cvdcMIBComplianceRev6, cvVoIPCallActiveRemMediaPort=cvVoIPCallActiveRemMediaPort, cvVoIPCallHistoryModeChgPeriod=cvVoIPCallHistoryModeChgPeriod, cvVoIPCallHistoryEarlyPackets=cvVoIPCallHistoryEarlyPackets, CvCallConnectionType=CvCallConnectionType, cvCallHistorySessionTarget=cvCallHistorySessionTarget, cvActiveCallWMIntvlDurUnits=cvActiveCallWMIntvlDurUnits, cvSipMsgRateWMIntvlDurUnits=cvSipMsgRateWMIntvlDurUnits, cvCallDurationStatsTable=cvCallDurationStatsTable, cvPeerCommonCfgTargetCarrierId=cvPeerCommonCfgTargetCarrierId, cvdcMIBComplianceRev21=cvdcMIBComplianceRev21, cvVoIPCallGroupRev5=cvVoIPCallGroupRev5, CvCasGroup=CvCasGroup, cvCallHistoryTable=cvCallHistoryTable, cvCallVolConnActiveConnection=cvCallVolConnActiveConnection, CvCallVolumeStatsIntvlType=CvCallVolumeStatsIntvlType, cvPeerCommonCfgPreference=cvPeerCommonCfgPreference, cvGeneralMediaPolicyNotificationEnable=cvGeneralMediaPolicyNotificationEnable, CvSessionProtocol=CvSessionProtocol, cvVoIPPeerCfgFaxBytes=cvVoIPPeerCfgFaxBytes, cvCallActiveDS0sHighThreshold=cvCallActiveDS0sHighThreshold, cvdcActiveDS0sLowNotification=cvdcActiveDS0sLowNotification, cvVoIPCallHistoryUsername=cvVoIPCallHistoryUsername, cvCallVolConnTotalActiveConnections=cvCallVolConnTotalActiveConnections, cvdcVoIPCfgGroupRev4=cvdcVoIPCfgGroupRev4, cvVoIPCallActiveGapFillWithRedundancy=cvVoIPCallActiveGapFillWithRedundancy, cvVoIPCallGroupRev3=cvVoIPCallGroupRev3, cvVoIPCallHistoryFallbackDelay=cvVoIPCallHistoryFallbackDelay, cvVoIPCallHistoryOctetAligned=cvVoIPCallHistoryOctetAligned, cvVoIPCallActiveUsername=cvVoIPCallActiveUsername, cvCallVolPeerTable=cvCallVolPeerTable, cvdcGeneralCfgGroupRev3=cvdcGeneralCfgGroupRev3, cvdcVoIPCfgGroupRev1=cvdcVoIPCfgGroupRev1, cvPeerCommonCfgTable=cvPeerCommonCfgTable, cvVoIPCallActiveCRC=cvVoIPCallActiveCRC, cvVoIPCallHistoryEntry=cvVoIPCallHistoryEntry, cvVoicePeerCfgTable=cvVoicePeerCfgTable, cvVoIPPeerCfgTable=cvVoIPPeerCfgTable, cvCallVolConnIndex=cvCallVolConnIndex, cvCallRateMonitorEnable=cvCallRateMonitorEnable, cvVoIPCallGroupRev1=cvVoIPCallGroupRev1, cvCallHistoryEntry=cvCallHistoryEntry, cvVoIPCallHistoryCoderMode=cvVoIPCallHistoryCoderMode, cvCallRateMonitor=cvCallRateMonitor, cvdcMIBComplianceRev5=cvdcMIBComplianceRev5, cvCallHistoryCallingName=cvCallHistoryCallingName, cvVoIPPeerCfgSessionProtocol=cvVoIPPeerCfgSessionProtocol, cvVoIPCallHistorySessionTarget=cvVoIPCallHistorySessionTarget, ciscoVoiceDialControlMIB=ciscoVoiceDialControlMIB, cvdcMIBComplianceRev15=cvdcMIBComplianceRev15, cvVoIPPeerCfgCRC=cvVoIPPeerCfgCRC, cvdcGeneralCfgGroupRev6=cvdcGeneralCfgGroupRev6, cvVoIPCallHistoryCallReferenceId=cvVoIPCallHistoryCallReferenceId, cvCallActiveConnectionId=cvCallActiveConnectionId, cvCallActiveFaxTxDuration=cvCallActiveFaxTxDuration, cvVoIPCallHistoryRobustSorting=cvVoIPCallHistoryRobustSorting, cvVoIPPeerCfgMediaPolicyNotificationEnable=cvVoIPPeerCfgMediaPolicyNotificationEnable, cvVoIPCallHistorySRTPEnable=cvVoIPCallHistorySRTPEnable, cvCallActiveInSignalLevel=cvCallActiveInSignalLevel, cvPeerCfgRowStatus=cvPeerCfgRowStatus, cvCallVolPeerOutgoingCalls=cvCallVolPeerOutgoingCalls, cvdcMIBCompliances=cvdcMIBCompliances, cvVoIPPeerCfgVADEnable=cvVoIPPeerCfgVADEnable, cvdcVoIPCfgGroupRev2=cvdcVoIPCfgGroupRev2, cvdcGeneralCfgGroupRev2=cvdcGeneralCfgGroupRev2, cvCallVolIfTable=cvCallVolIfTable, cvVoIPPeerCfgDSCPPolicyNotificationEnable=cvVoIPPeerCfgDSCPPolicyNotificationEnable, cvPeerCfgIndex=cvPeerCfgIndex, cvdcMIBComplianceRev17=cvdcMIBComplianceRev17, cvCallRateMonitorGroup=cvCallRateMonitorGroup, cvVoIPCallHistoryInterleaving=cvVoIPCallHistoryInterleaving, cvVoIPPeerCfgBitRates=cvVoIPPeerCfgBitRates, cvCallHistoryTxDuration=cvCallHistoryTxDuration, cvdcNotificationGroupRev2=cvdcNotificationGroupRev2, cvVoIPCallActiveModeChgNeighbor=cvVoIPCallActiveModeChgNeighbor, CvCallVolumeWMIntvlType=CvCallVolumeWMIntvlType, cvCallLegRateWMIntvlDurUnits=cvCallLegRateWMIntvlDurUnits, cvVoIPPeerCfgBitRate=cvVoIPPeerCfgBitRate, cvVoIPCallHistorySelectedQoS=cvVoIPCallHistorySelectedQoS, cvCallGroupRev5=cvCallGroupRev5, cvdcCallVolumeStatsHistory=cvdcCallVolumeStatsHistory, cvVoIPCallActiveCoderTypeRate=cvVoIPCallActiveCoderTypeRate, cvCallLegRateStatsIntvlDur=cvCallLegRateStatsIntvlDur, cvVoIPCallActiveCallId=cvVoIPCallActiveCallId, cvVoIPCallHistoryGapFillWithPrediction=cvVoIPCallHistoryGapFillWithPrediction, cvPeerCfgTable=cvPeerCfgTable, cvVoIPPeerCfgIcpif=cvVoIPPeerCfgIcpif, cvCallGroup=cvCallGroup, cvVoIPCallHistorySessionProtocol=cvVoIPCallHistorySessionProtocol, cvCallGroupRev2=cvCallGroupRev2, cvdcVoIPCfgAmrNbGroup=cvdcVoIPCfgAmrNbGroup, cvCallVolPeerIncomingCalls=cvCallVolPeerIncomingCalls, cvVoIPCallActiveLatePackets=cvVoIPCallActiveLatePackets, cvdcMIBComplianceRev10=cvdcMIBComplianceRev10, cvVoIPPeerCfgExpectFactor=cvVoIPPeerCfgExpectFactor, cvSipMsgRateStatsTable=cvSipMsgRateStatsTable, cvdcMIBComplianceRev22=cvdcMIBComplianceRev22, cvVoIPCallHistoryLatePackets=cvVoIPCallHistoryLatePackets, cvVoIPCallHistoryEncap=cvVoIPCallHistoryEncap, cvdcActiveDS0sHighNotification=cvdcActiveDS0sHighNotification, cvCallActiveVoiceTxDuration=cvCallActiveVoiceTxDuration, cvCallVolumeStatsHistory=cvCallVolumeStatsHistory, cvVoIPCallHistoryChannels=cvVoIPCallHistoryChannels, cvdcNotificationGroupRev4=cvdcNotificationGroupRev4, cvVoIPCallActiveGapFillWithInterpolation=cvVoIPCallActiveGapFillWithInterpolation, cvCallVolMediaIncomingCalls=cvCallVolMediaIncomingCalls, cvVoIPCallHistoryFallbackIcpif=cvVoIPCallHistoryFallbackIcpif, cvVoIPPeerCfgDigitRelay=cvVoIPPeerCfgDigitRelay, cvCallRateStatsIntvlDur=cvCallRateStatsIntvlDur, cvVoIPPeerCfgCoderRate=cvVoIPPeerCfgCoderRate, cvVoIPCallActiveInterleaving=cvVoIPCallActiveInterleaving, cvVoIPCallHistoryRemSigPort=cvVoIPCallHistoryRemSigPort, cvSipMsgRateStatsAvgVal=cvSipMsgRateStatsAvgVal, cvVoIPCallActiveRemoteUDPPort=cvVoIPCallActiveRemoteUDPPort, cvCallLegRateStatsMaxVal=cvCallLegRateStatsMaxVal, cvCallVolMediaOutgoingCalls=cvCallVolMediaOutgoingCalls, cvVoIPCallHistoryRemoteIPAddress=cvVoIPCallHistoryRemoteIPAddress, cvdcVoIPCfgISACGroup=cvdcVoIPCfgISACGroup, cvCallHistoryFaxTxDuration=cvCallHistoryFaxTxDuration, cvVoIPCallActiveRemMediaIPAddr=cvVoIPCallActiveRemMediaIPAddr)
mibBuilder.exportSymbols("CISCO-VOICE-DIAL-CONTROL-MIB", cvPeerCommonCfgSourceCarrierId=cvPeerCommonCfgSourceCarrierId, cvVoIPPeerCfgCodingMode=cvVoIPPeerCfgCodingMode, cvCallGroupRev4=cvCallGroupRev4, cvCallGroupRev1=cvCallGroupRev1, cvCallActiveDS0sHighNotifyEnable=cvCallActiveDS0sHighNotifyEnable, cvCallActiveEcanReflectorLocation=cvCallActiveEcanReflectorLocation, cvCallVolumeGroup=cvCallVolumeGroup, CvIlbcFrameMode=CvIlbcFrameMode, cvCallDurationStatsIntvlDur=cvCallDurationStatsIntvlDur, cvdcVoIPCfgGroup=cvdcVoIPCfgGroup, cvActiveCallStatsEntry=cvActiveCallStatsEntry, cvdcMIBComplianceRev14=cvdcMIBComplianceRev14, cvVoIPPeerCfgFrameSize=cvVoIPPeerCfgFrameSize, cvdcMIBComplianceRev16=cvdcMIBComplianceRev16, cvdcMIBComplianceRev7=cvdcMIBComplianceRev7, cvdcMIBComplianceRev2=cvdcMIBComplianceRev2, cvActiveCallStatsIntvlDur=cvActiveCallStatsIntvlDur, cvCallActiveSessionTarget=cvCallActiveSessionTarget, cvCallVolConnTable=cvCallVolConnTable, cvCallHistoryACOMLevel=cvCallHistoryACOMLevel, cvVoIPCallIlbcGroup=cvVoIPCallIlbcGroup, cvVoIPCallActiveOnTimeRvPlayout=cvVoIPCallActiveOnTimeRvPlayout, cvVoIPCallActiveRemSigIPAddr=cvVoIPCallActiveRemSigIPAddr, cvVoIPCallActiveReversedDirectionPeerAddress=cvVoIPCallActiveReversedDirectionPeerAddress, cvdcMIBNotificationPrefix=cvdcMIBNotificationPrefix, cvCallActiveTable=cvCallActiveTable, cvVoIPPeerCfgRedirectip2ip=cvVoIPPeerCfgRedirectip2ip, cvdcGeneralCfgGroupRev5=cvdcGeneralCfgGroupRev5, cvVoIPCallHistoryOnTimeRvPlayout=cvVoIPCallHistoryOnTimeRvPlayout, cvCallVolPeerEntry=cvCallVolPeerEntry, cvdcPoorQoVNotification=cvdcPoorQoVNotification, cvVoIPCallActiveModeChgPeriod=cvVoIPCallActiveModeChgPeriod, cvdcGeneralCfgGroupRev4=cvdcGeneralCfgGroupRev4, cvVoIPCallHistoryFallbackLoss=cvVoIPCallHistoryFallbackLoss, cvVoIPCallHistoryRemoteUDPPort=cvVoIPCallHistoryRemoteUDPPort, cvCallRateStatsAvgVal=cvCallRateStatsAvgVal, cvPeerCommonCfgDnisMappingName=cvPeerCommonCfgDnisMappingName, cvCallRateWMTable=cvCallRateWMTable, cvVoIPCallActiveRemMediaIPAddrT=cvVoIPCallActiveRemMediaIPAddrT, cvdcMIBConformance=cvdcMIBConformance, cvCallActiveACOMLevel=cvCallActiveACOMLevel, cvdcVoiceCfgGroupRev1=cvdcVoiceCfgGroupRev1, cvVoIPCallHistoryHiWaterPlayoutDelay=cvVoIPCallHistoryHiWaterPlayoutDelay, cvVoIPCallHistoryGapFillWithSilence=cvVoIPCallHistoryGapFillWithSilence, cvVoIPCallHistoryReceiveDelay=cvVoIPCallHistoryReceiveDelay, cvVoIPCallActiveVADEnable=cvVoIPCallActiveVADEnable, cvSipMsgRateStatsIntvlDur=cvSipMsgRateStatsIntvlDur, cvdcMIBComplianceRev11=cvdcMIBComplianceRev11, cvSipMsgRateStatsIntvlDurUnits=cvSipMsgRateStatsIntvlDurUnits, cvCallRateWMIndex=cvCallRateWMIndex, cvVoIPCallHistoryConnectionId=cvVoIPCallHistoryConnectionId, cvdcMIBComplianceRev8=cvdcMIBComplianceRev8, cvCallLegRateWMTable=cvCallLegRateWMTable, cvPeerCfgType=cvPeerCfgType, cvVoIPCallActiveSessionProtocol=cvVoIPCallActiveSessionProtocol, cvCallRateHiWaterMark=cvCallRateHiWaterMark, cvCallHistoryConnectionId=cvCallHistoryConnectionId, cvCallActiveEntry=cvCallActiveEntry, cvVoIPCallHistoryMaxPtime=cvVoIPCallHistoryMaxPtime, cvVoIPPeerCfgSessionTarget=cvVoIPPeerCfgSessionTarget, cvCallHistoryCallerIDBlock=cvCallHistoryCallerIDBlock, cvVoIPCallActiveCallReferenceId=cvVoIPCallActiveCallReferenceId, cvCallActiveOutSignalLevel=cvCallActiveOutSignalLevel, cvVoicePeerCfgRegisterE164=cvVoicePeerCfgRegisterE164, cvVoIPCallActiveHiWaterPlayoutDelay=cvVoIPCallActiveHiWaterPlayoutDelay, cvVoIPCallHistoryPtime=cvVoIPCallHistoryPtime, cvCallActiveDS0sLowThreshold=cvCallActiveDS0sLowThreshold, cvCallActiveDS0s=cvCallActiveDS0s, cvVoIPCallHistorySessionId=cvVoIPCallHistorySessionId, cvSipMsgRateWMEntry=cvSipMsgRateWMEntry, cvCallRateStatsEntry=cvCallRateStatsEntry, cvCallLegRateWMValue=cvCallLegRateWMValue, cvPeerCfgEntry=cvPeerCfgEntry, cvSipMsgRateStatsMaxVal=cvSipMsgRateStatsMaxVal, cvCallRateStatsMaxVal=cvCallRateStatsMaxVal, cvdcGeneralCfgGroup=cvdcGeneralCfgGroup, cvVoIPCallActiveSRTPEnable=cvVoIPCallActiveSRTPEnable, CvAmrNbBitRateMode=CvAmrNbBitRateMode, cvdcPoorQoVNotificationRev1=cvdcPoorQoVNotificationRev1, cvCallRateWMEntry=cvCallRateWMEntry, cvdcMIBComplianceRev12=cvdcMIBComplianceRev12, cvPeerCommonCfgHuntStop=cvPeerCommonCfgHuntStop, cvSipMsgRateWMTable=cvSipMsgRateWMTable, cvCallLegRateStatsEntry=cvCallLegRateStatsEntry, cvVoIPCallActiveReceiveDelay=cvVoIPCallActiveReceiveDelay, cvVoIPCallHistoryGapFillWithInterpolation=cvVoIPCallHistoryGapFillWithInterpolation, cvVoIPCallHistoryIcpif=cvVoIPCallHistoryIcpif, cvVoIPCallActiveTable=cvVoIPCallActiveTable, cvCallRateWMts=cvCallRateWMts, cvPeerCommonCfgEntry=cvPeerCommonCfgEntry, cvVoIPPeerCfgMinAcceptableQoS=cvVoIPPeerCfgMinAcceptableQoS, cvVoIPPeerCfgIPPrecedence=cvVoIPPeerCfgIPPrecedence, cvCallActiveCallerIDBlock=cvCallActiveCallerIDBlock, cvVoIPCallGroupSup2=cvVoIPCallGroupSup2, cvGeneralFallbackNotificationEnable=cvGeneralFallbackNotificationEnable, cvVoIPCallAmrNbGroup=cvVoIPCallAmrNbGroup, cvdcVoIPCfgIlbcGroup=cvdcVoIPCfgIlbcGroup, cvVoIPCallActiveEntry=cvVoIPCallActiveEntry, cvVoIPCallHistoryBitRates=cvVoIPCallHistoryBitRates, cvCallRateWMValue=cvCallRateWMValue, cvVoIPPeerCfgDesiredQoSVideo=cvVoIPPeerCfgDesiredQoSVideo, cvVoIPCallHistoryCallId=cvVoIPCallHistoryCallId, cvCallLegRateWMIndex=cvCallLegRateWMIndex, cvdcVoiceCfgGroupRev2=cvdcVoiceCfgGroupRev2, cvVoIPCallActiveChannels=cvVoIPCallActiveChannels, cvCallLegRateWMts=cvCallLegRateWMts, cvCallActiveNoiseLevel=cvCallActiveNoiseLevel, cvdcMIBComplianceRev1=cvdcMIBComplianceRev1, cvVoIPCallHistoryLoWaterPlayoutDelay=cvVoIPCallHistoryLoWaterPlayoutDelay, cvVoIPPeerCfgCoderBytes=cvVoIPPeerCfgCoderBytes, cvVoIPCallActiveSessionId=cvVoIPCallActiveSessionId, cvVoIPCallHistoryGapFillWithRedundancy=cvVoIPCallHistoryGapFillWithRedundancy, cvPeerCommonCfgMaxConnections=cvPeerCommonCfgMaxConnections, cvVoIPPeerCfgEntry=cvVoIPPeerCfgEntry, cvVoIPCallGroup=cvVoIPCallGroup, cvVoIPPeerCfgFaxRate=cvVoIPPeerCfgFaxRate, cvVoIPCallActiveConnectionId=cvVoIPCallActiveConnectionId, cvCallLegRateStatsTable=cvCallLegRateStatsTable)
