...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-FIREWALL-TC
# Produced by pysmi-0.3.4 at Sun Apr 21 23:35:35 2019
...
Bits, ObjectIdentity, Counter32, IpAddress, TimeTicks, Counter64, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ModuleIdentity, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "Counter64", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ModuleIdentity", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-FIREWALL-TC", CFWUrlfVendorId=CFWUrlfVendorId, CFWUrlServerStatus=CFWUrlServerStatus, CFWPolicyTarget=CFWPolicyTarget, CFWApplicationProtocol=CFWApplicationProtocol, CFWPolicyTargetType=CFWPolicyTargetType, ciscoFirewallTc=ciscoFirewallTc, CFWPolicy=CFWPolicy, PYSNMP_MODULE_ID=ciscoFirewallTc, CFWNetworkProtocol=CFWNetworkProtocol)
