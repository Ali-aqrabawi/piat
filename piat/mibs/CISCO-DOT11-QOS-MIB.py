...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DOT11-QOS-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:27:33 2019
...
iso, TimeTicks, MibIdentifier, NotificationType, Counter64, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Bits, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibIdentifier", "NotificationType", "Counter64", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Bits", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CISCO-DOT11-QOS-MIB", PYSNMP_MODULE_ID=ciscoDot11QosMIB, ciscoDot11QosStatsGroup=ciscoDot11QosStatsGroup, ciscoDot11QosQueue=ciscoDot11QosQueue, cdot11QosQueueEntry=cdot11QosQueueEntry, cdot11QosConfigEntry=cdot11QosConfigEntry, ciscoDot11QosNotificationGroup=ciscoDot11QosNotificationGroup, cdot11QosRetries=cdot11QosRetries, Cdot11QosTrafficClass=Cdot11QosTrafficClass, ciscoDot11QosStatistics=ciscoDot11QosStatistics, cdot11QosIfDiscardedFragments=cdot11QosIfDiscardedFragments, ciscoDot11QosMIBConformance=ciscoDot11QosMIBConformance, cdot11QosQueueQuota=cdot11QosQueueQuota, cdot11QosNotifEnabled=cdot11QosNotifEnabled, cdot11QosChangeNotif=cdot11QosChangeNotif, cdot11QosQueuePeakSize=cdot11QosQueuePeakSize, cdot11QosMaxRetry=cdot11QosMaxRetry, cdot11QosConfigTable=cdot11QosConfigTable, cdot11QosIfStatisticsEntry=cdot11QosIfStatisticsEntry, ciscoDot11QosNotifControl=ciscoDot11QosNotifControl, cdot11QosCWmax=cdot11QosCWmax, cdot11TrafficQueue=cdot11TrafficQueue, cdot11QosFails=cdot11QosFails, cdot11QosStatisticsEntry=cdot11QosStatisticsEntry, cdot11QosMutipleRetries=cdot11QosMutipleRetries, cdot11QosSupportEntry=cdot11QosSupportEntry, cdot11QosOptionImplemented=cdot11QosOptionImplemented, ciscoDot11QosMIBGroups=ciscoDot11QosMIBGroups, cdot11QosBackoffOffset=cdot11QosBackoffOffset, cdot11QosIfStatisticsTable=cdot11QosIfStatisticsTable, ciscoDot11QosMIBCompliances=ciscoDot11QosMIBCompliances, cdot11QosQueueTable=cdot11QosQueueTable, cdot11QosQueuesAvailable=cdot11QosQueuesAvailable, cdot11QosCWmin=cdot11QosCWmin, ciscoDot11QosMIB=ciscoDot11QosMIB, cdot11QosIfVlanId=cdot11QosIfVlanId, ciscoDot11QosConfigGroup=ciscoDot11QosConfigGroup, cdot11TrafficClass=cdot11TrafficClass, cdot11QosSupportTable=cdot11QosSupportTable, cdot11QosIfVlanTrafficClass=cdot11QosIfVlanTrafficClass, ciscoDot11QosConfig=ciscoDot11QosConfig, ciscoDot11QosMIBObjects=ciscoDot11QosMIBObjects, cdot11QosOptionEnabled=cdot11QosOptionEnabled, cdot11QosQueueSize=cdot11QosQueueSize, ciscoDot11QosMIBCompliance=ciscoDot11QosMIBCompliance, cdot11QosTransmittedFrames=cdot11QosTransmittedFrames, cdot11QosIfVlanEntry=cdot11QosIfVlanEntry, cdot11QosStatisticsTable=cdot11QosStatisticsTable, ciscoDot11QosMIBNotifs=ciscoDot11QosMIBNotifs, ciscoDot11QosNotifControlGroup=ciscoDot11QosNotifControlGroup, cdot11QosDiscardedFrames=cdot11QosDiscardedFrames, cdot11QosIfVlanTable=cdot11QosIfVlanTable)
