...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-TELEPRESENCE-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:38:36 2019
...
ObjectIdentity, Counter32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Integer32, TimeTicks, MibIdentifier, Gauge32, ModuleIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Integer32", "TimeTicks", "MibIdentifier", "Gauge32", "ModuleIdentity", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-TELEPRESENCE-MIB", ciscoTpNotificationGroup=ciscoTpNotificationGroup, CtpPeripheralStatusCode=CtpPeripheralStatusCode, ciscoTelepresenceMIB=ciscoTelepresenceMIB, ctp802dot11PeripheralStatusEntry=ctp802dot11PeripheralStatusEntry, ctpSysUserAuthFailTimeStamp=ctpSysUserAuthFailTimeStamp, CtpSystemAccessProtocol=CtpSystemAccessProtocol, ctpPeripheralStatusTable=ctpPeripheralStatusTable, ciscoTelepresenceCompliances=ciscoTelepresenceCompliances, ctp802dot11PeripheralStatusTable=ctp802dot11PeripheralStatusTable, ciscoTelepresenceComplianceR02=ciscoTelepresenceComplianceR02, ctpSysUserAuthFailHistTableSize=ctpSysUserAuthFailHistTableSize, ctp802dot11PeripheralLinkStrength=ctp802dot11PeripheralLinkStrength, CtpSystemResetMode=CtpSystemResetMode, ctpPeriStatusChangeNotification=ctpPeriStatusChangeNotification, ctpHDMIPeripheralStatusTable=ctpHDMIPeripheralStatusTable, ctpPeripheralStatusObjects=ctpPeripheralStatusObjects, ctpSysUserAuthFailSourceAddr=ctpSysUserAuthFailSourceAddr, ctpPeripheralDescription=ctpPeripheralDescription, ciscoTelepresenceCompliance=ciscoTelepresenceCompliance, ctpDVIPeripheralIndex=ctpDVIPeripheralIndex, ciscoTpPeripheralStatusGroupR02=ciscoTpPeripheralStatusGroupR02, ciscoTpConfigurationGroupR02=ciscoTpConfigurationGroupR02, ciscoTelepresenceMIBGroups=ciscoTelepresenceMIBGroups, CtpPeripheralPowerCode=CtpPeripheralPowerCode, ctpSysUserAuthFailHistoryIndex=ctpSysUserAuthFailHistoryIndex, ctpPeripheralAttributeEntry=ctpPeripheralAttributeEntry, ctpSysUserAuthFailUserName=ctpSysUserAuthFailUserName, ciscoTpPeripheralStatusGroup=ciscoTpPeripheralStatusGroup, ctpHDMIPeripheralCableStatus=ctpHDMIPeripheralCableStatus, ctpUSBPeripheralPowerStatus=ctpUSBPeripheralPowerStatus, ctpSysUserAuthFailHistoryTable=ctpSysUserAuthFailHistoryTable, ctpPeripheralErrorHistoryIndex=ctpPeripheralErrorHistoryIndex, ctpPeripheralDeviceCategory=ctpPeripheralDeviceCategory, ctpDVIPeripheralStatusEntry=ctpDVIPeripheralStatusEntry, ctpPeripheralAttributeValue=ctpPeripheralAttributeValue, ctp802dot11PeripheralLinkStatus=ctp802dot11PeripheralLinkStatus, ciscoTpEventHistoryGroupR01=ciscoTpEventHistoryGroupR01, ctp802dot11PeripheralAddrType=ctp802dot11PeripheralAddrType, ctpEtherPeripheralStatusEntry=ctpEtherPeripheralStatusEntry, ctpSysUserAuthFailSourceAddrType=ctpSysUserAuthFailSourceAddrType, ctpRS232PeripheralStatusTable=ctpRS232PeripheralStatusTable, ctpSysUserAuthFailSourcePort=ctpSysUserAuthFailSourcePort, ctpDPPeripheralStatusTable=ctpDPPeripheralStatusTable, ctpSystemReset=ctpSystemReset, ctpVlanId=ctpVlanId, ctp802dot11PeripheralIfIndex=ctp802dot11PeripheralIfIndex, ctpDPPeripheralPowerStatus=ctpDPPeripheralPowerStatus, ciscoTpConfigurationGroup=ciscoTpConfigurationGroup, ctpHDMIPeripheralStatusEntry=ctpHDMIPeripheralStatusEntry, ctpPeripheralStatusEntry=ctpPeripheralStatusEntry, ctpPeripheralAttributeTable=ctpPeripheralAttributeTable, ciscoTpNotificationGroupR01=ciscoTpNotificationGroupR01, ctpRS232PeripheralConnStatus=ctpRS232PeripheralConnStatus, ctpRS232PortIndex=ctpRS232PortIndex, ctpHDMIPeripheralIndex=ctpHDMIPeripheralIndex, ctpPeripheralErrorIndex=ctpPeripheralErrorIndex, ctpUSBPeripheralStatusEntry=ctpUSBPeripheralStatusEntry, ctpDVIPeripheralCableStatus=ctpDVIPeripheralCableStatus, ciscoTpPeripheralAttributeGroup=ciscoTpPeripheralAttributeGroup, ctpEtherPeripheralAddrType=ctpEtherPeripheralAddrType, ctpEtherPeripheralIndex=ctpEtherPeripheralIndex, ciscoTelepresenceComplianceR03=ciscoTelepresenceComplianceR03, ctpUSBPeripheralPortRate=ctpUSBPeripheralPortRate, ctpPeripheralErrorHistTableSize=ctpPeripheralErrorHistTableSize, ctpSysUserAuthFailNotification=ctpSysUserAuthFailNotification, ctpEtherPeripheralStatus=ctpEtherPeripheralStatus, ctp802dot11PeripheralAddr=ctp802dot11PeripheralAddr, ciscoTelepresenceMIBNotifs=ciscoTelepresenceMIBNotifs, ctpUSBPeripheralIndex=ctpUSBPeripheralIndex, ciscoTpEventHistoryGroup=ciscoTpEventHistoryGroup, ctpEventHistory=ctpEventHistory, PYSNMP_MODULE_ID=ciscoTelepresenceMIB, ctpPeripheralAttributeDescr=ctpPeripheralAttributeDescr, ctpPeripheralStatus=ctpPeripheralStatus, ciscoTelepresenceMIBObjects=ciscoTelepresenceMIBObjects, ctpEtherPeripheralStatusTable=ctpEtherPeripheralStatusTable, ctpPeripheralErrorDeviceNumber=ctpPeripheralErrorDeviceNumber, ctpDVIPeripheralStatusTable=ctpDVIPeripheralStatusTable, ctpEtherPeripheralAddr=ctpEtherPeripheralAddr, ctpDPPeripheralStatusEntry=ctpDPPeripheralStatusEntry, ciscoTelepresenceComplianceR05=ciscoTelepresenceComplianceR05, ctpSysUserAuthFailAccessProtocol=ctpSysUserAuthFailAccessProtocol, ctpPeripheralErrorHistLastIndex=ctpPeripheralErrorHistLastIndex, ctp802dot11PeripheralIndex=ctp802dot11PeripheralIndex, ctpPeriStatusChangeNotifyEnable=ctpPeriStatusChangeNotifyEnable, ciscoTpPeripheralStatusGroupR01=ciscoTpPeripheralStatusGroupR01, ctpDPPeripheralCableStatus=ctpDPPeripheralCableStatus, ctpHDMIPeripheralPowerStatus=ctpHDMIPeripheralPowerStatus, ctpPeripheralErrorDeviceCategory=ctpPeripheralErrorDeviceCategory, ctpPeripheralErrorHistoryTable=ctpPeripheralErrorHistoryTable, ctpPeripheralErrorNotifyEnable=ctpPeripheralErrorNotifyEnable, ciscoTelepresenceComplianceR04=ciscoTelepresenceComplianceR04, ctpSysUserAuthFailNotifyEnable=ctpSysUserAuthFailNotifyEnable, ctpUSBPeripheralCableStatus=ctpUSBPeripheralCableStatus, ciscoTpDPPeripheralStatusGroup=ciscoTpDPPeripheralStatusGroup, ciscoTelepresenceComplianceR01=ciscoTelepresenceComplianceR01, CtpPeripheralDeviceCategoryCode=CtpPeripheralDeviceCategoryCode, ciscoTpRS232PeripheralStatusGroup=ciscoTpRS232PeripheralStatusGroup, CtpPeripheralCableCode=CtpPeripheralCableCode, ciscoTelepresenceMIBConform=ciscoTelepresenceMIBConform, ctpDefaultGatewayAddrType=ctpDefaultGatewayAddrType, ctpRS232PeripheralStatusEntry=ctpRS232PeripheralStatusEntry, ctpRS232PeripheralIndex=ctpRS232PeripheralIndex, ctpPeripheralErrorNotification=ctpPeripheralErrorNotification, ciscoTpConfigurationGroupR01=ciscoTpConfigurationGroupR01, ctpDPPeripheralIndex=ctpDPPeripheralIndex, ctpPeripheralErrorStatus=ctpPeripheralErrorStatus, ctpPeripheralIndex=ctpPeripheralIndex, ctpUSBPeripheralStatusTable=ctpUSBPeripheralStatusTable, ctpObjects=ctpObjects, ctpPeripheralErrorTimeStamp=ctpPeripheralErrorTimeStamp, ctpPeripheralDeviceNumber=ctpPeripheralDeviceNumber, ctpPeripheralAttributeIndex=ctpPeripheralAttributeIndex, ctpSysUserAuthFailHistoryEntry=ctpSysUserAuthFailHistoryEntry, ctpDefaultGateway=ctpDefaultGateway, ctpEtherPeripheralIfIndex=ctpEtherPeripheralIfIndex, ctpSysUserAuthFailHistLastIndex=ctpSysUserAuthFailHistLastIndex, ctpPeripheralErrorHistoryEntry=ctpPeripheralErrorHistoryEntry, ctpUSBPeripheralPortType=ctpUSBPeripheralPortType)
