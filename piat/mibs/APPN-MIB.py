...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/APPN-MIB
...
TextualConvention, TruthValue, TimeStamp, DisplayString, DateAndTime, RowPointer, VariablePointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "DateAndTime", "RowPointer", "VariablePointer")
...
mibBuilder.exportSymbols("APPN-MIB", SnaModeName=SnaModeName, appnLsMltgMember=appnLsMltgMember, appnNodeType=appnNodeType, appnLsMaxDelay=appnLsMaxDelay, appnLsOutMsgBytes=appnLsOutMsgBytes, appnLsOutXidFrames=appnLsOutXidFrames, appnNodeBrNn=appnNodeBrNn, appnDirNnServerName=appnDirNnServerName, appnIsInSsRecvNxWndwSize=appnIsInSsRecvNxWndwSize, appnLsStatusXidRemoteSense=appnLsStatusXidRemoteSense, appnHprBfConfGroup=appnHprBfConfGroup, appnDirLocateOutstands=appnDirLocateOutstands, appnIsInPsSendMaxBtuSize=appnIsInPsSendMaxBtuSize, appnLsActiveTime=appnLsActiveTime, appnLsCurrentDelay=appnLsCurrentDelay, appnDirNotFoundLocates=appnDirNotFoundLocates, appnIsInPsRecvNxWndwSize=appnIsInPsRecvNxWndwSize, appnLocalEnTgCpCpSession=appnLocalEnTgCpCpSession, appnIsRtpTcid=appnIsRtpTcid, appnLsOutMsgFrames=appnLsOutMsgFrames, appnHprBaseConfGroup=appnHprBaseConfGroup, appnIsInPsAdjCpName=appnIsInPsAdjCpName, appnNodeEnModeCosMap=appnNodeEnModeCosMap, appnCosTgRowByteCostMin=appnCosTgRowByteCostMin, AppnPortCounter=AppnPortCounter, appnIsInSsRecvPacingType=appnIsInSsRecvPacingType, appnLsTgNum=appnLsTgNum, appnIsInGlobeRscvTime=appnIsInGlobeRscvTime, appnCosNodeRowMaxCongestAllow=appnCosNodeRowMaxCongestAllow, appnLsStatusRetry=appnLsStatusRetry, appnLocalEnTgEffCap=appnLocalEnTgEffCap, appnIsRtpNceId=appnIsRtpNceId, appnDirInLocates=appnDirInLocates, appnIsInP2SNonFmdBytes=appnIsInP2SNonFmdBytes, appnIntSessConfGroup=appnIntSessConfGroup, appnLsStatusTime=appnLsStatusTime, appnCosModeTable=appnCosModeTable, SnaNodeIdentification=SnaNodeIdentification, appnLsGoodXids=appnLsGoodXids, appnLsLimResource=appnLsLimResource, appnGeneralConfGroup2=appnGeneralConfGroup2, appnNnTopoTotalTduWars=appnNnTopoTotalTduWars, appnNnTgFRSecurity=appnNnTgFRSecurity, appnCosName=appnCosName, appnIsInPsSendRpc=appnIsInPsSendRpc, appnNnTgTopologyFREntry=appnNnTgTopologyFREntry, appnNnNodeFRPeriBorderSup=appnNnNodeFRPeriBorderSup, appnLocalTgHprSup=appnLocalTgHprSup, appnNnTgFRUsr2=appnNnTgFRUsr2, appnLocalTgPortName=appnLocalTgPortName, appnLocalTgByteCost=appnLocalTgByteCost, appnLsStatusEndSense=appnLsStatusEndSense, appnIsInS2PNonFmdBytes=appnIsInS2PNonFmdBytes, appnLsCpCpSessionSupport=appnLsCpCpSessionSupport, appnVrnPortName=appnVrnPortName, appnIsInGlobeCtrStatusTime=appnIsInGlobeCtrStatusTime, appnLsRouteNceId=appnLsRouteNceId, appnLsStatusIndex=appnLsStatusIndex, appnLsDynamic=appnLsDynamic, appnNodeLsCounterType=appnNodeLsCounterType, appnNnNodeFRExteBorderSup=appnNnNodeFRExteBorderSup, appnLsRevAnrLabel=appnLsRevAnrLabel, appnNodeNnFrsn=appnNodeNnFrsn, appnCosConfGroup=appnCosConfGroup, appnPortLsRole=appnPortLsRole, appnLsCpCpNceId=appnLsCpCpNceId, appnLocalEnTgConnCost=appnLocalEnTgConnCost, appnNnNodeFRRsn=appnNnNodeFRRsn, appnNnTgFRCpCpSession=appnNnTgFRCpCpSession, alertTrap=alertTrap, appnNnTopoCurNumNodes=appnNnTopoCurNumNodes, appnLsInMsgFrames=appnLsInMsgFrames, appnNodeNnCongested=appnNodeNnCongested, appnCosTgRowSecurityMax=appnCosTgRowSecurityMax, appnDirOutBcastLocates=appnDirOutBcastLocates, appnIsInSessUpTime=appnIsInSessUpTime, appnPortDlcLocalAddr=appnPortDlcLocalAddr, appnNodeHprOrgRteSetups=appnNodeHprOrgRteSetups, appnLocalTgUsr1=appnLocalTgUsr1, appnNnNodeFRRouteAddResist=appnNnNodeFRRouteAddResist, appnIsInSsAdjCpName=appnIsInSsAdjCpName, appnHprCtrlFlowsRtpConfGroup=appnHprCtrlFlowsRtpConfGroup, AppnTgEffectiveCapacity=AppnTgEffectiveCapacity, appnLsCurrentStateTime=appnLsCurrentStateTime, appnPortCounterDisconTime=appnPortCounterDisconTime, appnNnTgFRByteCost=appnNnTgFRByteCost, appnNodeNnPeriBorderSup=appnNodeNnPeriBorderSup, appnIsRtpTable=appnIsRtpTable, appnNodeNnExteBorderSup=appnNodeNnExteBorderSup, appnCosTgRowByteCostMax=appnCosTgRowByteCostMax, appnLocalTgTable=appnLocalTgTable, appnDirCurHomeEntries=appnDirCurHomeEntries, appnLocalTgNum=appnLocalTgNum, appnIsInSsSendMaxBtuSize=appnIsInSsSendMaxBtuSize, appnNnNodeFRType=appnNnNodeFRType, appnTrapConfGroup=appnTrapConfGroup, appnPortSIMRIM=appnPortSIMRIM, appnLsMaxDelayTime=appnLsMaxDelayTime, appnLocalTgBranchLinkType=appnLocalTgBranchLinkType, appnIsRtpSessions=appnIsRtpSessions, appnCosTgRowName=appnCosTgRowName, appnNodeNnSafeStoreFreq=appnNodeNnSafeStoreFreq, appnLsStatusEntry=appnLsStatusEntry, appnDirMaxCaches=appnDirMaxCaches, appnIsInRtpNceId=appnIsInRtpNceId, appnLsLocalAddr=appnLsLocalAddr, appnIsInGlobeCtrAdminStatus=appnIsInGlobeCtrAdminStatus, appnNodeEnLuSearch=appnNodeEnLuSearch, appnNodeAdaptiveBindPacing=appnNodeAdaptiveBindPacing, appnLocalEnTgOperational=appnLocalEnTgOperational, appnNodeHprEndRteRejects=appnNodeHprEndRteRejects, appnLocalEnTgByteCost=appnLocalEnTgByteCost, appnLocalEnTgEntry=appnLocalEnTgEntry, appnIsInS2PFmdPius=appnIsInS2PFmdPius, appnCosNameTable=appnCosNameTable, appnCosNodeRowResistMax=appnCosNodeRowResistMax, appnCosModeCosName=appnCosModeCosName, appnIsInRtpTcid=appnIsInRtpTcid, appnDirNotFoundBcastLocates=appnDirNotFoundBcastLocates, appnNnTgFRSubareaNum=appnNnTgFRSubareaNum, appnIsInCosName=appnIsInCosName, appnIsInSsSendNxWndwSize=appnIsInSsSendNxWndwSize, appnLsMaxSendBtuSize=appnLsMaxSendBtuSize, appnLocalEnTgSecurity=appnLocalEnTgSecurity, appnNnTopoConfGroup2=appnNnTopoConfGroup2, appnNnTgFRHprSup=appnNnTgFRHprSup, appnLsPortName=appnLsPortName, appnLocalTgIntersubnet=appnLocalTgIntersubnet, appnLsSpecific=appnLsSpecific, appnCosTgRowUsr2Min=appnCosTgRowUsr2Min, appnNnTgFRDlcData=appnNnTgFRDlcData, appnNnTopologyFREntry=appnNnTopologyFREntry, appnIsInRouteInfo=appnIsInRouteInfo, appnLsStatusTable=appnLsStatusTable, appnNnTgFRTypeIndicator=appnNnTgFRTypeIndicator, appnNnNodeFRGateway=appnNnNodeFRGateway, appnIsInP2SNonFmdPius=appnIsInP2SNonFmdPius, appnIsInPsAdjTgNum=appnIsInPsAdjTgNum, appnLsForAnrLabel=appnLsForAnrLabel, appnLsStatusXidByteInError=appnLsStatusXidByteInError, appnCosTgRowEntry=appnCosTgRowEntry, appnIsInFqCpName=appnIsInFqCpName, appnLocalTgDlcData=appnLocalTgDlcData, appnNn=appnNn, appnCosModeEntry=appnCosModeEntry, appnNnTgFRConnCost=appnNnTgFRConnCost, appnCosTgRowWgt=appnCosTgRowWgt, appnLsTable=appnLsTable, appnLsStatusRemoteAddr=appnLsStatusRemoteAddr, appnPortDefLsBadXids=appnPortDefLsBadXids, appnNnTgFRDelay=appnNnTgFRDelay, appnIsInPsRecvPacingType=appnIsInPsRecvPacingType, appnNnTopoNodePurges=appnNnTopoNodePurges, affectedObject=affectedObject, appnCosTgRowUsr1Min=appnCosTgRowUsr1Min, appnNodeNnInterchangeSup=appnNodeNnInterchangeSup, appnIsInP2SFmdPius=appnIsInP2SFmdPius, appnLocalTgCpCpSession=appnLocalTgCpCpSession, appnLocalEnTopoConfGroup2=appnLocalEnTopoConfGroup2, appnLocalTgMltgLinkType=appnLocalTgMltgLinkType, appnLocalTgEffCap=appnLocalTgEffCap, appnDirLuOwnerName=appnDirLuOwnerName, appnObjects=appnObjects, appnNnTgFRDest=appnNnTgFRDest, appnLocalTgOperational=appnLocalTgOperational, appnIsInS2PNonFmdPius=appnIsInS2PNonFmdPius, appnNnTgFRUsr1=appnNnTgFRUsr1, appnPortDynLsBadXids=appnPortDynLsBadXids, appnLsStatusXidBitInError=appnLsStatusXidBitInError, appnDirEntry=appnDirEntry, appnIsInSsAdjTgNum=appnIsInSsAdjTgNum, appnLocalEnTgUsr1=appnLocalEnTgUsr1, appnIsInSecLuName=appnIsInSecLuName, appnCosModeName=appnCosModeName, appnIsInSessType=appnIsInSessType, appnLsBfNceId=appnLsBfNceId, appnLsInXidBytes=appnLsInXidBytes, SnaControlPointName=SnaControlPointName, appnNnNodeFRFrsn=appnNnNodeFRFrsn, appnLsErrRecoSup=appnLsErrRecoSup, appnDir=appnDir, alertIdNumber=alertIdNumber, appnLocalEnTgMltgLinkType=appnLocalEnTgMltgLinkType, appnSessIntermediate=appnSessIntermediate, appnNnTgFRGarbageCollect=appnNnTgFRGarbageCollect, appnNnNodeFRBranchAwareness=appnNnNodeFRBranchAwareness, appnDirLuName=appnDirLuName, appnNnTgFRQuiescing=appnNnTgFRQuiescing, appnConformance=appnConformance, appnPortMaxIframeWindow=appnPortMaxIframeWindow, appnCosTgRowSecurityMin=appnCosTgRowSecurityMin, appnNnNodeFRName=appnNnNodeFRName, appnIsInPsSendPacingType=appnIsInPsSendPacingType, AppnLinkStationCounter=AppnLinkStationCounter, appnNodeHprOrgRteRejects=appnNodeHprOrgRteRejects, appnNnTopoMaxNodes=appnNnTopoMaxNodes, appnDirPerf=appnDirPerf, appnCos=appnCos, appnIsInSsSendPacingType=appnIsInSsSendPacingType, appnNodeNnQuiescing=appnNodeNnQuiescing, appnIsInGlobeRscv=appnIsInGlobeRscv, appnNnTgFRIntersubnet=appnNnTgFRIntersubnet, appnNodeNnRouteAddResist=appnNodeNnRouteAddResist, appnLsStatusLsName=appnLsStatusLsName, appnCosNodeRowTable=appnCosNodeRowTable, appnLsStatusGeneralSense=appnLsStatusGeneralSense, appnIsInPcid=appnIsInPcid, appnTrapNotifGroup=appnTrapNotifGroup, appnIsInGlobal=appnIsInGlobal, appnNodeNnIsrDepleted=appnNodeNnIsrDepleted, appnIsInSsSendRpc=appnIsInSsSendRpc, AppnTgDelay=AppnTgDelay, appnCosTgRowUsr2Max=appnCosTgRowUsr2Max, appnVrnConfGroup=appnVrnConfGroup, appnIsInEntry=appnIsInEntry, appnDirType=appnDirType, appnCosNodeRowMinCongestAllow=appnCosNodeRowMinCongestAllow, appnLsAdjNodeType=appnLsAdjNodeType, appnDirOutLocates=appnDirOutLocates, appnNnNodeFRHprSupport=appnNnNodeFRHprSupport, appnDirTable=appnDirTable, appnPortCommand=appnPortCommand, appnPortPortType=appnPortPortType, appnPortOperState=appnPortOperState, appnIsInTable=appnIsInTable, appnIsInSessState=appnIsInSessState, appnIsInPriLuName=appnIsInPriLuName, appnNnTgFRNum=appnNnTgFRNum, appnNnTgFRBranchTg=appnNnTgFRBranchTg, appnLocalTgUsr3=appnLocalTgUsr3, appnLsEchoRsps=appnLsEchoRsps, appnLinkConfGroup2=appnLinkConfGroup2, appnNnTgFRRsn=appnNnTgFRRsn, appnLsMinDelay=appnLsMinDelay, appnLocalTgEntry=appnLocalTgEntry, appnCompliance=appnCompliance, appnLsRemoteLsName=appnLsRemoteLsName, appnCosTgRowTable=appnCosTgRowTable, appnLocalTgConnCost=appnLocalTgConnCost, appnNnUniqueConfGroup=appnNnUniqueConfGroup, appnNnNodeFRQuiescing=appnNnNodeFRQuiescing, appnNnNodeFRIsr=appnNnNodeFRIsr, appnIsInGlobeCtrOperStatus=appnIsInGlobeCtrOperStatus, appnCosNodeRowResistMin=appnCosNodeRowResistMin, appnCosNodeRowName=appnCosNodeRowName, appnIsInTransPriority=appnIsInTransPriority, appnNodeCpName=appnNodeCpName, appnEnUniqueConfGroup=appnEnUniqueConfGroup, appnCosTgRowEffCapMin=appnCosTgRowEffCapMin, appnVrnTgNum=appnVrnTgNum, appnLsInXidFrames=appnLsInXidFrames, appnLsAdjCpName=appnLsAdjCpName, appnLsStatusTgNum=appnLsStatusTgNum, appnLocalEnTgOrigin=appnLocalEnTgOrigin)
mibBuilder.exportSymbols("APPN-MIB", appnNnTopoConfGroup=appnNnTopoConfGroup, appnPortName=appnPortName, appnNnTopologyFRTable=appnNnTopologyFRTable, appnCosTgRowUsr3Min=appnCosTgRowUsr3Min, appnNodeHprIntRteRejects=appnNodeHprIntRteRejects, AppnTopologyEntryTimeLeft=AppnTopologyEntryTimeLeft, appnNnTgFROwner=appnNnTgFROwner, appnNodeNnRsn=appnNodeNnRsn, appnIsInGlobeActSess=appnIsInGlobeActSess, appnCosTgRowUsr3Max=appnCosTgRowUsr3Max, appnCompliances=appnCompliances, PYSNMP_MODULE_ID=appnMIB, appnNnTgFRDestHprTrans=appnNnTgFRDestHprTrans, appnPortTable=appnPortTable, appnLsHprSup=appnLsHprSup, appnIsInS2PFmdBytes=appnIsInS2PFmdBytes, appnLocalEnTgDestVirtual=appnLocalEnTgDestVirtual, appnPortDlcType=appnPortDlcType, appnLsPartnerNodeId=appnLsPartnerNodeId, appnTraps=appnTraps, appnLinkConfGroup=appnLinkConfGroup, appnLocalTgQuiescing=appnLocalTgQuiescing, appnNnTopoTgPurges=appnNnTopoTgPurges, DisplayableDlcAddress=DisplayableDlcAddress, appnLocalTgUsr2=appnLocalTgUsr2, appnNnTgFRDestVirtual=appnNnTgFRDestVirtual, appnCosTransPriority=appnCosTransPriority, appnCosNodeRowEntry=appnCosNodeRowEntry, SnaSenseData=SnaSenseData, appnPortEntry=appnPortEntry, appnNnNodeFRGarbageCollect=appnNnNodeFRGarbageCollect, appnLocalEnTopoConfGroup=appnLocalEnTopoConfGroup, appnLsCommand=appnLsCommand, appnNnNodeFRIsrDepleted=appnNnNodeFRIsrDepleted, appnCosNameEntry=appnCosNameEntry, appnNnTgFRUsr3=appnNnTgFRUsr3, appnLsStatusCpName=appnLsStatusCpName, appnNodeParallelTg=appnNodeParallelTg, appnPortConfGroup=appnPortConfGroup, AppnTgSecurity=AppnTgSecurity, AppnTgDlcData=AppnTgDlcData, appnPortMaxRcvBtuSize=appnPortMaxRcvBtuSize, appnNodeNnIsr=appnNodeNnIsr, appnLsRemoteAddr=appnLsRemoteAddr, appnLsEntry=appnLsEntry, appnNnUniqueInfoAndCaps=appnNnUniqueInfoAndCaps, appnDirTableConfGroup=appnDirTableConfGroup, appnNnNodeFRInterchangeSup=appnNnNodeFRInterchangeSup, appnCosTgRowIndex=appnCosTgRowIndex, appnLsOperState=appnLsOperState, appnPortDefLsGoodXids=appnPortDefLsGoodXids, appnLocalTgConfGroup2=appnLocalTgConfGroup2, appnNodeMaxSessPerRtpConn=appnNodeMaxSessPerRtpConn, appnPortDynLsGoodXids=appnPortDynLsGoodXids, appnLocalEnTgUsr2=appnLocalEnTgUsr2, appnIsInP2SFmdBytes=appnIsInP2SFmdBytes, appnLocalDirPerfConfGroup=appnLocalDirPerfConfGroup, appnVrnTable=appnVrnTable, appnLocalTgDest=appnLocalTgDest, appnVrnName=appnVrnName, appnPortInformation=appnPortInformation, appnNnNodeFREntryTimeLeft=appnNnNodeFREntryTimeLeft, appnMIB=appnMIB, appnCompliance2=appnCompliance2, appnNnTopo=appnNnTopo, appnCosTgRowDelayMax=appnCosTgRowDelayMax, appnNodeEnNnServer=appnNodeEnNnServer, appnLsOutXidBytes=appnLsOutXidBytes, appnNode=appnNode, appnLsBadXids=appnLsBadXids, appnLsStatusPartnerId=appnLsStatusPartnerId, appnLsStatusLocalAddr=appnLsStatusLocalAddr, appnIsInSsRecvRpc=appnIsInSsRecvRpc, appnCosTgRowConnCostMin=appnCosTgRowConnCostMin, appnNnNodeFRCongested=appnNnNodeFRCongested, appnLsCounterDisconTime=appnLsCounterDisconTime, appnGeneralConfGroup=appnGeneralConfGroup, appnCosTgRowDelayMin=appnCosTgRowDelayMin, appnVrnInfo=appnVrnInfo, appnNodeNnCentralDirectory=appnNodeNnCentralDirectory, appnNnTgFREntryTimeLeft=appnNnTgFREntryTimeLeft, appnCosTgRowEffCapMax=appnCosTgRowEffCapMax, appnIsInCtrUpTime=appnIsInCtrUpTime, appnIsRtpEntry=appnIsRtpEntry, appnDirLuLocation=appnDirLuLocation, appnLsName=appnLsName, appnGroups=appnGroups, appnNodeNnTreeCache=appnNodeNnTreeCache, appnLsDlcType=appnLsDlcType, appnLocalTgDelay=appnLocalTgDelay, appnIsInPsRecvRpc=appnIsInPsRecvRpc, appnLocalEnTgUsr3=appnLocalEnTgUsr3, appnNnTgFRFrsn=appnNnTgFRFrsn, appnNnNodeFRCentralDirectory=appnNnNodeFRCentralDirectory, appnIsInGlobeHprBfActSess=appnIsInGlobeHprBfActSess, appnCosNodeRowWgt=appnCosNodeRowWgt, appnLocalEnTgDest=appnLocalEnTgDest, AppnNodeCounter=AppnNodeCounter, appnCosTgRowConnCostMax=appnCosTgRowConnCostMax, appnBrNnConfGroup=appnBrNnConfGroup, appnNodeUpTime=appnNodeUpTime, appnNnTgFRMltgLinkType=appnNnTgFRMltgLinkType, appnPortDynamicLinkSupport=appnPortDynamicLinkSupport, appnDirCurCaches=appnDirCurCaches, appnPortNegotLs=appnPortNegotLs, appnDirRegEntries=appnDirRegEntries, appnNnTgFROperational=appnNnTgFROperational, appnLsStatusXidLocalSense=appnLsStatusXidLocalSense, appnLsActOnDemand=appnLsActOnDemand, appnLsStatusDlcType=appnLsStatusDlcType, appnIsInModeName=appnIsInModeName, appnIsInPsSendNxWndwSize=appnIsInPsSendNxWndwSize, appnLocalEnTgTable=appnLocalEnTgTable, appnCosTgRowUsr1Max=appnCosTgRowUsr1Max, appnDirApparentLuOwnerName=appnDirApparentLuOwnerName, appnNodeHprEndRteSetups=appnNodeHprEndRteSetups, appnEnUniqueCaps=appnEnUniqueCaps, appnPortSpecific=appnPortSpecific, appnNnTgTopologyFRTable=appnNnTgTopologyFRTable, appnLinkStationInformation=appnLinkStationInformation, appnNnTopology=appnNnTopology, appnLocalEnTgEntryTimeLeft=appnLocalEnTgEntryTimeLeft, appnLocalEnTgNum=appnLocalEnTgNum, appnNodeNnGateway=appnNodeNnGateway, appnHprRtpConfGroup=appnHprRtpConfGroup, appnNodeHprIntRteSetups=appnNodeHprIntRteSetups, appnLsMigration=appnLsMigration, appnLocalTgSecurity=appnLocalTgSecurity, appnGeneralInfoAndCaps=appnGeneralInfoAndCaps, appnCosNodeRowIndex=appnCosNodeRowIndex, appnDirTableConfGroup2=appnDirTableConfGroup2, appnNodeCounterDisconTime=appnNodeCounterDisconTime, appnLocalTgDestVirtual=appnLocalTgDestVirtual, appnNodeMibVersion=appnNodeMibVersion, SnaClassOfServiceName=SnaClassOfServiceName, appnLocalEnTgDelay=appnLocalEnTgDelay, appnNodeHprSupport=appnNodeHprSupport, appnLocalTgConfGroup=appnLocalTgConfGroup, appnDirInBcastLocates=appnDirInBcastLocates, appnLocalTopology=appnLocalTopology, appnNnTgFREffCap=appnNnTgFREffCap, appnNodeId=appnNodeId, appnLsInMsgBytes=appnLsInMsgBytes, appnVrnEntry=appnVrnEntry, appnLocalEnTgDlcData=appnLocalEnTgDlcData)
