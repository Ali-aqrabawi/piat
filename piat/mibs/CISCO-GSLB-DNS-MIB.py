...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-GSLB-DNS-MIB
...
CiscoGslbAnswerAdminState, CiscoGslbAnswerStatus, CiscoGslbBalanceMethod, CiscoGslbAnswerType = mibBuilder.importSymbols("CISCO-GSLB-TC-MIB", "CiscoGslbAnswerAdminState", "CiscoGslbAnswerStatus", "CiscoGslbBalanceMethod", "CiscoGslbAnswerType")
...
ModuleIdentity, Gauge32, IpAddress, MibIdentifier, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, TimeTicks, iso, Counter32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "TimeTicks", "iso", "Counter32", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("CISCO-GSLB-DNS-MIB", cgdClauseBalanceMethod=cgdClauseBalanceMethod, cgdClauseTable=cgdClauseTable, cgdClauseRowStatus=cgdClauseRowStatus, cgdDnsRcvdQueries=cgdDnsRcvdQueries, cgdSourceAddressListHits=cgdSourceAddressListHits, cgdDomainListEntry=cgdDomainListEntry, cgdDnsRuleHits=cgdDnsRuleHits, cgdDomainListHits=cgdDomainListHits, cgdAnswerGroupHits=cgdAnswerGroupHits, cgdClauseHits=cgdClauseHits, cgdDnsRuleSuccesses=cgdDnsRuleSuccesses, ciscoGslbDnsAnswerGroup=ciscoGslbDnsAnswerGroup, cgdNotifObjects=cgdNotifObjects, cgdDomainStorageType=cgdDomainStorageType, cgdThirdClauseId=cgdThirdClauseId, cgdSourceAddList=cgdSourceAddList, ciscoGslbDnsMIBConform=ciscoGslbDnsMIBConform, cgdDnsDroppedQueries=cgdDnsDroppedQueries, cgdSourceAddressRowStatus=cgdSourceAddressRowStatus, cgdDnsRuleRowStatus=cgdDnsRuleRowStatus, ciscoGslbDnsNotifGroup=ciscoGslbDnsNotifGroup, cgdTotalAnswerGroups=cgdTotalAnswerGroups, cgdSourceAddressRate30Min=cgdSourceAddressRate30Min, cgdAnswerName=cgdAnswerName, cgdAnswerStorageType=cgdAnswerStorageType, cgdProxLkupSentReqs=cgdProxLkupSentReqs, cgdDomainRate5Min=cgdDomainRate5Min, cgdNSFwdSentQueries=cgdNSFwdSentQueries, cgdDomainRate4Hr=cgdDomainRate4Hr, cgdTotalRules=cgdTotalRules, cgdSourceAddressPrefixLength=cgdSourceAddressPrefixLength, cgdAnswerPrevStatus=cgdAnswerPrevStatus, ciscoGslbDnsMIBCompliance=ciscoGslbDnsMIBCompliance, ciscoGslbDnsMIBGroups=ciscoGslbDnsMIBGroups, cgdAnswerAddressType=cgdAnswerAddressType, cgdSourceAddressListName=cgdSourceAddressListName, cgdDnsRuleStorageType=cgdDnsRuleStorageType, cgdAnswerGroupRowStatus=cgdAnswerGroupRowStatus, cgdGlobal=cgdGlobal, cgdFirstClauseId=cgdFirstClauseId, PYSNMP_MODULE_ID=ciscoGslbDnsMIB, ciscoGslbDnsGlobalStatsGroup=ciscoGslbDnsGlobalStatsGroup, cgdTotalSourceAddressLists=cgdTotalSourceAddressLists, cgdAnswerGroupEntry=cgdAnswerGroupEntry, cgdAnswerRate4Hr=cgdAnswerRate4Hr, cgdDomainListStorageType=cgdDomainListStorageType, cgdSourceAddressEntry=cgdSourceAddressEntry, cgdAnswerRate1Min=cgdAnswerRate1Min, ciscoGslbDnsDomainGroup=ciscoGslbDnsDomainGroup, cgdDnsQueryRatePeak=cgdDnsQueryRatePeak, cgdDomainRate1Min=cgdDomainRate1Min, cgdAnswerType=cgdAnswerType, cgdClauseId=cgdClauseId, cgdSourceAddressTable=cgdSourceAddressTable, cgdDnsUnmatchedQueries=cgdDnsUnmatchedQueries, cgdDNSRuleDomainList=cgdDNSRuleDomainList, ciscoGslbAnswerEventStatusChange=ciscoGslbAnswerEventStatusChange, cgdAnswerRowStatus=cgdAnswerRowStatus, cgdDnsRuleName=cgdDnsRuleName, ciscoGslbDnsMIB=ciscoGslbDnsMIB, cgdSecondClauseId=cgdSecondClauseId, cgdBoomServSentReqs=cgdBoomServSentReqs, cgdDomain=cgdDomain, cgdGlobalStats=cgdGlobalStats, cgdClauseAnsGrpName=cgdClauseAnsGrpName, ciscoGslbDnsEventClause=ciscoGslbDnsEventClause, cgdAnswer=cgdAnswer, cgdAnswerId=cgdAnswerId, cgdAnswerGrpName=cgdAnswerGrpName, cgdNotifControl=cgdNotifControl, cgdDnsTcpSrcPortErrs=cgdDnsTcpSrcPortErrs, cgdDnsRuleTable=cgdDnsRuleTable, cgdTotalAnswers=cgdTotalAnswers, cgdSourceAddressRate1Min=cgdSourceAddressRate1Min, ciscoGslbDnsNotifControlGroup=ciscoGslbDnsNotifControlGroup, cgdAnswerGroupType=cgdAnswerGroupType, cgdAnswerTable=cgdAnswerTable, cgdDomainName=cgdDomainName, cgdSourceAddressRate4Hr=cgdSourceAddressRate4Hr, cgdDnsAnswerNotifEnable=cgdDnsAnswerNotifEnable, cgdAnswerGroupTable=cgdAnswerGroupTable, cgdSourceAddressHits=cgdSourceAddressHits, cgdAnswerRate5Min=cgdAnswerRate5Min, cgdTotalDomains=cgdTotalDomains, cgdNSFwdRcvdResps=cgdNSFwdRcvdResps, ciscoGslbDnsNotifObjectsGroup=ciscoGslbDnsNotifObjectsGroup, cgdDnsRuleEntry=cgdDnsRuleEntry, cgdSourceAddressId=cgdSourceAddressId, cgdTotalDomainLists=cgdTotalDomainLists, cgdSourceAddressListEntry=cgdSourceAddressListEntry, cgdDomainListName=cgdDomainListName, cgdDnsClauseTrapRateLimit=cgdDnsClauseTrapRateLimit, cgdDroppedDnsClauseNotifs=cgdDroppedDnsClauseNotifs, cgdDomainTable=cgdDomainTable, cgdSourceAddressList=cgdSourceAddressList, cgdSourceAddressRate5Min=cgdSourceAddressRate5Min, cgdAnswerStatus=cgdAnswerStatus, cgdAnswerEntry=cgdAnswerEntry, cgdSourceAddressListTable=cgdSourceAddressListTable, cgdAnswerRate30Min=cgdAnswerRate30Min, cgdDnsUdpSrcPortErrs=cgdDnsUdpSrcPortErrs, cgdDomainRowStatus=cgdDomainRowStatus, cgdDomainListTable=cgdDomainListTable, ciscoGslbDnsRuleGroup=ciscoGslbDnsRuleGroup, cgdSourceAddressStorageType=cgdSourceAddressStorageType, cgdDnsQueryRateCurrent=cgdDnsQueryRateCurrent, cgdAnswerHits=cgdAnswerHits, cgdDnsRcvdHostAddrQueries=cgdDnsRcvdHostAddrQueries, cgdAnswerAdminState=cgdAnswerAdminState, cgdAnsTrapRateLimit=cgdAnsTrapRateLimit, cgdSourceAddressAddress=cgdSourceAddressAddress, cgdDnsRule=cgdDnsRule, cgdSourceAddressListRowStatus=cgdSourceAddressListRowStatus, cgdDomainListRowStatus=cgdDomainListRowStatus, cgdClauseStorageType=cgdClauseStorageType, cgdProxLkupRcvdResps=cgdProxLkupRcvdResps, cgdTotalSourceAddresses=cgdTotalSourceAddresses, cgdAnswerGroupStorageType=cgdAnswerGroupStorageType, ciscoGslbDnsGlobalGroup=ciscoGslbDnsGlobalGroup, cgdSourceAddressAddressType=cgdSourceAddressAddressType, ciscoGslbDnsGlobalNotifStatsGroup=ciscoGslbDnsGlobalNotifStatsGroup, cgdClauseEntry=cgdClauseEntry, cgdDomainEntry=cgdDomainEntry, cgdAnswerGroupName=cgdAnswerGroupName, ciscoGslbDnsMIBObjects=ciscoGslbDnsMIBObjects, ciscoGslbDnsSourceAddGroup=ciscoGslbDnsSourceAddGroup, cgdDroppedAnsNotifs=cgdDroppedAnsNotifs, cgdDomainId=cgdDomainId, cgdAnswerAddress=cgdAnswerAddress, cgdSourceAdd=cgdSourceAdd, cgdSourceAddressListStorageType=cgdSourceAddressListStorageType, ciscoGslbDnsGlobalRateLimitGroup=ciscoGslbDnsGlobalRateLimitGroup, cgdDnsPollSockErrs=cgdDnsPollSockErrs, cgdDnsClauseNotifEnable=cgdDnsClauseNotifEnable, cgdDomainRate30Min=cgdDomainRate30Min, cgdDomainHits=cgdDomainHits, cgdDomainList=cgdDomainList, ciscoGslbDnsMIBCompliances=ciscoGslbDnsMIBCompliances, ciscoGslbDnsMIBNotifs=ciscoGslbDnsMIBNotifs)
