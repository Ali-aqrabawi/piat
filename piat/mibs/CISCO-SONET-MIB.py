...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-SONET-MIB
...
iso, Bits, Counter64, TimeTicks, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Counter64", "TimeTicks", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "MibIdentifier")
TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention")
sonetSectionCurrentStatus, sonetVTCurrentStatus, sonetPathCurrentStatus, sonetLineCurrentStatus, sonetPathCurrentEntry = mibBuilder.importSymbols("SONET-MIB", "sonetSectionCurrentStatus", "sonetVTCurrentStatus", "sonetPathCurrentStatus", "sonetLineCurrentStatus", "sonetPathCurrentEntry")
...
mibBuilder.exportSymbols("CISCO-SONET-MIB", cspTotalSESs=cspTotalSESs, csApsChannelProtocol=csApsChannelProtocol, cspRFIs=cspRFIs, csApsFailureStatus=csApsFailureStatus, cspFarEndTotalTable=cspFarEndTotalTable, csConfigRDIPType=csConfigRDIPType, ciscoSonetMIBNotifs=ciscoSonetMIBNotifs, ciscoSonetMIB=ciscoSonetMIB, cssTotalESs=cssTotalESs, cslTotalESs=cslTotalESs, cslRFIs=cslRFIs, cssTraceToExpect=cssTraceToExpect, ciscoSonetMIBCompliance=ciscoSonetMIBCompliance, ciscoSonetMIBCompliances=ciscoSonetMIBCompliances, ciscoSonetMIBObjects=ciscoSonetMIBObjects, csSignallingTransportMode=csSignallingTransportMode, ciscoSonetMIBCompliance1=ciscoSonetMIBCompliance1, csApsLineSwitchReason=csApsLineSwitchReason, cspTributaryMappingType=cspTributaryMappingType, cspTraceToExpect=cspTraceToExpect, csAu4Tug3Config=csAu4Tug3Config, csApsPrimarySection=csApsPrimarySection, CsApsLineFailureCode=CsApsLineFailureCode, cspTotalEntry=cspTotalEntry, cssLOSs=cssLOSs, cspTotalUASs=cspTotalUASs, cspSonetPathPayload=cspSonetPathPayload, csApsSwitchReason=csApsSwitchReason, csStatsEntry=csStatsEntry, cspConfig=cspConfig, cssLOFs=cssLOFs, cspFarEndTotalESs=cspFarEndTotalESs, csApsActiveLine=csApsActiveLine, csApsProtectionIndex=csApsProtectionIndex, csApsDirectionOperational=csApsDirectionOperational, csAu4Tug3=csAu4Tug3, cspTotalESs=cspTotalESs, cspTotalCVs=cspTotalCVs, ciscoSonetPathConfMIBGroup=ciscoSonetPathConfMIBGroup, cssTraceReceived=cssTraceReceived, cslFarEndTotalUASs=cslFarEndTotalUASs, ciscoSonetConfMIBGroup=ciscoSonetConfMIBGroup, ciscoSonetSectionStatusChange=ciscoSonetSectionStatusChange, csApsConfig=csApsConfig, cspTotalTable=cspTotalTable, ciscoSonetPathNotifGroup=ciscoSonetPathNotifGroup, csAu4Tug3ConfigEntry=csAu4Tug3ConfigEntry, csNotifications=csNotifications, ciscoSonetPathConfMIBGroup1=ciscoSonetPathConfMIBGroup1, csAu4Tug3Payload=csAu4Tug3Payload, cspTraceFailure=cspTraceFailure, ciscoSonetSectionNotifGroup=ciscoSonetSectionNotifGroup, cssTraceTable=cssTraceTable, csApsEnable=csApsEnable, csApsDirection=csApsDirection, ciscoSonetVTConfMIBGroup=ciscoSonetVTConfMIBGroup, ciscoSonetTraceMIBGroup=ciscoSonetTraceMIBGroup, csTributaryMappingType=csTributaryMappingType, csApsRevertive=csApsRevertive, ciscoSonetLineStatusChange=ciscoSonetLineStatusChange, ciscoSonetConfMIBGroup1=ciscoSonetConfMIBGroup1, csConfigTable=csConfigTable, cssTraceFailure=cssTraceFailure, cssTotalSESs=cssTotalSESs, ciscoSonetMIBCompliance3=ciscoSonetMIBCompliance3, cslTotalUASs=cslTotalUASs, csVTConfigEntry=csVTConfigEntry, cspTraceReceived=cspTraceReceived, csConfigFrameScramble=csConfigFrameScramble, cspFarEndTotalSESs=cspFarEndTotalSESs, cspTraceTable=cspTraceTable, cspTributaryGroupingType=cspTributaryGroupingType, cssTraceEntry=cssTraceEntry, cslAISs=cslAISs, cspSignallingTransportMode=cspSignallingTransportMode, ciscoSonetVTStatusChange=ciscoSonetVTStatusChange, csNotificationsEnabled=csNotificationsEnabled, csApsConfigEntry=csApsConfigEntry, csApsWaitToRestore=csApsWaitToRestore, csApsWorkingIndex=csApsWorkingIndex, csStatsTable=csStatsTable, cslTotalEntry=cslTotalEntry, cspFarEndTotalUASs=cspFarEndTotalUASs, csApsSigFaultBER=csApsSigFaultBER, cssTotalSEFSs=cssTotalSEFSs, ciscoSonetApsMIBGroup=ciscoSonetApsMIBGroup, CsApsLineFailureStatus=CsApsLineFailureStatus, csApsLineFailureCode=csApsLineFailureCode, csConfigLoopbackType=csConfigLoopbackType, cslTotalTable=cslTotalTable, cslFarEndTotalSESs=cslFarEndTotalSESs, cspConfigTable=cspConfigTable, ciscoSonetNotifEnableGroup=ciscoSonetNotifEnableGroup, csSection=csSection, cssTraceToTransmit=cssTraceToTransmit, cslFarEndTotalCVs=cslFarEndTotalCVs, csApsSigDegradeBER=csApsSigDegradeBER, cslFarEndTotalEntry=cslFarEndTotalEntry, csApsArchModeOperational=csApsArchModeOperational, cslFarEndTotalTable=cslFarEndTotalTable, cspTraceEntry=cspTraceEntry, cspConfigEntry=cspConfigEntry, csTributaryType=csTributaryType, ciscoSonetVTNotifGroup=ciscoSonetVTNotifGroup, cslTotalSESs=cslTotalSESs, ciscoSonetMIBGroups=ciscoSonetMIBGroups, ciscoSonetMIBCompliance2=ciscoSonetMIBCompliance2, csConfigXmtClockSource=csConfigXmtClockSource, cssTotalEntry=cssTotalEntry, csApsArchMode=csApsArchMode, CsApsLineSwitchReason=CsApsLineSwitchReason, csVTConfigTable=csVTConfigTable, ciscoSonetPathStatusChange=ciscoSonetPathStatusChange, cspFarEndTotalCVs=cspFarEndTotalCVs, csLine=csLine, csTributaryFramingType=csTributaryFramingType, csTributaryGroupingType=csTributaryGroupingType, ciscoSonetLineNotifGroup=ciscoSonetLineNotifGroup, cspAISs=cspAISs, cspTraceToTransmit=cspTraceToTransmit, csConfigRDIVType=csConfigRDIVType, csConfigEntry=csConfigEntry, ciscoSonetStatsMIBGroup=ciscoSonetStatsMIBGroup, ciscoSonetAu4Tug3Group=ciscoSonetAu4Tug3Group, cslFarEndTotalESs=cslFarEndTotalESs, ciscoSonetMIBConformance=ciscoSonetMIBConformance, csConfigType=csConfigType, csApsConfigTable=csApsConfigTable, ciscoSonetApsMIBGroup1=ciscoSonetApsMIBGroup1, csPath=csPath, csStats=csStats, csConfig=csConfig, cssTotalCVs=cssTotalCVs, cssTotalTable=cssTotalTable, cslTotalCVs=cslTotalCVs, PYSNMP_MODULE_ID=ciscoSonetMIB, csAu4Tug3ConfigTable=csAu4Tug3ConfigTable, cspFarEndTotalEntry=cspFarEndTotalEntry)
