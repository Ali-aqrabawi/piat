...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-PSD-CLIENT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:43:13 2019
...
Integer32, MibIdentifier, Bits, IpAddress, iso, ObjectIdentity, NotificationType, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Bits", "IpAddress", "iso", "ObjectIdentity", "NotificationType", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("CISCO-PSD-CLIENT-MIB", ciscoPsdClientNotifInfo=ciscoPsdClientNotifInfo, cPsdClientDSDiskFullTrans=cPsdClientDSDiskFullTrans, cPsdClientDSRdWrRetrans=cPsdClientDSRdWrRetrans, cPsdClientMIBCompliance=cPsdClientMIBCompliance, ciscoPsdClientMIB=ciscoPsdClientMIB, cPsdClientUpNotif=cPsdClientUpNotif, cPsdClientMIBNotifMgmtGroup=cPsdClientMIBNotifMgmtGroup, cPsdClientMIBConfigurationsGroup=cPsdClientMIBConfigurationsGroup, cPsdClientDSServerRowStatus=cPsdClientDSServerRowStatus, cPsdClientMIBStatisticsGroup=cPsdClientMIBStatisticsGroup, cPsdClientNotifEnable=cPsdClientNotifEnable, PYSNMP_MODULE_ID=ciscoPsdClientMIB, ciscoPsdClientMIBConform=ciscoPsdClientMIBConform, cPsdClientDSServerAddressType=cPsdClientDSServerAddressType, ciscoPsdClientStatistics=ciscoPsdClientStatistics, cPsdClientDownNotif=cPsdClientDownNotif, cPsdClientDSEntry=cPsdClientDSEntry, cPsdClientMIBNotifInfoGroup=cPsdClientMIBNotifInfoGroup, ciscoPsdClientMIBObjects=ciscoPsdClientMIBObjects, ciscoPsdClientNotifMgmt=ciscoPsdClientNotifMgmt, cPsdClientNotifDSServerAddrType=cPsdClientNotifDSServerAddrType, cPsdClientDSMaxRetrieve=cPsdClientDSMaxRetrieve, cPsdClientDSServerTable=cPsdClientDSServerTable, cPsdClientDSRowStatus=cPsdClientDSRowStatus, cPsdClientNotifDSServerAddress=cPsdClientNotifDSServerAddress, cPsdClientMIBNotifGroup=cPsdClientMIBNotifGroup, ciscoPsdClientMIBNotifs=ciscoPsdClientMIBNotifs, cPsdClientDSRetrieveOnly=cPsdClientDSRetrieveOnly, cPsdClientDSServerEntry=cPsdClientDSServerEntry, cPsdClientMIBGroups=cPsdClientMIBGroups, cPsdClientDSAutoRetrieve=cPsdClientDSAutoRetrieve, cPsdClientDSWriteReq=cPsdClientDSWriteReq, cPsdClientDSServerAddress=cPsdClientDSServerAddress, cPsdClientDiskFullNotif=cPsdClientDiskFullNotif, cPsdClientMIBCompliances=cPsdClientMIBCompliances, ciscoPsdClientConfigurations=ciscoPsdClientConfigurations, cPsdClientDSName=cPsdClientDSName, cPsdClientDSReadReq=cPsdClientDSReadReq, cPsdClientDSTable=cPsdClientDSTable)
