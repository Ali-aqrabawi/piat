...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-GPRS-GTP-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:43:42 2019
...
iso, NotificationType, Unsigned32, ModuleIdentity, ObjectIdentity, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Counter64, MibIdentifier, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Counter64", "MibIdentifier", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("CISCO-GPRS-GTP-MIB", cgprsGtpDroppedPktsCnt=cgprsGtpDroppedPktsCnt, ciscoGprsGtpConfig=ciscoGprsGtpConfig, cgprsGtpAPNName=cgprsGtpAPNName, cgprsGtpGgsnStatsGroup=cgprsGtpGgsnStatsGroup, cgprsGtpChargingGWName=cgprsGtpChargingGWName, cgprsGtpN3BufferSize=cgprsGtpN3BufferSize, cgprsGtpChargingGWTable=cgprsGtpChargingGWTable, cgprsGtpMaxNumPDPCxts=cgprsGtpMaxNumPDPCxts, cgprsGtpNoRespToEchoNotifEnable=cgprsGtpNoRespToEchoNotifEnable, cgprsGtpChargingGWid=cgprsGtpChargingGWid, cgprsGtpChargingGWRowStatus=cgprsGtpChargingGWRowStatus, cgprsGtpCurMTForPremiumQos=cgprsGtpCurMTForPremiumQos, cgprsGtpGSNid=cgprsGtpGSNid, cgprsGtpGSNTable=cgprsGtpGSNTable, cgprsGtpCurMTForNormalQos=cgprsGtpCurMTForNormalQos, cgprsGtpChargingGWOperState=cgprsGtpChargingGWOperState, cgprsGtpAPNId=cgprsGtpAPNId, cgprsGtpGSNidOfLastUnexpPDPCxt=cgprsGtpGSNidOfLastUnexpPDPCxt, cgprsGtpGSNPathRecoveredNotif=cgprsGtpGSNPathRecoveredNotif, cgprsGtpPDPCxtActivationRejNotif=cgprsGtpPDPCxtActivationRejNotif, cgprsGtpSecondaryChargingGWUpNotif=cgprsGtpSecondaryChargingGWUpNotif, cgprsGtpGeneralConfig=cgprsGtpGeneralConfig, cgprsGtpSecondaryChargingGWDownNotif=cgprsGtpSecondaryChargingGWDownNotif, cgprsGtpChargingGWEntry=cgprsGtpChargingGWEntry, cgprsGtpChargingGWNotifEnable=cgprsGtpChargingGWNotifEnable, cgprsGtpTotalPktsDropped=cgprsGtpTotalPktsDropped, cgprsGtpTotalNumAllocIpAddr=cgprsGtpTotalNumAllocIpAddr, cgprsGtpCurGSNBandwidthResrcUsed=cgprsGtpCurGSNBandwidthResrcUsed, cgprsGtpGSNEchoFailedNotifCnt=cgprsGtpGSNEchoFailedNotifCnt, cgprsGtpLastGSNidNoRespToEcho=cgprsGtpLastGSNidNoRespToEcho, ciscoGprsGtpConformances=ciscoGprsGtpConformances, cgprsGtpNumAllocIpAddrTable=cgprsGtpNumAllocIpAddrTable, cgprsGtpGgsnStats=cgprsGtpGgsnStats, cgprsGtpRejReasonOfLastUnexpPDPCxt=cgprsGtpRejReasonOfLastUnexpPDPCxt, cgprsGtpCompliance=cgprsGtpCompliance, cgprsGtpN3Request=cgprsGtpN3Request, ciscoGprsGtpMIB=ciscoGprsGtpMIB, cgprsGtpAPNTable=cgprsGtpAPNTable, cgprsGtpAPNRowStatus=cgprsGtpAPNRowStatus, cgprsGtpAPNEntry=cgprsGtpAPNEntry, cgprsGtpGroups=cgprsGtpGroups, cgprsGtpGgsnStatusGroup=cgprsGtpGgsnStatusGroup, cgprsGtpGeneralStatsGroup=cgprsGtpGeneralStatsGroup, cgprsGtpTIDOfLastUnexpPDPCxt=cgprsGtpTIDOfLastUnexpPDPCxt, cgprsGtpChargingGWType=cgprsGtpChargingGWType, cgprsGtpGSNTotalBandwidthResrc=cgprsGtpGSNTotalBandwidthResrc, cgprsGtpGSNEntry=cgprsGtpGSNEntry, cgprsGtpCompliances=cgprsGtpCompliances, cgprsGtpChargingMsgCnt=cgprsGtpChargingMsgCnt, cgprsGtpNumAllocIpAddrEntry=cgprsGtpNumAllocIpAddrEntry, cgprsGtpGeneralStats=cgprsGtpGeneralStats, cgprsGtpT3TunnelTimer=cgprsGtpT3TunnelTimer, cgprsGtpGgsnStatus=cgprsGtpGgsnStatus, ciscoGprsGtpNotifPrefix=ciscoGprsGtpNotifPrefix, cgprsGtpDroppedPktsTimeFrame=cgprsGtpDroppedPktsTimeFrame, cgprsGtpDroppedPktsMonTime=cgprsGtpDroppedPktsMonTime, cgprsGtpCurActivatedPDPCxtsCnt=cgprsGtpCurActivatedPDPCxtsCnt, cgprsGtpGgsnNotifGroup=cgprsGtpGgsnNotifGroup, cgprsGtpCurMTForBestEffortQos=cgprsGtpCurMTForBestEffortQos, cgprsGtpPrimaryChargingGWDownNotif=cgprsGtpPrimaryChargingGWDownNotif, ciscoGprsGtpMIBObjects=ciscoGprsGtpMIBObjects, cgprsGtpGeneralConfigGroup=cgprsGtpGeneralConfigGroup, cgprsGtpT3ResponseTimer=cgprsGtpT3ResponseTimer, PYSNMP_MODULE_ID=ciscoGprsGtpMIB, cgprsGtpPDPCxtActRejNotifEnable=cgprsGtpPDPCxtActRejNotifEnable, cgprsGtpCurRejPDPCxtActivationCnt=cgprsGtpCurRejPDPCxtActivationCnt, cgprsGtpPrimaryChargingGWUpNotif=cgprsGtpPrimaryChargingGWUpNotif, cgprsGtpLastGSNidRecovered=cgprsGtpLastGSNidRecovered, cgprsGtpGSNPathFailedNotif=cgprsGtpGSNPathFailedNotif, cgprsGtpVersion=cgprsGtpVersion, cgprsGtpCurUnexpRxGpduCnt=cgprsGtpCurUnexpRxGpduCnt, ciscoGprsGtpStats=ciscoGprsGtpStats, cgprsGtpGgsnConfigGroup=cgprsGtpGgsnConfigGroup, cgprsGtpNumAllocIpAddr=cgprsGtpNumAllocIpAddr, cgprsGtpEchoRequestTimer=cgprsGtpEchoRequestTimer, ciscoGprsGtpNotifs=ciscoGprsGtpNotifs, cgprsGtpAPNAddrAllocMethodGlobDef=cgprsGtpAPNAddrAllocMethodGlobDef, cgprsGtpCurRxPacketQueueSize=cgprsGtpCurRxPacketQueueSize, cgprsGtpAPNAddrAllocMethod=cgprsGtpAPNAddrAllocMethod, cgprsGtpGgsnConfig=cgprsGtpGgsnConfig)
