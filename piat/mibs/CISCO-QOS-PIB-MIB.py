...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-QOS-PIB-MIB
...
ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Unsigned32, Bits, TimeTicks, ModuleIdentity, Integer32, MibIdentifier, NotificationType, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Unsigned32", "Bits", "TimeTicks", "ModuleIdentity", "Integer32", "MibIdentifier", "NotificationType", "iso", "Counter32")
...
mibBuilder.exportSymbols("CISCO-QOS-PIB-MIB", PYSNMP_MODULE_ID=ciscoQosPIBMIB, qosDiffServMappingEntry=qosDiffServMappingEntry, qosIpAceId=qosIpAceId, qosCosToDscpCos=qosCosToDscpCos, qosPolicerEntry=qosPolicerEntry, qosPolicerId=qosPolicerId, qosUnmatchedPolicyTableGroup=qosUnmatchedPolicyTableGroup, qosIpAclMicroFlowPolicerId=qosIpAclMicroFlowPolicerId, qosL2Cos=qosL2Cos, qosIpAclAggregateId=qosIpAclAggregateId, qosIfTailDropNumThresholdSets=qosIfTailDropNumThresholdSets, qosMacClassificationTableGroup=qosMacClassificationTableGroup, qosIpAceTableGroup=qosIpAceTableGroup, qosIfDscpRoles=qosIfDscpRoles, qosIfWeightsRoles=qosIfWeightsRoles, qosIfRedTableGroup=qosIfRedTableGroup, qosMacClassificationTable=qosMacClassificationTable, Unsigned64=Unsigned64, qosIfThresholdSet=qosIfThresholdSet, qosUnmatchedPolicyDscp=qosUnmatchedPolicyDscp, qosIfSchedulingPreferenceId=qosIfSchedulingPreferenceId, qosPIBCompliances=qosPIBCompliances, qosDiffServMappingTable=qosDiffServMappingTable, qosIpAceTable=qosIpAceTable, qosIfDropPreference=qosIfDropPreference, qosIfTailDropTable=qosIfTailDropTable, qosUnmatchedPolicyDscpTrusted=qosUnmatchedPolicyDscpTrusted, qosIfSchedulingDiscipline=qosIfSchedulingDiscipline, qosIpAclId=qosIpAclId, qosIfSchedulingPreference=qosIfSchedulingPreference, qosIpAceOrder=qosIpAceOrder, qosIpAclDscp=qosIpAclDscp, qosIfRedTable=qosIfRedTable, qosIpAclActionTable=qosIpAclActionTable, ciscoQosPIBMIB=ciscoQosPIBMIB, qosIfRedRoles=qosIfRedRoles, qosCosToDscpEntry=qosCosToDscpEntry, qosMarkedDscp=qosMarkedDscp, qosIfRedThresholdSet=qosIfRedThresholdSet, qosPolicerTableGroup=qosPolicerTableGroup, qosUnmatchedPolicyAggregateId=qosUnmatchedPolicyAggregateId, qosIpAclInterfaceRoles=qosIpAclInterfaceRoles, qosIfDropPreferenceTableGroup=qosIfDropPreferenceTableGroup, qosUnmatchedPolicyDirection=qosUnmatchedPolicyDirection, qosPolicerRate=qosPolicerRate, qosIpAceSrcAddrMask=qosIpAceSrcAddrMask, qosIpAclActionId=qosIpAclActionId, qosIfDropPreferenceEntry=qosIfDropPreferenceEntry, qosInterfaceTypeTableGroup=qosInterfaceTypeTableGroup, qosIpAceDstL4PortMax=qosIpAceDstL4PortMax, qosIfRedThresholdSetUpper=qosIfRedThresholdSetUpper, RoleCombination=RoleCombination, qosIfRedNumThresholdSets=qosIfRedNumThresholdSets, Dscp=Dscp, qosDevicePibIncarnationEntry=qosDevicePibIncarnationEntry, qosIpAceSrcL4PortMin=qosIpAceSrcL4PortMin, ThresholdSetRange=ThresholdSetRange, qosDevicePepDomain=qosDevicePepDomain, qosPolicerTable=qosPolicerTable, qosIpAceEntry=qosIpAceEntry, qosIpAclInterfaceDirection=qosIpAclInterfaceDirection, qosIpAclDefAceId=qosIpAclDefAceId, qosIpAceSrcL4PortMax=qosIpAceSrcL4PortMax, qosUnmatchedPolicyId=qosUnmatchedPolicyId, qosPolicer=qosPolicer, qosIpAclDefinitionTableGroup=qosIpAclDefinitionTableGroup, qosDevicePibIncarnationTable=qosDevicePibIncarnationTable, qosDevicePibTtl=qosDevicePibTtl, qosDscp=qosDscp, qosDeviceCapabilities=qosDeviceCapabilities, qosIfDscpAssignmentId=qosIfDscpAssignmentId, qosMacQos=qosMacQos, qosAggregateTableGroup=qosAggregateTableGroup, Percent=Percent, qosDevicePibIncarnation=qosDevicePibIncarnation, qosIpAclDscpTrusted=qosIpAclDscpTrusted, qosInterfaceTypeRoles=qosInterfaceTypeRoles, qosIfTailDropThresholdSetValue=qosIfTailDropThresholdSetValue, qosDeviceAttributeTableGroup=qosDeviceAttributeTableGroup, qosIfSchedulingPreferenceEntry=qosIfSchedulingPreferenceEntry, qosIfTailDropThresholdSet=qosIfTailDropThresholdSet, qosUnmatchedPolicy=qosUnmatchedPolicy, qosAggregatePolicerId=qosAggregatePolicerId, qosIfQueue=qosIfQueue, qosPIBConformance=qosPIBConformance, qosDevicePdpName=qosDevicePdpName, qosUnmatchedPolicyEntry=qosUnmatchedPolicyEntry, qosInterfaceTypeEntry=qosInterfaceTypeEntry, qosIfRedThresholdSetLower=qosIfRedThresholdSetLower, qosDomainConfig=qosDomainConfig, qosIpAclDefinitionTable=qosIpAclDefinitionTable, qosDeviceAttributeTable=qosDeviceAttributeTable, qosDevicePrimaryPdp=qosDevicePrimaryPdp, qosIfWeightsEntry=qosIfWeightsEntry, qosPIBGroups=qosPIBGroups, qosIfDropPreferenceTable=qosIfDropPreferenceTable, qosIfSchedulingPreferencesTableGroup=qosIfSchedulingPreferencesTableGroup, qosIpAceDstL4PortMin=qosIpAceDstL4PortMin, qosIfDscpAssignmentTable=qosIfDscpAssignmentTable, qosIfDscp=qosIfDscp, qosPIBCompliance=qosPIBCompliance, qosIpAceDscpMin=qosIpAceDscpMin, qosCosToDscpTableGroup=qosCosToDscpTableGroup, qosDeviceIncarnationId=qosDeviceIncarnationId, qosCosToDscpDscp=qosCosToDscpDscp, qosInterfaceTypeCapabilities=qosInterfaceTypeCapabilities, qosIfDropRoles=qosIfDropRoles, QosInterfaceTypeCapabilities=QosInterfaceTypeCapabilities, qosIfWeightsTableGroup=qosIfWeightsTableGroup, qosAggregateId=qosAggregateId, qosIpAclActionEntry=qosIpAclActionEntry, qosDeviceAttributeEntry=qosDeviceAttributeEntry, qosMacClassificationId=qosMacClassificationId, qosIfWeightsDrainSize=qosIfWeightsDrainSize, qosIpAclDefinitionId=qosIpAclDefinitionId, qosDstMacVlan=qosDstMacVlan, qosIfTailDropRoles=qosIfTailDropRoles, qosDeviceMaxMessageSize=qosDeviceMaxMessageSize, qosIpQos=qosIpQos, qosIfParameters=qosIfParameters, qosPolicerExcessBurst=qosPolicerExcessBurst, qosDiffServMappingTableGroup=qosDiffServMappingTableGroup, qosPolicerNormalBurst=qosPolicerNormalBurst, qosDeviceAttributeId=qosDeviceAttributeId, qosPolicerAction=qosPolicerAction, qosIfDropPreferenceId=qosIfDropPreferenceId, QosInterfaceQueueType=QosInterfaceQueueType, qosIpAceDscpMax=qosIpAceDscpMax, qosUnmatchedPolicyTable=qosUnmatchedPolicyTable, qosIfRedEntry=qosIfRedEntry, qosIpAclDefinitionEntry=qosIpAclDefinitionEntry, qosIfWeightsTable=qosIfWeightsTable, qosIfTailDropId=qosIfTailDropId, QueueRange=QueueRange, qosDeviceSecondaryPdp=qosDeviceSecondaryPdp, qosAggregateEntry=qosAggregateEntry, qosUnmatchedPolicyRole=qosUnmatchedPolicyRole, qosIpAceDstAddrMask=qosIpAceDstAddrMask, PolicyInstanceId=PolicyInstanceId, qosIfDscpAssignmentTableGroup=qosIfDscpAssignmentTableGroup, qosIfSchedulingRoles=qosIfSchedulingRoles, qosCosToDscpTable=qosCosToDscpTable, qosDevicePibIncarnationTableGroup=qosDevicePibIncarnationTableGroup, qosIpAclActionTableGroup=qosIpAclActionTableGroup, qosIfTailDropEntry=qosIfTailDropEntry, QosLayer2Cos=QosLayer2Cos, qosInterfaceTypeTable=qosInterfaceTypeTable, qosIfWeightsNumQueues=qosIfWeightsNumQueues, qosIfWeightsId=qosIfWeightsId, qosUnmatchPolMicroFlowPolicerId=qosUnmatchPolMicroFlowPolicerId, qosInterfaceTypeId=qosInterfaceTypeId, qosMacClassificationEntry=qosMacClassificationEntry, qosDstMacAddress=qosDstMacAddress, qosIfQueueType=qosIfQueueType, qosIfSchedulingQueueType=qosIfSchedulingQueueType, qosIpAclOrder=qosIpAclOrder, qosIfDscpAssignmentEntry=qosIfDscpAssignmentEntry, qosIfTailDropTableGroup=qosIfTailDropTableGroup, qosDeviceConfig=qosDeviceConfig, qosDstMacCos=qosDstMacCos, qosIpAceDstAddr=qosIpAceDstAddr, qosInterfaceQueueType=qosInterfaceQueueType, qosIpAceProtocol=qosIpAceProtocol, qosIfSchedulingPreferencesTable=qosIfSchedulingPreferencesTable, qosIfRedId=qosIfRedId, qosIfWeightsQueueSize=qosIfWeightsQueueSize, qosIpAceSrcAddr=qosIpAceSrcAddr, qosIfDropDiscipline=qosIfDropDiscipline, qosIpAclActAclId=qosIpAclActAclId, qosAggregateTable=qosAggregateTable, qosIpAcePermit=qosIpAcePermit, qosIfWeightsQueue=qosIfWeightsQueue)
