...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/RFC1406-MIB
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, IpAddress, MibIdentifier, ModuleIdentity, transmission, Integer32, ObjectIdentity, iso, Gauge32, TimeTicks, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity", "transmission", "Integer32", "ObjectIdentity", "iso", "Gauge32", "TimeTicks", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("RFC1406-MIB", dsx1SendCode=dsx1SendCode, dsx1LineStatus=dsx1LineStatus, dsx1CurrentDMs=dsx1CurrentDMs, dsx1FarEndTotalSEFSs=dsx1FarEndTotalSEFSs, dsx1CurrentPCVs=dsx1CurrentPCVs, dsx1FarEndCurrentESs=dsx1FarEndCurrentESs, dsx1CurrentIndex=dsx1CurrentIndex, dsx1FarEndCurrentSEFSs=dsx1FarEndCurrentSEFSs, dsx1FarEndIntervalIndex=dsx1FarEndIntervalIndex, dsx1TotalBESs=dsx1TotalBESs, dsx1LineIndex=dsx1LineIndex, dsx1FarEndTotalDMs=dsx1FarEndTotalDMs, dsx1CurrentBESs=dsx1CurrentBESs, dsx1FarEndTimeElapsed=dsx1FarEndTimeElapsed, dsx1FarEndIntervalLESs=dsx1FarEndIntervalLESs, dsx1IntervalNumber=dsx1IntervalNumber, dsx1IntervalIndex=dsx1IntervalIndex, dsx1IntervalUASs=dsx1IntervalUASs, dsx1FracTable=dsx1FracTable, dsx1CurrentSESs=dsx1CurrentSESs, dsx1FracEntry=dsx1FracEntry, dsx1FarEndIntervalSESs=dsx1FarEndIntervalSESs, dsx1TransmitClockSource=dsx1TransmitClockSource, dsx1FarEndIntervalEntry=dsx1FarEndIntervalEntry, dsx1FarEndIntervalESs=dsx1FarEndIntervalESs, dsx1FarEndTotalIndex=dsx1FarEndTotalIndex, dsx1TotalESs=dsx1TotalESs, dsx1FarEndTotalUASs=dsx1FarEndTotalUASs, dsx1SignalMode=dsx1SignalMode, dsx1FracIndex=dsx1FracIndex, dsx1TotalDMs=dsx1TotalDMs, dsx1FarEndCurrentLESs=dsx1FarEndCurrentLESs, dsx1FarEndCurrentCSSs=dsx1FarEndCurrentCSSs, dsx1TotalCSSs=dsx1TotalCSSs, dsx1TotalLCVs=dsx1TotalLCVs, dsx1CurrentUASs=dsx1CurrentUASs, dsx1FarEndTotalLESs=dsx1FarEndTotalLESs, dsx1CircuitIdentifier=dsx1CircuitIdentifier, dsx1FarEndIntervalDMs=dsx1FarEndIntervalDMs, dsx1FarEndTotalCSSs=dsx1FarEndTotalCSSs, dsx1ConfigTable=dsx1ConfigTable, dsx1FarEndCurrentIndex=dsx1FarEndCurrentIndex, dsx1FarEndIntervalTable=dsx1FarEndIntervalTable, dsx1IntervalSESs=dsx1IntervalSESs, dsx1IntervalEntry=dsx1IntervalEntry, dsx1TotalLESs=dsx1TotalLESs, dsx1CurrentCSSs=dsx1CurrentCSSs, dsx1IfIndex=dsx1IfIndex, dsx1CurrentLESs=dsx1CurrentLESs, dsx1CurrentTable=dsx1CurrentTable, dsx1ValidIntervals=dsx1ValidIntervals, dsx1TimeElapsed=dsx1TimeElapsed, dsx1FarEndTotalSESs=dsx1FarEndTotalSESs, dsx1FarEndTotalEntry=dsx1FarEndTotalEntry, dsx1FarEndCurrentPCVs=dsx1FarEndCurrentPCVs, dsx1TotalIndex=dsx1TotalIndex, dsx1Fdl=dsx1Fdl, dsx1FracNumber=dsx1FracNumber, dsx1CurrentSEFSs=dsx1CurrentSEFSs, dsx1TotalSEFSs=dsx1TotalSEFSs, dsx1CurrentLCVs=dsx1CurrentLCVs, dsx1LineType=dsx1LineType, dsx1IntervalDMs=dsx1IntervalDMs, dsx1FracIfIndex=dsx1FracIfIndex, dsx1CurrentESs=dsx1CurrentESs, dsx1FarEndIntervalSEFSs=dsx1FarEndIntervalSEFSs, dsx1FarEndCurrentDMs=dsx1FarEndCurrentDMs, dsx1IntervalTable=dsx1IntervalTable, dsx1FarEndTotalESs=dsx1FarEndTotalESs, dsx1FarEndCurrentUASs=dsx1FarEndCurrentUASs, dsx1IntervalLESs=dsx1IntervalLESs, dsx1FarEndIntervalNumber=dsx1FarEndIntervalNumber, dsx1IntervalPCVs=dsx1IntervalPCVs, dsx1FarEndCurrentTable=dsx1FarEndCurrentTable, dsx1IntervalLCVs=dsx1IntervalLCVs, dsx1TotalTable=dsx1TotalTable, dsx1FarEndTotalBESs=dsx1FarEndTotalBESs, dsx1LoopbackConfig=dsx1LoopbackConfig, dsx1TotalPCVs=dsx1TotalPCVs, dsx1FarEndTotalPCVs=dsx1FarEndTotalPCVs, dsx1IntervalSEFSs=dsx1IntervalSEFSs, dsx1CurrentEntry=dsx1CurrentEntry, ds1=ds1, dsx1FarEndTotalTable=dsx1FarEndTotalTable, dsx1TotalSESs=dsx1TotalSESs, dsx1FarEndIntervalBESs=dsx1FarEndIntervalBESs, dsx1FarEndIntervalUASs=dsx1FarEndIntervalUASs, dsx1FarEndValidIntervals=dsx1FarEndValidIntervals, dsx1LineCoding=dsx1LineCoding, dsx1FarEndIntervalPCVs=dsx1FarEndIntervalPCVs, dsx1TotalEntry=dsx1TotalEntry, dsx1IntervalCSSs=dsx1IntervalCSSs, dsx1FarEndCurrentSESs=dsx1FarEndCurrentSESs, dsx1FarEndIntervalCSSs=dsx1FarEndIntervalCSSs, dsx1TotalUASs=dsx1TotalUASs, dsx1ConfigEntry=dsx1ConfigEntry, dsx1FarEndCurrentEntry=dsx1FarEndCurrentEntry, dsx1IntervalESs=dsx1IntervalESs, dsx1FarEndCurrentBESs=dsx1FarEndCurrentBESs, dsx1IntervalBESs=dsx1IntervalBESs)
