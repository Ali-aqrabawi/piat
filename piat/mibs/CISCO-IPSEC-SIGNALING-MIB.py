...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IPSEC-SIGNALING-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:44:03 2019
...
CIPsecTunnelStatus, CIPsecPhase1PeerIdentityType, CIPsecEncryptAlgorithm, CIPsecPhase1TunnelIndex, CIPsecControlProtocol, CIPsecIkeAuthMethod, CIPsecEncryptionKeySize, CIPsecIkeHashAlgorithm = mibBuilder.importSymbols("CISCO-IPSEC-TC", "CIPsecTunnelStatus", "CIPsecPhase1PeerIdentityType", "CIPsecEncryptAlgorithm", "CIPsecPhase1TunnelIndex", "CIPsecControlProtocol", "CIPsecIkeAuthMethod", "CIPsecEncryptionKeySize", "CIPsecIkeHashAlgorithm")
ciscoMgmt, = mibBuilder.importSymbols("CISCO-SMI", "ciscoMgmt")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Gauge32, Counter64, Integer32, ObjectIdentity, ModuleIdentity, MibIdentifier, IpAddress, NotificationType, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Bits")
TimeInterval, DisplayString, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "DisplayString", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("CISCO-IPSEC-SIGNALING-MIB", cisgIpsSgHistTableSize=cisgIpsSgHistTableSize, ciscoIpsSgCertCrlFailure=ciscoIpsSgCertCrlFailure, ciscoIPsecSignalingMIB=ciscoIPsecSignalingMIB, cisgIpsSgNotifCntlTunnelStart=cisgIpsSgNotifCntlTunnelStart, cisgIpsSgTunHistPeerLocalValue=cisgIpsSgTunHistPeerLocalValue, cisgIpsSgTunOutOctets=cisgIpsSgTunOutOctets, cisgIpsSgTunHistAuthMethod=cisgIpsSgTunHistAuthMethod, cisgIpsSgFailLocalValue=cisgIpsSgFailLocalValue, cisgIpsSgGlobalOutDropPkts=cisgIpsSgGlobalOutDropPkts, cisgIpsSgTunHistOutOctets=cisgIpsSgTunHistOutOctets, cisgIpsSgTunOutPkts=cisgIpsSgTunOutPkts, cisgIpsSgGlobalAuthFails=cisgIpsSgGlobalAuthFails, cisgIpsSgGlobalActiveTunnels=cisgIpsSgGlobalActiveTunnels, cisgIpsSgGlobalInP2SaDelReqs=cisgIpsSgGlobalInP2SaDelReqs, cisgIpsSgNotifCntlCertCrlFail=cisgIpsSgNotifCntlCertCrlFail, cisgIpsSgTunnelEntry=cisgIpsSgTunnelEntry, cisgIpsSgFailRemoteValue=cisgIpsSgFailRemoteValue, cisgIpsSgTunInDropPkts=cisgIpsSgTunInDropPkts, cisgIpsSgFailLocalType=cisgIpsSgFailLocalType, cisgIpsSgTunHistRemoteAddrType=cisgIpsSgTunHistRemoteAddrType, PYSNMP_MODULE_ID=ciscoIPsecSignalingMIB, cisgIpsSgTunHistIndex=cisgIpsSgTunHistIndex, cisgIpsSgNotificationCntl=cisgIpsSgNotificationCntl, cisgIpsSgGlobalRespTunnelFails=cisgIpsSgGlobalRespTunnelFails, cisgIpsSgTunRemoteAddressType=cisgIpsSgTunRemoteAddressType, cisgIpsSgTunHistTermReason=cisgIpsSgTunHistTermReason, cisgIpsSgGlobalInitTunnelFails=cisgIpsSgGlobalInitTunnelFails, cisgIpsSgTunActiveTime=cisgIpsSgTunActiveTime, cisgIpsSgTunHistEncryptAlgo=cisgIpsSgTunHistEncryptAlgo, cisgIpsSgFailGlobalCntl=cisgIpsSgFailGlobalCntl, cisgIpsSgGlobalInNotifys=cisgIpsSgGlobalInNotifys, cisgIpsSgTunHistLocalName=cisgIpsSgTunHistLocalName, cisgIpsSgTunHistOutPkts=cisgIpsSgTunHistOutPkts, cisgIpsSgGlobalInDropPkts=cisgIpsSgGlobalInDropPkts, cisgIpsSgFailLocalAddress=cisgIpsSgFailLocalAddress, cisgIpsSgFailGlobal=cisgIpsSgFailGlobal, cisgIpsSgCurrentActivity=cisgIpsSgCurrentActivity, cisgIpsSgGlobalOutP1SaDelReqs=cisgIpsSgGlobalOutP1SaDelReqs, cisgIpsSgTunLocalAddressType=cisgIpsSgTunLocalAddressType, ciscoIpsSgTunnelStart=ciscoIpsSgTunnelStart, cisgIpsSgTunHistLocalAddr=cisgIpsSgTunHistLocalAddr, cisgIpsSgGlobalPreviousTunnels=cisgIpsSgGlobalPreviousTunnels, ciscoIpsSgNotifcationGroup=ciscoIpsSgNotifcationGroup, cisgIpsSgGlobalOutNotifys=cisgIpsSgGlobalOutNotifys, cisgIpsSgNotifCntlAllNotifs=cisgIpsSgNotifCntlAllNotifs, cisgIpsSgHistory=cisgIpsSgHistory, cisgIpsSgTunOutNotifys=cisgIpsSgTunOutNotifys, cisgIpsSgTunHistEncryptKeySize=cisgIpsSgTunHistEncryptKeySize, ciscoIpsSgFailureGroup=ciscoIpsSgFailureGroup, cisgIpsSgGlobalSysCapFails=cisgIpsSgGlobalSysCapFails, cisgIpsSgGlobalInPkts=cisgIpsSgGlobalInPkts, cisgIpsSgTunHistHashAlgo=cisgIpsSgTunHistHashAlgo, cisgIpsSgGlobalInP1SaDelReqs=cisgIpsSgGlobalInP1SaDelReqs, cisgIpsSgTunHistRemoteAddr=cisgIpsSgTunHistRemoteAddr, cisgIpsSgTunStatus=cisgIpsSgTunStatus, cisgIpsSgFailTime=cisgIpsSgFailTime, cisgIpsSgPeerAssociations=cisgIpsSgPeerAssociations, cisgIpsSgNotifCntlTunnelStop=cisgIpsSgNotifCntlTunnelStop, cisgIpsSgGlobalBadTunnelRefs=cisgIpsSgGlobalBadTunnelRefs, cisgIpsSgGlobalInitTunnels=cisgIpsSgGlobalInitTunnels, cisgIpsSgTunIndex=cisgIpsSgTunIndex, cisgIpsSgTunHistLifeTime=cisgIpsSgTunHistLifeTime, ciscoIpsSgMIBGroups=ciscoIpsSgMIBGroups, cisgIpsSgProtocol=cisgIpsSgProtocol, ciscoIpsSgActivityGroup=ciscoIpsSgActivityGroup, cisgIpsSgTunnelTable=cisgIpsSgTunnelTable, cisgIpsSgHistGlobal=cisgIpsSgHistGlobal, cisgIpsSgTunnelHistTable=cisgIpsSgTunnelHistTable, cisgIpsSgTunHistOutP2SaDelReqs=cisgIpsSgTunHistOutP2SaDelReqs, cisgIpsSgTunAction=cisgIpsSgTunAction, cisgIpsSgTunRemoteType=cisgIpsSgTunRemoteType, cisgIpsSgTunInPkts=cisgIpsSgTunInPkts, cisgIpsSgTunHistPeerRemoteValue=cisgIpsSgTunHistPeerRemoteValue, cisgIpsSgTunHistInOctets=cisgIpsSgTunHistInOctets, cisgIpsSgFailIndex=cisgIpsSgFailIndex, cisgIpsSgTunRemoteAddress=cisgIpsSgTunRemoteAddress, cisgIpsSgTunHistPeerLocalType=cisgIpsSgTunHistPeerLocalType, cisgIpsSgTunHistInDropPkts=cisgIpsSgTunHistInDropPkts, cisgIpsSgTunHistRemoteName=cisgIpsSgTunHistRemoteName, cisgIpsSgGlobalDecryptFails=cisgIpsSgGlobalDecryptFails, ciscoIPsecSigMIBObjects=ciscoIPsecSigMIBObjects, cisgIpsSgGlobalOutP2SaDelReqs=cisgIpsSgGlobalOutP2SaDelReqs, cisgIpsSgTunAuthMethod=cisgIpsSgTunAuthMethod, ciscoIPsecSigMIBConform=ciscoIPsecSigMIBConform, cisgIpsSgFailures=cisgIpsSgFailures, cisgIpsSgTunRemoteValue=cisgIpsSgTunRemoteValue, cisgIpsSgGlobalHashValidFails=cisgIpsSgGlobalHashValidFails, cisgIpsSgTunInNotifys=cisgIpsSgTunInNotifys, cisgIpsSgTunHistPeerRemoteType=cisgIpsSgTunHistPeerRemoteType, cisgIpsSgTunHistLocalAddrType=cisgIpsSgTunHistLocalAddrType, cisgIpsSgGlobalOutPkts=cisgIpsSgGlobalOutPkts, cisgIpsSgFailEntry=cisgIpsSgFailEntry, ciscoIpsSgCoreHistoryGroup=ciscoIpsSgCoreHistoryGroup, cisgIpsSgGlobalInOctets=cisgIpsSgGlobalInOctets, cisgIpsSgTunLocalName=cisgIpsSgTunLocalName, ciscoIpsSgNotifCntlGroup=ciscoIpsSgNotifCntlGroup, cisgIpsSgTunEncryptKeySize=cisgIpsSgTunEncryptKeySize, ciscoIPsecSigMIBNotifs=ciscoIPsecSigMIBNotifs, cisgIpsSgFailRemoteType=cisgIpsSgFailRemoteType, cisgIpsSgTunLocalAddress=cisgIpsSgTunLocalAddress, ciscoIpsSgTunnelStop=ciscoIpsSgTunnelStop, cisgIpsSgTunLifeTime=cisgIpsSgTunLifeTime, cisgIpsSgNotifCntlSysFailure=cisgIpsSgNotifCntlSysFailure, cisgIpsSgFailReason=cisgIpsSgFailReason, cisgIpsSgTunHistOutNotifys=cisgIpsSgTunHistOutNotifys, ciscoIpsSgMIBCompliance=ciscoIpsSgMIBCompliance, cisgIpsSgTunHistActiveIndex=cisgIpsSgTunHistActiveIndex, cisgIpsSgTunOutDropPkts=cisgIpsSgTunOutDropPkts, cisgIpsSgTunHistStartTime=cisgIpsSgTunHistStartTime, cisgIpsSgTunInOctets=cisgIpsSgTunInOctets, cisgIpsSgTunLocalType=cisgIpsSgTunLocalType, cisgIpsSgTunHistOutDropPkts=cisgIpsSgTunHistOutDropPkts, ciscoIpsSgMIBCompliances=ciscoIpsSgMIBCompliances, cisgIpsSgGlobalStatsEntry=cisgIpsSgGlobalStatsEntry, cisgIpsSgTunHashAlgo=cisgIpsSgTunHashAlgo, cisgIpsSgGlobalStatsTable=cisgIpsSgGlobalStatsTable, cisgIpsSgGlobalRespTunnels=cisgIpsSgGlobalRespTunnels, ciscoIpsSgHistoryGroup=ciscoIpsSgHistoryGroup, cisgIpsSgTunHistPeerIntIndex=cisgIpsSgTunHistPeerIntIndex, cisgIpsSgTunnelHistEntry=cisgIpsSgTunnelHistEntry, cisgIpsSgHistGlobalCntl=cisgIpsSgHistGlobalCntl, cisgIpsSgGlobalOutOctets=cisgIpsSgGlobalOutOctets, cisgIpsSgTunHistInPkts=cisgIpsSgTunHistInPkts, ciscoIpsSgCoreFailureGroup=ciscoIpsSgCoreFailureGroup, cisgIpsSgTunLocalValue=cisgIpsSgTunLocalValue, cisgIpsSgTunOutP2SaDelReqs=cisgIpsSgTunOutP2SaDelReqs, cisgIpsSgTunRemoteName=cisgIpsSgTunRemoteName, cisgIpsSgTunHistActiveTime=cisgIpsSgTunHistActiveTime, cisgIpsSgFailTableSize=cisgIpsSgFailTableSize, ciscoIpsSgSysFailure=ciscoIpsSgSysFailure, cisgIpsSgTunHistInP2SaDelReqs=cisgIpsSgTunHistInP2SaDelReqs, cisgIpsSgFailTable=cisgIpsSgFailTable, cisgIpsSgFailRemoteAddress=cisgIpsSgFailRemoteAddress, cisgIpsSgTunHistInNotifys=cisgIpsSgTunHistInNotifys, cisgIpsSgTunEncryptAlgo=cisgIpsSgTunEncryptAlgo)
