...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/PNNI-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:37:14 2019
...
NotificationType, iso, Bits, zeroDotZero, ModuleIdentity, MibIdentifier, Unsigned32, Integer32, enterprises, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Bits", "zeroDotZero", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Integer32", "enterprises", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("PNNI-MIB", pnniSvccRccRemoteNodeId=pnniSvccRccRemoteNodeId, pnniMapTnsPlan=pnniMapTnsPlan, pnniScopeLocalNetwork=pnniScopeLocalNetwork, pnniNbrPeerPortTable=pnniNbrPeerPortTable, PnniAggrToken=PnniAggrToken, pnniDTLOptionalGroup=pnniDTLOptionalGroup, pnniMetrics5=pnniMetrics5, pnniMapOptionalGroup=pnniMapOptionalGroup, pnniLinkUpnodeAtmAddress=pnniLinkUpnodeAtmAddress, pnniMapOriginatingNodeId=pnniMapOriginatingNodeId, atmForum=atmForum, pnniSummaryAddress=pnniSummaryAddress, pnniMapNodeComplexRep=pnniMapNodeComplexRep, pnniLinkType=pnniLinkType, pnniSummaryAddressLgnGroup=pnniSummaryAddressLgnGroup, pnniNodeHlinkInact=pnniNodeHlinkInact, pnniNodeComplexRep=pnniNodeComplexRep, pnniMapNodeId=pnniMapNodeId, pnniMapType=pnniMapType, pnniRoutingGroup=pnniRoutingGroup, pnniMetricsClasses=pnniMetricsClasses, pnniRouteTnsMetricsTag=pnniRouteTnsMetricsTag, pnniRouteTnsInfo=pnniRouteTnsInfo, pnniSvccRccHelloState=pnniSvccRccHelloState, pnniNbrPeerXmtPtseAcks=pnniNbrPeerXmtPtseAcks, pnniPtseChecksum=pnniPtseChecksum, pnniCrankbackCountOriginator=pnniCrankbackCountOriginator, pnniMetrics4=pnniMetrics4, pnniRouteAddrType=pnniRouteAddrType, pnniNodeHelloHolddown=pnniNodeHelloHolddown, pnniRouteAddrPtseId=pnniRouteAddrPtseId, pnniLinkDerivedAggrToken=pnniLinkDerivedAggrToken, pnniRouteNodeDestNodeId=pnniRouteNodeDestNodeId, pnniIfAggrToken=pnniIfAggrToken, pnniRouteNodeBwdMetric2=pnniRouteNodeBwdMetric2, pnniNbrPeerRcvPtsps=pnniNbrPeerRcvPtsps, pnniSummaryRowStatus=pnniSummaryRowStatus, pnniNodeTimerEntry=pnniNodeTimerEntry, pnniRouteAddrEntry=pnniRouteAddrEntry, pnniNodeTimerMinGroup=pnniNodeTimerMinGroup, pnniSvccRccIfIndex=pnniSvccRccIfIndex, pnniLinkRcvHellos=pnniLinkRcvHellos, pnniIfTable=pnniIfTable, pnniPtseTable=pnniPtseTable, pnniRouteNodeClass=pnniRouteNodeClass, pnniMapTable=pnniMapTable, pnniSummaryAddressPrefixLength=pnniSummaryAddressPrefixLength, pnniMapNodeIAmLeader=pnniMapNodeIAmLeader, pnniNbrPeerState=pnniNbrPeerState, pnniNodeCtdPm=pnniNodeCtdPm, pnniPtseEntry=pnniPtseEntry, pnniRouteNodeBwdMetric3=pnniRouteNodeBwdMetric3, pnniNodePeerDelayedAckInterval=pnniNodePeerDelayedAckInterval, pnniRouteNodeVPCapability=pnniRouteNodeVPCapability, pnniLinkHelloState=pnniLinkHelloState, pnniNodeDatabaseOverload=pnniNodeDatabaseOverload, pnniRouteAddrVPCapability=pnniRouteAddrVPCapability, pnniLinkCommonPeerGroupId=pnniLinkCommonPeerGroupId, pnniRouteAddrOperStatus=pnniRouteAddrOperStatus, pnniLinkRemotePortId=pnniLinkRemotePortId, pnniRouteBaseGroup=pnniRouteBaseGroup, pnniNodeAdminStatus=pnniNodeAdminStatus, pnniNodePtseLifetimeFactor=pnniNodePtseLifetimeFactor, pnniNbrPeerTable=pnniNbrPeerTable, pnniDTLTable=pnniDTLTable, pnniNodeMinGroup=pnniNodeMinGroup, pnniPtseId=pnniPtseId, pnniRouteTnsProto=pnniRouteTnsProto, pnniNodePreferredPgl=pnniNodePreferredPgl, pnniMapTnsOptionalGroup=pnniMapTnsOptionalGroup, pnniMapTnsEntry=pnniMapTnsEntry, pnniMetricsTag=pnniMetricsTag, pnniMapRemoteNodeId=pnniMapRemoteNodeId, pnniSummaryTable=pnniSummaryTable, pnniRouteAddrInfo=pnniRouteAddrInfo, pnniNbrPeerRcvPtseReqs=pnniNbrPeerRcvPtseReqs, pnniScopeCommunityMinusOne=pnniScopeCommunityMinusOne, pnniNodeRxmtInterval=pnniNodeRxmtInterval, pnniNodeActiveParentNodeId=pnniNodeActiveParentNodeId, pnniNodeRowStatus=pnniNodeRowStatus, pnniSummaryAddressEntry=pnniSummaryAddressEntry, pnniNodeHelloInactivityFactor=pnniNodeHelloInactivityFactor, pnniDTLNodeId=pnniDTLNodeId, pnniMapAddrAdvertisingNodeId=pnniMapAddrAdvertisingNodeId, pnniRouteTnsTable=pnniRouteTnsTable, pnniMetrics8=pnniMetrics8, pnniDTLStatus=pnniDTLStatus, PnniPrefixLength=PnniPrefixLength, pnniPtseLifeTime=pnniPtseLifeTime, pnniRouteNodeEntry=pnniRouteNodeEntry, pnniNodePglTimeStamp=pnniNodePglTimeStamp, pnniRouteNodeOptionalGroup=pnniRouteNodeOptionalGroup, pnniNodeSvccInitTime=pnniNodeSvccInitTime, pnniMetricsTable=pnniMetricsTable, pnniRouteAddrTimeStamp=pnniRouteAddrTimeStamp, pnniNodeCdvPm=pnniNodeCdvPm, pnniDtlCountBorder=pnniDtlCountBorder, pnniRouteTnsOriginateAdvertisement=pnniRouteTnsOriginateAdvertisement, pnniAltRouteCountOriginator=pnniAltRouteCountOriginator, PnniNodeId=PnniNodeId, pnniMapTnsType=pnniMapTnsType, pnniNodeTimerTable=pnniNodeTimerTable, pnniSummarySuppress=pnniSummarySuppress, pnniNodePglState=pnniNodePglState, pnniNbrPeerRcvPtseAcks=pnniNbrPeerRcvPtseAcks, pnniMapPeerGroupId=pnniMapPeerGroupId, pnniLinkMinGroup=pnniLinkMinGroup, pnniMapNodeTable=pnniMapNodeTable, pnniNodePglLeadershipPriority=pnniNodePglLeadershipPriority, pnniSummaryState=pnniSummaryState, pnniRouteTnsRowStatus=pnniRouteTnsRowStatus, pnniMapNodeRestrictedBranching=pnniMapNodeRestrictedBranching, pnniMapNodePreferredPgl=pnniMapNodePreferredPgl, pnniScopeLocalNetworkPlusOne=pnniScopeLocalNetworkPlusOne, pnniNodeDomainName=pnniNodeDomainName, TnsType=TnsType, atmForumNetworkManagement=atmForumNetworkManagement, pnniNodeIndex=pnniNodeIndex, pnniRouteNodeTable=pnniRouteNodeTable, pnniRouteTnsOptionalGroup=pnniRouteTnsOptionalGroup, pnniNodeRestrictedBranching=pnniNodeRestrictedBranching, pnniNodePeerGroupLeader=pnniNodePeerGroupLeader, pnniRouteNodeNumber=pnniRouteNodeNumber, pnniMapNodeParentAtmAddress=pnniMapNodeParentAtmAddress, pnniNodeRestrictedTransit=pnniNodeRestrictedTransit, pnniRouteNodeTimeStamp=pnniRouteNodeTimeStamp, pnniNbrPeerPortMinGroup=pnniNbrPeerPortMinGroup, pnniNodePglOverrideDelay=pnniNodePglOverrideDelay, PnniMetricsTag=PnniMetricsTag, pnniRouteAddrOptionalGroup=pnniRouteAddrOptionalGroup, pnniNodePtses=pnniNodePtses, pnniScopeLocalNetworkPlusTwo=pnniScopeLocalNetworkPlusTwo, pnniMapVPCapability=pnniMapVPCapability, pnniCrankbackCountBorder=pnniCrankbackCountBorder, pnniNodePglLgnGroup=pnniNodePglLgnGroup, pnniLinkUpnodeId=pnniLinkUpnodeId, atmfPnni=atmfPnni, pnniRouteTnsAdvertisingNodeId=pnniRouteTnsAdvertisingNodeId, pnniNodePglReelectTime=pnniNodePglReelectTime, pnniNodePtseRefreshInterval=pnniNodePtseRefreshInterval, pnniLowestVersion=pnniLowestVersion, PnniSvccRccIndex=PnniSvccRccIndex, pnniRouteAddrAdvertisingNodeId=pnniRouteAddrAdvertisingNodeId, pnniScopeSitePlusOne=pnniScopeSitePlusOne, pnniRouteAddrProto=pnniRouteAddrProto, pnniRouteAddrRowStatus=pnniRouteAddrRowStatus, pnniNodeHelloInterval=pnniNodeHelloInterval, pnniMapNodeParentPglNodeId=pnniMapNodeParentPglNodeId, pnniNodeId=pnniNodeId, pnniRouteNodeFwdMetric4=pnniRouteNodeFwdMetric4, pnniNbrPeerPortFloodStatus=pnniNbrPeerPortFloodStatus, pnniRouteNodeFwdMetricAW=pnniRouteNodeFwdMetricAW, pnniSvccRccVci=pnniSvccRccVci, pnniRouteNodeBwdMetricAW=pnniRouteNodeBwdMetricAW, PnniLevel=PnniLevel, pnniScopeSiteMinusOne=pnniScopeSiteMinusOne, PnniPeerGroupId=PnniPeerGroupId, pnniNodeOperStatus=pnniNodeOperStatus, pnniIfAdmWeightRtVbr=pnniIfAdmWeightRtVbr, pnniNbrPeerRcvDbSums=pnniNbrPeerRcvDbSums, pnniMapAggrToken=pnniMapAggrToken, pnniRouteNodeDTL=pnniRouteNodeDTL, pnniScopeMinGroup=pnniScopeMinGroup, pnniRouteNodeDestPortId=pnniRouteNodeDestPortId, pnniNodePglTable=pnniNodePglTable, pnniRouteFailUnreachableOriginator=pnniRouteFailUnreachableOriginator, pnniRouteTnsPnniScope=pnniRouteTnsPnniScope, PnniNodeIndex=PnniNodeIndex, pnniMetricsEntry=pnniMetricsEntry, pnniMIBConformance=pnniMIBConformance, pnniScopeIntraOrganization=pnniScopeIntraOrganization, pnniRouteTnsType=pnniRouteTnsType, pnniRouteNodeInfo=pnniRouteNodeInfo, pnniPtseType=pnniPtseType, pnniRouteNodeFwdMetric8=pnniRouteNodeFwdMetric8, pnniRouteAddrIfIndex=pnniRouteAddrIfIndex, pnniMapAddrAddress=pnniMapAddrAddress, pnniNodeSvccRetryTime=pnniNodeSvccRetryTime, pnniRouteNodeBwdMetric1=pnniRouteNodeBwdMetric1, pnniMapNodeRestrictedTransit=pnniMapNodeRestrictedTransit, pnniMapAddrTable=pnniMapAddrTable, pnniRouteNodeBwdMetric5=pnniRouteNodeBwdMetric5, pnniNodeAvcrMt=pnniNodeAvcrMt, pnniScopeOrganizationMinusOne=pnniScopeOrganizationMinusOne, pnniIfAdmWeightAbr=pnniIfAdmWeightAbr, pnniMapNodePeerGroupId=pnniMapNodePeerGroupId, pnniMapAddrPrefixLength=pnniMapAddrPrefixLength, pnniRouteNodeFwdMetric2=pnniRouteNodeFwdMetric2, pnniDTLEntry=pnniDTLEntry, PYSNMP_MODULE_ID=pnniMIB, pnniScopeGlobal=pnniScopeGlobal, pnniDTLIndex=pnniDTLIndex, pnniMapTnsAdvertisedPortId=pnniMapTnsAdvertisedPortId, pnniRouteNodeBwdMetric7=pnniRouteNodeBwdMetric7, pnniMapMetricsTag=pnniMapMetricsTag, pnniLinkSvccRccIndex=pnniLinkSvccRccIndex, pnniScopeRegional=pnniScopeRegional, pnniMIBObjects=pnniMIBObjects, pnniPtseOptionalGroup=pnniPtseOptionalGroup, pnniIfBorderGroup=pnniIfBorderGroup, ServiceCategory=ServiceCategory, pnniSummaryPrefixLength=pnniSummaryPrefixLength, pnniMapNodeOptionalGroup=pnniMapNodeOptionalGroup, pnniDtlCountOriginator=pnniDtlCountOriginator, pnniNodeAvcrPm=pnniNodeAvcrPm, pnniRouteTnsIfIndex=pnniRouteTnsIfIndex, pnniSvccRccVersion=pnniSvccRccVersion, PnniHelloState=PnniHelloState, pnniMapNodeParentNodeId=pnniMapNodeParentNodeId, pnniNodeSvccCallingIntegrityTime=pnniNodeSvccCallingIntegrityTime, pnniNodeLowest=pnniNodeLowest, pnniMetricsAdminWeight=pnniMetricsAdminWeight, pnniLinkTable=pnniLinkTable, pnniLinkXmtHellos=pnniLinkXmtHellos, pnniMapAddrEntry=pnniMapAddrEntry, PnniVersion=PnniVersion, pnniMetricsGcacClp=pnniMetricsGcacClp, pnniNodePglMinGroup=pnniNodePglMinGroup, pnniRouteNodeFwdMetric6=pnniRouteNodeFwdMetric6, pnniMetricsIndex=pnniMetricsIndex, pnniMapNodeDatabaseOverload=pnniMapNodeDatabaseOverload, pnniSvccRccTable=pnniSvccRccTable, pnniSummaryEntry=pnniSummaryEntry, pnniSvccRccLgnGroup=pnniSvccRccLgnGroup, pnniScopeCommunityPlusOne=pnniScopeCommunityPlusOne, pnniDTLLinkType=pnniDTLLinkType, pnniRouteAddrPrefixLength=pnniRouteAddrPrefixLength, pnniRouteTnsId=pnniRouteTnsId, pnniScopeIntraCommunity=pnniScopeIntraCommunity, pnniNodePglEntry=pnniNodePglEntry, pnniNodePtseHolddown=pnniNodePtseHolddown, pnniRouteNodeFwdMetric7=pnniRouteNodeFwdMetric7, pnniSvccRccRcvHellos=pnniSvccRccRcvHellos, pnniRouteAddrIndex=pnniRouteAddrIndex, pnniScopeMappingTable=pnniScopeMappingTable, pnniIfVPCapability=pnniIfVPCapability, pnniNodeCfgParentNodeIndex=pnniNodeCfgParentNodeIndex, pnniRouteAddrAddress=pnniRouteAddrAddress, pnniMapAddrAdvertisedPortId=pnniMapAddrAdvertisedPortId, pnniNbrPeerXmtPtsps=pnniNbrPeerXmtPtsps, pnniMapNodeLeadershipPriority=pnniMapNodeLeadershipPriority, pnniMapNodeParentPeerGroupId=pnniMapNodeParentPeerGroupId, pnniMetrics7=pnniMetrics7, pnniRouteTnsEntry=pnniRouteTnsEntry, pnniRouteGeneralOptionalGroup=pnniRouteGeneralOptionalGroup, pnniSvccRccXmtHellos=pnniSvccRccXmtHellos, pnniNbrPeerSvccRccIndex=pnniNbrPeerSvccRccIndex, pnniMapOriginatingPortId=pnniMapOriginatingPortId, pnniMetricsDirection=pnniMetricsDirection, pnniRouteFailUnreachableBorder=pnniRouteFailUnreachableBorder, pnniMIB=pnniMIB, pnniMetricsRowStatus=pnniMetricsRowStatus, pnniNodeEntry=pnniNodeEntry, pnniNbrPeerXmtPtseReqs=pnniNbrPeerXmtPtseReqs)
mibBuilder.exportSymbols("PNNI-MIB", pnniMIBGroups=pnniMIBGroups, pnniRouteAddrAdvertisedPortId=pnniRouteAddrAdvertisedPortId, pnniMetrics2=pnniMetrics2, pnniRouteNodeFwdMetric1=pnniRouteNodeFwdMetric1, pnniNbrPeerRemoteNodeId=pnniNbrPeerRemoteNodeId, pnniScopeIntraSite=pnniScopeIntraSite, pnniMapAddrOptionalGroup=pnniMapAddrOptionalGroup, pnniMapNodeEntry=pnniMapNodeEntry, pnniSummaryAddressType=pnniSummaryAddressType, pnniSvccRccVpi=pnniSvccRccVpi, pnniSummaryAddressAddress=pnniSummaryAddressAddress, pnniRouteNodeBwdMetric6=pnniRouteNodeBwdMetric6, pnniNodeSvccEntry=pnniNodeSvccEntry, pnniIfEntry=pnniIfEntry, pnniMapTnsId=pnniMapTnsId, PnniAtmAddr=PnniAtmAddr, pnniNodeLevel=pnniNodeLevel, pnniMapEntry=pnniMapEntry, pnniMetrics1=pnniMetrics1, pnniRouteFailCountOriginator=pnniRouteFailCountOriginator, pnniRouteAddrTable=pnniRouteAddrTable, PnniPortId=PnniPortId, pnniNodeSvccLgnGroup=pnniNodeSvccLgnGroup, pnniLinkVersion=pnniLinkVersion, pnniSummaryAddressSuppress=pnniSummaryAddressSuppress, pnniAltRouteCountBorder=pnniAltRouteCountBorder, pnniScopeInterRegional=pnniScopeInterRegional, pnniSummaryType=pnniSummaryType, pnniMIBCompliances=pnniMIBCompliances, pnniPtseOriginatingNodeId=pnniPtseOriginatingNodeId, pnniLinkLgnGroup=pnniLinkLgnGroup, pnniRouteNodeStatus=pnniRouteNodeStatus, pnniSummaryAddressTable=pnniSummaryAddressTable, pnniIfRccServiceCategory=pnniIfRccServiceCategory, pnniIfNodeIndex=pnniIfNodeIndex, pnniPtseSequenceNum=pnniPtseSequenceNum, pnniNodePglInitTime=pnniNodePglInitTime, pnniMetrics6=pnniMetrics6, pnniSummaryAddressState=pnniSummaryAddressState, TnsPlan=TnsPlan, pnniRouteNodeFwdMetric3=pnniRouteNodeFwdMetric3, pnniIfAdmWeightUbr=pnniIfAdmWeightUbr, pnniMetricsOptionalGroup=pnniMetricsOptionalGroup, pnniNbrPeerPortId=pnniNbrPeerPortId, pnniGeneralMinGroup=pnniGeneralMinGroup, pnniNodeSvccTrafficDescriptorIndex=pnniNodeSvccTrafficDescriptorIndex, pnniRouteTnsTimeStamp=pnniRouteTnsTimeStamp, pnniRouteTnsOperStatus=pnniRouteTnsOperStatus, pnniMapAddrIndex=pnniMapAddrIndex, pnniIfMinGroup=pnniIfMinGroup, pnniRouteTnsPlan=pnniRouteTnsPlan, pnniNodeTimerLgnGroup=pnniNodeTimerLgnGroup, pnniRouteTnsRouteType=pnniRouteTnsRouteType, pnniRouteTnsVPCapability=pnniRouteTnsVPCapability, pnniHighestVersion=pnniHighestVersion, AtmAddrPrefix=AtmAddrPrefix, pnniSummaryLgnGroup=pnniSummaryLgnGroup, pnniRouteFailCountBorder=pnniRouteFailCountBorder, pnniLinkBorderOrLgnGroup=pnniLinkBorderOrLgnGroup, pnniLinkEntry=pnniLinkEntry, pnniNodeSvccTable=pnniNodeSvccTable, pnniRouteAddrOriginateAdvertisement=pnniRouteAddrOriginateAdvertisement, pnniIfPortId=pnniIfPortId, pnniMapIndex=pnniMapIndex, pnniMapRemotePortId=pnniMapRemotePortId, pnniRouteNodeFwdMetric5=pnniRouteNodeFwdMetric5, pnniRouteTnsAdvertisedPortId=pnniRouteTnsAdvertisedPortId, pnniRouteAddrNumber=pnniRouteAddrNumber, pnniNodeSvccCalledIntegrityTime=pnniNodeSvccCalledIntegrityTime, pnniScopeOrganizationPlusOne=pnniScopeOrganizationPlusOne, pnniRouteNodeBwdMetric8=pnniRouteNodeBwdMetric8, pnniNbrPeerXmtDbSums=pnniNbrPeerXmtDbSums, pnniMetrics3=pnniMetrics3, pnniIfAdmWeightCbr=pnniIfAdmWeightCbr, pnniDTLEntryIndex=pnniDTLEntryIndex, pnniScopeMappingEntry=pnniScopeMappingEntry, pnniRouteTnsPtseId=pnniRouteTnsPtseId, pnniMapTnsAdvertisingNodeId=pnniMapTnsAdvertisingNodeId, pnniPtseInfo=pnniPtseInfo, pnniRouteTnsIndex=pnniRouteTnsIndex, pnniNbrPeerLgnGroup=pnniNbrPeerLgnGroup, pnniSvccRccIndex=pnniSvccRccIndex, pnniNodeTable=pnniNodeTable, pnniNbrPeerPortCount=pnniNbrPeerPortCount, pnniMapTnsTable=pnniMapTnsTable, pnniMapPtseId=pnniMapPtseId, pnniRouteNodeGcacClp=pnniRouteNodeGcacClp, pnniDTLPortId=pnniDTLPortId, pnniRouteNodeBwdMetric4=pnniRouteNodeBwdMetric4, ClpType=ClpType, pnniBaseGroup=pnniBaseGroup, pnniMIBCompliance=pnniMIBCompliance, pnniSvccRccRemoteAtmAddress=pnniSvccRccRemoteAtmAddress, pnniNbrPeerPortEntry=pnniNbrPeerPortEntry, pnniIfAdmWeightNrtVbr=pnniIfAdmWeightNrtVbr, pnniIfRccTrafficDescrIndex=pnniIfRccTrafficDescrIndex, pnniRouteAddrPnniScope=pnniRouteAddrPnniScope, pnniLinkIfIndex=pnniLinkIfIndex, pnniLinkPortId=pnniLinkPortId, pnniLinkRemoteNodeId=pnniLinkRemoteNodeId, pnniMapNodeAtmAddress=pnniMapNodeAtmAddress, pnniNodePeerGroupId=pnniNodePeerGroupId, pnniNbrPeerEntry=pnniNbrPeerEntry, pnniNbrPeerMinGroup=pnniNbrPeerMinGroup, pnniRouteNodeProto=pnniRouteNodeProto, pnniSummaryAddressRowStatus=pnniSummaryAddressRowStatus, pnniGeneralBorderGroup=pnniGeneralBorderGroup, pnniSvccRccEntry=pnniSvccRccEntry, pnniNodeAtmAddress=pnniNodeAtmAddress, pnniRouteAddrMetricsTag=pnniRouteAddrMetricsTag)
