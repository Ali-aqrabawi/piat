...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DLSW-EXT-MIB
...
dlswTConnConfigIndex, dlswTConnConfigEntry, dlswTConnTcpConfigEntry, dlswTConnOperState, MacAddressNC, dlswCircuitEntry, LFSize, dlswIfEntry, TAddress, dlswCircuitState, DlcType, dlswTConnOperEntry = mibBuilder.importSymbols("DLSW-MIB", "dlswTConnConfigIndex", "dlswTConnConfigEntry", "dlswTConnTcpConfigEntry", "dlswTConnOperState", "MacAddressNC", "dlswCircuitEntry", "LFSize", "dlswIfEntry", "TAddress", "dlswCircuitState", "DlcType", "dlswTConnOperEntry")
InterfaceIndex, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndex")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
ModuleIdentity, NotificationType, Bits, Unsigned32, Gauge32, TimeTicks, Counter64, ObjectIdentity, Counter32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Bits", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "Counter32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-DLSW-EXT-MIB", cdeFastS1CacheId=cdeFastS1CacheId, cdeTConnSpecific=cdeTConnSpecific, cdeFastS2Sap=cdeFastS2Sap, cdeTrapCntlTConn=cdeTrapCntlTConn, cdeNodePeerOnDemandDefaultsPriority=cdeNodePeerOnDemandDefaultsPriority, cdeTrapControl=cdeTrapControl, cdeTConnOperPartnerBorderPeer=cdeTConnOperPartnerBorderPeer, cdeMIBCompliances=cdeMIBCompliances, cdeTConnDirectConfigFrameRelayDlci=cdeTConnDirectConfigFrameRelayDlci, cdeNodePromPeerDefaultsKeepaliveInterval=cdeNodePromPeerDefaultsKeepaliveInterval, cdeNodePeerOnDemandDefaultsFst=cdeNodePeerOnDemandDefaultsFst, TCPQueueMax=TCPQueueMax, cdeNodePromPeerDefaultsTCPQueueMax=cdeNodePromPeerDefaultsTCPQueueMax, cdeNodePromPeerDefaultsDestMac=cdeNodePromPeerDefaultsDestMac, cdeMIBTConnConfigGroup=cdeMIBTConnConfigGroup, cdeNodeCost=cdeNodeCost, cdeTConnConfigDynamicNoLlc=cdeTConnConfigDynamicNoLlc, cdeMIBNodeGroup=cdeMIBNodeGroup, ciscoDlswExtMIBObjects=ciscoDlswExtMIBObjects, cdeTConnOperPartnerGroupNum=cdeTConnOperPartnerGroupNum, cdeMIBCompliance=cdeMIBCompliance, cdeTConnConfigDestMac=cdeTConnConfigDestMac, cdeIfType=cdeIfType, cdeTConnConfigLocalAck=cdeTConnConfigLocalAck, cdeNode=cdeNode, cdeTConnOperEntry=cdeTConnOperEntry, cdeNodePassiveConnect=cdeNodePassiveConnect, cdeTConnTcpConfigEntry=cdeTConnTcpConfigEntry, cdeIfTable=cdeIfTable, cdeDomains=cdeDomains, cdeTrapsPrefix=cdeTrapsPrefix, cdeFastTimeToLive=cdeFastTimeToLive, cdeTrapTConnUpDown=cdeTrapTConnUpDown, cdeTConnDirectConfigIfIndex=cdeTConnDirectConfigIfIndex, cdeFastS2Mac=cdeFastS2Mac, cdeNodePeerOnDemandDefaultsInactivityInterval=cdeNodePeerOnDemandDefaultsInactivityInterval, cdeCircuitS2Name=cdeCircuitS2Name, cdeTConnOperTable=cdeTConnOperTable, cdeTConn=cdeTConn, cdeTConnConfigBackupTAddr=cdeTConnConfigBackupTAddr, cdeTConnOperTDomainType=cdeTConnOperTDomainType, cdeNodePeerOnDemandDefaultsKeepaliveInterval=cdeNodePeerOnDemandDefaultsKeepaliveInterval, cdeFastTable=cdeFastTable, cdeMIBTConnDirectConfigGroup=cdeMIBTConnDirectConfigGroup, cdeFastEntry=cdeFastEntry, cdeMIBInterfaceGroup=cdeMIBInterfaceGroup, cdeFastS1IfIndex=cdeFastS1IfIndex, cdeTConnDirectConfigMediaEncap=cdeTConnDirectConfigMediaEncap, cdeCircuitEntry=cdeCircuitEntry, cdeTConnConfigBackupLinger=cdeTConnConfigBackupLinger, cdeNodePeerOnDemandDefaultsLFSize=cdeNodePeerOnDemandDefaultsLFSize, cdeNodePromPeerDefaultsLFSize=cdeNodePromPeerDefaultsLFSize, cdeNodePeerOnDemandDefaultsTCPQueueMax=cdeNodePeerOnDemandDefaultsTCPQueueMax, TDomainType=TDomainType, cdeNodeKeepaliveInterval=cdeNodeKeepaliveInterval, cdeTConnConfigCost=cdeTConnConfigCost, PYSNMP_MODULE_ID=ciscoDlswExtMIB, cdeCircuitS1IdNum=cdeCircuitS1IdNum, cdeCircuitS1IdBlock=cdeCircuitS1IdBlock, cdeTConnConfigBackup=cdeTConnConfigBackup, cdeCircuit=cdeCircuit, cdeNodeBorder=cdeNodeBorder, cdeTrapCntlCircuit=cdeTrapCntlCircuit, cdeMIBTConnTcpConfigGroup=cdeMIBTConnTcpConfigGroup, cdeTConnTcpConfigQueueMax=cdeTConnTcpConfigQueueMax, cdeFastS2TDomain=cdeFastS2TDomain, cdeFastOrigin=cdeFastOrigin, cdeTrapControlGroup=cdeTrapControlGroup, cdeDirectFrameRelayDomain=cdeDirectFrameRelayDomain, cdeLlc2Domain=cdeLlc2Domain, cdeMIBTConnOperGroup=cdeMIBTConnOperGroup, cdeFastS1RouteInfo=cdeFastS1RouteInfo, cdeDirectHdlcDomain=cdeDirectHdlcDomain, cdeFastS1Mac=cdeFastS1Mac, cdeMIBFastGroup=cdeMIBFastGroup, cdeInterface=cdeInterface, cdeFastS2TAddress=cdeFastS2TAddress, cdeFast=cdeFast, cdeFSTDomain=cdeFSTDomain, cdeTConnConfigDynamicInactivityInterval=cdeTConnConfigDynamicInactivityInterval, KeepaliveInterval=KeepaliveInterval, cdeTConnConfigDynamic=cdeTConnConfigDynamic, cdeTConnTcp=cdeTConnTcp, cdeCircuitTable=cdeCircuitTable, cdeNodeMaxPacingWindow=cdeNodeMaxPacingWindow, cdeFastS1Sap=cdeFastS1Sap, cdeTConnConfigLFSize=cdeTConnConfigLFSize, cdeFastS2CacheId=cdeFastS2CacheId, cdeNodePromPeerDefaultsCost=cdeNodePromPeerDefaultsCost, cdeTConnConfigKeepaliveInterval=cdeTConnConfigKeepaliveInterval, cdeTConnOperPartnerPriority=cdeTConnOperPartnerPriority, cdeTConnDirect=cdeTConnDirect, cdeMIBConformance=cdeMIBConformance, cdeCircuitS1Name=cdeCircuitS1Name, cdeNodeInitPacingWindow=cdeNodeInitPacingWindow, cdeTrapCircuitUpDown=cdeTrapCircuitUpDown, cdeNodePromiscuous=cdeNodePromiscuous, cdeTConnTcpConfigTable=cdeTConnTcpConfigTable, cdeNodeBiuSegment=cdeNodeBiuSegment, cdeNodeTAddr=cdeNodeTAddr, Cost=Cost, cdeNodeGroup=cdeNodeGroup, cdeTConnConfigBackupLingerInterval=cdeTConnConfigBackupLingerInterval, cdeTConnConfigPriority=cdeTConnConfigPriority, cdeMIBGroups=cdeMIBGroups, cdeTraps=cdeTraps, cdeMIBCircuitGroup=cdeMIBCircuitGroup, cdeTConnDirectConfigEntry=cdeTConnDirectConfigEntry, cdeNodePeerOnDemandDefaultsCost=cdeNodePeerOnDemandDefaultsCost, cdeTConnConfigTable=cdeTConnConfigTable, cdeTConnConfigEntry=cdeTConnConfigEntry, ciscoDlswExtMIB=ciscoDlswExtMIB, cdeTConnConfigTDomainType=cdeTConnConfigTDomainType, cdeTConnDirectConfigTable=cdeTConnDirectConfigTable, cdeTConnOperPartnerCost=cdeTConnOperPartnerCost, cdeIfEntry=cdeIfEntry)
