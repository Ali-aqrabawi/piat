...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CIPCMPC-MIB
...
TDomain, TimeStamp, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TDomain", "TimeStamp", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-CIPCMPC-MIB", cipCmpcTgOperLastSeqNumFailureCause=cipCmpcTgOperLastSeqNumFailureCause, ciscoCipCmpcMibCompliance=ciscoCipCmpcMibCompliance, cipCmpcSubChannelAdminEntry=cipCmpcSubChannelAdminEntry, cipCmpcTgOperLastSeqNumReceived=cipCmpcTgOperLastSeqNumReceived, cipCmpcSubChannelAdminRowStatus=cipCmpcSubChannelAdminRowStatus, cipCmpcTgStatsDiscInds=cipCmpcTgStatsDiscInds, cipCmpcSubChannelAdminPath=cipCmpcSubChannelAdminPath, ciscoCipCmpcTgGroup=ciscoCipCmpcTgGroup, cipCmpcSubChannelOperEntry=cipCmpcSubChannelOperEntry, cipCmpcSubChannelAdminDirection=cipCmpcSubChannelAdminDirection, cipCmpcTgStatsConnectInds=cipCmpcTgStatsConnectInds, cipCmpcTgStatsDiscReqs=cipCmpcTgStatsDiscReqs, cipCmpcTgStatsSweepReqsIn=cipCmpcTgStatsSweepReqsIn, cipCmpcTgOperTable=cipCmpcTgOperTable, cipCmpcTgStatsTable=cipCmpcTgStatsTable, cipCmpcSubChannelAdminTgName=cipCmpcSubChannelAdminTgName, cipCmpcTg=cipCmpcTg, cipCmpcSubChannelAdminTable=cipCmpcSubChannelAdminTable, cipCmpcSubChannelAdminTgTransport=cipCmpcSubChannelAdminTgTransport, ciscoCipCmpcMibConformance=ciscoCipCmpcMibConformance, cipCmpcTgOperExpectedReceiveSeqNum=cipCmpcTgOperExpectedReceiveSeqNum, cipCmpcSubChannelAdminDevice=cipCmpcSubChannelAdminDevice, cipCmpcTgStatsConnectReqs=cipCmpcTgStatsConnectReqs, PYSNMP_MODULE_ID=ciscoCipCmpcMIB, cipCmpcTgStatsConnectCnfms=cipCmpcTgStatsConnectCnfms, cipCmpcSubChannelOperState=cipCmpcSubChannelOperState, cipCmpcTgStatsSweepReqsOut=cipCmpcTgStatsSweepReqsOut, cipCmpcTgOperName=cipCmpcTgOperName, cipCmpcTgStatsConnectRsps=cipCmpcTgStatsConnectRsps, cipCmpcSeqNumError=cipCmpcSeqNumError, cipCmpcTgStatsSweepRspsIn=cipCmpcTgStatsSweepRspsIn, ciscoCipCmpcMibGroups=ciscoCipCmpcMibGroups, cipCmpcSubChannelOperTable=cipCmpcSubChannelOperTable, cipCmpcSubChannelOperMaxbfru=cipCmpcSubChannelOperMaxbfru, cipCmpcTgStatsEntry=cipCmpcTgStatsEntry, cipCmpcTgStatsWraps=cipCmpcTgStatsWraps, cipCmpcTgStatsSweepRspsOut=cipCmpcTgStatsSweepRspsOut, cipCmpcNotifications=cipCmpcNotifications, cipCmpcTgOperEntry=cipCmpcTgOperEntry, ciscoCipCmpcSubChannelGroup=ciscoCipCmpcSubChannelGroup, cipCmpcTgOperLastSeqNumFailureTime=cipCmpcTgOperLastSeqNumFailureTime, cipCmpcDirectionMismatch=cipCmpcDirectionMismatch, cipCmpcTgOperLastSeqNumSent=cipCmpcTgOperLastSeqNumSent, ciscoCipCmpcMIB=ciscoCipCmpcMIB, cipCmpcObjects=cipCmpcObjects, ciscoCipCmpcMibCompliances=ciscoCipCmpcMibCompliances, cipCmpcSubChannel=cipCmpcSubChannel, cipCmpcNotificationPrefix=cipCmpcNotificationPrefix)
