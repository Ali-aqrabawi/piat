...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ITP-SCCP-MIB
...
CItpTcSubSystemNumber, CItpTcTableLoadStatus, CItpTcGtaDisplayZB, CItpTcTranslationType, CItpTcGtaAddr, CItpTcPointCode, CItpTcXuaName, CItpTcNumberingPlan, CItpTcNAI, CItpTcGtaDisplay, CItpTcDisplayPC = mibBuilder.importSymbols("CISCO-ITP-TC-MIB", "CItpTcSubSystemNumber", "CItpTcTableLoadStatus", "CItpTcGtaDisplayZB", "CItpTcTranslationType", "CItpTcGtaAddr", "CItpTcPointCode", "CItpTcXuaName", "CItpTcNumberingPlan", "CItpTcNAI", "CItpTcGtaDisplay", "CItpTcDisplayPC")
...
mibBuilder.exportSymbols("CISCO-ITP-SCCP-MIB", cItpSccpConformance=cItpSccpConformance, cItpSccpGttPrefGroup=cItpSccpGttPrefGroup, cItpSccpGttGtaGTI=cItpSccpGttGtaGTI, cItpSccpGttMapBackupSsn=cItpSccpGttMapBackupSsn, cItpSccpGttApp=cItpSccpGttApp, cItpSccpGttMapSsn=cItpSccpGttMapSsn, cItpSccpGttSelRefCount=cItpSccpGttSelRefCount, cItpSccpGttGtaResMap=cItpSccpGttGtaResMap, cItpSccpScalarsGroup=cItpSccpScalarsGroup, cItpSccpGttAppSsn=cItpSccpGttAppSsn, cItpSccpMIBComplianceRev1=cItpSccpMIBComplianceRev1, cItpSccpGttMapStateChange=cItpSccpGttMapStateChange, cItpSccpGttGtaTTorSSNvalue=cItpSccpGttGtaTTorSSNvalue, cItpSccpGttPrefInAddr=cItpSccpGttPrefInAddr, cItpSccpGttConPcTableEntry=cItpSccpGttConPcTableEntry, cItpSccpGttSelTable=cItpSccpGttSelTable, cItpSccpGttMapSsUnavail=cItpSccpGttMapSsUnavail, cItpSccpGttConPc=cItpSccpGttConPc, cItpSccpGttSelTableEntry=cItpSccpGttSelTableEntry, cItpSccpGttAppGrGroup=cItpSccpGttAppGrGroup, cItpSccpGttPrefTableEntry=cItpSccpGttPrefTableEntry, cItpSccpGttGtaSelName=cItpSccpGttGtaSelName, CItpSccpGttRoutingInd=CItpSccpGttRoutingInd, cItpSccpMIBCompliance=cItpSccpMIBCompliance, cItpSccpRsrToMtp=cItpSccpRsrToMtp, cItpSccpGttAppTable=cItpSccpGttAppTable, cItpSccpMIBNotifs=cItpSccpMIBNotifs, PYSNMP_MODULE_ID=ciscoItpSccpMIB, cItpSccpGttGta=cItpSccpGttGta, cItpSccpGttMapConPcList=cItpSccpGttMapConPcList, cItpSccpGttAppName=cItpSccpGttAppName, cItpSccpGttMapDisplayPC=cItpSccpGttMapDisplayPC, cItpSccpLUDTSMsgsSent=cItpSccpLUDTSMsgsSent, cItpSccpGttGtaResType=cItpSccpGttGtaResType, cItpSccpGttGtaAsName=cItpSccpGttGtaAsName, cItpSccpGttConPcTable=cItpSccpGttConPcTable, cItpSccpGttPrefOutAddr=cItpSccpGttPrefOutAddr, CItpSccpGttMapPcStatus=CItpSccpGttMapPcStatus, cItpSccpGttPostPrefConv=cItpSccpGttPostPrefConv, CItpSccpGttGlobalTitleInd=CItpSccpGttGlobalTitleInd, cItpSccpGttConfigLoadStatus=cItpSccpGttConfigLoadStatus, CItpSccpGttMapSsStatus=CItpSccpGttMapSsStatus, cItpSccpGttMapDisplaySS=cItpSccpGttMapDisplaySS, CItpSccpGttGtaAddrLen=CItpSccpGttGtaAddrLen, cItpSccpLUDTSMsgsRcvd=cItpSccpLUDTSMsgsRcvd, cItpSccpSelConfigLastChanged=cItpSccpSelConfigLastChanged, cItpSccpAppConfigLastChanged=cItpSccpAppConfigLastChanged, cItpSccpGttAppGrType=cItpSccpGttAppGrType, cItpSccpGttMapSccpUnavail=cItpSccpGttMapSccpUnavail, cItpSccpGttSelNP=cItpSccpGttSelNP, cItpSccpCpcConfigLastChanged=cItpSccpCpcConfigLastChanged, CItpSccpGttQOS=CItpSccpGttQOS, cItpSccpGttAppTableEntry=cItpSccpGttAppTableEntry, CItpSccpGttAppName=CItpSccpGttAppName, CItpSccpGttMapCongStatus=CItpSccpGttMapCongStatus, cItpSccpGttPrefTblNAI=cItpSccpGttPrefTblNAI, cItpSccpGttAppGrSsn=cItpSccpGttAppGrSsn, CItpSccpGttAppCost=CItpSccpGttAppCost, cItpSccpGttConfigLoad=cItpSccpGttConfigLoad, cItpSccpGttPrefTable=cItpSccpGttPrefTable, cItpSccpGttGtaTT=cItpSccpGttGtaTT, cItpSccpGttMapType=cItpSccpGttMapType, cItpSccpGttGtaAddrDisp=cItpSccpGttGtaAddrDisp, cItpSccpGttAppGrNumUsed=cItpSccpGttAppGrNumUsed, CItpSccpGttAppType=CItpSccpGttAppType, cItpSccpUDTMsgsRcvd=cItpSccpUDTMsgsRcvd, cItpSccpXUDTMsgsSent=cItpSccpXUDTMsgsSent, cItpSccpGttSelQOS=cItpSccpGttSelQOS, cItpSccpGttAppType=cItpSccpGttAppType, cItpSccpGttMapMultInd=cItpSccpGttMapMultInd, cItpSccpCrFromMtp=cItpSccpCrFromMtp, cItpSccpMIBObjects=cItpSccpMIBObjects, cItpSccpGttMapUsed=cItpSccpGttMapUsed, cItpSccpGttMapTable=cItpSccpGttMapTable, cItpSccpUDTSMsgsSent=cItpSccpUDTSMsgsSent, cItpSccpGttGtaTTorSSN=cItpSccpGttGtaTTorSSN, cItpSccpGttAppGrAsName=cItpSccpGttAppGrAsName, ciscoItpSccpMIB=ciscoItpSccpMIB, cItpSccpGttGtaResPc=cItpSccpGttGtaResPc, cItpSccpErrFromMtp=cItpSccpErrFromMtp, cItpSccpGttAppRi=cItpSccpGttAppRi, cItpSccpGttGtaAddrLenZB=cItpSccpGttGtaAddrLenZB, cItpSccpGttAppGroup=cItpSccpGttAppGroup, cItpSccpGttAppGrRi=cItpSccpGttAppGrRi, cItpSccpGttConPcRefCount=cItpSccpGttConPcRefCount, cItpSccpErrToMtp=cItpSccpErrToMtp, cItpSccpMapConfigLastChanged=cItpSccpMapConfigLastChanged, cItpSccpGttSelName=cItpSccpGttSelName, cItpSccpXUDTSMsgsSent=cItpSccpXUDTSMsgsSent, cItpSccpGttAppGrCost=cItpSccpGttAppGrCost, cItpSccpCrefToMtp=cItpSccpCrefToMtp, cItpSccpGttPrefItemNP=cItpSccpGttPrefItemNP, cItpSccpGttAppRefCount=cItpSccpGttAppRefCount, cItpSccpGttGtaGroupRev1=cItpSccpGttGtaGroupRev1, cItpSccpGttAppGrRefCount=cItpSccpGttAppGrRefCount, cItpSccpGtaConfigLastChanged=cItpSccpGtaConfigLastChanged, cItpSccpGttAppCost=cItpSccpGttAppCost, cItpSccpXUDTSMsgsRcvd=cItpSccpXUDTSMsgsRcvd, CItpSccpGttGtaAddrLenZB=CItpSccpGttGtaAddrLenZB, CItpSccpGttTransType=CItpSccpGttTransType, cItpSccpGttMapGroup=cItpSccpGttMapGroup, cItpSccpGttMapSsStatus=cItpSccpGttMapSsStatus, cItpSccpGttGtaTableEntry=cItpSccpGttGtaTableEntry, cItpSccpGttAppGrNewSsn=cItpSccpGttAppGrNewSsn, cItpSccpGttPrePrefConv=cItpSccpGttPrePrefConv, cItpSccpGttGtaAddrDispZB=cItpSccpGttGtaAddrDispZB, cItpSccpNotifications=cItpSccpNotifications, cItpSccpGttGtaGroup=cItpSccpGttGtaGroup, cItpSccpRsrFromMtp=cItpSccpRsrFromMtp, cItpSccpGttAppGrPc=cItpSccpGttAppGrPc, cItpSccpMIBCompliances=cItpSccpMIBCompliances, cItpSccpLUDTMsgsSent=cItpSccpLUDTMsgsSent, cItpSccpGttAppGrEntNum=cItpSccpGttAppGrEntNum, cItpSccpGttSelNAI=cItpSccpGttSelNAI, cItpSccpGttAppPc=cItpSccpGttAppPc, cItpSccpGttSelGroupRev1=cItpSccpGttSelGroupRev1, cItpSccpGttConPointCode=cItpSccpGttConPointCode, cItpSccpUDTSMsgsRcvd=cItpSccpUDTSMsgsRcvd, cItpSccpGttAppMult=cItpSccpGttAppMult, cItpSccpGttGtaAddr=cItpSccpGttGtaAddr, cItpSccpGttConPcGroup=cItpSccpGttConPcGroup, cItpSccpGttGtaRoutingInd=cItpSccpGttGtaRoutingInd, cItpSccpGttAppGrMult=cItpSccpGttAppGrMult, CItpSccpGttMultInd=CItpSccpGttMultInd, cItpSccpGttMapSsCongested=cItpSccpGttMapSsCongested, cItpSccpGttMapPc=cItpSccpGttMapPc, cItpSccpGttSelTT=cItpSccpGttSelTT, cItpSccpGttMapPcCongested=cItpSccpGttMapPcCongested, cItpSccpGttAppGrTable=cItpSccpGttAppGrTable, cItpSccpGttSelNumPerf=cItpSccpGttSelNumPerf, cItpSccpGttMapReRouteOnCong=cItpSccpGttMapReRouteOnCong, cItpSccpGttGtaTable=cItpSccpGttGtaTable, cItpSccpGttGtaNAI=cItpSccpGttGtaNAI, cItpSccpGttAppGrName=cItpSccpGttAppGrName, cItpSccpUDTMsgsSent=cItpSccpUDTMsgsSent, cItpSccpCrefFromMtp=cItpSccpCrefFromMtp, cItpSccpGttMapTableEntry=cItpSccpGttMapTableEntry, cItpSccpGttMapLastSsUsed=cItpSccpGttMapLastSsUsed, cItpSccpGttAppGrTableEntry=cItpSccpGttAppGrTableEntry, cItpSccpGttMapAltUsed=cItpSccpGttMapAltUsed, cItpSccpGttMapRefCount=cItpSccpGttMapRefCount, cItpSccpGttMap=cItpSccpGttMap, cItpSccpScalars=cItpSccpScalars, cItpSccpGttMapAdjacent=cItpSccpGttMapAdjacent, cItpSccpGttSelGroup=cItpSccpGttSelGroup, cItpSccpGttConPcListName=cItpSccpGttConPcListName, cItpSccpTotalMsgs=cItpSccpTotalMsgs, cItpSccpGttAppGrGroupRev2=cItpSccpGttAppGrGroupRev2, cItpSccpGttMapStateNotifEnabled=cItpSccpGttMapStateNotifEnabled, cItpSccpXUDTMsgsRcvd=cItpSccpXUDTMsgsRcvd, cItpSccpGttMapBackupPc=cItpSccpGttMapBackupPc, cItpSccpGttAppGr=cItpSccpGttAppGr, cItpSccpGttPref=cItpSccpGttPref, cItpSccpGttSelNotFound=cItpSccpGttSelNotFound, CItpSccpGttGtaResType=CItpSccpGttGtaResType, cItpSccpGttGtaResAppGroup=cItpSccpGttGtaResAppGroup, cItpSccpGttGtaQOS=cItpSccpGttGtaQOS, cItpSccpMIBComplianceRev2=cItpSccpMIBComplianceRev2, cItpSccpMIBGroups=cItpSccpMIBGroups, cItpSccpGttGtaGroupRev2=cItpSccpGttGtaGroupRev2, cItpSccpGttMapPcUnavail=cItpSccpGttMapPcUnavail, cItpSccpGttGtaNP=cItpSccpGttGtaNP, cItpSccpConfigStatusGroup=cItpSccpConfigStatusGroup, cItpSccpGttPrefName=cItpSccpGttPrefName, cItpSccpGttPrefTblNP=cItpSccpGttPrefTblNP, cItpSccpLUDTMsgsRcvd=cItpSccpLUDTMsgsRcvd, CItpSccpGttPrefName=CItpSccpGttPrefName, cItpSccpPrefConfigLastChanged=cItpSccpPrefConfigLastChanged, cItpSccpCrToMtp=cItpSccpCrToMtp, cItpSccpGttSelGTI=cItpSccpGttSelGTI, cItpSccpGttMapCongStatus=cItpSccpGttMapCongStatus, cItpSccpLocalMsgs=cItpSccpLocalMsgs, cItpSccpTotalGttMsgs=cItpSccpTotalGttMsgs, cItpSccpGttGtaAddrLen=cItpSccpGttGtaAddrLen, cItpSccpGttPrefItemNAI=cItpSccpGttPrefItemNAI, CItpSccpGttDisplaySS=CItpSccpGttDisplaySS, cItpSccpNotificationsGroup=cItpSccpNotificationsGroup, cItpSccpGttMapMtp3Fail=cItpSccpGttMapMtp3Fail, CItpSccpConPcListName=CItpSccpConPcListName, CItpSccpGttSelName=CItpSccpGttSelName, cItpSccpGttSel=cItpSccpGttSel, CItpSccpGttMapType=CItpSccpGttMapType, cItpSccpGttMapPcStatus=cItpSccpGttMapPcStatus)
