...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ITP-XUA-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:25:31 2019
...
CItpTcXuaName, CItpTcServiceIndicator, CItpTcPointCode, CItpTcNetworkName, CItpTcSubSystemNumber, CItpTcQos = mibBuilder.importSymbols("CISCO-ITP-TC-MIB", "CItpTcXuaName", "CItpTcServiceIndicator", "CItpTcPointCode", "CItpTcNetworkName", "CItpTcSubSystemNumber", "CItpTcQos")
ciscoMgmt, = mibBuilder.importSymbols("CISCO-SMI", "ciscoMgmt")
InetPortNumber, InetAddress, InetAddressType = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetPortNumber", "InetAddress", "InetAddressType")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
TimeTicks, MibIdentifier, ModuleIdentity, ObjectIdentity, Integer32, Bits, iso, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Integer32", "Bits", "iso", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("CISCO-ITP-XUA-MIB", cItpXuaSgmRowStatus=cItpXuaSgmRowStatus, cItpXuaAspErrorsRcvd=cItpXuaAspErrorsRcvd, cItpXuaASRouteAsTable=cItpXuaASRouteAsTable, cItpXuaAspSCON3sRcvd=cItpXuaAspSCON3sRcvd, cItpXuaInstLocalIpTableEntry=cItpXuaInstLocalIpTableEntry, cItpXuaSgmTableEntry=cItpXuaSgmTableEntry, cItpXuaAspBytesFromMtp3=cItpXuaAspBytesFromMtp3, ciscoItpXuaSgmCongChange=ciscoItpXuaSgmCongChange, cItpXuaInstLocalIpRowStatus=cItpXuaInstLocalIpRowStatus, CItpXuaProtocol=CItpXuaProtocol, cItpXuaAspBytesFromAsp=cItpXuaAspBytesFromAsp, cItpXuaSgmRemoteIpTableEntry=cItpXuaSgmRemoteIpTableEntry, cItpXuaAspPktsFromAsp=cItpXuaAspPktsFromAsp, cItpXuaAspAsWeight=cItpXuaAspAsWeight, cItpXuaAspPktsFromMtp3=cItpXuaAspPktsFromMtp3, cItpXuaAsrAsState=cItpXuaAsrAsState, cItpXuaAsTableEntry=cItpXuaAsTableEntry, ciscoItpXuaInstGroupRev2=ciscoItpXuaInstGroupRev2, cItpXuaInstShut=cItpXuaInstShut, CItpXuaTrafMode=CItpXuaTrafMode, ciscoItpXuaNotifGroupRev1=ciscoItpXuaNotifGroupRev1, cItpXuaSgmRemoteIpType=cItpXuaSgmRemoteIpType, ciscoItpXuaNotifObjectsGroup=ciscoItpXuaNotifObjectsGroup, cItpXuaAsProtocol=cItpXuaAsProtocol, cItpXuaInstTable=cItpXuaInstTable, cItpXuaAspStatsTableEntry=cItpXuaAspStatsTableEntry, cItpXuaAsBytesFromMtp3=cItpXuaAsBytesFromMtp3, cItpXuaSgmRemoteIp=cItpXuaSgmRemoteIp, cItpXuaAsrOutbPktsRcvd=cItpXuaAsrOutbPktsRcvd, ciscoItpXuaAsrGroup=ciscoItpXuaAsrGroup, cItpXuaAspASPACACKsSent=cItpXuaAspASPACACKsSent, ciscoItpXuaAsGroupRev2=ciscoItpXuaAsGroupRev2, ciscoItpXuaAspAssocStateChange=ciscoItpXuaAspAssocStateChange, ciscoItpXuaAsrAsGroup=ciscoItpXuaAsrAsGroup, cItpXuaAspStats=cItpXuaAspStats, cItpXuaAspCongLevel=cItpXuaAspCongLevel, cItpXuaAspQosClass=cItpXuaAspQosClass, PYSNMP_MODULE_ID=ciscoItpXuaMIB, cItpXuaAspRemoteIp=cItpXuaAspRemoteIp, cItpXuaSgmTable=cItpXuaSgmTable, cItpXuaAsrAsName=cItpXuaAsrAsName, cItpXuaStateChangeNotifEnabled=cItpXuaStateChangeNotifEnabled, cItpXuaAspStatsTable=cItpXuaAspStatsTable, cItpXuaAsNetworkName=cItpXuaAsNetworkName, cItpXuaAspDUPUsSent=cItpXuaAspDUPUsSent, cItpXuaAsrRoutingContext=cItpXuaAsrRoutingContext, cItpXuaAsrOutbByteSent=cItpXuaAsrOutbByteSent, cItpXuaAsRerouting=cItpXuaAsRerouting, cItpXuaAsDisplayName=cItpXuaAsDisplayName, cItpXuaAsActiveTS=cItpXuaAsActiveTS, cItpXuaAspAs=cItpXuaAspAs, cItpXuaAspRemotePort=cItpXuaAspRemotePort, cItpXuaAspRemoteIpRowStatus=cItpXuaAspRemoteIpRowStatus, cItpXuaAspSCON1sRcvd=cItpXuaAspSCON1sRcvd, ciscoItpXuaMIBComplianceRev2=ciscoItpXuaMIBComplianceRev2, cItpXuaAspSCON3sSent=cItpXuaAspSCON3sSent, cItpXuaAsrAsOutbByteRcvd=cItpXuaAsrAsOutbByteRcvd, CItpXuaAspState=CItpXuaAspState, cItpXuaSgmShut=cItpXuaSgmShut, cItpXuaAspBytesToMtp3=cItpXuaAspBytesToMtp3, cItpXuaAspDAVAsRcvd=cItpXuaAspDAVAsRcvd, cItpXuaAsQosClass=cItpXuaAsQosClass, cItpXuaAspRemoteIpAddr=cItpXuaAspRemoteIpAddr, cItpXuaAspSCON2sSent=cItpXuaAspSCON2sSent, ciscoItpXuaConformance=ciscoItpXuaConformance, cItpXuaAsBytesToASPsOfAs=cItpXuaAsBytesToASPsOfAs, cItpXuaAsRkSi=cItpXuaAsRkSi, cItpXuaAsrAsDrstRcvd=cItpXuaAsrAsDrstRcvd, ciscoItpXuaAspGroupRev2=ciscoItpXuaAspGroupRev2, cItpXuaAspAsState=cItpXuaAspAsState, ciscoItpXuaSgmRemoteIpGroup=ciscoItpXuaSgmRemoteIpGroup, cItpXuaASRouteTableEntry=cItpXuaASRouteTableEntry, cItpXuaAspShut=cItpXuaAspShut, ciscoItpXuaMIBCompliance=ciscoItpXuaMIBCompliance, cItpXuaAspPktsToAsp=cItpXuaAspPktsToAsp, ciscoItpXuaAspSup1Group=ciscoItpXuaAspSup1Group, ciscoItpXuaAspCongChange=ciscoItpXuaAspCongChange, cItpXuaSgmAssocId=cItpXuaSgmAssocId, cItpXuaAsrSgmateDavaRcvd=cItpXuaAsrSgmateDavaRcvd, cItpXuaAspASPIAsRcvd=cItpXuaAspASPIAsRcvd, cItpXuaAspASPDNsRcvd=cItpXuaAspASPDNsRcvd, cItpXuaAsStateOnSgMate=cItpXuaAsStateOnSgMate, CItpXuaAssocState=CItpXuaAssocState, cItpXuaAspAsRowStatus=cItpXuaAspAsRowStatus, ciscoItpXuaInstLocalIpGroup=ciscoItpXuaInstLocalIpGroup, cItpXuaAspTable=cItpXuaAspTable, cItpXuaSgmPassive=cItpXuaSgmPassive, cItpXuaInstLocalIpTable=cItpXuaInstLocalIpTable, cItpXuaAspErrorsSent=cItpXuaAspErrorsSent, ciscoItpXuaMIBGroups=ciscoItpXuaMIBGroups, cItpXuaAspAssocIdU32=cItpXuaAspAssocIdU32, cItpXuaAsRkSsn=cItpXuaAsRkSsn, cItpXuaAspName=cItpXuaAspName, cItpXuaInstRowStatus=cItpXuaInstRowStatus, cItpXuaInstAddrNum=cItpXuaInstAddrNum, cItpXuaAspASPUPsRcvd=cItpXuaAspASPUPsRcvd, ciscoItpXuaSgmGroup=ciscoItpXuaSgmGroup, ciscoItpXuaAspGroup=ciscoItpXuaAspGroup, ciscoItpXuaSgmGroupRev1=ciscoItpXuaSgmGroupRev1, cItpXuaSgmDisplayName=cItpXuaSgmDisplayName, cItpXuaAsrRowStatus=cItpXuaAsrRowStatus, cItpXuaAsrNetwork=cItpXuaAsrNetwork, ciscoItpXuaNotifGroup=ciscoItpXuaNotifGroup, cItpXuaSgmAddrNum=cItpXuaSgmAddrNum, cItpXuaAsCongLevel=cItpXuaAsCongLevel, cItpXuaAspProtocol=cItpXuaAspProtocol, cItpXuaInstPort=cItpXuaInstPort, cItpXuaAsNetworkAppear=cItpXuaAsNetworkAppear, cItpXuaAsrSgmateState=cItpXuaAsrSgmateState, ciscoItpXuaAspDestAddrStateChange=ciscoItpXuaAspDestAddrStateChange, cItpXuaAspAddrNum=cItpXuaAspAddrNum, cItpXuaAsrSgmateDunaRcvd=cItpXuaAsrSgmateDunaRcvd, ciscoItpXuaMIBObjects=ciscoItpXuaMIBObjects, ciscoItpXuaMIBComplianceRev6=ciscoItpXuaMIBComplianceRev6, cItpXuaAsrAsOutbPktsSent=cItpXuaAsrAsOutbPktsSent, cItpXuaAspDAUDsRcvd=cItpXuaAspDAUDsRcvd, cItpXuaAsPktsToMtp3=cItpXuaAsPktsToMtp3, ciscoItpXuaAsGroupRev3=ciscoItpXuaAsGroupRev3, CItpXuaAsState=CItpXuaAsState, cItpXuaAsrName=cItpXuaAsrName, cItpXuaAspBytesToAsp=cItpXuaAspBytesToAsp, cItpXuaAspDUNAsRcvd=cItpXuaAspDUNAsRcvd, cItpXuaAsPktsFromASPsOfAs=cItpXuaAsPktsFromASPsOfAs, cItpXuaAspASPDNACKsSent=cItpXuaAspASPDNACKsSent, cItpXuaAspSCON2sRcvd=cItpXuaAspSCON2sRcvd, cItpXuaAsRkParameters=cItpXuaAsRkParameters, ciscoItpXuaAspRemoteIpSup1Group=ciscoItpXuaAspRemoteIpSup1Group, cItpXuaAspASPUPACKsSent=cItpXuaAspASPUPACKsSent, cItpXuaAsp=cItpXuaAsp, cItpXuaSgmLocalPort=cItpXuaSgmLocalPort, cItpXuaAspRemoteIpTableEntry=cItpXuaAspRemoteIpTableEntry, cItpXuaASRoute=cItpXuaASRoute, cItpXuaAsState=cItpXuaAsState, cItpXuaAsRowStatus=cItpXuaAsRowStatus, cItpXuaAsrAsOutbPktsRcvd=cItpXuaAsrAsOutbPktsRcvd, cItpXuaInstOffload=cItpXuaInstOffload, cItpXuaSgmRemoteIpTable=cItpXuaSgmRemoteIpTable, ciscoItpXuaAspGroupRev1=ciscoItpXuaAspGroupRev1, cItpXuaAspASPIAACKsSent=cItpXuaAspASPIAACKsSent, ciscoItpXuaAspStatsGroup=ciscoItpXuaAspStatsGroup, cItpXuaAsrAsPriority=cItpXuaAsrAsPriority, ciscoItpXuaSgmDestAddrStateChange=ciscoItpXuaSgmDestAddrStateChange, CItpXuaRouteState=CItpXuaRouteState, cItpXuaSgmAssocState=cItpXuaSgmAssocState, cItpXuaAspAssocFailedReason=cItpXuaAspAssocFailedReason, cItpXuaAsrAsOutbByteSent=cItpXuaAsrAsOutbByteSent, cItpXuaAspDUNAsSent=cItpXuaAspDUNAsSent, cItpXuaAspIdentifier=cItpXuaAspIdentifier, cItpXuaAsBytesFromASPsOfAs=cItpXuaAsBytesFromASPsOfAs, cItpXuaAsPktsFromMtp3=cItpXuaAsPktsFromMtp3, cItpXuaAspConfigLastChanged=cItpXuaAspConfigLastChanged, cItpXuaAsName=cItpXuaAsName, cItpXuaAspBlocked=cItpXuaAspBlocked, cItpXuaAspRowStatus=cItpXuaAspRowStatus, cItpXuaAsRkCicMax=cItpXuaAsRkCicMax, cItpXuaAsrOutbPktsSent=cItpXuaAsrOutbPktsSent, cItpXuaInstLocalIp=cItpXuaInstLocalIp, cItpXuaAspRemoteIpType=cItpXuaAspRemoteIpType, ciscoItpXuaAspAsGroupRev3=ciscoItpXuaAspAsGroupRev3, cItpXuaAspPktsToMtp3=cItpXuaAspPktsToMtp3, cItpXuaAspDisplayName=cItpXuaAspDisplayName, ciscoItpXuaMIBNotifs=ciscoItpXuaMIBNotifs, ciscoItpXuaAsStateChange=ciscoItpXuaAsStateChange, cItpXuaAspSCON0sSent=cItpXuaAspSCON0sSent, cItpXuaAsRkOpc=cItpXuaAsRkOpc, cItpXuaAspAsActiveTS=cItpXuaAspAsActiveTS, cItpXuaSgmRemoteIpDestState=cItpXuaSgmRemoteIpDestState, cItpXuaAsrShut=cItpXuaAsrShut, ciscoItpXuaMIBComplianceRev3=ciscoItpXuaMIBComplianceRev3, cItpXuaAspNotifysSent=cItpXuaAspNotifysSent, cItpXuaAspDAVAsSent=cItpXuaAspDAVAsSent, cItpXuaAsrSgmatePriority=cItpXuaAsrSgmatePriority, ciscoItpXuaMIBComplianceRev5=ciscoItpXuaMIBComplianceRev5, cItpXuaAsrDpc=cItpXuaAsrDpc, cItpXuaInstTableEntry=cItpXuaInstTableEntry, cItpXuaSgmQosClass=cItpXuaSgmQosClass, cItpXuaAspASPACsRcvd=cItpXuaAspASPACsRcvd, ciscoItpXuaMIBCompliances=ciscoItpXuaMIBCompliances, cItpXuaAspLocalPort=cItpXuaAspLocalPort, cItpXuaAsrAsDavaRcvd=cItpXuaAsrAsDavaRcvd, ciscoItpXuaAspStatsSup1Group=ciscoItpXuaAspStatsSup1Group, cItpXuaAspDUPUsRcvd=cItpXuaAspDUPUsRcvd, cItpXuaAsTrafMode=cItpXuaAsTrafMode, cItpXuaAsrProtocol=cItpXuaAsrProtocol, cItpXuaSgmRemoteIpRowStatus=cItpXuaSgmRemoteIpRowStatus, cItpXuaSgmAssocFailedReason=cItpXuaSgmAssocFailedReason, cItpXuaInstProtocol=cItpXuaInstProtocol, cItpXuaAspAssocId=cItpXuaAspAssocId, cItpXuaASRouteAsTableEntry=cItpXuaASRouteAsTableEntry, cItpXuaAs=cItpXuaAs, ciscoItpXuaSgmAssocStateChange=ciscoItpXuaSgmAssocStateChange, cItpXuaInstLocalIpAddr=cItpXuaInstLocalIpAddr, ciscoItpXuaSgmRemoteIpSup1Group=ciscoItpXuaSgmRemoteIpSup1Group, cItpXuaAspAsTable=cItpXuaAspAsTable, ciscoItpXuaInstGroup=ciscoItpXuaInstGroup, cItpXuaInstConfigLastChanged=cItpXuaInstConfigLastChanged, cItpXuaAsRkOpcMask=cItpXuaAsRkOpcMask, cItpXuaSgmActiveTS=cItpXuaSgmActiveTS, cItpXuaAsBytesToMtp3=cItpXuaAsBytesToMtp3, ciscoItpXuaNotificationsGroup=ciscoItpXuaNotificationsGroup, ciscoItpXuaAsSup1Group=ciscoItpXuaAsSup1Group, cItpXuaAsPktsToASPsOfAs=cItpXuaAsPktsToASPsOfAs, ciscoItpXuaSgmStateChange=ciscoItpXuaSgmStateChange, ciscoItpXuaInstGroupSup1Group=ciscoItpXuaInstGroupSup1Group, cItpXuaAspRemoteIpTable=cItpXuaAspRemoteIpTable, ciscoItpXuaSup1Groups=ciscoItpXuaSup1Groups, cItpXuaAsConfigLastChanged=cItpXuaAsConfigLastChanged, cItpXuaAsrSgmateDrstRcvd=cItpXuaAsrSgmateDrstRcvd, CItpXuaRemoteIpDestState=CItpXuaRemoteIpDestState, ciscoItpXuaAspRemoteIpGroup=ciscoItpXuaAspRemoteIpGroup, cItpXuaInst=cItpXuaInst, cItpXuaInstActiveASPs=cItpXuaInstActiveASPs, cItpXuaSgmName=cItpXuaSgmName, cItpXuaAsTable=cItpXuaAsTable, cItpXuaASRouteAs=cItpXuaASRouteAs, cItpXuaSgmRemoteIpAddr=cItpXuaSgmRemoteIpAddr, cItpXuaAspAssocState=cItpXuaAspAssocState, cItpXuaSgmCongLevel=cItpXuaSgmCongLevel, cItpXuaAspSCON1sSent=cItpXuaAspSCON1sSent, cItpXuaASRouteTable=cItpXuaASRouteTable, cItpXuaScalars=cItpXuaScalars, cItpXuaSgmConfigLastChanged=cItpXuaSgmConfigLastChanged, cItpXuaAsShut=cItpXuaAsShut, ciscoItpXuaMIB=ciscoItpXuaMIB, ciscoItpXuaAsGroup=ciscoItpXuaAsGroup, cItpXuaInstLocalIpType=cItpXuaInstLocalIpType, ciscoItpXuaMIBComplianceRev4=ciscoItpXuaMIBComplianceRev4, cItpXuaAspTableEntry=cItpXuaAspTableEntry, cItpXuaAspRemoteIpDestState=cItpXuaAspRemoteIpDestState, cItpXuaInstOffProcNumber=cItpXuaInstOffProcNumber, cItpXuaAsRoutingContext=cItpXuaAsRoutingContext, cItpXuaAsRkCicMin=cItpXuaAsRkCicMin, cItpXuaAsRkGtt=cItpXuaAsRkGtt, cItpXuaSgmRemotePort=cItpXuaSgmRemotePort, cItpXuaInstOffloadSlot=cItpXuaInstOffloadSlot, cItpXuaAsrOutbByteRcvd=cItpXuaAsrOutbByteRcvd, cItpXuaAsrAsRowStatus=cItpXuaAsrAsRowStatus, cItpXuaMIBNotifObjects=cItpXuaMIBNotifObjects, ciscoItpXuaAspStateChange=ciscoItpXuaAspStateChange, ciscoItpXuaSgmGroupSup1Group=ciscoItpXuaSgmGroupSup1Group, cItpXuaAspDAUDsSent=cItpXuaAspDAUDsSent, ciscoItpXuaScalarsGroup=ciscoItpXuaScalarsGroup, ciscoItpXuaAspAsGroup=ciscoItpXuaAspAsGroup, cItpXuaAspAsTableEntry=cItpXuaAspAsTableEntry, cItpXuaSgm=cItpXuaSgm, cItpXuaAspAsName=cItpXuaAspAsName, cItpXuaAsrAsDunaRcvd=cItpXuaAsrAsDunaRcvd, cItpXuaAspSCON0sRcvd=cItpXuaAspSCON0sRcvd, ciscoItpXuaMIBComplianceRev1=ciscoItpXuaMIBComplianceRev1, cItpXuaAsRkDpc=cItpXuaAsRkDpc, cItpXuaSgmState=cItpXuaSgmState)
