...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IETF-VRRP-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:24:55 2019
...
Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, NotificationType, Unsigned32, Bits, Gauge32, MibIdentifier, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "NotificationType", "Unsigned32", "Bits", "Gauge32", "MibIdentifier", "iso", "ModuleIdentity", "Integer32")
TextualConvention, DisplayString, TimeStamp, TruthValue, MacAddress, TimeInterval, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "TruthValue", "MacAddress", "TimeInterval", "RowStatus")
...
mibBuilder.exportSymbols("CISCO-IETF-VRRP-MIB", cVrrpStatisticsAdvIntervalErrors=cVrrpStatisticsAdvIntervalErrors, CVrId=CVrId, cVrrpOperationsPrimaryIpAddr=cVrrpOperationsPrimaryIpAddr, cVrrpConformance=cVrrpConformance, cVrrpOperationsMasterIpAddr=cVrrpOperationsMasterIpAddr, cVrrpOperationsPreemptMode=cVrrpOperationsPreemptMode, cVrrpAssociatedInetAddrType=cVrrpAssociatedInetAddrType, cVrrpOperationsAdvInterval=cVrrpOperationsAdvInterval, ciscoVrrpMIB=ciscoVrrpMIB, cVrrpRouterStatisticsEntry=cVrrpRouterStatisticsEntry, cVrrpStatisticsRefreshRate=cVrrpStatisticsRefreshRate, cVrrpOperationsState=cVrrpOperationsState, cVrrpStatisticsPriZeroPktsRcvd=cVrrpStatisticsPriZeroPktsRcvd, cVrrpOperationsPriority=cVrrpOperationsPriority, PYSNMP_MODULE_ID=ciscoVrrpMIB, cVrrpRouterStatisticsTable=cVrrpRouterStatisticsTable, cVrrpOperationsGroup=cVrrpOperationsGroup, cVrrpRouterChecksumErrors=cVrrpRouterChecksumErrors, cVrrpNotificationProtoErrReason=cVrrpNotificationProtoErrReason, cVrrpMIBCompliance2=cVrrpMIBCompliance2, cVrrpStatisticsBecomeMaster=cVrrpStatisticsBecomeMaster, cVrrpStatisticsAdvertiseRcvd=cVrrpStatisticsAdvertiseRcvd, cVrrpStatisticsPacketLengthErrors=cVrrpStatisticsPacketLengthErrors, cVrrpNotificationProtoError=cVrrpNotificationProtoError, cVrrpNotificationNewMasterReason=cVrrpNotificationNewMasterReason, cVrrpOperationsVirtualMacAddr=cVrrpOperationsVirtualMacAddr, cVrrpOperationsAddrCount=cVrrpOperationsAddrCount, cVrrpNotificationsGroup=cVrrpNotificationsGroup, cVrrpNotificationCntl=cVrrpNotificationCntl, cVrrpRouterVersionErrors=cVrrpRouterVersionErrors, cVrrpNotifications=cVrrpNotifications, cVrrpNotificationInfoGroup=cVrrpNotificationInfoGroup, cVrrpNotificationNewMaster=cVrrpNotificationNewMaster, cVrrpStatisticsIpTtlErrors=cVrrpStatisticsIpTtlErrors, cVrrpStatisticsInvldTypePktsRcvd=cVrrpStatisticsInvldTypePktsRcvd, cVrrpAssociatedIpAddr=cVrrpAssociatedIpAddr, cVrrpOperationsEntry=cVrrpOperationsEntry, cVrrpOperationsVrId=cVrrpOperationsVrId, cVrrpStatisticsPriZeroPktsSent=cVrrpStatisticsPriZeroPktsSent, cVrrpAssociatedIpAddrTable=cVrrpAssociatedIpAddrTable, cVrrpStatisticsGroup=cVrrpStatisticsGroup, cVrrpStatisticsInvalidAuthType=cVrrpStatisticsInvalidAuthType, cVrrpMIBCompliances=cVrrpMIBCompliances, cVrrpStatistics=cVrrpStatistics, cVrrpOperationsVersion=cVrrpOperationsVersion, cVrrpMIBGroups=cVrrpMIBGroups, cVrrpOperationsInetAddrType=cVrrpOperationsInetAddrType, cVrrpOperationsRowStatus=cVrrpOperationsRowStatus, cVrrpAssociatedIpAddrRowStatus=cVrrpAssociatedIpAddrRowStatus, cVrrpMIBReadOnlyCompliance=cVrrpMIBReadOnlyCompliance, cVrrpOperationsAcceptMode=cVrrpOperationsAcceptMode, cVrrpAssociatedIpAddrEntry=cVrrpAssociatedIpAddrEntry, cVrrpStatisticsDiscontinuityTime=cVrrpStatisticsDiscontinuityTime, cVrrpOperations=cVrrpOperations, cVrrpRouterVrIdErrors=cVrrpRouterVrIdErrors, cVrrpStatisticsAddressListErrors=cVrrpStatisticsAddressListErrors, cVrrpOperationsTable=cVrrpOperationsTable, cVrrpOperationsUpTime=cVrrpOperationsUpTime)
