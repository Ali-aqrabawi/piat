...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-STP-EXTENSIONS-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:36:46 2019
...
vtpVlanEntry, vlanTrunkPortEntry, vtpVlanEditEntry, VlanIndex = mibBuilder.importSymbols("CISCO-VTP-MIB", "vtpVlanEntry", "vlanTrunkPortEntry", "vtpVlanEditEntry", "VlanIndex")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, NotificationType, iso, Bits, Counter64, MibIdentifier, Gauge32, Integer32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "NotificationType", "iso", "Bits", "Counter64", "MibIdentifier", "Gauge32", "Integer32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-STP-EXTENSIONS-MIB", stpxPVSTVlanTable=stpxPVSTVlanTable, stpxMIBCompliance4=stpxMIBCompliance4, stpxLongStpPortPathCost=stpxLongStpPortPathCost, stpxMIBCompliance8=stpxMIBCompliance8, stpxRootInconsistencyIndex=stpxRootInconsistencyIndex, stpxRSTPPortTable=stpxRSTPPortTable, stpxFastStartOperModeEntry=stpxFastStartOperModeEntry, stpxMSTInstanceIndex=stpxMSTInstanceIndex, stpxLoopGuardGlobalDefaultMode=stpxLoopGuardGlobalDefaultMode, stpxSMSTPortAdminMSTMode=stpxSMSTPortAdminMSTMode, stpxFastStartOperModeGroup=stpxFastStartOperModeGroup, stpxMIBCompliance2=stpxMIBCompliance2, stpxPreferredVlansMap3k=stpxPreferredVlansMap3k, stpxUplinkFastEnabled=stpxUplinkFastEnabled, stpxRootInconsistencyTable=stpxRootInconsistencyTable, stpxVlanObjects=stpxVlanObjects, stpxSMSTInstanceEditEntry=stpxSMSTInstanceEditEntry, stpxRootInconsistencyNotificationsGroup=stpxRootInconsistencyNotificationsGroup, stpxMISTPInstanceTable=stpxMISTPInstanceTable, stpxSMSTInstanceCISTRegionalRoot=stpxSMSTInstanceCISTRegionalRoot, stpxInconsistencyObjects=stpxInconsistencyObjects, stpxMSTPortRoleTable=stpxMSTPortRoleTable, stpxSMSTPortIndex=stpxSMSTPortIndex, stpxInconsistencyTable=stpxInconsistencyTable, stpxFastStartOperModeInstIndex=stpxFastStartOperModeInstIndex, stpxRootInconsistencyUpdate=stpxRootInconsistencyUpdate, stpxMSTRegionEditRevision=stpxMSTRegionEditRevision, stpxMIBCompliance12=stpxMIBCompliance12, stpxMISTPGroup=stpxMISTPGroup, stpxMSTInstanceEditTable=stpxMSTInstanceEditTable, stpxSpanningTreeGroup=stpxSpanningTreeGroup, stpxVlanIndex=stpxVlanIndex, stpxBpduSkewingDetectionEnable=stpxBpduSkewingDetectionEnable, stpxMSTPortStatus=stpxMSTPortStatus, stpxSMSTInstanceIndex=stpxSMSTInstanceIndex, stpxSpanningTreePathCostOperMode=stpxSpanningTreePathCostOperMode, stpxSMSTInstanceTable=stpxSMSTInstanceTable, stpxRootGuardConfigEntry=stpxRootGuardConfigEntry, stpxPVSTVlanGroup=stpxPVSTVlanGroup, stpxLoopInconsistencyPortIndex=stpxLoopInconsistencyPortIndex, stpxLoopInconsistencyIndex=stpxLoopInconsistencyIndex, PYSNMP_MODULE_ID=ciscoStpExtensionsMIB, stpxBpduSkewingLastSkewDuration=stpxBpduSkewingLastSkewDuration, stpxFastStartBpduGuardEnable=stpxFastStartBpduGuardEnable, stpxMISTPInstanceIndex=stpxMISTPInstanceIndex, stpxBackboneFastOutRLQResponsePDUs=stpxBackboneFastOutRLQResponsePDUs, stpxMIBCompliance10=stpxMIBCompliance10, stpxMSTInstanceEditEntry=stpxMSTInstanceEditEntry, stpxMSTInstanceTable=stpxMSTInstanceTable, stpxMSTPortRoleValue=stpxMSTPortRoleValue, stpxUplinkFastOperEnabled=stpxUplinkFastOperEnabled, stpxSMSTMaxHopCount=stpxSMSTMaxHopCount, stpxPreferredVlansGroup=stpxPreferredVlansGroup, stpxFastStartPortEntry=stpxFastStartPortEntry, stpxRootGuardObjects=stpxRootGuardObjects, stpxRSTPPortOperLinkType=stpxRSTPPortOperLinkType, stpxExtendedSysIDOperEnabled=stpxExtendedSysIDOperEnabled, stpxLongStpPortPathCostEntry=stpxLongStpPortPathCostEntry, stpxPreferredMSTInstancesMap=stpxPreferredMSTInstancesMap, stpxSpanningTreePathCostMode=stpxSpanningTreePathCostMode, stpxRootGuardConfigTable=stpxRootGuardConfigTable, stpxNotificationEnable=stpxNotificationEnable, stpxLoopInconsistencyNotificationsGroup=stpxLoopInconsistencyNotificationsGroup, stpxUplinkStationLearningGenRate=stpxUplinkStationLearningGenRate, stpxSMSTInstanceCISTIntRootCost=stpxSMSTInstanceCISTIntRootCost, stpxMISTPInstanceNumber=stpxMISTPInstanceNumber, stpxMISTPInstanceEntry=stpxMISTPInstanceEntry, stpxSMSTMaxInstances=stpxSMSTMaxInstances, stpxBackboneFastOutRLQRequestPDUs=stpxBackboneFastOutRLQRequestPDUs, stpxMSTRegionRevision=stpxMSTRegionRevision, stpxRootGuardConfigPortIndex=stpxRootGuardConfigPortIndex, stpxSMSTPortTable=stpxSMSTPortTable, stpxBackboneGroup=stpxBackboneGroup, stpxPreferredVlansTable=stpxPreferredVlansTable, stpxFastStartGroup3=stpxFastStartGroup3, stpxFastStartGlobalDefaultMode=stpxFastStartGlobalDefaultMode, stpxBackboneFastOperEnabled=stpxBackboneFastOperEnabled, stpxSMSTInstanceVlansMapped3k4k=stpxSMSTInstanceVlansMapped3k4k, stpxSMSTInstanceEditRowStatus=stpxSMSTInstanceEditRowStatus, stpxSstpGroup=stpxSstpGroup, stpxPreferredVlansMap=stpxPreferredVlansMap, stpxPVSTVlanIndex=stpxPVSTVlanIndex, stpxSpanningTreeObjects=stpxSpanningTreeObjects, stpxSMSTInstanceVlansMapped1k2k=stpxSMSTInstanceVlansMapped1k2k, stpxVlanMISTPInstMapTable=stpxVlanMISTPInstMapTable, stpxMSTInstanceEditIndex=stpxMSTInstanceEditIndex, stpxMISTPInstanceVlansMapped3k=stpxMISTPInstanceVlansMapped3k, stpxInconsistencyUpdate=stpxInconsistencyUpdate, stpxUplinkFastTransitions=stpxUplinkFastTransitions, stpxBpduSkewingWorstSkewDuration=stpxBpduSkewingWorstSkewDuration, stpxSMSTPortConfigedHelloTime=stpxSMSTPortConfigedHelloTime, stpxPreferredMSTInstancesTable=stpxPreferredMSTInstancesTable, stpxSMSTPortOperHelloTime=stpxSMSTPortOperHelloTime, stpxMIBConformance=stpxMIBConformance, stpxMIBCompliances=stpxMIBCompliances, stpxExtendedSysIDGroup=stpxExtendedSysIDGroup, stpxNotificationEnableGroup=stpxNotificationEnableGroup, stpxBpduSkewingEntry=stpxBpduSkewingEntry, stpxRSTPPortRoleInstanceIndex=stpxRSTPPortRoleInstanceIndex, stpxRSTPPortIndex=stpxRSTPPortIndex, stpxMSTMaxInstanceNumber=stpxMSTMaxInstanceNumber, stpxMIBCompliance9=stpxMIBCompliance9, stpxMSTRegionEditBufferOperation=stpxMSTRegionEditBufferOperation, stpxRPVSTPortEntry=stpxRPVSTPortEntry, stpxSMSTInstanceEntry=stpxSMSTInstanceEntry, StpxMSTConfigurationDigest=StpxMSTConfigurationDigest, stpxPreferredMISTPInstancesEntry=stpxPreferredMISTPInstancesEntry, stpxMSTGroup=stpxMSTGroup, stpxRSTPPortRoleValue=stpxRSTPPortRoleValue, stpxRootInconsistencyEntry=stpxRootInconsistencyEntry, stpxMISTPInstanceVlansMapped4k=stpxMISTPInstanceVlansMapped4k, stpxMSTPortEntry=stpxMSTPortEntry, stpxMSTPortOperLinkType=stpxMSTPortOperLinkType, stpxUplinkStationLearningFrames=stpxUplinkStationLearningFrames, stpxExtendedSysIDAdminEnabled=stpxExtendedSysIDAdminEnabled, stpxFastStartGroup=stpxFastStartGroup, stpxBackboneGroup2=stpxBackboneGroup2, stpxMSTObjects=stpxMSTObjects, stpxLoopInconsistencyTable=stpxLoopInconsistencyTable, stpxMSTInstanceVlansMapped=stpxMSTInstanceVlansMapped, stpxObjects=stpxObjects, stpxSMSTInstanceGroup=stpxSMSTInstanceGroup, stpxBackboneFastEnabled=stpxBackboneFastEnabled, stpxFastStartPortIndex=stpxFastStartPortIndex, stpxLoopGuardConfigTable=stpxLoopGuardConfigTable, stpxMSTPortRoleInstanceIndex=stpxMSTPortRoleInstanceIndex, stpxMIBGroups=stpxMIBGroups, stpxMSTGroup3=stpxMSTGroup3, stpxBackboneFastObjects=stpxBackboneFastObjects, stpxLoopGuardConfigPortIndex=stpxLoopGuardConfigPortIndex, stpxPreferredMSTInstancesGroup=stpxPreferredMSTInstancesGroup, stpxSMSTPortHelloTimeGroup=stpxSMSTPortHelloTimeGroup, stpxMSTInstanceEditVlansMap=stpxMSTInstanceEditVlansMap, stpxMSTInstanceEditVlansMap4k=stpxMSTInstanceEditVlansMap4k, stpxSMSTPortEntry=stpxSMSTPortEntry, stpxMSTPortProtocolMigration=stpxMSTPortProtocolMigration, stpxLoopInconsistencyEntry=stpxLoopInconsistencyEntry, stpxMSTRegionName=stpxMSTRegionName, stpxSMSTPortOperMSTMode=stpxSMSTPortOperMSTMode, stpxLoopGuardConfigEntry=stpxLoopGuardConfigEntry, stpxPortIndex=stpxPortIndex, stpxNotifications=stpxNotifications, stpxMSTInstanceEditVlansMap2k=stpxMSTInstanceEditVlansMap2k, stpxBpduSkewingWorstSkewTime=stpxBpduSkewingWorstSkewTime, stpxFastStartPortEnable=stpxFastStartPortEnable, stpxFastStartPortBpduGuardMode=stpxFastStartPortBpduGuardMode, stpxRPVSTPortTable=stpxRPVSTPortTable, stpxBpduSkewingInstanceIndex=stpxBpduSkewingInstanceIndex, stpxLoopGuardObjects=stpxLoopGuardObjects, stpxLoopInconsistencyUpdate=stpxLoopInconsistencyUpdate, stpxSMSTInstanceEditTable=stpxSMSTInstanceEditTable, stpxSMSTPortStatusGroup=stpxSMSTPortStatusGroup, stpxRSTPPortRoleEntry=stpxRSTPPortRoleEntry, stpxFastStartOperMode=stpxFastStartOperMode, stpxMIBCompliance=stpxMIBCompliance, stpxMISTPInstanceEnable=stpxMISTPInstanceEnable, stpxRootInconsistencyState=stpxRootInconsistencyState, stpxFastStartObjects=stpxFastStartObjects, stpxLoopGuardConfigMode=stpxLoopGuardConfigMode, stpxSMSTInstanceRemainingHopCount=stpxSMSTInstanceRemainingHopCount, stpxSMSTPortStatus=stpxSMSTPortStatus, stpxPreferredMISTPInstancesTable=stpxPreferredMISTPInstancesTable, stpxBpduSkewingGroup=stpxBpduSkewingGroup, stpxFastStartPortBpduFilterMode=stpxFastStartPortBpduFilterMode, stpxMSTInstanceEditVlansMap3k=stpxMSTInstanceEditVlansMap3k, stpxVlanMISTPInstMapEditInstIndex=stpxVlanMISTPInstMapEditInstIndex, stpxVlanMISTPInstMapEntry=stpxVlanMISTPInstMapEntry, stpxInconsistentState=stpxInconsistentState, stpxMSTPortIndex=stpxMSTPortIndex, stpxSMSTConfigDigestGroup=stpxSMSTConfigDigestGroup, stpxBackboneFastInRLQResponsePDUs=stpxBackboneFastInRLQResponsePDUs, stpxMIBCompliance11=stpxMIBCompliance11, stpxUplinkFastObjects=stpxUplinkFastObjects, stpxBackboneFastInInferiorBPDUs=stpxBackboneFastInInferiorBPDUs, stpxUplinkGroup=stpxUplinkGroup, stpxBpduSkewingObjects=stpxBpduSkewingObjects, stpxRPVSTPortStatus=stpxRPVSTPortStatus, stpxLoopGuardGroup2=stpxLoopGuardGroup2, stpxPreferredVlansMap2k=stpxPreferredVlansMap2k, stpxPVSTVlanEnable=stpxPVSTVlanEnable, stpxMSTPortAdminLinkType=stpxMSTPortAdminLinkType, stpxRPVSTObjects=stpxRPVSTObjects, stpxRootInconsistencyPortIndex=stpxRootInconsistencyPortIndex, stpxMSTPortRoleEntry=stpxMSTPortRoleEntry, stpxFastStartPortTable=stpxFastStartPortTable, stpxMSTInstanceVlansMapped3k=stpxMSTInstanceVlansMapped3k, stpxSMSTInstanceEditIndex=stpxSMSTInstanceEditIndex, stpxVlanMISTPInstMapEditEntry=stpxVlanMISTPInstMapEditEntry, stpxFastStartOperModeTable=stpxFastStartOperModeTable, stpx4kVlanGroup=stpx4kVlanGroup, stpxMSTInstanceEntry=stpxMSTInstanceEntry, stpxNotificationsGroup=stpxNotificationsGroup, stpxLongPathCostModeGroup=stpxLongPathCostModeGroup, stpxLoopGuardGroup=stpxLoopGuardGroup, ciscoStpExtensionsMIB=ciscoStpExtensionsMIB, stpxBackboneFastInRLQRequestPDUs=stpxBackboneFastInRLQRequestPDUs, stpxMSTInstanceVlansMapped4k=stpxMSTInstanceVlansMapped4k, stpxSMSTRegionRevision=stpxSMSTRegionRevision, stpxLoopInconsistencyState=stpxLoopInconsistencyState, stpxSMSTInstanceEditVlansMap1k2k=stpxSMSTInstanceEditVlansMap1k2k, stpxMSTPortTable=stpxMSTPortTable, stpxMISTPInstanceVlansMapped=stpxMISTPInstanceVlansMapped, stpxRSTPPortEntry=stpxRSTPPortEntry, stpxPreferredVlansMap4k=stpxPreferredVlansMap4k, stpxRPVSTPortVlanIndex=stpxRPVSTPortVlanIndex, stpxMISTPInstanceVlansMapped2k=stpxMISTPInstanceVlansMapped2k, stpxMIBCompliance3=stpxMIBCompliance3, stpxMSTGroup2=stpxMSTGroup2, stpxMSTRegionEditBufferStatus=stpxMSTRegionEditBufferStatus, stpxLongStpPortPathCostTable=stpxLongStpPortPathCostTable, stpxMIBCompliance6=stpxMIBCompliance6, stpxRSTPGroup=stpxRSTPGroup, stpxMSTPortRolePortIndex=stpxMSTPortRolePortIndex, stpxMSTMaxHopCount=stpxMSTMaxHopCount, stpxMISTPGroup2=stpxMISTPGroup2, stpxMIBCompliance7=stpxMIBCompliance7, stpxRPVSTGroup=stpxRPVSTGroup, stpxRSTPObjects=stpxRSTPObjects, stpxMSTRegionEditName=stpxMSTRegionEditName, stpxSMSTMaxInstanceID=stpxSMSTMaxInstanceID, stpxSMSTConfigPreStandardDigest=stpxSMSTConfigPreStandardDigest, stpxSMSTPortMSTModeGroup=stpxSMSTPortMSTModeGroup, stpxRSTPPortAdminLinkType=stpxRSTPPortAdminLinkType, stpxMSTInstanceRemainingHopCount=stpxMSTInstanceRemainingHopCount, stpxFastStartBpduFilterEnable=stpxFastStartBpduFilterEnable, stpxMISTPObjects=stpxMISTPObjects, stpxRSTPPortProtocolMigration=stpxRSTPPortProtocolMigration, stpxRootGuardGroup=stpxRootGuardGroup, stpxPVSTVlanEntry=stpxPVSTVlanEntry, stpxRPVSTPortIndex=stpxRPVSTPortIndex, stpxSMSTInstanceEditVlansMap3k4k=stpxSMSTInstanceEditVlansMap3k4k, stpxSMSTMaxHopCountGroup=stpxSMSTMaxHopCountGroup, stpxNotificationsPrefix=stpxNotificationsPrefix, stpxSMSTInstanceEditGroup=stpxSMSTInstanceEditGroup, stpxSMSTPortAdminHelloTime=stpxSMSTPortAdminHelloTime, stpxPreferredVlansEntry=stpxPreferredVlansEntry, stpxVlanMISTPInstMapInstIndex=stpxVlanMISTPInstMapInstIndex, stpxSMSTRegionEditRevision=stpxSMSTRegionEditRevision, stpxFastStartGroup2=stpxFastStartGroup2, stpxPathCostOperModeGroup=stpxPathCostOperModeGroup, stpxVlanMISTPInstMapEditTable=stpxVlanMISTPInstMapEditTable, stpxMSTInstanceVlansMapped2k=stpxMSTInstanceVlansMapped2k, stpxRSTPPortRolePortIndex=stpxRSTPPortRolePortIndex, stpxSpanningTreeType=stpxSpanningTreeType, stpxUplinkGroup2=stpxUplinkGroup2, stpxPreferredMSTInstancesEntry=stpxPreferredMSTInstancesEntry, stpxPreferredMISTPInstancesMap=stpxPreferredMISTPInstancesMap, stpxRSTPTransmitHoldCount=stpxRSTPTransmitHoldCount, stpxRSTPPortRoleTable=stpxRSTPPortRoleTable, stpxLoopGuardConfigEnabled=stpxLoopGuardConfigEnabled, stpxRootGuardConfigEnabled=stpxRootGuardConfigEnabled, stpxSMSTObjects=stpxSMSTObjects, stpxSMSTGroup=stpxSMSTGroup, stpxSMSTInstanceCISTGroup=stpxSMSTInstanceCISTGroup)
mibBuilder.exportSymbols("CISCO-STP-EXTENSIONS-MIB", stpxInconsistencyEntry=stpxInconsistencyEntry, stpxSMSTConfigDigest=stpxSMSTConfigDigest, stpxRSTPTransmitHoldCountGroup=stpxRSTPTransmitHoldCountGroup, stpxMIBCompliance5=stpxMIBCompliance5, stpxMSTGroup4=stpxMSTGroup4, stpxBpduSkewingTable=stpxBpduSkewingTable, stpxBpduSkewingPortIndex=stpxBpduSkewingPortIndex, stpxFastStartPortMode=stpxFastStartPortMode, stpxFastStartOperModePortIndex=stpxFastStartOperModePortIndex)
