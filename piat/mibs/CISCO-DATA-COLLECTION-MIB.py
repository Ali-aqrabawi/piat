...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DATA-COLLECTION-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:36:48 2019
...
Bits, Unsigned32, NotificationType, MibIdentifier, iso, Gauge32, ObjectIdentity, Counter64, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, TimeTicks, zeroDotZero = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "Gauge32", "ObjectIdentity", "Counter64", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "TimeTicks", "zeroDotZero")
RowStatus, TextualConvention, RowPointer, TruthValue, DisplayString, DateAndTime, VariablePointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "RowPointer", "TruthValue", "DisplayString", "DateAndTime", "VariablePointer")
...
mibBuilder.exportSymbols("CISCO-DATA-COLLECTION-MIB", cdcVFileCollectionError=cdcVFileCollectionError, PYSNMP_MODULE_ID=ciscoDataCollectionMIB, cdcVFileCollectionErrorEnable=cdcVFileCollectionErrorEnable, ciscoDataCollMIBCompliance=ciscoDataCollMIBCompliance, CdcFileFormat=CdcFileFormat, cdcDGBaseObjectRowStatus=cdcDGBaseObjectRowStatus, cdcVFileMgmtIndex=cdcVFileMgmtIndex, cdcVFileTable=cdcVFileTable, cdcVFileCommand=cdcVFileCommand, cdcDGInstanceType=cdcDGInstanceType, cdcVFileGroup=cdcVFileGroup, CdcCollectionList=CdcCollectionList, cdcFileXferConfRetryPeriod=cdcFileXferConfRetryPeriod, cdcDGComment=cdcDGComment, cdcVFileMgmtLastXferURL=cdcVFileMgmtLastXferURL, ciscoDataCollMIBCompliances=ciscoDataCollMIBCompliances, cdcFileXferConfTable=cdcFileXferConfTable, cdcFileXferGroup=cdcFileXferGroup, cdcDGBaseObjectEntry=cdcDGBaseObjectEntry, cdcFileXferComplete=cdcFileXferComplete, cdcFileXferConfFailureEnable=cdcFileXferConfFailureEnable, cdcFileXferConfPriUrl=cdcFileXferConfPriUrl, cdcDGInstanceIndex=cdcDGInstanceIndex, cdcDGRowStatus=cdcDGRowStatus, CdcCollectionSubtree=CdcCollectionSubtree, cdcVFileAdminStatus=cdcVFileAdminStatus, CdcRowInstanceId=CdcRowInstanceId, CdcUrl=CdcUrl, cdcFileXferConfEntry=cdcFileXferConfEntry, cdcDGBaseObjectIndex=cdcDGBaseObjectIndex, cdcVFileCurrentSize=cdcVFileCurrentSize, cdcVFileMaxSize=cdcVFileMaxSize, cdcDataSelectionGroup=cdcDataSelectionGroup, cdcDGBaseObjectGrpIndex=cdcDGBaseObjectGrpIndex, cdcDGTargetTag=cdcDGTargetTag, cdcDGInstanceNumRepititions=cdcDGInstanceNumRepititions, cdcVFileRetentionPeriod=cdcVFileRetentionPeriod, ciscoDataCollMIBObjects=ciscoDataCollMIBObjects, cdcDGInstanceEntry=cdcDGInstanceEntry, cdcDGType=cdcDGType, cdcVFileDescription=cdcVFileDescription, cdcFileXfer=cdcFileXfer, cdcVFileMgmtXferURL=cdcVFileMgmtXferURL, cdcDGObjectGrpIndex=cdcDGObjectGrpIndex, cdcDGInstanceOidEnd=cdcDGInstanceOidEnd, cdcDGObject=cdcDGObject, cdcDGEntry=cdcDGEntry, cdcVFileMaxSizeHitsLimit=cdcVFileMaxSizeHitsLimit, cdcDGContextName=cdcDGContextName, cdcVFileMgmtName=cdcVFileMgmtName, cdcVFileEntry=cdcVFileEntry, cdcFileXferConfRetryCount=cdcFileXferConfRetryCount, CdcFileXferStatus=CdcFileXferStatus, cdcDGInstanceGrpIndex=cdcDGInstanceGrpIndex, cdcVFileCollectionPeriod=cdcVFileCollectionPeriod, cdcVFileRowStatus=cdcVFileRowStatus, cdcVFileCollectMode=cdcVFileCollectMode, cdcDGInstanceOtherPtr=cdcDGInstanceOtherPtr, cdcVFileMgmtCommand=cdcVFileMgmtCommand, cdcDGBaseObjectSubtree=cdcDGBaseObjectSubtree, cdcVFileIndex=cdcVFileIndex, cdcVFileErrorCode=cdcVFileErrorCode, cdcFileXferConfSecUrl=cdcFileXferConfSecUrl, cdcVFileMgmtTimeToLive=cdcVFileMgmtTimeToLive, ciscoDataCollectionMIB=ciscoDataCollectionMIB, cdcVFileMgmtLastXferStatus=cdcVFileMgmtLastXferStatus, cdcVFileMgmtTable=cdcVFileMgmtTable, cdcVFileMgmtTimestamp=cdcVFileMgmtTimestamp, ciscoDataCollMIBNotifs=ciscoDataCollMIBNotifs, cdcVFilePersistentStorage=cdcVFilePersistentStorage, cdcVFileMgmtEntry=cdcVFileMgmtEntry, cdcFileXferConfSuccessEnable=cdcFileXferConfSuccessEnable, cdcVFileOperStatus=cdcVFileOperStatus, cdcDGInstGrpIndex=cdcDGInstGrpIndex, cdcDGTable=cdcDGTable, cdcDGInstanceOid=cdcDGInstanceOid, cdcVFileFormat=cdcVFileFormat, cdcDGInstanceRowStatus=cdcDGInstanceRowStatus, ciscoDataCollMIBGroups=ciscoDataCollMIBGroups, cdcDataGroup=cdcDataGroup, cdcDGVFileIndex=cdcDGVFileIndex, cdcDGBaseObjectList=cdcDGBaseObjectList, cdcDGIndex=cdcDGIndex, cdcVFile=cdcVFile, cdcDGPollPeriod=cdcDGPollPeriod, cdcDGInstanceTable=cdcDGInstanceTable, cdcDGBaseObjectTable=cdcDGBaseObjectTable, cdcNotificationGroup=cdcNotificationGroup, ciscoDataCollMIBConformance=ciscoDataCollMIBConformance, cdcVFileName=cdcVFileName)
