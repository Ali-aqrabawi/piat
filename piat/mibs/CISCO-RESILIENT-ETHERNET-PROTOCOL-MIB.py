...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-RESILIENT-ETHERNET-PROTOCOL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:48:01 2019
...
ModuleIdentity, Counter64, MibIdentifier, iso, NotificationType, IpAddress, ObjectIdentity, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "MibIdentifier", "iso", "NotificationType", "IpAddress", "ObjectIdentity", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("CISCO-RESILIENT-ETHERNET-PROTOCOL-MIB", ciscoRepSegmentGroup=ciscoRepSegmentGroup, crepifBlockedVlans4k=crepifBlockedVlans4k, crepIfPortID=crepIfPortID, crepPortRoleChange=crepPortRoleChange, crepSegmentEntry=crepSegmentEntry, RepPortType=RepPortType, crepGlobalInfo=crepGlobalInfo, crepifBlockedVlans2k=crepifBlockedVlans2k, crepIfStcnPropagateToSTP=crepIfStcnPropagateToSTP, crepSegmentTable=crepSegmentTable, crepifBlockedVlans1k=crepifBlockedVlans1k, RepSegmentId=RepSegmentId, crepEpaInfoTlvTxPackets=crepEpaInfoTlvTxPackets, crepVersion=crepVersion, crepifBlockedVlans3k=crepifBlockedVlans3k, crepBlockPortNumInfo=crepBlockPortNumInfo, crepLslRxPdus=crepLslRxPdus, crepPreemptionStatus=crepPreemptionStatus, ciscoRepMIBCompliances=ciscoRepMIBCompliances, RepSegmentList=RepSegmentList, PYSNMP_MODULE_ID=ciscoResilientEthernetProtocolMIB, crepLoadBalanceBlockPortType=crepLoadBalanceBlockPortType, crepIfPreemptDelayTimer=crepIfPreemptDelayTimer, ciscoRepGlobalGroup=ciscoRepGlobalGroup, ciscoRepMIBCompliance=ciscoRepMIBCompliance, ciscoRepMIBConform=ciscoRepMIBConform, crepIfStcnPropagateToIf=crepIfStcnPropagateToIf, ciscoRepNotificationGroup=ciscoRepNotificationGroup, crepCounterDiscontinuityTime=crepCounterDiscontinuityTime, crepIfSegmentId=crepIfSegmentId, crepBpaStcnLslRxPackets=crepBpaStcnLslRxPackets, ciscoResilientEthernetProtocolMIB=ciscoResilientEthernetProtocolMIB, crepBlockPortIdInfo=crepBlockPortIdInfo, crepInterfaceStatsEntry=crepInterfaceStatsEntry, crepIfIndex=crepIfIndex, crepInterfaceConfig=crepInterfaceConfig, crepIfOperEdgePortType=crepIfOperEdgePortType, crepAdminVlan=crepAdminVlan, crepSegmentInterface2=crepSegmentInterface2, crepSegmentInterface1=crepSegmentInterface1, ciscoRepMIBNotifs=ciscoRepMIBNotifs, crepIfAdminEdgePortType=crepIfAdminEdgePortType, crepSegmentComplete=crepSegmentComplete, crepInterfaceConfigEntry=crepInterfaceConfigEntry, crepEpaCommandTlvTxPackets=crepEpaCommandTlvTxPackets, crepInterfaceStatsTable=crepInterfaceStatsTable, crepSegmentConfig=crepSegmentConfig, crepLinkStatus=crepLinkStatus, crepIfOperStatus=crepIfOperStatus, crepHflTxPdus=crepHflTxPdus, crepBpaStcnHflRxPackets=crepBpaStcnHflRxPackets, ciscoRepMIBGroups=ciscoRepMIBGroups, ciscoRepInterfaceGroup=ciscoRepInterfaceGroup, crepGlobalRepNotifsRate=crepGlobalRepNotifsRate, crepSegmentPreemptStatus=crepSegmentPreemptStatus, crepBpaTlvRxPackets=crepBpaTlvRxPackets, crepNotifsEnable=crepNotifsEnable, crepEpaCommandTlvRxPackets=crepEpaCommandTlvRxPackets, ciscoRepMIBObjects=ciscoRepMIBObjects, crepBpaTlvTxPackets=crepBpaTlvTxPackets, crepMinSegmentId=crepMinSegmentId, crepIfConfigRowStatus=crepIfConfigRowStatus, crepInterfaceConfigTable=crepInterfaceConfigTable, crepEpaElectionTlvRxPackets=crepEpaElectionTlvRxPackets, crepIfStcnPropagateToOtherSegs=crepIfStcnPropagateToOtherSegs, crepIfPreferredConfig=crepIfPreferredConfig, crepBpaStcnHflTxPackets=crepBpaStcnHflTxPackets, crepEpaElectionTlvTxPackets=crepEpaElectionTlvTxPackets, crepSegmentPreempt=crepSegmentPreempt, crepBpaStcnLslTxPackets=crepBpaStcnLslTxPackets, crepSegmentId=crepSegmentId, crepIfPortRole=crepIfPortRole, crepHflRxPdus=crepHflRxPdus, crepEpaInfoTlvRxPackets=crepEpaInfoTlvRxPackets, crepMaxSegmentId=crepMaxSegmentId, crepLslTxPdus=crepLslTxPdus)
