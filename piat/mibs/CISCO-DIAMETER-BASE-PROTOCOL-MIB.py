...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DIAMETER-BASE-PROTOCOL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:46:47 2019
...
Gauge32, ObjectIdentity, Integer32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, MibIdentifier, NotificationType, IpAddress, TimeTicks, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Integer32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "TimeTicks", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-DIAMETER-BASE-PROTOCOL-MIB", cdbpLocalRealm=cdbpLocalRealm, cdbpPeerRowStatus=cdbpPeerRowStatus, cdbpPeerIpAddrTable=cdbpPeerIpAddrTable, cdbpRealmMessageRouteRAAsIn=cdbpRealmMessageRouteRAAsIn, cdbpPeerStatsDWCurrentStatus=cdbpPeerStatsDWCurrentStatus, cdbpPeerStatsAccsNotRecorded=cdbpPeerStatsAccsNotRecorded, cdbpAppAdvToPeerTable=cdbpAppAdvToPeerTable, cdbpPeerStatsACRsIn=cdbpPeerStatsACRsIn, cdbpPeerStatsRARsIn=cdbpPeerStatsRARsIn, cdbpLocalIpAddrIndex=cdbpLocalIpAddrIndex, cdbpRealmMessageRouteSTRsOut=cdbpRealmMessageRouteSTRsOut, ciscoDiameterBasePMIBNotifs=ciscoDiameterBasePMIBNotifs, cdbpPeerVendorId=cdbpPeerVendorId, cdbpPeerStatsTransientFailures=cdbpPeerStatsTransientFailures, ciscoDiaBaseProtEnablePeerConnectionUpNotif=ciscoDiaBaseProtEnablePeerConnectionUpNotif, cdbpLocalIpAddrType=cdbpLocalIpAddrType, cdbpPeerStatsASRsIn=cdbpPeerStatsASRsIn, cdbpPeerStatsEntry=cdbpPeerStatsEntry, cdbpPeerStatsProtocolErrors=cdbpPeerStatsProtocolErrors, cdbpPeerStatsSTAsOut=cdbpPeerStatsSTAsOut, cdbpPeerStatsTransportDown=cdbpPeerStatsTransportDown, cdbpRealmMessageRouteASAsIn=cdbpRealmMessageRouteASAsIn, cdbpPeerStatsDWRsOut=cdbpPeerStatsDWRsOut, cdbpLocalApplEntry=cdbpLocalApplEntry, cdbpLocalApplIndex=cdbpLocalApplIndex, ciscoDiaBaseProtEnableProtocolErrorNotif=ciscoDiaBaseProtEnableProtocolErrorNotif, cdbpPeerSecurity=cdbpPeerSecurity, cdbpRealmMessageRouteAction=cdbpRealmMessageRouteAction, ciscoDiaBaseProtEnableTransientFailureNotif=ciscoDiaBaseProtEnableTransientFailureNotif, cdbpAppAdvToPeerRowStatus=cdbpAppAdvToPeerRowStatus, ciscoDiameterBasePMIB=ciscoDiameterBasePMIB, cdbpLocalVendorStorageType=cdbpLocalVendorStorageType, cdbpRealmMessageRouteTable=cdbpRealmMessageRouteTable, cdbpLocalTcpListenPort=cdbpLocalTcpListenPort, cdbpAppAdvToPeerVendorId=cdbpAppAdvToPeerVendorId, cdbpPeerProtocol=cdbpPeerProtocol, cdbpLocalResetTime=cdbpLocalResetTime, cdbpPeerStatsRAAsIn=cdbpPeerStatsRAAsIn, cdbpRealmKnownPeersEntry=cdbpRealmKnownPeersEntry, cdbpLocalStatsTotalUpTime=cdbpLocalStatsTotalUpTime, cdbpRealmMessageRouteIndex=cdbpRealmMessageRouteIndex, cdbpPeerStatsState=cdbpPeerStatsState, cdbpPeerStatsACRsOut=cdbpPeerStatsACRsOut, ciscoDiameterBasePMIBRealmCfgSkippedGroup=ciscoDiameterBasePMIBRealmCfgSkippedGroup, cdbpLocalIpAddrTable=cdbpLocalIpAddrTable, cdbpLocalId=cdbpLocalId, cdbpPeerFirmwareRevision=cdbpPeerFirmwareRevision, cdbpPeerStatsTimeoutConnAtmpts=cdbpPeerStatsTimeoutConnAtmpts, cdbpPeerStatsDPRsOut=cdbpPeerStatsDPRsOut, cdbpPeerIndex=cdbpPeerIndex, cdbpPeerStatsStateDuration=cdbpPeerStatsStateDuration, cdbpPeerStatsAccReqstsDropped=cdbpPeerStatsAccReqstsDropped, cdbpPeerStatsCEAsOut=cdbpPeerStatsCEAsOut, cdbpLocalCfgs=cdbpLocalCfgs, cdbpRealmMessageRouteASRsIn=cdbpRealmMessageRouteASRsIn, cdbpPeerStatsSTRsIn=cdbpPeerStatsSTRsIn, ciscoDiameterBasePMIBPeerStatsGroup=ciscoDiameterBasePMIBPeerStatsGroup, cdbpLocalOriginHost=cdbpLocalOriginHost, cdbpRealmStats=cdbpRealmStats, cdbpAppAdvToPeerIndex=cdbpAppAdvToPeerIndex, cdbpPeerIpAddress=cdbpPeerIpAddress, cdbpPeerStatsCERsIn=cdbpPeerStatsCERsIn, cdbpRealmMessageRouteApp=cdbpRealmMessageRouteApp, cdbpAppAdvFromPeerVendorId=cdbpAppAdvFromPeerVendorId, cdbpPeerStatsAccRetrans=cdbpPeerStatsAccRetrans, ciscoDiameterBasePMIBLocalStatsSkippedGroup=ciscoDiameterBasePMIBLocalStatsSkippedGroup, cdbpPeerStatsRAAsOut=cdbpPeerStatsRAAsOut, cdbpLocalConfigReset=cdbpLocalConfigReset, ciscoDiameterBasePMIBLocalCfgSkippedGroup=ciscoDiameterBasePMIBLocalCfgSkippedGroup, cdbpLocalStatsTotalPacketsIn=cdbpLocalStatsTotalPacketsIn, cdbpPeerStatsEToEDupMessages=cdbpPeerStatsEToEDupMessages, ciscoDiameterBasePMIBRealmStatsSkippedGroup=ciscoDiameterBasePMIBRealmStatsSkippedGroup, cdbpAppAdvToPeerStorageType=cdbpAppAdvToPeerStorageType, cdbpPeerStatsWhoInitDisconnect=cdbpPeerStatsWhoInitDisconnect, cdbpLocalSctpListenPort=cdbpLocalSctpListenPort, ciscoDiameterBasePMIBTrapCfgGroup=ciscoDiameterBasePMIBTrapCfgGroup, cdbpPeerCfgs=cdbpPeerCfgs, cdbpPeerStatsACAsOut=cdbpPeerStatsACAsOut, cdbpRedundancyEnabled=cdbpRedundancyEnabled, cdbpPeerVendorEntry=cdbpPeerVendorEntry, cdbpPeerStatsRARsOut=cdbpPeerStatsRARsOut, cdbpRealmMessageRouteReqstsDrop=cdbpRealmMessageRouteReqstsDrop, cdbpRealmMessageRouteSTAsIn=cdbpRealmMessageRouteSTAsIn, cdbpPeerStatsDWAsOut=cdbpPeerStatsDWAsOut, cdbpPeerStatsDPAsOut=cdbpPeerStatsDPAsOut, cdbpPeerStatsUnknownTypes=cdbpPeerStatsUnknownTypes, ciscoDiaBaseProtProtocolErrorNotif=ciscoDiaBaseProtProtocolErrorNotif, cdbpPeerStats=cdbpPeerStats, cdbpRealmMessageRouteEntry=cdbpRealmMessageRouteEntry, cdbpPeerStatsAccDupRequests=cdbpPeerStatsAccDupRequests, cdbpRealmKnownPeers=cdbpRealmKnownPeers, ciscoDiameterBasePMIBCompliance=ciscoDiameterBasePMIBCompliance, cdbpLocalVendorTable=cdbpLocalVendorTable, cdbpRealmMessageRouteACAsOut=cdbpRealmMessageRouteACAsOut, cdbpPeerStatsDWReqTimer=cdbpPeerStatsDWReqTimer, ciscoDiameterBasePMIBPeerCfgSkippedGroup=ciscoDiameterBasePMIBPeerCfgSkippedGroup, cdbpLocalApplRowStatus=cdbpLocalApplRowStatus, ciscoDiaBaseProtEnablePeerConnectionDownNotif=ciscoDiaBaseProtEnablePeerConnectionDownNotif, cdbpPeerStatsCEAsIn=cdbpPeerStatsCEAsIn, cdbpRealmMessageRouteRARsOut=cdbpRealmMessageRouteRARsOut, cdbpAppAdvFromPeerType=cdbpAppAdvFromPeerType, cdbpLocalApplStorageType=cdbpLocalApplStorageType, cdbpAppAdvFromPeerTable=cdbpAppAdvFromPeerTable, cdbpLocalVendorIndex=cdbpLocalVendorIndex, cdbpLocalVendorRowStatus=cdbpLocalVendorRowStatus, cdbpPeerStatsPermanentFailures=cdbpPeerStatsPermanentFailures, cdbpPeerIpAddressIndex=cdbpPeerIpAddressIndex, cdbpPeerVendorStorageType=cdbpPeerVendorStorageType, cdbpPeerStatsASAsIn=cdbpPeerStatsASAsIn, cdbpRedundancyInfraState=cdbpRedundancyInfraState, cdbpTrapCfgs=cdbpTrapCfgs, cdbpRealmMessageRouteACRsOut=cdbpRealmMessageRouteACRsOut, cdbpPeerStatsCERsOut=cdbpPeerStatsCERsOut, cdbpPeerVendorRowStatus=cdbpPeerVendorRowStatus, cdbpPeerStatsDWAsIn=cdbpPeerStatsDWAsIn, cdbpRealmMessageRouteRAAsOut=cdbpRealmMessageRouteRAAsOut, cdbpLocalVendorId=cdbpLocalVendorId, cdbpRedundancyLastSwitchover=cdbpRedundancyLastSwitchover, cdbpAppAdvToPeerEntry=cdbpAppAdvToPeerEntry, cdbpLocalIpAddress=cdbpLocalIpAddress, cdbpPeerStatsLastDiscCause=cdbpPeerStatsLastDiscCause, cdbpRealmMessageRouteAccRetrans=cdbpRealmMessageRouteAccRetrans, cdbpAppAdvFromPeerIndex=cdbpAppAdvFromPeerIndex, cdbpPeerStatsTable=cdbpPeerStatsTable, cdbpRealmKnownPeersIndex=cdbpRealmKnownPeersIndex, ciscoDiaBaseProtPeerConnectionUpNotif=ciscoDiaBaseProtPeerConnectionUpNotif, cdbpRealmMessageRoutePendReqstsOut=cdbpRealmMessageRoutePendReqstsOut, ciscoDiameterBasePMIBConform=ciscoDiameterBasePMIBConform, cdbpPeerStatsAccPendReqstsOut=cdbpPeerStatsAccPendReqstsOut, ciscoDiameterBasePMIBLocalCfgGroup=ciscoDiameterBasePMIBLocalCfgGroup, cdbpRealmMessageRouteSTRsIn=cdbpRealmMessageRouteSTRsIn, ciscoDiameterBasePMIBCompliances=ciscoDiameterBasePMIBCompliances, cdbpPeerStatsDWRsIn=cdbpPeerStatsDWRsIn, cdbpRealmMessageRouteASAsOut=cdbpRealmMessageRouteASAsOut, ciscoDiameterBasePMIBGroups=ciscoDiameterBasePMIBGroups, cdbpRealmMessageRouteACRsIn=cdbpRealmMessageRouteACRsIn, ciscoDiameterBasePMIBObjects=ciscoDiameterBasePMIBObjects, cdbpRealmKnownPeersTable=cdbpRealmKnownPeersTable, cdbpAppAdvFromPeerEntry=cdbpAppAdvFromPeerEntry, cdbpPeerStorageType=cdbpPeerStorageType, cdbpRealmMessageRouteSTAsOut=cdbpRealmMessageRouteSTAsOut, ciscoDiaBaseProtPermanentFailureNotif=ciscoDiaBaseProtPermanentFailureNotif, cdbpRealmCfgs=cdbpRealmCfgs, ciscoDiameterBasePMIBPeerStatsSkippedGroup=ciscoDiameterBasePMIBPeerStatsSkippedGroup, cdbpLocalVendorEntry=cdbpLocalVendorEntry, cdbpPeerEntry=cdbpPeerEntry, cdbpPeerPortConnect=cdbpPeerPortConnect, cdbpPeerStatsDPAsIn=cdbpPeerStatsDPAsIn, cdbpRealmMessageRouteRealm=cdbpRealmMessageRouteRealm, cdbpPeerStatsSTAsIn=cdbpPeerStatsSTAsIn, cdbpPeerStatsDPRsIn=cdbpPeerStatsDPRsIn, ciscoDiaBaseProtPeerConnectionDownNotif=ciscoDiaBaseProtPeerConnectionDownNotif, cdbpRealmKnownPeersChosen=cdbpRealmKnownPeersChosen, cdbpLocalStatsTotalPacketsOut=cdbpLocalStatsTotalPacketsOut, cdbpRealmMessageRouteASRsOut=cdbpRealmMessageRouteASRsOut, cdbpLocalStats=cdbpLocalStats, cdbpAppAdvToPeerServices=cdbpAppAdvToPeerServices, cdbpPeerIpAddressType=cdbpPeerIpAddressType, cdbpPeerStatsACAsIn=cdbpPeerStatsACAsIn, cdbpPeerStatsSTRsOut=cdbpPeerStatsSTRsOut, cdbpRealmMessageRouteAccDupReqsts=cdbpRealmMessageRouteAccDupReqsts, cdbpPeerVendorTable=cdbpPeerVendorTable, cdbpPeerIpAddrEntry=cdbpPeerIpAddrEntry, cdbpPeerStatsASRsOut=cdbpPeerStatsASRsOut, cdbpPeerStatsTotalRetrans=cdbpPeerStatsTotalRetrans, cdbpLocalApplTable=cdbpLocalApplTable, cdbpPeerStatsHByHDropMessages=cdbpPeerStatsHByHDropMessages, PYSNMP_MODULE_ID=ciscoDiameterBasePMIB, ciscoDiaBaseProtTransientFailureNotif=ciscoDiaBaseProtTransientFailureNotif, cdbpPeerStatsMalformedReqsts=cdbpPeerStatsMalformedReqsts, cdbpRealmMessageRouteType=cdbpRealmMessageRouteType, cdbpRealmMessageRouteACAsIn=cdbpRealmMessageRouteACAsIn, cdbpRealmMessageRouteRARsIn=cdbpRealmMessageRouteRARsIn, ciscoDiaBaseProtEnablePermanentFailureNotif=ciscoDiaBaseProtEnablePermanentFailureNotif, ciscoDiameterBasePMIBPeerCfgGroup=ciscoDiameterBasePMIBPeerCfgGroup, cdbpPeerStatsRedirectEvents=cdbpPeerStatsRedirectEvents, cdbpPeerId=cdbpPeerId, cdbpPeerPortListen=cdbpPeerPortListen, cdbpPeerStatsASAsOut=cdbpPeerStatsASAsOut, ciscoDiameterBasePMIBNotificationsGroup=ciscoDiameterBasePMIBNotificationsGroup, cdbpPeerVendorIndex=cdbpPeerVendorIndex, cdbpLocalIpAddrEntry=cdbpLocalIpAddrEntry, cdbpPeerTable=cdbpPeerTable)
