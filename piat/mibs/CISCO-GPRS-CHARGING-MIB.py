...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-GPRS-CHARGING-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:27:59 2019
...
NotificationType, Counter64, MibIdentifier, ObjectIdentity, ModuleIdentity, Bits, iso, TimeTicks, Counter32, Integer32, Unsigned32, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Bits", "iso", "TimeTicks", "Counter32", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TestAndIncr, StorageType, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TestAndIncr", "StorageType", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("CISCO-GPRS-CHARGING-MIB", cgprsCgSentMsgNum=cgprsCgSentMsgNum, cgprsCgProfileStorageType=cgprsCgProfileStorageType, cgprsCgGatewayGroupStatusTable=cgprsCgGatewayGroupStatusTable, cgprsCgAlarmHistType=cgprsCgAlarmHistType, cgprsCgOldChgGatewayAddress=cgprsCgOldChgGatewayAddress, cgprsCgGatewayGroupStatusOldCgAddr=cgprsCgGatewayGroupStatusOldCgAddr, cgprsCgConditionLimit=cgprsCgConditionLimit, cgprsCgAlarmNotif=cgprsCgAlarmNotif, cgprsCgMIBConfigGroupRev2=cgprsCgMIBConfigGroupRev2, cgprsCgGatewayGroupServiceRecordsNum=cgprsCgGatewayGroupServiceRecordsNum, cgprsCgMIBStatsGroupRev3=cgprsCgMIBStatsGroupRev3, cgprsCgMIBConfigGroupR100=cgprsCgMIBConfigGroupR100, cgprsCgCdrOptionImeisv=cgprsCgCdrOptionImeisv, cgprsCgGateway=cgprsCgGateway, cgprsCgGatewayGroupCgDownTimes=cgprsCgGatewayGroupCgDownTimes, cgprsCgProfileMapEntry=cgprsCgProfileMapEntry, cgprsCgGatewayGroupAccPtNum=cgprsCgGatewayGroupAccPtNum, cgprsCgMIBStatsGroupRev2=cgprsCgMIBStatsGroupRev2, cgprsCgCdrPktsStatEnable=cgprsCgCdrPktsStatEnable, cgprsCgProfileMapTable=cgprsCgProfileMapTable, cgprsCgComplianceRev9=cgprsCgComplianceRev9, cgprsCgMIBAlarmsGroup=cgprsCgMIBAlarmsGroup, cgprsCgMapDataTos=cgprsCgMapDataTos, cgprsCgComplianceRev11=cgprsCgComplianceRev11, cgprsCgMIBStatusGroupR60=cgprsCgMIBStatusGroupR60, cgprsCgAlarmHistTable=cgprsCgAlarmHistTable, cgprsCgGatewayGroupStatusActiveCgAddr=cgprsCgGatewayGroupStatusActiveCgAddr, cgprsCgProfileRowStatus=cgprsCgProfileRowStatus, cgprsCgGatewayGroupSwitchoverNotif=cgprsCgGatewayGroupSwitchoverNotif, cgprsCgGatewayEntry=cgprsCgGatewayEntry, cgprsCgServiceMode=cgprsCgServiceMode, cgprsCgPartialCdrGenEnable=cgprsCgPartialCdrGenEnable, cgprsCgProfileContentPostQosChange=cgprsCgProfileContentPostQosChange, cgprsCgCdrOptionDynamicAddr=cgprsCgCdrOptionDynamicAddr, cgprsCgN3BufferSize=cgprsCgN3BufferSize, cgprsCgClearCdrPartialCdr=cgprsCgClearCdrPartialCdr, cgprsCgComplianceRev8=cgprsCgComplianceRev8, cgprsCgGatewayGroupAlarmNotif=cgprsCgGatewayGroupAlarmNotif, cgprsCgGroupSwitchOverPriority=cgprsCgGroupSwitchOverPriority, cgprsCgAlarmHistTableMax=cgprsCgAlarmHistTableMax, cgprsCgProfileMapNumber=cgprsCgProfileMapNumber, cgprsCgGatewayGroupAlarmHistIndex=cgprsCgGatewayGroupAlarmHistIndex, cgprsCgProfileTable=cgprsCgProfileTable, cgprsCgMIBConfigGroupRev4=cgprsCgMIBConfigGroupRev4, cgprsCgScdrEnable=cgprsCgScdrEnable, cgprsCgGroupIscsi=cgprsCgGroupIscsi, cgprsCgGatewayIpRowStatus=cgprsCgGatewayIpRowStatus, cgprsCgMIBCompliances=cgprsCgMIBCompliances, cgprsCgMIBConfigGroupRev5=cgprsCgMIBConfigGroupRev5, ciscoGprsCharMIBConformances=ciscoGprsCharMIBConformances, cgprsCgFlowControlEcho=cgprsCgFlowControlEcho, cgprsCgMIBNotifGroupRev1=cgprsCgMIBNotifGroupRev1, cgprsCgGatewayLinkState=cgprsCgGatewayLinkState, cgprsCgCdrSgsnChangeLimit=cgprsCgCdrSgsnChangeLimit, cgprsCgProfileMapCategory=cgprsCgProfileMapCategory, cgprsCgGroupTable=cgprsCgGroupTable, cgprsCgGatewayOperStatus=cgprsCgGatewayOperStatus, cgprsCgProfileContentPostValTime=cgprsCgProfileContentPostValTime, cgprsCgGatewayGroupAlarmHistTable=cgprsCgGatewayGroupAlarmHistTable, cgprsCgChargingCharReject=cgprsCgChargingCharReject, cgprsCgMIBExtConfigGroup=cgprsCgMIBExtConfigGroup, cgprsCgReconnect=cgprsCgReconnect, cgprsCgServerSwitchTimeout=cgprsCgServerSwitchTimeout, cgprsCgComplianceRev3=cgprsCgComplianceRev3, cgprsCgProfileMapTrusted=cgprsCgProfileMapTrusted, cgprsCgComplianceRev4=cgprsCgComplianceRev4, cgprsCgGatewayGroupTotalCdrOpened=cgprsCgGatewayGroupTotalCdrOpened, cgprsCgGatewayIndex=cgprsCgGatewayIndex, cgprsCgProfileContentPostUserLocChange=cgprsCgProfileContentPostUserLocChange, cgprsCgGatewayIpAddrType=cgprsCgGatewayIpAddrType, cgprsCgPendingMsgNum=cgprsCgPendingMsgNum, cgprsCgProfileTariffTime=cgprsCgProfileTariffTime, cgprsCgGatewayGroupCdrOpenedNum=cgprsCgGatewayGroupCdrOpenedNum, cgprsCgAlarmEnable=cgprsCgAlarmEnable, cgprsCgMIBConfigGroupR60=cgprsCgMIBConfigGroupR60, cgprsCgProfileCategory=cgprsCgProfileCategory, cgprsCgTariffTimeEntry=cgprsCgTariffTimeEntry, cgprsCgProfileDurLimit=cgprsCgProfileDurLimit, cgprsCgPtcEnable=cgprsCgPtcEnable, cgprsCgGatewayGroupCdrPendingMsgIscsiNum=cgprsCgGatewayGroupCdrPendingMsgIscsiNum, cgprsCgProfileContentDccaProfileTable=cgprsCgProfileContentDccaProfileTable, cgprsCgGatewayGroupMaintenanceModeNotif=cgprsCgGatewayGroupMaintenanceModeNotif, cgprsCgGroupEntry=cgprsCgGroupEntry, cgprsCgMIBConfigGroupRev1=cgprsCgMIBConfigGroupRev1, ciscoGprsChargingMIB=ciscoGprsChargingMIB, cgprsCgContainerTimeLimit=cgprsCgContainerTimeLimit, cgprsCgComplianceRev12=cgprsCgComplianceRev12, cgprsCgGtpPrimePort=cgprsCgGtpPrimePort, cgprsCgProfileContentDccaProfileName=cgprsCgProfileContentDccaProfileName, cgprsCgProfileNum=cgprsCgProfileNum, cgprsCgCdrOptionPdpType=cgprsCgCdrOptionPdpType, cgprsCgLinkState=cgprsCgLinkState, cgprsCgPartialCdrGenEnableAll=cgprsCgPartialCdrGenEnableAll, cgprsCgMIBConfigProfileChangeGroupRev1Sup1=cgprsCgMIBConfigProfileChangeGroupRev1Sup1, cgprsCgCdrOptionPdpAddress=cgprsCgCdrOptionPdpAddress, cgprsCgCdrOptionSerMsisdn=cgprsCgCdrOptionSerMsisdn, cgprsCgAlarmHistIndex=cgprsCgAlarmHistIndex, cgprsCgCdrOptionUserLocInfo=cgprsCgCdrOptionUserLocInfo, cgprsCgGatewayGroupAlarmEnable=cgprsCgGatewayGroupAlarmEnable, cgprsCgProfileContentPostSgsnChange=cgprsCgProfileContentPostSgsnChange, CgprsCgAlarmType=CgprsCgAlarmType, cgprsCgGatewayGroupPendingMsgNum=cgprsCgGatewayGroupPendingMsgNum, cgprsCgComplianceRev10=cgprsCgComplianceRev10, cgprsCgComplianceRev1=cgprsCgComplianceRev1, cgprsCgProfileVolumeLimitReset=cgprsCgProfileVolumeLimitReset, CgprsCgGatewayType=CgprsCgGatewayType, ciscoGprsChargingConfig=ciscoGprsChargingConfig, cgprsCgSgsnChangeLimit=cgprsCgSgsnChangeLimit, cgprsCgGatewayGroupTotalServiceRecords=cgprsCgGatewayGroupTotalServiceRecords, cgprsCgGatewayTable=cgprsCgGatewayTable, ciscoGprsChargingStats=ciscoGprsChargingStats, cgprsCgProfileVolumeLimit=cgprsCgProfileVolumeLimit, cgprsCgCharSelectionMode=cgprsCgCharSelectionMode, cgprsCgGatewayGroupTotalSentMsgToCg=cgprsCgGatewayGroupTotalSentMsgToCg, cgprsCgAlarmHistInfo=cgprsCgAlarmHistInfo, cgprsCgGroupRowStatus=cgprsCgGroupRowStatus, cgprsCgContainerVolThresh=cgprsCgContainerVolThresh, cgprsCgProfileCdrSuppressPrepaid=cgprsCgProfileCdrSuppressPrepaid, cgprsCgTransFormNumRespEnable=cgprsCgTransFormNumRespEnable, cgprsCgPathProtocol=cgprsCgPathProtocol, cgprsCgCdrOptionServiceRecord=cgprsCgCdrOptionServiceRecord, cgprsCgDownTimes=cgprsCgDownTimes, cgprsCgGatewayRowStatus=cgprsCgGatewayRowStatus, cgprsCgGatewayGroupStatusEntry=cgprsCgGatewayGroupStatusEntry, cgprsCgTariffTimeRowStatus=cgprsCgTariffTimeRowStatus, cgprsCgGatewayGroupAlarmHistInfo=cgprsCgGatewayGroupAlarmHistInfo, cgprsCgGatewayGroupAlarmHistEntry=cgprsCgGatewayGroupAlarmHistEntry, cgprsCgPtcPossiblyDupEnable=cgprsCgPtcPossiblyDupEnable, cgprsCgProfileDurLimitReset=cgprsCgProfileDurLimitReset, cgprsCgGatewayIpAddr=cgprsCgGatewayIpAddr, cgprsCgChargeForRoamersOnly=cgprsCgChargeForRoamersOnly, cgprsCgComplianceRev2=cgprsCgComplianceRev2, cgprsCgRelease=cgprsCgRelease, cgprsCgPathRequest=cgprsCgPathRequest, cgprsCgMIBConfigGroup=cgprsCgMIBConfigGroup, cgprsCgActiveChgGatewayAddress=cgprsCgActiveChgGatewayAddress, cgprsCgTariffTimeSec=cgprsCgTariffTimeSec, cgprsCgCdrNonPrimaryEnable=cgprsCgCdrNonPrimaryEnable, cgprsCgProfileContentPostRatChange=cgprsCgProfileContentPostRatChange, cgprsCgAlarmHistAddress=cgprsCgAlarmHistAddress, ciscoGprsCharNotifs=ciscoGprsCharNotifs, cgprsCgCdrAggreLimit=cgprsCgCdrAggreLimit, cgprsCgServiceRecordIncludePlmn=cgprsCgServiceRecordIncludePlmn, cgprsCgProfileContentPostVolume=cgprsCgProfileContentPostVolume, ciscoGprsChargingOthers=ciscoGprsChargingOthers, cgprsCgComplianceRev6=cgprsCgComplianceRev6, cgprsCgCdrOptionRatType=cgprsCgCdrOptionRatType, cgprsCgProfileCdrSuppress=cgprsCgProfileCdrSuppress, cgprsCgGatewayGroupTotalContainerCreated=cgprsCgGatewayGroupTotalContainerCreated, cgprsCgInServiceModeNotif=cgprsCgInServiceModeNotif, cgprsCgProfileContentRulebaseId=cgprsCgProfileContentRulebaseId, cgprsCgCdrOptionCamelCharInfo=cgprsCgCdrOptionCamelCharInfo, cgprsCgPktsQSize=cgprsCgPktsQSize, cgprsCgProfileContentDccaProfile=cgprsCgProfileContentDccaProfile, ciscoGprsChargingStatus=ciscoGprsChargingStatus, cgprsCgMIBConfigGroupR80=cgprsCgMIBConfigGroupR80, cgprsCgTariffTimeHour=cgprsCgTariffTimeHour, cgprsCgGatewayGroupCdrClosedNum=cgprsCgGatewayGroupCdrClosedNum, cgprsCgCdrOptionVirtualApn=cgprsCgCdrOptionVirtualApn, cgprsCgGroupIndex=cgprsCgGroupIndex, cgprsCgProfileEntry=cgprsCgProfileEntry, cgprsCgAlarmHistEntry=cgprsCgAlarmHistEntry, cgprsCgCdrClosedNum=cgprsCgCdrClosedNum, cgprsCgCdrOptionApnSelMode=cgprsCgCdrOptionApnSelMode, cgprsCgTotalServiceRecords=cgprsCgTotalServiceRecords, cgprsCgMIBStatsGroup=cgprsCgMIBStatsGroup, cgprsCgProfileContentPostTime=cgprsCgProfileContentPostTime, cgprsCgGatewayGroupCdrPendingMsgCgPathNum=cgprsCgGatewayGroupCdrPendingMsgCgPathNum, cgprsCgMIBStatusGroup=cgprsCgMIBStatusGroup, cgprsCgMIBConfigGroupR100Rev1=cgprsCgMIBConfigGroupR100Rev1, cgprsCgAccPtNum=cgprsCgAccPtNum, cgprsCgAlarmHistLatestIndex=cgprsCgAlarmHistLatestIndex, cgprsCgProfileMapNum=cgprsCgProfileMapNum, cgprsCgMIBConfigGroupR90=cgprsCgMIBConfigGroupR90, cgprsCgActiveChgGatewayAddrType=cgprsCgActiveChgGatewayAddrType, cgprsCgGatewaySwitchoverNotif=cgprsCgGatewaySwitchoverNotif, cgprsCgTariffTimeMin=cgprsCgTariffTimeMin, cgprsCgServiceRecordIncludeUserLocInfo=cgprsCgServiceRecordIncludeUserLocInfo, cgprsCgOperStatus=cgprsCgOperStatus, cgprsCgGatewayGroupStatusAddrType=cgprsCgGatewayGroupStatusAddrType, cgprsCgProfileSgsnChange=cgprsCgProfileSgsnChange, cgprsCgCdrOptionMsTimeZone=cgprsCgCdrOptionMsTimeZone, cgprsCgGroupServiceMode=cgprsCgGroupServiceMode, cgprsCgGatewayGroupContainerNum=cgprsCgGatewayGroupContainerNum, cgprsCgGatewayGroupInServiceModeNotif=cgprsCgGatewayGroupInServiceModeNotif, cgprsCgServiceRecordIncludeRat=cgprsCgServiceRecordIncludeRat, cgprsCgCdrOpenedNum=cgprsCgCdrOpenedNum, cgprsCgTotalContainerCreated=cgprsCgTotalContainerCreated, cgprsCgTariffTimeIndex=cgprsCgTariffTimeIndex, cgprsCgGatewayIpEntry=cgprsCgGatewayIpEntry, cgprsCgEnable=cgprsCgEnable, cgprsCgGatewayIpIndex=cgprsCgGatewayIpIndex, cgprsCgSwitchOverPriority=cgprsCgSwitchOverPriority, cgprsCgTransInterval=cgprsCgTransInterval, cgprsCgCdrOptionSgsnPlmn=cgprsCgCdrOptionSgsnPlmn, cgprsCgGatewayGroupTotalSentMsgToIscsi=cgprsCgGatewayGroupTotalSentMsgToIscsi, cgprsCgProfileContentPostValidityTime=cgprsCgProfileContentPostValidityTime, cgprsCgGatewayGroupTotalSentMsg=cgprsCgGatewayGroupTotalSentMsg, cgprsCgAlarmHistAddrType=cgprsCgAlarmHistAddrType, cgprsCgGatewayIpTable=cgprsCgGatewayIpTable, cgprsCgMIBAlarmsGroupRev1=cgprsCgMIBAlarmsGroupRev1, cgprsCgProfileContentDccaProfileWeight=cgprsCgProfileContentDccaProfileWeight, cgprsCgGatewayAddrType=cgprsCgGatewayAddrType, cgprsCgGatewayGroupAlarmHistAddress=cgprsCgGatewayGroupAlarmHistAddress, cgprsCgMIBStatusGroupRev1=cgprsCgMIBStatusGroupRev1, cgprsCgTariffTimeTable=cgprsCgTariffTimeTable, cgprsCgMaintenanceModeNotif=cgprsCgMaintenanceModeNotif, cgprsCgCdrLocalSeqNumEnable=cgprsCgCdrLocalSeqNumEnable, cgprsCgTotalCdrOpened=cgprsCgTotalCdrOpened, cgprsCgGatewayAddr=cgprsCgGatewayAddr, cgprsCgGatewayGroupAlarmHistType=cgprsCgGatewayGroupAlarmHistType, cgprsCgTariffTimeMaxEntries=cgprsCgTariffTimeMaxEntries, cgprsCgProfileContentPostPlmnChange=cgprsCgProfileContentPostPlmnChange, cgprsCgMIBAlarmsGroupRev2=cgprsCgMIBAlarmsGroupRev2, cgprsCgProfileDesc=cgprsCgProfileDesc, cgprsCgCdrNodeIdEnable=cgprsCgCdrNodeIdEnable, cgprsCgGatewayGroupAlarmHistAddrType=cgprsCgGatewayGroupAlarmHistAddrType, cgprsCgGatewayGroupStatisticsEntry=cgprsCgGatewayGroupStatisticsEntry, cgprsCgProfileContentDccaProfileEntry=cgprsCgProfileContentDccaProfileEntry, cgprsCgChargingSrcInterface=cgprsCgChargingSrcInterface, cgprsCgContainerNum=cgprsCgContainerNum, cgprsCgTariffTimeNextIndex=cgprsCgTariffTimeNextIndex, cgprsCgGatewayGroupStatisticsTable=cgprsCgGatewayGroupStatisticsTable, cgprsCgProfileMapOverride=cgprsCgProfileMapOverride, cgprsCgMIBConfigProfileChangeGroupRev1=cgprsCgMIBConfigProfileChangeGroupRev1, ciscoGprsChargingMIBObjects=ciscoGprsChargingMIBObjects, cgprsCgProfileScdrEnable=cgprsCgProfileScdrEnable, cgprsCgCdrOptionNip=cgprsCgCdrOptionNip, ciscoGprsCharNotifPrefix=ciscoGprsCharNotifPrefix, cgprsCgProfileContentDccaProfileRowStatus=cgprsCgProfileContentDccaProfileRowStatus, cgprsCgMIBGroups=cgprsCgMIBGroups, cgprsCgComplianceRev7=cgprsCgComplianceRev7, cgprsCgMIBStatsGroupRev1=cgprsCgMIBStatsGroupRev1, ciscoGprsChargingAlarms=ciscoGprsChargingAlarms, cgprsCgMIBNotifGroup=cgprsCgMIBNotifGroup, cgprsCgGatewayGroupAlarmHistSeverity=cgprsCgGatewayGroupAlarmHistSeverity, cgprsCgCdrOptionApn=cgprsCgCdrOptionApn, cgprsCgComplianceRev5=cgprsCgComplianceRev5, cgprsCgMIBConfigProfileChangeGroup=cgprsCgMIBConfigProfileChangeGroup, cgprsCgAlarmHistSeverity=cgprsCgAlarmHistSeverity, cgprsCgGtpShortHeaderEnable=cgprsCgGtpShortHeaderEnable, cgprsCgCompliance=cgprsCgCompliance, cgprsCgMIBNotifGroupRev2=cgprsCgMIBNotifGroupRev2, PYSNMP_MODULE_ID=ciscoGprsChargingMIB, cgprsCgGatewayGroupCdrPendingMsgMaintNum=cgprsCgGatewayGroupCdrPendingMsgMaintNum, cgprsCgMIBConfigGroupRev3=cgprsCgMIBConfigGroupRev3)
