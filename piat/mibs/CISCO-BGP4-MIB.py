...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-BGP4-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:36:38 2019
...
bgpPeerLastError, bgpPeerState, bgpPeerRemoteAddr, bgpPeerEntry = mibBuilder.importSymbols("BGP4-MIB", "bgpPeerLastError", "bgpPeerState", "bgpPeerRemoteAddr", "bgpPeerEntry")
ciscoMgmt, = mibBuilder.importSymbols("CISCO-SMI", "ciscoMgmt")
InetAddressType, InetAddress, InetAutonomousSystemNumber, InetPortNumber = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddressType", "InetAddress", "InetAutonomousSystemNumber", "InetPortNumber")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
ObjectIdentity, TimeTicks, Counter64, Unsigned32, MibIdentifier, Integer32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Counter64", "Unsigned32", "MibIdentifier", "Integer32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("CISCO-BGP4-MIB", cbgpRouteAddrPrefix=cbgpRouteAddrPrefix, cbgpPeer2CapsTable=cbgpPeer2CapsTable, cbgpPeer2AdminStatus=cbgpPeer2AdminStatus, cbgpRouteUnknownAttr=cbgpRouteUnknownAttr, cbgpRouteLocalPrefPresent=cbgpRouteLocalPrefPresent, cbgpRouteMultiExitDisc=cbgpRouteMultiExitDisc, cbgpPeer2Table=cbgpPeer2Table, cbgpPeer2AddrFamilyPrefixTable=cbgpPeer2AddrFamilyPrefixTable, cbgpRoutePeerType=cbgpRoutePeerType, cbgpPeer2Entry=cbgpPeer2Entry, cbgpPeer2RemoteIdentifier=cbgpPeer2RemoteIdentifier, ciscoBgp4MIBCompliances=ciscoBgp4MIBCompliances, ciscoBgp4PeerGroup1=ciscoBgp4PeerGroup1, cbgpPeerAddrFamilySafi=cbgpPeerAddrFamilySafi, cbgpLocalAs=cbgpLocalAs, cbgpBackwardTransition=cbgpBackwardTransition, ciscoBgp4NotificationPrefix=ciscoBgp4NotificationPrefix, cbgpPeer2InUpdates=cbgpPeer2InUpdates, ciscoBgp4MIBConformance=ciscoBgp4MIBConformance, cbgpPeerAddrFamilyPrefixEntry=cbgpPeerAddrFamilyPrefixEntry, cbgpRouteAggregatorAS=cbgpRouteAggregatorAS, cbgpPeer2AddrFamilySafi=cbgpPeer2AddrFamilySafi, cbgpPeerWithdrawnPrefixes=cbgpPeerWithdrawnPrefixes, cbgpNotifsEnable=cbgpNotifsEnable, cbgpPeerPrefixAdvertised=cbgpPeerPrefixAdvertised, cbgpPeer2AddrFamilyEntry=cbgpPeer2AddrFamilyEntry, cbgpPeerAddrFamilyTable=cbgpPeerAddrFamilyTable, cbgpPrefixThresholdExceeded=cbgpPrefixThresholdExceeded, cbgpPeer2RemoteAs=cbgpPeer2RemoteAs, cbgpPeerAddrFamilyAfi=cbgpPeerAddrFamilyAfi, cbgpPeer2AddrFamilyAfi=cbgpPeer2AddrFamilyAfi, cbgpPeerCapsTable=cbgpPeerCapsTable, cbgpPeerPrevState=cbgpPeerPrevState, cbgpPeer2AddrFamilyTable=cbgpPeer2AddrFamilyTable, cbgpRouteAggregatorAddrType=cbgpRouteAggregatorAddrType, cbgpPeerAddrFamilyPrefixTable=cbgpPeerAddrFamilyPrefixTable, cbgpRouteOrigin=cbgpRouteOrigin, cbgpRouteEntry=cbgpRouteEntry, cbgpRouteAfi=cbgpRouteAfi, cbgpPeerAcceptedPrefixes=cbgpPeerAcceptedPrefixes, cbgpPeer2PrefixClearThreshold=cbgpPeer2PrefixClearThreshold, cbgpPeer2State=cbgpPeer2State, cbgpPeer2MinASOriginationInterval=cbgpPeer2MinASOriginationInterval, cbgpRouteMedPresent=cbgpRouteMedPresent, cbgpPeer2LocalPort=cbgpPeer2LocalPort, ciscoBgp4RouteGroup=ciscoBgp4RouteGroup, ciscoBgp4MIBComplianceRev3=ciscoBgp4MIBComplianceRev3, cbgpRouteNextHop=cbgpRouteNextHop, cbgpPeer2PrefixAdminLimit=cbgpPeer2PrefixAdminLimit, cbgpPeer2WithdrawnPrefixes=cbgpPeer2WithdrawnPrefixes, cbgpPeer2LocalIdentifier=cbgpPeer2LocalIdentifier, ciscoBgp4NotificationsGroup1=ciscoBgp4NotificationsGroup1, cbgpPeer2PrefixThresholdClear=cbgpPeer2PrefixThresholdClear, cbgpPeerPrefixClearThreshold=cbgpPeerPrefixClearThreshold, cbgpPeerAddrFamilyEntry=cbgpPeerAddrFamilyEntry, cbgpPeerPrefixAdminLimit=cbgpPeerPrefixAdminLimit, cbgpPeer2Type=cbgpPeer2Type, ciscoBgp4MIBComplianceRev1=ciscoBgp4MIBComplianceRev1, PYSNMP_MODULE_ID=ciscoBgp4MIB, cbgpPeerTable=cbgpPeerTable, ciscoBgp4MIBComplianceRev2=ciscoBgp4MIBComplianceRev2, cbgpPeer2KeepAliveConfigured=cbgpPeer2KeepAliveConfigured, cbgpPeerPrefixWithdrawn=cbgpPeerPrefixWithdrawn, ciscoBgp4Peer2Group=ciscoBgp4Peer2Group, cbgpPeerDeniedPrefixes=cbgpPeerDeniedPrefixes, cbgpPeer2PrefixThresholdExceeded=cbgpPeer2PrefixThresholdExceeded, cbgpPeer2BackwardTransNotification=cbgpPeer2BackwardTransNotification, cbgpRouteTable=cbgpRouteTable, cbgpFsmStateChange=cbgpFsmStateChange, ciscoBgp4NotifyPrefix=ciscoBgp4NotifyPrefix, cbgpRoutePeer=cbgpRoutePeer, cbgpPeer2OutUpdates=cbgpPeer2OutUpdates, cbgpPeer2EstablishedNotification=cbgpPeer2EstablishedNotification, cbgpPeer2RemoteAddr=cbgpPeer2RemoteAddr, cbgpPeerPrefixThreshold=cbgpPeerPrefixThreshold, cbgpPeer2RemotePort=cbgpPeer2RemotePort, ciscoBgp4PeerGroup=ciscoBgp4PeerGroup, cbgpPeer2CapIndex=cbgpPeer2CapIndex, cbgpPeer2PrefixThreshold=cbgpPeer2PrefixThreshold, cbgpPeerCapsEntry=cbgpPeerCapsEntry, cbgpPeer2CapValue=cbgpPeer2CapValue, ciscoBgp4MIBObjects=ciscoBgp4MIBObjects, ciscoBgp4MIBGroups=ciscoBgp4MIBGroups, cbgpPeer2LastErrorTxt=cbgpPeer2LastErrorTxt, cbgpRouteBest=cbgpRouteBest, cbgpPeerPrefixLimit=cbgpPeerPrefixLimit, ciscoBgp4Peer2NotificationsGroup=ciscoBgp4Peer2NotificationsGroup, cbgpPeer2CapCode=cbgpPeer2CapCode, cbgpPeer2FsmEstablishedTime=cbgpPeer2FsmEstablishedTime, cbgpPeer2ConnectRetryInterval=cbgpPeer2ConnectRetryInterval, cbgpPeerSuppressedPrefixes=cbgpPeerSuppressedPrefixes, cbgpRouteASPathSegment=cbgpRouteASPathSegment, ciscoBgp4GlobalGroup=ciscoBgp4GlobalGroup, cbgpPeer2CapsEntry=cbgpPeer2CapsEntry, cbgpRoute=cbgpRoute, cbgpPeerPrefixDenied=cbgpPeerPrefixDenied, cbgpPeer2DeniedPrefixes=cbgpPeer2DeniedPrefixes, cbgpRouteAtomicAggregate=cbgpRouteAtomicAggregate, cbgpPeer2NegotiatedVersion=cbgpPeer2NegotiatedVersion, ciscoBgp4MIB=ciscoBgp4MIB, cbgpPeerAdvertisedPrefixes=cbgpPeerAdvertisedPrefixes, cbgpPeerAddrFamilyName=cbgpPeerAddrFamilyName, cbgpPeer2MinRouteAdvertisementInterval=cbgpPeer2MinRouteAdvertisementInterval, cbgpRouteAggregatorAddr=cbgpRouteAggregatorAddr, cbgpPeer2PrevState=cbgpPeer2PrevState, cbgpPeer2LocalAddr=cbgpPeer2LocalAddr, cbgpPeerEntry=cbgpPeerEntry, cbgpPeer2LocalAs=cbgpPeer2LocalAs, cbgpPeerCapIndex=cbgpPeerCapIndex, cbgpRouteLocalPref=cbgpRouteLocalPref, CbgpSafi=CbgpSafi, cbgpPeerPrefixSuppressed=cbgpPeerPrefixSuppressed, cbgpPeer2SuppressedPrefixes=cbgpPeer2SuppressedPrefixes, cbgpPeer2BackwardTransition=cbgpPeer2BackwardTransition, cbgpPeer2AddrFamilyPrefixEntry=cbgpPeer2AddrFamilyPrefixEntry, cbgpPeer2InTotalMessages=cbgpPeer2InTotalMessages, cbgpPeer2LastError=cbgpPeer2LastError, cbgpPeer2InUpdateElapsedTime=cbgpPeer2InUpdateElapsedTime, ciscoBgp4MIBCompliance=ciscoBgp4MIBCompliance, ciscoBgp4NotificationsGroup=ciscoBgp4NotificationsGroup, cbgpPeer2KeepAlive=cbgpPeer2KeepAlive, cbgpPeer2FsmStateChange=cbgpPeer2FsmStateChange, cbgpPeerPrefixAccepted=cbgpPeerPrefixAccepted, cbgpGlobal=cbgpGlobal, cbgpPeer2OutTotalMessages=cbgpPeer2OutTotalMessages, cbgpPeer2HoldTime=cbgpPeer2HoldTime, cbgpPeerCapValue=cbgpPeerCapValue, cbgpPeer2AcceptedPrefixes=cbgpPeer2AcceptedPrefixes, cbgpRouteSafi=cbgpRouteSafi, cbgpPeerLastErrorTxt=cbgpPeerLastErrorTxt, CbgpNetworkAddress=CbgpNetworkAddress, cbgpPeer2FsmEstablishedTransitions=cbgpPeer2FsmEstablishedTransitions, cbgpPrefixThresholdClear=cbgpPrefixThresholdClear, cbgpPeerCapCode=cbgpPeerCapCode, cbgpRouteAddrPrefixLen=cbgpRouteAddrPrefixLen, cbgpPeer2HoldTimeConfigured=cbgpPeer2HoldTimeConfigured, cbgpPeer2AddrFamilyName=cbgpPeer2AddrFamilyName, cbgpPeer2AdvertisedPrefixes=cbgpPeer2AdvertisedPrefixes, cbgpPeer=cbgpPeer)
