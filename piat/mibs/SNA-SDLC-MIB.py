...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/SNA-SDLC-MIB
...
IpAddress, Gauge32, ObjectIdentity, TimeTicks, mib_2, ModuleIdentity, Counter32, Unsigned32, Integer32, MibIdentifier, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ObjectIdentity", "TimeTicks", "mib-2", "ModuleIdentity", "Counter32", "Unsigned32", "Integer32", "MibIdentifier", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64")
...
mibBuilder.exportSymbols("SNA-SDLC-MIB", sdlcLSAdminISTATUS=sdlcLSAdminISTATUS, sdlcLSStatsPollRspsOut=sdlcLSStatsPollRspsOut, sdlcLSAdminRETRIESt=sdlcLSAdminRETRIESt, sdlcCorePortOperGroup=sdlcCorePortOperGroup, sdlcLSStatsDISCIn=sdlcLSStatsDISCIn, sdlcPortOperType=sdlcPortOperType, sdlcLSStatsOctetsIn=sdlcLSStatsOctetsIn, sdlcPortOperSERVLIM=sdlcPortOperSERVLIM, sdlcLSOperMODULO=sdlcLSOperMODULO, sdlcLSAdminName=sdlcLSAdminName, sdlcLSStatsBLUsIn=sdlcLSStatsBLUsIn, sdlcPortOperSlowPollTimer=sdlcPortOperSlowPollTimer, sdlcLSOperState=sdlcLSOperState, sdlcPortStatsRNRLIMITs=sdlcPortStatsRNRLIMITs, sdlcCoreLSStatsGroup=sdlcCoreLSStatsGroup, sdlcLSStatsTable=sdlcLSStatsTable, sdlcPortStatsRemoteBusies=sdlcPortStatsRemoteBusies, sdlcLSStatsPollRspsIn=sdlcLSStatsPollRspsIn, sdlcLSAdminREPLYTO=sdlcLSAdminREPLYTO, sdlcLSOperEntry=sdlcLSOperEntry, sdlcLSStatsRIMsIn=sdlcLSStatsRIMsIn, sdlcPortAdminTopology=sdlcPortAdminTopology, sdlcPortAdminSERVLIM=sdlcPortAdminSERVLIM, sdlcCoreCompliance=sdlcCoreCompliance, sdlcLSOperLastFailTime=sdlcLSOperLastFailTime, sdlcLSStatsIFramesIn=sdlcLSStatsIFramesIn, sdlcLSStatsActivityTOs=sdlcLSStatsActivityTOs, snaDLC=snaDLC, sdlcPortOperTable=sdlcPortOperTable, sdlcPrimaryMultipointGroup=sdlcPrimaryMultipointGroup, sdlcPortStatsIFramesOut=sdlcPortStatsIFramesOut, sdlcLSOperLastModifyTime=sdlcLSOperLastModifyTime, sdlcLSStatsRIMsOut=sdlcLSStatsRIMsOut, sdlcPortOperName=sdlcPortOperName, sdlcLSStatsFRMRsIn=sdlcLSStatsFRMRsIn, sdlcPortStatsLocalBusies=sdlcPortStatsLocalBusies, sdlcGroups=sdlcGroups, sdlcLSGroup=sdlcLSGroup, sdlcPrimaryMultipointCompliance=sdlcPrimaryMultipointCompliance, sdlc=sdlc, sdlcPortAdminPAUSE=sdlcPortAdminPAUSE, sdlcCoreGroups=sdlcCoreGroups, sdlcLSAdminRowStatus=sdlcLSAdminRowStatus, sdlcLSOperRETRIESt=sdlcLSOperRETRIESt, sdlcLSOperLastFailCtrlOut=sdlcLSOperLastFailCtrlOut, sdlcLSStatsUIFramesOut=sdlcLSStatsUIFramesOut, sdlcLSAdminState=sdlcLSAdminState, sdlcLSStatsTESTsIn=sdlcLSStatsTESTsIn, sdlcLSStatsDMIn=sdlcLSStatsDMIn, sdlcLSStatsUAIn=sdlcLSStatsUAIn, sdlcLSAdminSimRim=sdlcLSAdminSimRim, sdlcLSStatsBLUsOut=sdlcLSStatsBLUsOut, sdlcLSAdminDATMODE=sdlcLSAdminDATMODE, sdlcPortOperEntry=sdlcPortOperEntry, sdlcPrimaryCompliance=sdlcPrimaryCompliance, sdlcLSOperRETRIESn=sdlcLSOperRETRIESn, sdlcCoreLSOperGroup=sdlcCoreLSOperGroup, sdlcLSStatsFRMRsOut=sdlcLSStatsFRMRsOut, sdlcLSOperRole=sdlcLSOperRole, sdlcLSAdminMODULO=sdlcLSAdminMODULO, sdlcPortStatsPollRspsIn=sdlcPortStatsPollRspsIn, sdlcLSOperMAXIN=sdlcLSOperMAXIN, sdlcPortAdminTable=sdlcPortAdminTable, sdlcLSStatsTESTsOut=sdlcLSStatsTESTsOut, sdlcLSStatsPollsIn=sdlcLSStatsPollsIn, sdlcLSAdminXmitRcvCap=sdlcLSAdminXmitRcvCap, sdlcLSAdminMAXIN=sdlcLSAdminMAXIN, sdlcLSStatusChange=sdlcLSStatusChange, sdlcLSStatsEntry=sdlcLSStatsEntry, sdlcPortStatsEntry=sdlcPortStatsEntry, sdlcLSStatsUAOut=sdlcLSStatsUAOut, sdlcLSStatsRetriesExps=sdlcLSStatsRetriesExps, sdlcPortOperISTATUS=sdlcPortOperISTATUS, sdlcLSStatsDMOut=sdlcLSStatsDMOut, sdlcLSOperSimRim=sdlcLSOperSimRim, sdlcLSStatsXIDsOut=sdlcLSStatsXIDsOut, sdlcLSOperREPLYTO=sdlcLSOperREPLYTO, sdlcPortStatsInvalidAddresses=sdlcPortStatsInvalidAddresses, sdlcPortStatsProtocolErrs=sdlcPortStatsProtocolErrs, sdlcPortAdminName=sdlcPortAdminName, sdlcLSStatsSNRMOut=sdlcLSStatsSNRMOut, sdlcLSStatsSIMsIn=sdlcLSStatsSIMsIn, sdlcLSOperRNRLIMIT=sdlcLSOperRNRLIMIT, sdlcLSOperDATMODE=sdlcLSOperDATMODE, sdlcLSOperRETRIESm=sdlcLSOperRETRIESm, sdlcLSStatsRemoteBusies=sdlcLSStatsRemoteBusies, sdlcPortStatsActivityTOs=sdlcPortStatsActivityTOs, sdlcLSStatsREJsOut=sdlcLSStatsREJsOut, sdlcLSOperGPoll=sdlcLSOperGPoll, sdlcLSStatsUIFramesIn=sdlcLSStatsUIFramesIn, sdlcCorePortStatsGroup=sdlcCorePortStatsGroup, sdlcPortAdminRole=sdlcPortAdminRole, sdlcPortOperLastModifyTime=sdlcPortOperLastModifyTime, sdlcCorePortAdminGroup=sdlcCorePortAdminGroup, sdlcLSStatsRetransmitsIn=sdlcLSStatsRetransmitsIn, sdlcLSStatsXIDsIn=sdlcLSStatsXIDsIn, sdlcLSStatsSNRMIn=sdlcLSStatsSNRMIn, sdlcLSStatsRNRLIMITs=sdlcLSStatsRNRLIMITs, sdlcLSOperMAXDATASend=sdlcLSOperMAXDATASend, sdlcPortAdminISTATUS=sdlcPortAdminISTATUS, sdlcPortStatsOctetsOut=sdlcPortStatsOctetsOut, sdlcLSOperLastFailCause=sdlcLSOperLastFailCause, sdlcPortStatsPollRspsOut=sdlcPortStatsPollRspsOut, sdlcLSOperTable=sdlcLSOperTable, sdlcConformance=sdlcConformance, sdlcPortStatsPollsOut=sdlcPortStatsPollsOut, sdlcLSAdminRETRIESm=sdlcLSAdminRETRIESm, sdlcPrimaryGroup=sdlcPrimaryGroup, sdlcLSAdminRETRIESn=sdlcLSAdminRETRIESn, sdlcPortStatsPollsIn=sdlcPortStatsPollsIn, sdlcPortOperLastFailTime=sdlcPortOperLastFailTime, sdlcCompliances=sdlcCompliances, sdlcCoreLSAdminGroup=sdlcCoreLSAdminGroup, sdlcPortOperRole=sdlcPortOperRole, sdlcPortOperTopology=sdlcPortOperTopology, sdlcPortAdminACTIVTO=sdlcPortAdminACTIVTO, sdlcLSOperMAXOUT=sdlcLSOperMAXOUT, sdlcLSStatsLocalBusies=sdlcLSStatsLocalBusies, sdlcPortStatsPhysicalFailures=sdlcPortStatsPhysicalFailures, sdlcLSOperLastFailFRMRInfo=sdlcLSOperLastFailFRMRInfo, sdlcTraps=sdlcTraps, PYSNMP_MODULE_ID=snaDLC, sdlcPortOperPAUSE=sdlcPortOperPAUSE, sdlcPortOperLastFailCause=sdlcPortOperLastFailCause, sdlcLSOperLastFailREPLYTOs=sdlcLSOperLastFailREPLYTOs, sdlcLSOperLastFailCtrlIn=sdlcLSOperLastFailCtrlIn, sdlcPortStatsTable=sdlcPortStatsTable, sdlcLSAdminRNRLIMIT=sdlcLSAdminRNRLIMIT, sdlcLSStatsDISCOut=sdlcLSStatsDISCOut, sdlcLSOperName=sdlcLSOperName, sdlcLSStatsRetransmitsOut=sdlcLSStatsRetransmitsOut, sdlcLSAdminEntry=sdlcLSAdminEntry, sdlcPortStatusChange=sdlcPortStatusChange, sdlcLSAdminMAXDATASend=sdlcLSAdminMAXDATASend, sdlcLSAdminTable=sdlcLSAdminTable, sdlcPortAdminType=sdlcPortAdminType, sdlcLSOperXmitRcvCap=sdlcLSOperXmitRcvCap, sdlcPortStatsRetransmitsOut=sdlcPortStatsRetransmitsOut, sdlcLSStatsProtocolErrs=sdlcLSStatsProtocolErrs, sdlcPortOperACTIVTO=sdlcPortOperACTIVTO, sdlcPortGroup=sdlcPortGroup, sdlcLSStatsSIMsOut=sdlcLSStatsSIMsOut, sdlcPortStatsRetransmitsIn=sdlcPortStatsRetransmitsIn, sdlcPortAdminEntry=sdlcPortAdminEntry, sdlcPortStatsOctetsIn=sdlcPortStatsOctetsIn, sdlcPrimaryGroups=sdlcPrimaryGroups, sdlcLSAdminGPoll=sdlcLSAdminGPoll, sdlcPortStatsDwarfFrames=sdlcPortStatsDwarfFrames, sdlcLSAddress=sdlcLSAddress, sdlcPortOperSlowPollMethod=sdlcPortOperSlowPollMethod, sdlcLSStatsIFramesOut=sdlcLSStatsIFramesOut, sdlcPortStatsIFramesIn=sdlcPortStatsIFramesIn, sdlcPortStatsRetriesExps=sdlcPortStatsRetriesExps, sdlcLSStatsREJsIn=sdlcLSStatsREJsIn, sdlcLSAdminMAXOUT=sdlcLSAdminMAXOUT, sdlcPortAdminSlowPollTimer=sdlcPortAdminSlowPollTimer, sdlcLSStatsPollsOut=sdlcLSStatsPollsOut, sdlcLSStatsOctetsOut=sdlcLSStatsOctetsOut, sdlcLSAdminMAXDATARcv=sdlcLSAdminMAXDATARcv, sdlcLSOperEcho=sdlcLSOperEcho)
