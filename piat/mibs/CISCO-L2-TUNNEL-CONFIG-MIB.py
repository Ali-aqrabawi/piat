...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-L2-TUNNEL-CONFIG-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:35:19 2019
...
NotificationType, IpAddress, MibIdentifier, Counter32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Bits, Counter64, Gauge32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibIdentifier", "Counter32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Bits", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-L2-TUNNEL-CONFIG-MIB", cltcNotificationEnable=cltcNotificationEnable, cltcTunnelStatisticsTable=cltcTunnelStatisticsTable, cltcTunnelSysDropNotifEnableGroup=cltcTunnelSysDropNotifEnableGroup, cltcDot1qTunnelEntry=cltcDot1qTunnelEntry, cltcTunneledProtocolIndex=cltcTunneledProtocolIndex, cltcTunnelDropStatTable=cltcTunnelDropStatTable, cltcDot1qAllTaggedIfEnabled=cltcDot1qAllTaggedIfEnabled, cltcMIBConformance=cltcMIBConformance, cltcTunnelDropStatEntry=cltcTunnelDropStatEntry, cltcTunnelSysDropThreshold=cltcTunnelSysDropThreshold, ciscoL2TunnelConfigMIB=ciscoL2TunnelConfigMIB, cltcTunnelStatisticsEntry=cltcTunnelStatisticsEntry, cltcTunneledProtocolEntry=cltcTunneledProtocolEntry, cltcMIBCompliance4=cltcMIBCompliance4, cltcTunnelEncapStats=cltcTunnelEncapStats, cltcTunnelCos=cltcTunnelCos, cltcTunnelDropThreshold=cltcTunnelDropThreshold, cltcTunnelDropStats=cltcTunnelDropStats, cltcTunnelThresholdGroup=cltcTunnelThresholdGroup, cltcTunnelStatisticsGroup=cltcTunnelStatisticsGroup, cltcDot1qAllTaggedGroup=cltcDot1qAllTaggedGroup, cltcDot1qAllTaggedIfTable=cltcDot1qAllTaggedIfTable, cltcTunneledProtocolType=cltcTunneledProtocolType, cltcMIBNotificationsPrefix=cltcMIBNotificationsPrefix, cltcTunnelTotalDropStats=cltcTunnelTotalDropStats, cltcTunnelStatistics=cltcTunnelStatistics, cltcTunneledProtocol=cltcTunneledProtocol, cltcTunnelThresholdProtocolIndex=cltcTunnelThresholdProtocolIndex, cltcMIBCompliance5=cltcMIBCompliance5, cltcTunneledProtocolGroup=cltcTunneledProtocolGroup, cltcNotifsEnableGroup=cltcNotifsEnableGroup, cltcTunnelSysDropNotifEnable=cltcTunnelSysDropNotifEnable, cltcTunnelSysDropThresholdExceeded=cltcTunnelSysDropThresholdExceeded, cltcMIBCompliance=cltcMIBCompliance, cltcDot1qAllTaggedIfEntry=cltcDot1qAllTaggedIfEntry, cltcTunnelDeEncapStats=cltcTunnelDeEncapStats, cltcTunnelSysDropNotifGroup=cltcTunnelSysDropNotifGroup, cltcTunnelThreshold=cltcTunnelThreshold, cltcTunnelDropThresholdExceeded=cltcTunnelDropThresholdExceeded, cltcDot1qTunnelTable=cltcDot1qTunnelTable, cltcDot1qTunnelGroup=cltcDot1qTunnelGroup, cltcTunnelTotalDropGroup=cltcTunnelTotalDropGroup, cltcMIBObjects=cltcMIBObjects, cltcMIBCompliance3=cltcMIBCompliance3, cltcDot1qAllTagged=cltcDot1qAllTagged, cltcTunnelThresholdTable=cltcTunnelThresholdTable, cltcDot1qAllTaggedEnabled=cltcDot1qAllTaggedEnabled, cltcMIBGroups=cltcMIBGroups, cltcDot1qTunnel=cltcDot1qTunnel, PYSNMP_MODULE_ID=ciscoL2TunnelConfigMIB, cltcTunnelThresholdNotifsGroup=cltcTunnelThresholdNotifsGroup, cltcDot1qTunnelMode=cltcDot1qTunnelMode, cltcTunnelShutdownThresholdExceeded=cltcTunnelShutdownThresholdExceeded, cltcMIBNotifications=cltcMIBNotifications, cltcMIBCompliance2=cltcMIBCompliance2, cltcTunneledProtocolTable=cltcTunneledProtocolTable, cltcTunnelSysDropGroup=cltcTunnelSysDropGroup, cltcMIBCompliances=cltcMIBCompliances, cltcTunnelDropStatisticsGroup=cltcTunnelDropStatisticsGroup, cltcTunnelShutdownThreshold=cltcTunnelShutdownThreshold, cltcTunnelThresholdEntry=cltcTunnelThresholdEntry, cltcGlobal=cltcGlobal)
