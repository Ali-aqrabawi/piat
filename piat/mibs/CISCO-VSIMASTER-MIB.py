...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-VSIMASTER-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:32:55 2019
...
Bits, NotificationType, TimeTicks, iso, ObjectIdentity, Gauge32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "TimeTicks", "iso", "ObjectIdentity", "Gauge32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("CISCO-VSIMASTER-MIB", vsiControlIfIpAddress=vsiControlIfIpAddress, vsiXCControllerIndex=vsiXCControllerIndex, vsiLogicalControlIfIndex=vsiLogicalControlIfIndex, VsiLogicalIfIndex=VsiLogicalIfIndex, vsiLogicalIfAvailEgressCellRate=vsiLogicalIfAvailEgressCellRate, vsiControllerDeleted=vsiControllerDeleted, vsiBaseVersionSupported=vsiBaseVersionSupported, vsiLogicalIfMinVpi=vsiLogicalIfMinVpi, vsiXCVciHi=vsiXCVciHi, vsiSessionTable=vsiSessionTable, vsiLogicalIfVpiTranslated=vsiLogicalIfVpiTranslated, ciscoVsi2AlarmControlGroup=ciscoVsi2AlarmControlGroup, vsiSessionCmdsPending=vsiSessionCmdsPending, vsiVersionInUse=vsiVersionInUse, VsiXCIndex=VsiXCIndex, vsiLogicalIfIndex=vsiLogicalIfIndex, vsiControllerAdded=vsiControllerAdded, vsiLogicalIfRxHeaderErrors=vsiLogicalIfRxHeaderErrors, ciscoVsiMasterObjects=ciscoVsiMasterObjects, vsiVSITrapEnable=vsiVSITrapEnable, ciscoVsi2MasterGroup=ciscoVsi2MasterGroup, vsiSessionIndex=vsiSessionIndex, PYSNMP_MODULE_ID=ciscoVsiMasterMIB, vsiSessionControllerIndex=vsiSessionControllerIndex, vsiLogicalIfAdminState=vsiLogicalIfAdminState, vsiLogicalIfEndPointsInUse=vsiLogicalIfEndPointsInUse, vsiXCTable=vsiXCTable, vsiXCFailed=vsiXCFailed, ciscoVsiMasterCompliances=ciscoVsiMasterCompliances, vsiXCState=vsiXCState, vsiSessionUp=vsiSessionUp, vsiLcnExhaustionNotice=vsiLcnExhaustionNotice, vsiAvailableChnlThresholdStatus=vsiAvailableChnlThresholdStatus, vsiXCVpiHi=vsiXCVpiHi, vsiLogicalIfMaxVpi=vsiLogicalIfMaxVpi, vsiLogicalIfOperState=vsiLogicalIfOperState, vsiLogicalIfRxInvalidAddrs=vsiLogicalIfRxInvalidAddrs, vsiXCTrapEnable=vsiXCTrapEnable, vsiLogicalIfAvailEgressChnls=vsiLogicalIfAvailEgressChnls, vsiSpecifiedVersion=vsiSpecifiedVersion, vsiLogicalIfStrictSigRange=vsiLogicalIfStrictSigRange, ciscoVsiMasterMIB=ciscoVsiMasterMIB, vsiSessionActiveId=vsiSessionActiveId, vsiLogicalIfRxCells=vsiLogicalIfRxCells, vsiLogicalIfAvailIngressCellRate=vsiLogicalIfAvailIngressCellRate, vsiSessionState=vsiSessionState, vsiXCIndex=vsiXCIndex, ciscoVsiMasterGroups=ciscoVsiMasterGroups, vsiSessionTrapEnable=vsiSessionTrapEnable, vsiSessionSlaveId=vsiSessionSlaveId, vsiControllerIndex=vsiControllerIndex, ciscoVsiMasterConformance=ciscoVsiMasterConformance, vsiControllerId=vsiControllerId, vsiLogicalIfMaxEgressCellRate=vsiLogicalIfMaxEgressCellRate, vsiXCVciLow=vsiXCVciLow, vsiSessionEntry=vsiSessionEntry, vsiMasterControllerTable=vsiMasterControllerTable, vsiAvailableChnlWarnThreshold=vsiAvailableChnlWarnThreshold, vsiLogicalIfControllerIndex=vsiLogicalIfControllerIndex, vsiLogicalIfMaxIngressCellRate=vsiLogicalIfMaxIngressCellRate, vsiLogicalIfDown=vsiLogicalIfDown, vsiLogicalIfSessionIndex=vsiLogicalIfSessionIndex, vsiControllerType=vsiControllerType, vsiLogicalIfTable=vsiLogicalIfTable, vsiLogicalIfAvailIngressChnls=vsiLogicalIfAvailIngressChnls, vsiXCEntry=vsiXCEntry, vsiLogicalIfTxCells=vsiLogicalIfTxCells, vsiLogicalIfEntry=vsiLogicalIfEntry, ciscoVsiMasterModuleCompliance=ciscoVsiMasterModuleCompliance, vsiLogicalIfName=vsiLogicalIfName, vsiLogicalIfMinVci=vsiLogicalIfMinVci, vsiSessionVci=vsiSessionVci, vsiXCLogicalIfHi=vsiXCLogicalIfHi, vsiLogicalIfMaxVci=vsiLogicalIfMaxVci, vsiSessionSwitchName=vsiSessionSwitchName, vsiSessionPowerupId=vsiSessionPowerupId, vsiLogicalIfTrapEnable=vsiLogicalIfTrapEnable, ciscoVsi2MasterNotificationGroup=ciscoVsi2MasterNotificationGroup, VsiSessionIndex=VsiSessionIndex, vsiSessionWindowSize=vsiSessionWindowSize, vsiXCLogicalIfLow=vsiXCLogicalIfLow, vsiSessionVpi=vsiSessionVpi, ciscoVsiMasterNotifications=ciscoVsiMasterNotifications, vsiLogicalIfRxCellsDiscarded=vsiLogicalIfRxCellsDiscarded, vsiLogicalIfMulticastSupported=vsiLogicalIfMulticastSupported, vsiLogicalControlInterface=vsiLogicalControlInterface, vsiXCVpiLow=vsiXCVpiLow, ciscoVsiMasterGeneralGroup=ciscoVsiMasterGeneralGroup, ciscoVsi2MasterModuleCompliance=ciscoVsi2MasterModuleCompliance, vsiMasterControllerEntry=vsiMasterControllerEntry, vsiControllerTrapEnable=vsiControllerTrapEnable, vsiCrossConnects=vsiCrossConnects, vsiAvailableChnlAlarmThreshold=vsiAvailableChnlAlarmThreshold, VsiControllerIndex=VsiControllerIndex, vsiTopVersionSupported=vsiTopVersionSupported, vsiLogicalIfTxCellsDiscarded=vsiLogicalIfTxCellsDiscarded, vsiLogicalIfVcMergeSupported=vsiLogicalIfVcMergeSupported, vsiControlInterface=vsiControlInterface, vsiSessionSwitchId=vsiSessionSwitchId, vsiLogicalIfUp=vsiLogicalIfUp, vsiSessionDown=vsiSessionDown)
