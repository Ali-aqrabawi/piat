...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-PORT-STORM-CONTROL-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:36:26 2019
...
Unsigned32, Integer32, Counter32, ObjectIdentity, IpAddress, TimeTicks, ModuleIdentity, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Counter32", "ObjectIdentity", "IpAddress", "TimeTicks", "ModuleIdentity", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("CISCO-PORT-STORM-CONTROL-MIB", cpscConfigurationGroup=cpscConfigurationGroup, cpscNotificationControl=cpscNotificationControl, cpscNotificationGroup=cpscNotificationGroup, cpscNotificationThreshold=cpscNotificationThreshold, cpscStatisticsGroup=cpscStatisticsGroup, ciscoPortStormControlMIB=ciscoPortStormControlMIB, cpscConfigObjects=cpscConfigObjects, cpscStatusObjects=cpscStatusObjects, cpscHistoryStartTime=cpscHistoryStartTime, ciscoPortStormControlMIBCompliance=ciscoPortStormControlMIBCompliance, cpscTrafficType=cpscTrafficType, cpscHistoryTable=cpscHistoryTable, cpscNotificationGroupRev1=cpscNotificationGroupRev1, cpscActionTable=cpscActionTable, cpscNotificationsPrefix=cpscNotificationsPrefix, cpscUpperThreshold=cpscUpperThreshold, cpscHistoryEndTime=cpscHistoryEndTime, cpscStatusGroup=cpscStatusGroup, cpscLowerThreshold=cpscLowerThreshold, cpscThresholdTable=cpscThresholdTable, cpscHistoryGroup=cpscHistoryGroup, ciscoPortStormControlMIBCompliances=ciscoPortStormControlMIBCompliances, PYSNMP_MODULE_ID=ciscoPortStormControlMIB, ciscoPortStormControlMIBObjects=ciscoPortStormControlMIBObjects, cpscHistoryIndex=cpscHistoryIndex, cpscHistoryEntry=cpscHistoryEntry, cpscStatusEntry=cpscStatusEntry, cpscNotifConfigurationGroup=cpscNotifConfigurationGroup, ciscoPortStormControlMIBNotifs=ciscoPortStormControlMIBNotifs, cpscStatusTable=cpscStatusTable, cpscStatus=cpscStatus, cpscEventRev1=cpscEventRev1, cpscEvent=cpscEvent, cpscSuppressedPacket=cpscSuppressedPacket, CPortStormControlStatusType=CPortStormControlStatusType, CPortStormControlTrafficType=CPortStormControlTrafficType, cpscCurrentLevel=cpscCurrentLevel, cpscAction=cpscAction, cpscThresholdEntry=cpscThresholdEntry, ciscoPortStormControlMIBConform=ciscoPortStormControlMIBConform, ciscoPortStormControlMIBGroups=ciscoPortStormControlMIBGroups, ciscoPortStormControlMIBComplianceRev1=ciscoPortStormControlMIBComplianceRev1, cpscHistoryTrafficType=cpscHistoryTrafficType, CPortStormControlActionType=CPortStormControlActionType, cpscActionEntry=cpscActionEntry)
