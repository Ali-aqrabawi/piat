...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-VOICE-COMMON-DIAL-CONTROL-MIB
...
mibBuilder.exportSymbols("CISCO-VOICE-COMMON-DIAL-CONTROL-MIB", ciscoVoiceCommonDialControlMIB=ciscoVoiceCommonDialControlMIB, cvCommonDcCallActiveTable=cvCommonDcCallActiveTable, cvCommonDcCallActiveCoderTypeRate=cvCommonDcCallActiveCoderTypeRate, cvCommonDcCallHistoryVADEnable=cvCommonDcCallHistoryVADEnable, cvCommonDcMIBComplianceRev1=cvCommonDcMIBComplianceRev1, cvCommonDcCallActiveCodecBytes=cvCommonDcCallActiveCodecBytes, cvCommonDcCallHistoryCoderTypeRate=cvCommonDcCallHistoryCoderTypeRate, cvCommonDcCallHistoryTable=cvCommonDcCallHistoryTable, cvCommonDcCallHistoryCodecBytes=cvCommonDcCallHistoryCodecBytes, cvCommonDcMIBConformance=cvCommonDcMIBConformance, cvCommonDcCallHistoryEntry=cvCommonDcCallHistoryEntry, cvCommonDcMIBCompliance=cvCommonDcMIBCompliance, cvCommonDcCallGroup1=cvCommonDcCallGroup1, cvCommonDcCallHistoryInBandSignaling=cvCommonDcCallHistoryInBandSignaling, cvCommonDcCallActiveEntry=cvCommonDcCallActiveEntry, cvCommonDcMIBGroups=cvCommonDcMIBGroups, CvcCoderTypeRate=CvcCoderTypeRate, cvCommonDcMIBCompliances=cvCommonDcMIBCompliances, cvCommonDcCallActive=cvCommonDcCallActive, cvCommonDcCallActiveVADEnable=cvCommonDcCallActiveVADEnable, CvcFaxTransmitRate=CvcFaxTransmitRate, cvCommonDcCallActiveInBandSignaling=cvCommonDcCallActiveInBandSignaling, cvCommonDcCallActiveCallerIDBlock=cvCommonDcCallActiveCallerIDBlock, cvCommonDcMIBNotifications=cvCommonDcMIBNotifications, cvCommonDcCallHistoryCallingName=cvCommonDcCallHistoryCallingName, CvcInBandSignaling=CvcInBandSignaling, CvcCallReferenceIdOrZero=CvcCallReferenceIdOrZero, cvCommonDcCallActiveConnectionId=cvCommonDcCallActiveConnectionId, cvCommonDcMIBNotificationPrefix=cvCommonDcMIBNotificationPrefix, CvcSpeechCoderRate=CvcSpeechCoderRate, cvCommonDcCallHistoryCallerIDBlock=cvCommonDcCallHistoryCallerIDBlock, cvCommonDcCallActiveCallingName=cvCommonDcCallActiveCallingName, cvCommonDcCallGroup=cvCommonDcCallGroup, cvCommonDcCallHistoryConnectionId=cvCommonDcCallHistoryConnectionId, CvcVideoCoderRate=CvcVideoCoderRate, cvCommonDcMIBObjects=cvCommonDcMIBObjects, PYSNMP_MODULE_ID=ciscoVoiceCommonDialControlMIB, CvcGUid=CvcGUid, CvcH320CallType=CvcH320CallType, cvCommonDcCallHistory=cvCommonDcCallHistory)
