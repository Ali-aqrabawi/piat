...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-UNITY-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:37:16 2019
...
TimeTicks, Unsigned32, IpAddress, NotificationType, MibIdentifier, ModuleIdentity, Counter64, ObjectIdentity, Integer32, Counter32, Bits, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter64", "ObjectIdentity", "Integer32", "Counter32", "Bits", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CISCO-UNITY-MIB", ciscoUnityPorts=ciscoUnityPorts, ciscoUnityLicVMISubscribersMax=ciscoUnityLicVMISubscribersMax, ciscoUnityLicTTSSessionsMax=ciscoUnityLicTTSSessionsMax, ciscoUnityLicAMISIsLicensed=ciscoUnityLicAMISIsLicensed, ciscoUnityEventType=ciscoUnityEventType, ciscoUnityMIBNotifs=ciscoUnityMIBNotifs, ciscoUnityPortsInbound=ciscoUnityPortsInbound, ciscoUnityPortObjectId=ciscoUnityPortObjectId, ciscoUnityLicUtilVMISubs=ciscoUnityLicUtilVMISubs, ciscoUnityPortTRAPConnection=ciscoUnityPortTRAPConnection, ciscoUnityMonitoredEvent=ciscoUnityMonitoredEvent, ciscoUnityMIBCompliances=ciscoUnityMIBCompliances, ciscoUnityPortEnabled=ciscoUnityPortEnabled, ciscoUnityPortInfoGroup3=ciscoUnityPortInfoGroup3, ciscoUnityPortsInboundActive=ciscoUnityPortsInboundActive, ciscoUnityPortTable=ciscoUnityPortTable, ciscoUnityIndex=ciscoUnityIndex, ciscoUnityLicLanguagesMax=ciscoUnityLicLanguagesMax, ciscoUnityLicBridgeSessionsMax=ciscoUnityLicBridgeSessionsMax, ciscoUnityEventDescription=ciscoUnityEventDescription, ciscoUnityPortAMISDelivery=ciscoUnityPortAMISDelivery, ciscoUnityPortInfoGroup=ciscoUnityPortInfoGroup, ciscoUnityEventSource=ciscoUnityEventSource, ciscoUnityMIBGroups=ciscoUnityMIBGroups, ciscoUnityPortNumber=ciscoUnityPortNumber, CiscoUnityServerStatus=CiscoUnityServerStatus, ciscoUnityEntry=ciscoUnityEntry, ciscoUnityPortIndex=ciscoUnityPortIndex, ciscoUnityPortExtension=ciscoUnityPortExtension, ciscoUnityLicPoolingIsEnabled=ciscoUnityLicPoolingIsEnabled, ciscoUnityPortsOutboundActive=ciscoUnityPortsOutboundActive, ciscoUnityPortActivity=ciscoUnityPortActivity, ciscoUnityPortsActive=ciscoUnityPortsActive, ciscoUnityNotificationsInfoGroup=ciscoUnityNotificationsInfoGroup, ciscoUnityPortAnswerCalls=ciscoUnityPortAnswerCalls, ciscoUnityLicVPIMIsLicensed=ciscoUnityLicVPIMIsLicensed, ciscoUnityLicInfoGroup=ciscoUnityLicInfoGroup, ciscoUnityPortIntegration=ciscoUnityPortIntegration, ciscoUnityMIBComplianceRev1=ciscoUnityMIBComplianceRev1, PYSNMP_MODULE_ID=ciscoUnityMIB, ciscoUnityEventDate=ciscoUnityEventDate, ciscoUnityMIBCompliance=ciscoUnityMIBCompliance, ciscoUnityGlobalInfo=ciscoUnityGlobalInfo, ciscoUnityLicMaxMsgRecLenIsLic=ciscoUnityLicMaxMsgRecLenIsLic, ciscoUnityNotificationsGroup=ciscoUnityNotificationsGroup, ciscoUnityPortsOutbound=ciscoUnityPortsOutbound, ciscoUnityLicUtilSecondServer=ciscoUnityLicUtilSecondServer, CiscoUnityIndex=CiscoUnityIndex, ciscoUnityLicSecondServerIsLic=ciscoUnityLicSecondServerIsLic, ciscoUnityLicUtilSubs=ciscoUnityLicUtilSubs, ciscoUnityGeneralInfo=ciscoUnityGeneralInfo, ciscoUnityInfoGroup=ciscoUnityInfoGroup, ciscoUnityNotificationsInfo=ciscoUnityNotificationsInfo, ciscoUnityPortInfoGroup2=ciscoUnityPortInfoGroup2, ciscoUnityMIB=ciscoUnityMIB, ciscoUnityMIBConform=ciscoUnityMIBConform, ciscoUnityPortMessageNotif=ciscoUnityPortMessageNotif, ciscoUnityEventComputer=ciscoUnityEventComputer, ciscoUnityLicUMSubscribersMax=ciscoUnityLicUMSubscribersMax, ciscoUnityLicVoicePortsMax=ciscoUnityLicVoicePortsMax, ciscoUnityVersion=ciscoUnityVersion, ciscoUnityPortDialoutMWI=ciscoUnityPortDialoutMWI, ciscoUnityEventCategory=ciscoUnityEventCategory, ciscoUnityEventEMSNotes=ciscoUnityEventEMSNotes, ciscoUnityEventId=ciscoUnityEventId, ciscoUnityTable=ciscoUnityTable, ciscoUnityMIBObjects=ciscoUnityMIBObjects, ciscoUnityPortEntry=ciscoUnityPortEntry, ciscoUnityName=ciscoUnityName, ciscoUnityLicSubscribersMax=ciscoUnityLicSubscribersMax, ciscoUnityEventUser=ciscoUnityEventUser, ciscoUnityLicPrimaryServerIsLic=ciscoUnityLicPrimaryServerIsLic, ciscoUnityServerState=ciscoUnityServerState)
