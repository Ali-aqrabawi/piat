...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ENHANCED-IPSEC-FLOW-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:36:32 2019
...
CIPsecAuthAlgorithm, CIPsecPhase2TunnelIndex, CIPsecProtocol, CIPsecTunnelStatus, CIPsecEncryptAlgorithm, CIPsecDiffHellmanGrp, CIPsecEndPtType, CIPsecControlProtocol, CIPsecEncapMode, CIPsecEncryptionKeySize, CIPsecSpi, CIPsecCompAlgorithm, CIPsecPhase2SaDirection, CIPsecNATTraversalMode, CIPsecPhase1TunnelIndexOrZero, CIPsecPmtu = mibBuilder.importSymbols("CISCO-IPSEC-TC", "CIPsecAuthAlgorithm", "CIPsecPhase2TunnelIndex", "CIPsecProtocol", "CIPsecTunnelStatus", "CIPsecEncryptAlgorithm", "CIPsecDiffHellmanGrp", "CIPsecEndPtType", "CIPsecControlProtocol", "CIPsecEncapMode", "CIPsecEncryptionKeySize", "CIPsecSpi", "CIPsecCompAlgorithm", "CIPsecPhase2SaDirection", "CIPsecNATTraversalMode", "CIPsecPhase1TunnelIndexOrZero", "CIPsecPmtu")
...
Counter32, NotificationType, ObjectIdentity, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, iso, Integer32, IpAddress, Unsigned32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "iso", "Integer32", "IpAddress", "Unsigned32", "Counter64", "ModuleIdentity")
TruthValue, TextualConvention, TimeInterval, DateAndTime, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "TimeInterval", "DateAndTime", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("CISCO-ENHANCED-IPSEC-FLOW-MIB", ceipSecTunnelTable=ceipSecTunnelTable, ceipSecTunOutEncryptFails=ceipSecTunOutEncryptFails, ceipSecGlobalOutCompFailPkts=ceipSecGlobalOutCompFailPkts, ceipSecTunOutCompTooSmallPkts=ceipSecTunOutCompTooSmallPkts, ceipSecTunOutOctets=ceipSecTunOutOctets, ceipSecEndPtRemoteProtocol=ceipSecEndPtRemoteProtocol, ceipSecTunSaOutCompFailPkts=ceipSecTunSaOutCompFailPkts, ceipSecTunOutSaAhAuthAlgo=ceipSecTunOutSaAhAuthAlgo, ceipSecTunInDecompOctets=ceipSecTunInDecompOctets, ceipSecGlobalInPkts=ceipSecGlobalInPkts, ceipSecGlobalOutCompSkippedPkts=ceipSecGlobalOutCompSkippedPkts, ceipSecTunSaInReplayDropPkts=ceipSecTunSaInReplayDropPkts, ceipSecFailTime=ceipSecFailTime, ceipSecTunStatus=ceipSecTunStatus, ceipSecGlobalStats=ceipSecGlobalStats, ciscoEnhIPsecFlowNotifGroup=ciscoEnhIPsecFlowNotifGroup, ciscoEnhIPsecFlowNotifCntlGroup=ciscoEnhIPsecFlowNotifCntlGroup, ceipSecTunOutCompSkippedPkts=ceipSecTunOutCompSkippedPkts, ceipSecGlobalActiveTunnels=ceipSecGlobalActiveTunnels, ceipSecTunHistOutSaDHGrp=ceipSecTunHistOutSaDHGrp, ceipSecTunHistRemoteAddressType=ceipSecTunHistRemoteAddressType, ceipSecTunHistInPkts=ceipSecTunHistInPkts, ceipSecTunnelSaEntry=ceipSecTunnelSaEntry, ceipSecTunSaDirection=ceipSecTunSaDirection, ceipSecCertSerialNumber=ceipSecCertSerialNumber, ceipSecFailGlobal=ceipSecFailGlobal, ceipSecNotifCntlIpSecTunnelStop=ceipSecNotifCntlIpSecTunnelStop, ceipSecEndPtLocalAddrType1=ceipSecEndPtLocalAddrType1, ceipSecNotifCntlIpSecSysFailure=ceipSecNotifCntlIpSecSysFailure, ceipSecTunHistOutEncryptFails=ceipSecTunHistOutEncryptFails, ceipSecTunHistInSaAhAuthAlgo=ceipSecTunHistInSaAhAuthAlgo, ceipSecTunOutCompFailPkts=ceipSecTunOutCompFailPkts, ceipSecSaTable=ceipSecSaTable, ceipSecEndPtLocalAddr1=ceipSecEndPtLocalAddr1, ceipSecNotifCntlCertExpiry=ceipSecNotifCntlCertExpiry, ceipSecTunOutSaDHGrp=ceipSecTunOutSaDHGrp, ceipSecTunHistOutSaEncryptAlgo=ceipSecTunHistOutSaEncryptAlgo, ceipSecTunOutPkts=ceipSecTunOutPkts, ciscoEnhIPsecFlowCertObjectGroup=ciscoEnhIPsecFlowCertObjectGroup, ceipSecEndPtHistTunIndex=ceipSecEndPtHistTunIndex, ceipSecHistGlobal=ceipSecHistGlobal, ciscoEnhIPsecFlowMIBCompliance=ciscoEnhIPsecFlowMIBCompliance, ceipSecTunHistActiveIndex=ceipSecTunHistActiveIndex, ceipSecTunHistLocalAddress=ceipSecTunHistLocalAddress, ceipSecTunOutAuths=ceipSecTunOutAuths, ciscoEnhIPsecFlowMIBCompliances=ciscoEnhIPsecFlowMIBCompliances, ceipSecNotifCntlCertRenewal=ceipSecNotifCntlCertRenewal, ceipSecEndPtHistLocalAddr2=ceipSecEndPtHistLocalAddr2, ceipSecCertIssuerName=ceipSecCertIssuerName, ciscoEnhIpsecFlowCertRenewal=ciscoEnhIpsecFlowCertRenewal, ceipSecTunHistLocalAddressType=ceipSecTunHistLocalAddressType, ceipSecHistTableSize=ceipSecHistTableSize, ceipSecTunHistInSaEncryptKeySize=ceipSecTunHistInSaEncryptKeySize, ceipSecTunSaInAuthFails=ceipSecTunSaInAuthFails, ceipSecTunHistOutAuths=ceipSecTunHistOutAuths, ceipSecGlobalNoSaFails=ceipSecGlobalNoSaFails, ciscoEnhIPsecFlowHistoryGroup=ciscoEnhIPsecFlowHistoryGroup, ceipSecTunHistTotalRefreshes=ceipSecTunHistTotalRefreshes, ceipSecTunSaOutEncryptFails=ceipSecTunSaOutEncryptFails, ceipSecTunControlProtocol=ceipSecTunControlProtocol, ceipSecEndPtIndex=ceipSecEndPtIndex, ceipSecGlobalPeakThroughputDateAndTime=ceipSecGlobalPeakThroughputDateAndTime, ceipSecEndPtEntry=ceipSecEndPtEntry, ceipSecTunOutEncrypts=ceipSecTunOutEncrypts, ceipSecSaValue=ceipSecSaValue, ceipSecEndPtHistTable=ceipSecEndPtHistTable, ceipSecEndPtHistLocalType=ceipSecEndPtHistLocalType, ceipSecEndPtLocalName=ceipSecEndPtLocalName, ceipSecTunHistOutCompressedPkts=ceipSecTunHistOutCompressedPkts, ceipSecNotificationCntl=ceipSecNotificationCntl, ceipSecGlobalPeakAvgPacketSize=ceipSecGlobalPeakAvgPacketSize, ceipSecTunSaLifeTimeThreshold=ceipSecTunSaLifeTimeThreshold, ceipSecTunHistOutDropPkts=ceipSecTunHistOutDropPkts, ceipSecGlobalOutCompTooSmallPkts=ceipSecGlobalOutCompTooSmallPkts, ceipSecTunOutAuthFails=ceipSecTunOutAuthFails, ceipSecNotifCntlIpSecBadSa=ceipSecNotifCntlIpSecBadSa, ceipSecEndPtHistRemoteAddr1=ceipSecEndPtHistRemoteAddr1, ceipSecTunPmtu=ceipSecTunPmtu, ceipSecGlobalOutOctets=ceipSecGlobalOutOctets, ceipSecEndPtRemoteAddrType1=ceipSecEndPtRemoteAddrType1, ceipSecGlobalLastAveragePacketSize=ceipSecGlobalLastAveragePacketSize, ceipSecTunRemoteAddress=ceipSecTunRemoteAddress, ceipSecTunSaOutAuthFails=ceipSecTunSaOutAuthFails, ceipSecTunOutUncompOctets=ceipSecTunOutUncompOctets, ceipSecFailPktDstAddressType=ceipSecFailPktDstAddressType, ceipSecTunSaOutCompressedPkts=ceipSecTunSaOutCompressedPkts, ceipSecFailPktDstAddress=ceipSecFailPktDstAddress, ciscoEnhIPsecFlowNotifCntlGroupSup01=ciscoEnhIPsecFlowNotifCntlGroupSup01, ceipSecTunHistOutEncrypts=ceipSecTunHistOutEncrypts, ceipSecTunIndex=ceipSecTunIndex, ceipSecEndPtHistLocalProtocol=ceipSecEndPtHistLocalProtocol, ceipSecNotiCntlIpSecAllNotifs=ceipSecNotiCntlIpSecAllNotifs, ceipSecTunHistOutSaCompAlgo=ceipSecTunHistOutSaCompAlgo, ceipSecGlobalLastThroughputInKpps=ceipSecGlobalLastThroughputInKpps, ceipSecCertExpiryTime=ceipSecCertExpiryTime, ceipSecTunSaOutPkts=ceipSecTunSaOutPkts, ceipSecTunHistIndex=ceipSecTunHistIndex, ceipSecTunInOctets=ceipSecTunInOctets, ceipSecTunSaOutCompSkippedPkts=ceipSecTunSaOutCompSkippedPkts, ceipSecEndPtHistLocalAddr1=ceipSecEndPtHistLocalAddr1, ciscoEnhIPsecFlowActivityGroup=ciscoEnhIPsecFlowActivityGroup, ceipSecTunExpiredSaInstances=ceipSecTunExpiredSaInstances, ceipSecTunHistInDecrypts=ceipSecTunHistInDecrypts, ceipSecTunHistInAuthFails=ceipSecTunHistInAuthFails, ceipSecEndPtHistRemoteAddrType1=ceipSecEndPtHistRemoteAddrType1, ceipSecGlobalInReplayDrops=ceipSecGlobalInReplayDrops, ceipSecGlobalInDecryptFails=ceipSecGlobalInDecryptFails, ceipSecGlobalOutDrops=ceipSecGlobalOutDrops, ceipSecTunSaValue=ceipSecTunSaValue, ciscoEnhIpsecFlowSysFailure=ciscoEnhIpsecFlowSysFailure, ceipSecGlobalOutUncompOctets=ceipSecGlobalOutUncompOctets, ceipSecGlobalOutEncrypts=ceipSecGlobalOutEncrypts, ceipSecTunSaOutAuths=ceipSecTunSaOutAuths, ceipSecTunHistTermReason=ceipSecTunHistTermReason, ceipSecTunHistLifeSize=ceipSecTunHistLifeSize, ceipSecIfTunnelStatus=ceipSecIfTunnelStatus, ceipSecTunHistInSaDecompAlgo=ceipSecTunHistInSaDecompAlgo, ceipSecTunHistOutSaEspAuthAlgo=ceipSecTunHistOutSaEspAuthAlgo, ceipSecGlobalProtocolUseFails=ceipSecGlobalProtocolUseFails, ceipSecTunnelSaTable=ceipSecTunnelSaTable, ceipSecTunSaOutDropPkts=ceipSecTunSaOutDropPkts, ceipSecTunHistStartTime=ceipSecTunHistStartTime, ceipSecEndPtHistActiveIndex=ceipSecEndPtHistActiveIndex, ceipSecFailEntry=ceipSecFailEntry, ceipSecEndPtLocalProtocol=ceipSecEndPtLocalProtocol, ceipSecEndPtHistRemoteName=ceipSecEndPtHistRemoteName, ceipSecTunHistOutAuthFails=ceipSecTunHistOutAuthFails, ceipSecFailGlobalCntl=ceipSecFailGlobalCntl, ceipSecEndPtHistRemoteAddr2=ceipSecEndPtHistRemoteAddr2, ceipSecFailReason=ceipSecFailReason, ceipSecTunHistInDropPkts=ceipSecTunHistInDropPkts, ceipSecEndPtHistLocalPort=ceipSecEndPtHistLocalPort, ceipSecTunOutSaEspAuthAlgo=ceipSecTunOutSaEspAuthAlgo, ciscoEnhIPsecFlowFailureGroup=ciscoEnhIPsecFlowFailureGroup, ceipSecFailures=ceipSecFailures, ceipSecTunNATTraversalMode=ceipSecTunNATTraversalMode, ceipSecIfIndex=ceipSecIfIndex, ceipSecTunInDropPkts=ceipSecTunInDropPkts, ceipSecSaProtocol=ceipSecSaProtocol, ceipSecTunSaIndex=ceipSecTunSaIndex, ceipSecTunOutDropPkts=ceipSecTunOutDropPkts, ceipSecGlobalSysCapFails=ceipSecGlobalSysCapFails, ceipSecTunSaOutCompTooSmallPkts=ceipSecTunSaOutCompTooSmallPkts, ceipSecHistGlobalCntl=ceipSecHistGlobalCntl, ceipSecTunHistInDecompOctets=ceipSecTunHistInDecompOctets, ceipSecTunHistInAuths=ceipSecTunHistInAuths, ceipSecGlobalOutCompressedPkts=ceipSecGlobalOutCompressedPkts, ceipSecTunOutSaEncryptAlgo=ceipSecTunOutSaEncryptAlgo, ceipSecEndPtLocalPort=ceipSecEndPtLocalPort, ceipSecTunHistOutUncompOctets=ceipSecTunHistOutUncompOctets, ceipSecTunEncapMode=ceipSecTunEncapMode, ceipSecTunHistInOctets=ceipSecTunHistInOctets, ceipSecFailTable=ceipSecFailTable, ceipSecGlobalLastThroughputInMbps=ceipSecGlobalLastThroughputInMbps, ceipSecGlobalPreviousTunnels=ceipSecGlobalPreviousTunnels, ceipSecGlobalOutPkts=ceipSecGlobalOutPkts, ceipSecTunLifeSize=ceipSecTunLifeSize, ceipSecEndPtHistRemoteProtocol=ceipSecEndPtHistRemoteProtocol, ceipSecTunSaInDecrypts=ceipSecTunSaInDecrypts, ceipSecTunControlTunnelAlive=ceipSecTunControlTunnelAlive, ceipSecTunSaOutUncompOctets=ceipSecTunSaOutUncompOctets, ceipSecTunActiveTime=ceipSecTunActiveTime, ceipSecTunSaInDropPkts=ceipSecTunSaInDropPkts, ceipSecEndPtRemotePort=ceipSecEndPtRemotePort, ciscoEnhancedIpsecFlowMIBObjects=ciscoEnhancedIpsecFlowMIBObjects, ceipSecFailPktSrcAddressType=ceipSecFailPktSrcAddressType, ceipSecEndPtHistLocalAddrType2=ceipSecEndPtHistLocalAddrType2, ceipSecFailIndex=ceipSecFailIndex, ceipSecEndPtRemoteType=ceipSecEndPtRemoteType, ciscoEnhIPsecFlowPerformanceThroughputGroup=ciscoEnhIPsecFlowPerformanceThroughputGroup, ceipSecGlobalOutAuths=ceipSecGlobalOutAuths, ceipSecTunHistInReplayDropPkts=ceipSecTunHistInReplayDropPkts, ciscoEnhancedIpsecFlowMIBNotifs=ciscoEnhancedIpsecFlowMIBNotifs, ceipSecTunHistOutPkts=ceipSecTunHistOutPkts, ciscoEnhIPsecFlowMIBComplianceRev1=ciscoEnhIPsecFlowMIBComplianceRev1, ceipSecTunHistLifeTime=ceipSecTunHistLifeTime, ceipSecTunInSaDHGrp=ceipSecTunInSaDHGrp, ciscoEnhIPsecFlowMIBComplianceRev2=ciscoEnhIPsecFlowMIBComplianceRev2, ceipSecEndPtHistRemoteType=ceipSecEndPtHistRemoteType, ceipSecTunHistControlTunnelIndex=ceipSecTunHistControlTunnelIndex, ceipSecTunHistOutCompSkippedPkts=ceipSecTunHistOutCompSkippedPkts, ceipSecNotifCntlIpSecSetUpFail=ceipSecNotifCntlIpSecSetUpFail, ceipSecEndPtRemoteAddr1=ceipSecEndPtRemoteAddr1, ceipSecTunHistEncapMode=ceipSecTunHistEncapMode, ciscoEnhancedIpsecFlowMIBConform=ciscoEnhancedIpsecFlowMIBConform, ceipSecTunHistOutCompSmallPkts=ceipSecTunHistOutCompSmallPkts, ceipSecTunSaInOctets=ceipSecTunSaInOctets, ceipSecTunInDecryptFails=ceipSecTunInDecryptFails, ceipSecTunLocalAddress=ceipSecTunLocalAddress, ceipSecTunControlTunnelIndex=ceipSecTunControlTunnelIndex, ceipSecEndPtLocalAddr2=ceipSecEndPtLocalAddr2, ceipSecCertSubjectName=ceipSecCertSubjectName, ceipSecEndPtHistEntry=ceipSecEndPtHistEntry, ceipSecCertNotification=ceipSecCertNotification, ciscoEnhancedIpsecFlowMIB=ciscoEnhancedIpsecFlowMIB, ciscoEnhIpsecFlowTunnelStart=ciscoEnhIpsecFlowTunnelStart, PYSNMP_MODULE_ID=ciscoEnhancedIpsecFlowMIB, ceipSecEndPtHistRemoteAddrType2=ceipSecEndPtHistRemoteAddrType2, ciscoEnhIPsecFlowTunnelSaGroup=ciscoEnhIPsecFlowTunnelSaGroup, ceipSecTunCurrentSaInstances=ceipSecTunCurrentSaInstances, ceipSecSaStatus=ceipSecSaStatus, ceipSecGlobalPeakThroughputInMbps=ceipSecGlobalPeakThroughputInMbps, ceipSecTunInDecrypts=ceipSecTunInDecrypts, ceipSecIfTunnelTable=ceipSecIfTunnelTable, ceipSecFailTableSize=ceipSecFailTableSize, ceipSecGlobalInOctets=ceipSecGlobalInOctets, ceipSecGlobalInDecompOctets=ceipSecGlobalInDecompOctets, ceipSecTunTotalRefreshes=ceipSecTunTotalRefreshes, ceipSecCertExpiryStatus=ceipSecCertExpiryStatus, ceipSecTunSaInDecryptFails=ceipSecTunSaInDecryptFails, ceipSecTunHistActiveTime=ceipSecTunHistActiveTime, ceipSecGlobalPeakThroughputUtilization=ceipSecGlobalPeakThroughputUtilization, ceipSecTunnelHistEntry=ceipSecTunnelHistEntry, ceipSecTunHistInSaEncryptAlgo=ceipSecTunHistInSaEncryptAlgo, ceipSecTunHistInSaEspAuthAlgo=ceipSecTunHistInSaEspAuthAlgo, ceipSecFailPktSrcAddress=ceipSecFailPktSrcAddress, ceipSecGlobalInAuths=ceipSecGlobalInAuths, ceipSecEndPtRemoteName=ceipSecEndPtRemoteName, ceipSecTunSaLifeSizeThreshold=ceipSecTunSaLifeSizeThreshold, ciscoIPsecFlowMIBGroups=ciscoIPsecFlowMIBGroups, ceipSecSaEntry=ceipSecSaEntry, ceipSecTunSaStatus=ceipSecTunSaStatus, ceipSecTunSaOutEncrypts=ceipSecTunSaOutEncrypts, ceipSecPhaseTwo=ceipSecPhaseTwo, ceipSecTunnelEntry=ceipSecTunnelEntry, ceipSecTunRemoteAddressType=ceipSecTunRemoteAddressType, ceipSecTunInSaEncryptAlgo=ceipSecTunInSaEncryptAlgo, ceipSecTunSaInDecompOctets=ceipSecTunSaInDecompOctets, ceipSecEndPtHistRemotePort=ceipSecEndPtHistRemotePort, ceipSecTunHistOutOctets=ceipSecTunHistOutOctets, ciscoEnhIpsecFlowSetupFail=ciscoEnhIpsecFlowSetupFail, ceipSecTunInSaDecompAlgo=ceipSecTunInSaDecompAlgo, ceipSecEndPtLocalType=ceipSecEndPtLocalType, ceipSecTunHistOutSaEncryptKeySz=ceipSecTunHistOutSaEncryptKeySz, ceipSecTunHistInSaDHGrp=ceipSecTunHistInSaDHGrp, ceipSecEndPtLocalAddrType2=ceipSecEndPtLocalAddrType2, ceipSecGlobalThroughputLastUpdatedTime=ceipSecGlobalThroughputLastUpdatedTime, ceipSecEndPtHistLocalName=ceipSecEndPtHistLocalName, ceipSecEndPtHistLocalAddrType1=ceipSecEndPtHistLocalAddrType1, ceipSecNotifCntlIpSecTunnelStart=ceipSecNotifCntlIpSecTunnelStart, ceipSecGlobalInAuthFails=ceipSecGlobalInAuthFails, ceipSecGlobalInDrops=ceipSecGlobalInDrops, ceipSecCertRenewalStatus=ceipSecCertRenewalStatus, ceipSecGlobalThroughputUtilizatioinTimeInterval=ceipSecGlobalThroughputUtilizatioinTimeInterval, ceipSecTunHistInDecryptFails=ceipSecTunHistInDecryptFails, ceipSecTunLocalAddressType=ceipSecTunLocalAddressType, ceipSecTunnelHistTable=ceipSecTunnelHistTable, ceipSecTunInReplayDropPkts=ceipSecTunInReplayDropPkts, ceipSecTunSaInPkts=ceipSecTunSaInPkts, ciscoEnhIPsecFlowCoreHistGroup=ciscoEnhIPsecFlowCoreHistGroup, ceipSecFailSaSpi=ceipSecFailSaSpi, ceipSecTunInAuthFails=ceipSecTunInAuthFails, ceipSecEndPtTable=ceipSecEndPtTable, ciscoEnhIpsecFlowCertExpiry=ciscoEnhIpsecFlowCertExpiry)
mibBuilder.exportSymbols("CISCO-ENHANCED-IPSEC-FLOW-MIB", ceipSecTunInSaEspAuthAlgo=ceipSecTunInSaEspAuthAlgo, ceipSecGlobalOutEncryptFails=ceipSecGlobalOutEncryptFails, ceipSecTunInPkts=ceipSecTunInPkts, ceipSecTunHistNATTraversalMode=ceipSecTunHistNATTraversalMode, ceipSecTunHistRemoteAddress=ceipSecTunHistRemoteAddress, ceipSecTunHistOutCompFailPkts=ceipSecTunHistOutCompFailPkts, ceipSecEndPtRemoteAddr2=ceipSecEndPtRemoteAddr2, ciscoEnhIpsecFlowBadSa=ciscoEnhIpsecFlowBadSa, ceipSecTunLifeTime=ceipSecTunLifeTime, ceipSecTunSaIfIndex=ceipSecTunSaIfIndex, ceipSecTunOutSaEncryptKeySize=ceipSecTunOutSaEncryptKeySize, ceipSecTunInAuths=ceipSecTunInAuths, ceipSecGlobalInDecrypts=ceipSecGlobalInDecrypts, ceipSecHistory=ceipSecHistory, ceipSecTunHistControlProtocol=ceipSecTunHistControlProtocol, ceipSecFailTunnelIndex=ceipSecFailTunnelIndex, ciscoEnhIPsecFlowCoreFailGroup=ciscoEnhIPsecFlowCoreFailGroup, ceipSecGlobalLastThroughputUtilization=ceipSecGlobalLastThroughputUtilization, ceipSecEndPtHistIndex=ceipSecEndPtHistIndex, ceipSecTunInSaEncryptKeySize=ceipSecTunInSaEncryptKeySize, ceipSecTunInSaAhAuthAlgo=ceipSecTunInSaAhAuthAlgo, ceipSecTunHistTotalSas=ceipSecTunHistTotalSas, ceipSecTunOutCompressedPkts=ceipSecTunOutCompressedPkts, ceipSecTunHistPmtu=ceipSecTunHistPmtu, ceipSecSaIndex=ceipSecSaIndex, ceipSecTunSaOutOctets=ceipSecTunSaOutOctets, ceipSecIfTunnelEntry=ceipSecIfTunnelEntry, ceipSecTunOutSaCompAlgo=ceipSecTunOutSaCompAlgo, ceipSecTunHistOutSaAhAuthAlgo=ceipSecTunHistOutSaAhAuthAlgo, ceipSecSaDirection=ceipSecSaDirection, ciscoEnhIpsecFlowTunnelStop=ciscoEnhIpsecFlowTunnelStop, ciscoEnhIPsecFlowNotifGroupSup01=ciscoEnhIPsecFlowNotifGroupSup01, ceipSecGlobalOutAuthFails=ceipSecGlobalOutAuthFails, ceipSecTunSaInAuths=ceipSecTunSaInAuths, ceipSecEndPtRemoteAddrType2=ceipSecEndPtRemoteAddrType2, ceipSecTunSaProtocol=ceipSecTunSaProtocol)
