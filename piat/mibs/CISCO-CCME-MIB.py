...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CCME-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:34:32 2019
...
ObjectIdentity, Bits, Unsigned32, Integer32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, TimeTicks, MibIdentifier, Counter32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Unsigned32", "Integer32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "TimeTicks", "MibIdentifier", "Counter32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("CISCO-CCME-MIB", ccmeActiveStatsGroup=ccmeActiveStatsGroup, ccmeEphoneKeepAliveCnt=ccmeEphoneKeepAliveCnt, ciscoCcmeMIBComplianceRev2=ciscoCcmeMIBComplianceRev2, ciscoCcmeMIBObjects=ciscoCcmeMIBObjects, ccmeActiveStats=ccmeActiveStats, ccmeTimeFormat=ccmeTimeFormat, ccmeMohFlashFile=ccmeMohFlashFile, ccmeEphoneDnConfigEntry=ccmeEphoneDnConfigEntry, ccmEMUserProfileDirNumIndex=ccmEMUserProfileDirNumIndex, ccmeEphoneDnDStatus=ccmeEphoneDnDStatus, ccmeEphoneDebugStatus=ccmeEphoneDebugStatus, ccmeEphoneDnChDiscAtRing=ccmeEphoneDnChDiscAtRing, ccmeNightServiceDayEntry=ccmeNightServiceDayEntry, ccmeEphoneButtonNumber=ccmeEphoneButtonNumber, ccmeEphoneDnSecPref=ccmeEphoneDnSecPref, CcmeNightServiceCodeString=CcmeNightServiceCodeString, ccmeNightServiceChangeNotif=ccmeNightServiceChangeNotif, ccmeNightServiceDayStopHour=ccmeNightServiceDayStopHour, ccmeTransferPatternTable=ccmeTransferPatternTable, ccmeEphoneKeyPhone=ccmeEphoneKeyPhone, ccmeEphoneSpeedDialConfEntry=ccmeEphoneSpeedDialConfEntry, ccmeEphoneFastDialConfEntry=ccmeEphoneFastDialConfEntry, ccmeEphoneMediaCapability=ccmeEphoneMediaCapability, ccmeEphoneCallLegs=ccmeEphoneCallLegs, ccmeNightServiceDayTable=ccmeNightServiceDayTable, ccmeCorTableIndex=ccmeCorTableIndex, ccmeCorScope=ccmeCorScope, ccmeEphoneActTable=ccmeEphoneActTable, ccmeEphoneDnSecNum=ccmeEphoneDnSecNum, ccmeEphoneDnCFNoAnNum=ccmeEphoneDnCFNoAnNum, ccmeEphonePrimaryDn=ccmeEphonePrimaryDn, ccmeEphoneSpeedDialLabel=ccmeEphoneSpeedDialLabel, ccmeUserLoginDeactivateTime=ccmeUserLoginDeactivateTime, ccmeMIBNotifications=ccmeMIBNotifications, ccmePhoneFirmwareTable=ccmePhoneFirmwareTable, ccmeEphoneDnType=ccmeEphoneDnType, ccmeEphoneRegTime=ccmeEphoneRegTime, ccmeEphoneIpAddressType=ccmeEphoneIpAddressType, ccmeVersion=ccmeVersion, ccmeEphoneTrapReason=ccmeEphoneTrapReason, ccmeEphoneUsername=ccmeEphoneUsername, ccmeMwiSipServerPortNumber=ccmeMwiSipServerPortNumber, ccmeSecondaryDialTonePrefix=ccmeSecondaryDialTonePrefix, ccmeFXOHookFlashEnabled=ccmeFXOHookFlashEnabled, ccmeIPAddress=ccmeIPAddress, ccmeMaxRedirect=ccmeMaxRedirect, ccmeEphoneAftHrsBlkExmptEnabled=ccmeEphoneAftHrsBlkExmptEnabled, ccmeEphoneDnChNum=ccmeEphoneDnChNum, ccmeEMUserDirNumOverlay=ccmeEMUserDirNumOverlay, ccmeTransferPatternEntry=ccmeTransferPatternEntry, ccmeEphoneLoginStatus=ccmeEphoneLoginStatus, ccmeMohMulticastRoute=ccmeMohMulticastRoute, ccmeCorVoiceRegPoolNumber=ccmeCorVoiceRegPoolNumber, ccmeMohFlashMulticastPortNum=ccmeMohFlashMulticastPortNum, ciscoCcmeMIBNotifs=ciscoCcmeMIBNotifs, ccmeIPAddressType=ccmeIPAddressType, ccmeDialplanPatternTag=ccmeDialplanPatternTag, ccmeDialplanPattern=ccmeDialplanPattern, ccmeAfterHrsBlockDayTable=ccmeAfterHrsBlockDayTable, ccmeEphoneOverlayDN=ccmeEphoneOverlayDN, ccmeNightServiceEnabled=ccmeNightServiceEnabled, ccmeAfterHrsBlockDateTable=ccmeAfterHrsBlockDateTable, ccmeEphoneDnChDiscAtConn=ccmeEphoneDnChDiscAtConn, ccmeKeyEphoneRegChangeNotif=ccmeKeyEphoneRegChangeNotif, ccmeNightServiceDateStopMin=ccmeNightServiceDateStopMin, ccmeEphoneDnChStatsHistoryEntry=ccmeEphoneDnChStatsHistoryEntry, ccmeTransferPatternIndex=ccmeTransferPatternIndex, ciscoCcmeMIB=ciscoCcmeMIB, ccmeDialplanPatternTable=ccmeDialplanPatternTable, ccmeAfterHrsBlockDateStartMin=ccmeAfterHrsBlockDateStartMin, ccmeDialplanExtLength=ccmeDialplanExtLength, ccmeEphoneDnPriPref=ccmeEphoneDnPriPref, ccmeEphoneDnCFBusyNum=ccmeEphoneDnCFBusyNum, ccmeWebAdminSystemUser=ccmeWebAdminSystemUser, PYSNMP_MODULE_ID=ciscoCcmeMIB, ccmeEphoneDnMode=ccmeEphoneDnMode, ccmeDialplanExtPattern=ccmeDialplanExtPattern, ccmeAlertTimeout=ccmeAlertTimeout, ccmeEphoneAutoLineInEnabled=ccmeEphoneAutoLineInEnabled, ccmeVoiceMailNumber=ccmeVoiceMailNumber, ccmeEphoneAutoLineOut=ccmeEphoneAutoLineOut, ccmeEphoneActEntry=ccmeEphoneActEntry, ccmeLoopbackDnCodec=ccmeLoopbackDnCodec, ccmeMwiSipServerTransportType=ccmeMwiSipServerTransportType, ccmeEMphoneTotRegistered=ccmeEMphoneTotRegistered, ccmeAfterHrsBlockDayStartHour=ccmeAfterHrsBlockDayStartHour, ccmeCorConfTable=ccmeCorConfTable, ccmeEMUserDirNumTag=ccmeEMUserDirNumTag, ccmeIntercomDnConfEntry=ccmeIntercomDnConfEntry, ccmeUserAutoLogoutTo=ccmeUserAutoLogoutTo, ccmeConfig=ccmeConfig, ccmeIntercomDnLabel=ccmeIntercomDnLabel, ccmeEphoneDnMwiSipSubscrEnabled=ccmeEphoneDnMwiSipSubscrEnabled, ccmeEphoneDnChIncoming=ccmeEphoneDnChIncoming, ccmeConfigGroup1=ccmeConfigGroup1, ccmeEphoneRemote=ccmeEphoneRemote, ccmeEphoneTot=ccmeEphoneTot, ccmeEphoneDnChDiscCauseFarEnd=ccmeEphoneDnChDiscCauseFarEnd, ccmeCorListDefaultEnabled=ccmeCorListDefaultEnabled, ccmeEphoneLoginFailed=ccmeEphoneLoginFailed, ccmeAfterHrsBlockDate=ccmeAfterHrsBlockDate, ccmeAfterHrsBlockDateIndex=ccmeAfterHrsBlockDateIndex, ccmeNightServiceDateIndex=ccmeNightServiceDateIndex, ccmeNightServiceDateStopHour=ccmeNightServiceDateStopHour, ccmeWebAdminCustomerUser=ccmeWebAdminCustomerUser, ccmeEnabled=ccmeEnabled, ccmeNightServiceDay=ccmeNightServiceDay, ccmeNightServiceDayStartHour=ccmeNightServiceDayStartHour, ccmeUrlforDirectoriesBtn=ccmeUrlforDirectoriesBtn, ccmeNightServiceDayIndex=ccmeNightServiceDayIndex, ccmeEMLogoutDirNumTag=ccmeEMLogoutDirNumTag, ccmeEphoneFastDialTableIndex=ccmeEphoneFastDialTableIndex, ccmeLoopbackDnTag=ccmeLoopbackDnTag, ccmeEphonePagingDn=ccmeEphonePagingDn, ccmeMohFlashMulticastIPAddrType=ccmeMohFlashMulticastIPAddrType, ccmeAfterHrsBlockDateEntry=ccmeAfterHrsBlockDateEntry, ccmeNightServiceDayStopMin=ccmeNightServiceDayStopMin, ccmeEphoneDnHoldAltTo=ccmeEphoneDnHoldAltTo, ccmeEMphoneTot=ccmeEMphoneTot, ccmeLoopbackDnRetryTo=ccmeLoopbackDnRetryTo, ccmeEphoneDnChDiscCauseNearEnd=ccmeEphoneDnChDiscCauseNearEnd, ccmeIntercomDnAutoAnsEnabled=ccmeIntercomDnAutoAnsEnabled, ccmeWebGUIEditEnabled=ccmeWebGUIEditEnabled, ccmeDialplanAllowRegiEnabled=ccmeDialplanAllowRegiEnabled, ccmeEMLogOutProfileTag=ccmeEMLogOutProfileTag, ccmeAfterHrsBlockDateMonth=ccmeAfterHrsBlockDateMonth, ccmeEMLogoutDirNumConfEntry=ccmeEMLogoutDirNumConfEntry, ccmeAfterHrsBlockPatternTag=ccmeAfterHrsBlockPatternTag, ccmeCorConfEntry=ccmeCorConfEntry, ccmeMohMulticastIpAddress=ccmeMohMulticastIpAddress, ccmeEphonePreviousFirmwareRev=ccmeEphonePreviousFirmwareRev, ccmeEphoneCurrentFirmwareRev=ccmeEphoneCurrentFirmwareRev, ccmeEphoneMediaActive=ccmeEphoneMediaActive, ccmeEphoneTotRegistered=ccmeEphoneTotRegistered, ccmeEphoneUnRegThreshold=ccmeEphoneUnRegThreshold, ccmeLoopbackDnConfTable=ccmeLoopbackDnConfTable, ciscoCcmeMIBCompliances=ciscoCcmeMIBCompliances, ccmeEphoneDnChDiscAtAlert=ccmeEphoneDnChDiscAtAlert, ciscoCcmeMIBComplianceRev1=ciscoCcmeMIBComplianceRev1, ccmeEphoneDnChStatsHistoryTable=ccmeEphoneDnChStatsHistoryTable, ccmeSysTrapSeverity=ccmeSysTrapSeverity, ccmeInterDigitTimeout=ccmeInterDigitTimeout, ccmeConfigGroup=ccmeConfigGroup, ccmeDialplanPatternIndex=ccmeDialplanPatternIndex, ccmeEPhoneRegFailed=ccmeEPhoneRegFailed, ccmeEphoneSpeedDialNumber=ccmeEphoneSpeedDialNumber, ccmeNightServiceDateMonth=ccmeNightServiceDateMonth, ccmeMohMulticastFromFlashEnabled=ccmeMohMulticastFromFlashEnabled, ccmeDateFormat=ccmeDateFormat, ccmeActiveStatsGroupEM=ccmeActiveStatsGroupEM, ccmeNotifGroup=ccmeNotifGroup, ccmeEphoneDnChOutbound=ccmeEphoneDnChOutbound, ccmeWebGUITimeEnabled=ccmeWebGUITimeEnabled, ccmeEphoneKeepConfEnabled=ccmeEphoneKeepConfEnabled, ccmeLivefeedMohFailedNotif=ccmeLivefeedMohFailedNotif, ciscoCcmeMIBConform=ciscoCcmeMIBConform, ccmeEphonePagingPolicy=ccmeEphonePagingPolicy, ccmeNotificationEnable=ccmeNotificationEnable, ccmeEphoneTAPIClient=ccmeEphoneTAPIClient, ccmeTransferPatternType=ccmeTransferPatternType, ccmeEphoneMacAddress=ccmeEphoneMacAddress, ccmeEphoneDnConfigTable=ccmeEphoneDnConfigTable, ccmeLoopbackDnStrip=ccmeLoopbackDnStrip, ccmeLoopbackDnConfEntry=ccmeLoopbackDnConfEntry, ccmeTransferPattern=ccmeTransferPattern, ccmeMaxDirectoryNumber=ccmeMaxDirectoryNumber, ccmeMwiRelay=ccmeMwiRelay, ccmeEphoneDnName=ccmeEphoneDnName, ccmeConfigGroupEM=ccmeConfigGroupEM, ccmeHistoryStats=ccmeHistoryStats, ccmeAfterHrsBlockDateStopHour=ccmeAfterHrsBlockDateStopHour, ccmeNightServiceCode=ccmeNightServiceCode, ccmeEphoneLastError=ccmeEphoneLastError, ccmeEphoneKeepAlive=ccmeEphoneKeepAlive, ccmeIntercomDnConfTable=ccmeIntercomDnConfTable, ccmeMohMulticastPortNumber=ccmeMohMulticastPortNumber, ccmeEphoneRegState=ccmeEphoneRegState, ccmeMohFlashMulticastIPAddr=ccmeMohFlashMulticastIPAddr, ccmeAfterHrsBlockDateStopMin=ccmeAfterHrsBlockDateStopMin, ccmeEPhoneDeceased=ccmeEPhoneDeceased, ccmeEphoneIpAddress=ccmeEphoneIpAddress, ccmeLoopbackDnforward=ccmeLoopbackDnforward, ccmeIntercomDnBargeInEnabled=ccmeIntercomDnBargeInEnabled, ccmeMaxConferences=ccmeMaxConferences, ccmeAfterHrsBlockPatternAllTime=ccmeAfterHrsBlockPatternAllTime, ccmeEphonePendingReset=ccmeEphonePendingReset, ccmeMohMulticastIpAddressType=ccmeMohMulticastIpAddressType, ccmeEphoneObservedType=ccmeEphoneObservedType, ccmeBusyTimeout=ccmeBusyTimeout, ccmeEMUserDirNumConfEntry=ccmeEMUserDirNumConfEntry, ccmeStatusChangeNotif=ccmeStatusChangeNotif, ccmeMaxEphones=ccmeMaxEphones, ccmeCorEndingNumber=ccmeCorEndingNumber, ccmeEMLogoutDirNumConfTable=ccmeEMLogoutDirNumConfTable, ccmeEphoneBtnDNAssocConfEntry=ccmeEphoneBtnDNAssocConfEntry, ciscoCcmeMIBCompliance=ciscoCcmeMIBCompliance, ccmePortNumber=ccmePortNumber, ccmeEphoneDnCFNoAnTo=ccmeEphoneDnCFNoAnTo, ccmeEphoneActivityStatus=ccmeEphoneActivityStatus, ccmeNightServiceDayStartMin=ccmeNightServiceDayStartMin, ccmeAfterHrsBlockPatternEntry=ccmeAfterHrsBlockPatternEntry, ccmeEphoneTag=ccmeEphoneTag, ccmeEphoneDnHuntstop=ccmeEphoneDnHuntstop, ccmeEMLogoutDirNum=ccmeEMLogoutDirNum, ccmeEMUserProfileTag=ccmeEMUserProfileTag, ccmeHistoryStatsGroup=ccmeHistoryStatsGroup, ccmeAfterHrsBlockDayEntry=ccmeAfterHrsBlockDayEntry, ccmeAfterHrsBlockDayStopMin=ccmeAfterHrsBlockDayStopMin, ccmeAfterHrsBlockPattern=ccmeAfterHrsBlockPattern, ccmeKeepAliveTimeout=ccmeKeepAliveTimeout, ccmeEphoneFastDialConfTable=ccmeEphoneFastDialConfTable, ccmeEphoneDnMwiCapability=ccmeEphoneDnMwiCapability, ccmeEMUserDirNumConfTable=ccmeEMUserDirNumConfTable, ccmeAfterHrsBlockPatternTable=ccmeAfterHrsBlockPatternTable, ccmeAfterHrsBlockDayStartMin=ccmeAfterHrsBlockDayStartMin, ccmeEphoneFastDialNumber=ccmeEphoneFastDialNumber, ccmeEMUserDirNum=ccmeEMUserDirNum, ccmeEphoneTotKeyPhConfigured=ccmeEphoneTotKeyPhConfigured, ccmeNightServiceDateStartHour=ccmeNightServiceDateStartHour, ccmeEphoneDnScriptName=ccmeEphoneDnScriptName, ccmeEphoneFastDialName=ccmeEphoneFastDialName, ccmeEphoneDnPriNum=ccmeEphoneDnPriNum, ccmeCorDirection=ccmeCorDirection, ccmeCorStartingNumber=ccmeCorStartingNumber, ccmeTransferSystem=ccmeTransferSystem, ccmePhoneFirmwareEntry=ccmePhoneFirmwareEntry, ccmePhoneFirmwareRev=ccmePhoneFirmwareRev, ccmeEphoneDnChOutBusy=ccmeEphoneDnChOutBusy, ccmeIntercomDnTag=ccmeIntercomDnTag, ccmeNightServiceDateStartMin=ccmeNightServiceDateStartMin, ccmeEphoneDnHoldAltType=ccmeEphoneDnHoldAltType, ccmeEphoneDnHuntstopCh=ccmeEphoneDnHuntstopCh, ccmeUrlforServicesBtn=ccmeUrlforServicesBtn, ccmeEphoneDnCFAllNum=ccmeEphoneDnCFAllNum, ccmePhoneFirmwareIndex=ccmePhoneFirmwareIndex, ccmeCorListName=ccmeCorListName, ccmeEphoneDnChInAnswered=ccmeEphoneDnChInAnswered, ccmeLoopbackDnSuffix=ccmeLoopbackDnSuffix, ccmeSysNotificationReason=ccmeSysNotificationReason, ccmeMwiSipSvrUnsolicitedEnabled=ccmeMwiSipSvrUnsolicitedEnabled, ccmeEMLogoutDirNumOverlay=ccmeEMLogoutDirNumOverlay, ccmeAfterHrsBlockDayIndex=ccmeAfterHrsBlockDayIndex, ccmePhoneType=ccmePhoneType, ccmeCorTag=ccmeCorTag, ccmeAfterHrsBlockDateStartHour=ccmeAfterHrsBlockDateStartHour, ccmeAfterHrsBlockDay=ccmeAfterHrsBlockDay, ccmeDialplanPatternEntry=ccmeDialplanPatternEntry, ccmeEphoneSpeedDialConfTable=ccmeEphoneSpeedDialConfTable, ccmeEphoneUnRegThresholdExceed=ccmeEphoneUnRegThresholdExceed, ccmeMwiExpires=ccmeMwiExpires, ccmeEphoneDnChDiscAtHold=ccmeEphoneDnChDiscAtHold, ccmeEphoneConfTable=ccmeEphoneConfTable, ccmeEphoneConfEntry=ccmeEphoneConfEntry, ccmeMohSource=ccmeMohSource)
mibBuilder.exportSymbols("CISCO-CCME-MIB", ccmeEphoneDeviceName=ccmeEphoneDeviceName, ccmeEphoneSpeedDialTag=ccmeEphoneSpeedDialTag, ccmeScriptName=ccmeScriptName, ccmeEphoneTemplate=ccmeEphoneTemplate, ccmeIntercomDnExtensionNum=ccmeIntercomDnExtensionNum, ccmeLoopbackDnAutoCon=ccmeLoopbackDnAutoCon, ccmeEphoneAddon=ccmeEphoneAddon, CcmeDigitPatternString=CcmeDigitPatternString, ccmeMwiSipServerRegE164Enabled=ccmeMwiSipServerRegE164Enabled, ciscoCcmeMIBGroups=ciscoCcmeMIBGroups, ccmeSystemMessage=ccmeSystemMessage, ccmeMaxConferenceNotif=ccmeMaxConferenceNotif, ccmeEphoneTotKeyPhRegistered=ccmeEphoneTotKeyPhRegistered, ccmeNightServiceDate=ccmeNightServiceDate, ccmeEphoneNightBellSvcEnabled=ccmeEphoneNightBellSvcEnabled, ccmeEphoneBtnDNAssocConfTable=ccmeEphoneBtnDNAssocConfTable, ccmeMwiSipServerIpAddress=ccmeMwiSipServerIpAddress, ccmeNightServiceDateEntry=ccmeNightServiceDateEntry, ccmeEphoneDnTag=ccmeEphoneDnTag, ccmeEphoneDnLabel=ccmeEphoneDnLabel, ccmeEphoneSpeedDialTableIndex=ccmeEphoneSpeedDialTableIndex, ccmeNightServiceDateTable=ccmeNightServiceDateTable, ccmEMLogOutProfileDirNumIndex=ccmEMLogOutProfileDirNumIndex, ccmeEphoneModel=ccmeEphoneModel, ccmeLoopbackDnPrefix=ccmeLoopbackDnPrefix, ccmeEphoneActiveDN=ccmeEphoneActiveDN, ccmeEphoneDnChOutAnswered=ccmeEphoneDnChOutAnswered, ccmeAfterHrsBlockDayStopHour=ccmeAfterHrsBlockDayStopHour)
