...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-L4L7MODULE-REDUNDANCY-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:45:38 2019
...
NotificationType, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, iso, Bits, Gauge32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "iso", "Bits", "Gauge32", "TimeTicks", "IpAddress")
RowStatus, TimeStamp, DisplayString, TruthValue, StorageType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "TruthValue", "StorageType", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-L4L7MODULE-REDUNDANCY-MIB", clrPeerSoftwareCompatibilty=clrPeerSoftwareCompatibilty, ciscoLmRedundancyMIBCompliance=ciscoLmRedundancyMIBCompliance, clrLBStatsDroppedEntries=clrLBStatsDroppedEntries, ciscoLmRedundancyMIBNotifs=ciscoLmRedundancyMIBNotifs, clrRedState=clrRedState, clrRedundancyConfigEntry=clrRedundancyConfigEntry, clrHAStatsMissedHeartBeatMsgs=clrHAStatsMissedHeartBeatMsgs, clrPeerOperStatus=clrPeerOperStatus, clrHAStatsTable=clrHAStatsTable, clrPeerHeartBeatTime=clrPeerHeartBeatTime, clrHAStatsRxHeartBeatMsgs=clrHAStatsRxHeartBeatMsgs, clrPeerInfoEntry=clrPeerInfoEntry, clrLBStatsSharedStickyEntries=clrLBStatsSharedStickyEntries, clrRedundancyState=clrRedundancyState, clrPeerId=clrPeerId, clrPeerConfigEntry=clrPeerConfigEntry, clrConfig=clrConfig, clrRedundancyPriority=clrRedundancyPriority, clrRedundancyIpAddress=clrRedundancyIpAddress, clrLBStatsReceiveFailures=clrLBStatsReceiveFailures, CiscoL4L7RedState=CiscoL4L7RedState, cslbxNotifControlGroup=cslbxNotifControlGroup, PYSNMP_MODULE_ID=ciscoL4L7moduleRedundancyMIB, clrPeerIpAddressType=clrPeerIpAddressType, clrRedStateChangeTime=clrRedStateChangeTime, clrRedContext=clrRedContext, clrHAStatsTxHeartBeatMsgs=clrHAStatsTxHeartBeatMsgs, clrRedundancyStatsGroup=clrRedundancyStatsGroup, clrPeerInfoTable=clrPeerInfoTable, clrStateChangeNotifEnabled=clrStateChangeNotifEnabled, ciscoLmRedundancyMIBCompliances=ciscoLmRedundancyMIBCompliances, ciscoLmRedundancyMIBGroups=ciscoLmRedundancyMIBGroups, clrPeerHeartBeatCount=clrPeerHeartBeatCount, clrPeerConfigGroup=clrPeerConfigGroup, clrLBStatsSentPackets=clrLBStatsSentPackets, clrLBStatsReceivedPackets=clrLBStatsReceivedPackets, clrRedStorageType=clrRedStorageType, clrRedGroupId=clrRedGroupId, clrPeerInterface=clrPeerInterface, clrPeerConfigTable=clrPeerConfigTable, ciscoL4L7moduleRedundancyMIB=ciscoL4L7moduleRedundancyMIB, clrPeerLicenseCompatibility=clrPeerLicenseCompatibility, clrRedRowStatus=clrRedRowStatus, clrPeerStorageType=clrPeerStorageType, clrPeerRowStatus=clrPeerRowStatus, clrLBStatsTable=clrLBStatsTable, ciscoLmRedundancyMIBConformance=ciscoLmRedundancyMIBConformance, clrRedundancyStateChangeTime=clrRedundancyStateChangeTime, clrHAStatsPeerDownEvents=clrHAStatsPeerDownEvents, clrRedConfigGroup=clrRedConfigGroup, clrHAStatsHeartBeatTimeoutMismatches=clrHAStatsHeartBeatTimeoutMismatches, ciscoLmRedundancyMIBObjects=ciscoLmRedundancyMIBObjects, clrLBStatsSendFailures=clrLBStatsSendFailures, clrRedPreempt=clrRedPreempt, clrRedundancyInfoTable=clrRedundancyInfoTable, clrHAStatsRxUniDirectionalHeartBeatMsgs=clrHAStatsRxUniDirectionalHeartBeatMsgs, clrRedPriority=clrRedPriority, clrRedFailOverTime=clrRedFailOverTime, clrHAStatsEntry=clrHAStatsEntry, clrPeerIpAddress=clrPeerIpAddress, clrLBStatsEntry=clrLBStatsEntry, clrRedundancyConfigTable=clrRedundancyConfigTable, clrNotifObjects=clrNotifObjects, clrPeerRedGroups=clrPeerRedGroups, clrRedPeerId=clrRedPeerId, clrHAStatsPeerUpEvents=clrHAStatsPeerUpEvents, clrRedundancyStateChange=clrRedundancyStateChange, cslbxNotifGroup=cslbxNotifGroup, clrRedundancyInfoEntry=clrRedundancyInfoEntry, clrPeerBackupInterface=clrPeerBackupInterface, clrRedInfoGroup=clrRedInfoGroup, clrRedundancyIpAddressType=clrRedundancyIpAddressType, clrStats=clrStats)
