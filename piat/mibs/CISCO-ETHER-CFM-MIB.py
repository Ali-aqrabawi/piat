...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ETHER-CFM-MIB
...
mibBuilder.exportSymbols("CISCO-ETHER-CFM-MIB", cEtherCfmEventType=cEtherCfmEventType, ciscoEtherCfmMIBObjects=ciscoEtherCfmMIBObjects, ciscoEtherCfmMIBConform=ciscoEtherCfmMIBConform, ciscoEtherCfmMIBGroups=ciscoEtherCfmMIBGroups, ciscoEtherCfmMIBCompliance=ciscoEtherCfmMIBCompliance, ciscoEtherCfmMIBEventGroup=ciscoEtherCfmMIBEventGroup, cEtherCfmCcMepDown=cEtherCfmCcMepDown, cEtherCfmEventTable=cEtherCfmEventTable, cEtherCfmEventIndex=cEtherCfmEventIndex, cEtherCfmEventLclMacAddress=cEtherCfmEventLclMacAddress, cecCfmEvents=cecCfmEvents, cEtherCfmEventRmtMacAddress=cEtherCfmEventRmtMacAddress, cEtherCfmEventCode=cEtherCfmEventCode, cEtherCfmCcLoop=cEtherCfmCcLoop, cEtherCfmEventDeleteRow=cEtherCfmEventDeleteRow, cEtherCfmEventLclMepCount=cEtherCfmEventLclMepCount, cEtherCfmEventRmtServiceId=cEtherCfmEventRmtServiceId, cEtherCfmCcCrossconnect=cEtherCfmCcCrossconnect, cEtherCfmXCheckServiceUp=cEtherCfmXCheckServiceUp, CfmMepid=CfmMepid, cEtherCfmEventRmtPortState=cEtherCfmEventRmtPortState, ciscoEtherCfmNotificationPrefix=ciscoEtherCfmNotificationPrefix, cEtherCfmEventEntry=cEtherCfmEventEntry, cEtherCfmXCheckMissing=cEtherCfmXCheckMissing, ciscoEtherCfmMIB=ciscoEtherCfmMIB, ciscoEtherCfmMIBNotifGroup=ciscoEtherCfmMIBNotifGroup, cEtherCfmEventSvlan=cEtherCfmEventSvlan, cEtherCfmEventLclMepid=cEtherCfmEventLclMepid, ciscoEtherCfmMIBCompliances=ciscoEtherCfmMIBCompliances, cEtherCfmEventLclIfCount=cEtherCfmEventLclIfCount, cEtherCfmEventDomainName=cEtherCfmEventDomainName, cEtherCfmEventServiceId=cEtherCfmEventServiceId, cEtherCfmXCheckUnknown=cEtherCfmXCheckUnknown, PYSNMP_MODULE_ID=ciscoEtherCfmMIB, cEtherCfmCcMepUp=cEtherCfmCcMepUp, cEtherCfmEventLastChange=cEtherCfmEventLastChange, cEtherCfmEventRmtMepid=cEtherCfmEventRmtMepid, cEtherCfmMaxEventIndex=cEtherCfmMaxEventIndex, ciscoEtherCfmMIBNotifs=ciscoEtherCfmMIBNotifs, cEtherCfmCcConfigError=cEtherCfmCcConfigError, cEtherCfmEventDomainIndex=cEtherCfmEventDomainIndex)
