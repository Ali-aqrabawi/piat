...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-DOT11-IF-MIB
...
mibBuilder.exportSymbols("CISCO-DOT11-IF-MIB", cd11IfStatistics=cd11IfStatistics, cd11IfAuthAlgorithmEntry=cd11IfAuthAlgorithmEntry, cd11IfAuxSsidAuthAlgRequireEap=cd11IfAuxSsidAuthAlgRequireEap, cd11IfPhyFhssMaxCompatibleRate=cd11IfPhyFhssMaxCompatibleRate, cd11IfRecFrameMacCrcErrors=cd11IfRecFrameMacCrcErrors, cd11IfStationSwitchOverNotif=cd11IfStationSwitchOverNotif, cd11IfNativeTxPowerLevel=cd11IfNativeTxPowerLevel, cd11IfWepDefaultKeysEntry=cd11IfWepDefaultKeysEntry, cd11IfMacLayerCountersTable=cd11IfMacLayerCountersTable, cd11IfSuppDataRatesPrivacyValue=cd11IfSuppDataRatesPrivacyValue, cd11IfDesiredBssTable=cd11IfDesiredBssTable, cd11IfAssignedAidTable=cd11IfAssignedAidTable, cd11IfSuppDataRatesPrivacyIndex=cd11IfSuppDataRatesPrivacyIndex, cd11IfVlanSecurityTable=cd11IfVlanSecurityTable, cd11IfRadioMonitorRowStatus=cd11IfRadioMonitorRowStatus, ciscoDot11IfComplianceRev4=ciscoDot11IfComplianceRev4, cd11IfErpOfdmTxPowerLevel3=cd11IfErpOfdmTxPowerLevel3, cd11IfErpOfdmTxPowerLevel6=cd11IfErpOfdmTxPowerLevel6, cd11IfRatesSensRequiredSnr=cd11IfRatesSensRequiredSnr, cd11IfVlanEncryptKeyLen=cd11IfVlanEncryptKeyLen, cd11IfChanSelectChannel=cd11IfChanSelectChannel, cd11IfVlanSecurityVlanEnabled=cd11IfVlanSecurityVlanEnabled, cd11IfAuxSsidMicAlgorithm=cd11IfAuxSsidMicAlgorithm, cd11IfVlanBcastKeyChangeInterval=cd11IfVlanBcastKeyChangeInterval, cd11IfAuxSsidAuthAlgEapMethod=cd11IfAuxSsidAuthAlgEapMethod, cd11IfAssociationManageGroup=cd11IfAssociationManageGroup, cd11IfRemoteMonitoringGroup=cd11IfRemoteMonitoringGroup, cd11IfCiscoExtensionsEnable=cd11IfCiscoExtensionsEnable, cd11IfClientNumberTxPowerLevels=cd11IfClientNumberTxPowerLevels, cd11IfAuxSsidBroadcastSsid=cd11IfAuxSsidBroadcastSsid, cd11IfMultipleBssidEnable=cd11IfMultipleBssidEnable, cd11IfClientTxPowerLevel2=cd11IfClientTxPowerLevel2, cd11IfNativeTxPowerSupportTable=cd11IfNativeTxPowerSupportTable, cd11IfAuxSsidTable=cd11IfAuxSsidTable, cd11IfRfNativePowerEntry=cd11IfRfNativePowerEntry, cd11IfDesiredBssAddr=cd11IfDesiredBssAddr, cd11IfAuthAlgorithmTable=cd11IfAuthAlgorithmTable, cd11IfClientTxPowerLevel4=cd11IfClientTxPowerLevel4, cd11IfDot11UpgradeStatus=cd11IfDot11UpgradeStatus, Cd11IfDot11UpgradeStatus=Cd11IfDot11UpgradeStatus, cd11IfVlanPsPacketForwardEnable=cd11IfVlanPsPacketForwardEnable, cd11IfPhyDsssMaxCompatibleRate=cd11IfPhyDsssMaxCompatibleRate, cd11IfRogueApDetectedEntry=cd11IfRogueApDetectedEntry, cd11IfMacStatisticsGroup=cd11IfMacStatisticsGroup, cd11IfWepDefaultKeyValue=cd11IfWepDefaultKeyValue, CDot11IfWepKeyPermuteAlgorithm=CDot11IfWepKeyPermuteAlgorithm, cd11IfClientCurrentTxPowerLevel=cd11IfClientCurrentTxPowerLevel, cd11IfRadioManageGroup=cd11IfRadioManageGroup, cd11IfClientTxPowerEntry=cd11IfClientTxPowerEntry, cd11IfPhyMacSpecification=cd11IfPhyMacSpecification, cd11IfChanSelectEntry=cd11IfChanSelectEntry, cd11IfNativePowerUnits=cd11IfNativePowerUnits, PYSNMP_MODULE_ID=ciscoDot11IfMIB, cd11IfDot11UpgradeStatusEntry=cd11IfDot11UpgradeStatusEntry, cd11IfManagementGroup=cd11IfManagementGroup, cd11IfDataRatesSensitivityEntry=cd11IfDataRatesSensitivityEntry, cd11IfAuxSsidAuthAlgTable=cd11IfAuxSsidAuthAlgTable, cd11IfRadioMonitoringEntry=cd11IfRadioMonitoringEntry, cd11IfErpOfdmTxPowerLevel5=cd11IfErpOfdmTxPowerLevel5, cd11IfRfFrequencyBand=cd11IfRfFrequencyBand, cd11IfAuxSsidIndex=cd11IfAuxSsidIndex, cd11IfRfStartChannelNumber=cd11IfRfStartChannelNumber, cd11IfMaxChannelSwitchTime=cd11IfMaxChannelSwitchTime, cd11IfEthernetEncapsulDefault=cd11IfEthernetEncapsulDefault, cd11IfVlanWepEncryptOptions=cd11IfVlanWepEncryptOptions, cd11IfNativeTxPower=cd11IfNativeTxPower, ciscoDot11IfMIBCompliances=ciscoDot11IfMIBCompliances, ciscoDot11IfComplianceRev2=ciscoDot11IfComplianceRev2, cd11IfAuxSsidAuthAlgEnable=cd11IfAuxSsidAuthAlgEnable, cd11IfErpOfdmTxPowerLevel7=cd11IfErpOfdmTxPowerLevel7, cd11IfVlanWepManageGroup=cd11IfVlanWepManageGroup, cd11IfDesiredSsidMicAlgorithm=cd11IfDesiredSsidMicAlgorithm, cd11IfVlanEncryptKeyStatus=cd11IfVlanEncryptKeyStatus, cd11IfPhyOperationEntry=cd11IfPhyOperationEntry, cd11IfMonitorNotificationGroup=cd11IfMonitorNotificationGroup, cd11IfVoipExtensionsEnable=cd11IfVoipExtensionsEnable, cd11IfNativeNumberPowerLevels=cd11IfNativeNumberPowerLevels, cd11IfAuxSsidAuthAlgRequireMac=cd11IfAuxSsidAuthAlgRequireMac, cd11IfClientTxPowerLevel1=cd11IfClientTxPowerLevel1, cd11IfAuthAlgRequireEap=cd11IfAuthAlgRequireEap, cd11IfAuxSsidWepPermuteAlg=cd11IfAuxSsidWepPermuteAlg, cd11IfPhyBasicRateSet=cd11IfPhyBasicRateSet, cd11IfRfFrequencyBandType=cd11IfRfFrequencyBandType, cd11IfSuppDataRatesPrivacyEntry=cd11IfSuppDataRatesPrivacyEntry, cd11IfVlanSecurityCiphers=cd11IfVlanSecurityCiphers, cd11IfErpOfdmTxPowerLevel4=cd11IfErpOfdmTxPowerLevel4, cd11IfSuppDataRatesPrivacyEnabl=cd11IfSuppDataRatesPrivacyEnabl, cd11IfFrequencyBandEntry=cd11IfFrequencyBandEntry, cd11IfStationConfigEntry=cd11IfStationConfigEntry, cd11IfManagement=cd11IfManagement, cd11IfPrivacyOptionMaxRate=cd11IfPrivacyOptionMaxRate, cd11IfAuxSsidAuthAlgMacMethod=cd11IfAuxSsidAuthAlgMacMethod, cd11IfRfChannelSpacingNumber=cd11IfRfChannelSpacingNumber, cd11IfVlanEncryptKeyConfigGroup=cd11IfVlanEncryptKeyConfigGroup, cd11IfConfigurations=cd11IfConfigurations, cd11IfRadioMonitoringTable=cd11IfRadioMonitoringTable, cd11IfAuxSsidAuthAlgEntry=cd11IfAuxSsidAuthAlgEntry, cd11IfErpOfdmTxPowerLevel8=cd11IfErpOfdmTxPowerLevel8, cd11IfRfEndChannelNumber=cd11IfRfEndChannelNumber, cd11Ifdot11MobileStationScanGroup=cd11Ifdot11MobileStationScanGroup, cd11IfSuppDataRatesPrivacyTable=cd11IfSuppDataRatesPrivacyTable, CDot11RadioModulationClass=CDot11RadioModulationClass, cd11IfDataRatesSensitivityGroup=cd11IfDataRatesSensitivityGroup, cd11IfVlanBcastKeyCapabilChange=cd11IfVlanBcastKeyCapabilChange, cd11IfRemoteRadioMacAddr=cd11IfRemoteRadioMacAddr, cd11IfPhyConfigGroup=cd11IfPhyConfigGroup, cd11IfRfNativePowerTable=cd11IfRfNativePowerTable, cd11IfVlanSecurityVlanId=cd11IfVlanSecurityVlanId, cd11IfWepDefaultKeysTable=cd11IfWepDefaultKeysTable, cd11IfPhyOperationTable=cd11IfPhyOperationTable, cd11IfNativeRadioManageGroup=cd11IfNativeRadioManageGroup, cd11IfRogueApName=cd11IfRogueApName, cd11IfVlanId=cd11IfVlanId, cd11IfVlanManageGroup=cd11IfVlanManageGroup, cd11IfMobileStationScanParent=cd11IfMobileStationScanParent, cd11IfStationRole=cd11IfStationRole, CDot11IfMicAlgorithm=CDot11IfMicAlgorithm, cd11IfPhyDsssChannelAutoEnable=cd11IfPhyDsssChannelAutoEnable, cd11IfAuxiliarySsidLength=cd11IfAuxiliarySsidLength, cd11IfDesiredBssEntry=cd11IfDesiredBssEntry, cd11IfRogueApDetectedNotif=cd11IfRogueApDetectedNotif, cd11IfErpOfdmNumberTxPowerLevels=cd11IfErpOfdmNumberTxPowerLevels, cd11IfDomainCapabilityGroup=cd11IfDomainCapabilityGroup, cd11IfVlanEncryptKeyEntry=cd11IfVlanEncryptKeyEntry, cd11IfAuthAlgDefaultVlan=cd11IfAuthAlgDefaultVlan, cd11IfVlanWepEncryptKeyHashing=cd11IfVlanWepEncryptKeyHashing, cd11IfRadioMonitorPollingFreq=cd11IfRadioMonitorPollingFreq, cd11IfSsidAssociationGroup=cd11IfSsidAssociationGroup, cd11IfAuxSsid=cd11IfAuxSsid, CDot11RadioFrequencyBandType=CDot11RadioFrequencyBandType, cd11IfVlanBcastKeyClientLeave=cd11IfVlanBcastKeyClientLeave, cd11IfChanSelectTable=cd11IfChanSelectTable, cd11IfNativeCurrentPowerLevel=cd11IfNativeCurrentPowerLevel, cd11IfChanSelectEnable=cd11IfChanSelectEnable, cd11IfVlanEncryptKeyTransmit=cd11IfVlanEncryptKeyTransmit, cd11IfModulationType=cd11IfModulationType, cd11IfMobileStationScanChannel=cd11IfMobileStationScanChannel, cd11IfPhyMacCapabilityGroup=cd11IfPhyMacCapabilityGroup, cd11IfDesiredSsidMaxAssocSta=cd11IfDesiredSsidMaxAssocSta, cd11IfErpOfdmCurrentTxPowerLevel=cd11IfErpOfdmCurrentTxPowerLevel, cd11IfStationConfigTable=cd11IfStationConfigTable, cd11IfClientTxPowerTable=cd11IfClientTxPowerTable, cd11IfRfFrequencySpacing=cd11IfRfFrequencySpacing, cd11IfPhyFhssTable=cd11IfPhyFhssTable, cd11IfDomainCapabilitySet=cd11IfDomainCapabilitySet, cd11IfErpOfdmTxPowerTable=cd11IfErpOfdmTxPowerTable, cd11IfClientTxPowerLevel8=cd11IfClientTxPowerLevel8, cd11IfClientTxPowerLevel3=cd11IfClientTxPowerLevel3, cd11IfVlanSecurityRowStatus=cd11IfVlanSecurityRowStatus, cd11IfAuthAlgEapMethod=cd11IfAuthAlgEapMethod, cd11IfPsPacketForwardEnable=cd11IfPsPacketForwardEnable, cd11IfRfStartChannelFrequency=cd11IfRfStartChannelFrequency, cd11IfRogueApMacAddr=cd11IfRogueApMacAddr, cd11IfAssignedAidEntry=cd11IfAssignedAidEntry, ciscoDot11IfMIBConformance=ciscoDot11IfMIBConformance, cd11IfLocalRadioMonitorStatus=cd11IfLocalRadioMonitorStatus, cd11IfRfFrequencyUnits=cd11IfRfFrequencyUnits, cd11IfPhyConcatenation=cd11IfPhyConcatenation, cd11IfAuxSsidMaxAssocSta=cd11IfAuxSsidMaxAssocSta, cd11IfDataRatesSensitivityTable=cd11IfDataRatesSensitivityTable, cd11IfAuthAlgMethodListGroup=cd11IfAuthAlgMethodListGroup, cd11IfClientTxPowerLevel7=cd11IfClientTxPowerLevel7, cd11IfWorldMode=cd11IfWorldMode, cd11IfRadioMonitorPollingTimeOut=cd11IfRadioMonitorPollingTimeOut, cd11IfBridgeSpacing=cd11IfBridgeSpacing, cd11IfAuxSsidEntry=cd11IfAuxSsidEntry, cd11IfRatesSensContention=cd11IfRatesSensContention, cd11IfRogueApDetectedTable=cd11IfRogueApDetectedTable, cd11IfPhyConfig=cd11IfPhyConfig, cd11IfPhyDsssTable=cd11IfPhyDsssTable, cd11IfDot11UpgradeStatusTable=cd11IfDot11UpgradeStatusTable, ciscoDot11IfCompliance=ciscoDot11IfCompliance, cd11IfStationManageGroup=cd11IfStationManageGroup, cd11IfMobileStationListIgnore=cd11IfMobileStationListIgnore, cd11IfAllowBroadcastSsidAssoc=cd11IfAllowBroadcastSsidAssoc, cd11IfVlanEncryptKeyIndex=cd11IfVlanEncryptKeyIndex, cd11IfAuthAlgMacAddrMethod=cd11IfAuthAlgMacAddrMethod, cd11IfTransDeferEnerDetects=cd11IfTransDeferEnerDetects, CDot11IfCipherType=CDot11IfCipherType, cd11IfAssignedAid=cd11IfAssignedAid, cd11IfVlanEncryptionMode=cd11IfVlanEncryptionMode, cd11IfRadioModulationClass=cd11IfRadioModulationClass, cd11IfVlanSecurityEntry=cd11IfVlanSecurityEntry, cd11IfAuxSsidAuthAlgDefaultVlan=cd11IfAuxSsidAuthAlgDefaultVlan, cd11IfMacStatistics=cd11IfMacStatistics, cd11IfWorldModeCountry=cd11IfWorldModeCountry, cd11IfPhyNativePowerUseStandard=cd11IfPhyNativePowerUseStandard, cd11IfVlanEncryptKeyTable=cd11IfVlanEncryptKeyTable, cd11IfVlanEncryptKeyValue=cd11IfVlanEncryptKeyValue, ciscoDot11IfComplianceRev3=ciscoDot11IfComplianceRev3, cd11IfDesiredBssIndex=cd11IfDesiredBssIndex, cd11Ifdot11UpgradeStatusGroup=cd11Ifdot11UpgradeStatusGroup, cd11IfWepDefaultKeyIndex=cd11IfWepDefaultKeyIndex, cd11IfErpOfdmTxPowerEntry=cd11IfErpOfdmTxPowerEntry, cd11IfVlanWepEncryptMic=cd11IfVlanWepEncryptMic, cd11IfErpOfdmTxPowerLevel1=cd11IfErpOfdmTxPowerLevel1, cd11IfFrequencyBandTable=cd11IfFrequencyBandTable, cd11IfCurrentCarrierSet=cd11IfCurrentCarrierSet, cd11IfPreambleType=cd11IfPreambleType, ciscoDot11IfMIBObjects=ciscoDot11IfMIBObjects, ciscoDot11IfComplianceRev1=ciscoDot11IfComplianceRev1, cd11IfRogueApDetectedGroup=cd11IfRogueApDetectedGroup, cd11IfPhyFhssEntry=cd11IfPhyFhssEntry, cd11IfErpOfdmTxPowerLevel2=cd11IfErpOfdmTxPowerLevel2, CDot11IfVlanIdOrZero=CDot11IfVlanIdOrZero, cd11IfDesiredSsidWepPermuteAlg=cd11IfDesiredSsidWepPermuteAlg, ciscoDot11IfMIB=ciscoDot11IfMIB, cd11IfAuthAlgRequireMacAddr=cd11IfAuthAlgRequireMacAddr, cd11IfWepDefaultKeyLen=cd11IfWepDefaultKeyLen, cd11IfClientTxPowerLevel6=cd11IfClientTxPowerLevel6, cd11IfSsidMismatches=cd11IfSsidMismatches, ciscoDot11IfMIBGroups=ciscoDot11IfMIBGroups, cd11IfNativeTxPowerSupportEntry=cd11IfNativeTxPowerSupportEntry, cd11IfClientTxPowerLevel5=cd11IfClientTxPowerLevel5, cd11IfMacLayerCountersEntry=cd11IfMacLayerCountersEntry, ciscoDot11IfMIBNotifications=ciscoDot11IfMIBNotifications, cd11IfPhyErpConfigGroup=cd11IfPhyErpConfigGroup, cd11IfPhyConfigGroupRev1=cd11IfPhyConfigGroupRev1, cd11IfPhyDsssEntry=cd11IfPhyDsssEntry, cd11IfPhyDsssCurrentChannel=cd11IfPhyDsssCurrentChannel, cd11IfAssignedSta=cd11IfAssignedSta, WepKeyType128=WepKeyType128)
