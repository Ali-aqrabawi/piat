...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-ERR-DISABLE-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:34:16 2019
...
Unsigned32, Gauge32, ModuleIdentity, Bits, TimeTicks, Counter32, Counter64, IpAddress, MibIdentifier, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "ModuleIdentity", "Bits", "TimeTicks", "Counter32", "Counter64", "IpAddress", "MibIdentifier", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("CISCO-ERR-DISABLE-MIB", cErrDisableRecoveryInterval=cErrDisableRecoveryInterval, ciscoErrDisableGlobalCfgGroup=ciscoErrDisableGlobalCfgGroup, cErrDisableNotificationsPrefix=cErrDisableNotificationsPrefix, cErrDisableIfStatusEntry=cErrDisableIfStatusEntry, ciscoErrDisableMIB=ciscoErrDisableMIB, ciscoErrDisableMIBConform=ciscoErrDisableMIBConform, ciscoErrDisableNotifGroupRev1=ciscoErrDisableNotifGroupRev1, cErrDisableFeatureTable=cErrDisableFeatureTable, cErrDisableFeatureRecoveryInterval=cErrDisableFeatureRecoveryInterval, cErrDisableFeatureIndex=cErrDisableFeatureIndex, cErrDisableGlobalObjects=cErrDisableGlobalObjects, cErrDisableFeatureMaxFlapCount=cErrDisableFeatureMaxFlapCount, ciscoErrDisableNotifGroup=ciscoErrDisableNotifGroup, cErrDisableIfStatusCause=cErrDisableIfStatusCause, ciscoErrDisableMIBCompliances=ciscoErrDisableMIBCompliances, cErrDisableInterfaceEventRev1=cErrDisableInterfaceEventRev1, ciscoErrDisableNotifCfgGroup=ciscoErrDisableNotifCfgGroup, ciscoErrDisableShutdownVlanGroup=ciscoErrDisableShutdownVlanGroup, ciscoErrDisableFeatureFlapGroup=ciscoErrDisableFeatureFlapGroup, cErrDisableFeatureDetectShutdownVlan=cErrDisableFeatureDetectShutdownVlan, cErrDisableIfStatusTimeToRecover=cErrDisableIfStatusTimeToRecover, ciscoErrDisableMIBGroups=ciscoErrDisableMIBGroups, cErrDisableFeatureFlapTimePeriod=cErrDisableFeatureFlapTimePeriod, ciscoErrDisableMIBComplianceRev2=ciscoErrDisableMIBComplianceRev2, cErrDisableFeatureRecoveryEnable=cErrDisableFeatureRecoveryEnable, cErrDisableIfStatusTable=cErrDisableIfStatusTable, ciscoErrDisableFeatureCfgGroup=ciscoErrDisableFeatureCfgGroup, CErrDisableFeatureID=CErrDisableFeatureID, ciscoErrDisableIfStatusGroup=ciscoErrDisableIfStatusGroup, cErrDisableIfStatusVlanIndex=cErrDisableIfStatusVlanIndex, cErrDisableNotifEnable=cErrDisableNotifEnable, cErrDisableFeatureConfigurable=cErrDisableFeatureConfigurable, ciscoErrDisableMIBComplianceRev1=ciscoErrDisableMIBComplianceRev1, cErrDisableFeatureObjects=cErrDisableFeatureObjects, cErrDisableNotifRate=cErrDisableNotifRate, cErrDisableIfObjects=cErrDisableIfObjects, ciscoErrDisableMIBObjects=ciscoErrDisableMIBObjects, cErrDisableFeatureEntry=cErrDisableFeatureEntry, ciscoErrDisableMIBNotifs=ciscoErrDisableMIBNotifs, cErrDisableInterfaceEvent=cErrDisableInterfaceEvent, ciscoErrDisableMIBCompliance=ciscoErrDisableMIBCompliance, PYSNMP_MODULE_ID=ciscoErrDisableMIB, cErrDisableFeatureDetectEnable=cErrDisableFeatureDetectEnable)
