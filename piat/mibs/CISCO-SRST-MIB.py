...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-SRST-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:46:36 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Gauge32, Bits, NotificationType, Counter32, ModuleIdentity, Unsigned32, iso, ObjectIdentity, MibIdentifier, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Gauge32", "Bits", "NotificationType", "Counter32", "ModuleIdentity", "Unsigned32", "iso", "ObjectIdentity", "MibIdentifier", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("CISCO-SRST-MIB", csrstVersion=csrstVersion, csrstCallFwdNoAnswerTo=csrstCallFwdNoAnswerTo, csrstSipVoRegNumberListIndex=csrstSipVoRegNumberListIndex, ciscoSrstMIBComplianceRev1=ciscoSrstMIBComplianceRev1, csrstIPAddress=csrstIPAddress, csrstMaxConferences=csrstMaxConferences, PYSNMP_MODULE_ID=ciscoSrstMIB, ciscoSrstMIBObjects=ciscoSrstMIBObjects, csrstSipVoRegPoolTag=csrstSipVoRegPoolTag, csrstMIBNotifsGroup=csrstMIBNotifsGroup, csrstScriptName=csrstScriptName, csrstSipVoRegPoolEdptTag=csrstSipVoRegPoolEdptTag, csrstSipPhoneCurrentRegistered=csrstSipPhoneCurrentRegistered, csrstSysNotifReason=csrstSysNotifReason, csrstSipCallLegs=csrstSipCallLegs, csrstAliasEntry=csrstAliasEntry, csrstAccessCode=csrstAccessCode, csrstPortNumber=csrstPortNumber, csrstSysNotifSeverity=csrstSysNotifSeverity, csrstSipPhoneUnRegThresholdExceed=csrstSipPhoneUnRegThresholdExceed, csrstDateFormat=csrstDateFormat, csrstLimitDN=csrstLimitDN, csrstLimitDNType=csrstLimitDNType, csrstSipVoRegNumberListEntry=csrstSipVoRegNumberListEntry, csrstNotifInfoGroup=csrstNotifInfoGroup, csrstAliasHuntStopEnabled=csrstAliasHuntStopEnabled, csrstMohMulticastPort=csrstMohMulticastPort, csrstSystemMessageSecondary=csrstSystemMessageSecondary, csrstNotificationEnabled=csrstNotificationEnabled, csrstCallFwdBusy=csrstCallFwdBusy, csrstMohFilename=csrstMohFilename, csrstSipPhoneRegFailed=csrstSipPhoneRegFailed, csrstAliasPreference=csrstAliasPreference, csrstXlateCalledNumber=csrstXlateCalledNumber, csrstMaxEphones=csrstMaxEphones, csrstSipNetMask=csrstSipNetMask, csrstMohMulticastAddr=csrstMohMulticastAddr, csrstSipVoRegPoolTable=csrstSipVoRegPoolTable, SrstOperType=SrstOperType, csrstAliasNumPattern=csrstAliasNumPattern, ciscoSrstMIBGroups=ciscoSrstMIBGroups, csrstSecondaryDialTone=csrstSecondaryDialTone, csrstConf=csrstConf, csrstSipVoRegNumberListTag=csrstSipVoRegNumberListTag, ciscoSrstMIBCompliance=ciscoSrstMIBCompliance, csrstTotalUpTime=csrstTotalUpTime, csrstSipRegSrvExpMax=csrstSipRegSrvExpMax, csrstGlobal=csrstGlobal, csrstSipProxySrvIpAddr=csrstSipProxySrvIpAddr, csrstSipEndpointTag=csrstSipEndpointTag, csrstMohMulticastAddrType=csrstMohMulticastAddrType, csrstLimitDNTable=csrstLimitDNTable, csrstCallFwdNoAnswer=csrstCallFwdNoAnswer, csrstBusyTo=csrstBusyTo, csrstEnabled=csrstEnabled, csrstSipConfGroup=csrstSipConfGroup, csrstActiveStats=csrstActiveStats, csrstAliasTable=csrstAliasTable, csrstInterdigitTo=csrstInterdigitTo, csrstSipVoRegPoolEntry=csrstSipVoRegPoolEntry, csrstLimitDNEntry=csrstLimitDNEntry, csrstAccessCodeEntry=csrstAccessCodeEntry, csrstSipVoRegPoolIpAddrType=csrstSipVoRegPoolIpAddrType, csrstSipVoRegNumberListTable=csrstSipVoRegNumberListTable, csrstXlateCallingNumber=csrstXlateCallingNumber, csrstSipEndpointTable=csrstSipEndpointTable, csrstStateChange=csrstStateChange, csrstAccessCodeTable=csrstAccessCodeTable, csrstSipEndpointDN=csrstSipEndpointDN, csrstSipIp2IpGlobalEnabled=csrstSipIp2IpGlobalEnabled, csrstTimeFormat=csrstTimeFormat, csrstUserLocaleInfoRev1=csrstUserLocaleInfoRev1, csrstFailNotif=csrstFailNotif, csrstIPAddressType=csrstIPAddressType, csrstSipProxySrvPref=csrstSipProxySrvPref, csrstSipNetId=csrstSipNetId, csrstUserLocaleInfo=csrstUserLocaleInfo, csrstSipEndpointEntry=csrstSipEndpointEntry, csrstSystemMessagePrimary=csrstSystemMessagePrimary, csrstTransferSystem=csrstTransferSystem, csrstConfGroupRev1=csrstConfGroupRev1, csrstSipVoRegNumberHuntstopEnabled=csrstSipVoRegNumberHuntstopEnabled, csrstSipProxySrvAltIpAddr=csrstSipProxySrvAltIpAddr, ciscoSrstMIBNotifications=ciscoSrstMIBNotifications, csrstAliasAltNumber=csrstAliasAltNumber, csrstVoiceMailNumber=csrstVoiceMailNumber, ciscoSrstMIBConformance=ciscoSrstMIBConformance, csrstSipSend300MultSupport=csrstSipSend300MultSupport, csrstAccessCodeDIDEnabled=csrstAccessCodeDIDEnabled, ciscoSrstMIB=ciscoSrstMIB, csrstAlertTo=csrstAlertTo, csrstAliasIndex=csrstAliasIndex, csrstSipPhoneUnRegThreshold=csrstSipPhoneUnRegThreshold, csrstSipRegSrvExpMin=csrstSipRegSrvExpMin, csrstSipDefaultPreference=csrstSipDefaultPreference, csrstConfGroup=csrstConfGroup, csrstSipEndpointIpAddrType=csrstSipEndpointIpAddrType, ciscoSrstMIBCompliances=ciscoSrstMIBCompliances, csrstSipVoRegPoolAppl=csrstSipVoRegPoolAppl, csrstAccessCodeType=csrstAccessCodeType, csrstState=csrstState, csrstSipEndpointIpAddress=csrstSipEndpointIpAddress, csrstConferenceFailed=csrstConferenceFailed, csrstActiveStatsGroup=csrstActiveStatsGroup, csrstSipConf=csrstSipConf, csrstSipProxySrvMonitor=csrstSipProxySrvMonitor, csrstSipVoRegNumberPattern=csrstSipVoRegNumberPattern, csrstSipVoRegNumberPref=csrstSipVoRegNumberPref, csrstAliasTag=csrstAliasTag, csrstMaxDN=csrstMaxDN)
