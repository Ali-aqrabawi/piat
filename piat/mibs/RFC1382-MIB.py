...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/RFC1382-MIB
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Gauge32, Bits, Counter32, Integer32, Counter64, Unsigned32, iso, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, transmission = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Gauge32", "Bits", "Counter32", "Integer32", "Counter64", "Unsigned32", "iso", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "transmission")
...
mibBuilder.exportSymbols("RFC1382-MIB", x25OperInterruptTimer=x25OperInterruptTimer, x25CircuitInterruptTimeouts=x25CircuitInterruptTimeouts, x25AdmnPacketSequencing=x25AdmnPacketSequencing, X121Address=X121Address, x25CallParmCalledNetworkFacilities=x25CallParmCalledNetworkFacilities, x25protocolCcittV1988=x25protocolCcittV1988, x25StatRetryCountExceededs=x25StatRetryCountExceededs, x25ChannelEntry=x25ChannelEntry, x25protocolIso8208V1989=x25protocolIso8208V1989, x25ClearedCircuitCallingAddress=x25ClearedCircuitCallingAddress, x25ChannelLIC=x25ChannelLIC, x25CallParmCugoa=x25CallParmCugoa, x25CallParmUserData=x25CallParmUserData, x25StatOutgoingCircuits=x25StatOutgoingCircuits, x25CallParmInThruPutClasSize=x25CallParmInThruPutClasSize, x25StatInCalls=x25StatInCalls, x25ChannelHOC=x25ChannelHOC, x25protocolCcittV1980=x25protocolCcittV1980, x25CircuitDescr=x25CircuitDescr, x25StatCallTimeouts=x25StatCallTimeouts, x25CallParmInPacketSize=x25CallParmInPacketSize, x25CallParmOutWindowSize=x25CallParmOutWindowSize, x25OperRestartTimer=x25OperRestartTimer, x25CallParmStatus=x25CallParmStatus, x25CallParmCalledExt=x25CallParmCalledExt, x25StatOutCallAttempts=x25StatOutCallAttempts, x25AdmnRejectTimer=x25AdmnRejectTimer, x25StatInProviderInitiatedClears=x25StatInProviderInitiatedClears, x25ChannelTable=x25ChannelTable, x25AdmnRestartTimer=x25AdmnRestartTimer, x25CallParmPriority=x25CallParmPriority, x25OperMaxActiveCircuits=x25OperMaxActiveCircuits, x25protocolIso8208V1987=x25protocolIso8208V1987, x25CircuitTable=x25CircuitTable, x25CircuitDataRetransmissionTimeouts=x25CircuitDataRetransmissionTimeouts, x25AdmnEntry=x25AdmnEntry, x25OperResetTimer=x25OperResetTimer, x25CircuitOutInterrupts=x25CircuitOutInterrupts, x25CallParmTable=x25CallParmTable, x25StatDataRxmtTimeouts=x25StatDataRxmtTimeouts, x25CircuitCallingDteAddress=x25CircuitCallingDteAddress, x25StatOutCallFailures=x25StatOutCallFailures, x25OperWindowTimer=x25OperWindowTimer, x25AdmnProtocolVersionSupported=x25AdmnProtocolVersionSupported, x25AdmnWindowTimer=x25AdmnWindowTimer, x25CallParmOutPacketSize=x25CallParmOutPacketSize, x25CallParmChargingInfo=x25CallParmChargingInfo, x25CallParmOutThruPutClasSize=x25CallParmOutThruPutClasSize, x25ClearedCircuitEntry=x25ClearedCircuitEntry, x25CircuitInPdus=x25CircuitInPdus, x25OperDataLinkId=x25OperDataLinkId, x25StatOutDataPackets=x25StatOutDataPackets, x25protocolCcittV1984=x25protocolCcittV1984, x25CircuitCalledDteAddress=x25CircuitCalledDteAddress, x25CallParmInMinThuPutCls=x25CallParmInMinThuPutCls, x25Reset=x25Reset, x25ClearedCircuitClearFacilities=x25ClearedCircuitClearFacilities, x25CallParmProtection=x25CallParmProtection, x25AdmnNumberPVCs=x25AdmnNumberPVCs, x25AdmnDataRxmtTimer=x25AdmnDataRxmtTimer, x25AdmnDataRxmtCount=x25AdmnDataRxmtCount, x25StatInInterrupts=x25StatInInterrupts, x25ClearedCircuitIndex=x25ClearedCircuitIndex, x25AdmnCallTimer=x25AdmnCallTimer, x25AdmnRejectCount=x25AdmnRejectCount, x25StatIndex=x25StatIndex, x25OperRegistrationRequestTimer=x25OperRegistrationRequestTimer, x25Restart=x25Restart, x25OperLocalAddress=x25OperLocalAddress, x25CallParmProposeReverseCharging=x25CallParmProposeReverseCharging, x25CircuitOutOctets=x25CircuitOutOctets, x25OperClearCount=x25OperClearCount, x25StatTwowayCircuits=x25StatTwowayCircuits, x25StatInProviderInitiatedResets=x25StatInProviderInitiatedResets, x25ClearedCircuitClearingCause=x25ClearedCircuitClearingCause, x25CallParmIndex=x25CallParmIndex, x25CallParmEndTrnsDly=x25CallParmEndTrnsDly, x25StatEntry=x25StatEntry, x25AdmnRegistrationRequestCount=x25AdmnRegistrationRequestCount, x25OperDefCallParamId=x25OperDefCallParamId, x25ClearedCircuitTable=x25ClearedCircuitTable, x25ClearedCircuitPleIndex=x25ClearedCircuitPleIndex, x25ClearedCircuitTimeEstablished=x25ClearedCircuitTimeEstablished, x25StatInRestarts=x25StatInRestarts, x25CallParmBcug=x25CallParmBcug, x25AdmnMaxActiveCircuits=x25AdmnMaxActiveCircuits, x25OperProtocolVersionSupported=x25OperProtocolVersionSupported, x25OperRejectTimer=x25OperRejectTimer, x25protocolCcittV1976=x25protocolCcittV1976, x25ClearedCircuitEntriesGranted=x25ClearedCircuitEntriesGranted, x25CallParmRpoa=x25CallParmRpoa, x25StatInAccusedOfProtocolErrors=x25StatInAccusedOfProtocolErrors, x25StatClearCountExceededs=x25StatClearCountExceededs, x25OperInterfaceMode=x25OperInterfaceMode, x25ChannelIndex=x25ChannelIndex, x25AdmnInterfaceMode=x25AdmnInterfaceMode, x25AdmnLocalAddress=x25AdmnLocalAddress, x25AdmnClearTimer=x25AdmnClearTimer, x25CallParmFastSelect=x25CallParmFastSelect, x25AdmnTable=x25AdmnTable, x25AdmnRegistrationRequestTimer=x25AdmnRegistrationRequestTimer, x25CircuitStatus=x25CircuitStatus, x25StatInRemotelyInitiatedResets=x25StatInRemotelyInitiatedResets, x25StatInCallRefusals=x25StatInCallRefusals, x25CircuitEntry=x25CircuitEntry, x25ClearedCircuitEntriesRequested=x25ClearedCircuitEntriesRequested, x25StatIncomingCircuits=x25StatIncomingCircuits, x25ProtocolVersion=x25ProtocolVersion, x25OperEntry=x25OperEntry, x25CallParmCallingNetworkFacilities=x25CallParmCallingNetworkFacilities, x25CircuitInOctets=x25CircuitInOctets, x25CallParmEntry=x25CallParmEntry, x25CircuitOutPdus=x25CircuitOutPdus, x25OperClearTimer=x25OperClearTimer, x25OperDataRxmtTimer=x25OperDataRxmtTimer, x25OperMinimumRecallTimer=x25OperMinimumRecallTimer, x25OperRegistrationRequestCount=x25OperRegistrationRequestCount, x25CallParmOutMinThuPutCls=x25CallParmOutMinThuPutCls, x25CircuitIndex=x25CircuitIndex, x25OperPacketSequencing=x25OperPacketSequencing, x25AdmnIndex=x25AdmnIndex, x25AdmnClearCount=x25AdmnClearCount, x25CircuitInRemotelyInitiatedResets=x25CircuitInRemotelyInitiatedResets, x25CallParmInWindowSize=x25CallParmInWindowSize, x25CallParmCallingExt=x25CallParmCallingExt, x25OperTable=x25OperTable, x25CircuitDirection=x25CircuitDirection, x25OperCallTimer=x25OperCallTimer, x25OperIndex=x25OperIndex, x25StatInDataPackets=x25StatInDataPackets, x25CircuitCallParamId=x25CircuitCallParamId, x25OperDataRxmtCount=x25OperDataRxmtCount, x25CallParmAcceptReverseCharging=x25CallParmAcceptReverseCharging, x25StatClearTimeouts=x25StatClearTimeouts, x25ClearedCircuitInPdus=x25ClearedCircuitInPdus, x25AdmnRestartCount=x25AdmnRestartCount, x25StatOutInterrupts=x25StatOutInterrupts, x25AdmnResetCount=x25AdmnResetCount, x25StatResetTimeouts=x25StatResetTimeouts, x25ClearedCircuitOutPdus=x25ClearedCircuitOutPdus, x25=x25, x25ClearedCircuitChannel=x25ClearedCircuitChannel, x25ClearedCircuitDiagnosticCode=x25ClearedCircuitDiagnosticCode, x25CircuitResetTimeouts=x25CircuitResetTimeouts, x25CallParmRefCount=x25CallParmRefCount, x25OperRestartCount=x25OperRestartCount, x25ChannelHTC=x25ChannelHTC, x25CircuitEstablishTime=x25CircuitEstablishTime, x25ChannelLTC=x25ChannelLTC, x25CircuitInInterrupts=x25CircuitInInterrupts, x25CircuitChannel=x25CircuitChannel, x25CallParmExptData=x25CallParmExptData, x25StatInterruptTimeouts=x25StatInterruptTimeouts, x25OperResetCount=x25OperResetCount, x25AdmnResetTimer=x25AdmnResetTimer, x25OperNumberPVCs=x25OperNumberPVCs, x25CircuitInProviderInitiatedResets=x25CircuitInProviderInitiatedResets, x25CallParmTrnstDly=x25CallParmTrnstDly, x25ChannelLOC=x25ChannelLOC, x25CallParmNui=x25CallParmNui, x25AdmnMinimumRecallTimer=x25AdmnMinimumRecallTimer, x25StatTable=x25StatTable, x25ClearedCircuitTimeCleared=x25ClearedCircuitTimeCleared, x25OperRejectCount=x25OperRejectCount, x25StatRestartTimeouts=x25StatRestartTimeouts, x25CircuitOriginallyCalledAddress=x25CircuitOriginallyCalledAddress, x25ClearedCircuitCalledAddress=x25ClearedCircuitCalledAddress, x25AdmnInterruptTimer=x25AdmnInterruptTimer, x25AdmnDefCallParamId=x25AdmnDefCallParamId, x25CallParmCug=x25CallParmCug, x25ChannelHIC=x25ChannelHIC)
