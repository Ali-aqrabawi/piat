...
# ASN.1 source file:///usr/share/snmp/mibs/ietf/MPLS-TE-STD-MIB
...
MplsBitRate, MplsLSPID, MplsBurstSize, TeHopAddress, TeHopAddressType, mplsStdMIB, TeHopAddressAS, TeHopAddressUnnum, MplsExtendedTunnelId, MplsPathIndex, MplsTunnelInstanceIndex, MplsTunnelIndex, MplsTunnelAffinity, MplsPathIndexOrZero, MplsOwner = mibBuilder.importSymbols("MPLS-TC-STD-MIB", "MplsBitRate", "MplsLSPID", "MplsBurstSize", "TeHopAddress", "TeHopAddressType", "mplsStdMIB", "TeHopAddressAS", "TeHopAddressUnnum", "MplsExtendedTunnelId", "MplsPathIndex", "MplsTunnelInstanceIndex", "MplsTunnelIndex", "MplsTunnelAffinity", "MplsPathIndexOrZero", "MplsOwner")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, Counter32, Counter64, zeroDotZero, NotificationType, Integer32, IpAddress, Unsigned32, ModuleIdentity, Bits, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "Counter32", "Counter64", "zeroDotZero", "NotificationType", "Integer32", "IpAddress", "Unsigned32", "ModuleIdentity", "Bits", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("MPLS-TE-STD-MIB", mplsTunnelMaxHops=mplsTunnelMaxHops, mplsTunnelNotificationMaxRate=mplsTunnelNotificationMaxRate, mplsTunnelHopInclude=mplsTunnelHopInclude, mplsTeObjects=mplsTeObjects, mplsTeModuleReadOnlyCompliance=mplsTeModuleReadOnlyCompliance, mplsTunnelLocalProtectInUse=mplsTunnelLocalProtectInUse, mplsTunnelPerfErrors=mplsTunnelPerfErrors, mplsTunnelPerfHCBytes=mplsTunnelPerfHCBytes, mplsTunnelGroup=mplsTunnelGroup, mplsTunnelCHopTable=mplsTunnelCHopTable, mplsTunnelUp=mplsTunnelUp, mplsTunnelHopType=mplsTunnelHopType, mplsTeCompliances=mplsTeCompliances, mplsTunnelXCPointer=mplsTunnelXCPointer, mplsTunnelPathInUse=mplsTunnelPathInUse, mplsTunnelResourceFrequency=mplsTunnelResourceFrequency, mplsTunnelPrimaryInstance=mplsTunnelPrimaryInstance, mplsTunnelSessionAttributes=mplsTunnelSessionAttributes, mplsTunnelOwner=mplsTunnelOwner, mplsTunnelPathChanges=mplsTunnelPathChanges, mplsTunnelCHopLspId=mplsTunnelCHopLspId, mplsTunnelResourceMaxBurstSize=mplsTunnelResourceMaxBurstSize, mplsTunnelHopPathOptionIndex=mplsTunnelHopPathOptionIndex, mplsTunnelARHopIpAddr=mplsTunnelARHopIpAddr, mplsTunnelConfigured=mplsTunnelConfigured, mplsTunnelIsNotIntfcGroup=mplsTunnelIsNotIntfcGroup, mplsTunnelCRLDPResTable=mplsTunnelCRLDPResTable, mplsTunnelCRLDPResWeight=mplsTunnelCRLDPResWeight, mplsTunnelStateTransitions=mplsTunnelStateTransitions, mplsTunnelNotificationEnable=mplsTunnelNotificationEnable, mplsTunnelHoldingPrio=mplsTunnelHoldingPrio, mplsTunnelARHopTable=mplsTunnelARHopTable, mplsTunnelRerouted=mplsTunnelRerouted, mplsTunnelHopListIndexNext=mplsTunnelHopListIndexNext, mplsTunnelReoptimized=mplsTunnelReoptimized, mplsTunnelCRLDPResMeanBurstSize=mplsTunnelCRLDPResMeanBurstSize, mplsTunnelCHopIndex=mplsTunnelCHopIndex, mplsTunnelCreationTime=mplsTunnelCreationTime, mplsTunnelARHopAddrUnnum=mplsTunnelARHopAddrUnnum, mplsTunnelSignallingProto=mplsTunnelSignallingProto, mplsTunnelInstanceUpTime=mplsTunnelInstanceUpTime, mplsTunnelPerfPackets=mplsTunnelPerfPackets, mplsTunnelHopIpAddr=mplsTunnelHopIpAddr, mplsTunnelEgressLSRId=mplsTunnelEgressLSRId, mplsTunnelIsIf=mplsTunnelIsIf, mplsTunnelSignaledGroup=mplsTunnelSignaledGroup, mplsTunnelCHopAddrType=mplsTunnelCHopAddrType, mplsTunnelResourceStorageType=mplsTunnelResourceStorageType, mplsTunnelSetupPrio=mplsTunnelSetupPrio, mplsTunnelResourceMaxRate=mplsTunnelResourceMaxRate, mplsTunnelStorageType=mplsTunnelStorageType, mplsTunnelHopEntryPathComp=mplsTunnelHopEntryPathComp, mplsTunnelHopPathOptionName=mplsTunnelHopPathOptionName, mplsTeNotifications=mplsTeNotifications, mplsTunnelIncludeAllAffinity=mplsTunnelIncludeAllAffinity, mplsTunnelCHopAsNumber=mplsTunnelCHopAsNumber, mplsTunnelCHopType=mplsTunnelCHopType, mplsTunnelOperStatus=mplsTunnelOperStatus, mplsTunnelResourceEntry=mplsTunnelResourceEntry, mplsTunnelTEDistProto=mplsTunnelTEDistProto, mplsTunnelHopLspId=mplsTunnelHopLspId, mplsTeNotificationGroup=mplsTeNotificationGroup, mplsTeConformance=mplsTeConformance, mplsTunnelHopAddrType=mplsTunnelHopAddrType, mplsTunnelCHopTableIndex=mplsTunnelCHopTableIndex, mplsTunnelIsIntfcGroup=mplsTunnelIsIntfcGroup, mplsTunnelPerfTable=mplsTunnelPerfTable, mplsTunnelIndex=mplsTunnelIndex, mplsTunnelExcludeAnyAffinity=mplsTunnelExcludeAnyAffinity, mplsTunnelARHopIndex=mplsTunnelARHopIndex, mplsTunnelIndexNext=mplsTunnelIndexNext, mplsTeScalars=mplsTeScalars, mplsTunnelIfIndex=mplsTunnelIfIndex, mplsTunnelEntry=mplsTunnelEntry, mplsTunnelARHopListIndex=mplsTunnelARHopListIndex, mplsTunnelHopTable=mplsTunnelHopTable, mplsTunnelHopStorageType=mplsTunnelHopStorageType, mplsTunnelARHopLspId=mplsTunnelARHopLspId, mplsTunnelPerfEntry=mplsTunnelPerfEntry, mplsTunnelCRLDPResExBurstSize=mplsTunnelCRLDPResExBurstSize, mplsTunnelName=mplsTunnelName, mplsTunnelTable=mplsTunnelTable, mplsTunnelInstance=mplsTunnelInstance, mplsTunnelCHopListIndex=mplsTunnelCHopListIndex, mplsTunnelResourceExBurstSize=mplsTunnelResourceExBurstSize, mplsTeStdMIB=mplsTeStdMIB, mplsTunnelHopAsNumber=mplsTunnelHopAsNumber, mplsTunnelCRLDPResStorageType=mplsTunnelCRLDPResStorageType, mplsTunnelResourcePointer=mplsTunnelResourcePointer, mplsTunnelLastPathChange=mplsTunnelLastPathChange, mplsTunnelHopIpPrefixLen=mplsTunnelHopIpPrefixLen, mplsTunnelResourceWeight=mplsTunnelResourceWeight, mplsTunnelHopIndex=mplsTunnelHopIndex, mplsTunnelActive=mplsTunnelActive, mplsTunnelIncludeAnyAffinity=mplsTunnelIncludeAnyAffinity, mplsTeModuleFullCompliance=mplsTeModuleFullCompliance, mplsTunnelCHopIpPrefixLen=mplsTunnelCHopIpPrefixLen, mplsTunnelHopRowStatus=mplsTunnelHopRowStatus, mplsTunnelRole=mplsTunnelRole, mplsTunnelTotalUpTime=mplsTunnelTotalUpTime, mplsTunnelIngressLSRId=mplsTunnelIngressLSRId, mplsTunnelDown=mplsTunnelDown, mplsTunnelHopAddrUnnum=mplsTunnelHopAddrUnnum, mplsTunnelManualGroup=mplsTunnelManualGroup, mplsTunnelPrimaryUpTime=mplsTunnelPrimaryUpTime, mplsTunnelHopTableIndex=mplsTunnelHopTableIndex, mplsTunnelHopEntry=mplsTunnelHopEntry, mplsTunnelCHopIpAddr=mplsTunnelCHopIpAddr, mplsTunnelDescr=mplsTunnelDescr, mplsTunnelPerfHCPackets=mplsTunnelPerfHCPackets, mplsTunnelCRLDPResOptionalGroup=mplsTunnelCRLDPResOptionalGroup, mplsTunnelHopListIndex=mplsTunnelHopListIndex, mplsTeGroups=mplsTeGroups, mplsTunnelRowStatus=mplsTunnelRowStatus, mplsTunnelPerfBytes=mplsTunnelPerfBytes, mplsTunnelCRLDPResFrequency=mplsTunnelCRLDPResFrequency, mplsTunnelCRLDPResRowStatus=mplsTunnelCRLDPResRowStatus, mplsTunnelARHopTableIndex=mplsTunnelARHopTableIndex, mplsTunnelResourceIndexNext=mplsTunnelResourceIndexNext, mplsTunnelResourceMeanRate=mplsTunnelResourceMeanRate, mplsTunnelInstancePriority=mplsTunnelInstancePriority, mplsTunnelCHopAddrUnnum=mplsTunnelCHopAddrUnnum, mplsTunnelCHopEntry=mplsTunnelCHopEntry, mplsTunnelResourceTable=mplsTunnelResourceTable, mplsTunnelAdminStatus=mplsTunnelAdminStatus, mplsTunnelCRLDPResEntry=mplsTunnelCRLDPResEntry, mplsTunnelARHopAddrType=mplsTunnelARHopAddrType, mplsTunnelScalarGroup=mplsTunnelScalarGroup, mplsTunnelResourceMeanBurstSize=mplsTunnelResourceMeanBurstSize, mplsTunnelCRLDPResFlags=mplsTunnelCRLDPResFlags, mplsTunnelResourceIndex=mplsTunnelResourceIndex, PYSNMP_MODULE_ID=mplsTeStdMIB, mplsTunnelResourceRowStatus=mplsTunnelResourceRowStatus, mplsTunnelARHopEntry=mplsTunnelARHopEntry)
