...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-WAN-TOPOLOGY-MIB
...
NotificationType, iso, Bits, MibIdentifier, ModuleIdentity, Unsigned32, Integer32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Bits", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Integer32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-WAN-TOPOLOGY-MIB", cwtMIBCompliance2=cwtMIBCompliance2, cwtFeederType=cwtFeederType, cwtFeederInfoAdd=cwtFeederInfoAdd, ciscoWanTopologyMIBObjects=ciscoWanTopologyMIBObjects, ciscoWanTopologyMIB=ciscoWanTopologyMIB, cwtPrimIPIfName=cwtPrimIPIfName, cwtDBLastChange=cwtDBLastChange, cwtPrimIP=cwtPrimIP, cwtFeederName=cwtFeederName, cwtFeederLanIP=cwtFeederLanIP, cwtLinkIndex=cwtLinkIndex, cwtNodeInfoTimeOutFlag=cwtNodeInfoTimeOutFlag, cwtFeederPort=cwtFeederPort, cwtTopoInfoAdd=cwtTopoInfoAdd, cwtTopoDbFull=cwtTopoDbFull, cwtSecIPAddrType=cwtSecIPAddrType, PYSNMP_MODULE_ID=ciscoWanTopologyMIB, cwtTopoInfoDelete=cwtTopoInfoDelete, cwtLocalIfIndex=cwtLocalIfIndex, cwtFeederMIBGroups=cwtFeederMIBGroups, cwtFeederRowStatus=cwtFeederRowStatus, cwtSystemGroup=cwtSystemGroup, cwtIndex=cwtIndex, cwtFeederSlot=cwtFeederSlot, cwtLinkInfoGroup=cwtLinkInfoGroup, cwtNodeId=cwtNodeId, cwtLinkOutsideLink=cwtLinkOutsideLink, cwtLinkLocalIfIndex=cwtLinkLocalIfIndex, cwtNodalInfoGroup=cwtNodalInfoGroup, cwtFeederInfoDelete=cwtFeederInfoDelete, cwtLinkRowStatus=cwtLinkRowStatus, ciscoWanTopologyMIBNotifs=ciscoWanTopologyMIBNotifs, cwtLinkInfoDelete=cwtLinkInfoDelete, cwtNodeInfoTable=cwtNodeInfoTable, cwtMIBCompliances=cwtMIBCompliances, cwtGatewayNodeFlag=cwtGatewayNodeFlag, cwtNodeName=cwtNodeName, cwtGatewayNodeOperStatus=cwtGatewayNodeOperStatus, cwtGatewayAdminStatus=cwtGatewayAdminStatus, cwtSecIPIfType=cwtSecIPIfType, cwtSecIPIfName=cwtSecIPIfName, cwtLinkLocalPhysicalId=cwtLinkLocalPhysicalId, cwtMIBCompliance=cwtMIBCompliance, cwtMIBConformance=cwtMIBConformance, cwtFeederAtmIPAddrType=cwtFeederAtmIPAddrType, cwtLinkRemoteNodeId=cwtLinkRemoteNodeId, cwtLinkInfoAdd=cwtLinkInfoAdd, cwtMIBGroups=cwtMIBGroups, cwtNodalMIBGroups=cwtNodalMIBGroups, cwtSecIP=cwtSecIP, cwtConfigGatewayStatus=cwtConfigGatewayStatus, cwtLinkRemoteIfIndex=cwtLinkRemoteIfIndex, cwtLinkInfoTable=cwtLinkInfoTable, cwtLinkInfoEntry=cwtLinkInfoEntry, cwtLocalIfName=cwtLocalIfName, cwtNotificationsGroup3=cwtNotificationsGroup3, cwtFeederInfoGroup=cwtFeederInfoGroup, cwtNodeInfoEntry=cwtNodeInfoEntry, cwtPrimIPIfType=cwtPrimIPIfType, cwtPrimIPAddrType=cwtPrimIPAddrType, cwtLinkLocalNodeId=cwtLinkLocalNodeId, cwtLinkRemotePhysicalId=cwtLinkRemotePhysicalId, cwtLinkInfoTimeOutFlag=cwtLinkInfoTimeOutFlag, cwtSysObjId=cwtSysObjId, cwtFeederAtmIP=cwtFeederAtmIP, cwtTopoInfoModify=cwtTopoInfoModify, cwtRowStatus=cwtRowStatus, cwtNotificationsGroup=cwtNotificationsGroup, cwtSystemMIBGroups=cwtSystemMIBGroups, cwtLinkInfoModify=cwtLinkInfoModify, CwtNodeInfoTableIndex=CwtNodeInfoTableIndex, cwtFeederInfoTable=cwtFeederInfoTable, cwtFeederInfoEntry=cwtFeederInfoEntry, cwtLocalNodeId=cwtLocalNodeId, cwtFeederLanIPAddrType=cwtFeederLanIPAddrType, cwtFeederInfoModify=cwtFeederInfoModify, cwtFeederShelf=cwtFeederShelf, cwtMIBCompliance3=cwtMIBCompliance3, cwtFeederLMIType=cwtFeederLMIType, cwtFeederModelNumber=cwtFeederModelNumber, cwtFeederIndex=cwtFeederIndex, cwtNotificationsGroup2=cwtNotificationsGroup2, cwtLinkMIBGroups=cwtLinkMIBGroups)
