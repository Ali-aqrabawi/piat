...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-CALL-TRACKER-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:39:47 2019
...
Counter32, NotificationType, Unsigned32, ModuleIdentity, TimeTicks, Gauge32, ObjectIdentity, iso, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Unsigned32", "ModuleIdentity", "TimeTicks", "Gauge32", "ObjectIdentity", "iso", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("CISCO-CALL-TRACKER-MIB", cctHistoryCallId=cctHistoryCallId, cctActiveGroupRev1=cctActiveGroupRev1, cctActiveInitialTxRate=cctActiveInitialTxRate, cctActiveUserSubnetMask=cctActiveUserSubnetMask, cctActiveChargedUnits=cctActiveChargedUnits, cctActiveAccountingSessionId=cctActiveAccountingSessionId, cctMIBNotificationPrefix=cctMIBNotificationPrefix, cctActiveEntryPort=cctActiveEntryPort, cctActiveServiceUpTime=cctActiveServiceUpTime, cctGeneralGroup=cctGeneralGroup, cctHistoryEntryPort=cctHistoryEntryPort, cctCallSetupTermNotifyEnable=cctCallSetupTermNotifyEnable, cctHistoryEntryDs1=cctHistoryEntryDs1, cctHistoryReceiveBytes=cctHistoryReceiveBytes, cctHistoryEntryChannel=cctHistoryEntryChannel, cctHistoryChargedUnits=cctHistoryChargedUnits, cctActiveSetupTime=cctActiveSetupTime, cctMIBGroups=cctMIBGroups, cctMIBComplianceRev1=cctMIBComplianceRev1, cctActiveEntry=cctActiveEntry, cctHistoryTableNumberEntries=cctHistoryTableNumberEntries, cctActiveMpBundleId=cctActiveMpBundleId, cctHistoryResourcePort=cctHistoryResourcePort, cctHistoryTableEntriesLimit=cctHistoryTableEntriesLimit, cctHistoryCallingPartyId=cctHistoryCallingPartyId, cctNotificationConfigGroup=cctNotificationConfigGroup, cctMIBObjects=cctMIBObjects, cctGeneral=cctGeneral, cctActiveInitialRxRate=cctActiveInitialRxRate, cctCallIdPrefix=cctCallIdPrefix, cctMIBNotifications=cctMIBNotifications, cctActive=cctActive, cctHistoryTableRetainTimer=cctHistoryTableRetainTimer, cctActiveTableHighWaterMark=cctActiveTableHighWaterMark, cctHistoryTableMaxEntries=cctHistoryTableMaxEntries, cctHistoryTableNewestIndex=cctHistoryTableNewestIndex, cctHistoryAccountingSessionId=cctHistoryAccountingSessionId, cctHistoryEntrySlot=cctHistoryEntrySlot, cctActiveCalledPartyId=cctActiveCalledPartyId, cctActiveServiceType=cctActiveServiceType, cctActiveResourcePort=cctActiveResourcePort, cctHistoryInitialRxRate=cctHistoryInitialRxRate, cctHistoryTableHighWaterMark=cctHistoryTableHighWaterMark, cctActivePhysicalLayerReadyTime=cctActivePhysicalLayerReadyTime, cctHistoryCalledPartyId=cctHistoryCalledPartyId, CctCallSigType=CctCallSigType, ciscoCallTrackerMIB=ciscoCallTrackerMIB, cctCallSetupNotification=cctCallSetupNotification, cctActiveOrigin=cctActiveOrigin, cctNotificationGroup=cctNotificationGroup, cctHistoryTable=cctHistoryTable, cctNotificationConfig=cctNotificationConfig, cctActiveEntryChannel=cctActiveEntryChannel, cctHistoryInitialTxRate=cctHistoryInitialTxRate, cctActiveTable=cctActiveTable, cctActiveCallSignalingType=cctActiveCallSignalingType, cctActiveGroup=cctActiveGroup, cctHistoryServiceUpTime=cctHistoryServiceUpTime, cctHistoryResourceSlot=cctHistoryResourceSlot, cctHistoryUserSubnetMask=cctHistoryUserSubnetMask, cctHistoryGroupRev1=cctHistoryGroupRev1, cctHistoryMpBundleId=cctHistoryMpBundleId, CctCallId=CctCallId, cctActiveUserIpAddr=cctActiveUserIpAddr, cctHistory=cctHistory, cctHistoryCallSignalingType=cctHistoryCallSignalingType, cctHistoryGroup=cctHistoryGroup, cctMIBCompliances=cctMIBCompliances, CctCallCategory=CctCallCategory, cctActiveResourceSlot=cctActiveResourceSlot, cctHistorySetupTime=cctHistorySetupTime, cctHistoryPhysicalLayerReadyTime=cctHistoryPhysicalLayerReadyTime, cctMIBCompliance=cctMIBCompliance, cctActiveTableNumberEntries=cctActiveTableNumberEntries, cctCallTerminateNotification=cctCallTerminateNotification, cctActiveUserId=cctActiveUserId, cctActiveTransmitBytes=cctActiveTransmitBytes, cctActiveUserValidationTime=cctActiveUserValidationTime, cctActiveReceiveBytes=cctActiveReceiveBytes, cctHistoryUserId=cctHistoryUserId, CctServiceType=CctServiceType, cctHistoryOrigin=cctHistoryOrigin, cctMIBConformance=cctMIBConformance, cctActiveEntrySlot=cctActiveEntrySlot, cctActiveEntryDs1=cctActiveEntryDs1, cctActiveConnectionTime=cctActiveConnectionTime, cctHistoryDisconnectReasonText=cctHistoryDisconnectReasonText, PYSNMP_MODULE_ID=ciscoCallTrackerMIB, cctHistoryTransmitBytes=cctHistoryTransmitBytes, cctHistoryEntry=cctHistoryEntry, cctHistoryCallCategory=cctHistoryCallCategory, cctActiveCallCategory=cctActiveCallCategory, cctHistoryConnectionTime=cctHistoryConnectionTime, cctHistoryDisconnectTime=cctHistoryDisconnectTime, cctActiveCallingPartyId=cctActiveCallingPartyId, cctHistoryUserIpAddr=cctHistoryUserIpAddr, cctHistoryServiceType=cctHistoryServiceType, cctActiveCallId=cctActiveCallId, cctHistoryUserValidationTime=cctHistoryUserValidationTime, cctHistoryIndex=cctHistoryIndex)
