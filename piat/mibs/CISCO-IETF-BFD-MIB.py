...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IETF-BFD-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:31:50 2019
...
Counter32, iso, Integer32, IpAddress, Unsigned32, NotificationType, ModuleIdentity, Counter64, MibIdentifier, Bits, ObjectIdentity, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Integer32", "IpAddress", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter64", "MibIdentifier", "Bits", "ObjectIdentity", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CISCO-IETF-BFD-MIB", ciscoBfdSession04Group=ciscoBfdSession04Group, ciscoBfdSessDemandModeDesiredFlag=ciscoBfdSessDemandModeDesiredFlag, ciscoBfdSessVersionNumber=ciscoBfdSessVersionNumber, CiscoBfdDiag=CiscoBfdDiag, ciscoBfdSessApplicationId=ciscoBfdSessApplicationId, ciscoBfdSessAuthPresFlag=ciscoBfdSessAuthPresFlag, ciscoBfdModuleFullComplianceRev2=ciscoBfdModuleFullComplianceRev2, ciscoBfdConformance=ciscoBfdConformance, ciscoBfdSessionPerfHCGroup=ciscoBfdSessionPerfHCGroup, ciscoBfdSessAuthenticationType=ciscoBfdSessAuthenticationType, CiscoBfdSessIndexTC=CiscoBfdSessIndexTC, PYSNMP_MODULE_ID=ciscoIetfBfdMIB, ciscoBfdSessPerfLastSessDownTime=ciscoBfdSessPerfLastSessDownTime, ciscoBfdScalarObjects=ciscoBfdScalarObjects, ciscoBfdSessUpTime=ciscoBfdSessUpTime, ciscoBfdSessInterface=ciscoBfdSessInterface, ciscoBfdSessIpMapEntry=ciscoBfdSessIpMapEntry, ciscoBfdSessPerfSessUpCount=ciscoBfdSessPerfSessUpCount, ciscoIetfBfdMIB=ciscoIetfBfdMIB, ciscoBfdSessPerfPktIn=ciscoBfdSessPerfPktIn, ciscoBfdSessUdpPort=ciscoBfdSessUdpPort, ciscoBfdSessState=ciscoBfdSessState, ciscoBfdSessAddr=ciscoBfdSessAddr, ciscoBfdSessRowStatus=ciscoBfdSessRowStatus, ciscoBfdSessDiscMapEntry=ciscoBfdSessDiscMapEntry, ciscoBfdCompliances=ciscoBfdCompliances, ciscoBfdSessNotificationsEnable=ciscoBfdSessNotificationsEnable, ciscoBfdSessStorType=ciscoBfdSessStorType, ciscoBfdSessDown=ciscoBfdSessDown, ciscoBfdGroups=ciscoBfdGroups, ciscoBfdSessMapTable=ciscoBfdSessMapTable, ciscoBfdSessPerfPktInHC=ciscoBfdSessPerfPktInHC, ciscoBfdSessDiscMapTable=ciscoBfdSessDiscMapTable, ciscoBfdSessUp=ciscoBfdSessUp, ciscoBfdSessType=ciscoBfdSessType, ciscoBfdSessDiscMapIndex=ciscoBfdSessDiscMapIndex, ciscoBfdSessIpMapTable=ciscoBfdSessIpMapTable, ciscoBfdSessDetectMult=ciscoBfdSessDetectMult, ciscoBfdSessPerfDiscTime=ciscoBfdSessPerfDiscTime, ciscoBfdNotifications=ciscoBfdNotifications, ciscoBfdSessTable=ciscoBfdSessTable, ciscoBfdSessDiscriminator=ciscoBfdSessDiscriminator, ciscoBfdAdminStatus=ciscoBfdAdminStatus, ciscoBfdSessPerfTable=ciscoBfdSessPerfTable, CiscoBfdInterval=CiscoBfdInterval, ciscoBfdSessOperMode=ciscoBfdSessOperMode, ciscoBfdSessPerfPktOut=ciscoBfdSessPerfPktOut, ciscoBfdSessionGroup=ciscoBfdSessionGroup, ciscoBfdSessPerfPktOutHC=ciscoBfdSessPerfPktOutHC, ciscoBfdSessionPerfGroup=ciscoBfdSessionPerfGroup, ciscoBfdObjects=ciscoBfdObjects, ciscoBfdSessAddrType=ciscoBfdSessAddrType, ciscoBfdSessPerfEntry=ciscoBfdSessPerfEntry, ciscoBfdSessControlPlanIndepFlag=ciscoBfdSessControlPlanIndepFlag, ciscoBfdSession0304Group=ciscoBfdSession0304Group, ciscoBfdSessPerfLastCommLostDiag=ciscoBfdSessPerfLastCommLostDiag, ciscoBfdSessIpMapIndex=ciscoBfdSessIpMapIndex, ciscoBfdSessIndex=ciscoBfdSessIndex, ciscoBfdSessEntry=ciscoBfdSessEntry, ciscoBfdSession03Group=ciscoBfdSession03Group, ciscoBfdSessEchoFuncModeDesiredFlag=ciscoBfdSessEchoFuncModeDesiredFlag, ciscoBfdModuleFullCompliance=ciscoBfdModuleFullCompliance, ciscoBfdSessDiag=ciscoBfdSessDiag, ciscoBfdSessRemoteDiscr=ciscoBfdSessRemoteDiscr, ciscoBfdNotificationGroup=ciscoBfdNotificationGroup, ciscoBfdSessDesiredMinTxInterval=ciscoBfdSessDesiredMinTxInterval, ciscoBfdSessMapBfdIndex=ciscoBfdSessMapBfdIndex, ciscoBfdSessMapEntry=ciscoBfdSessMapEntry, ciscoBfdVersionNumber=ciscoBfdVersionNumber, ciscoBfdSessReqMinRxInterval=ciscoBfdSessReqMinRxInterval, ciscoBfdSessRemoteHeardFlag=ciscoBfdSessRemoteHeardFlag, ciscoBfdSessReqMinEchoRxInterval=ciscoBfdSessReqMinEchoRxInterval)
