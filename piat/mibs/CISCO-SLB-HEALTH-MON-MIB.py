...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-SLB-HEALTH-MON-MIB
...
cslbxServerProbes, SlbUrlString, SlbFunctionNameString = mibBuilder.importSymbols("CISCO-SLB-EXT-MIB", "cslbxServerProbes", "SlbUrlString", "SlbFunctionNameString")
slbServerFarmName, SlbServerString, slbEntity = mibBuilder.importSymbols("CISCO-SLB-MIB", "slbServerFarmName", "SlbServerString", "slbEntity")
...
RowStatus, TextualConvention, DateAndTime, TruthValue, DisplayString, TimeInterval = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "DateAndTime", "TruthValue", "DisplayString", "TimeInterval")
...
mibBuilder.exportSymbols("CISCO-SLB-HEALTH-MON-MIB", cslbxProbeSendData=cslbxProbeSendData, cslbxProbeIMAPMethodName=cslbxProbeIMAPMethodName, ciscoSlbHealthMonNotifObjects=ciscoSlbHealthMonNotifObjects, cslbxProbeHeaderRowStatus=cslbxProbeHeaderRowStatus, cslbxProbeExpectStatusRowStatus=cslbxProbeExpectStatusRowStatus, cslbxProbeDnsDomainName=cslbxProbeDnsDomainName, cslbHealthMonHTTPProbesCommmonGroup=cslbHealthMonHTTPProbesCommmonGroup, cshMonServerfarmRealPassedProbes=cshMonServerfarmRealPassedProbes, ciscoSlbHealthMonMIBNotifs=ciscoSlbHealthMonMIBNotifs, ciscoSlbHealthMonMIBCompliance=ciscoSlbHealthMonMIBCompliance, cslbHealthMonHTTPSProbesGroup=cslbHealthMonHTTPSProbesGroup, cshMonSfarmRealProbesFailed=cshMonSfarmRealProbesFailed, cslbHealthMonFTPProbesGroup=cslbHealthMonFTPProbesGroup, ciscoSlbHealthMonMIB=ciscoSlbHealthMonMIB, cslbHealthMonHTTPSProbesGroupRev1=cslbHealthMonHTTPSProbesGroupRev1, cslbxProbeExpectStatusMaxValue=cslbxProbeExpectStatusMaxValue, cshMonServerfarmRealFailedProbes=cshMonServerfarmRealFailedProbes, cslbxProbeHTTPCfgHashName=cslbxProbeHTTPCfgHashName, cshMonProbeInheritedPortType=cshMonProbeInheritedPortType, cshMonServerfarmRealProbeLastFailedTime=cshMonServerfarmRealProbeLastFailedTime, cslbxProbePriority=cslbxProbePriority, cslbxProbeFTPCfgEntry=cslbxProbeFTPCfgEntry, cshMonProbeInheritedPort=cshMonProbeInheritedPort, cshMonSocketNormalUse=cshMonSocketNormalUse, ciscoSlbHealthMonMIBConformance=ciscoSlbHealthMonMIBConformance, cshMonServerfarmRealProbeHealthMonState=cshMonServerfarmRealProbeHealthMonState, cslbxProbeProtocolType=cslbxProbeProtocolType, cslbxDnsProbeIpRowStatus=cslbxDnsProbeIpRowStatus, cslbxProbeName=cslbxProbeName, cslbxProbeHeaderCfgEntry=cslbxProbeHeaderCfgEntry, cshMonServerfarmRealProbeStatsEntry=cshMonServerfarmRealProbeStatsEntry, cshMonServerfarmRealServerName=cshMonServerfarmRealServerName, cslbxProbeHTTPCfgTable=cslbxProbeHTTPCfgTable, cslbxProbeType=cslbxProbeType, cslbxProbeTftpRequestMethod=cslbxProbeTftpRequestMethod, ciscoSlbHealthMonMIBGroups=ciscoSlbHealthMonMIBGroups, cslbxDnsProbeIpTable=cslbxDnsProbeIpTable, cshMonSocketOverusageCount=cshMonSocketOverusageCount, PYSNMP_MODULE_ID=ciscoSlbHealthMonMIB, cslbHealthMonProbeScriptGroup=cslbHealthMonProbeScriptGroup, cshMonProbeTotalSentProbes=cshMonProbeTotalSentProbes, cslbxProbeHttpRequestUrl=cslbxProbeHttpRequestUrl, cshMonProbeTotalOpenTimeouts=cshMonProbeTotalOpenTimeouts, cslbxProbeTFTPCfgTable=cslbxProbeTFTPCfgTable, cslbxProbeFTPCfgTable=cslbxProbeFTPCfgTable, cslbxProbeTFTPCfgEntry=cslbxProbeTFTPCfgEntry, cslbxProbeHTTPCfgVersion=cslbxProbeHTTPCfgVersion, cslbxProbeConnTermination=cslbxProbeConnTermination, cslbHealthMonProbeCfgExtGroup=cslbHealthMonProbeCfgExtGroup, cslbxProbeHTTPCfgSslSessionReuse=cslbxProbeHTTPCfgSslSessionReuse, cslbxProbeRetries=cslbxProbeRetries, SlbProbeType=SlbProbeType, cshMonSfarmRealProbeStatsTable=cshMonSfarmRealProbeStatsTable, cslbxProbeRouteMethod=cslbxProbeRouteMethod, cslbxProbeIMAPMailBox=cslbxProbeIMAPMailBox, cshMonProbeTotalReceivedRSTs=cshMonProbeTotalReceivedRSTs, cslbxProbeAlternateDestAddr=cslbxProbeAlternateDestAddr, cslbxProbeHTTPCfgSslTlsVersion=cslbxProbeHTTPCfgSslTlsVersion, cshMonProbeTypeStatsEntry=cshMonProbeTypeStatsEntry, cslbxProbeHTTPCfgHashValid=cslbxProbeHTTPCfgHashValid, cshMonProbeTotalRefusedConns=cshMonProbeTotalRefusedConns, cslbxDnsProbeIpAddress=cslbxDnsProbeIpAddress, ciscoSlbHealthMonMIBComplianceRev1=ciscoSlbHealthMonMIBComplianceRev1, cshMonServerfarmRealProbeStatsTable=cshMonServerfarmRealProbeStatsTable, cslbxProbePassword=cslbxProbePassword, cslbxProbeState=cslbxProbeState, cslbxProbeExpectStatusCfgTable=cslbxProbeExpectStatusCfgTable, cslbHealthMonServerProbesGroup=cslbHealthMonServerProbesGroup, cshMonServerfarmRealProbeLastProbeTime=cshMonServerfarmRealProbeLastProbeTime, ciscoSlbHealthMonMIBComplianceRev2=ciscoSlbHealthMonMIBComplianceRev2, cslbxProbeFailedInterval=cslbxProbeFailedInterval, cslbxProbeHTTPCfgPersistence=cslbxProbeHTTPCfgPersistence, cshMonSfarmRealServerName=cshMonSfarmRealServerName, cslbxProbePassCount=cslbxProbePassCount, cslbxProbeSIPCfgTable=cslbxProbeSIPCfgTable, cshMonProbeTotalActiveSockets=cshMonProbeTotalActiveSockets, cslbHealthMonServerProbesGroupRev1=cslbHealthMonServerProbesGroupRev1, cslbxProbeHeaderProbeName=cslbxProbeHeaderProbeName, cslbxProbeHTTPCfgCipherSuite=cslbxProbeHTTPCfgCipherSuite, cslbxProbeTftpRequestFileName=cslbxProbeTftpRequestFileName, ciscoSlbHealthMonMIBCompliances=ciscoSlbHealthMonMIBCompliances, cshMonProbeTotalConnectionErrors=cshMonProbeTotalConnectionErrors, ciscoSlbHealthMonMIBComplianceRev3=ciscoSlbHealthMonMIBComplianceRev3, cslbxProbeTftpRequestFileType=cslbxProbeTftpRequestFileType, CiscoProbeHealthMonState=CiscoProbeHealthMonState, cshMonSfarmRealServerPort=cshMonSfarmRealServerPort, cslbHealthMonSIPProbesGroup=cslbHealthMonSIPProbesGroup, cslbxProbeRowStatus=cslbxProbeRowStatus, cslbHealthMonIMAPProbesGroup=cslbHealthMonIMAPProbesGroup, cslbxProbeReceiveTimeout=cslbxProbeReceiveTimeout, cshMonServerfarmRealServerPort=cshMonServerfarmRealServerPort, cshMonProbeTypeStatsGroup=cshMonProbeTypeStatsGroup, cshMonSfarmRealProbeStatsEntry=cshMonSfarmRealProbeStatsEntry, cshMonSocketOveruse=cshMonSocketOveruse, cslbxProbeHeaderFieldName=cslbxProbeHeaderFieldName, cshMonProbeTypeStatsTable=cshMonProbeTypeStatsTable, cshMonProbeTotalReceiveTimeouts=cshMonProbeTotalReceiveTimeouts, cslbxDnsProbeIpAddressType=cslbxDnsProbeIpAddressType, cslbxProbeExpectStatusMinValue=cslbxProbeExpectStatusMinValue, cslbxProbeIMAPCfgEntry=cslbxProbeIMAPCfgEntry, cshMonSfarmProbes=cshMonSfarmProbes, CiscoProbeInheritedPortType=CiscoProbeInheritedPortType, cslbHealthMonTFTPProbesGroup=cslbHealthMonTFTPProbesGroup, cslbxProbeCfgTable=cslbxProbeCfgTable, cslbxProbeHeaderFieldValue=cslbxProbeHeaderFieldValue, ciscoSlbHealthMonMIBObjects=ciscoSlbHealthMonMIBObjects, cslbxProbeAlternateDestAddrType=cslbxProbeAlternateDestAddrType, cslbxProbeScriptArguments=cslbxProbeScriptArguments, cslbxProbeHTTPSslTlsVersionSupported=cslbxProbeHTTPSslTlsVersionSupported, cshMonProbeTotalPassedProbes=cshMonProbeTotalPassedProbes, cshMonNotifGroup=cshMonNotifGroup, cslbxProbeHttpRequestMethod=cslbxProbeHttpRequestMethod, cslbxProbeFtpRequestFileType=cslbxProbeFtpRequestFileType, cslbxProbeTcpOpenTimeout=cslbxProbeTcpOpenTimeout, cslbxProbeSendDataType=cslbxProbeSendDataType, cslbxDnsProbeIpProbeName=cslbxDnsProbeIpProbeName, cslbxProbeExpectStatusProbeName=cslbxProbeExpectStatusProbeName, cslbxProbeSIPRegAddress=cslbxProbeSIPRegAddress, cshMonSfarmrealserverProbeStatsGroup=cshMonSfarmrealserverProbeStatsGroup, cslbxProbeDescription=cslbxProbeDescription, cslbxProbeUserName=cslbxProbeUserName, cslbxProbeHTTPCfgEntry=cslbxProbeHTTPCfgEntry, cslbxProbeExpectStatusCfgEntry=cslbxProbeExpectStatusCfgEntry, cslbxProbeScriptName=cslbxProbeScriptName, cshMonNotifObjectsGroup=cshMonNotifObjectsGroup, cslbxProbeSIPCfgEntry=cslbxProbeSIPCfgEntry, cslbxProbeSocketReuse=cslbxProbeSocketReuse, cshMonSfarmRealProbeHealthMonState=cshMonSfarmRealProbeHealthMonState, cslbxProbeCfgEntry=cslbxProbeCfgEntry, cslbxProbeFtpRequestMethod=cslbxProbeFtpRequestMethod, cslbxProbeIMAPCfgTable=cslbxProbeIMAPCfgTable, cslbxProbeFtpRequestFileName=cslbxProbeFtpRequestFileName, cslbxProbeInterval=cslbxProbeInterval, cshMonProbeTotalFailedProbes=cshMonProbeTotalFailedProbes, cslbxProbeHeaderCfgTable=cslbxProbeHeaderCfgTable, cshMonSfarmrealserverProbeStatsGroupRev1=cshMonSfarmrealserverProbeStatsGroupRev1, cshMonServerfarmRealProbeLastActiveTime=cshMonServerfarmRealProbeLastActiveTime, cslbxProbePort=cslbxProbePort, cshMonProbeTotalSendFailures=cshMonProbeTotalSendFailures, cslbxDnsProbeIpEntry=cslbxDnsProbeIpEntry, cshMonSfarmRealProbesPassed=cshMonSfarmRealProbesPassed)
