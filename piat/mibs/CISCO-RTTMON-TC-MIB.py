...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-RTTMON-TC-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:43:55 2019
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Counter64, IpAddress, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, ModuleIdentity, iso, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Counter64", "IpAddress", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "ModuleIdentity", "iso", "Bits", "Integer32")
...
mibBuilder.exportSymbols("CISCO-RTTMON-TC-MIB", RttMonRttType=RttMonRttType, RttMonOperation=RttMonOperation, PYSNMP_MODULE_ID=ciscoRttMonTCMIB, RttMplsVpnMonRttType=RttMplsVpnMonRttType, RttMonProtocol=RttMonProtocol, ciscoRttMonTCMIB=ciscoRttMonTCMIB, RttResponseSense=RttResponseSense, RttMplsVpnMonLpdGrpStatus=RttMplsVpnMonLpdGrpStatus, RttMonCtrlIndex=RttMonCtrlIndex, RttMonCodecType=RttMonCodecType, RttMonTargetAddress=RttMonTargetAddress, RttMplsVpnMonLpdFailureSense=RttMplsVpnMonLpdFailureSense, RttMonIdLst=RttMonIdLst, RttMonScheduleStartType=RttMonScheduleStartType, RttMonReactVar=RttMonReactVar, RttMonLSPPingReplyMode=RttMonLSPPingReplyMode, RttReset=RttReset)
