...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-IP-ADDRESS-POOL-MIB
...
IpAddressPoolNameOrNull, IpAddressPoolGroupNameOrNull, IpAddressPoolGroupName, IpAddrPoolInstanceIdentifierOrZero, IpAddressPoolThresholdUnits, IpAddrPoolInstanceIdentifier = mibBuilder.importSymbols("CISCO-IP-ADDRESS-POOL-TC-MIB", "IpAddressPoolNameOrNull", "IpAddressPoolGroupNameOrNull", "IpAddressPoolGroupName", "IpAddrPoolInstanceIdentifierOrZero", "IpAddressPoolThresholdUnits", "IpAddrPoolInstanceIdentifier")
ciscoMgmt, = mibBuilder.importSymbols("CISCO-SMI", "ciscoMgmt")
InetAddress, InetAddressPrefixLength, InetAddressType = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddress", "InetAddressPrefixLength", "InetAddressType")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, MibIdentifier, Counter64, Gauge32, Counter32, Integer32, iso, NotificationType, Bits, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "MibIdentifier", "Counter64", "Gauge32", "Counter32", "Integer32", "iso", "NotificationType", "Bits", "ObjectIdentity", "Unsigned32")
RowStatus, TextualConvention, StorageType, DisplayString, TimeStamp, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "StorageType", "DisplayString", "TimeStamp", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("CISCO-IP-ADDRESS-POOL-MIB", ciapPools=ciapPools, ciapGlobalNotifyEnable=ciapGlobalNotifyEnable, ciapNotifyThresholdRising=ciapNotifyThresholdRising, ciapPoolThresholdRising=ciapPoolThresholdRising, ciapAllocatedAddressType=ciapAllocatedAddressType, ciapRangeStorage=ciapRangeStorage, ciapPrefixPrefixesFree=ciapPrefixPrefixesFree, ciapPoolGroupGroup=ciapPoolGroupGroup, ciapPoolGroupThresholdRising=ciapPoolGroupThresholdRising, ciapPrefixAddress=ciapPrefixAddress, ciapNotifDataGroup=ciapNotifDataGroup, ciapPoolGroupThresholdFalling=ciapPoolGroupThresholdFalling, ciapEventThresholdRising=ciapEventThresholdRising, ciapNotifyThresholdFalling=ciapNotifyThresholdFalling, ciapGlobalGroup=ciapGlobalGroup, ciapPoolName=ciapPoolName, ciapPoolGroup=ciapPoolGroup, ciapAllocatedAddressTable=ciapAllocatedAddressTable, ciapPoolGroupId=ciapPoolGroupId, ciapPrefixStorage=ciapPrefixStorage, ciapAllocatedAddresses=ciapAllocatedAddresses, ciapPoolContainedIn=ciapPoolContainedIn, ciapPoolGroupContainsId=ciapPoolGroupContainsId, ciapPrefixEntry=ciapPrefixEntry, ciapGlobalThresholdRising=ciapGlobalThresholdRising, ciapPrefixThresholdFalling=ciapPrefixThresholdFalling, ciapNotifyThresholdUnits=ciapNotifyThresholdUnits, ciapPoolStorage=ciapPoolStorage, ciapPoolId=ciapPoolId, ciscoIpAddressPoolMIBObjects=ciscoIpAddressPoolMIBObjects, ciscoIpAddressPoolMIBNotifs=ciscoIpAddressPoolMIBNotifs, ciapGlobalThresholdFalling=ciapGlobalThresholdFalling, ciapRangeStatus=ciapRangeStatus, ciapRangeAddressesFree=ciapRangeAddressesFree, ciapPrefixCacheSize=ciapPrefixCacheSize, ciapPoolAddressesInUse=ciapPoolAddressesInUse, ciapPoolIdNext=ciapPoolIdNext, ciapEventThresholdFalling=ciapEventThresholdFalling, ciscoIpAddressPoolMIBConform=ciscoIpAddressPoolMIBConform, ciapAllocatedAddressMask=ciapAllocatedAddressMask, ciapPrefixAddressMask=ciapPrefixAddressMask, ciapPrefixPriority=ciapPrefixPriority, ciapPoolGroupAddressesInUse=ciapPoolGroupAddressesInUse, ciapPrefixAssignedLength=ciapPrefixAssignedLength, ciapGlobalThresholdUnits=ciapGlobalThresholdUnits, PYSNMP_MODULE_ID=ciscoIpAddressPoolMIB, ciapRangePriority=ciapRangePriority, ciapAllocatedAddress=ciapAllocatedAddress, ciscoIpAddressPoolCompliance01=ciscoIpAddressPoolCompliance01, ciapPoolAddressesFree=ciapPoolAddressesFree, ciscoIpAddressPoolMIB=ciscoIpAddressPoolMIB, ciapNotifyInUse=ciapNotifyInUse, ciapRangeRecycleDelay=ciapRangeRecycleDelay, ciapPrefixPrefixesInUse=ciapPrefixPrefixesInUse, ciapRangeThresholdFalling=ciapRangeThresholdFalling, ciapPoolThresholdFalling=ciapPoolThresholdFalling, ciapRangeThresholdRising=ciapRangeThresholdRising, ciapPoolStatus=ciapPoolStatus, ciscoIpAddressPoolMIBGroups=ciscoIpAddressPoolMIBGroups, ciapRangeEntry=ciapRangeEntry, ciapPoolGroupThresholdUnits=ciapPoolGroupThresholdUnits, ciapPrefixGroup=ciapPrefixGroup, ciapGlobal=ciapGlobal, ciapPrefixTableChanged=ciapPrefixTableChanged, ciapPrefixType=ciapPrefixType, ciapNotifyData=ciapNotifyData, ciapPoolGroups=ciapPoolGroups, ciapRangeGroup=ciapRangeGroup, ciapPoolGroupName=ciapPoolGroupName, ciapRangeTableChanged=ciapRangeTableChanged, ciapPoolGroupEntry=ciapPoolGroupEntry, ciapPoolTableChanged=ciapPoolTableChanged, ciapPoolThresholdUnits=ciapPoolThresholdUnits, ciapNotifsGroup=ciapNotifsGroup, ciapPoolGroupContainsEntry=ciapPoolGroupContainsEntry, ciapPoolTable=ciapPoolTable, ciapPoolGroupTable=ciapPoolGroupTable, ciapRangeCacheSize=ciapRangeCacheSize, ciapPrefixThresholdUnits=ciapPrefixThresholdUnits, ciapRangeAddressType=ciapRangeAddressType, ciapPoolGroupIdNext=ciapPoolGroupIdNext, ciapNotifyFree=ciapNotifyFree, ciapPoolType=ciapPoolType, ciapPoolGroupAddressesFree=ciapPoolGroupAddressesFree, ciapPrefixThresholdRising=ciapPrefixThresholdRising, ciapRangeThresholdUnits=ciapRangeThresholdUnits, ciscoIpAddressPoolMIBCompliances=ciscoIpAddressPoolMIBCompliances, ciapPrefixRecycleDelay=ciapPrefixRecycleDelay, ciapPrefixTable=ciapPrefixTable, ciapRangeAddressesInUse=ciapRangeAddressesInUse, ciapRangeAddressLower=ciapRangeAddressLower, ciapPoolEntry=ciapPoolEntry, ciapPoolGroupContainsTable=ciapPoolGroupContainsTable, ciapAllocatedAddressEntry=ciapAllocatedAddressEntry, ciapNotifyResource=ciapNotifyResource, ciapRangeAddressUpper=ciapRangeAddressUpper, ciapPrefixStatus=ciapPrefixStatus, ciapRangeTable=ciapRangeTable)
