...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-FCPING-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:44:52 2019
...
FcAddressType, VsanIndex, FcAddress = mibBuilder.importSymbols("CISCO-ST-TC", "FcAddressType", "VsanIndex", "FcAddress")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
TimeTicks, Gauge32, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, NotificationType, Integer32, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "NotificationType", "Integer32", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso")
...
mibBuilder.exportSymbols("CISCO-FCPING-MIB", fcPingTxPackets=fcPingTxPackets, fcPingStatsEntry=fcPingStatsEntry, fcPingTable=fcPingTable, fcPingAvgRtt=fcPingAvgRtt, fcPingStats=fcPingStats, fcPingPacketTimeout=fcPingPacketTimeout, fcPingMIBGroups=fcPingMIBGroups, fcPingConfigGroup=fcPingConfigGroup, fcPingMaxRtt=fcPingMaxRtt, ciscoFcPingMIBObjects=ciscoFcPingMIBObjects, fcPingNumTimeouts=fcPingNumTimeouts, fcPingIndex=fcPingIndex, PYSNMP_MODULE_ID=ciscoFcPingMIB, fcPingTrapOnCompletion=fcPingTrapOnCompletion, fcPingAddressType=fcPingAddressType, fcPingCompletionNotify=fcPingCompletionNotify, fcPingVsanIndex=fcPingVsanIndex, fcPingPacketCount=fcPingPacketCount, fcPingMinRtt=fcPingMinRtt, fcPingNotifications=fcPingNotifications, fcPingMIBCompliance=fcPingMIBCompliance, fcPingRxPackets=fcPingRxPackets, fcPingRowStatus=fcPingRowStatus, fcPingNotifyGroup=fcPingNotifyGroup, fcPingAgeInterval=fcPingAgeInterval, fcPingConfiguration=fcPingConfiguration, fcPingDelay=fcPingDelay, fcPingEntry=fcPingEntry, fcPingMIBConformance=fcPingMIBConformance, fcPingStatsGroup=fcPingStatsGroup, fcPingUsrPriority=fcPingUsrPriority, fcPingStatsTable=fcPingStatsTable, fcPingAddress=fcPingAddress, fcPingPayloadSize=fcPingPayloadSize, ciscoFcPingMIB=ciscoFcPingMIB, fcPingOperStatus=fcPingOperStatus, fcPingNotification=fcPingNotification, FcStartOper=FcStartOper, fcPingMIBCompliances=fcPingMIBCompliances, fcPingAdminStatus=fcPingAdminStatus)
