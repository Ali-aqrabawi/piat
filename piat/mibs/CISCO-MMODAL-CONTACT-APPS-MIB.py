...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-MMODAL-CONTACT-APPS-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:42:09 2019
...
TimeTicks, iso, Integer32, IpAddress, Counter32, Unsigned32, ModuleIdentity, Gauge32, Counter64, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Integer32", "IpAddress", "Counter32", "Unsigned32", "ModuleIdentity", "Gauge32", "Counter64", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("CISCO-MMODAL-CONTACT-APPS-MIB", cmmcaRsIntContactDetailRecords=cmmcaRsIntContactDetailRecords, cmmcaRsRtDBPercentFree=cmmcaRsRtDBPercentFree, cmmcaRdaIntNumMsgProc=cmmcaRdaIntNumMsgProc, cmmcaBreAggTotalResourceInstanceTerminations=cmmcaBreAggTotalResourceInstanceTerminations, cmmcaServiceEntry=cmmcaServiceEntry, cmmcaRmAggNumOffersReject=cmmcaRmAggNumOffersReject, cmmcaRaAggTaskStateChangeMsgReceived=cmmcaRaAggTaskStateChangeMsgReceived, cmmcaRsRtDBSpaceUsed=cmmcaRsRtDBSpaceUsed, cmmcaRtMsgReceived=cmmcaRtMsgReceived, cmmcaBreIntTotalInstanceTerminations=cmmcaBreIntTotalInstanceTerminations, cmmcaRtTraceMask=cmmcaRtTraceMask, cmmcaCmRtNumCallConnecting=cmmcaCmRtNumCallConnecting, cmmcaGeneralInfoGroup=cmmcaGeneralInfoGroup, cmmcaWaAggResyncResourceResponseReceived=cmmcaWaAggResyncResourceResponseReceived, CmmcaIndex=CmmcaIndex, cmmcaRaAggContactSegDetailMesgDispatched=cmmcaRaAggContactSegDetailMesgDispatched, cmmcaDeviceType=cmmcaDeviceType, cmmcaWaAggWorkRequestCanceledSent=cmmcaWaAggWorkRequestCanceledSent, cmmcaSystemConditionTimeStamp=cmmcaSystemConditionTimeStamp, cmmcaMpaRtActivePublishAddresses=cmmcaMpaRtActivePublishAddresses, cmmcaBreRtCurrentInstances=cmmcaBreRtCurrentInstances, cmmcaRuntimeInfo=cmmcaRuntimeInfo, cmmcaRtUptime=cmmcaRtUptime, cmmcaRmGroup=cmmcaRmGroup, cmmcaRsRtDBPercentUsed=cmmcaRsRtDBPercentUsed, cmmcaWaRtTotalContactCount=cmmcaWaRtTotalContactCount, cmmcaBreIntTotalAbnormalResourceEndings=cmmcaBreIntTotalAbnormalResourceEndings, cmmcaCmAggNumCallArrivals=cmmcaCmAggNumCallArrivals, cmmcaRsRtDBSpaceFree=cmmcaRsRtDBSpaceFree, cmmcaIcmgwRtACMIOutQueueWait=cmmcaIcmgwRtACMIOutQueueWait, cmmcaMaxMsgQMemAvail=cmmcaMaxMsgQMemAvail, cmmcaNextNodeName=cmmcaNextNodeName, cmmcaWaRtTotalResourceManagerCount=cmmcaWaRtTotalResourceManagerCount, cmmcaServiceType=cmmcaServiceType, cmmcaRmIntNumOffersReject=cmmcaRmIntNumOffersReject, cmmcaTPoolRtRunningThreads=cmmcaTPoolRtRunningThreads, cmmcaRaAggResourceTaskDetailMsgDispatched=cmmcaRaAggResourceTaskDetailMsgDispatched, cmmcaCmIntMaxCallDurationTime=cmmcaCmIntMaxCallDurationTime, cmmcaWaRtResourceMemberCount=cmmcaWaRtResourceMemberCount, cmmcaWaAggCancelWorkRequestReceived=cmmcaWaAggCancelWorkRequestReceived, cmmcaWaAggMessageSentError=cmmcaWaAggMessageSentError, CmmcaNextNodeStatus=CmmcaNextNodeStatus, cmmcaTPoolRtIdleThreads=cmmcaTPoolRtIdleThreads, cmmcaWaRtSkillCompetencyCount=cmmcaWaRtSkillCompetencyCount, cmmcaRtMsgQMemPercentUsage=cmmcaRtMsgQMemPercentUsage, cmmcaRaEntry=cmmcaRaEntry, cmmcaWaAggTotalConfigErrors=cmmcaWaAggTotalConfigErrors, cmmcaSystemConditionTable=cmmcaSystemConditionTable, cmmcaRsIntDBWrites=cmmcaRsIntDBWrites, cmmcaNextNodeType=cmmcaNextNodeType, ciscoMmodalContactAppsMIB=ciscoMmodalContactAppsMIB, cmmcaRdaAggNumUnSuccessPresenceNotifications=cmmcaRdaAggNumUnSuccessPresenceNotifications, cmmcaEnvRtCurrMemAvail=cmmcaEnvRtCurrMemAvail, cmmcaCmAggAvgCallInQueueTime=cmmcaCmAggAvgCallInQueueTime, cmmcaIcmgwRtPendingGetContactDetailDlgs=cmmcaIcmgwRtPendingGetContactDetailDlgs, cmmcaWaAggOfferTaskSent=cmmcaWaAggOfferTaskSent, cmmcaIcmgwRtPendingCallTermEvents=cmmcaIcmgwRtPendingCallTermEvents, cmmcaBreAggLoadedScripts=cmmcaBreAggLoadedScripts, cmmcaRsIntResourceTaskDetailRecords=cmmcaRsIntResourceTaskDetailRecords, cmmcaLocalDeviceType=cmmcaLocalDeviceType, cmmcaSystemStatus=cmmcaSystemStatus, cmmcaMpaTable=cmmcaMpaTable, cmmcaRsAggTotalContactSegmentMediaDetailRecords=cmmcaRsAggTotalContactSegmentMediaDetailRecords, cmmcaWaAggCancelQueueEventSent=cmmcaWaAggCancelQueueEventSent, cmmcaSystemConditionSeverity=cmmcaSystemConditionSeverity, cmmcaWaRtSelectionStrategyCount=cmmcaWaRtSelectionStrategyCount, cmmcaWaAggWRIFailureResponseSent=cmmcaWaAggWRIFailureResponseSent, cmmcaWaAggResourceResponseCanceledSent=cmmcaWaAggResourceResponseCanceledSent, cmmcaMpaAggInstantMessagesReceived=cmmcaMpaAggInstantMessagesReceived, cmmcaRaAggMsgReceived=cmmcaRaAggMsgReceived, cmmcaIcmgwRtAgentsMonitored=cmmcaIcmgwRtAgentsMonitored, cmmcaEnvRtCurrMemUsed=cmmcaEnvRtCurrMemUsed, cmmcaEventAppName=cmmcaEventAppName, cmmcaLicenseInfoGroup=cmmcaLicenseInfoGroup, cmmcaRaAggContactDetailAttribMsgDispatched=cmmcaRaAggContactDetailAttribMsgDispatched, cmmcaIcmgwRtAqsMonitored=cmmcaIcmgwRtAqsMonitored, cmmcaMpaAggTotalIMAddressesRegistered=cmmcaMpaAggTotalIMAddressesRegistered, cmmcaWaAggResyncResourceResponseAckSent=cmmcaWaAggResyncResourceResponseAckSent, cmmcaCmAggAvgCallArrivalRate=cmmcaCmAggAvgCallArrivalRate, cmmcaRmIntNumOffersTimedOut=cmmcaRmIntNumOffersTimedOut, cmmcaIcmgwRtPendingQueryAgentStateDlgs=cmmcaIcmgwRtPendingQueryAgentStateDlgs, cmmcaEnableNotifications=cmmcaEnableNotifications, ciscoMmodalContactAppsMIBGroups=ciscoMmodalContactAppsMIBGroups, cmmcaMpaRtTotalPublishAddressesRegistered=cmmcaMpaRtTotalPublishAddressesRegistered, cmmcaIcmgwAggSocketConnects=cmmcaIcmgwAggSocketConnects, cmmcaBreIntMaxConcurrentInstances=cmmcaBreIntMaxConcurrentInstances, cmmcaBreAggTotalAbnormalContactEndings=cmmcaBreAggTotalAbnormalContactEndings, cmmcaRtRoutingDomain=cmmcaRtRoutingDomain, cmmcaLicenseInfo=cmmcaLicenseInfo, cmmcaBreAggMaxConcurrentInstances=cmmcaBreAggMaxConcurrentInstances, cmmcaEventHostName=cmmcaEventHostName, cmmcaRsTable=cmmcaRsTable, cmmcaCmRtNumCallRingBack=cmmcaCmRtNumCallRingBack, cmmcaCmIntMaxCallInQueueTime=cmmcaCmIntMaxCallInQueueTime, cmmcaSystemConditionStatus=cmmcaSystemConditionStatus, cmmcaBreIntTotalContactInstanceInitiations=cmmcaBreIntTotalContactInstanceInitiations, cmmcaTPoolRtMaxThreadsAvail=cmmcaTPoolRtMaxThreadsAvail, cmmcaCmEntry=cmmcaCmEntry, cmmcaEnvMaxThreadsUsed=cmmcaEnvMaxThreadsUsed, cmmcaDeviceDescription=cmmcaDeviceDescription, cmmcaRmEntry=cmmcaRmEntry, cmmcaRaGroup=cmmcaRaGroup, cmmcaMpaRtIncomingCalls=cmmcaMpaRtIncomingCalls, cmmcaMpaRtActiveSipControlAddresses=cmmcaMpaRtActiveSipControlAddresses, cmmcaEventTimestamp=cmmcaEventTimestamp, cmmcaServiceInfo=cmmcaServiceInfo, cmmcaMpaAggPresenceUpdatesBytesRcv=cmmcaMpaAggPresenceUpdatesBytesRcv, cmmcaWaRtSelectionStrategyAttrCount=cmmcaWaRtSelectionStrategyAttrCount, cmmcaNotificationInfo=cmmcaNotificationInfo, cmmcaTimeZoneOffsetHours=cmmcaTimeZoneOffsetHours, cmmcaMIBEvent=cmmcaMIBEvent, cmmcaEnvRtCurrThreadsInUse=cmmcaEnvRtCurrThreadsInUse, cmmcaRdaAggNumSuccessPresenceNotifications=cmmcaRdaAggNumSuccessPresenceNotifications, PYSNMP_MODULE_ID=ciscoMmodalContactAppsMIB, cmmcaRsIntAssignmentQueDetailRecords=cmmcaRsIntAssignmentQueDetailRecords, cmmcaIcmgwAggACMIBytesRcvd=cmmcaIcmgwAggACMIBytesRcvd, cmmcaRsDBSizeAllocated=cmmcaRsDBSizeAllocated, cmmcaMaxThreadsAvailable=cmmcaMaxThreadsAvailable, cmmcaWaAggCancelResourceRequestReceived=cmmcaWaAggCancelResourceRequestReceived, cmmcaIcmgwRtGetContactDetailDelay=cmmcaIcmgwRtGetContactDetailDelay, cmmcaMpaGroup=cmmcaMpaGroup, cmmcaMpaRtActiveRegisteredSipAddresses=cmmcaMpaRtActiveRegisteredSipAddresses, cmmcaIcmgwAggSocketDisconnects=cmmcaIcmgwAggSocketDisconnects, ciscoMmodalContactAppsMIBCompliances=ciscoMmodalContactAppsMIBCompliances, cmmcaWaTable=cmmcaWaTable, cmmcaRaAggResourceStateChngMesgReceived=cmmcaRaAggResourceStateChngMesgReceived, cmmcaRaAggNodeSyncDispatched=cmmcaRaAggNodeSyncDispatched, cmmcaIcmgwTable=cmmcaIcmgwTable, cmmcaBreIntAvgConcurrentInstances=cmmcaBreIntAvgConcurrentInstances, cmmcaCmAggMaxCallDurationTimeDt=cmmcaCmAggMaxCallDurationTimeDt, cmmcaWaAggResourceResponseSent=cmmcaWaAggResourceResponseSent, cmmcaWaRtAttributeValueCount=cmmcaWaRtAttributeValueCount, cmmcaGeneralInfo=cmmcaGeneralInfo, cmmcaRsGroup=cmmcaRsGroup, cmmcaRsRtDBStatus=cmmcaRsRtDBStatus, cmmcaServiceIndex=cmmcaServiceIndex, cmmcaIcmgwAggQueryAgentStateTimeouts=cmmcaIcmgwAggQueryAgentStateTimeouts, cmmcaRaAggResourceStateChngMsgDispatched=cmmcaRaAggResourceStateChngMsgDispatched, cmmcaBreAggTotalContactInstanceInitiations=cmmcaBreAggTotalContactInstanceInitiations, cmmcaEnvRtUpTime=cmmcaEnvRtUpTime, cmmcaServices=cmmcaServices, cmmcaMpaEntry=cmmcaMpaEntry, cmmcaRaAggContactDetailMesgDispatched=cmmcaRaAggContactDetailMesgDispatched, cmmcaBreIntTotalContactInstanceTerminations=cmmcaBreIntTotalContactInstanceTerminations, cmmcaCmRtNumActiveCalls=cmmcaCmRtNumActiveCalls, cmmcaMpaAggTotalRegisteredSipAddresses=cmmcaMpaAggTotalRegisteredSipAddresses, cmmcaRtCongested=cmmcaRtCongested, cmmcaWaRtAttributeCriteriaCount=cmmcaWaRtAttributeCriteriaCount, cmmcaDescription=cmmcaDescription, cmmcaTPoolRtCoreThreads=cmmcaTPoolRtCoreThreads, cmmcaNextNodeTable=cmmcaNextNodeTable, cmmcaCmRtNumCallRejecting=cmmcaCmRtNumCallRejecting, cmmcaMpaRtActiveInteractions=cmmcaMpaRtActiveInteractions, cmmcaNextNodeIpAddr=cmmcaNextNodeIpAddr, cmmcaRmRtAgentsNoQueue=cmmcaRmRtAgentsNoQueue, cmmcaEventMessageName=cmmcaEventMessageName, cmmcaBreIntTotalAbnormalEndings=cmmcaBreIntTotalAbnormalEndings, cmmcaIcmgwRtACMIOutQueueDepth=cmmcaIcmgwRtACMIOutQueueDepth, cmmcaIcmgwAggGetContactDetailTimeouts=cmmcaIcmgwAggGetContactDetailTimeouts, cmmcaClusterInfoTable=cmmcaClusterInfoTable, cmmcaDeviceStatus=cmmcaDeviceStatus, cmmcaCmIntAvgCallArrivalRate=cmmcaCmIntAvgCallArrivalRate, cmmcaBreAggTotalInstanceTerminations=cmmcaBreAggTotalInstanceTerminations, cmmcaNextNodeIndex=cmmcaNextNodeIndex, cmmcaRmRtAgentsReserved=cmmcaRmRtAgentsReserved, cmmcaDeviceInetAddress=cmmcaDeviceInetAddress, cmmcaEventMessageId=cmmcaEventMessageId, cmmcaRmRtAgentsReady=cmmcaRmRtAgentsReady, cmmcaBreTable=cmmcaBreTable, cmmcaCmTable=cmmcaCmTable, cmmcaMpaAggFailedReinvites=cmmcaMpaAggFailedReinvites, cmmcaRsAggTotalAssignmentQueDetailRecords=cmmcaRsAggTotalAssignmentQueDetailRecords, cmmcaRmRtAgentsLoggedIn=cmmcaRmRtAgentsLoggedIn, cmmcaWaAggOfferTaskCancelledSent=cmmcaWaAggOfferTaskCancelledSent, cmmcaCmAggMaxCallInQueueTime=cmmcaCmAggMaxCallInQueueTime, cmmcaWaRtResourceCriteriaCount=cmmcaWaRtResourceCriteriaCount, cmmcaMpaAggConnectsRcv=cmmcaMpaAggConnectsRcv, cmmcaServiceStatus=cmmcaServiceStatus, cmmcaIcmgwGroup=cmmcaIcmgwGroup, cmmcaRsAggTotalContactDetailRecords=cmmcaRsAggTotalContactDetailRecords, cmmcaServiceTable=cmmcaServiceTable, cmmcaStartTime=cmmcaStartTime, cmmcaRdaRtNumInactiveClients=cmmcaRdaRtNumInactiveClients, cmmcaRsAggTotalResourceTaskDetailRecords=cmmcaRsAggTotalResourceTaskDetailRecords, cmmcaWaRtSkillCount=cmmcaWaRtSkillCount, cmmcaCmAggMaxCallArrivalRate=cmmcaCmAggMaxCallArrivalRate, cmmcaTimeZoneOffsetMinutes=cmmcaTimeZoneOffsetMinutes, cmmcaIcmgwAggACMIBytesSent=cmmcaIcmgwAggACMIBytesSent, cmmcaRtThreadsInUse=cmmcaRtThreadsInUse, cmmcaSystemConditionMessage=cmmcaSystemConditionMessage, cmmcaCmGroup=cmmcaCmGroup, cmmcaCmRtNumCallTransferring=cmmcaCmRtNumCallTransferring, cmmcaWaRtTotalContactManagerCount=cmmcaWaRtTotalContactManagerCount, cmmcaMpaRtOutgoingCalls=cmmcaMpaRtOutgoingCalls, cmmcaDeviceName=cmmcaDeviceName, cmmcaCmIntNumCallArrivals=cmmcaCmIntNumCallArrivals, ciscoMmodalContactAppsMIBObjects=ciscoMmodalContactAppsMIBObjects, CmmcaSeverityLevel=CmmcaSeverityLevel, cmmcaMpaAggAvgLatency=cmmcaMpaAggAvgLatency, cmmcaIcmgwAggACMIMsgsRcvd=cmmcaIcmgwAggACMIMsgsRcvd, cmmcaSystemConditionId=cmmcaSystemConditionId, cmmcaServiceGroup=cmmcaServiceGroup, cmmcaBreAggAvgConcurrentInstances=cmmcaBreAggAvgConcurrentInstances, cmmcaEventsGroup=cmmcaEventsGroup, cmmcaDeviceInetAddressType=cmmcaDeviceInetAddressType, cmmcaMpaAggInstantMessagesSent=cmmcaMpaAggInstantMessagesSent, cmmcaTimeZoneName=cmmcaTimeZoneName, cmmcaRmIntNumOffersAccept=cmmcaRmIntNumOffersAccept, cmmcaRuntimeInfoGroup=cmmcaRuntimeInfoGroup, cmmcaWaAggOfferTaskAcceptedSent=cmmcaWaAggOfferTaskAcceptedSent, cmmcaCmAggMaxCallDurationTime=cmmcaCmAggMaxCallDurationTime, cmmcaCmAggMaxCallInQueueTimeDt=cmmcaCmAggMaxCallInQueueTimeDt, cmmcaBreEntry=cmmcaBreEntry, CmmcaServiceStatus=CmmcaServiceStatus, cmmcaMpaRtActiveClientSessions=cmmcaMpaRtActiveClientSessions, cmmcaRaAggContactSegMediaDetailMsgDispatched=cmmcaRaAggContactSegMediaDetailMsgDispatched, cmmcaRaAggResourceTaskDetailMsgReceived=cmmcaRaAggResourceTaskDetailMsgReceived, cmmcaRaAggVersionRequestDispatched=cmmcaRaAggVersionRequestDispatched, cmmcaSystemConditionIndex=cmmcaSystemConditionIndex, cmmcaRaAggContactDetailMesgReceived=cmmcaRaAggContactDetailMesgReceived, cmmcaEnvRtMaxMemAvail=cmmcaEnvRtMaxMemAvail, cmmcaMpaAggTotalCalls=cmmcaMpaAggTotalCalls, cmmcaRaAggVersionResponseRecieved=cmmcaRaAggVersionResponseRecieved, cmmcaIcmgwRtRoutesMonitored=cmmcaIcmgwRtRoutesMonitored, CmmcaConditionStatus=CmmcaConditionStatus, cmmcaWaAggRRIFailureResponseSent=cmmcaWaAggRRIFailureResponseSent, cmmcaClusterInfoEntry=cmmcaClusterInfoEntry, ciscoMmodalContactAppsMIBNotifs=ciscoMmodalContactAppsMIBNotifs, ciscoMmodalContactAppsMIBConform=ciscoMmodalContactAppsMIBConform, cmmcaRsIntContactDetailAttribRecords=cmmcaRsIntContactDetailAttribRecords, cmmcaBreIntTotalInstanceInitiations=cmmcaBreIntTotalInstanceInitiations, cmmcaBreAggMaxConcurrentInstancesDt=cmmcaBreAggMaxConcurrentInstancesDt, cmmcaBreAggTotalInstanceInitiations=cmmcaBreAggTotalInstanceInitiations, cmmcaEventState=cmmcaEventState, cmmcaWaAggResyncResourceSent=cmmcaWaAggResyncResourceSent, cmmcaSystemConditionDescription=cmmcaSystemConditionDescription, CmmcaSystemConditionStatus=CmmcaSystemConditionStatus, cmmcaRsAggTotalContactDetailAttributeRecords=cmmcaRsAggTotalContactDetailAttributeRecords, cmmcaWaAggOfferTaskResponseReceived=cmmcaWaAggOfferTaskResponseReceived, cmmcaMpaAggNewCalls=cmmcaMpaAggNewCalls, cmmcaRmRtAgentsOnCalls=cmmcaRmRtAgentsOnCalls, cmmcaRtLogLevel=cmmcaRtLogLevel, cmmcaRsRtTransactionLogSize=cmmcaRsRtTransactionLogSize, cmmcaRdaIntNumSuccessPresenceNotifications=cmmcaRdaIntNumSuccessPresenceNotifications, cmmcaEventText=cmmcaEventText, ciscoMmodalContactAppsMIBComplianceRev=ciscoMmodalContactAppsMIBComplianceRev, cmmcaNextNodeIpAddrType=cmmcaNextNodeIpAddrType, cmmcaRsRtNumberActiveDBUserSessions=cmmcaRsRtNumberActiveDBUserSessions, cmmcaBreGroup=cmmcaBreGroup, cmmcaRdaRtNumOutStandingOfferTasks=cmmcaRdaRtNumOutStandingOfferTasks, cmmcaWaRtAssignmentQueCount=cmmcaWaRtAssignmentQueCount, cmmcaServiceIntPeriod=cmmcaServiceIntPeriod, cmmcaBreIntTotalResourceInstanceInitiations=cmmcaBreIntTotalResourceInstanceInitiations, cmmcaWaAggWorkRequestReceived=cmmcaWaAggWorkRequestReceived)
mibBuilder.exportSymbols("CISCO-MMODAL-CONTACT-APPS-MIB", cmmcaRaTable=cmmcaRaTable, cmmcaRsAggTotalContactSegmentDetailRecords=cmmcaRsAggTotalContactSegmentDetailRecords, cmmcaNextNodeStatus=cmmcaNextNodeStatus, cmmcaBreAggTotalAbnormalResourceEndings=cmmcaBreAggTotalAbnormalResourceEndings, cmmcaRsEntry=cmmcaRsEntry, cmmcaNotificationInfoGroup=cmmcaNotificationInfoGroup, cmmcaRmAggNumOffersAccept=cmmcaRmAggNumOffersAccept, cmmcaCmIntAvgCallDurationTime=cmmcaCmIntAvgCallDurationTime, cmmcaEventSeverity=cmmcaEventSeverity, cmmcaRaAggMsgSent=cmmcaRaAggMsgSent, cmmcaRdaTable=cmmcaRdaTable, cmmcaCmRtNumCallTrying=cmmcaCmRtNumCallTrying, cmmcaRdaAggNumMsgProc=cmmcaRdaAggNumMsgProc, cmmcaWaRtAttributeDefCount=cmmcaWaRtAttributeDefCount, cmmcaRsIntResourceEventDetailRecords=cmmcaRsIntResourceEventDetailRecords, cmmcaRsIntAssignmentQueAttribRecords=cmmcaRsIntAssignmentQueAttribRecords, cmmcaVersion=cmmcaVersion, cmmcaRdaGroup=cmmcaRdaGroup, cmmcaMpaAggTotalSipControlAddressesRegistered=cmmcaMpaAggTotalSipControlAddressesRegistered, cmmcaBreAggTotalResourceInstanceInitiations=cmmcaBreAggTotalResourceInstanceInitiations, cmmcaWaAggResourceRequestReceived=cmmcaWaAggResourceRequestReceived, cmmcaRmAggNumOffersTimedOut=cmmcaRmAggNumOffersTimedOut, cmmcaRmTable=cmmcaRmTable, cmmcaCmRtNumCallTerminating=cmmcaCmRtNumCallTerminating, cmmcaCmIntMaxCallInQueueTimeDt=cmmcaCmIntMaxCallInQueueTimeDt, cmmcaRdaEntry=cmmcaRdaEntry, cmmcaBreIntMaxConcurrentInstancesDt=cmmcaBreIntMaxConcurrentInstancesDt, cmmcaBreIntTotalAbnormalContactEndings=cmmcaBreIntTotalAbnormalContactEndings, cmmcaRdaIntNumUnSuccessPresenceNotifications=cmmcaRdaIntNumUnSuccessPresenceNotifications, cmmcaBreAggTotalContactInstanceTerminations=cmmcaBreAggTotalContactInstanceTerminations, cmmcaWaRtTotalResourceCount=cmmcaWaRtTotalResourceCount, cmmcaRaAggContactSegDetailMsgReceived=cmmcaRaAggContactSegDetailMsgReceived, cmmcaMpaAggTotalMonitoredPresenceAddressesRegistered=cmmcaMpaAggTotalMonitoredPresenceAddressesRegistered, cmmcaThreadPoolGroup=cmmcaThreadPoolGroup, cmmcaMpaRtActiveIMAddresses=cmmcaMpaRtActiveIMAddresses, cmmcaRtMessageThroughput=cmmcaRtMessageThroughput, cmmcaCmAggAvgCallDurationTime=cmmcaCmAggAvgCallDurationTime, cmmcaMpaAggPresenceUpdatesReceived=cmmcaMpaAggPresenceUpdatesReceived, cmmcaServiceName=cmmcaServiceName, cmmcaThreadPool=cmmcaThreadPool, cmmcaCmRtNumCallInitial=cmmcaCmRtNumCallInitial, cmmcaOpsConsoleURL=cmmcaOpsConsoleURL, cmmcaNextNodeEntry=cmmcaNextNodeEntry, cmmcaSystemConditionEntry=cmmcaSystemConditionEntry, cmmcaRsAggTotalDBWrites=cmmcaRsAggTotalDBWrites, cmmcaBreRtActiveScripts=cmmcaBreRtActiveScripts, cmmcaIcmgwEntry=cmmcaIcmgwEntry, cmmcaCmIntMaxCallDurationTimeDt=cmmcaCmIntMaxCallDurationTimeDt, cmmcaServerName=cmmcaServerName, cmmcaDeviceIndex=cmmcaDeviceIndex, cmmcaBreIntTotalResourceInstanceTerminations=cmmcaBreIntTotalResourceInstanceTerminations, cmmcaRsAggTotalResourceEventDetailRecords=cmmcaRsAggTotalResourceEventDetailRecords, cmmcaRsIntContactSegmentMediaDetailRecords=cmmcaRsIntContactSegmentMediaDetailRecords, cmmcaTotalLicensesConfigured=cmmcaTotalLicensesConfigured, cmmcaMpaAggFailedInvites=cmmcaMpaAggFailedInvites, cmmcaRsAggTotalAssignmentQueAttribRecords=cmmcaRsAggTotalAssignmentQueAttribRecords, cmmcaIcmgwAggACMIMsgsSent=cmmcaIcmgwAggACMIMsgsSent, cmmcaTPoolRtMaxThreadsUsed=cmmcaTPoolRtMaxThreadsUsed, cmmcaBreAggDistinctScripts=cmmcaBreAggDistinctScripts, cmmcaRmRtAgentsWrapUp=cmmcaRmRtAgentsWrapUp, cmmcaIcmgwRtQueryAgentStateDelay=cmmcaIcmgwRtQueryAgentStateDelay, cmmcaRtLicensesAvailable=cmmcaRtLicensesAvailable, cmmcaCmRtNumCallConnected=cmmcaCmRtNumCallConnected, cmmcaRdaRtNumActiveClients=cmmcaRdaRtNumActiveClients, cmmcaCmIntAvgCallInQueueTime=cmmcaCmIntAvgCallInQueueTime, cmmcaRsIntContactSegmentDetailRecords=cmmcaRsIntContactSegmentDetailRecords, cmmcaEnvRtMaxMemUsed=cmmcaEnvRtMaxMemUsed, cmmcaMpaRtActiveMonitoredPresenceAddresses=cmmcaMpaRtActiveMonitoredPresenceAddresses, cmmcaMpaAggTotalClientsRegistered=cmmcaMpaAggTotalClientsRegistered, cmmcaWaGroup=cmmcaWaGroup, cmmcaClusterId=cmmcaClusterId, cmmcaWaRtResourceCount=cmmcaWaRtResourceCount, cmmcaWaAggQueueEventSent=cmmcaWaAggQueueEventSent, CmmcaServiceType=CmmcaServiceType, cmmcaCmAggMaxCallArrivalRateDt=cmmcaCmAggMaxCallArrivalRateDt, cmmcaBreAggTotalAbnormalEndings=cmmcaBreAggTotalAbnormalEndings, cmmcaWaEntry=cmmcaWaEntry)
