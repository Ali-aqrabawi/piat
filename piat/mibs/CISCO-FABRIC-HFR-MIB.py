...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-FABRIC-HFR-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:30:47 2019
...
ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, IpAddress, Bits, Gauge32, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "IpAddress", "Bits", "Gauge32", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("CISCO-FABRIC-HFR-MIB", cfhBundlePortStatsHighRxUCECells=cfhBundlePortStatsHighRxUCECells, cfhBundleTotal=cfhBundleTotal, cfhMIBNotifications=cfhMIBNotifications, cfhCardEntry=cfhCardEntry, cfhNotificationsGroup=cfhNotificationsGroup, CfhPlane=CfhPlane, cfhPlaneStatsTable=cfhPlaneStatsTable, cfhCardFabInUse=cfhCardFabInUse, cfhBundleName=cfhBundleName, cfhBundlePortSecondId=cfhBundlePortSecondId, cfhBundleTotalLinks=cfhBundleTotalLinks, cfhBundlePortId=cfhBundlePortId, cfhPlaneStatsRxUCECells=cfhPlaneStatsRxUCECells, cfhBundlePortStatsTxDataCells=cfhBundlePortStatsTxDataCells, cfhBundlePortLCRId=cfhBundlePortLCRId, cfhBundleEntry=cfhBundleEntry, cfhPlane=cfhPlane, cfhPlaneDownedBundles=cfhPlaneDownedBundles, cfhBundlePortStatsEntry=cfhBundlePortStatsEntry, cfhBundlePortStatsHighRxPECells=cfhBundlePortStatsHighRxPECells, cfhPlaneGroup=cfhPlaneGroup, cfhPlaneTable=cfhPlaneTable, cfhCardFabInUseDiscTime=cfhCardFabInUseDiscTime, cfhBundlePortStatsHighRxCECells=cfhBundlePortStatsHighRxCECells, cfhBundlePortGrpId=cfhBundlePortGrpId, cfhBundlePortEntry=cfhBundlePortEntry, cfhGenBundleDownedLinkTrapEnable=cfhGenBundleDownedLinkTrapEnable, cfhBundlePortLCRCardIndex=cfhBundlePortLCRCardIndex, cfhBundleTable=cfhBundleTable, cfhPlaneStatsUnicastLostCells=cfhPlaneStatsUnicastLostCells, cfhBundleGroup=cfhBundleGroup, cfhBundlePortStatsRxCECells=cfhBundlePortStatsRxCECells, cfhGenInfoGroup=cfhGenInfoGroup, cfhCardPlaneTable=cfhCardPlaneTable, cfhPlaneTotalBundles=cfhPlaneTotalBundles, cfhPlaneStatsRxPECells=cfhPlaneStatsRxPECells, cfhBundleOperStatus=cfhBundleOperStatus, cfhCardGroup=cfhCardGroup, cfhBundlePortStatsRxDataCells=cfhBundlePortStatsRxDataCells, cfhBundlePortAdminState=cfhBundlePortAdminState, CfhScaledPercentage=CfhScaledPercentage, cfhBundlePortStatsRxUCECells=cfhBundlePortStatsRxUCECells, cfhPlaneStatsTxDataCells=cfhPlaneStatsTxDataCells, cfhCardTable=cfhCardTable, cfhFabricCapacityGroup=cfhFabricCapacityGroup, cfhPlaneStatsCounterDiscTime=cfhPlaneStatsCounterDiscTime, cfhCard=cfhCard, ciscoFabricHfrMIBObjects=ciscoFabricHfrMIBObjects, cfhGenPlaneStateTrapEnable=cfhGenPlaneStateTrapEnable, cfhCardPlaneRxConnectivity=cfhCardPlaneRxConnectivity, cfhCardFabUsage=cfhCardFabUsage, cfhBundlePort=cfhBundlePort, cfhPlaneId=cfhPlaneId, cfhBundleDowned=cfhBundleDowned, cfhMIBCompliance1=cfhMIBCompliance1, cfhMIBCompliances=cfhMIBCompliances, cfhBundlePortOperState=cfhBundlePortOperState, cfhPlaneAdminStatus=cfhPlaneAdminStatus, cfhPlaneEntry=cfhPlaneEntry, cfhBundleStateNotification=cfhBundleStateNotification, ciscoFabricHfrMIB=ciscoFabricHfrMIB, cfhPlaneCapacityThreshold=cfhPlaneCapacityThreshold, cfhMIBCompliance=cfhMIBCompliance, cfhBundlePortStatsTable=cfhBundlePortStatsTable, cfhPlaneStateNotification=cfhPlaneStateNotification, cfhPlaneStatsEntry=cfhPlaneStatsEntry, cfhMIBConformance=cfhMIBConformance, cfhPlaneOperStatus=cfhPlaneOperStatus, PYSNMP_MODULE_ID=ciscoFabricHfrMIB, cfhBundlePortSecondCardIndex=cfhBundlePortSecondCardIndex, cfhMIBGroups=cfhMIBGroups, CfhAdminState=CfhAdminState, cfhBundlePortTable=cfhBundlePortTable, cfhPlaneStatsRxDataCells=cfhPlaneStatsRxDataCells, cfhBundlePortStatsRxPECells=cfhBundlePortStatsRxPECells, cfhCardPlaneTxConnectivity=cfhCardPlaneTxConnectivity, cfhBundlePortGroup=cfhBundlePortGroup, cfhGeneral=cfhGeneral, CfhBundle=CfhBundle, cfhBundleDownedLinkNotification=cfhBundleDownedLinkNotification, cfhBundlePortTotalNumber=cfhBundlePortTotalNumber, cfhPlaneStatsRxCECells=cfhPlaneStatsRxCECells, cfhPlaneStatsMulticastLostCells=cfhPlaneStatsMulticastLostCells, cfhBundleDownedLinks=cfhBundleDownedLinks, cfhBundlePlane=cfhBundlePlane, cfhBundleId=cfhBundleId, cfhGenBundleStateTrapEnable=cfhGenBundleStateTrapEnable, cfhBundle=cfhBundle, cfhCardPlaneEntry=cfhCardPlaneEntry)
