...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/CISCO-MODEM-MGMT-MIB
# Produced by pysmi-0.3.4 at Sun Apr 21 23:42:04 2019
...
IpAddress, ModuleIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Bits, Gauge32, Counter64, ObjectIdentity, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Bits", "Gauge32", "Counter64", "ObjectIdentity", "Counter32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("CISCO-MODEM-MGMT-MIB", cmMIBNotificationPrefix=cmMIBNotificationPrefix, ciscoModemMgmtMIBComplianceRev5=ciscoModemMgmtMIBComplianceRev5, cmNotificationGroup=cmNotificationGroup, cmCallDirection=cmCallDirection, cmGroupInfoGroup=cmGroupInfoGroup, cmLineStatusEntry=cmLineStatusEntry, cmTotalCallDuration=cmTotalCallDuration, cmSystemInfoGroupRev1=cmSystemInfoGroupRev1, cmLineSpeedStatisticsTable=cmLineSpeedStatisticsTable, cmRXRate=cmRXRate, cmBusyOutRequest=cmBusyOutRequest, cmGroupMemberTable=cmGroupMemberTable, cm2400To14400Connections=cm2400To14400Connections, cmManageable=cmManageable, cmIncomingConnectionCompletions=cmIncomingConnectionCompletions, cmGroupTable=cmGroupTable, ciscoModemMgmtMIBObjects=ciscoModemMgmtMIBObjects, cmStateNotification=cmStateNotification, cmLineInfoGroup=cmLineInfoGroup, cmIncomingConnectionFailures=cmIncomingConnectionFailures, cmCallPhoneNumber=cmCallPhoneNumber, cmSystemModemsInUse=cmSystemModemsInUse, cmNotificationConfig=cmNotificationConfig, cmModulationSchemeUsed=cmModulationSchemeUsed, cmATModePermit=cmATModePermit, cmLineStatisticsTable=cmLineStatisticsTable, cmLinkFailures=cmLinkFailures, cmManagedLineInfoGroupRev2=cmManagedLineInfoGroupRev2, cmSystemModemsDead=cmSystemModemsDead, cmRingNoAnswers=cmRingNoAnswers, cmSystemModemsUnavailable=cmSystemModemsUnavailable, cmGroupEntry=cmGroupEntry, cmSystemWatchdogTime=cmSystemWatchdogTime, cmPortIndex=cmPortIndex, cmSystemInstalledModem=cmSystemInstalledModem, cmSystemModemsAvailable=cmSystemModemsAvailable, cmWatchdogTimeouts=cmWatchdogTimeouts, cmShutdown=cmShutdown, cmSystemInfoGroup=cmSystemInfoGroup, cmBad=cmBad, cmGreaterThan14400Connections=cmGreaterThan14400Connections, cmProtocolUsed=cmProtocolUsed, cmSystemInfo=cmSystemInfo, cmSystemMaxRetries=cmSystemMaxRetries, cmGroupTotalDevices=cmGroupTotalDevices, ciscoModemMgmtMIBComplianceRev3=ciscoModemMgmtMIBComplianceRev3, ciscoModemMgmtMIBComplianceRev6=ciscoModemMgmtMIBComplianceRev6, cmOutgoingConnectionCompletions=cmOutgoingConnectionCompletions, cmSlotIndex=cmSlotIndex, cmProtocolErrors=cmProtocolErrors, cmState=cmState, cmStatusPolling=cmStatusPolling, cmStateNotifyEnable=cmStateNotifyEnable, cmCallerID=cmCallerID, cmGroup=cmGroup, cmNoCarriers=cmNoCarriers, cmSystemStatusPollTime=cmSystemStatusPollTime, cmInitialLineSpeed=cmInitialLineSpeed, cmNotificationConfigGroup=cmNotificationConfigGroup, ciscoModemMgmtMIBGroups=ciscoModemMgmtMIBGroups, cmInitialTxLineConnections=cmInitialTxLineConnections, cmInitialLineConnections=cmInitialLineConnections, PYSNMP_MODULE_ID=ciscoModemMgmtMIB, cmPollingTimeouts=cmPollingTimeouts, cmGroupMemberEntry=cmGroupMemberEntry, ciscoModemMgmtMIBComplianceRev2=ciscoModemMgmtMIBComplianceRev2, ciscoModemMgmtMIBComplianceRev4=ciscoModemMgmtMIBComplianceRev4, cmGroupIndex=cmGroupIndex, cmGroupInfo=cmGroupInfo, cmLineSpeedInfoGroup=cmLineSpeedInfoGroup, cmLineSpeedStatisticsEntry=cmLineSpeedStatisticsEntry, ciscoModemMgmtMIBConformance=ciscoModemMgmtMIBConformance, cmManagedLineInfoGroup=cmManagedLineInfoGroup, cmMIBNotifications=cmMIBNotifications, cmOutgoingConnectionFailures=cmOutgoingConnectionFailures, cmLineSpeedInfoGroupRev1=cmLineSpeedInfoGroupRev1, cmInitialRxLineConnections=cmInitialRxLineConnections, cmSystemConfiguredGroup=cmSystemConfiguredGroup, cmHoldReset=cmHoldReset, ciscoModemMgmtMIB=ciscoModemMgmtMIB, ciscoModemMgmtMIBComplianceRev1=ciscoModemMgmtMIBComplianceRev1, cmLineSpeedInfoGroupRev2=cmLineSpeedInfoGroupRev2, cmCallDuration=cmCallDuration, cmSystemModemsOffline=cmSystemModemsOffline, cmFailedDialAttempts=cmFailedDialAttempts, cmManagedLineInfoGroupRev1=cmManagedLineInfoGroupRev1, cmLineStatisticsEntry=cmLineStatisticsEntry, cmNoDialTones=cmNoDialTones, cmTXAnalogSignalLevel=cmTXAnalogSignalLevel, cmRXAnalogSignalLevel=cmRXAnalogSignalLevel, cmLineInfo=cmLineInfo, ciscoModemMgmtMIBCompliance=ciscoModemMgmtMIBCompliance, cm2400OrLessConnections=cm2400OrLessConnections, cmLineConfigEntry=cmLineConfigEntry, cmProductDetails=cmProductDetails, cmLineConfigTable=cmLineConfigTable, ciscoModemMgmtMIBCompliances=ciscoModemMgmtMIBCompliances, cmManufacturerID=cmManufacturerID, cmTXRate=cmTXRate, cmDialTimeouts=cmDialTimeouts, cmLineStatusTable=cmLineStatusTable, cmDisconnectReason=cmDisconnectReason, cmInterface=cmInterface)
